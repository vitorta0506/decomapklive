...
# static fields
.field private static final u:Lio/grpc/netty/shaded/io/netty/util/internal/r;
...
# instance fields
.field private final t:Lio/grpc/netty/shaded/io/netty/util/internal/r$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Lkg/n$f$a;

    invoke-direct {v0}, Lkg/n$f$a;-><init>()V
    ...
    sput-object v0, Lkg/n$f;->u:Lio/grpc/netty/shaded/io/netty/util/internal/r;
...
.method private constructor <init>(Lio/grpc/netty/shaded/io/netty/util/internal/r$a;)V
    ...
    invoke-direct {p0, v0, v1, v2}, Lkg/y0;-><init>(Lkg/k;II)V

    .line 3
    iput-object p1, p0, Lkg/n$f;->t:Lio/grpc/netty/shaded/io/netty/util/internal/r$a;
...
.method synthetic constructor <init>(Lio/grpc/netty/shaded/io/netty/util/internal/r$a;Lkg/n$a;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lkg/n$f;-><init>(Lio/grpc/netty/shaded/io/netty/util/internal/r$a;)V

    return-void
.end method

.method static O3()Lkg/n$f;
    .locals 1

    .line 1
    sget-object v0, Lkg/n$f;->u:Lio/grpc/netty/shaded/io/netty/util/internal/r;

    invoke-virtual {v0}, Lio/grpc/netty/shaded/io/netty/util/internal/r;->a()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lkg/n$f;
...
.method protected C3()V
    ...
    .line 4
    iget-object v0, p0, Lkg/n$f;->t:Lio/grpc/netty/shaded/io/netty/util/internal/r$a;
