...
.method constructor <init>(Lio/grpc/internal/z1$a0;Lio/grpc/Status;Lio/grpc/internal/ClientStreamListener$RpcProgress;Lio/grpc/s0;)V
    ...
    iput-object p1, p0, Lio/grpc/internal/z1$a0$f;->d:Lio/grpc/internal/z1$a0;

    iput-object p2, p0, Lio/grpc/internal/z1$a0$f;->a:Lio/grpc/Status;

    iput-object p3, p0, Lio/grpc/internal/z1$a0$f;->b:Lio/grpc/internal/ClientStreamListener$RpcProgress;

    iput-object p4, p0, Lio/grpc/internal/z1$a0$f;->c:Lio/grpc/s0;
...
.method public run()V
    ...
    .line 1
    iget-object v0, p0, Lio/grpc/internal/z1$a0$f;->d:Lio/grpc/internal/z1$a0;
    ...
    iget-object v1, p0, Lio/grpc/internal/z1$a0$f;->a:Lio/grpc/Status;

    iget-object v2, p0, Lio/grpc/internal/z1$a0$f;->b:Lio/grpc/internal/ClientStreamListener$RpcProgress;

    iget-object v3, p0, Lio/grpc/internal/z1$a0$f;->c:Lio/grpc/s0;
