...
.method public static d(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILwf/b;)V
    .locals 8
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct/range {v0 .. v6}, Lyf/a;-><init>(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILwf/b;)V
...
.method public static g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {v1, p0}, Lzf/f;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {v1}, Lzf/f;->c()I

    move-result v0

    .line 3
    invoke-static {p0}, Lzf/a;->c(Ljava/io/Closeable;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
