...
# virtual methods
.method b(Lcom/linecorp/linesdk/auth/LineAuthenticationConfig;Lcom/linecorp/linesdk/internal/pkce/PKCECode;Lcom/linecorp/linesdk/auth/LineAuthenticationParams;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    .locals 7
    ...
    .line 2
    invoke-virtual {p2}, Lcom/linecorp/linesdk/internal/pkce/PKCECode;->c()Ljava/lang/String;
    ...
    invoke-static {p2}, Lqc/e;->d(Ljava/util/List;)Ljava/lang/String;
    ...
    .line 8
    :cond_0
    invoke-virtual {p3}, Lcom/linecorp/linesdk/auth/LineAuthenticationParams;->a()Lcom/linecorp/linesdk/auth/LineAuthenticationParams$BotPrompt;
    ...
    .line 10
    invoke-static {p4, p2}, Lyc/f;->c(Ljava/lang/String;Ljava/util/Map;)Landroid/net/Uri;
    ...
    .line 13
    invoke-static {p4}, Lyc/f;->d([Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {p1, p2}, Lyc/f;->b(Landroid/net/Uri;Ljava/util/Map;)Landroid/net/Uri;
...
.method d(Landroid/content/Context;Landroid/net/Uri;Z)Lcom/linecorp/linesdk/auth/internal/a$a;
    ...
    .line 12
    invoke-virtual {p0, p1, p3}, Lcom/linecorp/linesdk/auth/internal/a;->h(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
    ...
    invoke-direct {p1, p3, v0, v5}, Lcom/linecorp/linesdk/auth/internal/a$a;-><init>(Landroid/content/Intent;Landroid/os/Bundle;Z)V
    ...
    invoke-direct {p2, p1, v0, v2}, Lcom/linecorp/linesdk/auth/internal/a$a;-><init>(Landroid/content/Intent;Landroid/os/Bundle;Z)V
    ...
    invoke-direct {p1, p2, v0, v2}, Lcom/linecorp/linesdk/auth/internal/a$a;-><init>(Landroid/content/Intent;Landroid/os/Bundle;Z)V
...
.method f(Landroid/content/Context;Lcom/linecorp/linesdk/auth/LineAuthenticationConfig;Lcom/linecorp/linesdk/internal/pkce/PKCECode;Lcom/linecorp/linesdk/auth/LineAuthenticationParams;)Lcom/linecorp/linesdk/auth/internal/a$b;
    .locals 8
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {v0, v6}, Lcom/linecorp/linesdk/auth/internal/LineAuthenticationStatus;->j(Ljava/lang/String;)V
    ...
    .line 9
    invoke-virtual/range {v1 .. v7}, Lcom/linecorp/linesdk/auth/internal/a;->b(Lcom/linecorp/linesdk/auth/LineAuthenticationConfig;Lcom/linecorp/linesdk/internal/pkce/PKCECode;Lcom/linecorp/linesdk/auth/LineAuthenticationParams;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
...
.method h(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
    .locals 0
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
