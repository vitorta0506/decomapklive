...
# instance fields
.field private final cache:Lcom/squareup/okhttp/internal/b;
...
.method constructor <init>(Ljava/io/File;JLcom/squareup/okhttp/internal/io/FileSystem;)V
    ...
    .line 4
    invoke-static/range {v1 .. v6}, Lcom/squareup/okhttp/internal/b;->y(Lcom/squareup/okhttp/internal/io/FileSystem;Ljava/io/File;IIJ)Lcom/squareup/okhttp/internal/b;

    move-result-object p1

    iput-object p1, p0, Lcom/squareup/okhttp/Cache;->cache:Lcom/squareup/okhttp/internal/b;

    return-void
.end method

.method private abortQuietly(Lcom/squareup/okhttp/internal/b$e;)V
    .locals 0
...
.method static synthetic access$400(Lcom/squareup/okhttp/Cache;Lqe/b;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/squareup/okhttp/Cache;->trackResponse(Lqe/b;)V

    return-void
.end method

.method static synthetic access$600(Lcom/squareup/okhttp/Cache;)Lcom/squareup/okhttp/internal/b;
    .locals 0

    iget-object p0, p0, Lcom/squareup/okhttp/Cache;->cache:Lcom/squareup/okhttp/internal/b;
...
.method private put(Lcom/squareup/okhttp/Response;)Lcom/squareup/okhttp/internal/http/CacheRequest;
    ...
    .line 5
    :cond_1
    invoke-static {p1}, Lqe/i;->g(Lcom/squareup/okhttp/Response;)Z
    ...
    .line 7
    :try_start_1
    iget-object v1, p0, Lcom/squareup/okhttp/Cache;->cache:Lcom/squareup/okhttp/internal/b;
    ...
    invoke-virtual {v1, p1}, Lcom/squareup/okhttp/internal/b;->C(Ljava/lang/String;)Lcom/squareup/okhttp/internal/b$e;
    ...
    :cond_3
    :try_start_2
    invoke-virtual {v0, p1}, Lcom/squareup/okhttp/Cache$Entry;->writeTo(Lcom/squareup/okhttp/internal/b$e;)V

    .line 9
    new-instance v0, Lcom/squareup/okhttp/Cache$CacheRequestImpl;

    invoke-direct {v0, p0, p1}, Lcom/squareup/okhttp/Cache$CacheRequestImpl;-><init>(Lcom/squareup/okhttp/Cache;Lcom/squareup/okhttp/internal/b$e;)V
    :try_end_2
    ...
    .line 10
    :catch_2
    invoke-direct {p0, p1}, Lcom/squareup/okhttp/Cache;->abortQuietly(Lcom/squareup/okhttp/internal/b$e;)V
...
.method private remove(Lcom/squareup/okhttp/Request;)V
    ...
    iget-object v0, p0, Lcom/squareup/okhttp/Cache;->cache:Lcom/squareup/okhttp/internal/b;

    invoke-static {p1}, Lcom/squareup/okhttp/Cache;->urlToKey(Lcom/squareup/okhttp/Request;)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v0, p1}, Lcom/squareup/okhttp/internal/b;->X(Ljava/lang/String;)Z
...
.method private declared-synchronized trackResponse(Lqe/b;)V
    .locals 1
    ...
    .line 2
    iget-object v0, p1, Lqe/b;->a:Lcom/squareup/okhttp/Request;
    ...
    .line 4
    :cond_0
    iget-object p1, p1, Lqe/b;->b:Lcom/squareup/okhttp/Response;
...
.method private update(Lcom/squareup/okhttp/Response;Lcom/squareup/okhttp/Response;)V
    ...
    invoke-static {p1}, Lcom/squareup/okhttp/Cache$CacheResponseBody;->access$500(Lcom/squareup/okhttp/Cache$CacheResponseBody;)Lcom/squareup/okhttp/internal/b$g;

    move-result-object p1

    .line 3
    :try_start_0
    invoke-virtual {p1}, Lcom/squareup/okhttp/internal/b$g;->c()Lcom/squareup/okhttp/internal/b$e;
    ...
    .line 5
    invoke-virtual {p1}, Lcom/squareup/okhttp/internal/b$e;->e()V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_1
...
.method private static urlToKey(Lcom/squareup/okhttp/Request;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/squareup/okhttp/internal/i;->p(Ljava/lang/String;)Ljava/lang/String;
...
.method get(Lcom/squareup/okhttp/Request;)Lcom/squareup/okhttp/Response;
    ...
    .line 2
    :try_start_0
    iget-object v2, p0, Lcom/squareup/okhttp/Cache;->cache:Lcom/squareup/okhttp/internal/b;

    invoke-virtual {v2, v0}, Lcom/squareup/okhttp/internal/b;->K(Ljava/lang/String;)Lcom/squareup/okhttp/internal/b$g;
    ...
    invoke-virtual {v0, v3}, Lcom/squareup/okhttp/internal/b$g;->d(I)Lokio/Source;
    ...
    .line 4
    invoke-virtual {v2, p1, v0}, Lcom/squareup/okhttp/Cache$Entry;->response(Lcom/squareup/okhttp/Request;Lcom/squareup/okhttp/internal/b$g;)Lcom/squareup/okhttp/Response;
    ...
    invoke-static {p1}, Lcom/squareup/okhttp/internal/i;->c(Ljava/io/Closeable;)V
...
.method public getDirectory()Ljava/io/File;
    ...
    invoke-virtual {v0}, Lcom/squareup/okhttp/internal/b;->L()Ljava/io/File;
...
.method public getMaxSize()J
    ...
    invoke-virtual {v0}, Lcom/squareup/okhttp/internal/b;->M()J
...
.method public getSize()J
    ...
    invoke-virtual {v0}, Lcom/squareup/okhttp/internal/b;->Z()J
...
.method public initialize()V
    ...
    invoke-virtual {v0}, Lcom/squareup/okhttp/internal/b;->N()V
