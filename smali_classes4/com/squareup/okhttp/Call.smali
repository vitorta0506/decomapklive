...
.method public cancel()V
    ...
    .line 2
    iget-object v0, p0, Lcom/squareup/okhttp/Call;->engine:Lqe/g;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lqe/g;->e()V
...
.method getResponse(Lcom/squareup/okhttp/Request;Z)Lcom/squareup/okhttp/Response;
    ...
    invoke-direct/range {v0 .. v8}, Lqe/g;-><init>(Lcom/squareup/okhttp/OkHttpClient;Lcom/squareup/okhttp/Request;ZZZLqe/o;Lqe/l;Lcom/squareup/okhttp/Response;)V

    iput-object p1, p0, Lcom/squareup/okhttp/Call;->engine:Lqe/g;
    ...
    .line 13
    :try_start_0
    iget-object v3, p0, Lcom/squareup/okhttp/Call;->engine:Lqe/g;

    invoke-virtual {v3}, Lqe/g;->y()V

    .line 14
    iget-object v3, p0, Lcom/squareup/okhttp/Call;->engine:Lqe/g;

    invoke-virtual {v3}, Lqe/g;->s()V
    :try_end_0
    ...
    .line 15
    iget-object v2, p0, Lcom/squareup/okhttp/Call;->engine:Lqe/g;

    invoke-virtual {v2}, Lqe/g;->m()Lcom/squareup/okhttp/Response;
    ...
    invoke-virtual {v2}, Lqe/g;->j()Lcom/squareup/okhttp/Request;
    ...
    .line 17
    iget-object p1, p0, Lcom/squareup/okhttp/Call;->engine:Lqe/g;

    invoke-virtual {p1}, Lqe/g;->w()V
    ...
    invoke-virtual {v2}, Lqe/g;->f()Lqe/o;
    ...
    invoke-virtual {v3, v4}, Lqe/g;->x(Lcom/squareup/okhttp/HttpUrl;)Z
    ...
    invoke-direct/range {v3 .. v11}, Lqe/g;-><init>(Lcom/squareup/okhttp/OkHttpClient;Lcom/squareup/okhttp/Request;ZZZLqe/o;Lqe/l;Lcom/squareup/okhttp/Response;)V

    iput-object v1, p0, Lcom/squareup/okhttp/Call;->engine:Lqe/g;
    ...
    .line 24
    :try_start_1
    iget-object v4, p0, Lcom/squareup/okhttp/Call;->engine:Lqe/g;

    invoke-virtual {v4, v3, v1}, Lqe/g;->v(Ljava/io/IOException;Lokio/Sink;)Lqe/g;
    ...
    invoke-virtual {v3, v1}, Lqe/g;->u(Lcom/squareup/okhttp/internal/http/RouteException;)Lqe/g;
    ...
    .line 28
    :try_start_4
    iput-object v3, p0, Lcom/squareup/okhttp/Call;->engine:Lqe/g;
    :try_end_4
    ...
    .line 31
    iget-object p2, p0, Lcom/squareup/okhttp/Call;->engine:Lqe/g;

    invoke-virtual {p2}, Lqe/g;->f()Lqe/o;

    move-result-object p2

    .line 32
    invoke-virtual {p2}, Lqe/o;->o()V
