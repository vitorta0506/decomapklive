...
.method constructor <init>(Lokio/BufferedSource;IZ)V
    ...
    .line 2
    iput-object p1, p0, Lcom/squareup/okhttp/internal/framed/e$c;->a:Lokio/BufferedSource;
    ...
    invoke-direct {p3, p1}, Lcom/squareup/okhttp/internal/framed/e$a;-><init>(Lokio/BufferedSource;)V
    ...
    invoke-direct {p1, p2, p3}, Lcom/squareup/okhttp/internal/framed/d$a;-><init>(ILokio/Source;)V
...
.method private a(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V
    .locals 4
    ...
    .line 1
    iget-object v1, p0, Lcom/squareup/okhttp/internal/framed/e$c;->a:Lokio/BufferedSource;
    ...
    .line 2
    :cond_2
    invoke-static {p2, p3, v2}, Lcom/squareup/okhttp/internal/framed/e;->e(IBS)I

    move-result p2

    .line 3
    iget-object p3, p0, Lcom/squareup/okhttp/internal/framed/e$c;->a:Lokio/BufferedSource;

    invoke-interface {p1, v0, p4, p3, p2}, Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;->data(ZILokio/BufferedSource;I)V

    .line 4
    iget-object p1, p0, Lcom/squareup/okhttp/internal/framed/e$c;->a:Lokio/BufferedSource;
...
.method private b(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V
    ...
    .line 1
    iget-object p4, p0, Lcom/squareup/okhttp/internal/framed/e$c;->a:Lokio/BufferedSource;
    ...
    .line 2
    iget-object v2, p0, Lcom/squareup/okhttp/internal/framed/e$c;->a:Lokio/BufferedSource;
...
.method private c(ISBI)Ljava/util/List;
    ...
    iput p1, v0, Lcom/squareup/okhttp/internal/framed/e$a;->e:I

    iput p1, v0, Lcom/squareup/okhttp/internal/framed/e$a;->b:I

    .line 2
    iput-short p2, v0, Lcom/squareup/okhttp/internal/framed/e$a;->f:S
...
.method private d(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V
    ...
    .line 1
    iget-object v0, p0, Lcom/squareup/okhttp/internal/framed/e$c;->a:Lokio/BufferedSource;
    ...
    .line 2
    invoke-direct {p0, p1, p4}, Lcom/squareup/okhttp/internal/framed/e$c;->h(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;I)V
    ...
    .line 4
    invoke-direct {p0, p2, v0, p3, p4}, Lcom/squareup/okhttp/internal/framed/e$c;->c(ISBI)Ljava/util/List;
...
.method private e(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V
    ...
    .line 1
    iget-object p2, p0, Lcom/squareup/okhttp/internal/framed/e$c;->a:Lokio/BufferedSource;
...
.method private h(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;I)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 2
    iget-object v3, p0, Lcom/squareup/okhttp/internal/framed/e$c;->a:Lokio/BufferedSource;
...
.method private k(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method private o(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V
    ...
    .line 4
    new-instance p3, Lcom/squareup/okhttp/internal/framed/i;

    invoke-direct {p3}, Lcom/squareup/okhttp/internal/framed/i;-><init>()V
    ...
    :goto_1
    :pswitch_4
    invoke-virtual {p3, v2, v0, v3}, Lcom/squareup/okhttp/internal/framed/i;->l(III)Lcom/squareup/okhttp/internal/framed/i;
    ...
    .line 12
    :cond_6
    invoke-interface {p1, v0, p3}, Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;->settings(ZLcom/squareup/okhttp/internal/framed/i;)V

    .line 13
    invoke-virtual {p3}, Lcom/squareup/okhttp/internal/framed/i;->d()I
...
.method public nextFrame(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;)Z
    ...
    invoke-static {v1}, Lcom/squareup/okhttp/internal/framed/e;->d(Lokio/BufferedSource;)I
    ...
    .line 5
    iget-object v4, p0, Lcom/squareup/okhttp/internal/framed/e$c;->a:Lokio/BufferedSource;
    ...
    invoke-static {v2, v4, v1, v0, v3}, Lcom/squareup/okhttp/internal/framed/e$b;->b(ZIIBB)Ljava/lang/String;
    ...
    .line 8
    :pswitch_0
    invoke-direct {p0, p1, v1, v3, v4}, Lcom/squareup/okhttp/internal/framed/e$c;->p(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V

    goto :goto_0

    .line 9
    :pswitch_1
    invoke-direct {p0, p1, v1, v3, v4}, Lcom/squareup/okhttp/internal/framed/e$c;->b(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V

    goto :goto_0

    .line 10
    :pswitch_2
    invoke-direct {p0, p1, v1, v3, v4}, Lcom/squareup/okhttp/internal/framed/e$c;->e(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V

    goto :goto_0

    .line 11
    :pswitch_3
    invoke-direct {p0, p1, v1, v3, v4}, Lcom/squareup/okhttp/internal/framed/e$c;->j(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V

    goto :goto_0

    .line 12
    :pswitch_4
    invoke-direct {p0, p1, v1, v3, v4}, Lcom/squareup/okhttp/internal/framed/e$c;->o(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V

    goto :goto_0

    .line 13
    :pswitch_5
    invoke-direct {p0, p1, v1, v3, v4}, Lcom/squareup/okhttp/internal/framed/e$c;->k(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V

    goto :goto_0

    .line 14
    :pswitch_6
    invoke-direct {p0, p1, v1, v3, v4}, Lcom/squareup/okhttp/internal/framed/e$c;->i(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V

    goto :goto_0

    .line 15
    :pswitch_7
    invoke-direct {p0, p1, v1, v3, v4}, Lcom/squareup/okhttp/internal/framed/e$c;->d(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V

    goto :goto_0

    .line 16
    :pswitch_8
    invoke-direct {p0, p1, v1, v3, v4}, Lcom/squareup/okhttp/internal/framed/e$c;->a(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V
    ...
    invoke-static {v0, p1}, Lcom/squareup/okhttp/internal/framed/e;->c(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
...
.method public readConnectionPreface()V
    ...
    .line 1
    iget-boolean v0, p0, Lcom/squareup/okhttp/internal/framed/e$c;->c:Z
    ...
    invoke-static {}, Lcom/squareup/okhttp/internal/framed/e;->a()Lokio/ByteString;
