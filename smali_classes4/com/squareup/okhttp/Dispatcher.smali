...
.method public declared-synchronized cancel(Ljava/lang/Object;)V
    ...
    invoke-static {p1, v2}, Lcom/squareup/okhttp/internal/i;->h(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-object v1, v1, Lcom/squareup/okhttp/Call;->engine:Lqe/g;

    if-eqz v1, :cond_2

    .line 8
    invoke-virtual {v1}, Lqe/g;->e()V
...
.method public declared-synchronized getExecutorService()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-static {v1, v8}, Lcom/squareup/okhttp/internal/i;->s(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
