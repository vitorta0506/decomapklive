...
.method private errorReason(Lcom/huawei/hms/api/ConnectionResult;)Ljava/lang/String;
    ...
    :pswitch_0
    const-string/jumbo p1, "there is already an update popup at the front desk, but it hasn\'t been clicked or it is not effective for a while"

    goto :goto_1

    :pswitch_1
    const-string/jumbo p1, "update failed, because no activity incoming, can\'t pop update page"
    ...
    :cond_1
    const-string/jumbo p1, "update cancelled"
    ...
    :goto_0
    const-string/jumbo p1, "unknown errorReason"
...
.method private innerConnectionFailed(Lcom/huawei/hms/api/ConnectionResult;)V
    ...
    invoke-virtual {v3}, Lcom/huawei/hms/common/internal/TaskApiCallWrapper;->getTaskCompletionSource()Lwb/g;

    move-result-object v3

    invoke-virtual {v6, v7, v5, v4, v3}, Lcom/huawei/hms/common/internal/TaskApiCall;->onResponse(Lcom/huawei/hms/common/internal/AnyClient;Lcom/huawei/hms/common/internal/ResponseErrorCode;Ljava/lang/String;Lwb/g;)V
...
.method private sendConnectionSuspended(Lcom/huawei/hms/common/HuaweiApi$TaskApiCallbackWrapper;)V
    ...
    invoke-virtual {p1}, Lcom/huawei/hms/common/internal/TaskApiCallWrapper;->getTaskCompletionSource()Lwb/g;

    move-result-object p1

    const/4 v3, 0x0

    invoke-virtual {v1, v2, v0, v3, p1}, Lcom/huawei/hms/common/internal/TaskApiCall;->onResponse(Lcom/huawei/hms/common/internal/AnyClient;Lcom/huawei/hms/common/internal/ResponseErrorCode;Ljava/lang/String;Lwb/g;)V
