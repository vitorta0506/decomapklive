...
.method public constructor <init>(JLcom/squareup/okhttp/Request;Lcom/squareup/okhttp/Response;)V
    ...
    .line 2
    iput v0, p0, Lqe/b$b;->l:I

    .line 3
    iput-wide p1, p0, Lqe/b$b;->a:J

    .line 4
    iput-object p3, p0, Lqe/b$b;->b:Lcom/squareup/okhttp/Request;

    .line 5
    iput-object p4, p0, Lqe/b$b;->c:Lcom/squareup/okhttp/Response;
    ...
    .line 11
    invoke-static {v1}, Lqe/f;->b(Ljava/lang/String;)Ljava/util/Date;

    move-result-object p4

    iput-object p4, p0, Lqe/b$b;->d:Ljava/util/Date;

    .line 12
    iput-object v1, p0, Lqe/b$b;->e:Ljava/lang/String;
    ...
    iput-object p4, p0, Lqe/b$b;->f:Ljava/util/Date;

    .line 17
    iput-object v1, p0, Lqe/b$b;->g:Ljava/lang/String;
    ...
    .line 19
    iput-object v1, p0, Lqe/b$b;->k:Ljava/lang/String;
    ...
    .line 21
    invoke-static {v1, v0}, Lqe/c;->a(Ljava/lang/String;I)I
    ...
    .line 22
    :cond_4
    sget-object v2, Lqe/i;->c:Ljava/lang/String;
    ...
    iput-wide v1, p0, Lqe/b$b;->i:J

    goto :goto_1

    .line 24
    :cond_5
    sget-object v2, Lqe/i;->d:Ljava/lang/String;
...
.method private b()J
    ...
    .line 1
    iget-object v0, p0, Lqe/b$b;->c:Lcom/squareup/okhttp/Response;
...
.method private d()Lqe/b;
    ...
    iget-object v2, p0, Lqe/b$b;->b:Lcom/squareup/okhttp/Request;

    invoke-direct {v0, v2, v1, v1}, Lqe/b;-><init>(Lcom/squareup/okhttp/Request;Lcom/squareup/okhttp/Response;Lqe/b$a;)V

    return-object v0

    .line 3
    :cond_0
    iget-object v0, p0, Lqe/b$b;->b:Lcom/squareup/okhttp/Request;
    ...
    invoke-static {v0, v2}, Lqe/b;->a(Lcom/squareup/okhttp/Response;Lcom/squareup/okhttp/Request;)Z
    ...
    invoke-static {v2}, Lqe/b$b;->e(Lcom/squareup/okhttp/Request;)Z
    ...
    .line 15
    :goto_0
    iget-object v6, p0, Lqe/b$b;->c:Lcom/squareup/okhttp/Response;
    ...
    invoke-direct {v2, v1, v0, v1}, Lqe/b;-><init>(Lcom/squareup/okhttp/Request;Lcom/squareup/okhttp/Response;Lqe/b$a;)V
    ...
    .line 25
    iget-object v2, p0, Lqe/b$b;->k:Ljava/lang/String;
    ...
    .line 27
    :cond_a
    iget-object v2, p0, Lqe/b$b;->f:Ljava/util/Date;
    ...
    .line 28
    iget-object v2, p0, Lqe/b$b;->g:Ljava/lang/String;
    ...
    .line 29
    :cond_b
    iget-object v2, p0, Lqe/b$b;->d:Ljava/util/Date;

    if-eqz v2, :cond_c

    .line 30
    iget-object v2, p0, Lqe/b$b;->e:Ljava/lang/String;
    ...
    .line 32
    invoke-static {v0}, Lqe/b$b;->e(Lcom/squareup/okhttp/Request;)Z
    ...
    iget-object v3, p0, Lqe/b$b;->c:Lcom/squareup/okhttp/Response;

    invoke-direct {v2, v0, v3, v1}, Lqe/b;-><init>(Lcom/squareup/okhttp/Request;Lcom/squareup/okhttp/Response;Lqe/b$a;)V
    ...
    invoke-direct {v2, v0, v1, v1}, Lqe/b;-><init>(Lcom/squareup/okhttp/Request;Lcom/squareup/okhttp/Response;Lqe/b$a;)V
...
# virtual methods
.method public c()Lqe/b;
    .locals 2

    .line 1
    invoke-direct {p0}, Lqe/b$b;->d()Lqe/b;

    move-result-object v0

    .line 2
    iget-object v1, v0, Lqe/b;->a:Lcom/squareup/okhttp/Request;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lqe/b$b;->b:Lcom/squareup/okhttp/Request;
    ...
    invoke-direct {v0, v1, v1, v1}, Lqe/b;-><init>(Lcom/squareup/okhttp/Request;Lcom/squareup/okhttp/Response;Lqe/b$a;)V
