...
public class ReLinkerInstance {
    ...
    protected void cleanupOldLibFiles(Context context, String str, String str2) {
        ...
        File[] listFiles = workaroundLibDir.listFiles(new FilenameFilter() { // from class: org.extra.relinker.ReLinkerInstance.2
        ...
        if (context != null) {
            if (!TextUtils.isEmpty(str)) {
                ...
                if (loadListener == null) {
                    ...
                    new Thread(new Runnable() { // from class: org.extra.relinker.ReLinkerInstance.1
