...
public final class OpenSSLProvider extends Provider {
    ...
    private void putECDHKeyAgreementImplClass(String str) {
        ...
        putImplClassWithKeyConstraints("KeyAgreement.ECDH", str2 + str, sb3, "PKCS#8");
    }
    ...
    private void putRAWRSASignatureImplClass(String str) {
        ...
        String sb3 = sb2.toString();
        putImplClassWithKeyConstraints("Signature.NONEwithRSA", str2 + str, sb3, null);
    }
    ...
    public OpenSSLProvider(String str) {
        this(str, a0.r(), "TLSv1.3");
    }

    OpenSSLProvider(String str, boolean z10, String str2) {
        ...
        if (z10) {
            put("TrustManagerFactory.PKIX", c0.class.getName());
        ...
        put("Alg.Alias.KeyPairGenerator.1.2.840.113549.1.1.1", RSAUtils.RSA);
        put("Alg.Alias.KeyPairGenerator.1.2.840.113549.1.1.7", RSAUtils.RSA);
        put("Alg.Alias.KeyPairGenerator.2.5.8.1.1", RSAUtils.RSA);
        ...
        put("Alg.Alias.KeyFactory.1.2.840.113549.1.1.1", RSAUtils.RSA);
        put("Alg.Alias.KeyFactory.1.2.840.113549.1.1.7", RSAUtils.RSA);
        put("Alg.Alias.KeyFactory.2.5.8.1.1", RSAUtils.RSA);
        ...
        putSymmetricCipherImplClass(LicenceCheck.AES_DECODE_ALGORITHM, "OpenSSLEvpCipherAES$AES$CBC$PKCS5Padding");
        put("Alg.Alias.Cipher.AES/CBC/PKCS7Padding", LicenceCheck.AES_DECODE_ALGORITHM);
