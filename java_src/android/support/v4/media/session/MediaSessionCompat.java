...
public class MediaSessionCompat {
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            void postToHandler(int i9, int i10) {
                MediaSessionImplBase.this.postToHandler(i9, i10, 0, null, null);
            }

            void postToHandler(int i9, Object obj) {
                MediaSessionImplBase.this.postToHandler(i9, 0, 0, obj, null);
            }

            void postToHandler(int i9, Object obj, int i10) {
        ...
        private void sendRepeatMode(int i9) {
            for (int beginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                try {
                    this.mControllerCallbacks.getBroadcastItem(beginBroadcast).onRepeatModeChanged(i9);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        private void sendShuffleMode(int i9) {
            for (int beginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                try {
                    this.mControllerCallbacks.getBroadcastItem(beginBroadcast).onShuffleModeChanged(i9);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        void adjustVolume(int i9, int i10) {
            if (this.mVolumeType == 2) {
                ...
                if (volumeProviderCompat != null) {
                    volumeProviderCompat.onAdjustVolume(i9);
                    return;
                }
                return;
            }
        ...
        String getPackageNameForUid(int i9) {
        ...
        int getRccStateFromState(int i9) {
            switch (i9) {
                case 0:
                    return 0;
                case 1:
        ...
        void postToHandler(int i9, int i10, int i11, Object obj, Bundle bundle) {
            synchronized (this.mLock) {
                MessageHandler messageHandler = this.mHandler;
                if (messageHandler != null) {
                    Message obtainMessage = messageHandler.obtainMessage(i9, i10, i11, obj);
                    Bundle bundle2 = new Bundle();
        ...
        */
        ...
        void setVolumeTo(int i9, int i10) {
            if (this.mVolumeType == 2) {
                VolumeProviderCompat volumeProviderCompat = this.mVolumeProvider;
                if (volumeProviderCompat != null) {
                    volumeProviderCompat.onSetVolumeTo(i9);
                    return;
                }
                return;
            }
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setFlags(int i9) {
            this.mSessionFwk.setFlags(i9 | 1 | 2);
        }
        ...
        public void setRepeatMode(int i9) {
            if (this.mRepeatMode != i9) {
                ...
                for (int beginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                    try {
                        this.mExtraControllerCallbacks.getBroadcastItem(beginBroadcast).onRepeatModeChanged(i9);
                    } catch (RemoteException unused) {
                    }
                }
                this.mExtraControllerCallbacks.finishBroadcast();
        ...
        public void setShuffleMode(int i9) {
            if (this.mShuffleMode != i9) {
                ...
                for (int beginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                    try {
                        this.mExtraControllerCallbacks.getBroadcastItem(beginBroadcast).onShuffleModeChanged(i9);
                    } catch (RemoteException unused) {
                    }
                }
                this.mExtraControllerCallbacks.finishBroadcast();
