...
public interface ICustomTabsCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICustomTabsCallback {
        ...
        private static class Proxy implements ICustomTabsCallback {
            ...
            @Override // android.support.customtabs.ICustomTabsCallback
            public void onRelationshipValidationResult(int i9, Uri uri, boolean z10, Bundle bundle) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
    ...
    void onRelationshipValidationResult(int i9, Uri uri, boolean z10, Bundle bundle) throws RemoteException;
}
