...
public final class Metadata extends GeneratedMessageV3 implements f {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements f {
        ...
        private List<MetadataEntry> f42009f;

        /* renamed from: g  reason: collision with root package name */
        private l2<MetadataEntry, MetadataEntry.b, e> f42010g;
        ...
        private void a0() {
            if ((this.f42008e & 1) == 0) {
                this.f42009f = new ArrayList(this.f42009f);
                this.f42008e |= 1;
            }
        }

        private l2<MetadataEntry, MetadataEntry.b, e> d0() {
            if (this.f42010g == null) {
                this.f42010g = new l2<>(this.f42009f, (this.f42008e & 1) != 0, H(), O());
                this.f42009f = null;
            }
            return this.f42010g;
        }
        ...
        protected GeneratedMessageV3.e K() {
            return io.grpc.binarylog.v1.b.f42031l.d(Metadata.class, b.class);
        }
        ...
        public Metadata I() {
            ...
            int i9 = this.f42008e;
            l2<MetadataEntry, MetadataEntry.b, e> l2Var = this.f42010g;
            if (l2Var == null) {
                if ((i9 & 1) != 0) {
                    this.f42009f = Collections.unmodifiableList(this.f42009f);
                    this.f42008e &= -2;
                }
                metadata.entry_ = this.f42009f;
            } else {
                metadata.entry_ = l2Var.e();
            }
            Q();
            return metadata;
        }
        ...
        */
        public io.grpc.binarylog.v1.Metadata.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.binarylog.v1.Metadata.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.binarylog.v1.Metadata.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.binarylog.v1.Metadata$b");
        }

        @Override // com.google.protobuf.GeneratedMessageV3.b, com.google.protobuf.l1.a, com.google.protobuf.r1
        public Descriptors.b getDescriptorForType() {
            return io.grpc.binarylog.v1.b.f42030k;
        }
        ...
        public b i0(Metadata metadata) {
            ...
            if (this.f42010g == null) {
                if (!metadata.entry_.isEmpty()) {
                    if (this.f42009f.isEmpty()) {
                        this.f42009f = metadata.entry_;
                        this.f42008e &= -2;
                    } else {
                        a0();
                        this.f42009f.addAll(metadata.entry_);
                    }
                    R();
                }
                ...
                if (this.f42010g.k()) {
                    ...
                    this.f42009f = metadata.entry_;
                    this.f42008e &= -2;
                    this.f42010g = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                } else {
                    this.f42010g.b(metadata.entry_);
                }
            }
        ...
        private b() {
            this.f42009f = Collections.emptyList();
            e0();
        }
    ...
    public MetadataEntry getEntry(int i9) {
    ...
    public e getEntryOrBuilder(int i9) {
        return this.entry_.get(i9);
    }

    public List<? extends e> getEntryOrBuilderList() {
        return this.entry_;
    }
    ...
    public int getSerializedSize() {
        ...
        for (int i11 = 0; i11 < this.entry_.size(); i11++) {
            i10 += CodedOutputStream.G(1, this.entry_.get(i11));
        }
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        for (int i9 = 0; i9 < this.entry_.size(); i9++) {
            codedOutputStream.L0(1, this.entry_.get(i9));
        }
                ...
                try {
                    ...
                    if (L != 0) {
                        if (L != 10) {
                            ...
                            this.entry_.add((MetadataEntry) pVar.B(MetadataEntry.parser(), f0Var));
                        }
                    }
                    z10 = true;
