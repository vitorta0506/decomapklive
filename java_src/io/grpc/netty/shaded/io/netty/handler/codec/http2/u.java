...
final class u {
    ...
    public static int a(CharSequence charSequence, CharSequence charSequence2) {
        if ((charSequence instanceof io.grpc.netty.shaded.io.netty.util.c) && (charSequence2 instanceof io.grpc.netty.shaded.io.netty.util.c)) {
            ...
            return io.grpc.netty.shaded.io.netty.util.internal.t.x(cVar.a(), cVar.b(), cVar2.a(), cVar2.b(), charSequence.length());
        }
        return io.grpc.netty.shaded.io.netty.util.internal.f.c(charSequence, charSequence2);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean b(CharSequence charSequence, CharSequence charSequence2) {
        return io.grpc.netty.shaded.io.netty.util.c.j(charSequence, charSequence2);
    }
}
