...
public final class ZipkinConfig extends GeneratedMessageV3 implements r1 {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        private Object f49634f;

        /* renamed from: g  reason: collision with root package name */
        private boolean f49635g;

        /* renamed from: h  reason: collision with root package name */
        private BoolValue f49636h;

        /* renamed from: i  reason: collision with root package name */
        private q2<BoolValue, BoolValue.b, l> f49637i;

        /* renamed from: j  reason: collision with root package name */
        private int f49638j;

        /* renamed from: k  reason: collision with root package name */
        private Object f49639k;
        ...
        protected GeneratedMessageV3.e K() {
            return h.f49661b.d(ZipkinConfig.class, b.class);
        }
        ...
        public ZipkinConfig I() {
            ...
            zipkinConfig.collectorCluster_ = this.f49633e;
            zipkinConfig.collectorEndpoint_ = this.f49634f;
            zipkinConfig.traceId128Bit_ = this.f49635g;
            q2<BoolValue, BoolValue.b, l> q2Var = this.f49637i;
            if (q2Var == null) {
                zipkinConfig.sharedSpanContext_ = this.f49636h;
            } else {
                zipkinConfig.sharedSpanContext_ = q2Var.b();
            }
            zipkinConfig.collectorEndpointVersion_ = this.f49638j;
            zipkinConfig.collectorHostname_ = this.f49639k;
            Q();
            return zipkinConfig;
        }
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v3.ZipkinConfig.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v3.ZipkinConfig.access$1100()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v3.ZipkinConfig r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v3.ZipkinConfig) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.g0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v3.ZipkinConfig r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v3.ZipkinConfig) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v3.ZipkinConfig.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v3.ZipkinConfig$b");
        }
        ...
        public b g0(ZipkinConfig zipkinConfig) {
            ...
            if (!zipkinConfig.getCollectorCluster().isEmpty()) {
                this.f49633e = zipkinConfig.collectorCluster_;
                R();
            }
            if (!zipkinConfig.getCollectorEndpoint().isEmpty()) {
                this.f49634f = zipkinConfig.collectorEndpoint_;
                R();
            }
            ...
            if (!zipkinConfig.getCollectorHostname().isEmpty()) {
                this.f49639k = zipkinConfig.collectorHostname_;
                R();
            }
        ...
        public b h0(BoolValue boolValue) {
            q2<BoolValue, BoolValue.b, l> q2Var = this.f49637i;
            if (q2Var == null) {
                BoolValue boolValue2 = this.f49636h;
                if (boolValue2 != null) {
                    this.f49636h = BoolValue.newBuilder(boolValue2).d0(boolValue).I();
                } else {
                    this.f49636h = boolValue;
                }
                R();
            } else {
                q2Var.e(boolValue);
    ...
    public int getSerializedSize() {
        ...
        if (!GeneratedMessageV3.isStringEmpty(this.collectorHostname_)) {
            computeStringSize += GeneratedMessageV3.computeStringSize(6, this.collectorHostname_);
        }
    ...
    public int hashCode() {
        ...
        int hashCode2 = (((((((((hashCode * 37) + 5) * 53) + this.collectorEndpointVersion_) * 37) + 6) * 53) + getCollectorHostname().hashCode()) * 29) + this.unknownFields.hashCode();
                ...
                try {
                    ...
                    if (L != 0) {
                        if (L == 10) {
                            ...
                            this.collectorHostname_ = pVar.K();
                        }
                    }
                    z10 = true;
