...
public final class ResponseFlagFilter extends GeneratedMessageV3 implements m {
    ...
    public class a extends com.google.protobuf.c<ResponseFlagFilter> {
        ...
        /* renamed from: G */
        public ResponseFlagFilter m(com.google.protobuf.p pVar, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements m {
        ...
        private void a0() {
            if ((this.f47382e & 1) == 0) {
                this.f47383f = new y0(this.f47383f);
                this.f47382e |= 1;
            }
        }
        ...
        protected GeneratedMessageV3.e K() {
            return c.f47413x.d(ResponseFlagFilter.class, b.class);
        }
        ...
        public ResponseFlagFilter I() {
            ...
            if ((this.f47382e & 1) != 0) {
                this.f47383f = this.f47383f.V0();
                this.f47382e &= -2;
            }
            responseFlagFilter.flags_ = this.f47383f;
            Q();
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.accesslog.v3.ResponseFlagFilter.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.accesslog.v3.ResponseFlagFilter.access$600()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.accesslog.v3.ResponseFlagFilter r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.accesslog.v3.ResponseFlagFilter) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.h0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.accesslog.v3.ResponseFlagFilter r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.accesslog.v3.ResponseFlagFilter) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.accesslog.v3.ResponseFlagFilter.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.accesslog.v3.ResponseFlagFilter$b");
        }
        ...
        public b h0(ResponseFlagFilter responseFlagFilter) {
            ...
            if (!responseFlagFilter.flags_.isEmpty()) {
                if (this.f47383f.isEmpty()) {
                    this.f47383f = responseFlagFilter.flags_;
                    this.f47382e &= -2;
                } else {
                    a0();
                    this.f47383f.addAll(responseFlagFilter.flags_);
                }
                R();
            }
    ...
    /* synthetic */ ResponseFlagFilter(com.google.protobuf.p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return m1607getFlagsList().equals(responseFlagFilter.m1607getFlagsList()) && this.unknownFields.equals(responseFlagFilter.unknownFields);
    }
    ...
    public int getSerializedSize() {
        ...
        int size = 0 + i10 + (m1607getFlagsList().size() * 1) + this.unknownFields.getSerializedSize();
    ...
    public int hashCode() {
        ...
        if (getFlagsCount() > 0) {
            hashCode = (((hashCode * 37) + 1) * 53) + m1607getFlagsList().hashCode();
        }
    ...
    private ResponseFlagFilter(com.google.protobuf.p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
    ...
    public static ResponseFlagFilter parseFrom(com.google.protobuf.p pVar) throws IOException {
        return (ResponseFlagFilter) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
    }

    public static ResponseFlagFilter parseFrom(com.google.protobuf.p pVar, f0 f0Var) throws IOException {
