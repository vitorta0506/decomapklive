...
public final class HeaderFilter extends GeneratedMessageV3 implements i {
    ...
    public class a extends com.google.protobuf.c<HeaderFilter> {
        ...
        /* renamed from: G */
        public HeaderFilter m(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements i {
        ...
        private HeaderMatcher f48486e;

        /* renamed from: f  reason: collision with root package name */
        private q2<HeaderMatcher, HeaderMatcher.c, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.e> f48487f;
        ...
        protected GeneratedMessageV3.e K() {
            return c.f48520v.d(HeaderFilter.class, b.class);
        }
        ...
        public HeaderFilter I() {
            ...
            q2<HeaderMatcher, HeaderMatcher.c, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.e> q2Var = this.f48487f;
            if (q2Var == null) {
                headerFilter.header_ = this.f48486e;
            } else {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.HeaderFilter.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.HeaderFilter.access$600()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.HeaderFilter.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.HeaderFilter$b");
        }
        ...
        public b h0(HeaderMatcher headerMatcher) {
            q2<HeaderMatcher, HeaderMatcher.c, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.e> q2Var = this.f48487f;
            if (q2Var == null) {
                HeaderMatcher headerMatcher2 = this.f48486e;
                if (headerMatcher2 != null) {
                    this.f48486e = HeaderMatcher.newBuilder(headerMatcher2).g0(headerMatcher).I();
                } else {
                    this.f48486e = headerMatcher;
                }
                R();
            } else {
    ...
    /* synthetic */ HeaderFilter(p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
    ...
    private HeaderFilter(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
    ...
    public static HeaderFilter parseFrom(p pVar) throws IOException {
        return (HeaderFilter) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
    }

    public static HeaderFilter parseFrom(p pVar, f0 f0Var) throws IOException {
