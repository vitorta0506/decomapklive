...
public final class Rds extends GeneratedMessageV3 implements c {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements c {
        ...
        private ConfigSource f48656e;

        /* renamed from: f  reason: collision with root package name */
        private q2<ConfigSource, ConfigSource.c, k> f48657f;

        /* renamed from: g  reason: collision with root package name */
        private Object f48658g;
        ...
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.a.f48702l.d(Rds.class, b.class);
        }
        ...
        public Rds I() {
            ...
            q2<ConfigSource, ConfigSource.c, k> q2Var = this.f48657f;
            if (q2Var == null) {
                rds.configSource_ = this.f48656e;
            } else {
                rds.configSource_ = q2Var.b();
            }
            rds.routeConfigName_ = this.f48658g;
            Q();
            return rds;
        }
        ...
        public b d0(ConfigSource configSource) {
            q2<ConfigSource, ConfigSource.c, k> q2Var = this.f48657f;
            if (q2Var == null) {
                ConfigSource configSource2 = this.f48656e;
                if (configSource2 != null) {
                    this.f48656e = ConfigSource.newBuilder(configSource2).i0(configSource).I();
                } else {
                    this.f48656e = configSource;
                }
                R();
            } else {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.Rds.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.Rds.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.Rds.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.Rds$b");
        }
        ...
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.a.f48701k;
        }
        ...
        public b h0(Rds rds) {
            ...
            if (!rds.getRouteConfigName().isEmpty()) {
                this.f48658g = rds.routeConfigName_;
                R();
            }
