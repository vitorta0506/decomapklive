...
public final class HTTPFault extends GeneratedMessageV3 implements r1 {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        private FaultDelay f49701f;

        /* renamed from: g  reason: collision with root package name */
        private q2<FaultDelay, FaultDelay.c, io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.a> f49702g;

        /* renamed from: h  reason: collision with root package name */
        private FaultAbort f49703h;

        /* renamed from: i  reason: collision with root package name */
        private q2<FaultAbort, FaultAbort.c, io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.http.fault.v3.a> f49704i;

        /* renamed from: j  reason: collision with root package name */
        private Object f49705j;

        /* renamed from: k  reason: collision with root package name */
        private List<HeaderMatcher> f49706k;

        /* renamed from: l  reason: collision with root package name */
        private l2<HeaderMatcher, HeaderMatcher.c, f> f49707l;

        /* renamed from: m  reason: collision with root package name */
        private z0 f49708m;

        /* renamed from: n  reason: collision with root package name */
        private UInt32Value f49709n;

        /* renamed from: o  reason: collision with root package name */
        private q2<UInt32Value, UInt32Value.b, e3> f49710o;

        /* renamed from: p  reason: collision with root package name */
        private FaultRateLimit f49711p;

        /* renamed from: q  reason: collision with root package name */
        private q2<FaultRateLimit, FaultRateLimit.c, io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.c> f49712q;

        /* renamed from: r  reason: collision with root package name */
        private Object f49713r;

        /* renamed from: s  reason: collision with root package name */
        private Object f49714s;

        /* renamed from: t  reason: collision with root package name */
        private Object f49715t;

        /* renamed from: u  reason: collision with root package name */
        private Object f49716u;

        /* renamed from: v  reason: collision with root package name */
        private Object f49717v;

        /* renamed from: w  reason: collision with root package name */
        private Object f49718w;

        /* renamed from: x  reason: collision with root package name */
        private Object f49719x;

        /* renamed from: y  reason: collision with root package name */
        private boolean f49720y;
        ...
        private void a0() {
            if ((this.f49700e & 2) == 0) {
                this.f49708m = new y0(this.f49708m);
                this.f49700e |= 2;
            }
        }
        ...
        private void b0() {
            if ((this.f49700e & 1) == 0) {
                this.f49706k = new ArrayList(this.f49706k);
                this.f49700e |= 1;
            }
        }

        private l2<HeaderMatcher, HeaderMatcher.c, f> e0() {
            if (this.f49707l == null) {
                this.f49707l = new l2<>(this.f49706k, (this.f49700e & 1) != 0, H(), O());
                this.f49706k = null;
            }
            return this.f49707l;
        }
        ...
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.http.fault.v3.b.f49726f.d(HTTPFault.class, b.class);
        }
        ...
        public HTTPFault I() {
            ...
            q2<FaultDelay, FaultDelay.c, io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.a> q2Var = this.f49702g;
            if (q2Var == null) {
                hTTPFault.delay_ = this.f49701f;
            } else {
                hTTPFault.delay_ = q2Var.b();
            }
            q2<FaultAbort, FaultAbort.c, io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.http.fault.v3.a> q2Var2 = this.f49704i;
            if (q2Var2 == null) {
                hTTPFault.abort_ = this.f49703h;
            } else {
                hTTPFault.abort_ = q2Var2.b();
            }
            hTTPFault.upstreamCluster_ = this.f49705j;
            l2<HeaderMatcher, HeaderMatcher.c, f> l2Var = this.f49707l;
            if (l2Var == null) {
                if ((this.f49700e & 1) != 0) {
                    this.f49706k = Collections.unmodifiableList(this.f49706k);
                    this.f49700e &= -2;
                }
                hTTPFault.headers_ = this.f49706k;
            } else {
                hTTPFault.headers_ = l2Var.e();
            }
            if ((this.f49700e & 2) != 0) {
                this.f49708m = this.f49708m.V0();
                this.f49700e &= -3;
            }
            hTTPFault.downstreamNodes_ = this.f49708m;
            q2<UInt32Value, UInt32Value.b, e3> q2Var3 = this.f49710o;
            if (q2Var3 == null) {
                hTTPFault.maxActiveFaults_ = this.f49709n;
            } else {
                hTTPFault.maxActiveFaults_ = q2Var3.b();
            }
            q2<FaultRateLimit, FaultRateLimit.c, io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.c> q2Var4 = this.f49712q;
            if (q2Var4 == null) {
                hTTPFault.responseRateLimit_ = this.f49711p;
            } else {
                hTTPFault.responseRateLimit_ = q2Var4.b();
            }
            hTTPFault.delayPercentRuntime_ = this.f49713r;
            hTTPFault.abortPercentRuntime_ = this.f49714s;
            hTTPFault.delayDurationRuntime_ = this.f49715t;
            hTTPFault.abortHttpStatusRuntime_ = this.f49716u;
            hTTPFault.maxActiveFaultsRuntime_ = this.f49717v;
            hTTPFault.responseRateLimitPercentRuntime_ = this.f49718w;
            hTTPFault.abortGrpcStatusRuntime_ = this.f49719x;
            hTTPFault.disableDownstreamClusterStats_ = this.f49720y;
            Q();
            return hTTPFault;
        }
        ...
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.http.fault.v3.b.f49725e;
        }

        public b h0(FaultAbort faultAbort) {
            q2<FaultAbort, FaultAbort.c, io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.http.fault.v3.a> q2Var = this.f49704i;
            if (q2Var == null) {
                FaultAbort faultAbort2 = this.f49703h;
                if (faultAbort2 != null) {
                    this.f49703h = FaultAbort.newBuilder(faultAbort2).g0(faultAbort).I();
                } else {
                    this.f49703h = faultAbort;
                }
                R();
            } else {
                q2Var.e(faultAbort);
        ...
        public b i0(FaultDelay faultDelay) {
            q2<FaultDelay, FaultDelay.c, io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.a> q2Var = this.f49702g;
            if (q2Var == null) {
                FaultDelay faultDelay2 = this.f49701f;
                if (faultDelay2 != null) {
                    this.f49701f = FaultDelay.newBuilder(faultDelay2).h0(faultDelay).I();
                } else {
                    this.f49701f = faultDelay;
                }
                R();
            } else {
                q2Var.e(faultDelay);
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.http.fault.v3.HTTPFault.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.http.fault.v3.HTTPFault.access$2100()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.http.fault.v3.HTTPFault r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.http.fault.v3.HTTPFault) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.l0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.http.fault.v3.HTTPFault r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.http.fault.v3.HTTPFault) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.http.fault.v3.HTTPFault.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.http.fault.v3.HTTPFault$b");
        }
        ...
        public b l0(HTTPFault hTTPFault) {
            ...
            if (!hTTPFault.getUpstreamCluster().isEmpty()) {
                this.f49705j = hTTPFault.upstreamCluster_;
                R();
            }
            if (this.f49707l == null) {
                if (!hTTPFault.headers_.isEmpty()) {
                    if (this.f49706k.isEmpty()) {
                        this.f49706k = hTTPFault.headers_;
                        this.f49700e &= -2;
                    } else {
                        b0();
                        this.f49706k.addAll(hTTPFault.headers_);
                    }
                    R();
                }
                ...
                if (this.f49707l.k()) {
                    ...
                    this.f49706k = hTTPFault.headers_;
                    this.f49700e &= -2;
                    this.f49707l = GeneratedMessageV3.alwaysUseFieldBuilders ? e0() : null;
                } else {
                    this.f49707l.b(hTTPFault.headers_);
                }
            }
            if (!hTTPFault.downstreamNodes_.isEmpty()) {
                if (this.f49708m.isEmpty()) {
                    this.f49708m = hTTPFault.downstreamNodes_;
                    this.f49700e &= -3;
                } else {
                    a0();
                    this.f49708m.addAll(hTTPFault.downstreamNodes_);
                }
                R();
            }
            ...
            if (!hTTPFault.getDelayPercentRuntime().isEmpty()) {
                this.f49713r = hTTPFault.delayPercentRuntime_;
                R();
            }
            if (!hTTPFault.getAbortPercentRuntime().isEmpty()) {
                this.f49714s = hTTPFault.abortPercentRuntime_;
                R();
            }
            if (!hTTPFault.getDelayDurationRuntime().isEmpty()) {
                this.f49715t = hTTPFault.delayDurationRuntime_;
                R();
            }
            if (!hTTPFault.getAbortHttpStatusRuntime().isEmpty()) {
                this.f49716u = hTTPFault.abortHttpStatusRuntime_;
                R();
            }
            if (!hTTPFault.getMaxActiveFaultsRuntime().isEmpty()) {
                this.f49717v = hTTPFault.maxActiveFaultsRuntime_;
                R();
            }
            if (!hTTPFault.getResponseRateLimitPercentRuntime().isEmpty()) {
                this.f49718w = hTTPFault.responseRateLimitPercentRuntime_;
                R();
            }
            if (!hTTPFault.getAbortGrpcStatusRuntime().isEmpty()) {
                this.f49719x = hTTPFault.abortGrpcStatusRuntime_;
                R();
            }
            if (hTTPFault.getDisableDownstreamClusterStats()) {
                q0(hTTPFault.getDisableDownstreamClusterStats());
            }
        ...
        public b m0(UInt32Value uInt32Value) {
            q2<UInt32Value, UInt32Value.b, e3> q2Var = this.f49710o;
            if (q2Var == null) {
                UInt32Value uInt32Value2 = this.f49709n;
                if (uInt32Value2 != null) {
                    this.f49709n = UInt32Value.newBuilder(uInt32Value2).g0(uInt32Value).I();
                } else {
                    this.f49709n = uInt32Value;
                }
                R();
            } else {
                q2Var.e(uInt32Value);
        ...
        public b n0(FaultRateLimit faultRateLimit) {
            q2<FaultRateLimit, FaultRateLimit.c, io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.c> q2Var = this.f49712q;
            if (q2Var == null) {
                FaultRateLimit faultRateLimit2 = this.f49711p;
                if (faultRateLimit2 != null) {
                    this.f49711p = FaultRateLimit.newBuilder(faultRateLimit2).h0(faultRateLimit).I();
                } else {
                    this.f49711p = faultRateLimit;
                }
                R();
            } else {
        ...
        private b() {
            this.f49705j = "";
            this.f49706k = Collections.emptyList();
            this.f49708m = y0.f15344d;
            this.f49713r = "";
            this.f49714s = "";
            this.f49715t = "";
            this.f49716u = "";
    ...
    public boolean equals(Object obj) {
        ...
        if ((!hasDelay() || getDelay().equals(hTTPFault.getDelay())) && hasAbort() == hTTPFault.hasAbort()) {
            if ((!hasAbort() || getAbort().equals(hTTPFault.getAbort())) && getUpstreamCluster().equals(hTTPFault.getUpstreamCluster()) && getHeadersList().equals(hTTPFault.getHeadersList()) && m1634getDownstreamNodesList().equals(hTTPFault.m1634getDownstreamNodesList()) && hasMaxActiveFaults() == hTTPFault.hasMaxActiveFaults()) {
    ...
    public io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.c getResponseRateLimitOrBuilder() {
    ...
    public int getSerializedSize() {
        ...
        int size = G + i11 + (m1634getDownstreamNodesList().size() * 1);
        ...
        if (z10) {
            size += CodedOutputStream.e(15, z10);
        }
    ...
    public int hashCode() {
        ...
        if (getDownstreamNodesCount() > 0) {
            hashCode2 = (((hashCode2 * 37) + 5) * 53) + m1634getDownstreamNodesList().hashCode();
        }
    ...
    public i2 m1634getDownstreamNodesList() {
                    ...
                    try {
                        ...
                        switch (L) {
                            ...
                            case 106:
                                ...
                                continue;
                            case 114:
                                this.abortGrpcStatusRuntime_ = pVar.K();
                                continue;
                            case 120:
                                this.disableDownstreamClusterStats_ = pVar.r();
                                continue;
                            default:
