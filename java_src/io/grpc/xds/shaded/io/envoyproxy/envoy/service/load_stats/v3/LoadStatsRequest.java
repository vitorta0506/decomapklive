...
public final class LoadStatsRequest extends GeneratedMessageV3 implements r1 {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        private Node f50152f;

        /* renamed from: g  reason: collision with root package name */
        private q2<Node, Node.c, l0> f50153g;

        /* renamed from: h  reason: collision with root package name */
        private List<ClusterStats> f50154h;

        /* renamed from: i  reason: collision with root package name */
        private l2<ClusterStats, ClusterStats.b, io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.b> f50155i;
        ...
        private void b0() {
            if ((this.f50151e & 1) == 0) {
                this.f50154h = new ArrayList(this.f50154h);
                this.f50151e |= 1;
            }
        }

        private l2<ClusterStats, ClusterStats.b, io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.b> d0() {
            if (this.f50155i == null) {
                this.f50155i = new l2<>(this.f50154h, (this.f50151e & 1) != 0, H(), O());
                this.f50154h = null;
            }
            return this.f50155i;
        }
        ...
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v3.b.f50165b.d(LoadStatsRequest.class, b.class);
        }

        public b W(ClusterStats clusterStats) {
            l2<ClusterStats, ClusterStats.b, io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.b> l2Var = this.f50155i;
            if (l2Var == null) {
                Objects.requireNonNull(clusterStats);
                b0();
                this.f50154h.add(clusterStats);
                R();
            } else {
        ...
        public LoadStatsRequest I() {
            ...
            q2<Node, Node.c, l0> q2Var = this.f50153g;
            if (q2Var == null) {
                loadStatsRequest.node_ = this.f50152f;
            } else {
            ...
            if (l2Var == null) {
                if ((this.f50151e & 1) != 0) {
                    this.f50154h = Collections.unmodifiableList(this.f50154h);
                    this.f50151e &= -2;
                }
                loadStatsRequest.clusterStats_ = this.f50154h;
            } else {
        ...
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v3.b.f50164a;
        }
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v3.LoadStatsRequest.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v3.LoadStatsRequest.access$800()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v3.LoadStatsRequest r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v3.LoadStatsRequest) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.j0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v3.LoadStatsRequest r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v3.LoadStatsRequest) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v3.LoadStatsRequest.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v3.LoadStatsRequest$b");
        }
        ...
        public b j0(LoadStatsRequest loadStatsRequest) {
            ...
            if (this.f50155i == null) {
                if (!loadStatsRequest.clusterStats_.isEmpty()) {
                    if (this.f50154h.isEmpty()) {
                        this.f50154h = loadStatsRequest.clusterStats_;
                        this.f50151e &= -2;
                    } else {
                        b0();
                        this.f50154h.addAll(loadStatsRequest.clusterStats_);
                    }
                    R();
                }
                ...
                if (this.f50155i.k()) {
                    ...
                    this.f50154h = loadStatsRequest.clusterStats_;
                    this.f50151e &= -2;
                    this.f50155i = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                } else {
                    this.f50155i.b(loadStatsRequest.clusterStats_);
                }
            }
        ...
        public b k0(Node node) {
            q2<Node, Node.c, l0> q2Var = this.f50153g;
            if (q2Var == null) {
                Node node2 = this.f50152f;
                if (node2 != null) {
                    this.f50152f = Node.newBuilder(node2).q0(node).I();
                } else {
                    this.f50152f = node;
                }
                R();
        ...
        private b() {
            this.f50154h = Collections.emptyList();
            g0();
        }
    ...
    public io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.b getClusterStatsOrBuilder(int i9) {
        return this.clusterStats_.get(i9);
    }

    public List<? extends io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.b> getClusterStatsOrBuilderList() {
        return this.clusterStats_;
    }
