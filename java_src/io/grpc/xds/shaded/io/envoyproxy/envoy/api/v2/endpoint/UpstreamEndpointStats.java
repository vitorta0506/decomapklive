...
public final class UpstreamEndpointStats extends GeneratedMessageV3 implements h {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements h {
        ...
        private Address f46852f;

        /* renamed from: g  reason: collision with root package name */
        private q2<Address, Address.c, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.a> f46853g;

        /* renamed from: h  reason: collision with root package name */
        private Struct f46854h;

        /* renamed from: i  reason: collision with root package name */
        private q2<Struct, Struct.b, u2> f46855i;

        /* renamed from: j  reason: collision with root package name */
        private long f46856j;
        ...
        private long f46859m;

        /* renamed from: n  reason: collision with root package name */
        private List<EndpointLoadMetricStats> f46860n;

        /* renamed from: o  reason: collision with root package name */
        private l2<EndpointLoadMetricStats, EndpointLoadMetricStats.b, c> f46861o;
        ...
        private void a0() {
            if ((this.f46851e & 1) == 0) {
                this.f46860n = new ArrayList(this.f46860n);
                this.f46851e |= 1;
            }
        }

        private l2<EndpointLoadMetricStats, EndpointLoadMetricStats.b, c> d0() {
            if (this.f46861o == null) {
                this.f46861o = new l2<>(this.f46860n, (this.f46851e & 1) != 0, H(), O());
                this.f46860n = null;
            }
            return this.f46861o;
        }
        ...
        protected GeneratedMessageV3.e K() {
            return f.f46886d.d(UpstreamEndpointStats.class, b.class);
        }
        ...
        public UpstreamEndpointStats I() {
            ...
            q2<Address, Address.c, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.a> q2Var = this.f46853g;
            if (q2Var == null) {
                upstreamEndpointStats.address_ = this.f46852f;
            } else {
                upstreamEndpointStats.address_ = q2Var.b();
            }
            q2<Struct, Struct.b, u2> q2Var2 = this.f46855i;
            if (q2Var2 == null) {
                upstreamEndpointStats.metadata_ = this.f46854h;
            } else {
                upstreamEndpointStats.metadata_ = q2Var2.b();
            }
            upstreamEndpointStats.totalSuccessfulRequests_ = this.f46856j;
            upstreamEndpointStats.totalRequestsInProgress_ = this.f46857k;
            upstreamEndpointStats.totalErrorRequests_ = this.f46858l;
            upstreamEndpointStats.totalIssuedRequests_ = this.f46859m;
            l2<EndpointLoadMetricStats, EndpointLoadMetricStats.b, c> l2Var = this.f46861o;
            if (l2Var == null) {
                if ((this.f46851e & 1) != 0) {
                    this.f46860n = Collections.unmodifiableList(this.f46860n);
                    this.f46851e &= -2;
                }
                upstreamEndpointStats.loadMetricStats_ = this.f46860n;
            } else {
        ...
        public b g0(Address address) {
            q2<Address, Address.c, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.a> q2Var = this.f46853g;
            if (q2Var == null) {
                Address address2 = this.f46852f;
                if (address2 != null) {
                    this.f46852f = Address.newBuilder(address2).g0(address).I();
                } else {
                    this.f46852f = address;
                }
                R();
            } else {
                q2Var.e(address);
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats.access$1300()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.j0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.endpoint.UpstreamEndpointStats$b");
        }
        ...
        public b j0(UpstreamEndpointStats upstreamEndpointStats) {
            ...
            if (this.f46861o == null) {
                if (!upstreamEndpointStats.loadMetricStats_.isEmpty()) {
                    if (this.f46860n.isEmpty()) {
                        this.f46860n = upstreamEndpointStats.loadMetricStats_;
                        this.f46851e &= -2;
                    } else {
                        a0();
                        this.f46860n.addAll(upstreamEndpointStats.loadMetricStats_);
                    }
                    R();
                }
                ...
                if (this.f46861o.k()) {
                    ...
                    this.f46860n = upstreamEndpointStats.loadMetricStats_;
                    this.f46851e &= -2;
                    this.f46861o = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                } else {
                    this.f46861o.b(upstreamEndpointStats.loadMetricStats_);
                }
            }
        ...
        public b k0(Struct struct) {
            q2<Struct, Struct.b, u2> q2Var = this.f46855i;
            if (q2Var == null) {
                Struct struct2 = this.f46854h;
                if (struct2 != null) {
                    this.f46854h = Struct.newBuilder(struct2).i0(struct).I();
                } else {
                    this.f46854h = struct;
                }
                R();
        ...
        private b() {
            this.f46860n = Collections.emptyList();
            e0();
        }
