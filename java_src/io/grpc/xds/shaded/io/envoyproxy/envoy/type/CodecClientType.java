...
public enum CodecClientType implements h2 {
    ...
    private static final u0.d<CodecClientType> internalValueMap = new u0.d<CodecClientType>() { // from class: io.grpc.xds.shaded.io.envoyproxy.envoy.type.CodecClientType.a
