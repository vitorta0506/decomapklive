...
public final class ScopedRoutes extends GeneratedMessageV3 implements j {
    ...
    public static final class ScopeKeyBuilder extends GeneratedMessageV3 implements d {
        ...
        public static final class FragmentBuilder extends GeneratedMessageV3 implements c {
            ...
            public static final class HeaderValueExtractor extends GeneratedMessageV3 implements c {
                ...
                public static final class KvElement extends GeneratedMessageV3 implements c {
                    ...
                    public static final class b extends GeneratedMessageV3.b<b> implements c {
                        ...
                        private Object f49852e;

                        /* renamed from: f  reason: collision with root package name */
                        private Object f49853f;
                        ...
                        protected GeneratedMessageV3.e K() {
                            return io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.b.D.d(KvElement.class, b.class);
                        }
                        ...
                        public KvElement I() {
                            ...
                            kvElement.separator_ = this.f49852e;
                            kvElement.key_ = this.f49853f;
                            Q();
                            return kvElement;
                        }
                        ...
                        */
                        public io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.KvElement.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                            /*
                                r2 = this;
                                r0 = 0
                                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.KvElement.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                            ...
                            L26:
                                throw r3
                            */
                            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.KvElement.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes$ScopeKeyBuilder$FragmentBuilder$HeaderValueExtractor$KvElement$b");
                        }
                        ...
                        public b g0(KvElement kvElement) {
                            ...
                            if (!kvElement.getSeparator().isEmpty()) {
                                this.f49852e = kvElement.separator_;
                                R();
                            }
                            if (!kvElement.getKey().isEmpty()) {
                                this.f49853f = kvElement.key_;
                                R();
                            }
                        ...
                        public Descriptors.b getDescriptorForType() {
                            return io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.b.C;
                        }
                ...
                public static final class b extends GeneratedMessageV3.b<b> implements c {
                    ...
                    /* renamed from: f  reason: collision with root package name */
                    private Object f49855f;

                    /* renamed from: g  reason: collision with root package name */
                    private Object f49856g;

                    /* renamed from: h  reason: collision with root package name */
                    private Object f49857h;

                    /* renamed from: i  reason: collision with root package name */
                    private q2<KvElement, KvElement.b, c> f49858i;
                    ...
                    @Override // com.google.protobuf.GeneratedMessageV3.b
                    protected GeneratedMessageV3.e K() {
                        return io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.b.B.d(HeaderValueExtractor.class, b.class);
                    }
                    ...
                    public HeaderValueExtractor I() {
                        ...
                        headerValueExtractor.name_ = this.f49856g;
                        headerValueExtractor.elementSeparator_ = this.f49857h;
                        if (this.f49854e == 3) {
                            headerValueExtractor.extractType_ = this.f49855f;
                        }
                        if (this.f49854e == 4) {
                            q2<KvElement, KvElement.b, c> q2Var = this.f49858i;
                            if (q2Var == null) {
                                headerValueExtractor.extractType_ = this.f49855f;
                            } else {
                        ...
                        headerValueExtractor.extractTypeCase_ = this.f49854e;
                        Q();
                    ...
                    public b d0(KvElement kvElement) {
                        q2<KvElement, KvElement.b, c> q2Var = this.f49858i;
                        if (q2Var == null) {
                            if (this.f49854e == 4 && this.f49855f != KvElement.getDefaultInstance()) {
                                this.f49855f = KvElement.newBuilder((KvElement) this.f49855f).g0(kvElement).I();
                            } else {
                                this.f49855f = kvElement;
                            }
                            R();
                        } else {
                            if (this.f49854e == 4) {
                    ...
                    /*
                        ...
                        To view partially-correct add '--show-bad-code' argument
                    */
                    public io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                        /*
                            r2 = this;
                            r0 = 0
                            com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.access$2000()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                            java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                        ...
                        L26:
                            throw r3
                        */
                        throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes$ScopeKeyBuilder$FragmentBuilder$HeaderValueExtractor$b");
                    }
                    ...
                    @Override // com.google.protobuf.GeneratedMessageV3.b, com.google.protobuf.l1.a, com.google.protobuf.r1
                    public Descriptors.b getDescriptorForType() {
                        return io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.b.A;
                    }
                    ...
                    public b h0(HeaderValueExtractor headerValueExtractor) {
                        ...
                        if (!headerValueExtractor.getName().isEmpty()) {
                            this.f49856g = headerValueExtractor.name_;
                            R();
                        }
                        if (!headerValueExtractor.getElementSeparator().isEmpty()) {
                            this.f49857h = headerValueExtractor.elementSeparator_;
                            R();
                        }
                        int i9 = b.f49865a[headerValueExtractor.getExtractTypeCase().ordinal()];
                        if (i9 == 1) {
                    ...
                    public b k0(int i9) {
                        this.f49854e = 3;
                        this.f49855f = Integer.valueOf(i9);
                        R();
                        return this;
                    }
            ...
            public static final class b extends GeneratedMessageV3.b<b> implements c {
                ...
                /* renamed from: g  reason: collision with root package name */
                private q2<HeaderValueExtractor, HeaderValueExtractor.b, c> f49861g;
                ...
                @Override // com.google.protobuf.GeneratedMessageV3.b
                protected GeneratedMessageV3.e K() {
                    return io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.b.f49902z.d(FragmentBuilder.class, b.class);
                }
                ...
                public FragmentBuilder I() {
                    ...
                    if (this.f49859e == 1) {
                        q2<HeaderValueExtractor, HeaderValueExtractor.b, c> q2Var = this.f49861g;
                        if (q2Var == null) {
                            fragmentBuilder.type_ = this.f49860f;
                        } else {
                            fragmentBuilder.type_ = q2Var.b();
                        }
                    }
                    fragmentBuilder.typeCase_ = this.f49859e;
                    Q();
                ...
                /*
                    ...
                    To view partially-correct add '--show-bad-code' argument
                */
                public io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                    /*
                        r2 = this;
                        r0 = 0
                        com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.access$3100()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                        java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    ...
                    L26:
                        throw r3
                    */
                    throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes$ScopeKeyBuilder$FragmentBuilder$b");
                }
                ...
                public b g0(FragmentBuilder fragmentBuilder) {
                    ...
                    if (b.f49866b[fragmentBuilder.getTypeCase().ordinal()] == 1) {
                ...
                @Override // com.google.protobuf.GeneratedMessageV3.b, com.google.protobuf.l1.a, com.google.protobuf.r1
                public Descriptors.b getDescriptorForType() {
                    return io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.b.f49901y;
                }

                public b h0(HeaderValueExtractor headerValueExtractor) {
                    q2<HeaderValueExtractor, HeaderValueExtractor.b, c> q2Var = this.f49861g;
                    if (q2Var == null) {
                        if (this.f49859e == 1 && this.f49860f != HeaderValueExtractor.getDefaultInstance()) {
                            this.f49860f = HeaderValueExtractor.newBuilder((HeaderValueExtractor) this.f49860f).h0(headerValueExtractor).I();
                        } else {
                            this.f49860f = headerValueExtractor;
                        }
                        R();
                    } else {
                        if (this.f49859e == 1) {
                        ...
                        this.f49861g.g(headerValueExtractor);
                    }
                    this.f49859e = 1;
                    return this;
                }
        ...
        public static final class b extends GeneratedMessageV3.b<b> implements d {
            ...
            /* renamed from: f  reason: collision with root package name */
            private List<FragmentBuilder> f49863f;

            /* renamed from: g  reason: collision with root package name */
            private l2<FragmentBuilder, FragmentBuilder.b, c> f49864g;
            ...
            private void a0() {
                if ((this.f49862e & 1) == 0) {
                    this.f49863f = new ArrayList(this.f49863f);
                    this.f49862e |= 1;
                }
            }
            ...
            private l2<FragmentBuilder, FragmentBuilder.b, c> d0() {
                if (this.f49864g == null) {
                    this.f49864g = new l2<>(this.f49863f, (this.f49862e & 1) != 0, H(), O());
                    this.f49863f = null;
                }
                return this.f49864g;
            }
            ...
            @Override // com.google.protobuf.GeneratedMessageV3.b
            protected GeneratedMessageV3.e K() {
                return io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.b.f49900x.d(ScopeKeyBuilder.class, b.class);
            }
            ...
            public ScopeKeyBuilder I() {
                ...
                int i9 = this.f49862e;
                l2<FragmentBuilder, FragmentBuilder.b, c> l2Var = this.f49864g;
                if (l2Var == null) {
                    if ((i9 & 1) != 0) {
                        this.f49863f = Collections.unmodifiableList(this.f49863f);
                        this.f49862e &= -2;
                    }
                    scopeKeyBuilder.fragments_ = this.f49863f;
                } else {
            ...
            /*
                ...
                To view partially-correct add '--show-bad-code' argument
            */
            public io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes.ScopeKeyBuilder.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                /*
                    r2 = this;
                    r0 = 0
                    com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes.ScopeKeyBuilder.access$4000()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                ...
                L26:
                    throw r3
                */
                throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes.ScopeKeyBuilder.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes$ScopeKeyBuilder$b");
            }

            @Override // com.google.protobuf.GeneratedMessageV3.b, com.google.protobuf.l1.a, com.google.protobuf.r1
            public Descriptors.b getDescriptorForType() {
                return io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.b.f49899w;
            }
            ...
            public b i0(ScopeKeyBuilder scopeKeyBuilder) {
                ...
                if (this.f49864g == null) {
                    if (!scopeKeyBuilder.fragments_.isEmpty()) {
                        if (this.f49863f.isEmpty()) {
                            this.f49863f = scopeKeyBuilder.fragments_;
                            this.f49862e &= -2;
                        } else {
                            a0();
                            this.f49863f.addAll(scopeKeyBuilder.fragments_);
                        }
                        R();
                    }
                    ...
                    if (this.f49864g.k()) {
                        ...
                        this.f49863f = scopeKeyBuilder.fragments_;
                        this.f49862e &= -2;
                        this.f49864g = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                    } else {
                        this.f49864g.b(scopeKeyBuilder.fragments_);
                    }
                }
            ...
            private b() {
                this.f49863f = Collections.emptyList();
                e0();
            }
    ...
    public static /* synthetic */ class b {
        ...
        static final /* synthetic */ int[] f49866b;

        /* renamed from: c  reason: collision with root package name */
        static final /* synthetic */ int[] f49867c;
        ...
        static {
            ...
            try {
                f49867c[ConfigSpecifierCase.SCOPED_RDS.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f49867c[ConfigSpecifierCase.CONFIGSPECIFIER_NOT_SET.ordinal()] = 3;
            ...
            try {
                f49866b[ScopeKeyBuilder.FragmentBuilder.TypeCase.TYPE_NOT_SET.ordinal()] = 2;
            ...
            try {
                f49865a[ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.ExtractTypeCase.ELEMENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f49865a[ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.ExtractTypeCase.EXTRACTTYPE_NOT_SET.ordinal()] = 3;
    ...
    public static final class c extends GeneratedMessageV3.b<c> implements j {
        ...
        /* renamed from: f  reason: collision with root package name */
        private Object f49869f;

        /* renamed from: g  reason: collision with root package name */
        private Object f49870g;

        /* renamed from: h  reason: collision with root package name */
        private ScopeKeyBuilder f49871h;

        /* renamed from: i  reason: collision with root package name */
        private q2<ScopeKeyBuilder, ScopeKeyBuilder.b, d> f49872i;

        /* renamed from: j  reason: collision with root package name */
        private ConfigSource f49873j;

        /* renamed from: k  reason: collision with root package name */
        private q2<ConfigSource, ConfigSource.c, k> f49874k;

        /* renamed from: l  reason: collision with root package name */
        private q2<ScopedRouteConfigurationsList, ScopedRouteConfigurationsList.b, i> f49875l;

        /* renamed from: m  reason: collision with root package name */
        private q2<ScopedRds, ScopedRds.b, h> f49876m;
        ...
        @Override // com.google.protobuf.GeneratedMessageV3.b
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.b.f49898v.d(ScopedRoutes.class, c.class);
        }
        ...
        public ScopedRoutes I() {
            ...
            scopedRoutes.name_ = this.f49870g;
            q2<ScopeKeyBuilder, ScopeKeyBuilder.b, d> q2Var = this.f49872i;
            if (q2Var == null) {
                scopedRoutes.scopeKeyBuilder_ = this.f49871h;
            } else {
                scopedRoutes.scopeKeyBuilder_ = q2Var.b();
            }
            q2<ConfigSource, ConfigSource.c, k> q2Var2 = this.f49874k;
            if (q2Var2 == null) {
                scopedRoutes.rdsConfigSource_ = this.f49873j;
            } else {
                scopedRoutes.rdsConfigSource_ = q2Var2.b();
            }
            if (this.f49868e == 4) {
                q2<ScopedRouteConfigurationsList, ScopedRouteConfigurationsList.b, i> q2Var3 = this.f49875l;
                if (q2Var3 == null) {
                    scopedRoutes.configSpecifier_ = this.f49869f;
                } else {
                    scopedRoutes.configSpecifier_ = q2Var3.b();
                }
            }
            if (this.f49868e == 5) {
                q2<ScopedRds, ScopedRds.b, h> q2Var4 = this.f49876m;
                if (q2Var4 == null) {
                    scopedRoutes.configSpecifier_ = this.f49869f;
                } else {
            ...
            scopedRoutes.configSpecifierCase_ = this.f49868e;
            Q();
            return scopedRoutes;
        }
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes.access$5200()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRoutes$c");
        }
        ...
        public c g0(ScopedRoutes scopedRoutes) {
            ...
            if (!scopedRoutes.getName().isEmpty()) {
                this.f49870g = scopedRoutes.name_;
                R();
            }
            ...
            int i9 = b.f49867c[scopedRoutes.getConfigSpecifierCase().ordinal()];
            if (i9 == 1) {
        ...
        @Override // com.google.protobuf.GeneratedMessageV3.b, com.google.protobuf.l1.a, com.google.protobuf.r1
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.b.f49897u;
        }

        public c h0(ConfigSource configSource) {
            q2<ConfigSource, ConfigSource.c, k> q2Var = this.f49874k;
            if (q2Var == null) {
                ConfigSource configSource2 = this.f49873j;
                if (configSource2 != null) {
                    this.f49873j = ConfigSource.newBuilder(configSource2).k0(configSource).I();
                } else {
                    this.f49873j = configSource;
                }
                R();
            } else {
        ...
        public c i0(ScopeKeyBuilder scopeKeyBuilder) {
            q2<ScopeKeyBuilder, ScopeKeyBuilder.b, d> q2Var = this.f49872i;
            if (q2Var == null) {
                ScopeKeyBuilder scopeKeyBuilder2 = this.f49871h;
                if (scopeKeyBuilder2 != null) {
                    this.f49871h = ScopeKeyBuilder.newBuilder(scopeKeyBuilder2).i0(scopeKeyBuilder).I();
                } else {
                    this.f49871h = scopeKeyBuilder;
                }
                R();
            } else {
        ...
        public c j0(ScopedRds scopedRds) {
            q2<ScopedRds, ScopedRds.b, h> q2Var = this.f49876m;
            if (q2Var == null) {
                if (this.f49868e == 5 && this.f49869f != ScopedRds.getDefaultInstance()) {
                    this.f49869f = ScopedRds.newBuilder((ScopedRds) this.f49869f).g0(scopedRds).I();
                } else {
                    this.f49869f = scopedRds;
                }
                R();
            } else {
                if (this.f49868e == 5) {
        ...
        public c k0(ScopedRouteConfigurationsList scopedRouteConfigurationsList) {
            q2<ScopedRouteConfigurationsList, ScopedRouteConfigurationsList.b, i> q2Var = this.f49875l;
            if (q2Var == null) {
                if (this.f49868e == 4 && this.f49869f != ScopedRouteConfigurationsList.getDefaultInstance()) {
                    this.f49869f = ScopedRouteConfigurationsList.newBuilder((ScopedRouteConfigurationsList) this.f49869f).i0(scopedRouteConfigurationsList).I();
                } else {
                    this.f49869f = scopedRouteConfigurationsList;
                }
                R();
            } else {
                if (this.f49868e == 4) {
                ...
                this.f49875l.g(scopedRouteConfigurationsList);
            }
            this.f49868e = 4;
            return this;
        }
    ...
    public h getScopedRdsOrBuilder() {
        if (this.configSpecifierCase_ == 5) {
            return (ScopedRds) this.configSpecifier_;
        }
        return ScopedRds.getDefaultInstance();
    ...
    public i getScopedRouteConfigurationsListOrBuilder() {
        if (this.configSpecifierCase_ == 4) {
            return (ScopedRouteConfigurationsList) this.configSpecifier_;
        }
        return ScopedRouteConfigurationsList.getDefaultInstance();
