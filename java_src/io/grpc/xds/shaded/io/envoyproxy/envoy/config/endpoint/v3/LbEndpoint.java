...
public final class LbEndpoint extends GeneratedMessageV3 implements g {
    ...
    public static /* synthetic */ class b {
        ...
        static {
            ...
            try {
                f48361a[HostIdentifierCase.ENDPOINT_NAME.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f48361a[HostIdentifierCase.HOSTIDENTIFIER_NOT_SET.ordinal()] = 3;
    ...
    public static final class c extends GeneratedMessageV3.b<c> implements g {
        ...
        private Object f48363f;

        /* renamed from: g  reason: collision with root package name */
        private q2<Endpoint, Endpoint.b, e> f48364g;

        /* renamed from: h  reason: collision with root package name */
        private int f48365h;

        /* renamed from: i  reason: collision with root package name */
        private Metadata f48366i;

        /* renamed from: j  reason: collision with root package name */
        private q2<Metadata, Metadata.b, k0> f48367j;

        /* renamed from: k  reason: collision with root package name */
        private UInt32Value f48368k;

        /* renamed from: l  reason: collision with root package name */
        private q2<UInt32Value, UInt32Value.b, e3> f48369l;
        ...
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.c.f48419f.d(LbEndpoint.class, c.class);
        }
        ...
        public LbEndpoint I() {
            ...
            if (this.f48362e == 1) {
                q2<Endpoint, Endpoint.b, e> q2Var = this.f48364g;
                if (q2Var == null) {
                    lbEndpoint.hostIdentifier_ = this.f48363f;
                } else {
            ...
            lbEndpoint.healthStatus_ = this.f48365h;
            q2<Metadata, Metadata.b, k0> q2Var2 = this.f48367j;
            if (q2Var2 == null) {
                lbEndpoint.metadata_ = this.f48366i;
            } else {
                lbEndpoint.metadata_ = q2Var2.b();
            }
            q2<UInt32Value, UInt32Value.b, e3> q2Var3 = this.f48369l;
            if (q2Var3 == null) {
                lbEndpoint.loadBalancingWeight_ = this.f48368k;
            } else {
                lbEndpoint.loadBalancingWeight_ = q2Var3.b();
            }
            lbEndpoint.hostIdentifierCase_ = this.f48362e;
            Q();
            return lbEndpoint;
        }
        ...
        public c d0(Endpoint endpoint) {
            q2<Endpoint, Endpoint.b, e> q2Var = this.f48364g;
            if (q2Var == null) {
                if (this.f48362e == 1 && this.f48363f != Endpoint.getDefaultInstance()) {
                    this.f48363f = Endpoint.newBuilder((Endpoint) this.f48363f).h0(endpoint).I();
                } else {
                    this.f48363f = endpoint;
                }
                R();
            } else {
                if (this.f48362e == 1) {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.LbEndpoint.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.LbEndpoint.access$1000()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.LbEndpoint.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.LbEndpoint$c");
        }
        ...
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.c.f48418e;
        }
        ...
        public c h0(LbEndpoint lbEndpoint) {
            ...
            int i9 = b.f48361a[lbEndpoint.getHostIdentifierCase().ordinal()];
            if (i9 == 1) {
                d0(lbEndpoint.getEndpoint());
            } else if (i9 == 2) {
                this.f48362e = 5;
                this.f48363f = lbEndpoint.hostIdentifier_;
                R();
            }
        ...
        public c i0(UInt32Value uInt32Value) {
            q2<UInt32Value, UInt32Value.b, e3> q2Var = this.f48369l;
            if (q2Var == null) {
                UInt32Value uInt32Value2 = this.f48368k;
                if (uInt32Value2 != null) {
                    this.f48368k = UInt32Value.newBuilder(uInt32Value2).g0(uInt32Value).I();
                } else {
                    this.f48368k = uInt32Value;
                }
                R();
            } else {
                q2Var.e(uInt32Value);
        ...
        public c j0(Metadata metadata) {
            q2<Metadata, Metadata.b, k0> q2Var = this.f48367j;
            if (q2Var == null) {
                Metadata metadata2 = this.f48366i;
                if (metadata2 != null) {
                    this.f48366i = Metadata.newBuilder(metadata2).k0(metadata).I();
                } else {
                    this.f48366i = metadata;
                }
                R();
            } else {
                q2Var.e(metadata);
