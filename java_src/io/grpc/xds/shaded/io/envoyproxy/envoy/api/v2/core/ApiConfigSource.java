...
public final class ApiConfigSource extends GeneratedMessageV3 implements d {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements d {
        ...
        private List<GrpcService> f46359i;

        /* renamed from: j  reason: collision with root package name */
        private l2<GrpcService, GrpcService.c, r> f46360j;

        /* renamed from: k  reason: collision with root package name */
        private Duration f46361k;

        /* renamed from: l  reason: collision with root package name */
        private q2<Duration, Duration.b, com.google.protobuf.v> f46362l;

        /* renamed from: m  reason: collision with root package name */
        private Duration f46363m;

        /* renamed from: n  reason: collision with root package name */
        private q2<Duration, Duration.b, com.google.protobuf.v> f46364n;

        /* renamed from: o  reason: collision with root package name */
        private RateLimitSettings f46365o;

        /* renamed from: p  reason: collision with root package name */
        private q2<RateLimitSettings, RateLimitSettings.b, h0> f46366p;
        ...
        private void a0() {
            if ((this.f46355e & 1) == 0) {
                this.f46358h = new y0(this.f46358h);
                this.f46355e |= 1;
            }
        }
        ...
        private void b0() {
            if ((this.f46355e & 2) == 0) {
                this.f46359i = new ArrayList(this.f46359i);
                this.f46355e |= 2;
            }
        }

        private l2<GrpcService, GrpcService.c, r> e0() {
            if (this.f46360j == null) {
                this.f46360j = new l2<>(this.f46359i, (this.f46355e & 2) != 0, H(), O());
                this.f46359i = null;
            }
            return this.f46360j;
        }
        ...
        protected GeneratedMessageV3.e K() {
            return l.f46738b.d(ApiConfigSource.class, b.class);
        }
        ...
        public ApiConfigSource I() {
            ...
            apiConfigSource.apiType_ = this.f46356f;
            apiConfigSource.transportApiVersion_ = this.f46357g;
            if ((this.f46355e & 1) != 0) {
                this.f46358h = this.f46358h.V0();
                this.f46355e &= -2;
            }
            apiConfigSource.clusterNames_ = this.f46358h;
            l2<GrpcService, GrpcService.c, r> l2Var = this.f46360j;
            if (l2Var == null) {
                if ((this.f46355e & 2) != 0) {
                    this.f46359i = Collections.unmodifiableList(this.f46359i);
                    this.f46355e &= -3;
                }
                apiConfigSource.grpcServices_ = this.f46359i;
            } else {
                apiConfigSource.grpcServices_ = l2Var.e();
            }
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var = this.f46362l;
            if (q2Var == null) {
                apiConfigSource.refreshDelay_ = this.f46361k;
            } else {
                apiConfigSource.refreshDelay_ = q2Var.b();
            }
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var2 = this.f46364n;
            if (q2Var2 == null) {
                apiConfigSource.requestTimeout_ = this.f46363m;
            } else {
                apiConfigSource.requestTimeout_ = q2Var2.b();
            }
            q2<RateLimitSettings, RateLimitSettings.b, h0> q2Var3 = this.f46366p;
            if (q2Var3 == null) {
                apiConfigSource.rateLimitSettings_ = this.f46365o;
            } else {
                apiConfigSource.rateLimitSettings_ = q2Var3.b();
            }
            apiConfigSource.setNodeOnFirstMessageOnly_ = this.f46367q;
            Q();
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.ApiConfigSource.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.ApiConfigSource.access$1400()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.ApiConfigSource.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.ApiConfigSource$b");
        }
        ...
        public b j0(ApiConfigSource apiConfigSource) {
            ...
            if (!apiConfigSource.clusterNames_.isEmpty()) {
                if (this.f46358h.isEmpty()) {
                    this.f46358h = apiConfigSource.clusterNames_;
                    this.f46355e &= -2;
                } else {
                    a0();
                    this.f46358h.addAll(apiConfigSource.clusterNames_);
                }
                R();
            }
            if (this.f46360j == null) {
                if (!apiConfigSource.grpcServices_.isEmpty()) {
                    if (this.f46359i.isEmpty()) {
                        this.f46359i = apiConfigSource.grpcServices_;
                        this.f46355e &= -3;
                    } else {
                        b0();
                        this.f46359i.addAll(apiConfigSource.grpcServices_);
                    }
                    R();
                }
                ...
                if (this.f46360j.k()) {
                    ...
                    this.f46359i = apiConfigSource.grpcServices_;
                    this.f46355e &= -3;
                    this.f46360j = GeneratedMessageV3.alwaysUseFieldBuilders ? e0() : null;
                } else {
                    this.f46360j.b(apiConfigSource.grpcServices_);
                }
            }
        ...
        public b k0(RateLimitSettings rateLimitSettings) {
            q2<RateLimitSettings, RateLimitSettings.b, h0> q2Var = this.f46366p;
            if (q2Var == null) {
                RateLimitSettings rateLimitSettings2 = this.f46365o;
                if (rateLimitSettings2 != null) {
                    this.f46365o = RateLimitSettings.newBuilder(rateLimitSettings2).h0(rateLimitSettings).I();
                } else {
                    this.f46365o = rateLimitSettings;
                }
                R();
            } else {
        ...
        public b l0(Duration duration) {
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var = this.f46362l;
            if (q2Var == null) {
                Duration duration2 = this.f46361k;
                if (duration2 != null) {
                    this.f46361k = Duration.newBuilder(duration2).e0(duration).I();
                } else {
                    this.f46361k = duration;
                }
                R();
            } else {
                q2Var.e(duration);
        ...
        public b m0(Duration duration) {
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var = this.f46364n;
            if (q2Var == null) {
                Duration duration2 = this.f46363m;
                if (duration2 != null) {
                    this.f46363m = Duration.newBuilder(duration2).e0(duration).I();
                } else {
                    this.f46363m = duration;
                }
                R();
            } else {
                q2Var.e(duration);
        ...
        private b() {
            this.f46356f = 0;
            this.f46357g = 0;
            this.f46358h = y0.f15344d;
            this.f46359i = Collections.emptyList();
            g0();
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.apiType_ == apiConfigSource.apiType_ && this.transportApiVersion_ == apiConfigSource.transportApiVersion_ && m1592getClusterNamesList().equals(apiConfigSource.m1592getClusterNamesList()) && getGrpcServicesList().equals(apiConfigSource.getGrpcServicesList()) && hasRefreshDelay() == apiConfigSource.hasRefreshDelay()) {
    ...
    public r getGrpcServicesOrBuilder(int i9) {
        return this.grpcServices_.get(i9);
    }

    public List<? extends r> getGrpcServicesOrBuilderList() {
        return this.grpcServices_;
    }
    ...
    public h0 getRateLimitSettingsOrBuilder() {
    ...
    public int getSerializedSize() {
        ...
        int l10 = this.apiType_ != ApiType.UNSUPPORTED_REST_LEGACY.getNumber() ? CodedOutputStream.l(1, this.apiType_) + 0 : 0;
        int i10 = 0;
        for (int i11 = 0; i11 < this.clusterNames_.size(); i11++) {
            i10 += GeneratedMessageV3.computeStringSizeNoTag(this.clusterNames_.c1(i11));
        }
        int size = l10 + i10 + (m1592getClusterNamesList().size() * 1);
    ...
    public int hashCode() {
        ...
        if (getClusterNamesCount() > 0) {
            hashCode = (((hashCode * 37) + 2) * 53) + m1592getClusterNamesList().hashCode();
        }
        ...
        int d10 = (((((hashCode * 37) + 7) * 53) + u0.d(getSetNodeOnFirstMessageOnly())) * 29) + this.unknownFields.hashCode();
    ...
    public i2 m1592getClusterNamesList() {
