...
public final class RegexMatchAndSubstitute extends GeneratedMessageV3 implements h {
    ...
    public class a extends com.google.protobuf.c<RegexMatchAndSubstitute> {
        ...
        /* renamed from: G */
        public RegexMatchAndSubstitute m(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements h {
        ...
        private RegexMatcher f50286e;

        /* renamed from: f  reason: collision with root package name */
        private q2<RegexMatcher, RegexMatcher.c, i> f50287f;

        /* renamed from: g  reason: collision with root package name */
        private Object f50288g;
        ...
        protected GeneratedMessageV3.e K() {
            return j.f50324f.d(RegexMatchAndSubstitute.class, b.class);
        }
        ...
        public RegexMatchAndSubstitute I() {
            ...
            q2<RegexMatcher, RegexMatcher.c, i> q2Var = this.f50287f;
            if (q2Var == null) {
                regexMatchAndSubstitute.pattern_ = this.f50286e;
            } else {
                regexMatchAndSubstitute.pattern_ = q2Var.b();
            }
            regexMatchAndSubstitute.substitution_ = this.f50288g;
            Q();
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.RegexMatchAndSubstitute.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.RegexMatchAndSubstitute.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.RegexMatchAndSubstitute.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.RegexMatchAndSubstitute$b");
        }
        ...
        public b g0(RegexMatchAndSubstitute regexMatchAndSubstitute) {
            ...
            if (!regexMatchAndSubstitute.getSubstitution().isEmpty()) {
                this.f50288g = regexMatchAndSubstitute.substitution_;
                R();
            }
        ...
        public b h0(RegexMatcher regexMatcher) {
            q2<RegexMatcher, RegexMatcher.c, i> q2Var = this.f50287f;
            if (q2Var == null) {
                RegexMatcher regexMatcher2 = this.f50286e;
                if (regexMatcher2 != null) {
                    this.f50286e = RegexMatcher.newBuilder(regexMatcher2).g0(regexMatcher).I();
                } else {
                    this.f50286e = regexMatcher;
                }
                R();
            } else {
    ...
    /* synthetic */ RegexMatchAndSubstitute(p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
    ...
    private RegexMatchAndSubstitute(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
    ...
    public static RegexMatchAndSubstitute parseFrom(p pVar) throws IOException {
        return (RegexMatchAndSubstitute) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
    }

    public static RegexMatchAndSubstitute parseFrom(p pVar, f0 f0Var) throws IOException {
