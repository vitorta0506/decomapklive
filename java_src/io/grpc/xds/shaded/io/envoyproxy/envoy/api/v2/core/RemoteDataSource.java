...
public final class RemoteDataSource extends GeneratedMessageV3 implements i0 {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements i0 {
        ...
        private HttpUri f46625e;

        /* renamed from: f  reason: collision with root package name */
        private q2<HttpUri, HttpUri.c, a0> f46626f;

        /* renamed from: g  reason: collision with root package name */
        private Object f46627g;

        /* renamed from: h  reason: collision with root package name */
        private RetryPolicy f46628h;

        /* renamed from: i  reason: collision with root package name */
        private q2<RetryPolicy, RetryPolicy.b, j0> f46629i;
        ...
        protected GeneratedMessageV3.e K() {
            return g.D.d(RemoteDataSource.class, b.class);
        }
        ...
        public RemoteDataSource I() {
            ...
            q2<HttpUri, HttpUri.c, a0> q2Var = this.f46626f;
            if (q2Var == null) {
                remoteDataSource.httpUri_ = this.f46625e;
            } else {
                remoteDataSource.httpUri_ = q2Var.b();
            }
            remoteDataSource.sha256_ = this.f46627g;
            q2<RetryPolicy, RetryPolicy.b, j0> q2Var2 = this.f46629i;
            if (q2Var2 == null) {
                remoteDataSource.retryPolicy_ = this.f46628h;
            } else {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.RemoteDataSource.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.RemoteDataSource.access$800()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.RemoteDataSource.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.RemoteDataSource$b");
        }
        ...
        public b g0(RemoteDataSource remoteDataSource) {
            ...
            if (!remoteDataSource.getSha256().isEmpty()) {
                this.f46627g = remoteDataSource.sha256_;
                R();
            }
        ...
        public b h0(HttpUri httpUri) {
            q2<HttpUri, HttpUri.c, a0> q2Var = this.f46626f;
            if (q2Var == null) {
                HttpUri httpUri2 = this.f46625e;
                if (httpUri2 != null) {
                    this.f46625e = HttpUri.newBuilder(httpUri2).g0(httpUri).I();
                } else {
                    this.f46625e = httpUri;
                }
                R();
            } else {
                q2Var.e(httpUri);
        ...
        public b i0(RetryPolicy retryPolicy) {
            q2<RetryPolicy, RetryPolicy.b, j0> q2Var = this.f46629i;
            if (q2Var == null) {
                RetryPolicy retryPolicy2 = this.f46628h;
                if (retryPolicy2 != null) {
                    this.f46628h = RetryPolicy.newBuilder(retryPolicy2).g0(retryPolicy).I();
                } else {
                    this.f46628h = retryPolicy;
                }
                R();
            } else {
                q2Var.e(retryPolicy);
    ...
    public j0 getRetryPolicyOrBuilder() {
