...
public enum RoutingPriority implements h2 {
    ...
    private static final u0.d<RoutingPriority> internalValueMap = new u0.d<RoutingPriority>() { // from class: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.RoutingPriority.a
