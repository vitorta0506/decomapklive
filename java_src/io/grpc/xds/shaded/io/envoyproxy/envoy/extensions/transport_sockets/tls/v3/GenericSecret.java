...
public final class GenericSecret extends GeneratedMessageV3 implements e {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements e {
        ...
        private DataSource f49976e;

        /* renamed from: f  reason: collision with root package name */
        private q2<DataSource, DataSource.c, n> f49977f;
        ...
        protected GeneratedMessageV3.e K() {
            return i.f50037b.d(GenericSecret.class, b.class);
        }
        ...
        public GenericSecret I() {
            ...
            q2<DataSource, DataSource.c, n> q2Var = this.f49977f;
            if (q2Var == null) {
                genericSecret.secret_ = this.f49976e;
            } else {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.GenericSecret.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.GenericSecret.access$600()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.GenericSecret r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.GenericSecret) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.g0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.GenericSecret r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.GenericSecret) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.GenericSecret.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.GenericSecret$b");
        }
        ...
        public b h0(DataSource dataSource) {
            q2<DataSource, DataSource.c, n> q2Var = this.f49977f;
            if (q2Var == null) {
                DataSource dataSource2 = this.f49976e;
                if (dataSource2 != null) {
                    this.f49976e = DataSource.newBuilder(dataSource2).g0(dataSource).I();
                } else {
                    this.f49976e = dataSource;
                }
                R();
            } else {
                q2Var.e(dataSource);
