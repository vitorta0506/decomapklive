...
public final class QueryParameterMatcher extends GeneratedMessageV3 implements j {
    ...
    public static /* synthetic */ class b {
        ...
        static {
            ...
            try {
                f49157a[QueryParameterMatchSpecifierCase.PRESENT_MATCH.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f49157a[QueryParameterMatchSpecifierCase.QUERYPARAMETERMATCHSPECIFIER_NOT_SET.ordinal()] = 3;
    ...
    public static final class c extends GeneratedMessageV3.b<c> implements j {
        ...
        private q2<StringMatcher, StringMatcher.c, io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.v3.n> f49161h;
        ...
        protected GeneratedMessageV3.e K() {
            return o.X0.d(QueryParameterMatcher.class, c.class);
        }
        ...
        public QueryParameterMatcher I() {
            ...
            queryParameterMatcher.name_ = this.f49160g;
            if (this.f49158e == 5) {
                q2<StringMatcher, StringMatcher.c, io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.v3.n> q2Var = this.f49161h;
                if (q2Var == null) {
                    queryParameterMatcher.queryParameterMatchSpecifier_ = this.f49159f;
                } else {
                    queryParameterMatcher.queryParameterMatchSpecifier_ = q2Var.b();
                }
            }
            if (this.f49158e == 6) {
                queryParameterMatcher.queryParameterMatchSpecifier_ = this.f49159f;
            }
            queryParameterMatcher.queryParameterMatchSpecifierCase_ = this.f49158e;
            Q();
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.route.v3.QueryParameterMatcher.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.route.v3.QueryParameterMatcher.access$800()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.route.v3.QueryParameterMatcher r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.route.v3.QueryParameterMatcher) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.g0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.route.v3.QueryParameterMatcher r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.route.v3.QueryParameterMatcher) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.route.v3.QueryParameterMatcher.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.route.v3.QueryParameterMatcher$c");
        }
        ...
        public c g0(QueryParameterMatcher queryParameterMatcher) {
            ...
            if (!queryParameterMatcher.getName().isEmpty()) {
                this.f49160g = queryParameterMatcher.name_;
                R();
            }
            int i9 = b.f49157a[queryParameterMatcher.getQueryParameterMatchSpecifierCase().ordinal()];
            if (i9 == 1) {
                h0(queryParameterMatcher.getStringMatch());
            } else if (i9 == 2) {
                k0(queryParameterMatcher.getPresentMatch());
            }
        ...
        public c h0(StringMatcher stringMatcher) {
            q2<StringMatcher, StringMatcher.c, io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.v3.n> q2Var = this.f49161h;
            if (q2Var == null) {
                if (this.f49158e == 5 && this.f49159f != StringMatcher.getDefaultInstance()) {
                    this.f49159f = StringMatcher.newBuilder((StringMatcher) this.f49159f).g0(stringMatcher).I();
                } else {
                    this.f49159f = stringMatcher;
                }
                R();
            } else {
                if (this.f49158e == 5) {
        ...
        public c k0(boolean z10) {
            this.f49158e = 6;
            this.f49159f = Boolean.valueOf(z10);
            R();
            return this;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (getName().equals(queryParameterMatcher.getName()) && getQueryParameterMatchSpecifierCase().equals(queryParameterMatcher.getQueryParameterMatchSpecifierCase())) {
                ...
                try {
                    ...
                    if (L != 0) {
                        if (L == 10) {
                            ...
                            StringMatcher.c builder = this.queryParameterMatchSpecifierCase_ == 5 ? ((StringMatcher) this.queryParameterMatchSpecifier_).toBuilder() : null;
                            o1 B = pVar.B(StringMatcher.parser(), f0Var);
                            this.queryParameterMatchSpecifier_ = B;
                            if (builder != null) {
                                builder.g0((StringMatcher) B);
                                this.queryParameterMatchSpecifier_ = builder.I();
                            }
