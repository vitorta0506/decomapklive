...
public final class DeltaDiscoveryRequest extends GeneratedMessageV3 implements r1 {
    ...
    public class a extends com.google.protobuf.c<DeltaDiscoveryRequest> {
        ...
        /* renamed from: G */
        public DeltaDiscoveryRequest m(com.google.protobuf.p pVar, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        private Node f46033f;

        /* renamed from: g  reason: collision with root package name */
        private q2<Node, Node.c, e0> f46034g;

        /* renamed from: h  reason: collision with root package name */
        private Object f46035h;
        ...
        private g1<String, String> f46038k;

        /* renamed from: l  reason: collision with root package name */
        private Object f46039l;

        /* renamed from: m  reason: collision with root package name */
        private Status f46040m;

        /* renamed from: n  reason: collision with root package name */
        private q2<Status, Status.b, com.google.rpc.c> f46041n;
        ...
        private void a0() {
            if ((this.f46032e & 1) == 0) {
                this.f46036i = new y0(this.f46036i);
                this.f46032e |= 1;
            }
        }
        ...
        private void b0() {
            if ((this.f46032e & 2) == 0) {
                this.f46037j = new y0(this.f46037j);
                this.f46032e |= 2;
            }
        }

        private g1<String, String> e0() {
            g1<String, String> g1Var = this.f46038k;
            return g1Var == null ? g1.g(c.f46042a) : g1Var;
        }

        private g1<String, String> g0() {
            R();
            if (this.f46038k == null) {
                this.f46038k = g1.p(c.f46042a);
            }
            if (!this.f46038k.m()) {
                this.f46038k = this.f46038k.f();
            }
            return this.f46038k;
        }
        ...
        protected GeneratedMessageV3.e K() {
            return d.f46799f.d(DeltaDiscoveryRequest.class, b.class);
        }
        ...
        public DeltaDiscoveryRequest I() {
            ...
            q2<Node, Node.c, e0> q2Var = this.f46034g;
            if (q2Var == null) {
                deltaDiscoveryRequest.node_ = this.f46033f;
            } else {
                deltaDiscoveryRequest.node_ = q2Var.b();
            }
            deltaDiscoveryRequest.typeUrl_ = this.f46035h;
            if ((this.f46032e & 1) != 0) {
                this.f46036i = this.f46036i.V0();
                this.f46032e &= -2;
            }
            deltaDiscoveryRequest.resourceNamesSubscribe_ = this.f46036i;
            if ((this.f46032e & 2) != 0) {
                this.f46037j = this.f46037j.V0();
                this.f46032e &= -3;
            }
            deltaDiscoveryRequest.resourceNamesUnsubscribe_ = this.f46037j;
            deltaDiscoveryRequest.initialResourceVersions_ = e0();
            deltaDiscoveryRequest.initialResourceVersions_.n();
            deltaDiscoveryRequest.responseNonce_ = this.f46039l;
            q2<Status, Status.b, com.google.rpc.c> q2Var2 = this.f46041n;
            if (q2Var2 == null) {
                deltaDiscoveryRequest.errorDetail_ = this.f46040m;
            } else {
        ...
        public b i0(Status status) {
            q2<Status, Status.b, com.google.rpc.c> q2Var = this.f46041n;
            if (q2Var == null) {
                Status status2 = this.f46040m;
                if (status2 != null) {
                    this.f46040m = Status.newBuilder(status2).i0(status).I();
                } else {
                    this.f46040m = status;
                }
                R();
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.DeltaDiscoveryRequest.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.DeltaDiscoveryRequest.access$1300()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.DeltaDiscoveryRequest r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.DeltaDiscoveryRequest) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.l0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.DeltaDiscoveryRequest r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.DeltaDiscoveryRequest) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.DeltaDiscoveryRequest.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.DeltaDiscoveryRequest$b");
        }
        ...
        public b l0(DeltaDiscoveryRequest deltaDiscoveryRequest) {
            ...
            if (!deltaDiscoveryRequest.getTypeUrl().isEmpty()) {
                this.f46035h = deltaDiscoveryRequest.typeUrl_;
                R();
            }
            if (!deltaDiscoveryRequest.resourceNamesSubscribe_.isEmpty()) {
                if (this.f46036i.isEmpty()) {
                    this.f46036i = deltaDiscoveryRequest.resourceNamesSubscribe_;
                    this.f46032e &= -2;
                } else {
                    a0();
                    this.f46036i.addAll(deltaDiscoveryRequest.resourceNamesSubscribe_);
                }
                R();
            }
            if (!deltaDiscoveryRequest.resourceNamesUnsubscribe_.isEmpty()) {
                if (this.f46037j.isEmpty()) {
                    this.f46037j = deltaDiscoveryRequest.resourceNamesUnsubscribe_;
                    this.f46032e &= -3;
                } else {
                    b0();
                    this.f46037j.addAll(deltaDiscoveryRequest.resourceNamesUnsubscribe_);
                }
                R();
            }
            g0().o(deltaDiscoveryRequest.internalGetInitialResourceVersions());
            if (!deltaDiscoveryRequest.getResponseNonce().isEmpty()) {
                this.f46039l = deltaDiscoveryRequest.responseNonce_;
                R();
            }
        ...
        public b m0(Node node) {
            q2<Node, Node.c, e0> q2Var = this.f46034g;
            if (q2Var == null) {
                Node node2 = this.f46033f;
                if (node2 != null) {
                    this.f46033f = Node.newBuilder(node2).n0(node).I();
                } else {
                    this.f46033f = node;
                }
                R();
    ...
    public static final class c {
        ...
        static final e1<String, String> f46042a;

        static {
            Descriptors.b bVar = d.f46800g;
            WireFormat.FieldType fieldType = WireFormat.FieldType.STRING;
            f46042a = e1.k(bVar, fieldType, "", fieldType, "");
        }
    }

    /* synthetic */ DeltaDiscoveryRequest(com.google.protobuf.p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((!hasNode() || getNode().equals(deltaDiscoveryRequest.getNode())) && getTypeUrl().equals(deltaDiscoveryRequest.getTypeUrl()) && m1578getResourceNamesSubscribeList().equals(deltaDiscoveryRequest.m1578getResourceNamesSubscribeList()) && m1579getResourceNamesUnsubscribeList().equals(deltaDiscoveryRequest.m1579getResourceNamesUnsubscribeList()) && internalGetInitialResourceVersions().equals(deltaDiscoveryRequest.internalGetInitialResourceVersions()) && getResponseNonce().equals(deltaDiscoveryRequest.getResponseNonce()) && hasErrorDetail() == deltaDiscoveryRequest.hasErrorDetail()) {
    ...
    public int getSerializedSize() {
        ...
        int size = G + i10 + (m1578getResourceNamesSubscribeList().size() * 1);
        int i12 = 0;
        ...
        int size2 = size + i12 + (m1579getResourceNamesUnsubscribeList().size() * 1);
        for (Map.Entry<String, String> entry : internalGetInitialResourceVersions().i().entrySet()) {
            size2 += CodedOutputStream.G(5, c.f46042a.newBuilderForType().N(entry.getKey()).P(entry.getValue()).build());
        }
    ...
    public int hashCode() {
        ...
        if (getResourceNamesSubscribeCount() > 0) {
            hashCode2 = (((hashCode2 * 37) + 3) * 53) + m1578getResourceNamesSubscribeList().hashCode();
        }
        if (getResourceNamesUnsubscribeCount() > 0) {
            hashCode2 = (((hashCode2 * 37) + 4) * 53) + m1579getResourceNamesUnsubscribeList().hashCode();
        }
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        GeneratedMessageV3.serializeStringMapTo(codedOutputStream, internalGetInitialResourceVersions(), c.f46042a, 5);
        if (!GeneratedMessageV3.isStringEmpty(this.responseNonce_)) {
    ...
    public i2 m1578getResourceNamesSubscribeList() {
        return this.resourceNamesSubscribe_;
    }

    /* renamed from: getResourceNamesUnsubscribeList */
    public i2 m1579getResourceNamesUnsubscribeList() {
    ...
    private DeltaDiscoveryRequest(com.google.protobuf.p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
                ...
                try {
                    ...
                    if (L != 0) {
                        if (L == 10) {
                            ...
                            if (!(z11 & true)) {
                                this.initialResourceVersions_ = g1.p(c.f46042a);
                                z11 |= true;
                            }
                            e1 e1Var = (e1) pVar.B(c.f46042a.getParserForType(), f0Var);
    ...
    public static DeltaDiscoveryRequest parseFrom(com.google.protobuf.p pVar) throws IOException {
        return (DeltaDiscoveryRequest) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
    }

    public static DeltaDiscoveryRequest parseFrom(com.google.protobuf.p pVar, f0 f0Var) throws IOException {
