...
public final class UpstreamTlsContext extends GeneratedMessageV3 implements r1 {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        private CommonTlsContext f50017e;

        /* renamed from: f  reason: collision with root package name */
        private q2<CommonTlsContext, CommonTlsContext.c, d> f50018f;

        /* renamed from: g  reason: collision with root package name */
        private Object f50019g;

        /* renamed from: h  reason: collision with root package name */
        private boolean f50020h;

        /* renamed from: i  reason: collision with root package name */
        private UInt32Value f50021i;

        /* renamed from: j  reason: collision with root package name */
        private q2<UInt32Value, UInt32Value.b, e3> f50022j;
        ...
        protected GeneratedMessageV3.e K() {
            return l.f50044b.d(UpstreamTlsContext.class, b.class);
        }
        ...
        public UpstreamTlsContext I() {
            ...
            q2<CommonTlsContext, CommonTlsContext.c, d> q2Var = this.f50018f;
            if (q2Var == null) {
                upstreamTlsContext.commonTlsContext_ = this.f50017e;
            } else {
                upstreamTlsContext.commonTlsContext_ = q2Var.b();
            }
            upstreamTlsContext.sni_ = this.f50019g;
            upstreamTlsContext.allowRenegotiation_ = this.f50020h;
            q2<UInt32Value, UInt32Value.b, e3> q2Var2 = this.f50022j;
            if (q2Var2 == null) {
                upstreamTlsContext.maxSessionKeys_ = this.f50021i;
            } else {
        ...
        public b d0(CommonTlsContext commonTlsContext) {
            q2<CommonTlsContext, CommonTlsContext.c, d> q2Var = this.f50018f;
            if (q2Var == null) {
                CommonTlsContext commonTlsContext2 = this.f50017e;
                if (commonTlsContext2 != null) {
                    this.f50017e = CommonTlsContext.newBuilder(commonTlsContext2).n0(commonTlsContext).I();
                } else {
                    this.f50017e = commonTlsContext;
                }
                R();
            } else {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.UpstreamTlsContext.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.UpstreamTlsContext.access$900()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.UpstreamTlsContext r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.UpstreamTlsContext) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.h0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.UpstreamTlsContext r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.UpstreamTlsContext) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.UpstreamTlsContext.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.UpstreamTlsContext$b");
        }
        ...
        public b h0(UpstreamTlsContext upstreamTlsContext) {
            ...
            if (!upstreamTlsContext.getSni().isEmpty()) {
                this.f50019g = upstreamTlsContext.sni_;
                R();
            }
        ...
        public b i0(UInt32Value uInt32Value) {
            q2<UInt32Value, UInt32Value.b, e3> q2Var = this.f50022j;
            if (q2Var == null) {
                UInt32Value uInt32Value2 = this.f50021i;
                if (uInt32Value2 != null) {
                    this.f50021i = UInt32Value.newBuilder(uInt32Value2).g0(uInt32Value).I();
                } else {
                    this.f50021i = uInt32Value;
                }
                R();
            } else {
                q2Var.e(uInt32Value);
