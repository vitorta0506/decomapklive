...
public final class MetadataMatcher extends GeneratedMessageV3 implements io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.c {
    ...
    public static final class PathSegment extends GeneratedMessageV3 implements d {
        ...
        public static final class b extends GeneratedMessageV3.b<b> implements d {
            ...
            protected GeneratedMessageV3.e K() {
                return io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.d.f50311d.d(PathSegment.class, b.class);
            }
            ...
            public PathSegment I() {
                ...
                if (this.f50273e == 1) {
                    pathSegment.segment_ = this.f50274f;
                }
                pathSegment.segmentCase_ = this.f50273e;
                Q();
                return pathSegment;
            }
            ...
            */
            public io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.MetadataMatcher.PathSegment.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                /*
                    r2 = this;
                    r0 = 0
                    com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.MetadataMatcher.PathSegment.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                ...
                L26:
                    throw r3
                */
                throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.MetadataMatcher.PathSegment.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.MetadataMatcher$PathSegment$b");
            }
            ...
            public b g0(PathSegment pathSegment) {
                ...
                if (b.f50275a[pathSegment.getSegmentCase().ordinal()] == 1) {
                    this.f50273e = 1;
                    this.f50274f = pathSegment.segment_;
                    R();
                }
            ...
            public Descriptors.b getDescriptorForType() {
                return io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.d.f50310c;
            }
    ...
    public class a extends com.google.protobuf.c<MetadataMatcher> {
        ...
        @Override // com.google.protobuf.e2
        /* renamed from: G */
        public MetadataMatcher m(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static /* synthetic */ class b {
        ...
        static final /* synthetic */ int[] f50275a;
        ...
        static {
            ...
            try {
                f50275a[PathSegment.SegmentCase.SEGMENT_NOT_SET.ordinal()] = 2;
    ...
    /* loaded from: classes6.dex */
    public static final class c extends GeneratedMessageV3.b<c> implements io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.c {

        /* renamed from: e  reason: collision with root package name */
        private int f50276e;

        /* renamed from: f  reason: collision with root package name */
        private Object f50277f;

        /* renamed from: g  reason: collision with root package name */
        private List<PathSegment> f50278g;

        /* renamed from: h  reason: collision with root package name */
        private l2<PathSegment, PathSegment.b, d> f50279h;

        /* renamed from: i  reason: collision with root package name */
        private ValueMatcher f50280i;

        /* renamed from: j  reason: collision with root package name */
        private q2<ValueMatcher, ValueMatcher.c, m> f50281j;
        ...
        private void a0() {
            if ((this.f50276e & 1) == 0) {
                this.f50278g = new ArrayList(this.f50278g);
                this.f50276e |= 1;
            }
        }

        private l2<PathSegment, PathSegment.b, d> d0() {
            if (this.f50279h == null) {
                this.f50279h = new l2<>(this.f50278g, (this.f50276e & 1) != 0, H(), O());
                this.f50278g = null;
            }
            return this.f50279h;
        }
        ...
        @Override // com.google.protobuf.GeneratedMessageV3.b
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.d.f50309b.d(MetadataMatcher.class, c.class);
        }
        ...
        public MetadataMatcher I() {
            ...
            metadataMatcher.filter_ = this.f50277f;
            l2<PathSegment, PathSegment.b, d> l2Var = this.f50279h;
            if (l2Var == null) {
                if ((this.f50276e & 1) != 0) {
                    this.f50278g = Collections.unmodifiableList(this.f50278g);
                    this.f50276e &= -2;
                }
                metadataMatcher.path_ = this.f50278g;
            } else {
                metadataMatcher.path_ = l2Var.e();
            }
            q2<ValueMatcher, ValueMatcher.c, m> q2Var = this.f50281j;
            if (q2Var == null) {
                metadataMatcher.value_ = this.f50280i;
            } else {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.MetadataMatcher.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.MetadataMatcher.access$1900()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.MetadataMatcher.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.MetadataMatcher$c");
        }

        @Override // com.google.protobuf.GeneratedMessageV3.b, com.google.protobuf.l1.a, com.google.protobuf.r1
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.d.f50308a;
        }
        ...
        public c i0(MetadataMatcher metadataMatcher) {
            ...
            if (!metadataMatcher.getFilter().isEmpty()) {
                this.f50277f = metadataMatcher.filter_;
                R();
            }
            if (this.f50279h == null) {
                if (!metadataMatcher.path_.isEmpty()) {
                    if (this.f50278g.isEmpty()) {
                        this.f50278g = metadataMatcher.path_;
                        this.f50276e &= -2;
                    } else {
                        a0();
                        this.f50278g.addAll(metadataMatcher.path_);
                    }
                    R();
                }
                ...
                if (this.f50279h.k()) {
                    ...
                    this.f50278g = metadataMatcher.path_;
                    this.f50276e &= -2;
                    this.f50279h = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                } else {
                    this.f50279h.b(metadataMatcher.path_);
                }
            }
        ...
        public c k0(ValueMatcher valueMatcher) {
            q2<ValueMatcher, ValueMatcher.c, m> q2Var = this.f50281j;
            if (q2Var == null) {
                ValueMatcher valueMatcher2 = this.f50280i;
                if (valueMatcher2 != null) {
                    this.f50280i = ValueMatcher.newBuilder(valueMatcher2).h0(valueMatcher).I();
                } else {
                    this.f50280i = valueMatcher;
                }
                R();
            } else {
        ...
        private c() {
            this.f50277f = "";
            this.f50278g = Collections.emptyList();
            e0();
        }
    ...
    /* synthetic */ MetadataMatcher(p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
    ...
    private MetadataMatcher(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
        Objects.requireNonNull(f0Var);
        h3.b h10 = h3.h();
        boolean z10 = false;
    ...
    public static MetadataMatcher parseFrom(p pVar) throws IOException {
        return (MetadataMatcher) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
    }

    public static MetadataMatcher parseFrom(p pVar, f0 f0Var) throws IOException {
