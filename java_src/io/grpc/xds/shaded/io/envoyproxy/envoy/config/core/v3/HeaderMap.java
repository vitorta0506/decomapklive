...
public final class HeaderMap extends GeneratedMessageV3 implements r1 {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        private List<HeaderValue> f47924f;

        /* renamed from: g  reason: collision with root package name */
        private l2<HeaderValue, HeaderValue.b, z> f47925g;
        ...
        private void a0() {
            if ((this.f47923e & 1) == 0) {
                this.f47924f = new ArrayList(this.f47924f);
                this.f47923e |= 1;
            }
        }
        ...
        private l2<HeaderValue, HeaderValue.b, z> d0() {
            if (this.f47925g == null) {
                this.f47925g = new l2<>(this.f47924f, (this.f47923e & 1) != 0, H(), O());
                this.f47924f = null;
            }
            return this.f47925g;
        }
        ...
        protected GeneratedMessageV3.e K() {
            return g.D.d(HeaderMap.class, b.class);
        }
        ...
        public HeaderMap I() {
            ...
            int i9 = this.f47923e;
            l2<HeaderValue, HeaderValue.b, z> l2Var = this.f47925g;
            if (l2Var == null) {
                if ((i9 & 1) != 0) {
                    this.f47924f = Collections.unmodifiableList(this.f47924f);
                    this.f47923e &= -2;
                }
                headerMap.headers_ = this.f47924f;
            } else {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.HeaderMap.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.HeaderMap.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.HeaderMap r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.HeaderMap) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.i0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.HeaderMap r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.HeaderMap) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.HeaderMap.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.HeaderMap$b");
        }
        ...
        public b i0(HeaderMap headerMap) {
            ...
            if (this.f47925g == null) {
                if (!headerMap.headers_.isEmpty()) {
                    if (this.f47924f.isEmpty()) {
                        this.f47924f = headerMap.headers_;
                        this.f47923e &= -2;
                    } else {
                        a0();
                        this.f47924f.addAll(headerMap.headers_);
                    }
                    R();
                }
                ...
                if (this.f47925g.k()) {
                    ...
                    this.f47924f = headerMap.headers_;
                    this.f47923e &= -2;
                    this.f47925g = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                } else {
                    this.f47925g.b(headerMap.headers_);
                }
            }
    ...
    public z getHeadersOrBuilder(int i9) {
        return this.headers_.get(i9);
    }

    public List<? extends z> getHeadersOrBuilderList() {
        return this.headers_;
    }
