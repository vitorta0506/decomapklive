...
public final class Tracing extends GeneratedMessageV3 implements r1 {
    ...
    public static final class Http extends GeneratedMessageV3 implements d {
        ...
        public static final class b extends GeneratedMessageV3.b<b> implements d {
            ...
            private Object f49560f;

            /* renamed from: g  reason: collision with root package name */
            private Object f49561g;

            /* renamed from: h  reason: collision with root package name */
            private q2<Struct, Struct.b, u2> f49562h;

            /* renamed from: i  reason: collision with root package name */
            private q2<Any, Any.b, com.google.protobuf.f> f49563i;
            ...
            protected GeneratedMessageV3.e K() {
                return io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.c.f49582d.d(Http.class, b.class);
            }
            ...
            public Http I() {
                ...
                http.name_ = this.f49561g;
                if (this.f49559e == 2) {
                    q2<Struct, Struct.b, u2> q2Var = this.f49562h;
                    if (q2Var == null) {
                        http.configType_ = this.f49560f;
                    } else {
                        http.configType_ = q2Var.b();
                    }
                }
                if (this.f49559e == 3) {
                    q2<Any, Any.b, com.google.protobuf.f> q2Var2 = this.f49563i;
                    if (q2Var2 == null) {
                        http.configType_ = this.f49560f;
                    } else {
                        http.configType_ = q2Var2.b();
                    }
                }
                http.configTypeCase_ = this.f49559e;
                Q();
                return http;
            }
            ...
            public b d0(Struct struct) {
                q2<Struct, Struct.b, u2> q2Var = this.f49562h;
                if (q2Var == null) {
                    if (this.f49559e == 2 && this.f49560f != Struct.getDefaultInstance()) {
                        this.f49560f = Struct.newBuilder((Struct) this.f49560f).i0(struct).I();
                    } else {
                        this.f49560f = struct;
                    }
                    R();
            ...
            */
            public io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.Tracing.Http.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                /*
                    r2 = this;
                    r0 = 0
                    com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.Tracing.Http.access$800()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.Tracing$Http r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.Tracing.Http) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    if (r3 == 0) goto L10
                    r2.h0(r3)
                L10:
                    return r2
                ...
                L13:
                    ...
                    io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.Tracing$Http r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.Tracing.Http) r4     // Catch: java.lang.Throwable -> L11
                ...
                L26:
                    throw r3
                */
                throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.Tracing.Http.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.Tracing$Http$b");
            }
            ...
            public Descriptors.b getDescriptorForType() {
                return io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.c.f49581c;
            }
            ...
            public b h0(Http http) {
                ...
                if (!http.getName().isEmpty()) {
                    this.f49561g = http.name_;
                    R();
                }
                int i9 = b.f49564a[http.getConfigTypeCase().ordinal()];
                if (i9 == 1) {
                    d0(http.getConfig());
                } else if (i9 == 2) {
                    i0(http.getTypedConfig());
                }
            ...
            public b i0(Any any) {
                q2<Any, Any.b, com.google.protobuf.f> q2Var = this.f49563i;
                if (q2Var == null) {
                    if (this.f49559e == 3 && this.f49560f != Any.getDefaultInstance()) {
                        this.f49560f = Any.newBuilder((Any) this.f49560f).d0(any).I();
                    } else {
                        this.f49560f = any;
                    }
                    R();
        ...
        public boolean equals(Object obj) {
            ...
            if (getName().equals(http.getName()) && getConfigTypeCase().equals(http.getConfigTypeCase())) {
                ...
                if (i9 != 2) {
                    if (i9 == 3 && !getTypedConfig().equals(http.getTypedConfig())) {
                        return false;
                    }
                } else if (!getConfig().equals(http.getConfig())) {
                    return false;
                }
        ...
        public static b newBuilder(Http http) {
            return DEFAULT_INSTANCE.toBuilder().h0(http);
        }
    ...
    public static /* synthetic */ class b {
        ...
        static {
            ...
            f49564a = iArr;
            try {
                iArr[Http.ConfigTypeCase.CONFIG.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f49564a[Http.ConfigTypeCase.TYPED_CONFIG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f49564a[Http.ConfigTypeCase.CONFIGTYPE_NOT_SET.ordinal()] = 3;
    ...
    public static final class c extends GeneratedMessageV3.b<c> implements r1 {
        ...
        /* renamed from: e  reason: collision with root package name */
        private Http f49565e;

        /* renamed from: f  reason: collision with root package name */
        private q2<Http, Http.b, d> f49566f;
        ...
        @Override // com.google.protobuf.GeneratedMessageV3.b
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.c.f49580b.d(Tracing.class, c.class);
        }
        ...
        public Tracing I() {
            ...
            q2<Http, Http.b, d> q2Var = this.f49566f;
            if (q2Var == null) {
                tracing.http_ = this.f49565e;
            } else {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.Tracing.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.Tracing.access$1700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.Tracing r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.Tracing) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.g0(r3)
            L10:
                return r2
            ...
            L13:
                r3 = move-exception
                com.google.protobuf.o1 r4 = r3.getUnfinishedMessage()     // Catch: java.lang.Throwable -> L11
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.Tracing r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.Tracing) r4     // Catch: java.lang.Throwable -> L11
                java.io.IOException r3 = r3.unwrapIOException()     // Catch: java.lang.Throwable -> L1f
                throw r3     // Catch: java.lang.Throwable -> L1f
            L1f:
                r3 = move-exception
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.Tracing.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.Tracing$c");
        }
        ...
        @Override // com.google.protobuf.GeneratedMessageV3.b, com.google.protobuf.l1.a, com.google.protobuf.r1
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.c.f49579a;
        }

        public c h0(Http http) {
            q2<Http, Http.b, d> q2Var = this.f49566f;
            if (q2Var == null) {
                Http http2 = this.f49565e;
                if (http2 != null) {
                    this.f49565e = Http.newBuilder(http2).h0(http).I();
                } else {
                    this.f49565e = http;
                }
                R();
