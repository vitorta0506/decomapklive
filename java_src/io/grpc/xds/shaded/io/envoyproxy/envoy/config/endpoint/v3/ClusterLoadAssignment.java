...
public final class ClusterLoadAssignment extends GeneratedMessageV3 implements io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.a {
    ...
    public static final class Policy extends GeneratedMessageV3 implements d {
        ...
        public static final class DropOverload extends GeneratedMessageV3 implements c {
            ...
            class a extends com.google.protobuf.c<DropOverload> {
                ...
                /* renamed from: G */
                public DropOverload m(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
            ...
            public static final class b extends GeneratedMessageV3.b<b> implements c {
                ...
                private Object f48321e;

                /* renamed from: f  reason: collision with root package name */
                private FractionalPercent f48322f;

                /* renamed from: g  reason: collision with root package name */
                private q2<FractionalPercent, FractionalPercent.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.v3.b> f48323g;
                ...
                protected GeneratedMessageV3.e K() {
                    return f.f48432f.d(DropOverload.class, b.class);
                }
                ...
                public DropOverload I() {
                    ...
                    dropOverload.category_ = this.f48321e;
                    q2<FractionalPercent, FractionalPercent.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.v3.b> q2Var = this.f48323g;
                    if (q2Var == null) {
                        dropOverload.dropPercentage_ = this.f48322f;
                    } else {
                ...
                public b d0(FractionalPercent fractionalPercent) {
                    q2<FractionalPercent, FractionalPercent.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.v3.b> q2Var = this.f48323g;
                    if (q2Var == null) {
                        FractionalPercent fractionalPercent2 = this.f48322f;
                        if (fractionalPercent2 != null) {
                            this.f48322f = FractionalPercent.newBuilder(fractionalPercent2).g0(fractionalPercent).I();
                        } else {
                            this.f48322f = fractionalPercent;
                        }
                        R();
                    } else {
                ...
                */
                public io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment.Policy.DropOverload.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                    /*
                        r2 = this;
                        r0 = 0
                        com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment.Policy.DropOverload.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                        java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                        io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment$Policy$DropOverload r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment.Policy.DropOverload) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                        if (r3 == 0) goto L10
                        r2.h0(r3)
                    L10:
                        return r2
                    ...
                    L13:
                        ...
                        io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment$Policy$DropOverload r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment.Policy.DropOverload) r4     // Catch: java.lang.Throwable -> L11
                    ...
                    L26:
                        throw r3
                    */
                    throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment.Policy.DropOverload.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment$Policy$DropOverload$b");
                }
                ...
                public b h0(DropOverload dropOverload) {
                    ...
                    if (!dropOverload.getCategory().isEmpty()) {
                        this.f48321e = dropOverload.category_;
                        R();
                    }
            ...
            /* synthetic */ DropOverload(p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
                this(pVar, f0Var);
            }
            ...
            public io.grpc.xds.shaded.io.envoyproxy.envoy.type.v3.b getDropPercentageOrBuilder() {
            ...
            private DropOverload(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
                this();
            ...
            public static DropOverload parseFrom(p pVar) throws IOException {
                return (DropOverload) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
            }

            public static DropOverload parseFrom(p pVar, f0 f0Var) throws IOException {
        ...
        public static final class b extends GeneratedMessageV3.b<b> implements d {
            ...
            /* renamed from: f  reason: collision with root package name */
            private List<DropOverload> f48325f;

            /* renamed from: g  reason: collision with root package name */
            private l2<DropOverload, DropOverload.b, c> f48326g;

            /* renamed from: h  reason: collision with root package name */
            private UInt32Value f48327h;

            /* renamed from: i  reason: collision with root package name */
            private q2<UInt32Value, UInt32Value.b, e3> f48328i;

            /* renamed from: j  reason: collision with root package name */
            private Duration f48329j;

            /* renamed from: k  reason: collision with root package name */
            private q2<Duration, Duration.b, v> f48330k;
            ...
            private void a0() {
                if ((this.f48324e & 1) == 0) {
                    this.f48325f = new ArrayList(this.f48325f);
                    this.f48324e |= 1;
                }
            }
            ...
            private l2<DropOverload, DropOverload.b, c> d0() {
                if (this.f48326g == null) {
                    this.f48326g = new l2<>(this.f48325f, (this.f48324e & 1) != 0, H(), O());
                    this.f48325f = null;
                }
                return this.f48326g;
            }
            ...
            @Override // com.google.protobuf.GeneratedMessageV3.b
            protected GeneratedMessageV3.e K() {
                return f.f48430d.d(Policy.class, b.class);
            }
            ...
            public Policy I() {
                ...
                int i9 = this.f48324e;
                l2<DropOverload, DropOverload.b, c> l2Var = this.f48326g;
                if (l2Var == null) {
                    if ((i9 & 1) != 0) {
                        this.f48325f = Collections.unmodifiableList(this.f48325f);
                        this.f48324e &= -2;
                    }
                    policy.dropOverloads_ = this.f48325f;
                } else {
                    policy.dropOverloads_ = l2Var.e();
                }
                q2<UInt32Value, UInt32Value.b, e3> q2Var = this.f48328i;
                if (q2Var == null) {
                    policy.overprovisioningFactor_ = this.f48327h;
                } else {
                    policy.overprovisioningFactor_ = q2Var.b();
                }
                q2<Duration, Duration.b, v> q2Var2 = this.f48330k;
                if (q2Var2 == null) {
                    policy.endpointStaleAfter_ = this.f48329j;
                } else {
            ...
            public b g0(Duration duration) {
                q2<Duration, Duration.b, v> q2Var = this.f48330k;
                if (q2Var == null) {
                    Duration duration2 = this.f48329j;
                    if (duration2 != null) {
                        this.f48329j = Duration.newBuilder(duration2).e0(duration).I();
                    } else {
                        this.f48329j = duration;
                    }
                    R();
                } else {
                    q2Var.e(duration);
            ...
            /*
                ...
                To view partially-correct add '--show-bad-code' argument
            */
            public io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment.Policy.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                /*
                    r2 = this;
                    r0 = 0
                    com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment.Policy.access$1900()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment$Policy r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment.Policy) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    if (r3 == 0) goto L10
                    r2.j0(r3)
                L10:
                    return r2
                ...
                L13:
                    r3 = move-exception
                    com.google.protobuf.o1 r4 = r3.getUnfinishedMessage()     // Catch: java.lang.Throwable -> L11
                    io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment$Policy r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment.Policy) r4     // Catch: java.lang.Throwable -> L11
                    java.io.IOException r3 = r3.unwrapIOException()     // Catch: java.lang.Throwable -> L1f
                    throw r3     // Catch: java.lang.Throwable -> L1f
                L1f:
                    r3 = move-exception
                ...
                L26:
                    throw r3
                */
                throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment.Policy.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment$Policy$b");
            }
            ...
            public b j0(Policy policy) {
                ...
                if (this.f48326g == null) {
                    if (!policy.dropOverloads_.isEmpty()) {
                        if (this.f48325f.isEmpty()) {
                            this.f48325f = policy.dropOverloads_;
                            this.f48324e &= -2;
                        } else {
                            a0();
                            this.f48325f.addAll(policy.dropOverloads_);
                        }
                        R();
                    }
                    ...
                    if (this.f48326g.k()) {
                        ...
                        this.f48325f = policy.dropOverloads_;
                        this.f48324e &= -2;
                        this.f48326g = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                    } else {
                        this.f48326g.b(policy.dropOverloads_);
                    }
                }
            ...
            public b k0(UInt32Value uInt32Value) {
                q2<UInt32Value, UInt32Value.b, e3> q2Var = this.f48328i;
                if (q2Var == null) {
                    UInt32Value uInt32Value2 = this.f48327h;
                    if (uInt32Value2 != null) {
                        this.f48327h = UInt32Value.newBuilder(uInt32Value2).g0(uInt32Value).I();
                    } else {
                        this.f48327h = uInt32Value;
                    }
                    R();
                } else {
                    q2Var.e(uInt32Value);
            ...
            private b() {
                this.f48325f = Collections.emptyList();
                e0();
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (getDropOverloadsList().equals(policy.getDropOverloadsList()) && hasOverprovisioningFactor() == policy.hasOverprovisioningFactor()) {
                if ((!hasOverprovisioningFactor() || getOverprovisioningFactor().equals(policy.getOverprovisioningFactor())) && hasEndpointStaleAfter() == policy.hasEndpointStaleAfter()) {
                    return (!hasEndpointStaleAfter() || getEndpointStaleAfter().equals(policy.getEndpointStaleAfter())) && this.unknownFields.equals(policy.unknownFields);
                }
                return false;
            }
            return false;
    ...
    public class a extends com.google.protobuf.c<ClusterLoadAssignment> {
        ...
        @Override // com.google.protobuf.e2
        /* renamed from: G */
        public ClusterLoadAssignment m(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
            return new ClusterLoadAssignment(pVar, f0Var, null);
        }
    }

    /* loaded from: classes6.dex */
    public static final class b extends GeneratedMessageV3.b<b> implements io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.a {

        /* renamed from: e  reason: collision with root package name */
        private int f48331e;

        /* renamed from: f  reason: collision with root package name */
        private Object f48332f;

        /* renamed from: g  reason: collision with root package name */
        private List<LocalityLbEndpoints> f48333g;

        /* renamed from: h  reason: collision with root package name */
        private l2<LocalityLbEndpoints, LocalityLbEndpoints.c, j> f48334h;

        /* renamed from: i  reason: collision with root package name */
        private g1<String, Endpoint> f48335i;

        /* renamed from: j  reason: collision with root package name */
        private Policy f48336j;

        /* renamed from: k  reason: collision with root package name */
        private q2<Policy, Policy.b, d> f48337k;
        ...
        private void a0() {
            if ((this.f48331e & 1) == 0) {
                this.f48333g = new ArrayList(this.f48333g);
                this.f48331e |= 1;
            }
        }

        private l2<LocalityLbEndpoints, LocalityLbEndpoints.c, j> d0() {
            if (this.f48334h == null) {
                this.f48334h = new l2<>(this.f48333g, (this.f48331e & 1) != 0, H(), O());
                this.f48333g = null;
            }
            return this.f48334h;
        }
        ...
        private g1<String, Endpoint> e0() {
            ...
            if (this.f48335i == null) {
                this.f48335i = g1.p(c.f48338a);
            }
            if (!this.f48335i.m()) {
                this.f48335i = this.f48335i.f();
            }
            return this.f48335i;
        }

        private g1<String, Endpoint> g0() {
            g1<String, Endpoint> g1Var = this.f48335i;
            return g1Var == null ? g1.g(c.f48338a) : g1Var;
        }
        ...
        @Override // com.google.protobuf.GeneratedMessageV3.b
        protected GeneratedMessageV3.e K() {
            return f.f48428b.d(ClusterLoadAssignment.class, b.class);
        }
        ...
        public ClusterLoadAssignment I() {
            ...
            clusterLoadAssignment.clusterName_ = this.f48332f;
            l2<LocalityLbEndpoints, LocalityLbEndpoints.c, j> l2Var = this.f48334h;
            if (l2Var == null) {
                if ((this.f48331e & 1) != 0) {
                    this.f48333g = Collections.unmodifiableList(this.f48333g);
                    this.f48331e &= -2;
                }
                clusterLoadAssignment.endpoints_ = this.f48333g;
            } else {
                clusterLoadAssignment.endpoints_ = l2Var.e();
            }
            clusterLoadAssignment.namedEndpoints_ = g0();
            clusterLoadAssignment.namedEndpoints_.n();
            q2<Policy, Policy.b, d> q2Var = this.f48337k;
            if (q2Var == null) {
                clusterLoadAssignment.policy_ = this.f48336j;
            } else {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment.access$3200()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.k0(r3)
            L10:
                return r2
            ...
            L13:
                r3 = move-exception
                com.google.protobuf.o1 r4 = r3.getUnfinishedMessage()     // Catch: java.lang.Throwable -> L11
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment) r4     // Catch: java.lang.Throwable -> L11
                java.io.IOException r3 = r3.unwrapIOException()     // Catch: java.lang.Throwable -> L1f
                throw r3     // Catch: java.lang.Throwable -> L1f
            L1f:
                r3 = move-exception
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterLoadAssignment$b");
        }
        ...
        public b k0(ClusterLoadAssignment clusterLoadAssignment) {
            ...
            if (!clusterLoadAssignment.getClusterName().isEmpty()) {
                this.f48332f = clusterLoadAssignment.clusterName_;
                R();
            }
            if (this.f48334h == null) {
                if (!clusterLoadAssignment.endpoints_.isEmpty()) {
                    if (this.f48333g.isEmpty()) {
                        this.f48333g = clusterLoadAssignment.endpoints_;
                        this.f48331e &= -2;
                    } else {
                        a0();
                        this.f48333g.addAll(clusterLoadAssignment.endpoints_);
                    }
                    R();
                }
                ...
                if (this.f48334h.k()) {
                    ...
                    this.f48333g = clusterLoadAssignment.endpoints_;
                    this.f48331e &= -2;
                    this.f48334h = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                } else {
                    this.f48334h.b(clusterLoadAssignment.endpoints_);
                }
            }
        ...
        public b l0(Policy policy) {
            q2<Policy, Policy.b, d> q2Var = this.f48337k;
            if (q2Var == null) {
                Policy policy2 = this.f48336j;
                if (policy2 != null) {
                    this.f48336j = Policy.newBuilder(policy2).j0(policy).I();
                } else {
                    this.f48336j = policy;
                }
                R();
        ...
        private b() {
            this.f48332f = "";
            this.f48333g = Collections.emptyList();
            h0();
        }
    ...
    public static final class c {
        ...
        static final e1<String, Endpoint> f48338a = e1.k(f.f48433g, WireFormat.FieldType.STRING, "", WireFormat.FieldType.MESSAGE, Endpoint.getDefaultInstance());
    }
    ...
    /* synthetic */ ClusterLoadAssignment(p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
    ...
    public j getEndpointsOrBuilder(int i9) {
        return this.endpoints_.get(i9);
    }

    public List<? extends j> getEndpointsOrBuilderList() {
        return this.endpoints_;
    }
    ...
    public int getSerializedSize() {
        ...
        for (Map.Entry<String, Endpoint> entry : internalGetNamedEndpoints().i().entrySet()) {
            computeStringSize += CodedOutputStream.G(5, c.f48338a.newBuilderForType().N(entry.getKey()).P(entry.getValue()).build());
        }
        int serializedSize = computeStringSize + this.unknownFields.getSerializedSize();
        this.memoizedSize = serializedSize;
        return serializedSize;
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        GeneratedMessageV3.serializeStringMapTo(codedOutputStream, internalGetNamedEndpoints(), c.f48338a, 5);
        this.unknownFields.writeTo(codedOutputStream);
    }
    ...
    private ClusterLoadAssignment(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
        Objects.requireNonNull(f0Var);
        h3.b h10 = h3.h();
        boolean z10 = false;
                ...
                try {
                    ...
                    if (L != 0) {
                        if (L == 10) {
                            ...
                            if (!(z11 & true)) {
                                this.namedEndpoints_ = g1.p(c.f48338a);
                                z11 |= true;
                            }
                            e1 e1Var = (e1) pVar.B(c.f48338a.getParserForType(), f0Var);
    ...
    public static ClusterLoadAssignment parseFrom(p pVar) throws IOException {
        return (ClusterLoadAssignment) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
    }

    public static ClusterLoadAssignment parseFrom(p pVar, f0 f0Var) throws IOException {
