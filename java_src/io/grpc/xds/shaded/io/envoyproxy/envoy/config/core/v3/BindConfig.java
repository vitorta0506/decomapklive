...
public final class BindConfig extends GeneratedMessageV3 implements h {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements h {
        ...
        private SocketAddress f47796f;

        /* renamed from: g  reason: collision with root package name */
        private q2<SocketAddress, SocketAddress.c, b1> f47797g;

        /* renamed from: h  reason: collision with root package name */
        private BoolValue f47798h;

        /* renamed from: i  reason: collision with root package name */
        private q2<BoolValue, BoolValue.b, com.google.protobuf.l> f47799i;

        /* renamed from: j  reason: collision with root package name */
        private List<SocketOption> f47800j;

        /* renamed from: k  reason: collision with root package name */
        private l2<SocketOption, SocketOption.c, c1> f47801k;
        ...
        private void a0() {
            if ((this.f47795e & 1) == 0) {
                this.f47800j = new ArrayList(this.f47800j);
                this.f47795e |= 1;
            }
        }

        private l2<SocketOption, SocketOption.c, c1> d0() {
            if (this.f47801k == null) {
                this.f47801k = new l2<>(this.f47800j, (this.f47795e & 1) != 0, H(), O());
                this.f47800j = null;
            }
            return this.f47801k;
        }
        ...
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.b.f48178j.d(BindConfig.class, b.class);
        }
        ...
        public BindConfig I() {
            ...
            q2<SocketAddress, SocketAddress.c, b1> q2Var = this.f47797g;
            if (q2Var == null) {
                bindConfig.sourceAddress_ = this.f47796f;
            } else {
                bindConfig.sourceAddress_ = q2Var.b();
            }
            q2<BoolValue, BoolValue.b, com.google.protobuf.l> q2Var2 = this.f47799i;
            if (q2Var2 == null) {
                bindConfig.freebind_ = this.f47798h;
            } else {
                bindConfig.freebind_ = q2Var2.b();
            }
            l2<SocketOption, SocketOption.c, c1> l2Var = this.f47801k;
            if (l2Var == null) {
                if ((this.f47795e & 1) != 0) {
                    this.f47800j = Collections.unmodifiableList(this.f47800j);
                    this.f47795e &= -2;
                }
                bindConfig.socketOptions_ = this.f47800j;
            } else {
        ...
        public b g0(BoolValue boolValue) {
            q2<BoolValue, BoolValue.b, com.google.protobuf.l> q2Var = this.f47799i;
            if (q2Var == null) {
                BoolValue boolValue2 = this.f47798h;
                if (boolValue2 != null) {
                    this.f47798h = BoolValue.newBuilder(boolValue2).d0(boolValue).I();
                } else {
                    this.f47798h = boolValue;
                }
                R();
            } else {
                q2Var.e(boolValue);
        ...
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.b.f48177i;
        }
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.BindConfig.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.BindConfig.access$900()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.BindConfig r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.BindConfig) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.j0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.BindConfig r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.BindConfig) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.BindConfig.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.BindConfig$b");
        }
        ...
        public b j0(BindConfig bindConfig) {
            ...
            if (this.f47801k == null) {
                if (!bindConfig.socketOptions_.isEmpty()) {
                    if (this.f47800j.isEmpty()) {
                        this.f47800j = bindConfig.socketOptions_;
                        this.f47795e &= -2;
                    } else {
                        a0();
                        this.f47800j.addAll(bindConfig.socketOptions_);
                    }
                    R();
                }
                ...
                if (this.f47801k.k()) {
                    ...
                    this.f47800j = bindConfig.socketOptions_;
                    this.f47795e &= -2;
                    this.f47801k = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                } else {
                    this.f47801k.b(bindConfig.socketOptions_);
                }
            }
        ...
        public b k0(SocketAddress socketAddress) {
            q2<SocketAddress, SocketAddress.c, b1> q2Var = this.f47797g;
            if (q2Var == null) {
                SocketAddress socketAddress2 = this.f47796f;
                if (socketAddress2 != null) {
                    this.f47796f = SocketAddress.newBuilder(socketAddress2).g0(socketAddress).I();
                } else {
                    this.f47796f = socketAddress;
                }
                R();
            } else {
        ...
        private b() {
            this.f47800j = Collections.emptyList();
            e0();
        }
    ...
    public b1 getSourceAddressOrBuilder() {
