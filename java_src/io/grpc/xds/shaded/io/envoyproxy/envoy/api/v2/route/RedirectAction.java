...
public final class RedirectAction extends GeneratedMessageV3 implements i {
    ...
    public static /* synthetic */ class b {
        ...
        static final /* synthetic */ int[] f47081b;
        ...
        static {
            ...
            try {
                f47081b[PathRewriteSpecifierCase.PREFIX_REWRITE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f47081b[PathRewriteSpecifierCase.PATHREWRITESPECIFIER_NOT_SET.ordinal()] = 3;
            ...
            try {
                f47080a[SchemeRewriteSpecifierCase.SCHEME_REDIRECT.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f47080a[SchemeRewriteSpecifierCase.SCHEMEREWRITESPECIFIER_NOT_SET.ordinal()] = 3;
    ...
    public static final class c extends GeneratedMessageV3.b<c> implements i {
        ...
        private Object f47083f;

        /* renamed from: g  reason: collision with root package name */
        private int f47084g;

        /* renamed from: h  reason: collision with root package name */
        private Object f47085h;

        /* renamed from: i  reason: collision with root package name */
        private Object f47086i;
        ...
        protected GeneratedMessageV3.e K() {
            return l.f47298h0.d(RedirectAction.class, c.class);
        }
        ...
        public RedirectAction I() {
            ...
            if (this.f47082e == 4) {
                redirectAction.schemeRewriteSpecifier_ = this.f47083f;
            }
            if (this.f47082e == 7) {
                redirectAction.schemeRewriteSpecifier_ = this.f47083f;
            }
            redirectAction.hostRedirect_ = this.f47086i;
            redirectAction.portRedirect_ = this.f47087j;
            if (this.f47084g == 2) {
                redirectAction.pathRewriteSpecifier_ = this.f47085h;
            }
            if (this.f47084g == 5) {
                redirectAction.pathRewriteSpecifier_ = this.f47085h;
            }
            redirectAction.responseCode_ = this.f47088k;
            redirectAction.stripQuery_ = this.f47089l;
            redirectAction.schemeRewriteSpecifierCase_ = this.f47082e;
            redirectAction.pathRewriteSpecifierCase_ = this.f47084g;
            Q();
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.RedirectAction.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.RedirectAction.access$1300()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.RedirectAction.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.RedirectAction$c");
        }
        ...
        public c g0(RedirectAction redirectAction) {
            ...
            if (!redirectAction.getHostRedirect().isEmpty()) {
                this.f47086i = redirectAction.hostRedirect_;
                R();
            }
            if (redirectAction.getPortRedirect() != 0) {
                k0(redirectAction.getPortRedirect());
            }
            if (redirectAction.responseCode_ != 0) {
                l0(redirectAction.getResponseCodeValue());
            }
            if (redirectAction.getStripQuery()) {
                m0(redirectAction.getStripQuery());
            }
            int i9 = b.f47080a[redirectAction.getSchemeRewriteSpecifierCase().ordinal()];
            if (i9 == 1) {
                j0(redirectAction.getHttpsRedirect());
            } else if (i9 == 2) {
                this.f47082e = 7;
                this.f47083f = redirectAction.schemeRewriteSpecifier_;
                R();
            }
            int i10 = b.f47081b[redirectAction.getPathRewriteSpecifierCase().ordinal()];
            if (i10 == 1) {
                this.f47084g = 2;
                this.f47085h = redirectAction.pathRewriteSpecifier_;
                R();
            } else if (i10 == 2) {
                this.f47084g = 5;
                this.f47085h = redirectAction.pathRewriteSpecifier_;
        ...
        public c j0(boolean z10) {
            this.f47082e = 4;
            this.f47083f = Boolean.valueOf(z10);
            R();
            return this;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (getHostRedirect().equals(redirectAction.getHostRedirect()) && getPortRedirect() == redirectAction.getPortRedirect() && this.responseCode_ == redirectAction.responseCode_ && getStripQuery() == redirectAction.getStripQuery() && getSchemeRewriteSpecifierCase().equals(redirectAction.getSchemeRewriteSpecifierCase())) {
            ...
            if (getPathRewriteSpecifierCase().equals(redirectAction.getPathRewriteSpecifierCase())) {
                ...
                if (i10 != 2) {
                    if (i10 == 5 && !getPrefixRewrite().equals(redirectAction.getPrefixRewrite())) {
                        return false;
                    }
