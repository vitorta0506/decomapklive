...
public final class HttpProtocolOptions extends GeneratedMessageV3 implements f0 {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements f0 {
        ...
        private Duration f48034e;

        /* renamed from: f  reason: collision with root package name */
        private q2<Duration, Duration.b, com.google.protobuf.v> f48035f;

        /* renamed from: g  reason: collision with root package name */
        private Duration f48036g;

        /* renamed from: h  reason: collision with root package name */
        private q2<Duration, Duration.b, com.google.protobuf.v> f48037h;

        /* renamed from: i  reason: collision with root package name */
        private UInt32Value f48038i;

        /* renamed from: j  reason: collision with root package name */
        private q2<UInt32Value, UInt32Value.b, e3> f48039j;

        /* renamed from: k  reason: collision with root package name */
        private Duration f48040k;

        /* renamed from: l  reason: collision with root package name */
        private q2<Duration, Duration.b, com.google.protobuf.v> f48041l;

        /* renamed from: m  reason: collision with root package name */
        private int f48042m;

        /* renamed from: n  reason: collision with root package name */
        private UInt32Value f48043n;

        /* renamed from: o  reason: collision with root package name */
        private q2<UInt32Value, UInt32Value.b, e3> f48044o;
        ...
        protected GeneratedMessageV3.e K() {
            return n0.f48262j.d(HttpProtocolOptions.class, b.class);
        }
        ...
        public HttpProtocolOptions I() {
            ...
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var = this.f48035f;
            if (q2Var == null) {
                httpProtocolOptions.idleTimeout_ = this.f48034e;
            } else {
                httpProtocolOptions.idleTimeout_ = q2Var.b();
            }
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var2 = this.f48037h;
            if (q2Var2 == null) {
                httpProtocolOptions.maxConnectionDuration_ = this.f48036g;
            } else {
                httpProtocolOptions.maxConnectionDuration_ = q2Var2.b();
            }
            q2<UInt32Value, UInt32Value.b, e3> q2Var3 = this.f48039j;
            if (q2Var3 == null) {
                httpProtocolOptions.maxHeadersCount_ = this.f48038i;
            } else {
                httpProtocolOptions.maxHeadersCount_ = q2Var3.b();
            }
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var4 = this.f48041l;
            if (q2Var4 == null) {
                httpProtocolOptions.maxStreamDuration_ = this.f48040k;
            } else {
                httpProtocolOptions.maxStreamDuration_ = q2Var4.b();
            }
            httpProtocolOptions.headersWithUnderscoresAction_ = this.f48042m;
            q2<UInt32Value, UInt32Value.b, e3> q2Var5 = this.f48044o;
            if (q2Var5 == null) {
                httpProtocolOptions.maxRequestsPerConnection_ = this.f48043n;
            } else {
                httpProtocolOptions.maxRequestsPerConnection_ = q2Var5.b();
            }
            Q();
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.HttpProtocolOptions.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.HttpProtocolOptions.access$1100()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.HttpProtocolOptions r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.HttpProtocolOptions) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.g0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.HttpProtocolOptions r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.HttpProtocolOptions) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.HttpProtocolOptions.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.HttpProtocolOptions$b");
        }
        ...
        public b g0(HttpProtocolOptions httpProtocolOptions) {
            ...
            if (httpProtocolOptions.hasMaxStreamDuration()) {
                l0(httpProtocolOptions.getMaxStreamDuration());
            }
            if (httpProtocolOptions.headersWithUnderscoresAction_ != 0) {
                o0(httpProtocolOptions.getHeadersWithUnderscoresActionValue());
            }
            if (httpProtocolOptions.hasMaxRequestsPerConnection()) {
                k0(httpProtocolOptions.getMaxRequestsPerConnection());
            }
        ...
        public b h0(Duration duration) {
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var = this.f48035f;
            if (q2Var == null) {
                Duration duration2 = this.f48034e;
                if (duration2 != null) {
                    this.f48034e = Duration.newBuilder(duration2).e0(duration).I();
                } else {
                    this.f48034e = duration;
                }
                R();
            } else {
                q2Var.e(duration);
        ...
        public b i0(Duration duration) {
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var = this.f48037h;
            if (q2Var == null) {
                Duration duration2 = this.f48036g;
                if (duration2 != null) {
                    this.f48036g = Duration.newBuilder(duration2).e0(duration).I();
                } else {
                    this.f48036g = duration;
                }
                R();
            } else {
                q2Var.e(duration);
        ...
        public b j0(UInt32Value uInt32Value) {
            q2<UInt32Value, UInt32Value.b, e3> q2Var = this.f48039j;
            if (q2Var == null) {
                UInt32Value uInt32Value2 = this.f48038i;
                if (uInt32Value2 != null) {
                    this.f48038i = UInt32Value.newBuilder(uInt32Value2).g0(uInt32Value).I();
                } else {
                    this.f48038i = uInt32Value;
                }
                R();
            } else {
                q2Var.e(uInt32Value);
        ...
        public b k0(UInt32Value uInt32Value) {
            q2<UInt32Value, UInt32Value.b, e3> q2Var = this.f48044o;
            if (q2Var == null) {
                UInt32Value uInt32Value2 = this.f48043n;
                if (uInt32Value2 != null) {
                    this.f48043n = UInt32Value.newBuilder(uInt32Value2).g0(uInt32Value).I();
                } else {
                    this.f48043n = uInt32Value;
                }
                R();
            } else {
                q2Var.e(uInt32Value);
        ...
        public b l0(Duration duration) {
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var = this.f48041l;
            if (q2Var == null) {
                Duration duration2 = this.f48040k;
                if (duration2 != null) {
                    this.f48040k = Duration.newBuilder(duration2).e0(duration).I();
                } else {
                    this.f48040k = duration;
                }
                R();
            } else {
                q2Var.e(duration);
        ...
        if ((!hasIdleTimeout() || getIdleTimeout().equals(httpProtocolOptions.getIdleTimeout())) && hasMaxConnectionDuration() == httpProtocolOptions.hasMaxConnectionDuration()) {
            if ((!hasMaxConnectionDuration() || getMaxConnectionDuration().equals(httpProtocolOptions.getMaxConnectionDuration())) && hasMaxHeadersCount() == httpProtocolOptions.hasMaxHeadersCount()) {
                if ((!hasMaxHeadersCount() || getMaxHeadersCount().equals(httpProtocolOptions.getMaxHeadersCount())) && hasMaxStreamDuration() == httpProtocolOptions.hasMaxStreamDuration()) {
                    if ((!hasMaxStreamDuration() || getMaxStreamDuration().equals(httpProtocolOptions.getMaxStreamDuration())) && this.headersWithUnderscoresAction_ == httpProtocolOptions.headersWithUnderscoresAction_ && hasMaxRequestsPerConnection() == httpProtocolOptions.hasMaxRequestsPerConnection()) {
                        return (!hasMaxRequestsPerConnection() || getMaxRequestsPerConnection().equals(httpProtocolOptions.getMaxRequestsPerConnection())) && this.unknownFields.equals(httpProtocolOptions.unknownFields);
                    }
                    return false;
                }
                return false;
    ...
    public int getSerializedSize() {
        ...
        if (this.maxRequestsPerConnection_ != null) {
            G += CodedOutputStream.G(6, getMaxRequestsPerConnection());
        }
    ...
    public int hashCode() {
        ...
        int i10 = (((hashCode * 37) + 5) * 53) + this.headersWithUnderscoresAction_;
        if (hasMaxRequestsPerConnection()) {
            i10 = (((i10 * 37) + 6) * 53) + getMaxRequestsPerConnection().hashCode();
        }
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        if (this.maxRequestsPerConnection_ != null) {
            codedOutputStream.L0(6, getMaxRequestsPerConnection());
        }
                        ...
                        if (L != 0) {
                            if (L == 10) {
                                ...
                                if (builder5 != null) {
                                    ...
                                    this.maxRequestsPerConnection_ = builder5.I();
                                }
                            }
                        }
                        z10 = true;
