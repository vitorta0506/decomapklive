...
public final class Extension extends GeneratedMessageV3 implements q {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements q {
        ...
        private Object f46408e;

        /* renamed from: f  reason: collision with root package name */
        private Object f46409f;

        /* renamed from: g  reason: collision with root package name */
        private Object f46410g;

        /* renamed from: h  reason: collision with root package name */
        private BuildVersion f46411h;

        /* renamed from: i  reason: collision with root package name */
        private q2<BuildVersion, BuildVersion.b, i> f46412i;

        /* renamed from: j  reason: collision with root package name */
        private boolean f46413j;
        ...
        protected GeneratedMessageV3.e K() {
            return g.f46697f.d(Extension.class, b.class);
        }
        ...
        public Extension I() {
            ...
            extension.name_ = this.f46408e;
            extension.category_ = this.f46409f;
            extension.typeDescriptor_ = this.f46410g;
            q2<BuildVersion, BuildVersion.b, i> q2Var = this.f46412i;
            if (q2Var == null) {
                extension.version_ = this.f46411h;
            } else {
                extension.version_ = q2Var.b();
            }
            extension.disabled_ = this.f46413j;
            Q();
            return extension;
        }
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.Extension.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.Extension.access$1000()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.Extension.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.Extension$b");
        }
        ...
        public b g0(Extension extension) {
            ...
            if (!extension.getName().isEmpty()) {
                this.f46408e = extension.name_;
                R();
            }
            if (!extension.getCategory().isEmpty()) {
                this.f46409f = extension.category_;
                R();
            }
            if (!extension.getTypeDescriptor().isEmpty()) {
                this.f46410g = extension.typeDescriptor_;
                R();
            }
        ...
        public b i0(BuildVersion buildVersion) {
            q2<BuildVersion, BuildVersion.b, i> q2Var = this.f46412i;
            if (q2Var == null) {
                BuildVersion buildVersion2 = this.f46411h;
                if (buildVersion2 != null) {
                    this.f46411h = BuildVersion.newBuilder(buildVersion2).g0(buildVersion).I();
                } else {
                    this.f46411h = buildVersion;
                }
                R();
            } else {
    ...
    public int hashCode() {
        ...
        int d10 = (((((hashCode * 37) + 5) * 53) + u0.d(getDisabled())) * 29) + this.unknownFields.hashCode();
