...
public final class LoadStatsResponse extends GeneratedMessageV3 implements r1 {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        private Duration f50141h;

        /* renamed from: i  reason: collision with root package name */
        private q2<Duration, Duration.b, v> f50142i;

        /* renamed from: j  reason: collision with root package name */
        private boolean f50143j;
        ...
        private void a0() {
            if ((this.f50138e & 1) == 0) {
                this.f50139f = new y0(this.f50139f);
                this.f50138e |= 1;
            }
        }
        ...
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v2.b.f50149d.d(LoadStatsResponse.class, b.class);
        }
        ...
        public LoadStatsResponse I() {
            ...
            if ((this.f50138e & 1) != 0) {
                this.f50139f = this.f50139f.V0();
                this.f50138e &= -2;
            }
            loadStatsResponse.clusters_ = this.f50139f;
            loadStatsResponse.sendAllClusters_ = this.f50140g;
            q2<Duration, Duration.b, v> q2Var = this.f50142i;
            if (q2Var == null) {
                loadStatsResponse.loadReportingInterval_ = this.f50141h;
            } else {
                loadStatsResponse.loadReportingInterval_ = q2Var.b();
            }
            loadStatsResponse.reportEndpointGranularity_ = this.f50143j;
            Q();
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v2.LoadStatsResponse.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v2.LoadStatsResponse.access$900()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v2.LoadStatsResponse r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v2.LoadStatsResponse) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.h0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v2.LoadStatsResponse r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v2.LoadStatsResponse) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v2.LoadStatsResponse.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v2.LoadStatsResponse$b");
        }
        ...
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.service.load_stats.v2.b.f50148c;
        }
        ...
        public b h0(LoadStatsResponse loadStatsResponse) {
            ...
            if (!loadStatsResponse.clusters_.isEmpty()) {
                if (this.f50139f.isEmpty()) {
                    this.f50139f = loadStatsResponse.clusters_;
                    this.f50138e &= -2;
                } else {
                    a0();
                    this.f50139f.addAll(loadStatsResponse.clusters_);
                }
                R();
            }
        ...
        public b i0(Duration duration) {
            q2<Duration, Duration.b, v> q2Var = this.f50142i;
            if (q2Var == null) {
                Duration duration2 = this.f50141h;
                if (duration2 != null) {
                    this.f50141h = Duration.newBuilder(duration2).e0(duration).I();
                } else {
                    this.f50141h = duration;
                }
                R();
            } else {
                q2Var.e(duration);
    ...
    public boolean equals(Object obj) {
        ...
        if (m1646getClustersList().equals(loadStatsResponse.m1646getClustersList()) && getSendAllClusters() == loadStatsResponse.getSendAllClusters() && hasLoadReportingInterval() == loadStatsResponse.hasLoadReportingInterval()) {
    ...
    public int getSerializedSize() {
        ...
        int size = 0 + i10 + (m1646getClustersList().size() * 1);
    ...
    public int hashCode() {
        ...
        if (getClustersCount() > 0) {
            hashCode = (((hashCode * 37) + 1) * 53) + m1646getClustersList().hashCode();
        }
    ...
    public i2 m1646getClustersList() {
