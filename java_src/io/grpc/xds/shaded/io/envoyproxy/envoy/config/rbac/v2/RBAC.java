...
public final class RBAC extends GeneratedMessageV3 implements r1 {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        private g1<String, Policy> f49028f;
        ...
        private g1<String, Policy> b0() {
            ...
            if (this.f49028f == null) {
                this.f49028f = g1.p(c.f49029a);
            }
            if (!this.f49028f.m()) {
                this.f49028f = this.f49028f.f();
            }
            return this.f49028f;
        }

        private g1<String, Policy> d0() {
            g1<String, Policy> g1Var = this.f49028f;
            return g1Var == null ? g1.g(c.f49029a) : g1Var;
        }
        ...
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.config.rbac.v2.c.f49031b.d(RBAC.class, b.class);
        }
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.rbac.v2.RBAC.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.rbac.v2.RBAC.access$800()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.rbac.v2.RBAC.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.rbac.v2.RBAC$b");
        }

        @Override // com.google.protobuf.GeneratedMessageV3.b, com.google.protobuf.l1.a, com.google.protobuf.r1
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.config.rbac.v2.c.f49030a;
        }
    ...
    public static final class c {
        ...
        static final e1<String, Policy> f49029a = e1.k(io.grpc.xds.shaded.io.envoyproxy.envoy.config.rbac.v2.c.f49032c, WireFormat.FieldType.STRING, "", WireFormat.FieldType.MESSAGE, Policy.getDefaultInstance());
    }
    ...
    public int getSerializedSize() {
        ...
        for (Map.Entry<String, Policy> entry : internalGetPolicies().i().entrySet()) {
            l10 += CodedOutputStream.G(2, c.f49029a.newBuilderForType().N(entry.getKey()).P(entry.getValue()).build());
        }
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        GeneratedMessageV3.serializeStringMapTo(codedOutputStream, internalGetPolicies(), c.f49029a, 2);
                ...
                try {
                    ...
                    if (L != 0) {
                        if (L == 8) {
                            ...
                            if (!(z11 & true)) {
                                this.policies_ = g1.p(c.f49029a);
                                z11 |= true;
                            }
                            e1 e1Var = (e1) pVar.B(c.f49029a.getParserForType(), f0Var);
