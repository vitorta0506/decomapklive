...
public final class ListenerFilterChainMatchPredicate extends GeneratedMessageV3 implements g {
    ...
    public static final class MatchSet extends GeneratedMessageV3 implements d {
        ...
        public static final class b extends GeneratedMessageV3.b<b> implements d {
            ...
            private List<ListenerFilterChainMatchPredicate> f48807f;

            /* renamed from: g  reason: collision with root package name */
            private l2<ListenerFilterChainMatchPredicate, c, g> f48808g;
            ...
            private void a0() {
                if ((this.f48806e & 1) == 0) {
                    this.f48807f = new ArrayList(this.f48807f);
                    this.f48806e |= 1;
                }
            }

            private l2<ListenerFilterChainMatchPredicate, c, g> d0() {
                if (this.f48808g == null) {
                    this.f48808g = new l2<>(this.f48807f, (this.f48806e & 1) != 0, H(), O());
                    this.f48807f = null;
                }
                return this.f48808g;
            }
            ...
            protected GeneratedMessageV3.e K() {
                return f.f48848l.d(MatchSet.class, b.class);
            }
            ...
            public MatchSet I() {
                ...
                int i9 = this.f48806e;
                l2<ListenerFilterChainMatchPredicate, c, g> l2Var = this.f48808g;
                if (l2Var == null) {
                    if ((i9 & 1) != 0) {
                        this.f48807f = Collections.unmodifiableList(this.f48807f);
                        this.f48806e &= -2;
                    }
                    matchSet.rules_ = this.f48807f;
                } else {
            ...
            */
            public io.grpc.xds.shaded.io.envoyproxy.envoy.config.listener.v3.ListenerFilterChainMatchPredicate.MatchSet.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                /*
                    r2 = this;
                    r0 = 0
                    com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.listener.v3.ListenerFilterChainMatchPredicate.MatchSet.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    io.grpc.xds.shaded.io.envoyproxy.envoy.config.listener.v3.ListenerFilterChainMatchPredicate$MatchSet r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.listener.v3.ListenerFilterChainMatchPredicate.MatchSet) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    if (r3 == 0) goto L10
                    r2.i0(r3)
                L10:
                    return r2
                ...
                L13:
                    ...
                    io.grpc.xds.shaded.io.envoyproxy.envoy.config.listener.v3.ListenerFilterChainMatchPredicate$MatchSet r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.listener.v3.ListenerFilterChainMatchPredicate.MatchSet) r4     // Catch: java.lang.Throwable -> L11
                ...
                L26:
                    throw r3
                */
                throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.listener.v3.ListenerFilterChainMatchPredicate.MatchSet.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.listener.v3.ListenerFilterChainMatchPredicate$MatchSet$b");
            }
                ...
                if (this.f48808g == null) {
                    if (!matchSet.rules_.isEmpty()) {
                        if (this.f48807f.isEmpty()) {
                            this.f48807f = matchSet.rules_;
                            this.f48806e &= -2;
                        } else {
                            a0();
                            this.f48807f.addAll(matchSet.rules_);
                        }
                        R();
                    }
                    ...
                    if (this.f48808g.k()) {
                        ...
                        this.f48807f = matchSet.rules_;
                        this.f48806e &= -2;
                        this.f48808g = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                    } else {
                        this.f48808g.b(matchSet.rules_);
                    }
                }
    ...
    public static /* synthetic */ class b {
        ...
        static final /* synthetic */ int[] f48809a;
        ...
        static {
            ...
            try {
                f48809a[RuleCase.AND_MATCH.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f48809a[RuleCase.NOT_MATCH.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f48809a[RuleCase.ANY_MATCH.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f48809a[RuleCase.DESTINATION_PORT_RANGE.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f48809a[RuleCase.RULE_NOT_SET.ordinal()] = 6;
    ...
    public static final class c extends GeneratedMessageV3.b<c> implements g {
        ...
        /* renamed from: f  reason: collision with root package name */
        private Object f48811f;

        /* renamed from: g  reason: collision with root package name */
        private q2<MatchSet, MatchSet.b, d> f48812g;

        /* renamed from: h  reason: collision with root package name */
        private q2<MatchSet, MatchSet.b, d> f48813h;

        /* renamed from: i  reason: collision with root package name */
        private q2<ListenerFilterChainMatchPredicate, c, g> f48814i;

        /* renamed from: j  reason: collision with root package name */
        private q2<Int32Range, Int32Range.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.v3.d> f48815j;
        ...
        @Override // com.google.protobuf.GeneratedMessageV3.b
        protected GeneratedMessageV3.e K() {
            return f.f48846j.d(ListenerFilterChainMatchPredicate.class, c.class);
        }
        ...
        public ListenerFilterChainMatchPredicate I() {
            ...
            if (this.f48810e == 1) {
                q2<MatchSet, MatchSet.b, d> q2Var = this.f48812g;
                if (q2Var == null) {
                    listenerFilterChainMatchPredicate.rule_ = this.f48811f;
                } else {
                    listenerFilterChainMatchPredicate.rule_ = q2Var.b();
                }
            }
            if (this.f48810e == 2) {
                q2<MatchSet, MatchSet.b, d> q2Var2 = this.f48813h;
                if (q2Var2 == null) {
                    listenerFilterChainMatchPredicate.rule_ = this.f48811f;
                } else {
            ...
            if (this.f48810e == 3) {
                q2<ListenerFilterChainMatchPredicate, c, g> q2Var3 = this.f48814i;
                if (q2Var3 == null) {
                    listenerFilterChainMatchPredicate.rule_ = this.f48811f;
                } else {
            ...
            if (this.f48810e == 5) {
                q2<Int32Range, Int32Range.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.v3.d> q2Var4 = this.f48815j;
                if (q2Var4 == null) {
                    listenerFilterChainMatchPredicate.rule_ = this.f48811f;
                } else {
            ...
            listenerFilterChainMatchPredicate.ruleCase_ = this.f48810e;
            Q();
        ...
        public c d0(MatchSet matchSet) {
            q2<MatchSet, MatchSet.b, d> q2Var = this.f48813h;
            if (q2Var == null) {
                if (this.f48810e == 2 && this.f48811f != MatchSet.getDefaultInstance()) {
                    this.f48811f = MatchSet.newBuilder((MatchSet) this.f48811f).i0(matchSet).I();
                } else {
                    this.f48811f = matchSet;
                }
                R();
            } else {
                if (this.f48810e == 2) {
        ...
        public c e0(Int32Range int32Range) {
            q2<Int32Range, Int32Range.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.v3.d> q2Var = this.f48815j;
            if (q2Var == null) {
                if (this.f48810e == 5 && this.f48811f != Int32Range.getDefaultInstance()) {
                    this.f48811f = Int32Range.newBuilder((Int32Range) this.f48811f).g0(int32Range).I();
                } else {
                    this.f48811f = int32Range;
                }
                R();
            } else {
                if (this.f48810e == 5) {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.listener.v3.ListenerFilterChainMatchPredicate.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.listener.v3.ListenerFilterChainMatchPredicate.access$1600()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.listener.v3.ListenerFilterChainMatchPredicate r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.listener.v3.ListenerFilterChainMatchPredicate) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.i0(r3)
            L10:
                return r2
            ...
            L13:
                r3 = move-exception
                com.google.protobuf.o1 r4 = r3.getUnfinishedMessage()     // Catch: java.lang.Throwable -> L11
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.listener.v3.ListenerFilterChainMatchPredicate r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.listener.v3.ListenerFilterChainMatchPredicate) r4     // Catch: java.lang.Throwable -> L11
                java.io.IOException r3 = r3.unwrapIOException()     // Catch: java.lang.Throwable -> L1f
                throw r3     // Catch: java.lang.Throwable -> L1f
            L1f:
                r3 = move-exception
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.listener.v3.ListenerFilterChainMatchPredicate.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.listener.v3.ListenerFilterChainMatchPredicate$c");
        }
        ...
        public c i0(ListenerFilterChainMatchPredicate listenerFilterChainMatchPredicate) {
            ...
            int i9 = b.f48809a[listenerFilterChainMatchPredicate.getRuleCase().ordinal()];
            if (i9 == 1) {
        ...
        public c j0(ListenerFilterChainMatchPredicate listenerFilterChainMatchPredicate) {
            q2<ListenerFilterChainMatchPredicate, c, g> q2Var = this.f48814i;
            if (q2Var == null) {
                if (this.f48810e == 3 && this.f48811f != ListenerFilterChainMatchPredicate.getDefaultInstance()) {
                    this.f48811f = ListenerFilterChainMatchPredicate.newBuilder((ListenerFilterChainMatchPredicate) this.f48811f).i0(listenerFilterChainMatchPredicate).I();
                } else {
                    this.f48811f = listenerFilterChainMatchPredicate;
                }
                R();
            } else {
                if (this.f48810e == 3) {
                ...
                this.f48814i.g(listenerFilterChainMatchPredicate);
            }
            this.f48810e = 3;
            return this;
        }
        ...
        public c k0(MatchSet matchSet) {
            q2<MatchSet, MatchSet.b, d> q2Var = this.f48812g;
            if (q2Var == null) {
                if (this.f48810e == 1 && this.f48811f != MatchSet.getDefaultInstance()) {
                    this.f48811f = MatchSet.newBuilder((MatchSet) this.f48811f).i0(matchSet).I();
                } else {
                    this.f48811f = matchSet;
                }
        ...
        public c m0(boolean z10) {
            this.f48810e = 4;
            this.f48811f = Boolean.valueOf(z10);
            R();
            return this;
        }
