...
public final class RuntimeFilter extends GeneratedMessageV3 implements m {
    ...
    public class a extends com.google.protobuf.c<RuntimeFilter> {
        ...
        /* renamed from: G */
        public RuntimeFilter m(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements m {
        ...
        private Object f48493e;

        /* renamed from: f  reason: collision with root package name */
        private FractionalPercent f48494f;

        /* renamed from: g  reason: collision with root package name */
        private q2<FractionalPercent, FractionalPercent.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.b> f48495g;

        /* renamed from: h  reason: collision with root package name */
        private boolean f48496h;
        ...
        protected GeneratedMessageV3.e K() {
            return c.f48514p.d(RuntimeFilter.class, b.class);
        }
        ...
        public RuntimeFilter I() {
            ...
            runtimeFilter.runtimeKey_ = this.f48493e;
            q2<FractionalPercent, FractionalPercent.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.b> q2Var = this.f48495g;
            if (q2Var == null) {
                runtimeFilter.percentSampled_ = this.f48494f;
            } else {
                runtimeFilter.percentSampled_ = q2Var.b();
            }
            runtimeFilter.useIndependentRandomness_ = this.f48496h;
            Q();
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.RuntimeFilter.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.RuntimeFilter.access$800()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.RuntimeFilter.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.RuntimeFilter$b");
        }
        ...
        public b g0(RuntimeFilter runtimeFilter) {
            ...
            if (!runtimeFilter.getRuntimeKey().isEmpty()) {
                this.f48493e = runtimeFilter.runtimeKey_;
                R();
            }
        ...
        public b h0(FractionalPercent fractionalPercent) {
            q2<FractionalPercent, FractionalPercent.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.b> q2Var = this.f48495g;
            if (q2Var == null) {
                FractionalPercent fractionalPercent2 = this.f48494f;
                if (fractionalPercent2 != null) {
                    this.f48494f = FractionalPercent.newBuilder(fractionalPercent2).g0(fractionalPercent).I();
                } else {
                    this.f48494f = fractionalPercent;
                }
                R();
            } else {
    ...
    /* synthetic */ RuntimeFilter(p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
    ...
    public io.grpc.xds.shaded.io.envoyproxy.envoy.type.b getPercentSampledOrBuilder() {
    ...
    private RuntimeFilter(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
    ...
    public static RuntimeFilter parseFrom(p pVar) throws IOException {
        return (RuntimeFilter) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
    }

    public static RuntimeFilter parseFrom(p pVar, f0 f0Var) throws IOException {
