...
public final class AccessLog extends GeneratedMessageV3 implements io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.b {
    ...
    public class a extends com.google.protobuf.c<AccessLog> {
        ...
        /* renamed from: G */
        public AccessLog m(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static /* synthetic */ class b {
        ...
        static {
            ...
            try {
                f48447a[ConfigTypeCase.TYPED_CONFIG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f48447a[ConfigTypeCase.CONFIGTYPE_NOT_SET.ordinal()] = 3;
    ...
    /* loaded from: classes6.dex */
    public static final class c extends GeneratedMessageV3.b<c> implements io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.b {

        /* renamed from: e  reason: collision with root package name */
        private int f48448e;

        /* renamed from: f  reason: collision with root package name */
        private Object f48449f;

        /* renamed from: g  reason: collision with root package name */
        private Object f48450g;

        /* renamed from: h  reason: collision with root package name */
        private AccessLogFilter f48451h;

        /* renamed from: i  reason: collision with root package name */
        private q2<AccessLogFilter, AccessLogFilter.c, io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.a> f48452i;

        /* renamed from: j  reason: collision with root package name */
        private q2<Struct, Struct.b, u2> f48453j;

        /* renamed from: k  reason: collision with root package name */
        private q2<Any, Any.b, com.google.protobuf.f> f48454k;
        ...
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.c.f48500b.d(AccessLog.class, c.class);
        }
        ...
        public AccessLog I() {
            ...
            accessLog.name_ = this.f48450g;
            q2<AccessLogFilter, AccessLogFilter.c, io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.a> q2Var = this.f48452i;
            if (q2Var == null) {
                accessLog.filter_ = this.f48451h;
            } else {
                accessLog.filter_ = q2Var.b();
            }
            if (this.f48448e == 3) {
                q2<Struct, Struct.b, u2> q2Var2 = this.f48453j;
                if (q2Var2 == null) {
                    accessLog.configType_ = this.f48449f;
                } else {
                    accessLog.configType_ = q2Var2.b();
                }
            }
            if (this.f48448e == 4) {
                q2<Any, Any.b, com.google.protobuf.f> q2Var3 = this.f48454k;
                if (q2Var3 == null) {
                    accessLog.configType_ = this.f48449f;
                } else {
                    accessLog.configType_ = q2Var3.b();
                }
            }
            accessLog.configTypeCase_ = this.f48448e;
            Q();
            return accessLog;
        }
        ...
        public c d0(Struct struct) {
            q2<Struct, Struct.b, u2> q2Var = this.f48453j;
            if (q2Var == null) {
                if (this.f48448e == 3 && this.f48449f != Struct.getDefaultInstance()) {
                    this.f48449f = Struct.newBuilder((Struct) this.f48449f).i0(struct).I();
                } else {
                    this.f48449f = struct;
                }
                R();
                ...
                this.f48453j.g(struct);
            }
            this.f48448e = 3;
            return this;
        }

        public c e0(AccessLogFilter accessLogFilter) {
            q2<AccessLogFilter, AccessLogFilter.c, io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.a> q2Var = this.f48452i;
            if (q2Var == null) {
                AccessLogFilter accessLogFilter2 = this.f48451h;
                if (accessLogFilter2 != null) {
                    this.f48451h = AccessLogFilter.newBuilder(accessLogFilter2).j0(accessLogFilter).I();
                } else {
                    this.f48451h = accessLogFilter;
                }
                R();
            } else {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.AccessLog.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.AccessLog.access$900()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.AccessLog r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.AccessLog) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.i0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.AccessLog r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.AccessLog) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.AccessLog.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.AccessLog$c");
        }

        @Override // com.google.protobuf.GeneratedMessageV3.b, com.google.protobuf.l1.a, com.google.protobuf.r1
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.c.f48499a;
        }
        ...
        public c v(l1 l1Var) {
            if (l1Var instanceof AccessLog) {
                return i0((AccessLog) l1Var);
            }
            super.P0(l1Var);
            return this;
        }

        public c i0(AccessLog accessLog) {
            if (accessLog == AccessLog.getDefaultInstance()) {
                return this;
            }
            if (!accessLog.getName().isEmpty()) {
                this.f48450g = accessLog.name_;
                R();
            }
            if (accessLog.hasFilter()) {
                e0(accessLog.getFilter());
            }
            int i9 = b.f48447a[accessLog.getConfigTypeCase().ordinal()];
            if (i9 == 1) {
                d0(accessLog.getConfig());
            } else if (i9 == 2) {
                j0(accessLog.getTypedConfig());
            }
        ...
        public c j0(Any any) {
            q2<Any, Any.b, com.google.protobuf.f> q2Var = this.f48454k;
            if (q2Var == null) {
                if (this.f48448e == 4 && this.f48449f != Any.getDefaultInstance()) {
                    this.f48449f = Any.newBuilder((Any) this.f48449f).d0(any).I();
                } else {
                    this.f48449f = any;
                }
                R();
    ...
    /* synthetic */ AccessLog(p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getName().equals(accessLog.getName()) && hasFilter() == accessLog.hasFilter()) {
            if ((!hasFilter() || getFilter().equals(accessLog.getFilter())) && getConfigTypeCase().equals(accessLog.getConfigTypeCase())) {
                ...
                if (i9 != 3) {
                    if (i9 == 4 && !getTypedConfig().equals(accessLog.getTypedConfig())) {
                        return false;
                    }
                } else if (!getConfig().equals(accessLog.getConfig())) {
                    return false;
                }
                return this.unknownFields.equals(accessLog.unknownFields);
            }
            return false;
        }
        return false;
    ...
    public io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.a getFilterOrBuilder() {
        return getFilter();
    }
    ...
    public int getSerializedSize() {
        ...
        if (this.configTypeCase_ == 3) {
            computeStringSize += CodedOutputStream.G(3, (Struct) this.configType_);
        }
    ...
    public int hashCode() {
        ...
        if (hasFilter()) {
            hashCode2 = (((hashCode2 * 37) + 2) * 53) + getFilter().hashCode();
        }
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        if (this.configTypeCase_ == 3) {
            codedOutputStream.L0(3, (Struct) this.configType_);
        }
        if (this.configTypeCase_ == 4) {
    ...
    public static c newBuilder(AccessLog accessLog) {
        return DEFAULT_INSTANCE.toBuilder().i0(accessLog);
    }
    ...
    private AccessLog(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
                    ...
                    if (L != 0) {
                        if (L != 10) {
                            if (L == 18) {
                                ...
                                Struct.b builder2 = this.configTypeCase_ == 3 ? ((Struct) this.configType_).toBuilder() : null;
                                o1 B = pVar.B(Struct.parser(), f0Var);
                                this.configType_ = B;
                                if (builder2 != null) {
                                    builder2.i0((Struct) B);
                                ...
                                Any.b builder3 = this.configTypeCase_ == 4 ? ((Any) this.configType_).toBuilder() : null;
                                o1 B2 = pVar.B(Any.parser(), f0Var);
                                this.configType_ = B2;
                                if (builder3 != null) {
                                    builder3.d0((Any) B2);
                                    this.configType_ = builder3.I();
                                }
    ...
    public static AccessLog parseFrom(p pVar) throws IOException {
        return (AccessLog) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
    }

    public static AccessLog parseFrom(p pVar, f0 f0Var) throws IOException {
