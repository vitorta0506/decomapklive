...
public final class MetadataKey extends GeneratedMessageV3 implements io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.a {
    ...
    public static final class PathSegment extends GeneratedMessageV3 implements d {
        ...
        public static final class b extends GeneratedMessageV3.b<b> implements d {
            ...
            protected GeneratedMessageV3.e K() {
                return io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.c.f50481d.d(PathSegment.class, b.class);
            }
            ...
            public PathSegment I() {
                ...
                if (this.f50464e == 1) {
                    pathSegment.segment_ = this.f50465f;
                }
                pathSegment.segmentCase_ = this.f50464e;
                Q();
                return pathSegment;
            }
            ...
            */
            public io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.MetadataKey.PathSegment.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                /*
                    r2 = this;
                    r0 = 0
                    com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.MetadataKey.PathSegment.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.MetadataKey$PathSegment r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.MetadataKey.PathSegment) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    if (r3 == 0) goto L10
                    r2.g0(r3)
                L10:
                    return r2
                ...
                L13:
                    ...
                    io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.MetadataKey$PathSegment r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.MetadataKey.PathSegment) r4     // Catch: java.lang.Throwable -> L11
                ...
                L26:
                    throw r3
                */
                throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.MetadataKey.PathSegment.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.MetadataKey$PathSegment$b");
            }
            ...
            public b g0(PathSegment pathSegment) {
                ...
                if (b.f50466a[pathSegment.getSegmentCase().ordinal()] == 1) {
                    this.f50464e = 1;
                    this.f50465f = pathSegment.segment_;
                    R();
                }
            ...
            public Descriptors.b getDescriptorForType() {
                return io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.c.f50480c;
            }
    ...
    public static /* synthetic */ class b {
        ...
        static {
            ...
            try {
                f50466a[PathSegment.SegmentCase.SEGMENT_NOT_SET.ordinal()] = 2;
    ...
    /* loaded from: classes6.dex */
    public static final class c extends GeneratedMessageV3.b<c> implements io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.a {

        /* renamed from: e  reason: collision with root package name */
        private int f50467e;

        /* renamed from: f  reason: collision with root package name */
        private Object f50468f;

        /* renamed from: g  reason: collision with root package name */
        private List<PathSegment> f50469g;

        /* renamed from: h  reason: collision with root package name */
        private l2<PathSegment, PathSegment.b, d> f50470h;
        ...
        private void a0() {
            if ((this.f50467e & 1) == 0) {
                this.f50469g = new ArrayList(this.f50469g);
                this.f50467e |= 1;
            }
        }
        ...
        private l2<PathSegment, PathSegment.b, d> d0() {
            if (this.f50470h == null) {
                this.f50470h = new l2<>(this.f50469g, (this.f50467e & 1) != 0, H(), O());
                this.f50469g = null;
            }
            return this.f50470h;
        }
        ...
        @Override // com.google.protobuf.GeneratedMessageV3.b
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.c.f50479b.d(MetadataKey.class, c.class);
        }
        ...
        public MetadataKey I() {
            ...
            metadataKey.key_ = this.f50468f;
            l2<PathSegment, PathSegment.b, d> l2Var = this.f50470h;
            if (l2Var == null) {
                if ((this.f50467e & 1) != 0) {
                    this.f50469g = Collections.unmodifiableList(this.f50469g);
                    this.f50467e &= -2;
                }
                metadataKey.path_ = this.f50469g;
            } else {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.MetadataKey.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.MetadataKey.access$1800()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.MetadataKey r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.MetadataKey) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.i0(r3)
            L10:
                return r2
            ...
            L13:
                r3 = move-exception
                com.google.protobuf.o1 r4 = r3.getUnfinishedMessage()     // Catch: java.lang.Throwable -> L11
                io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.MetadataKey r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.MetadataKey) r4     // Catch: java.lang.Throwable -> L11
                java.io.IOException r3 = r3.unwrapIOException()     // Catch: java.lang.Throwable -> L1f
                throw r3     // Catch: java.lang.Throwable -> L1f
            L1f:
                r3 = move-exception
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.MetadataKey.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.MetadataKey$c");
        }

        @Override // com.google.protobuf.GeneratedMessageV3.b, com.google.protobuf.l1.a, com.google.protobuf.r1
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.type.metadata.v3.c.f50478a;
        }
        ...
        public c i0(MetadataKey metadataKey) {
            ...
            if (!metadataKey.getKey().isEmpty()) {
                this.f50468f = metadataKey.key_;
                R();
            }
            if (this.f50470h == null) {
                if (!metadataKey.path_.isEmpty()) {
                    if (this.f50469g.isEmpty()) {
                        this.f50469g = metadataKey.path_;
                        this.f50467e &= -2;
                    } else {
                        a0();
                        this.f50469g.addAll(metadataKey.path_);
                    }
                    R();
                }
                ...
                if (this.f50470h.k()) {
                    ...
                    this.f50469g = metadataKey.path_;
                    this.f50467e &= -2;
                    this.f50470h = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                } else {
                    this.f50470h.b(metadataKey.path_);
                }
            }
        ...
        private c() {
            this.f50468f = "";
            this.f50469g = Collections.emptyList();
            e0();
        }
