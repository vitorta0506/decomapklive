...
public final class ValueMatcher extends GeneratedMessageV3 implements m {
    ...
    public static final class NullMatch extends GeneratedMessageV3 implements d {
        ...
        class a extends com.google.protobuf.c<NullMatch> {
            ...
            /* renamed from: G */
            public NullMatch m(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        ...
        public static final class b extends GeneratedMessageV3.b<b> implements d {
            ...
            protected GeneratedMessageV3.e K() {
                return n.f50334d.d(NullMatch.class, b.class);
            }
            ...
            */
            public io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.ValueMatcher.NullMatch.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                /*
                    r2 = this;
                    r0 = 0
                    com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.ValueMatcher.NullMatch.access$500()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                ...
                L26:
                    throw r3
                */
                throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.ValueMatcher.NullMatch.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.ValueMatcher$NullMatch$b");
            }
        ...
        /* synthetic */ NullMatch(p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
            this(pVar, f0Var);
        }
        ...
        private NullMatch(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
            this();
        ...
        public static NullMatch parseFrom(p pVar) throws IOException {
            return (NullMatch) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
        }

        public static NullMatch parseFrom(p pVar, f0 f0Var) throws IOException {
    ...
    public class a extends com.google.protobuf.c<ValueMatcher> {
        ...
        @Override // com.google.protobuf.e2
        /* renamed from: G */
        public ValueMatcher m(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static /* synthetic */ class b {
        ...
        static {
            ...
            try {
                f50301a[MatchPatternCase.DOUBLE_MATCH.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f50301a[MatchPatternCase.STRING_MATCH.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f50301a[MatchPatternCase.BOOL_MATCH.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f50301a[MatchPatternCase.PRESENT_MATCH.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f50301a[MatchPatternCase.LIST_MATCH.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f50301a[MatchPatternCase.MATCHPATTERN_NOT_SET.ordinal()] = 7;
    ...
    public static final class c extends GeneratedMessageV3.b<c> implements m {
        ...
        private Object f50303f;

        /* renamed from: g  reason: collision with root package name */
        private q2<NullMatch, NullMatch.b, d> f50304g;

        /* renamed from: h  reason: collision with root package name */
        private q2<DoubleMatcher, DoubleMatcher.c, io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.a> f50305h;

        /* renamed from: i  reason: collision with root package name */
        private q2<StringMatcher, StringMatcher.c, k> f50306i;

        /* renamed from: j  reason: collision with root package name */
        private q2<ListMatcher, ListMatcher.c, io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.b> f50307j;
        ...
        @Override // com.google.protobuf.GeneratedMessageV3.b
        protected GeneratedMessageV3.e K() {
            return n.f50332b.d(ValueMatcher.class, c.class);
        }
        ...
        public ValueMatcher I() {
            ...
            if (this.f50302e == 1) {
                q2<NullMatch, NullMatch.b, d> q2Var = this.f50304g;
                if (q2Var == null) {
                    valueMatcher.matchPattern_ = this.f50303f;
                } else {
                    valueMatcher.matchPattern_ = q2Var.b();
                }
            }
            if (this.f50302e == 2) {
                q2<DoubleMatcher, DoubleMatcher.c, io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.a> q2Var2 = this.f50305h;
                if (q2Var2 == null) {
                    valueMatcher.matchPattern_ = this.f50303f;
                } else {
            ...
            if (this.f50302e == 3) {
                q2<StringMatcher, StringMatcher.c, k> q2Var3 = this.f50306i;
                if (q2Var3 == null) {
                    valueMatcher.matchPattern_ = this.f50303f;
                } else {
            ...
            if (this.f50302e == 6) {
                q2<ListMatcher, ListMatcher.c, io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.b> q2Var4 = this.f50307j;
                if (q2Var4 == null) {
                    valueMatcher.matchPattern_ = this.f50303f;
                } else {
            ...
            valueMatcher.matchPatternCase_ = this.f50302e;
            Q();
            return valueMatcher;
        }
        ...
        public c d0(DoubleMatcher doubleMatcher) {
            q2<DoubleMatcher, DoubleMatcher.c, io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.a> q2Var = this.f50305h;
            if (q2Var == null) {
                if (this.f50302e == 2 && this.f50303f != DoubleMatcher.getDefaultInstance()) {
                    this.f50303f = DoubleMatcher.newBuilder((DoubleMatcher) this.f50303f).g0(doubleMatcher).I();
                } else {
                    this.f50303f = doubleMatcher;
                }
                R();
            } else {
                if (this.f50302e == 2) {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.ValueMatcher.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.ValueMatcher.access$1400()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.ValueMatcher.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.ValueMatcher$c");
        }
        ...
        public c h0(ValueMatcher valueMatcher) {
            ...
            switch (b.f50301a[valueMatcher.getMatchPatternCase().ordinal()]) {
                case 1:
        ...
        public c i0(ListMatcher listMatcher) {
            q2<ListMatcher, ListMatcher.c, io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.b> q2Var = this.f50307j;
            if (q2Var == null) {
                if (this.f50302e == 6 && this.f50303f != ListMatcher.getDefaultInstance()) {
                    this.f50303f = ListMatcher.newBuilder((ListMatcher) this.f50303f).g0(listMatcher).I();
                } else {
                    this.f50303f = listMatcher;
                }
                R();
            } else {
                if (this.f50302e == 6) {
        ...
        public c j0(NullMatch nullMatch) {
            q2<NullMatch, NullMatch.b, d> q2Var = this.f50304g;
            if (q2Var == null) {
                if (this.f50302e == 1 && this.f50303f != NullMatch.getDefaultInstance()) {
                    this.f50303f = NullMatch.newBuilder((NullMatch) this.f50303f).g0(nullMatch).I();
                } else {
                    this.f50303f = nullMatch;
                }
                R();
            } else {
                if (this.f50302e == 1) {
        ...
        public c k0(StringMatcher stringMatcher) {
            q2<StringMatcher, StringMatcher.c, k> q2Var = this.f50306i;
            if (q2Var == null) {
                if (this.f50302e == 3 && this.f50303f != StringMatcher.getDefaultInstance()) {
                    this.f50303f = StringMatcher.newBuilder((StringMatcher) this.f50303f).g0(stringMatcher).I();
                } else {
                    this.f50303f = stringMatcher;
                }
                R();
            } else {
                if (this.f50302e == 3) {
        ...
        public c m0(boolean z10) {
            this.f50302e = 4;
            this.f50303f = Boolean.valueOf(z10);
            R();
            return this;
        }
    ...
    /* synthetic */ ValueMatcher(p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
    ...
    public io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.a getDoubleMatchOrBuilder() {
        if (this.matchPatternCase_ == 2) {
            return (DoubleMatcher) this.matchPattern_;
        }
        return DoubleMatcher.getDefaultInstance();
    ...
    public io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.b getListMatchOrBuilder() {
        if (this.matchPatternCase_ == 6) {
            return (ListMatcher) this.matchPattern_;
        }
        return ListMatcher.getDefaultInstance();
    ...
    public k getStringMatchOrBuilder() {
        if (this.matchPatternCase_ == 3) {
            return (StringMatcher) this.matchPattern_;
        }
        return StringMatcher.getDefaultInstance();
    ...
    private ValueMatcher(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
        Objects.requireNonNull(f0Var);
        h3.b h10 = h3.h();
        boolean z10 = false;
    ...
    public static ValueMatcher parseFrom(p pVar) throws IOException {
        return (ValueMatcher) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
    }

    public static ValueMatcher parseFrom(p pVar, f0 f0Var) throws IOException {
