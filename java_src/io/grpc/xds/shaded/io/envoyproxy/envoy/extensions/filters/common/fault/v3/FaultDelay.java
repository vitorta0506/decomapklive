...
public final class FaultDelay extends GeneratedMessageV3 implements io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.a {
    ...
    public static final class HeaderDelay extends GeneratedMessageV3 implements d {
        ...
        public static final class b extends GeneratedMessageV3.b<b> implements d {
            ...
            protected GeneratedMessageV3.e K() {
                return io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.b.f49686d.d(HeaderDelay.class, b.class);
            }
            ...
            */
            public io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.FaultDelay.HeaderDelay.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                /*
                    r2 = this;
                    r0 = 0
                    com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.FaultDelay.HeaderDelay.access$500()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.FaultDelay$HeaderDelay r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.FaultDelay.HeaderDelay) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    if (r3 == 0) goto L10
                    r2.g0(r3)
                L10:
                    return r2
                ...
                L13:
                    ...
                    io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.FaultDelay$HeaderDelay r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.FaultDelay.HeaderDelay) r4     // Catch: java.lang.Throwable -> L11
                ...
                L26:
                    throw r3
                */
                throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.FaultDelay.HeaderDelay.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.FaultDelay$HeaderDelay$b");
            }
            ...
            public Descriptors.b getDescriptorForType() {
                return io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.b.f49685c;
            }
    ...
    public static /* synthetic */ class b {
        ...
        static {
            ...
            try {
                f49668a[FaultDelaySecifierCase.HEADER_DELAY.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f49668a[FaultDelaySecifierCase.FAULTDELAYSECIFIER_NOT_SET.ordinal()] = 3;
    ...
    /* loaded from: classes6.dex */
    public static final class c extends GeneratedMessageV3.b<c> implements io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.a {

        /* renamed from: e  reason: collision with root package name */
        private int f49669e;

        /* renamed from: f  reason: collision with root package name */
        private Object f49670f;

        /* renamed from: g  reason: collision with root package name */
        private q2<Duration, Duration.b, v> f49671g;

        /* renamed from: h  reason: collision with root package name */
        private q2<HeaderDelay, HeaderDelay.b, d> f49672h;

        /* renamed from: i  reason: collision with root package name */
        private FractionalPercent f49673i;

        /* renamed from: j  reason: collision with root package name */
        private q2<FractionalPercent, FractionalPercent.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.v3.b> f49674j;
        ...
        @Override // com.google.protobuf.GeneratedMessageV3.b
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.b.f49684b.d(FaultDelay.class, c.class);
        }
        ...
        public FaultDelay I() {
            ...
            if (this.f49669e == 3) {
                q2<Duration, Duration.b, v> q2Var = this.f49671g;
                if (q2Var == null) {
                    faultDelay.faultDelaySecifier_ = this.f49670f;
                } else {
                    faultDelay.faultDelaySecifier_ = q2Var.b();
                }
            }
            if (this.f49669e == 5) {
                q2<HeaderDelay, HeaderDelay.b, d> q2Var2 = this.f49672h;
                if (q2Var2 == null) {
                    faultDelay.faultDelaySecifier_ = this.f49670f;
                } else {
            ...
            q2<FractionalPercent, FractionalPercent.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.v3.b> q2Var3 = this.f49674j;
            if (q2Var3 == null) {
                faultDelay.percentage_ = this.f49673i;
            } else {
                faultDelay.percentage_ = q2Var3.b();
            }
            faultDelay.faultDelaySecifierCase_ = this.f49669e;
            Q();
            return faultDelay;
        }
        ...
        public c d0(Duration duration) {
            q2<Duration, Duration.b, v> q2Var = this.f49671g;
            if (q2Var == null) {
                if (this.f49669e == 3 && this.f49670f != Duration.getDefaultInstance()) {
                    this.f49670f = Duration.newBuilder((Duration) this.f49670f).e0(duration).I();
                } else {
                    this.f49670f = duration;
                }
                R();
            } else {
                if (this.f49669e == 3) {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.FaultDelay.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.FaultDelay.access$1500()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.FaultDelay r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.FaultDelay) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.h0(r3)
            L10:
                return r2
            ...
            L13:
                r3 = move-exception
                com.google.protobuf.o1 r4 = r3.getUnfinishedMessage()     // Catch: java.lang.Throwable -> L11
                io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.FaultDelay r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.FaultDelay) r4     // Catch: java.lang.Throwable -> L11
                java.io.IOException r3 = r3.unwrapIOException()     // Catch: java.lang.Throwable -> L1f
                throw r3     // Catch: java.lang.Throwable -> L1f
            L1f:
                r3 = move-exception
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.FaultDelay.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.FaultDelay$c");
        }
        ...
        @Override // com.google.protobuf.GeneratedMessageV3.b, com.google.protobuf.l1.a, com.google.protobuf.r1
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.common.fault.v3.b.f49683a;
        }
        ...
        public c h0(FaultDelay faultDelay) {
            ...
            int i9 = b.f49668a[faultDelay.getFaultDelaySecifierCase().ordinal()];
            if (i9 == 1) {
        ...
        public c i0(HeaderDelay headerDelay) {
            q2<HeaderDelay, HeaderDelay.b, d> q2Var = this.f49672h;
            if (q2Var == null) {
                if (this.f49669e == 5 && this.f49670f != HeaderDelay.getDefaultInstance()) {
                    this.f49670f = HeaderDelay.newBuilder((HeaderDelay) this.f49670f).g0(headerDelay).I();
                } else {
                    this.f49670f = headerDelay;
                }
                R();
            } else {
                if (this.f49669e == 5) {
        ...
        public c j0(FractionalPercent fractionalPercent) {
            q2<FractionalPercent, FractionalPercent.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.v3.b> q2Var = this.f49674j;
            if (q2Var == null) {
                FractionalPercent fractionalPercent2 = this.f49673i;
                if (fractionalPercent2 != null) {
                    this.f49673i = FractionalPercent.newBuilder(fractionalPercent2).g0(fractionalPercent).I();
                } else {
                    this.f49673i = fractionalPercent;
                }
                R();
            } else {
    ...
    public boolean equals(Object obj) {
        ...
        if (hasPercentage() != faultDelay.hasPercentage()) {
            return false;
        }
    ...
    public int getSerializedSize() {
        ...
        int G = this.faultDelaySecifierCase_ == 3 ? 0 + CodedOutputStream.G(3, (Duration) this.faultDelaySecifier_) : 0;
        if (this.percentage_ != null) {
            G += CodedOutputStream.G(4, getPercentage());
        }
        if (this.faultDelaySecifierCase_ == 5) {
            G += CodedOutputStream.G(5, (HeaderDelay) this.faultDelaySecifier_);
        }
