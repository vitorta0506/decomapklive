...
public final class HttpFilter extends GeneratedMessageV3 implements io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.b {
    ...
    public static /* synthetic */ class b {
        ...
        static final /* synthetic */ int[] f48650a;
        ...
        static {
            ...
            try {
                f48650a[ConfigTypeCase.TYPED_CONFIG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f48650a[ConfigTypeCase.CONFIGTYPE_NOT_SET.ordinal()] = 3;
    ...
    /* loaded from: classes6.dex */
    public static final class c extends GeneratedMessageV3.b<c> implements io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.b {

        /* renamed from: e  reason: collision with root package name */
        private int f48651e;

        /* renamed from: f  reason: collision with root package name */
        private Object f48652f;

        /* renamed from: g  reason: collision with root package name */
        private Object f48653g;

        /* renamed from: h  reason: collision with root package name */
        private q2<Struct, Struct.b, u2> f48654h;

        /* renamed from: i  reason: collision with root package name */
        private q2<Any, Any.b, com.google.protobuf.f> f48655i;
        ...
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.a.B.d(HttpFilter.class, c.class);
        }
        ...
        public HttpFilter I() {
            ...
            httpFilter.name_ = this.f48653g;
            if (this.f48651e == 2) {
                q2<Struct, Struct.b, u2> q2Var = this.f48654h;
                if (q2Var == null) {
                    httpFilter.configType_ = this.f48652f;
                } else {
                    httpFilter.configType_ = q2Var.b();
                }
            }
            if (this.f48651e == 4) {
                q2<Any, Any.b, com.google.protobuf.f> q2Var2 = this.f48655i;
                if (q2Var2 == null) {
                    httpFilter.configType_ = this.f48652f;
                } else {
            ...
            httpFilter.configTypeCase_ = this.f48651e;
            Q();
            return httpFilter;
        }
        ...
        public c d0(Struct struct) {
            q2<Struct, Struct.b, u2> q2Var = this.f48654h;
            if (q2Var == null) {
                if (this.f48651e == 2 && this.f48652f != Struct.getDefaultInstance()) {
                    this.f48652f = Struct.newBuilder((Struct) this.f48652f).i0(struct).I();
                } else {
                    this.f48652f = struct;
                }
                R();
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.HttpFilter.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.HttpFilter.access$800()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.HttpFilter r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.HttpFilter) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.h0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.HttpFilter r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.HttpFilter) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.HttpFilter.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.HttpFilter$c");
        }
        ...
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.network.http_connection_manager.v2.a.A;
        }
        ...
        public c h0(HttpFilter httpFilter) {
            ...
            if (!httpFilter.getName().isEmpty()) {
                this.f48653g = httpFilter.name_;
                R();
            }
            int i9 = b.f48650a[httpFilter.getConfigTypeCase().ordinal()];
            if (i9 == 1) {
                d0(httpFilter.getConfig());
            } else if (i9 == 2) {
        ...
        public c i0(Any any) {
            q2<Any, Any.b, com.google.protobuf.f> q2Var = this.f48655i;
            if (q2Var == null) {
                if (this.f48651e == 4 && this.f48652f != Any.getDefaultInstance()) {
                    this.f48652f = Any.newBuilder((Any) this.f48652f).d0(any).I();
                } else {
                    this.f48652f = any;
                }
                R();
    ...
    public boolean equals(Object obj) {
        ...
        if (getName().equals(httpFilter.getName()) && getConfigTypeCase().equals(httpFilter.getConfigTypeCase())) {
            ...
            if (i9 != 2) {
                if (i9 == 4 && !getTypedConfig().equals(httpFilter.getTypedConfig())) {
                    return false;
                }
            } else if (!getConfig().equals(httpFilter.getConfig())) {
                return false;
            }
