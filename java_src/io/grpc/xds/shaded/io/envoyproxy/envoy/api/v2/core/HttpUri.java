...
public final class HttpUri extends GeneratedMessageV3 implements a0 {
    ...
    public static /* synthetic */ class b {
        ...
        static {
            ...
            try {
                f46590a[HttpUpstreamTypeCase.HTTPUPSTREAMTYPE_NOT_SET.ordinal()] = 2;
    ...
    public static final class c extends GeneratedMessageV3.b<c> implements a0 {
        ...
        private Object f46592f;

        /* renamed from: g  reason: collision with root package name */
        private Object f46593g;

        /* renamed from: h  reason: collision with root package name */
        private Duration f46594h;

        /* renamed from: i  reason: collision with root package name */
        private q2<Duration, Duration.b, com.google.protobuf.v> f46595i;
        ...
        protected GeneratedMessageV3.e K() {
            return b0.f46687b.d(HttpUri.class, c.class);
        }
        ...
        public HttpUri I() {
            ...
            httpUri.uri_ = this.f46593g;
            if (this.f46591e == 2) {
                httpUri.httpUpstreamType_ = this.f46592f;
            }
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var = this.f46595i;
            if (q2Var == null) {
                httpUri.timeout_ = this.f46594h;
            } else {
                httpUri.timeout_ = q2Var.b();
            }
            httpUri.httpUpstreamTypeCase_ = this.f46591e;
            Q();
            return httpUri;
        }
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HttpUri.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HttpUri.access$900()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HttpUri.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HttpUri$c");
        }
        ...
        public c g0(HttpUri httpUri) {
            ...
            if (!httpUri.getUri().isEmpty()) {
                this.f46593g = httpUri.uri_;
                R();
            }
            if (httpUri.hasTimeout()) {
                h0(httpUri.getTimeout());
            }
            if (b.f46590a[httpUri.getHttpUpstreamTypeCase().ordinal()] == 1) {
                this.f46591e = 2;
                this.f46592f = httpUri.httpUpstreamType_;
                R();
            }
        ...
        public c h0(Duration duration) {
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var = this.f46595i;
            if (q2Var == null) {
                Duration duration2 = this.f46594h;
                if (duration2 != null) {
                    this.f46594h = Duration.newBuilder(duration2).e0(duration).I();
                } else {
                    this.f46594h = duration;
                }
                R();
            } else {
                q2Var.e(duration);
