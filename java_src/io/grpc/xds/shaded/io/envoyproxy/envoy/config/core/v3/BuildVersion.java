...
public final class BuildVersion extends GeneratedMessageV3 implements i {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements i {
        ...
        private SemanticVersion f47802e;

        /* renamed from: f  reason: collision with root package name */
        private q2<SemanticVersion, SemanticVersion.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.v3.i> f47803f;

        /* renamed from: g  reason: collision with root package name */
        private Struct f47804g;

        /* renamed from: h  reason: collision with root package name */
        private q2<Struct, Struct.b, u2> f47805h;
        ...
        protected GeneratedMessageV3.e K() {
            return g.f48213d.d(BuildVersion.class, b.class);
        }
        ...
        public BuildVersion I() {
            ...
            q2<SemanticVersion, SemanticVersion.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.v3.i> q2Var = this.f47803f;
            if (q2Var == null) {
                buildVersion.version_ = this.f47802e;
            } else {
                buildVersion.version_ = q2Var.b();
            }
            q2<Struct, Struct.b, u2> q2Var2 = this.f47805h;
            if (q2Var2 == null) {
                buildVersion.metadata_ = this.f47804g;
            } else {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.BuildVersion.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.BuildVersion.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.BuildVersion.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.BuildVersion$b");
        }
        ...
        public b h0(Struct struct) {
            q2<Struct, Struct.b, u2> q2Var = this.f47805h;
            if (q2Var == null) {
                Struct struct2 = this.f47804g;
                if (struct2 != null) {
                    this.f47804g = Struct.newBuilder(struct2).i0(struct).I();
                } else {
                    this.f47804g = struct;
                }
                R();
        ...
        public b j0(SemanticVersion semanticVersion) {
            q2<SemanticVersion, SemanticVersion.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.v3.i> q2Var = this.f47803f;
            if (q2Var == null) {
                SemanticVersion semanticVersion2 = this.f47802e;
                if (semanticVersion2 != null) {
                    this.f47802e = SemanticVersion.newBuilder(semanticVersion2).g0(semanticVersion).I();
                } else {
                    this.f47802e = semanticVersion;
                }
                R();
            } else {
    ...
    public io.grpc.xds.shaded.io.envoyproxy.envoy.type.v3.i getVersionOrBuilder() {
        return getVersion();
    }
