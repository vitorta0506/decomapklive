...
public enum HealthStatus implements h2 {
    ...
    private static final u0.d<HealthStatus> internalValueMap = new u0.d<HealthStatus>() { // from class: io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.HealthStatus.a
