...
public final class Router extends GeneratedMessageV3 implements r1 {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        private BoolValue f48585f;

        /* renamed from: g  reason: collision with root package name */
        private q2<BoolValue, BoolValue.b, l> f48586g;

        /* renamed from: h  reason: collision with root package name */
        private boolean f48587h;

        /* renamed from: i  reason: collision with root package name */
        private List<AccessLog> f48588i;

        /* renamed from: j  reason: collision with root package name */
        private l2<AccessLog, AccessLog.c, io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.b> f48589j;
        ...
        private void a0() {
            if ((this.f48584e & 2) == 0) {
                this.f48591l = new y0(this.f48591l);
                this.f48584e |= 2;
            }
        }
        ...
        private void b0() {
            if ((this.f48584e & 1) == 0) {
                this.f48588i = new ArrayList(this.f48588i);
                this.f48584e |= 1;
            }
        }
        ...
        private l2<AccessLog, AccessLog.c, io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.b> e0() {
            if (this.f48589j == null) {
                this.f48589j = new l2<>(this.f48588i, (this.f48584e & 1) != 0, H(), O());
                this.f48588i = null;
            }
            return this.f48589j;
        }
        ...
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.http.router.v2.a.f48594b.d(Router.class, b.class);
        }
        ...
        public Router I() {
            ...
            q2<BoolValue, BoolValue.b, l> q2Var = this.f48586g;
            if (q2Var == null) {
                router.dynamicStats_ = this.f48585f;
            } else {
                router.dynamicStats_ = q2Var.b();
            }
            router.startChildSpan_ = this.f48587h;
            l2<AccessLog, AccessLog.c, io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.b> l2Var = this.f48589j;
            if (l2Var == null) {
                if ((this.f48584e & 1) != 0) {
                    this.f48588i = Collections.unmodifiableList(this.f48588i);
                    this.f48584e &= -2;
                }
                router.upstreamLog_ = this.f48588i;
            } else {
                router.upstreamLog_ = l2Var.e();
            }
            router.suppressEnvoyHeaders_ = this.f48590k;
            if ((this.f48584e & 2) != 0) {
                this.f48591l = this.f48591l.V0();
                this.f48584e &= -3;
            }
            router.strictCheckHeaders_ = this.f48591l;
            router.respectExpectedRqTimeout_ = this.f48592m;
            Q();
            return router;
        }
        ...
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.http.router.v2.a.f48593a;
        }

        public b h0(BoolValue boolValue) {
            q2<BoolValue, BoolValue.b, l> q2Var = this.f48586g;
            if (q2Var == null) {
                BoolValue boolValue2 = this.f48585f;
                if (boolValue2 != null) {
                    this.f48585f = BoolValue.newBuilder(boolValue2).d0(boolValue).I();
                } else {
                    this.f48585f = boolValue;
                }
                R();
            } else {
                q2Var.e(boolValue);
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.http.router.v2.Router.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.http.router.v2.Router.access$1200()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.http.router.v2.Router r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.http.router.v2.Router) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.k0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.http.router.v2.Router r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.http.router.v2.Router) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.http.router.v2.Router.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.http.router.v2.Router$b");
        }
        ...
        public b k0(Router router) {
            ...
            if (this.f48589j == null) {
                if (!router.upstreamLog_.isEmpty()) {
                    if (this.f48588i.isEmpty()) {
                        this.f48588i = router.upstreamLog_;
                        this.f48584e &= -2;
                    } else {
                        b0();
                        this.f48588i.addAll(router.upstreamLog_);
                    }
                    R();
                }
                ...
                if (this.f48589j.k()) {
                    ...
                    this.f48588i = router.upstreamLog_;
                    this.f48584e &= -2;
                    this.f48589j = GeneratedMessageV3.alwaysUseFieldBuilders ? e0() : null;
                } else {
                    this.f48589j.b(router.upstreamLog_);
                }
            }
            ...
            if (!router.strictCheckHeaders_.isEmpty()) {
                if (this.f48591l.isEmpty()) {
                    this.f48591l = router.strictCheckHeaders_;
                    this.f48584e &= -3;
                } else {
                    a0();
                    this.f48591l.addAll(router.strictCheckHeaders_);
                }
                R();
            }
        ...
        private b() {
            this.f48588i = Collections.emptyList();
            this.f48591l = y0.f15344d;
            g0();
        }
    ...
    public boolean equals(Object obj) {
        ...
        return (!hasDynamicStats() || getDynamicStats().equals(router.getDynamicStats())) && getStartChildSpan() == router.getStartChildSpan() && getUpstreamLogList().equals(router.getUpstreamLogList()) && getSuppressEnvoyHeaders() == router.getSuppressEnvoyHeaders() && m1619getStrictCheckHeadersList().equals(router.m1619getStrictCheckHeadersList()) && getRespectExpectedRqTimeout() == router.getRespectExpectedRqTimeout() && this.unknownFields.equals(router.unknownFields);
    }
    ...
    public int getSerializedSize() {
        ...
        int size = G + i11 + (m1619getStrictCheckHeadersList().size() * 1);
    ...
    public io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.b getUpstreamLogOrBuilder(int i9) {
        return this.upstreamLog_.get(i9);
    }

    public List<? extends io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.b> getUpstreamLogOrBuilderList() {
        return this.upstreamLog_;
    }
    ...
    public int hashCode() {
        ...
        if (getStrictCheckHeadersCount() > 0) {
            d11 = (((d11 * 37) + 5) * 53) + m1619getStrictCheckHeadersList().hashCode();
        }
        int d12 = (((((d11 * 37) + 6) * 53) + u0.d(getRespectExpectedRqTimeout())) * 29) + this.unknownFields.hashCode();
    ...
    public i2 m1619getStrictCheckHeadersList() {
