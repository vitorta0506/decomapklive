...
public final class LightstepConfig extends GeneratedMessageV3 implements r1 {
    ...
    public static final class c extends GeneratedMessageV3.b<c> implements r1 {
        ...
        private DataSource f49604h;

        /* renamed from: i  reason: collision with root package name */
        private q2<DataSource, DataSource.c, n> f49605i;

        /* renamed from: j  reason: collision with root package name */
        private List<Integer> f49606j;
        ...
        private void a0() {
            if ((this.f49601e & 1) == 0) {
                this.f49606j = new ArrayList(this.f49606j);
                this.f49601e |= 1;
            }
        }
        ...
        protected GeneratedMessageV3.e K() {
            return d.f49652b.d(LightstepConfig.class, c.class);
        }
        ...
        public LightstepConfig I() {
            ...
            lightstepConfig.collectorCluster_ = this.f49602f;
            lightstepConfig.accessTokenFile_ = this.f49603g;
            q2<DataSource, DataSource.c, n> q2Var = this.f49605i;
            if (q2Var == null) {
                lightstepConfig.accessToken_ = this.f49604h;
            } else {
                lightstepConfig.accessToken_ = q2Var.b();
            }
            if ((this.f49601e & 1) != 0) {
                this.f49606j = Collections.unmodifiableList(this.f49606j);
                this.f49601e &= -2;
            }
            lightstepConfig.propagationModes_ = this.f49606j;
            Q();
        ...
        public c e0(DataSource dataSource) {
            q2<DataSource, DataSource.c, n> q2Var = this.f49605i;
            if (q2Var == null) {
                DataSource dataSource2 = this.f49604h;
                if (dataSource2 != null) {
                    this.f49604h = DataSource.newBuilder(dataSource2).g0(dataSource).I();
                } else {
                    this.f49604h = dataSource;
                }
                R();
            } else {
                q2Var.e(dataSource);
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v3.LightstepConfig.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v3.LightstepConfig.access$900()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v3.LightstepConfig r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v3.LightstepConfig) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.i0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v3.LightstepConfig r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v3.LightstepConfig) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v3.LightstepConfig.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v3.LightstepConfig$c");
        }
        ...
        public c v(l1 l1Var) {
            if (l1Var instanceof LightstepConfig) {
                return i0((LightstepConfig) l1Var);
            }
            super.P0(l1Var);
            return this;
        }

        public c i0(LightstepConfig lightstepConfig) {
            if (lightstepConfig == LightstepConfig.getDefaultInstance()) {
                return this;
            }
            if (!lightstepConfig.getCollectorCluster().isEmpty()) {
                this.f49602f = lightstepConfig.collectorCluster_;
                R();
            }
            if (!lightstepConfig.getAccessTokenFile().isEmpty()) {
                this.f49603g = lightstepConfig.accessTokenFile_;
                R();
            }
            if (lightstepConfig.hasAccessToken()) {
                e0(lightstepConfig.getAccessToken());
            }
            if (!lightstepConfig.propagationModes_.isEmpty()) {
                if (this.f49606j.isEmpty()) {
                    this.f49606j = lightstepConfig.propagationModes_;
                    this.f49601e &= -2;
                } else {
                    a0();
                    this.f49606j.addAll(lightstepConfig.propagationModes_);
                }
                R();
            }
        ...
        private c() {
            this.f49602f = "";
            this.f49603g = "";
            this.f49606j = Collections.emptyList();
            d0();
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (getCollectorCluster().equals(lightstepConfig.getCollectorCluster()) && getAccessTokenFile().equals(lightstepConfig.getAccessTokenFile()) && hasAccessToken() == lightstepConfig.hasAccessToken()) {
            return (!hasAccessToken() || getAccessToken().equals(lightstepConfig.getAccessToken())) && this.propagationModes_.equals(lightstepConfig.propagationModes_) && this.unknownFields.equals(lightstepConfig.unknownFields);
        }
        return false;
    }

    public DataSource getAccessToken() {
        DataSource dataSource = this.accessToken_;
    ...
    public n getAccessTokenOrBuilder() {
    ...
    public int getSerializedSize() {
        ...
        if (this.accessToken_ != null) {
            i12 += CodedOutputStream.G(4, getAccessToken());
        }
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        if (this.accessToken_ != null) {
            codedOutputStream.L0(4, getAccessToken());
        }
    ...
    public static c newBuilder(LightstepConfig lightstepConfig) {
        return DEFAULT_INSTANCE.toBuilder().i0(lightstepConfig);
    }
                ...
                try {
                    ...
                    if (L != 0) {
                        if (L == 10) {
                            ...
                            this.accessToken_ = dataSource2;
                            if (builder != null) {
                                builder.g0(dataSource2);
                                this.accessToken_ = builder.I();
                            }
                        }
                    }
                    z10 = true;
