...
public final class DiscoveryRequest extends GeneratedMessageV3 implements r1 {
    ...
    public class a extends com.google.protobuf.c<DiscoveryRequest> {
        ...
        /* renamed from: G */
        public DiscoveryRequest m(com.google.protobuf.p pVar, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        private Object f46051f;

        /* renamed from: g  reason: collision with root package name */
        private Node f46052g;

        /* renamed from: h  reason: collision with root package name */
        private q2<Node, Node.c, e0> f46053h;

        /* renamed from: i  reason: collision with root package name */
        private z0 f46054i;

        /* renamed from: j  reason: collision with root package name */
        private Object f46055j;

        /* renamed from: k  reason: collision with root package name */
        private Object f46056k;

        /* renamed from: l  reason: collision with root package name */
        private Status f46057l;

        /* renamed from: m  reason: collision with root package name */
        private q2<Status, Status.b, com.google.rpc.c> f46058m;
        ...
        private void b0() {
            if ((this.f46050e & 1) == 0) {
                this.f46054i = new y0(this.f46054i);
                this.f46050e |= 1;
            }
        }
        ...
        protected GeneratedMessageV3.e K() {
            return d.f46795b.d(DiscoveryRequest.class, b.class);
        }

        public b W(Iterable<String> iterable) {
            b0();
            b.a.a(iterable, this.f46054i);
            R();
            return this;
        }
        ...
        public DiscoveryRequest I() {
            ...
            discoveryRequest.versionInfo_ = this.f46051f;
            q2<Node, Node.c, e0> q2Var = this.f46053h;
            if (q2Var == null) {
                discoveryRequest.node_ = this.f46052g;
            } else {
                discoveryRequest.node_ = q2Var.b();
            }
            if ((this.f46050e & 1) != 0) {
                this.f46054i = this.f46054i.V0();
                this.f46050e &= -2;
            }
            discoveryRequest.resourceNames_ = this.f46054i;
            discoveryRequest.typeUrl_ = this.f46055j;
            discoveryRequest.responseNonce_ = this.f46056k;
            q2<Status, Status.b, com.google.rpc.c> q2Var2 = this.f46058m;
            if (q2Var2 == null) {
                discoveryRequest.errorDetail_ = this.f46057l;
            } else {
        ...
        public b g0(Status status) {
            q2<Status, Status.b, com.google.rpc.c> q2Var = this.f46058m;
            if (q2Var == null) {
                Status status2 = this.f46057l;
                if (status2 != null) {
                    this.f46057l = Status.newBuilder(status2).i0(status).I();
                } else {
                    this.f46057l = status;
                }
                R();
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.DiscoveryRequest.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.DiscoveryRequest.access$1100()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.DiscoveryRequest r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.DiscoveryRequest) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.j0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.DiscoveryRequest r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.DiscoveryRequest) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.DiscoveryRequest.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.DiscoveryRequest$b");
        }
        ...
        public b j0(DiscoveryRequest discoveryRequest) {
            ...
            if (!discoveryRequest.getVersionInfo().isEmpty()) {
                this.f46051f = discoveryRequest.versionInfo_;
                R();
            }
            ...
            if (!discoveryRequest.resourceNames_.isEmpty()) {
                if (this.f46054i.isEmpty()) {
                    this.f46054i = discoveryRequest.resourceNames_;
                    this.f46050e &= -2;
                } else {
                    b0();
                    this.f46054i.addAll(discoveryRequest.resourceNames_);
                }
                R();
            }
            if (!discoveryRequest.getTypeUrl().isEmpty()) {
                this.f46055j = discoveryRequest.typeUrl_;
                R();
            }
            if (!discoveryRequest.getResponseNonce().isEmpty()) {
                this.f46056k = discoveryRequest.responseNonce_;
                R();
            }
        ...
        public b k0(Node node) {
            q2<Node, Node.c, e0> q2Var = this.f46053h;
            if (q2Var == null) {
                Node node2 = this.f46052g;
                if (node2 != null) {
                    this.f46052g = Node.newBuilder(node2).n0(node).I();
                } else {
                    this.f46052g = node;
                }
                R();
    ...
    /* synthetic */ DiscoveryRequest(com.google.protobuf.p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getVersionInfo().equals(discoveryRequest.getVersionInfo()) && hasNode() == discoveryRequest.hasNode()) {
            if ((!hasNode() || getNode().equals(discoveryRequest.getNode())) && m1581getResourceNamesList().equals(discoveryRequest.m1581getResourceNamesList()) && getTypeUrl().equals(discoveryRequest.getTypeUrl()) && getResponseNonce().equals(discoveryRequest.getResponseNonce()) && hasErrorDetail() == discoveryRequest.hasErrorDetail()) {
    ...
    public int getSerializedSize() {
        ...
        int size = computeStringSize + i10 + (m1581getResourceNamesList().size() * 1);
    ...
    public int hashCode() {
        ...
        if (getResourceNamesCount() > 0) {
            hashCode = (((hashCode * 37) + 3) * 53) + m1581getResourceNamesList().hashCode();
        }
    ...
    public i2 m1581getResourceNamesList() {
    ...
    private DiscoveryRequest(com.google.protobuf.p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
    ...
    public static DiscoveryRequest parseFrom(com.google.protobuf.p pVar) throws IOException {
        return (DiscoveryRequest) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
    }

    public static DiscoveryRequest parseFrom(com.google.protobuf.p pVar, f0 f0Var) throws IOException {
