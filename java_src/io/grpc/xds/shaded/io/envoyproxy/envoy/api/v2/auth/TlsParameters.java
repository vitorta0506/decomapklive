...
public final class TlsParameters extends GeneratedMessageV3 implements j {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements j {
        ...
        private void a0() {
            if ((this.f46224e & 1) == 0) {
                this.f46227h = new y0(this.f46227h);
                this.f46224e |= 1;
            }
        }
        ...
        private void b0() {
            if ((this.f46224e & 2) == 0) {
                this.f46228i = new y0(this.f46228i);
                this.f46224e |= 2;
            }
        }
        ...
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.auth.b.f46239b.d(TlsParameters.class, b.class);
        }
        ...
        public TlsParameters I() {
            ...
            tlsParameters.tlsMinimumProtocolVersion_ = this.f46225f;
            tlsParameters.tlsMaximumProtocolVersion_ = this.f46226g;
            if ((this.f46224e & 1) != 0) {
                this.f46227h = this.f46227h.V0();
                this.f46224e &= -2;
            }
            tlsParameters.cipherSuites_ = this.f46227h;
            if ((this.f46224e & 2) != 0) {
                this.f46228i = this.f46228i.V0();
                this.f46224e &= -3;
            }
            tlsParameters.ecdhCurves_ = this.f46228i;
            Q();
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.auth.TlsParameters.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.auth.TlsParameters.access$900()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.auth.TlsParameters.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.auth.TlsParameters$b");
        }

        @Override // com.google.protobuf.GeneratedMessageV3.b, com.google.protobuf.l1.a, com.google.protobuf.r1
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.auth.b.f46238a;
        }
        ...
        public b i0(TlsParameters tlsParameters) {
            ...
            if (!tlsParameters.cipherSuites_.isEmpty()) {
                if (this.f46227h.isEmpty()) {
                    this.f46227h = tlsParameters.cipherSuites_;
                    this.f46224e &= -2;
                } else {
                    a0();
                    this.f46227h.addAll(tlsParameters.cipherSuites_);
                }
                R();
            }
            if (!tlsParameters.ecdhCurves_.isEmpty()) {
                if (this.f46228i.isEmpty()) {
                    this.f46228i = tlsParameters.ecdhCurves_;
                    this.f46224e &= -3;
                } else {
                    b0();
                    this.f46228i.addAll(tlsParameters.ecdhCurves_);
                }
                R();
            }
    ...
    public boolean equals(Object obj) {
        ...
        return this.tlsMinimumProtocolVersion_ == tlsParameters.tlsMinimumProtocolVersion_ && this.tlsMaximumProtocolVersion_ == tlsParameters.tlsMaximumProtocolVersion_ && m1590getCipherSuitesList().equals(tlsParameters.m1590getCipherSuitesList()) && m1591getEcdhCurvesList().equals(tlsParameters.m1591getEcdhCurvesList()) && this.unknownFields.equals(tlsParameters.unknownFields);
    }
    ...
    public int getSerializedSize() {
        ...
        int size = l10 + i11 + (m1590getCipherSuitesList().size() * 1);
        int i13 = 0;
        for (int i14 = 0; i14 < this.ecdhCurves_.size(); i14++) {
            i13 += GeneratedMessageV3.computeStringSizeNoTag(this.ecdhCurves_.c1(i14));
        }
        int size2 = size + i13 + (m1591getEcdhCurvesList().size() * 1) + this.unknownFields.getSerializedSize();
    ...
    public int hashCode() {
        ...
        if (getCipherSuitesCount() > 0) {
            hashCode = (((hashCode * 37) + 3) * 53) + m1590getCipherSuitesList().hashCode();
        }
        if (getEcdhCurvesCount() > 0) {
            hashCode = (((hashCode * 37) + 4) * 53) + m1591getEcdhCurvesList().hashCode();
        }
    ...
    public i2 m1590getCipherSuitesList() {
        return this.cipherSuites_;
    }

    /* renamed from: getEcdhCurvesList */
    public i2 m1591getEcdhCurvesList() {
