...
import io.grpc.xds.shaded.io.envoyproxy.envoy.config.route.v3.t;
...
public final class ScopedRouteConfigurationsList extends GeneratedMessageV3 implements i {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements i {
        ...
        private List<ScopedRouteConfiguration> f49850f;

        /* renamed from: g  reason: collision with root package name */
        private l2<ScopedRouteConfiguration, ScopedRouteConfiguration.c, t> f49851g;
        ...
        private void a0() {
            if ((this.f49849e & 1) == 0) {
                this.f49850f = new ArrayList(this.f49850f);
                this.f49849e |= 1;
            }
        }

        private l2<ScopedRouteConfiguration, ScopedRouteConfiguration.c, t> d0() {
            if (this.f49851g == null) {
                this.f49851g = new l2<>(this.f49850f, (this.f49849e & 1) != 0, H(), O());
                this.f49850f = null;
            }
            return this.f49851g;
        }
        ...
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.b.f49896t.d(ScopedRouteConfigurationsList.class, b.class);
        }
        ...
        public ScopedRouteConfigurationsList I() {
            ...
            int i9 = this.f49849e;
            l2<ScopedRouteConfiguration, ScopedRouteConfiguration.c, t> l2Var = this.f49851g;
            if (l2Var == null) {
                if ((i9 & 1) != 0) {
                    this.f49850f = Collections.unmodifiableList(this.f49850f);
                    this.f49849e &= -2;
                }
                scopedRouteConfigurationsList.scopedRouteConfigurations_ = this.f49850f;
            } else {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRouteConfigurationsList.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRouteConfigurationsList.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRouteConfigurationsList.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.ScopedRouteConfigurationsList$b");
        }

        @Override // com.google.protobuf.GeneratedMessageV3.b, com.google.protobuf.l1.a, com.google.protobuf.r1
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.extensions.filters.network.http_connection_manager.v3.b.f49895s;
        }
        ...
        public b i0(ScopedRouteConfigurationsList scopedRouteConfigurationsList) {
            ...
            if (this.f49851g == null) {
                if (!scopedRouteConfigurationsList.scopedRouteConfigurations_.isEmpty()) {
                    if (this.f49850f.isEmpty()) {
                        this.f49850f = scopedRouteConfigurationsList.scopedRouteConfigurations_;
                        this.f49849e &= -2;
                    } else {
                        a0();
                        this.f49850f.addAll(scopedRouteConfigurationsList.scopedRouteConfigurations_);
                    }
                    R();
                }
                ...
                if (this.f49851g.k()) {
                    ...
                    this.f49850f = scopedRouteConfigurationsList.scopedRouteConfigurations_;
                    this.f49849e &= -2;
                    this.f49851g = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                } else {
                    this.f49851g.b(scopedRouteConfigurationsList.scopedRouteConfigurations_);
                }
            }
        ...
        private b() {
            this.f49850f = Collections.emptyList();
            e0();
        }
    ...
    public t getScopedRouteConfigurationsOrBuilder(int i9) {
        return this.scopedRouteConfigurations_.get(i9);
    }

    public List<? extends t> getScopedRouteConfigurationsOrBuilderList() {
        return this.scopedRouteConfigurations_;
    }
