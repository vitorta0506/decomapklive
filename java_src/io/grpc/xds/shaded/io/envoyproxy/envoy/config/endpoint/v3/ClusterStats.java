...
public final class ClusterStats extends GeneratedMessageV3 implements io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.b {
    ...
    public static final class DroppedRequests extends GeneratedMessageV3 implements c {
        ...
        public static final class b extends GeneratedMessageV3.b<b> implements c {
            ...
            private Object f48339e;

            /* renamed from: f  reason: collision with root package name */
            private long f48340f;
            ...
            protected GeneratedMessageV3.e K() {
                return i.f48445j.d(DroppedRequests.class, b.class);
            }
            ...
            public DroppedRequests I() {
                ...
                droppedRequests.category_ = this.f48339e;
                droppedRequests.droppedCount_ = this.f48340f;
                Q();
            ...
            */
            public io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterStats.DroppedRequests.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                /*
                    r2 = this;
                    r0 = 0
                    com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterStats.DroppedRequests.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterStats$DroppedRequests r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterStats.DroppedRequests) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    if (r3 == 0) goto L10
                    r2.g0(r3)
                L10:
                    return r2
                ...
                L13:
                    ...
                    io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterStats$DroppedRequests r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterStats.DroppedRequests) r4     // Catch: java.lang.Throwable -> L11
                ...
                L26:
                    throw r3
                */
                throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterStats.DroppedRequests.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterStats$DroppedRequests$b");
            }
            ...
            public b g0(DroppedRequests droppedRequests) {
                ...
                if (!droppedRequests.getCategory().isEmpty()) {
                    this.f48339e = droppedRequests.category_;
                    R();
                }
    ...
    /* loaded from: classes6.dex */
    public static final class b extends GeneratedMessageV3.b<b> implements io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.b {

        /* renamed from: e  reason: collision with root package name */
        private int f48341e;

        /* renamed from: f  reason: collision with root package name */
        private Object f48342f;

        /* renamed from: g  reason: collision with root package name */
        private Object f48343g;

        /* renamed from: h  reason: collision with root package name */
        private List<UpstreamLocalityStats> f48344h;

        /* renamed from: i  reason: collision with root package name */
        private l2<UpstreamLocalityStats, UpstreamLocalityStats.b, l> f48345i;

        /* renamed from: j  reason: collision with root package name */
        private long f48346j;

        /* renamed from: k  reason: collision with root package name */
        private List<DroppedRequests> f48347k;

        /* renamed from: l  reason: collision with root package name */
        private l2<DroppedRequests, DroppedRequests.b, c> f48348l;

        /* renamed from: m  reason: collision with root package name */
        private Duration f48349m;

        /* renamed from: n  reason: collision with root package name */
        private q2<Duration, Duration.b, v> f48350n;
        ...
        private void d0() {
            if ((this.f48341e & 2) == 0) {
                this.f48347k = new ArrayList(this.f48347k);
                this.f48341e |= 2;
            }
        }
        ...
        private void e0() {
            if ((this.f48341e & 1) == 0) {
                this.f48344h = new ArrayList(this.f48344h);
                this.f48341e |= 1;
            }
        }

        private l2<DroppedRequests, DroppedRequests.b, c> h0() {
            if (this.f48348l == null) {
                this.f48348l = new l2<>(this.f48347k, (this.f48341e & 2) != 0, H(), O());
                this.f48347k = null;
            }
            return this.f48348l;
        }

        private l2<UpstreamLocalityStats, UpstreamLocalityStats.b, l> i0() {
            if (this.f48345i == null) {
                this.f48345i = new l2<>(this.f48344h, (this.f48341e & 1) != 0, H(), O());
                this.f48344h = null;
            }
            return this.f48345i;
        }
        ...
        @Override // com.google.protobuf.GeneratedMessageV3.b
        protected GeneratedMessageV3.e K() {
            return i.f48443h.d(ClusterStats.class, b.class);
        }

        public b W(DroppedRequests.b bVar) {
            l2<DroppedRequests, DroppedRequests.b, c> l2Var = this.f48348l;
            if (l2Var == null) {
                d0();
                this.f48347k.add(bVar.build());
                R();
            } else {
                l2Var.d(bVar.build());
            }
        ...
        public b Y(UpstreamLocalityStats.b bVar) {
            l2<UpstreamLocalityStats, UpstreamLocalityStats.b, l> l2Var = this.f48345i;
            if (l2Var == null) {
                e0();
                this.f48344h.add(bVar.build());
                R();
            } else {
                l2Var.d(bVar.build());
            }
        ...
        public ClusterStats I() {
            ...
            clusterStats.clusterName_ = this.f48342f;
            clusterStats.clusterServiceName_ = this.f48343g;
            l2<UpstreamLocalityStats, UpstreamLocalityStats.b, l> l2Var = this.f48345i;
            if (l2Var == null) {
                if ((this.f48341e & 1) != 0) {
                    this.f48344h = Collections.unmodifiableList(this.f48344h);
                    this.f48341e &= -2;
                }
                clusterStats.upstreamLocalityStats_ = this.f48344h;
            } else {
                clusterStats.upstreamLocalityStats_ = l2Var.e();
            }
            clusterStats.totalDroppedRequests_ = this.f48346j;
            l2<DroppedRequests, DroppedRequests.b, c> l2Var2 = this.f48348l;
            if (l2Var2 == null) {
                if ((this.f48341e & 2) != 0) {
                    this.f48347k = Collections.unmodifiableList(this.f48347k);
                    this.f48341e &= -3;
                }
                clusterStats.droppedRequests_ = this.f48347k;
            } else {
                clusterStats.droppedRequests_ = l2Var2.e();
            }
            q2<Duration, Duration.b, v> q2Var = this.f48350n;
            if (q2Var == null) {
                clusterStats.loadReportInterval_ = this.f48349m;
            } else {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterStats.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterStats.access$2300()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterStats r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterStats) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.m0(r3)
            L10:
                return r2
            ...
            L13:
                r3 = move-exception
                com.google.protobuf.o1 r4 = r3.getUnfinishedMessage()     // Catch: java.lang.Throwable -> L11
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterStats r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterStats) r4     // Catch: java.lang.Throwable -> L11
                java.io.IOException r3 = r3.unwrapIOException()     // Catch: java.lang.Throwable -> L1f
                throw r3     // Catch: java.lang.Throwable -> L1f
            L1f:
                r3 = move-exception
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterStats.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.endpoint.v3.ClusterStats$b");
        }
        ...
        public b m0(ClusterStats clusterStats) {
            ...
            if (!clusterStats.getClusterName().isEmpty()) {
                this.f48342f = clusterStats.clusterName_;
                R();
            }
            if (!clusterStats.getClusterServiceName().isEmpty()) {
                this.f48343g = clusterStats.clusterServiceName_;
                R();
            }
            if (this.f48345i == null) {
                if (!clusterStats.upstreamLocalityStats_.isEmpty()) {
                    if (this.f48344h.isEmpty()) {
                        this.f48344h = clusterStats.upstreamLocalityStats_;
                        this.f48341e &= -2;
                    } else {
                        e0();
                        this.f48344h.addAll(clusterStats.upstreamLocalityStats_);
                    }
                    R();
                }
                ...
                if (this.f48345i.k()) {
                    ...
                    this.f48344h = clusterStats.upstreamLocalityStats_;
                    this.f48341e &= -2;
                    this.f48345i = GeneratedMessageV3.alwaysUseFieldBuilders ? i0() : null;
                } else {
                    this.f48345i.b(clusterStats.upstreamLocalityStats_);
                }
            }
            ...
            if (this.f48348l == null) {
                if (!clusterStats.droppedRequests_.isEmpty()) {
                    if (this.f48347k.isEmpty()) {
                        this.f48347k = clusterStats.droppedRequests_;
                        this.f48341e &= -3;
                    } else {
                        d0();
                        this.f48347k.addAll(clusterStats.droppedRequests_);
                    }
                    R();
                }
                ...
                if (this.f48348l.k()) {
                    ...
                    this.f48347k = clusterStats.droppedRequests_;
                    this.f48341e &= -3;
                    this.f48348l = GeneratedMessageV3.alwaysUseFieldBuilders ? h0() : null;
                } else {
                    this.f48348l.b(clusterStats.droppedRequests_);
                }
            }
        ...
        public b n0(Duration duration) {
            q2<Duration, Duration.b, v> q2Var = this.f48350n;
            if (q2Var == null) {
                Duration duration2 = this.f48349m;
                if (duration2 != null) {
                    this.f48349m = Duration.newBuilder(duration2).e0(duration).I();
                } else {
                    this.f48349m = duration;
                }
                R();
            } else {
                q2Var.e(duration);
        ...
        private b() {
            this.f48342f = "";
            this.f48343g = "";
            this.f48344h = Collections.emptyList();
            this.f48347k = Collections.emptyList();
            j0();
        }
    ...
    public l getUpstreamLocalityStatsOrBuilder(int i9) {
        return this.upstreamLocalityStats_.get(i9);
    }

    public List<? extends l> getUpstreamLocalityStatsOrBuilderList() {
        return this.upstreamLocalityStats_;
    }
