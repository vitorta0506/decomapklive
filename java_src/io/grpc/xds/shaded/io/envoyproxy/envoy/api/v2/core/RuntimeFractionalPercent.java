...
public final class RuntimeFractionalPercent extends GeneratedMessageV3 implements k0 {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements k0 {
        ...
        private FractionalPercent f46639e;

        /* renamed from: f  reason: collision with root package name */
        private q2<FractionalPercent, FractionalPercent.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.b> f46640f;

        /* renamed from: g  reason: collision with root package name */
        private Object f46641g;
        ...
        protected GeneratedMessageV3.e K() {
            return g.J.d(RuntimeFractionalPercent.class, b.class);
        }
        ...
        public RuntimeFractionalPercent I() {
            ...
            q2<FractionalPercent, FractionalPercent.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.b> q2Var = this.f46640f;
            if (q2Var == null) {
                runtimeFractionalPercent.defaultValue_ = this.f46639e;
            } else {
                runtimeFractionalPercent.defaultValue_ = q2Var.b();
            }
            runtimeFractionalPercent.runtimeKey_ = this.f46641g;
            Q();
        ...
        public b d0(FractionalPercent fractionalPercent) {
            q2<FractionalPercent, FractionalPercent.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.b> q2Var = this.f46640f;
            if (q2Var == null) {
                FractionalPercent fractionalPercent2 = this.f46639e;
                if (fractionalPercent2 != null) {
                    this.f46639e = FractionalPercent.newBuilder(fractionalPercent2).g0(fractionalPercent).I();
                } else {
                    this.f46639e = fractionalPercent;
                }
                R();
            } else {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.RuntimeFractionalPercent.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.RuntimeFractionalPercent.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.RuntimeFractionalPercent.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.RuntimeFractionalPercent$b");
        }
        ...
        public b h0(RuntimeFractionalPercent runtimeFractionalPercent) {
            ...
            if (!runtimeFractionalPercent.getRuntimeKey().isEmpty()) {
                this.f46641g = runtimeFractionalPercent.runtimeKey_;
                R();
            }
    ...
    public io.grpc.xds.shaded.io.envoyproxy.envoy.type.b getDefaultValueOrBuilder() {
