...
public final class Route extends GeneratedMessageV3 implements n {
    ...
    public static /* synthetic */ class b {
        ...
        static {
            ...
            try {
                f47124a[ActionCase.REDIRECT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f47124a[ActionCase.DIRECT_RESPONSE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f47124a[ActionCase.FILTER_ACTION.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f47124a[ActionCase.ACTION_NOT_SET.ordinal()] = 5;
    ...
    public static final class c extends GeneratedMessageV3.b<c> implements n {
        private Tracing A;
        private q2<Tracing, Tracing.b, o> B;
        ...
        private Object f47126f;

        /* renamed from: g  reason: collision with root package name */
        private int f47127g;

        /* renamed from: h  reason: collision with root package name */
        private Object f47128h;

        /* renamed from: i  reason: collision with root package name */
        private RouteMatch f47129i;

        /* renamed from: j  reason: collision with root package name */
        private q2<RouteMatch, RouteMatch.c, m> f47130j;

        /* renamed from: k  reason: collision with root package name */
        private q2<RouteAction, RouteAction.c, k> f47131k;

        /* renamed from: l  reason: collision with root package name */
        private q2<RedirectAction, RedirectAction.c, i> f47132l;

        /* renamed from: m  reason: collision with root package name */
        private q2<DirectResponseAction, DirectResponseAction.b, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.c> f47133m;

        /* renamed from: n  reason: collision with root package name */
        private q2<FilterAction, FilterAction.b, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.d> f47134n;

        /* renamed from: o  reason: collision with root package name */
        private Metadata f47135o;

        /* renamed from: p  reason: collision with root package name */
        private q2<Metadata, Metadata.b, d0> f47136p;

        /* renamed from: q  reason: collision with root package name */
        private Decorator f47137q;

        /* renamed from: r  reason: collision with root package name */
        private q2<Decorator, Decorator.b, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.b> f47138r;

        /* renamed from: s  reason: collision with root package name */
        private g1<String, Struct> f47139s;

        /* renamed from: t  reason: collision with root package name */
        private g1<String, Any> f47140t;

        /* renamed from: u  reason: collision with root package name */
        private List<HeaderValueOption> f47141u;

        /* renamed from: v  reason: collision with root package name */
        private l2<HeaderValueOption, HeaderValueOption.b, t> f47142v;

        /* renamed from: w  reason: collision with root package name */
        private z0 f47143w;

        /* renamed from: x  reason: collision with root package name */
        private List<HeaderValueOption> f47144x;

        /* renamed from: y  reason: collision with root package name */
        private l2<HeaderValueOption, HeaderValueOption.b, t> f47145y;
        ...
        private void a0() {
            if ((this.f47127g & 4) == 0) {
                this.f47141u = new ArrayList(this.f47141u);
                this.f47127g |= 4;
            }
        }
        ...
        private void b0() {
            if ((this.f47127g & 8) == 0) {
                this.f47143w = new y0(this.f47143w);
                this.f47127g |= 8;
            }
        }

        private void d0() {
            if ((this.f47127g & 16) == 0) {
                this.f47144x = new ArrayList(this.f47144x);
                this.f47127g |= 16;
            }
        }

        private void e0() {
            if ((this.f47127g & 32) == 0) {
                this.f47146z = new y0(this.f47146z);
                this.f47127g |= 32;
            }
        }
        ...
        private l2<HeaderValueOption, HeaderValueOption.b, t> h0() {
            if (this.f47142v == null) {
                this.f47142v = new l2<>(this.f47141u, (this.f47127g & 4) != 0, H(), O());
                this.f47141u = null;
            }
            return this.f47142v;
        }
        ...
        private l2<HeaderValueOption, HeaderValueOption.b, t> i0() {
            if (this.f47145y == null) {
                this.f47145y = new l2<>(this.f47144x, (this.f47127g & 16) != 0, H(), O());
                this.f47144x = null;
            }
            return this.f47145y;
        }
        ...
        private g1<String, Struct> j0() {
            R();
            if (this.f47139s == null) {
                this.f47139s = g1.p(d.f47147a);
            }
            if (!this.f47139s.m()) {
                this.f47139s = this.f47139s.f();
            }
            return this.f47139s;
        }
        ...
        private g1<String, Any> k0() {
            ...
            if (this.f47140t == null) {
                this.f47140t = g1.p(e.f47148a);
            }
            if (!this.f47140t.m()) {
                this.f47140t = this.f47140t.f();
            }
            return this.f47140t;
        }

        private g1<String, Struct> l0() {
            g1<String, Struct> g1Var = this.f47139s;
            return g1Var == null ? g1.g(d.f47147a) : g1Var;
        }

        private g1<String, Any> m0() {
            g1<String, Any> g1Var = this.f47140t;
            return g1Var == null ? g1.g(e.f47148a) : g1Var;
        }
        ...
        public c B0(RouteAction routeAction) {
            q2<RouteAction, RouteAction.c, k> q2Var = this.f47131k;
            if (q2Var == null) {
                if (this.f47125e == 2 && this.f47126f != RouteAction.getDefaultInstance()) {
                    this.f47126f = RouteAction.newBuilder((RouteAction) this.f47126f).r0(routeAction).I();
                } else {
                    this.f47126f = routeAction;
                }
                R();
            } else {
                if (this.f47125e == 2) {
                ...
                this.f47131k.g(routeAction);
            }
            this.f47125e = 2;
            return this;
        }

        public c D0(Tracing tracing) {
            q2<Tracing, Tracing.b, o> q2Var = this.B;
            if (q2Var == null) {
        ...
        protected GeneratedMessageV3.e K() {
            return l.f47301j.d(Route.class, c.class);
        }
        ...
        public Route I() {
            ...
            route.name_ = this.f47128h;
            q2<RouteMatch, RouteMatch.c, m> q2Var = this.f47130j;
            if (q2Var == null) {
                route.match_ = this.f47129i;
            } else {
                route.match_ = q2Var.b();
            }
            if (this.f47125e == 2) {
                q2<RouteAction, RouteAction.c, k> q2Var2 = this.f47131k;
                if (q2Var2 == null) {
                    route.action_ = this.f47126f;
                } else {
                    route.action_ = q2Var2.b();
                }
            }
            if (this.f47125e == 3) {
                q2<RedirectAction, RedirectAction.c, i> q2Var3 = this.f47132l;
                if (q2Var3 == null) {
                    route.action_ = this.f47126f;
                } else {
            ...
            if (this.f47125e == 7) {
                q2<DirectResponseAction, DirectResponseAction.b, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.c> q2Var4 = this.f47133m;
                if (q2Var4 == null) {
                    route.action_ = this.f47126f;
                } else {
            ...
            if (this.f47125e == 17) {
                q2<FilterAction, FilterAction.b, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.d> q2Var5 = this.f47134n;
                if (q2Var5 == null) {
                    route.action_ = this.f47126f;
                } else {
            ...
            q2<Metadata, Metadata.b, d0> q2Var6 = this.f47136p;
            if (q2Var6 == null) {
                route.metadata_ = this.f47135o;
            } else {
                route.metadata_ = q2Var6.b();
            }
            q2<Decorator, Decorator.b, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.b> q2Var7 = this.f47138r;
            if (q2Var7 == null) {
                route.decorator_ = this.f47137q;
            } else {
                route.decorator_ = q2Var7.b();
            }
            route.perFilterConfig_ = l0();
            route.perFilterConfig_.n();
            route.typedPerFilterConfig_ = m0();
            route.typedPerFilterConfig_.n();
            l2<HeaderValueOption, HeaderValueOption.b, t> l2Var = this.f47142v;
            if (l2Var == null) {
                if ((this.f47127g & 4) != 0) {
                    this.f47141u = Collections.unmodifiableList(this.f47141u);
                    this.f47127g &= -5;
                }
                route.requestHeadersToAdd_ = this.f47141u;
            } else {
                route.requestHeadersToAdd_ = l2Var.e();
            }
            if ((this.f47127g & 8) != 0) {
                this.f47143w = this.f47143w.V0();
                this.f47127g &= -9;
            }
            route.requestHeadersToRemove_ = this.f47143w;
            l2<HeaderValueOption, HeaderValueOption.b, t> l2Var2 = this.f47145y;
            if (l2Var2 == null) {
                if ((this.f47127g & 16) != 0) {
                    this.f47144x = Collections.unmodifiableList(this.f47144x);
                    this.f47127g &= -17;
                }
                route.responseHeadersToAdd_ = this.f47144x;
            } else {
                route.responseHeadersToAdd_ = l2Var2.e();
            }
            if ((this.f47127g & 32) != 0) {
                this.f47146z = this.f47146z.V0();
                this.f47127g &= -33;
            }
            route.responseHeadersToRemove_ = this.f47146z;
            q2<Tracing, Tracing.b, o> q2Var8 = this.B;
            if (q2Var8 == null) {
                route.tracing_ = this.A;
            } else {
                route.tracing_ = q2Var8.b();
            }
            q2<UInt32Value, UInt32Value.b, e3> q2Var9 = this.D;
            if (q2Var9 == null) {
                route.perRequestBufferLimitBytes_ = this.C;
            } else {
                route.perRequestBufferLimitBytes_ = q2Var9.b();
            }
            route.actionCase_ = this.f47125e;
            Q();
            return route;
        }
        ...
        public c o0(Decorator decorator) {
            q2<Decorator, Decorator.b, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.b> q2Var = this.f47138r;
            if (q2Var == null) {
                Decorator decorator2 = this.f47137q;
                if (decorator2 != null) {
                    this.f47137q = Decorator.newBuilder(decorator2).g0(decorator).I();
                } else {
                    this.f47137q = decorator;
                }
                R();
            } else {
                q2Var.e(decorator);
        ...
        public c q0(DirectResponseAction directResponseAction) {
            q2<DirectResponseAction, DirectResponseAction.b, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.c> q2Var = this.f47133m;
            if (q2Var == null) {
                if (this.f47125e == 7 && this.f47126f != DirectResponseAction.getDefaultInstance()) {
                    this.f47126f = DirectResponseAction.newBuilder((DirectResponseAction) this.f47126f).h0(directResponseAction).I();
                } else {
                    this.f47126f = directResponseAction;
                }
                R();
            } else {
                if (this.f47125e == 7) {
                ...
                this.f47133m.g(directResponseAction);
            }
            this.f47125e = 7;
            return this;
        }

        public c r0(FilterAction filterAction) {
            q2<FilterAction, FilterAction.b, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.d> q2Var = this.f47134n;
            if (q2Var == null) {
                if (this.f47125e == 17 && this.f47126f != FilterAction.getDefaultInstance()) {
                    this.f47126f = FilterAction.newBuilder((FilterAction) this.f47126f).h0(filterAction).I();
                } else {
                    this.f47126f = filterAction;
                }
                R();
            } else {
                if (this.f47125e == 17) {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.Route.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.Route.access$2300()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.Route r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.Route) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.u0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.Route r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.Route) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.Route.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.Route$c");
        }
        ...
        public c v(l1 l1Var) {
            if (l1Var instanceof Route) {
                return u0((Route) l1Var);
            }
            super.P0(l1Var);
            return this;
        }

        public c u0(Route route) {
            if (route == Route.getDefaultInstance()) {
                return this;
            }
            if (!route.getName().isEmpty()) {
                this.f47128h = route.name_;
                R();
            }
            if (route.hasMatch()) {
                v0(route.getMatch());
            ...
            if (route.hasMetadata()) {
                x0(route.getMetadata());
            }
            if (route.hasDecorator()) {
                o0(route.getDecorator());
            }
            j0().o(route.internalGetPerFilterConfig());
            k0().o(route.internalGetTypedPerFilterConfig());
            if (this.f47142v == null) {
                if (!route.requestHeadersToAdd_.isEmpty()) {
                    if (this.f47141u.isEmpty()) {
                        this.f47141u = route.requestHeadersToAdd_;
                        this.f47127g &= -5;
                    } else {
                        a0();
                        this.f47141u.addAll(route.requestHeadersToAdd_);
                    }
                    R();
                }
                ...
                if (this.f47142v.k()) {
                    ...
                    this.f47141u = route.requestHeadersToAdd_;
                    this.f47127g &= -5;
                    this.f47142v = GeneratedMessageV3.alwaysUseFieldBuilders ? h0() : null;
                } else {
                    this.f47142v.b(route.requestHeadersToAdd_);
                }
            }
            if (!route.requestHeadersToRemove_.isEmpty()) {
                if (this.f47143w.isEmpty()) {
                    this.f47143w = route.requestHeadersToRemove_;
                    this.f47127g &= -9;
                } else {
                    b0();
                    this.f47143w.addAll(route.requestHeadersToRemove_);
                }
                R();
            }
            if (this.f47145y == null) {
                if (!route.responseHeadersToAdd_.isEmpty()) {
                    if (this.f47144x.isEmpty()) {
                        this.f47144x = route.responseHeadersToAdd_;
                        this.f47127g &= -17;
                    } else {
                        d0();
                        this.f47144x.addAll(route.responseHeadersToAdd_);
                    }
                    R();
                }
                ...
                if (this.f47145y.k()) {
                    ...
                    this.f47144x = route.responseHeadersToAdd_;
                    this.f47127g &= -17;
                    this.f47145y = GeneratedMessageV3.alwaysUseFieldBuilders ? i0() : null;
                } else {
                    this.f47145y.b(route.responseHeadersToAdd_);
                }
            }
            if (!route.responseHeadersToRemove_.isEmpty()) {
                if (this.f47146z.isEmpty()) {
                    this.f47146z = route.responseHeadersToRemove_;
                    this.f47127g &= -33;
                } else {
                    e0();
                    this.f47146z.addAll(route.responseHeadersToRemove_);
                }
                R();
            }
            if (route.hasTracing()) {
            ...
            if (route.hasPerRequestBufferLimitBytes()) {
                y0(route.getPerRequestBufferLimitBytes());
            }
            int i9 = b.f47124a[route.getActionCase().ordinal()];
            if (i9 == 1) {
                B0(route.getRoute());
            } else if (i9 == 2) {
                z0(route.getRedirect());
            } else if (i9 == 3) {
                q0(route.getDirectResponse());
            } else if (i9 == 4) {
                r0(route.getFilterAction());
            }
        ...
        public c v0(RouteMatch routeMatch) {
            q2<RouteMatch, RouteMatch.c, m> q2Var = this.f47130j;
            if (q2Var == null) {
                RouteMatch routeMatch2 = this.f47129i;
                if (routeMatch2 != null) {
                    this.f47129i = RouteMatch.newBuilder(routeMatch2).l0(routeMatch).I();
                } else {
                    this.f47129i = routeMatch;
                }
                R();
            } else {
                q2Var.e(routeMatch);
        ...
        public c x0(Metadata metadata) {
            q2<Metadata, Metadata.b, d0> q2Var = this.f47136p;
            if (q2Var == null) {
                Metadata metadata2 = this.f47135o;
                if (metadata2 != null) {
                    this.f47135o = Metadata.newBuilder(metadata2).i0(metadata).I();
                } else {
                    this.f47135o = metadata;
                }
                R();
            } else {
                q2Var.e(metadata);
        ...
        public c z0(RedirectAction redirectAction) {
            q2<RedirectAction, RedirectAction.c, i> q2Var = this.f47132l;
            if (q2Var == null) {
                if (this.f47125e == 3 && this.f47126f != RedirectAction.getDefaultInstance()) {
                    this.f47126f = RedirectAction.newBuilder((RedirectAction) this.f47126f).g0(redirectAction).I();
                } else {
                    this.f47126f = redirectAction;
                }
                R();
            } else {
                if (this.f47125e == 3) {
        ...
        private c() {
            this.f47125e = 0;
            this.f47128h = "";
            this.f47141u = Collections.emptyList();
            z0 z0Var = y0.f15344d;
            this.f47143w = z0Var;
            this.f47144x = Collections.emptyList();
            this.f47146z = z0Var;
            n0();
        }
    ...
    public static final class d {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final e1<String, Struct> f47147a = e1.k(l.f47303k, WireFormat.FieldType.STRING, "", WireFormat.FieldType.MESSAGE, Struct.getDefaultInstance());
    }
    ...
    public static final class e {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final e1<String, Any> f47148a = e1.k(l.f47307m, WireFormat.FieldType.STRING, "", WireFormat.FieldType.MESSAGE, Any.getDefaultInstance());
    }
                        ...
                        if ((!hasTracing() || getTracing().equals(route.getTracing())) && hasPerRequestBufferLimitBytes() == route.hasPerRequestBufferLimitBytes()) {
                            if ((!hasPerRequestBufferLimitBytes() || getPerRequestBufferLimitBytes().equals(route.getPerRequestBufferLimitBytes())) && getActionCase().equals(route.getActionCase())) {
                                ...
                                if (i9 != 2) {
                                    if (i9 != 3) {
                                        if (i9 != 7) {
                                            if (i9 == 17 && !getFilterAction().equals(route.getFilterAction())) {
                                                return false;
                                            }
    ...
    public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.b getDecoratorOrBuilder() {
        return getDecorator();
    }
    ...
    public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.c getDirectResponseOrBuilder() {
        if (this.actionCase_ == 7) {
            return (DirectResponseAction) this.action_;
        }
        return DirectResponseAction.getDefaultInstance();
    ...
    public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.d getFilterActionOrBuilder() {
        if (this.actionCase_ == 17) {
            return (FilterAction) this.action_;
        }
        return FilterAction.getDefaultInstance();
    ...
    public int getSerializedSize() {
        ...
        for (Map.Entry<String, Struct> entry : internalGetPerFilterConfig().i().entrySet()) {
            G += CodedOutputStream.G(8, d.f47147a.newBuilderForType().N(entry.getKey()).P(entry.getValue()).build());
        }
        ...
        int size = G + i12 + (m1601getResponseHeadersToRemoveList().size() * 1);
        int i14 = 0;
        ...
        int size2 = size + i14 + (m1600getRequestHeadersToRemoveList().size() * 1);
        for (Map.Entry<String, Any> entry2 : internalGetTypedPerFilterConfig().i().entrySet()) {
            size2 += CodedOutputStream.G(13, e.f47148a.newBuilderForType().N(entry2.getKey()).P(entry2.getValue()).build());
        }
    ...
    public int hashCode() {
        ...
        if (getRequestHeadersToRemoveCount() > 0) {
            hashCode2 = (((hashCode2 * 37) + 12) * 53) + m1600getRequestHeadersToRemoveList().hashCode();
        }
        ...
        if (getResponseHeadersToRemoveCount() > 0) {
            hashCode2 = (((hashCode2 * 37) + 11) * 53) + m1601getResponseHeadersToRemoveList().hashCode();
        }
        if (hasTracing()) {
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        GeneratedMessageV3.serializeStringMapTo(codedOutputStream, internalGetPerFilterConfig(), d.f47147a, 8);
        ...
        GeneratedMessageV3.serializeStringMapTo(codedOutputStream, internalGetTypedPerFilterConfig(), e.f47148a, 13);
        if (!GeneratedMessageV3.isStringEmpty(this.name_)) {
    ...
    public static c newBuilder(Route route) {
        return DEFAULT_INSTANCE.toBuilder().u0(route);
    }
    ...
    public i2 m1600getRequestHeadersToRemoveList() {
        return this.requestHeadersToRemove_;
    }

    /* renamed from: getResponseHeadersToRemoveList */
    public i2 m1601getResponseHeadersToRemoveList() {
            ...
            try {
                try {
                    ...
                    switch (L) {
                        ...
                        case 66:
                            if (!(z11 & true)) {
                                this.perFilterConfig_ = g1.p(d.f47147a);
                                z11 |= true;
                            }
                            e1 e1Var = (e1) pVar.B(d.f47147a.getParserForType(), f0Var);
                        ...
                        case 106:
                            if (!(z11 & true)) {
                                this.typedPerFilterConfig_ = g1.p(e.f47148a);
                                z11 |= true;
                            }
                            e1 e1Var2 = (e1) pVar.B(e.f47148a.getParserForType(), f0Var);
