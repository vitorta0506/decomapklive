...
public final class OrFilter extends GeneratedMessageV3 implements k {
    ...
    public class a extends com.google.protobuf.c<OrFilter> {
        ...
        /* renamed from: G */
        public OrFilter m(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements k {
        ...
        private List<AccessLogFilter> f48489f;

        /* renamed from: g  reason: collision with root package name */
        private l2<AccessLogFilter, AccessLogFilter.c, io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.a> f48490g;
        ...
        private void a0() {
            if ((this.f48488e & 1) == 0) {
                this.f48489f = new ArrayList(this.f48489f);
                this.f48488e |= 1;
            }
        }
        ...
        private l2<AccessLogFilter, AccessLogFilter.c, io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.a> d0() {
            if (this.f48490g == null) {
                this.f48490g = new l2<>(this.f48489f, (this.f48488e & 1) != 0, H(), O());
                this.f48489f = null;
            }
            return this.f48490g;
        }
        ...
        protected GeneratedMessageV3.e K() {
            return c.f48518t.d(OrFilter.class, b.class);
        }
        ...
        public OrFilter I() {
            ...
            int i9 = this.f48488e;
            l2<AccessLogFilter, AccessLogFilter.c, io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.a> l2Var = this.f48490g;
            if (l2Var == null) {
                if ((i9 & 1) != 0) {
                    this.f48489f = Collections.unmodifiableList(this.f48489f);
                    this.f48488e &= -2;
                }
                orFilter.filters_ = this.f48489f;
            } else {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.OrFilter.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.OrFilter.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.OrFilter r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.OrFilter) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.i0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.OrFilter r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.OrFilter) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.OrFilter.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.OrFilter$b");
        }
        ...
        public b i0(OrFilter orFilter) {
            ...
            if (this.f48490g == null) {
                if (!orFilter.filters_.isEmpty()) {
                    if (this.f48489f.isEmpty()) {
                        this.f48489f = orFilter.filters_;
                        this.f48488e &= -2;
                    } else {
                        a0();
                        this.f48489f.addAll(orFilter.filters_);
                    }
                    R();
                }
                ...
                if (this.f48490g.k()) {
                    ...
                    this.f48489f = orFilter.filters_;
                    this.f48488e &= -2;
                    this.f48490g = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                } else {
                    this.f48490g.b(orFilter.filters_);
                }
            }
        ...
        private b() {
            this.f48489f = Collections.emptyList();
            e0();
        }
    ...
    /* synthetic */ OrFilter(p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
    ...
    private OrFilter(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
    ...
    public static OrFilter parseFrom(p pVar) throws IOException {
        return (OrFilter) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
    }

    public static OrFilter parseFrom(p pVar, f0 f0Var) throws IOException {
