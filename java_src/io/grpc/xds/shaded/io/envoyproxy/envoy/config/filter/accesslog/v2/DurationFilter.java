...
public final class DurationFilter extends GeneratedMessageV3 implements f {
    ...
    public class a extends com.google.protobuf.c<DurationFilter> {
        ...
        /* renamed from: G */
        public DurationFilter m(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements f {
        ...
        private ComparisonFilter f48475e;

        /* renamed from: f  reason: collision with root package name */
        private q2<ComparisonFilter, ComparisonFilter.b, e> f48476f;
        ...
        protected GeneratedMessageV3.e K() {
            return c.f48508j.d(DurationFilter.class, b.class);
        }
        ...
        public DurationFilter I() {
            ...
            q2<ComparisonFilter, ComparisonFilter.b, e> q2Var = this.f48476f;
            if (q2Var == null) {
                durationFilter.comparison_ = this.f48475e;
            } else {
        ...
        public b d0(ComparisonFilter comparisonFilter) {
            q2<ComparisonFilter, ComparisonFilter.b, e> q2Var = this.f48476f;
            if (q2Var == null) {
                ComparisonFilter comparisonFilter2 = this.f48475e;
                if (comparisonFilter2 != null) {
                    this.f48475e = ComparisonFilter.newBuilder(comparisonFilter2).g0(comparisonFilter).I();
                } else {
                    this.f48475e = comparisonFilter;
                }
                R();
            } else {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.DurationFilter.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.DurationFilter.access$600()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.DurationFilter.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.DurationFilter$b");
        }
    ...
    /* synthetic */ DurationFilter(p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
    ...
    private DurationFilter(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
    ...
    public static DurationFilter parseFrom(p pVar) throws IOException {
        return (DurationFilter) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
    }

    public static DurationFilter parseFrom(p pVar, f0 f0Var) throws IOException {
