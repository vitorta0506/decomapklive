...
public final class TlsSessionTicketKeys extends GeneratedMessageV3 implements l {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements l {
        ...
        private List<DataSource> f46230f;

        /* renamed from: g  reason: collision with root package name */
        private l2<DataSource, DataSource.c, n> f46231g;
        ...
        private void a0() {
            if ((this.f46229e & 1) == 0) {
                this.f46230f = new ArrayList(this.f46230f);
                this.f46229e |= 1;
            }
        }
        ...
        private l2<DataSource, DataSource.c, n> d0() {
            if (this.f46231g == null) {
                this.f46231g = new l2<>(this.f46230f, (this.f46229e & 1) != 0, H(), O());
                this.f46230f = null;
            }
            return this.f46231g;
        }
        ...
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.auth.b.f46245h.d(TlsSessionTicketKeys.class, b.class);
        }
        ...
        public TlsSessionTicketKeys I() {
            ...
            int i9 = this.f46229e;
            l2<DataSource, DataSource.c, n> l2Var = this.f46231g;
            if (l2Var == null) {
                if ((i9 & 1) != 0) {
                    this.f46230f = Collections.unmodifiableList(this.f46230f);
                    this.f46229e &= -2;
                }
                tlsSessionTicketKeys.keys_ = this.f46230f;
            } else {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.auth.TlsSessionTicketKeys.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.auth.TlsSessionTicketKeys.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.auth.TlsSessionTicketKeys.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.auth.TlsSessionTicketKeys$b");
        }

        @Override // com.google.protobuf.GeneratedMessageV3.b, com.google.protobuf.l1.a, com.google.protobuf.r1
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.auth.b.f46244g;
        }
        ...
        public b i0(TlsSessionTicketKeys tlsSessionTicketKeys) {
            ...
            if (this.f46231g == null) {
                if (!tlsSessionTicketKeys.keys_.isEmpty()) {
                    if (this.f46230f.isEmpty()) {
                        this.f46230f = tlsSessionTicketKeys.keys_;
                        this.f46229e &= -2;
                    } else {
                        a0();
                        this.f46230f.addAll(tlsSessionTicketKeys.keys_);
                    }
                    R();
                }
                ...
                if (this.f46231g.k()) {
                    ...
                    this.f46230f = tlsSessionTicketKeys.keys_;
                    this.f46229e &= -2;
                    this.f46231g = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                } else {
                    this.f46231g.b(tlsSessionTicketKeys.keys_);
                }
            }
        ...
        private b() {
            this.f46230f = Collections.emptyList();
            e0();
        }
