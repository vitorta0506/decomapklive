...
public final class SdsSecretConfig extends GeneratedMessageV3 implements g {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements g {
        ...
        private Object f46200e;

        /* renamed from: f  reason: collision with root package name */
        private ConfigSource f46201f;

        /* renamed from: g  reason: collision with root package name */
        private q2<ConfigSource, ConfigSource.c, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.k> f46202g;
        ...
        protected GeneratedMessageV3.e K() {
            return h.f46252d.d(SdsSecretConfig.class, b.class);
        }
        ...
        public SdsSecretConfig I() {
            ...
            sdsSecretConfig.name_ = this.f46200e;
            q2<ConfigSource, ConfigSource.c, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.k> q2Var = this.f46202g;
            if (q2Var == null) {
                sdsSecretConfig.sdsConfig_ = this.f46201f;
            } else {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.auth.SdsSecretConfig.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.auth.SdsSecretConfig.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.auth.SdsSecretConfig.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.auth.SdsSecretConfig$b");
        }
        ...
        public b g0(SdsSecretConfig sdsSecretConfig) {
            ...
            if (!sdsSecretConfig.getName().isEmpty()) {
                this.f46200e = sdsSecretConfig.name_;
                R();
            }
        ...
        public b h0(ConfigSource configSource) {
            q2<ConfigSource, ConfigSource.c, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.k> q2Var = this.f46202g;
            if (q2Var == null) {
                ConfigSource configSource2 = this.f46201f;
                if (configSource2 != null) {
                    this.f46201f = ConfigSource.newBuilder(configSource2).i0(configSource).I();
                } else {
                    this.f46201f = configSource;
                }
                R();
            } else {
    ...
    public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.k getSdsConfigOrBuilder() {
        return getSdsConfig();
    }
