...
public final class HedgePolicy extends GeneratedMessageV3 implements g {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements g {
        ...
        private UInt32Value f49145e;

        /* renamed from: f  reason: collision with root package name */
        private q2<UInt32Value, UInt32Value.b, e3> f49146f;

        /* renamed from: g  reason: collision with root package name */
        private FractionalPercent f49147g;

        /* renamed from: h  reason: collision with root package name */
        private q2<FractionalPercent, FractionalPercent.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.v3.b> f49148h;

        /* renamed from: i  reason: collision with root package name */
        private boolean f49149i;
        ...
        protected GeneratedMessageV3.e K() {
            return o.f49484j0.d(HedgePolicy.class, b.class);
        }
        ...
        public HedgePolicy I() {
            ...
            q2<UInt32Value, UInt32Value.b, e3> q2Var = this.f49146f;
            if (q2Var == null) {
                hedgePolicy.initialRequests_ = this.f49145e;
            } else {
                hedgePolicy.initialRequests_ = q2Var.b();
            }
            q2<FractionalPercent, FractionalPercent.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.v3.b> q2Var2 = this.f49148h;
            if (q2Var2 == null) {
                hedgePolicy.additionalRequestChance_ = this.f49147g;
            } else {
                hedgePolicy.additionalRequestChance_ = q2Var2.b();
            }
            hedgePolicy.hedgeOnPerTryTimeout_ = this.f49149i;
            Q();
            return hedgePolicy;
        }
        ...
        public b d0(FractionalPercent fractionalPercent) {
            q2<FractionalPercent, FractionalPercent.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.v3.b> q2Var = this.f49148h;
            if (q2Var == null) {
                FractionalPercent fractionalPercent2 = this.f49147g;
                if (fractionalPercent2 != null) {
                    this.f49147g = FractionalPercent.newBuilder(fractionalPercent2).g0(fractionalPercent).I();
                } else {
                    this.f49147g = fractionalPercent;
                }
                R();
            } else {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.route.v3.HedgePolicy.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.route.v3.HedgePolicy.access$800()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.route.v3.HedgePolicy r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.route.v3.HedgePolicy) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.h0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.route.v3.HedgePolicy r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.route.v3.HedgePolicy) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.route.v3.HedgePolicy.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.route.v3.HedgePolicy$b");
        }
        ...
        public b i0(UInt32Value uInt32Value) {
            q2<UInt32Value, UInt32Value.b, e3> q2Var = this.f49146f;
            if (q2Var == null) {
                UInt32Value uInt32Value2 = this.f49145e;
                if (uInt32Value2 != null) {
                    this.f49145e = UInt32Value.newBuilder(uInt32Value2).g0(uInt32Value).I();
                } else {
                    this.f49145e = uInt32Value;
                }
                R();
            } else {
                q2Var.e(uInt32Value);
    ...
    public io.grpc.xds.shaded.io.envoyproxy.envoy.type.v3.b getAdditionalRequestChanceOrBuilder() {
