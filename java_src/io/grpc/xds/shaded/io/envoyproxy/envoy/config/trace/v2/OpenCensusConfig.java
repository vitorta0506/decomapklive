...
public final class OpenCensusConfig extends GeneratedMessageV3 implements r1 {
    ...
    public static final class d extends GeneratedMessageV3.b<d> implements r1 {
        ...
        private TraceConfig f49541f;

        /* renamed from: g  reason: collision with root package name */
        private q2<TraceConfig, TraceConfig.c, h> f49542g;

        /* renamed from: h  reason: collision with root package name */
        private boolean f49543h;

        /* renamed from: i  reason: collision with root package name */
        private boolean f49544i;

        /* renamed from: j  reason: collision with root package name */
        private Object f49545j;

        /* renamed from: k  reason: collision with root package name */
        private Object f49546k;

        /* renamed from: l  reason: collision with root package name */
        private GrpcService f49547l;

        /* renamed from: m  reason: collision with root package name */
        private q2<GrpcService, GrpcService.c, r> f49548m;

        /* renamed from: n  reason: collision with root package name */
        private boolean f49549n;

        /* renamed from: o  reason: collision with root package name */
        private Object f49550o;

        /* renamed from: p  reason: collision with root package name */
        private boolean f49551p;

        /* renamed from: q  reason: collision with root package name */
        private Object f49552q;

        /* renamed from: r  reason: collision with root package name */
        private GrpcService f49553r;

        /* renamed from: s  reason: collision with root package name */
        private q2<GrpcService, GrpcService.c, r> f49554s;

        /* renamed from: t  reason: collision with root package name */
        private List<Integer> f49555t;

        /* renamed from: u  reason: collision with root package name */
        private List<Integer> f49556u;
        ...
        private void a0() {
            if ((this.f49540e & 1) == 0) {
                this.f49555t = new ArrayList(this.f49555t);
                this.f49540e |= 1;
            }
        }
        ...
        private void b0() {
            if ((this.f49540e & 2) == 0) {
                this.f49556u = new ArrayList(this.f49556u);
                this.f49540e |= 2;
            }
        }
        ...
        protected GeneratedMessageV3.e K() {
            return e.f49588b.d(OpenCensusConfig.class, d.class);
        }
        ...
        public OpenCensusConfig I() {
            ...
            q2<TraceConfig, TraceConfig.c, h> q2Var = this.f49542g;
            if (q2Var == null) {
                openCensusConfig.traceConfig_ = this.f49541f;
            } else {
                openCensusConfig.traceConfig_ = q2Var.b();
            }
            openCensusConfig.stdoutExporterEnabled_ = this.f49543h;
            openCensusConfig.stackdriverExporterEnabled_ = this.f49544i;
            openCensusConfig.stackdriverProjectId_ = this.f49545j;
            openCensusConfig.stackdriverAddress_ = this.f49546k;
            q2<GrpcService, GrpcService.c, r> q2Var2 = this.f49548m;
            if (q2Var2 == null) {
                openCensusConfig.stackdriverGrpcService_ = this.f49547l;
            } else {
                openCensusConfig.stackdriverGrpcService_ = q2Var2.b();
            }
            openCensusConfig.zipkinExporterEnabled_ = this.f49549n;
            openCensusConfig.zipkinUrl_ = this.f49550o;
            openCensusConfig.ocagentExporterEnabled_ = this.f49551p;
            openCensusConfig.ocagentAddress_ = this.f49552q;
            q2<GrpcService, GrpcService.c, r> q2Var3 = this.f49554s;
            if (q2Var3 == null) {
                openCensusConfig.ocagentGrpcService_ = this.f49553r;
            } else {
                openCensusConfig.ocagentGrpcService_ = q2Var3.b();
            }
            if ((this.f49540e & 1) != 0) {
                this.f49555t = Collections.unmodifiableList(this.f49555t);
                this.f49540e &= -2;
            }
            openCensusConfig.incomingTraceContext_ = this.f49555t;
            if ((this.f49540e & 2) != 0) {
                this.f49556u = Collections.unmodifiableList(this.f49556u);
                this.f49540e &= -3;
            }
            openCensusConfig.outgoingTraceContext_ = this.f49556u;
            Q();
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.OpenCensusConfig.d u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.OpenCensusConfig.access$1800()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.OpenCensusConfig.d.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.trace.v2.OpenCensusConfig$d");
        }
        ...
        public d i0(OpenCensusConfig openCensusConfig) {
            ...
            if (!openCensusConfig.getStackdriverProjectId().isEmpty()) {
                this.f49545j = openCensusConfig.stackdriverProjectId_;
                R();
            }
            if (!openCensusConfig.getStackdriverAddress().isEmpty()) {
                this.f49546k = openCensusConfig.stackdriverAddress_;
                R();
            }
            ...
            if (!openCensusConfig.getZipkinUrl().isEmpty()) {
                this.f49550o = openCensusConfig.zipkinUrl_;
                R();
            }
            ...
            if (!openCensusConfig.getOcagentAddress().isEmpty()) {
                this.f49552q = openCensusConfig.ocagentAddress_;
                R();
            }
            ...
            if (!openCensusConfig.incomingTraceContext_.isEmpty()) {
                if (this.f49555t.isEmpty()) {
                    this.f49555t = openCensusConfig.incomingTraceContext_;
                    this.f49540e &= -2;
                } else {
                    a0();
                    this.f49555t.addAll(openCensusConfig.incomingTraceContext_);
                }
                R();
            }
            if (!openCensusConfig.outgoingTraceContext_.isEmpty()) {
                if (this.f49556u.isEmpty()) {
                    this.f49556u = openCensusConfig.outgoingTraceContext_;
                    this.f49540e &= -3;
                } else {
                    b0();
                    this.f49556u.addAll(openCensusConfig.outgoingTraceContext_);
                }
                R();
            }
        ...
        public d j0(GrpcService grpcService) {
            q2<GrpcService, GrpcService.c, r> q2Var = this.f49554s;
            if (q2Var == null) {
                GrpcService grpcService2 = this.f49553r;
                if (grpcService2 != null) {
                    this.f49553r = GrpcService.newBuilder(grpcService2).j0(grpcService).I();
                } else {
                    this.f49553r = grpcService;
                }
                R();
            } else {
                q2Var.e(grpcService);
        ...
        public d k0(GrpcService grpcService) {
            q2<GrpcService, GrpcService.c, r> q2Var = this.f49548m;
            if (q2Var == null) {
                GrpcService grpcService2 = this.f49547l;
                if (grpcService2 != null) {
                    this.f49547l = GrpcService.newBuilder(grpcService2).j0(grpcService).I();
                } else {
                    this.f49547l = grpcService;
                }
                R();
            } else {
                q2Var.e(grpcService);
        ...
        public d l0(TraceConfig traceConfig) {
            q2<TraceConfig, TraceConfig.c, h> q2Var = this.f49542g;
            if (q2Var == null) {
                TraceConfig traceConfig2 = this.f49541f;
                if (traceConfig2 != null) {
                    this.f49541f = TraceConfig.newBuilder(traceConfig2).h0(traceConfig).I();
                } else {
                    this.f49541f = traceConfig;
                }
                R();
            } else {
                q2Var.e(traceConfig);
        ...
        private d() {
            ...
            this.f49550o = "";
            this.f49552q = "";
            this.f49555t = Collections.emptyList();
            this.f49556u = Collections.emptyList();
            e0();
        }
    ...
    public r getOcagentGrpcServiceOrBuilder() {
    ...
    public r getStackdriverGrpcServiceOrBuilder() {
    ...
    public h getTraceConfigOrBuilder() {
