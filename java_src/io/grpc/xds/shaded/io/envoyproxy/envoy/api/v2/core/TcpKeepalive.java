...
public final class TcpKeepalive extends GeneratedMessageV3 implements q0 {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements q0 {
        ...
        private UInt32Value f46659e;

        /* renamed from: f  reason: collision with root package name */
        private q2<UInt32Value, UInt32Value.b, e3> f46660f;

        /* renamed from: g  reason: collision with root package name */
        private UInt32Value f46661g;

        /* renamed from: h  reason: collision with root package name */
        private q2<UInt32Value, UInt32Value.b, e3> f46662h;

        /* renamed from: i  reason: collision with root package name */
        private UInt32Value f46663i;

        /* renamed from: j  reason: collision with root package name */
        private q2<UInt32Value, UInt32Value.b, e3> f46664j;
        ...
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.b.f46678f.d(TcpKeepalive.class, b.class);
        }
        ...
        public TcpKeepalive I() {
            ...
            q2<UInt32Value, UInt32Value.b, e3> q2Var = this.f46660f;
            if (q2Var == null) {
                tcpKeepalive.keepaliveProbes_ = this.f46659e;
            } else {
                tcpKeepalive.keepaliveProbes_ = q2Var.b();
            }
            q2<UInt32Value, UInt32Value.b, e3> q2Var2 = this.f46662h;
            if (q2Var2 == null) {
                tcpKeepalive.keepaliveTime_ = this.f46661g;
            } else {
                tcpKeepalive.keepaliveTime_ = q2Var2.b();
            }
            q2<UInt32Value, UInt32Value.b, e3> q2Var3 = this.f46664j;
            if (q2Var3 == null) {
                tcpKeepalive.keepaliveInterval_ = this.f46663i;
            } else {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.TcpKeepalive.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.TcpKeepalive.access$800()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.TcpKeepalive r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.TcpKeepalive) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.g0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.TcpKeepalive r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.TcpKeepalive) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.TcpKeepalive.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.TcpKeepalive$b");
        }
        ...
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.b.f46677e;
        }

        public b h0(UInt32Value uInt32Value) {
            q2<UInt32Value, UInt32Value.b, e3> q2Var = this.f46664j;
            if (q2Var == null) {
                UInt32Value uInt32Value2 = this.f46663i;
                if (uInt32Value2 != null) {
                    this.f46663i = UInt32Value.newBuilder(uInt32Value2).g0(uInt32Value).I();
                } else {
                    this.f46663i = uInt32Value;
                }
                R();
            } else {
                q2Var.e(uInt32Value);
        ...
        public b i0(UInt32Value uInt32Value) {
            q2<UInt32Value, UInt32Value.b, e3> q2Var = this.f46660f;
            if (q2Var == null) {
                UInt32Value uInt32Value2 = this.f46659e;
                if (uInt32Value2 != null) {
                    this.f46659e = UInt32Value.newBuilder(uInt32Value2).g0(uInt32Value).I();
                } else {
                    this.f46659e = uInt32Value;
                }
                R();
            } else {
                q2Var.e(uInt32Value);
        ...
        public b j0(UInt32Value uInt32Value) {
            q2<UInt32Value, UInt32Value.b, e3> q2Var = this.f46662h;
            if (q2Var == null) {
                UInt32Value uInt32Value2 = this.f46661g;
                if (uInt32Value2 != null) {
                    this.f46661g = UInt32Value.newBuilder(uInt32Value2).g0(uInt32Value).I();
                } else {
                    this.f46661g = uInt32Value;
                }
                R();
            } else {
                q2Var.e(uInt32Value);
