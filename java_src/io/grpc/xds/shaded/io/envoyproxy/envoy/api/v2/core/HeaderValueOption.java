...
public final class HeaderValueOption extends GeneratedMessageV3 implements t {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements t {
        ...
        private HeaderValue f46481e;

        /* renamed from: f  reason: collision with root package name */
        private q2<HeaderValue, HeaderValue.b, u> f46482f;

        /* renamed from: g  reason: collision with root package name */
        private BoolValue f46483g;

        /* renamed from: h  reason: collision with root package name */
        private q2<BoolValue, BoolValue.b, com.google.protobuf.l> f46484h;
        ...
        protected GeneratedMessageV3.e K() {
            return g.f46713v.d(HeaderValueOption.class, b.class);
        }
        ...
        public HeaderValueOption I() {
            ...
            q2<HeaderValue, HeaderValue.b, u> q2Var = this.f46482f;
            if (q2Var == null) {
                headerValueOption.header_ = this.f46481e;
            } else {
                headerValueOption.header_ = q2Var.b();
            }
            q2<BoolValue, BoolValue.b, com.google.protobuf.l> q2Var2 = this.f46484h;
            if (q2Var2 == null) {
                headerValueOption.append_ = this.f46483g;
            } else {
        ...
        public b d0(BoolValue boolValue) {
            q2<BoolValue, BoolValue.b, com.google.protobuf.l> q2Var = this.f46484h;
            if (q2Var == null) {
                BoolValue boolValue2 = this.f46483g;
                if (boolValue2 != null) {
                    this.f46483g = BoolValue.newBuilder(boolValue2).d0(boolValue).I();
                } else {
                    this.f46483g = boolValue;
                }
                R();
            } else {
                q2Var.e(boolValue);
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HeaderValueOption.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HeaderValueOption.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HeaderValueOption.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HeaderValueOption$b");
        }
        ...
        public b i0(HeaderValue headerValue) {
            q2<HeaderValue, HeaderValue.b, u> q2Var = this.f46482f;
            if (q2Var == null) {
                HeaderValue headerValue2 = this.f46481e;
                if (headerValue2 != null) {
                    this.f46481e = HeaderValue.newBuilder(headerValue2).g0(headerValue).I();
                } else {
                    this.f46481e = headerValue;
                }
                R();
            } else {
                q2Var.e(headerValue);
