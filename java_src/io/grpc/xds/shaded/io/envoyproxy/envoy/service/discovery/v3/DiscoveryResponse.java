...
public final class DiscoveryResponse extends GeneratedMessageV3 implements r1 {
    ...
    public class a extends com.google.protobuf.c<DiscoveryResponse> {
        ...
        /* renamed from: G */
        public DiscoveryResponse m(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        private Object f50094f;

        /* renamed from: g  reason: collision with root package name */
        private List<Any> f50095g;

        /* renamed from: h  reason: collision with root package name */
        private l2<Any, Any.b, f> f50096h;

        /* renamed from: i  reason: collision with root package name */
        private boolean f50097i;

        /* renamed from: j  reason: collision with root package name */
        private Object f50098j;

        /* renamed from: k  reason: collision with root package name */
        private Object f50099k;

        /* renamed from: l  reason: collision with root package name */
        private ControlPlane f50100l;

        /* renamed from: m  reason: collision with root package name */
        private q2<ControlPlane, ControlPlane.b, m> f50101m;
        ...
        private void a0() {
            if ((this.f50093e & 1) == 0) {
                this.f50095g = new ArrayList(this.f50095g);
                this.f50093e |= 1;
            }
        }

        private l2<Any, Any.b, f> d0() {
            if (this.f50096h == null) {
                this.f50096h = new l2<>(this.f50095g, (this.f50093e & 1) != 0, H(), O());
                this.f50095g = null;
            }
            return this.f50096h;
        }
        ...
        protected GeneratedMessageV3.e K() {
            return c.f50121d.d(DiscoveryResponse.class, b.class);
        }
        ...
        public DiscoveryResponse I() {
            ...
            discoveryResponse.versionInfo_ = this.f50094f;
            l2<Any, Any.b, f> l2Var = this.f50096h;
            if (l2Var == null) {
                if ((this.f50093e & 1) != 0) {
                    this.f50095g = Collections.unmodifiableList(this.f50095g);
                    this.f50093e &= -2;
                }
                discoveryResponse.resources_ = this.f50095g;
            } else {
                discoveryResponse.resources_ = l2Var.e();
            }
            discoveryResponse.canary_ = this.f50097i;
            discoveryResponse.typeUrl_ = this.f50098j;
            discoveryResponse.nonce_ = this.f50099k;
            q2<ControlPlane, ControlPlane.b, m> q2Var = this.f50101m;
            if (q2Var == null) {
                discoveryResponse.controlPlane_ = this.f50100l;
            } else {
        ...
        public b g0(ControlPlane controlPlane) {
            q2<ControlPlane, ControlPlane.b, m> q2Var = this.f50101m;
            if (q2Var == null) {
                ControlPlane controlPlane2 = this.f50100l;
                if (controlPlane2 != null) {
                    this.f50100l = ControlPlane.newBuilder(controlPlane2).g0(controlPlane).I();
                } else {
                    this.f50100l = controlPlane;
                }
                R();
            } else {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.service.discovery.v3.DiscoveryResponse.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.service.discovery.v3.DiscoveryResponse.access$1200()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.service.discovery.v3.DiscoveryResponse r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.service.discovery.v3.DiscoveryResponse) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.j0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.service.discovery.v3.DiscoveryResponse r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.service.discovery.v3.DiscoveryResponse) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.service.discovery.v3.DiscoveryResponse.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.service.discovery.v3.DiscoveryResponse$b");
        }
        ...
        public b j0(DiscoveryResponse discoveryResponse) {
            ...
            if (!discoveryResponse.getVersionInfo().isEmpty()) {
                this.f50094f = discoveryResponse.versionInfo_;
                R();
            }
            if (this.f50096h == null) {
                if (!discoveryResponse.resources_.isEmpty()) {
                    if (this.f50095g.isEmpty()) {
                        this.f50095g = discoveryResponse.resources_;
                        this.f50093e &= -2;
                    } else {
                        a0();
                        this.f50095g.addAll(discoveryResponse.resources_);
                    }
                    R();
                }
                ...
                if (this.f50096h.k()) {
                    ...
                    this.f50095g = discoveryResponse.resources_;
                    this.f50093e &= -2;
                    this.f50096h = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                } else {
                    this.f50096h.b(discoveryResponse.resources_);
                }
            }
            ...
            if (!discoveryResponse.getTypeUrl().isEmpty()) {
                this.f50098j = discoveryResponse.typeUrl_;
                R();
            }
            if (!discoveryResponse.getNonce().isEmpty()) {
                this.f50099k = discoveryResponse.nonce_;
                R();
            }
        ...
        private b() {
            this.f50094f = "";
            this.f50095g = Collections.emptyList();
            this.f50098j = "";
            this.f50099k = "";
            e0();
        }
    ...
    /* synthetic */ DiscoveryResponse(p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
    ...
    public f getResourcesOrBuilder(int i9) {
        return this.resources_.get(i9);
    }
    ...
    private DiscoveryResponse(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
    ...
    public static DiscoveryResponse parseFrom(p pVar) throws IOException {
        return (DiscoveryResponse) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
    }

    public static DiscoveryResponse parseFrom(p pVar, f0 f0Var) throws IOException {
