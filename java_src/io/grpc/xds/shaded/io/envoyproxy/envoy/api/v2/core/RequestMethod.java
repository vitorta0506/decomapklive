...
public enum RequestMethod implements h2 {
    ...
    private static final u0.d<RequestMethod> internalValueMap = new u0.d<RequestMethod>() { // from class: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.RequestMethod.a
