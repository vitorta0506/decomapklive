...
public final class StringMatcher extends GeneratedMessageV3 implements n {
    ...
    public class a extends com.google.protobuf.c<StringMatcher> {
        ...
        /* renamed from: G */
        public StringMatcher m(com.google.protobuf.p pVar, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static /* synthetic */ class b {
        ...
        static {
            ...
            try {
                f50377a[MatchPatternCase.PREFIX.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f50377a[MatchPatternCase.SUFFIX.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f50377a[MatchPatternCase.SAFE_REGEX.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f50377a[MatchPatternCase.CONTAINS.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f50377a[MatchPatternCase.MATCHPATTERN_NOT_SET.ordinal()] = 6;
    ...
    public static final class c extends GeneratedMessageV3.b<c> implements n {
        ...
        private Object f50379f;

        /* renamed from: g  reason: collision with root package name */
        private q2<RegexMatcher, RegexMatcher.c, l> f50380g;
        ...
        protected GeneratedMessageV3.e K() {
            return o.f50419b.d(StringMatcher.class, c.class);
        }
        ...
        public StringMatcher I() {
            ...
            if (this.f50378e == 1) {
                stringMatcher.matchPattern_ = this.f50379f;
            }
            if (this.f50378e == 2) {
                stringMatcher.matchPattern_ = this.f50379f;
            }
            ...
            if (this.f50378e == 5) {
                q2<RegexMatcher, RegexMatcher.c, l> q2Var = this.f50380g;
                if (q2Var == null) {
                    stringMatcher.matchPattern_ = this.f50379f;
                } else {
            ...
            stringMatcher.ignoreCase_ = this.f50381h;
            stringMatcher.matchPatternCase_ = this.f50378e;
            Q();
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.v3.StringMatcher.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.v3.StringMatcher.access$800()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.v3.StringMatcher r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.v3.StringMatcher) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.g0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.v3.StringMatcher r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.v3.StringMatcher) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.v3.StringMatcher.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.v3.StringMatcher$c");
        }
        ...
        public c g0(StringMatcher stringMatcher) {
            ...
            int i9 = b.f50377a[stringMatcher.getMatchPatternCase().ordinal()];
            if (i9 == 1) {
                this.f50378e = 1;
                this.f50379f = stringMatcher.matchPattern_;
                R();
            } else if (i9 == 2) {
                this.f50378e = 2;
                this.f50379f = stringMatcher.matchPattern_;
        ...
        public c h0(RegexMatcher regexMatcher) {
            q2<RegexMatcher, RegexMatcher.c, l> q2Var = this.f50380g;
            if (q2Var == null) {
                if (this.f50378e == 5 && this.f50379f != RegexMatcher.getDefaultInstance()) {
                    this.f50379f = RegexMatcher.newBuilder((RegexMatcher) this.f50379f).g0(regexMatcher).I();
                } else {
                    this.f50379f = regexMatcher;
                }
                R();
            } else {
                if (this.f50378e == 5) {
    ...
    /* synthetic */ StringMatcher(com.google.protobuf.p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
        ...
        if (getIgnoreCase() == stringMatcher.getIgnoreCase() && getMatchPatternCase().equals(stringMatcher.getMatchPatternCase())) {
            ...
            if (i9 != 1) {
                if (i9 != 2) {
                    if (i9 != 3) {
                        if (i9 != 5) {
                            if (i9 == 7 && !getContains().equals(stringMatcher.getContains())) {
                                return false;
                            }
                        } else if (!getSafeRegex().equals(stringMatcher.getSafeRegex())) {
                            return false;
                        }
    ...
    public l getSafeRegexOrBuilder() {
        if (this.matchPatternCase_ == 5) {
            return (RegexMatcher) this.matchPattern_;
        }
        return RegexMatcher.getDefaultInstance();
    ...
    private StringMatcher(com.google.protobuf.p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
    ...
    public static StringMatcher parseFrom(com.google.protobuf.p pVar) throws IOException {
        return (StringMatcher) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
    }

    public static StringMatcher parseFrom(com.google.protobuf.p pVar, f0 f0Var) throws IOException {
