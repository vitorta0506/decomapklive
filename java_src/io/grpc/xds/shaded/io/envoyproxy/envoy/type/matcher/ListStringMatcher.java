...
public final class ListStringMatcher extends GeneratedMessageV3 implements r1 {
    ...
    public class a extends com.google.protobuf.c<ListStringMatcher> {
        ...
        /* renamed from: G */
        public ListStringMatcher m(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        private List<StringMatcher> f50271f;

        /* renamed from: g  reason: collision with root package name */
        private l2<StringMatcher, StringMatcher.c, k> f50272g;
        ...
        private void a0() {
            if ((this.f50270e & 1) == 0) {
                this.f50271f = new ArrayList(this.f50271f);
                this.f50270e |= 1;
            }
        }

        private l2<StringMatcher, StringMatcher.c, k> d0() {
            if (this.f50272g == null) {
                this.f50272g = new l2<>(this.f50271f, (this.f50270e & 1) != 0, H(), O());
                this.f50271f = null;
            }
            return this.f50272g;
        }
        ...
        protected GeneratedMessageV3.e K() {
            return l.f50329d.d(ListStringMatcher.class, b.class);
        }
        ...
        public ListStringMatcher I() {
            ...
            int i9 = this.f50270e;
            l2<StringMatcher, StringMatcher.c, k> l2Var = this.f50272g;
            if (l2Var == null) {
                if ((i9 & 1) != 0) {
                    this.f50271f = Collections.unmodifiableList(this.f50271f);
                    this.f50270e &= -2;
                }
                listStringMatcher.patterns_ = this.f50271f;
            } else {
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.ListStringMatcher.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.ListStringMatcher.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.ListStringMatcher r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.ListStringMatcher) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.i0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.ListStringMatcher r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.ListStringMatcher) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.ListStringMatcher.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.ListStringMatcher$b");
        }
        ...
        public b i0(ListStringMatcher listStringMatcher) {
            ...
            if (this.f50272g == null) {
                if (!listStringMatcher.patterns_.isEmpty()) {
                    if (this.f50271f.isEmpty()) {
                        this.f50271f = listStringMatcher.patterns_;
                        this.f50270e &= -2;
                    } else {
                        a0();
                        this.f50271f.addAll(listStringMatcher.patterns_);
                    }
                    R();
                }
                ...
                if (this.f50272g.k()) {
                    ...
                    this.f50271f = listStringMatcher.patterns_;
                    this.f50270e &= -2;
                    this.f50272g = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                } else {
                    this.f50272g.b(listStringMatcher.patterns_);
                }
            }
        ...
        private b() {
            this.f50271f = Collections.emptyList();
            e0();
        }
    ...
    /* synthetic */ ListStringMatcher(p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
    ...
    public k getPatternsOrBuilder(int i9) {
        return this.patterns_.get(i9);
    }

    public List<? extends k> getPatternsOrBuilderList() {
        return this.patterns_;
    }
    ...
    private ListStringMatcher(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
    ...
    public static ListStringMatcher parseFrom(p pVar) throws IOException {
        return (ListStringMatcher) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
    }

    public static ListStringMatcher parseFrom(p pVar, f0 f0Var) throws IOException {
