...
public final class ExtensionFilter extends GeneratedMessageV3 implements g {
    ...
    public class a extends com.google.protobuf.c<ExtensionFilter> {
        ...
        /* renamed from: G */
        public ExtensionFilter m(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static /* synthetic */ class b {
        ...
        static {
            ...
            try {
                f48477a[ConfigTypeCase.TYPED_CONFIG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f48477a[ConfigTypeCase.CONFIGTYPE_NOT_SET.ordinal()] = 3;
    ...
    public static final class c extends GeneratedMessageV3.b<c> implements g {
        ...
        private Object f48479f;

        /* renamed from: g  reason: collision with root package name */
        private Object f48480g;

        /* renamed from: h  reason: collision with root package name */
        private q2<Struct, Struct.b, u2> f48481h;

        /* renamed from: i  reason: collision with root package name */
        private q2<Any, Any.b, com.google.protobuf.f> f48482i;
        ...
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.c.B.d(ExtensionFilter.class, c.class);
        }
        ...
        public ExtensionFilter I() {
            ...
            extensionFilter.name_ = this.f48480g;
            if (this.f48478e == 2) {
                q2<Struct, Struct.b, u2> q2Var = this.f48481h;
                if (q2Var == null) {
                    extensionFilter.configType_ = this.f48479f;
                } else {
                    extensionFilter.configType_ = q2Var.b();
                }
            }
            if (this.f48478e == 3) {
                q2<Any, Any.b, com.google.protobuf.f> q2Var2 = this.f48482i;
                if (q2Var2 == null) {
                    extensionFilter.configType_ = this.f48479f;
                } else {
                    extensionFilter.configType_ = q2Var2.b();
                }
            }
            extensionFilter.configTypeCase_ = this.f48478e;
            Q();
        ...
        public c d0(Struct struct) {
            q2<Struct, Struct.b, u2> q2Var = this.f48481h;
            if (q2Var == null) {
                if (this.f48478e == 2 && this.f48479f != Struct.getDefaultInstance()) {
                    this.f48479f = Struct.newBuilder((Struct) this.f48479f).i0(struct).I();
                } else {
                    this.f48479f = struct;
                }
                R();
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.ExtensionFilter.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.ExtensionFilter.access$800()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.ExtensionFilter r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.ExtensionFilter) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.h0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.ExtensionFilter r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.ExtensionFilter) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.ExtensionFilter.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.ExtensionFilter$c");
        }
        ...
        public c v(l1 l1Var) {
            if (l1Var instanceof ExtensionFilter) {
                return h0((ExtensionFilter) l1Var);
            }
            super.P0(l1Var);
            return this;
        }
        ...
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.config.filter.accesslog.v2.c.A;
        }

        public c h0(ExtensionFilter extensionFilter) {
            if (extensionFilter == ExtensionFilter.getDefaultInstance()) {
                return this;
            }
            if (!extensionFilter.getName().isEmpty()) {
                this.f48480g = extensionFilter.name_;
                R();
            }
            int i9 = b.f48477a[extensionFilter.getConfigTypeCase().ordinal()];
            if (i9 == 1) {
                d0(extensionFilter.getConfig());
            } else if (i9 == 2) {
                i0(extensionFilter.getTypedConfig());
            }
        ...
        public c i0(Any any) {
            q2<Any, Any.b, com.google.protobuf.f> q2Var = this.f48482i;
            if (q2Var == null) {
                if (this.f48478e == 3 && this.f48479f != Any.getDefaultInstance()) {
                    this.f48479f = Any.newBuilder((Any) this.f48479f).d0(any).I();
                } else {
                    this.f48479f = any;
                }
                R();
    ...
    /* synthetic */ ExtensionFilter(p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getName().equals(extensionFilter.getName()) && getConfigTypeCase().equals(extensionFilter.getConfigTypeCase())) {
            ...
            if (i9 != 2) {
                if (i9 == 3 && !getTypedConfig().equals(extensionFilter.getTypedConfig())) {
                    return false;
                }
            } else if (!getConfig().equals(extensionFilter.getConfig())) {
                return false;
            }
            return this.unknownFields.equals(extensionFilter.unknownFields);
        }
        return false;
    }
    ...
    public static c newBuilder(ExtensionFilter extensionFilter) {
        return DEFAULT_INSTANCE.toBuilder().h0(extensionFilter);
    }
    ...
    private ExtensionFilter(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
    ...
    public static ExtensionFilter parseFrom(p pVar) throws IOException {
        return (ExtensionFilter) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
    }

    public static ExtensionFilter parseFrom(p pVar, f0 f0Var) throws IOException {
