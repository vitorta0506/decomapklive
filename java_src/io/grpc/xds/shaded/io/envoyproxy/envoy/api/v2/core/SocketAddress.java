...
public final class SocketAddress extends GeneratedMessageV3 implements n0 {
    ...
    public static /* synthetic */ class b {
        ...
        static {
            ...
            try {
                f46645a[PortSpecifierCase.NAMED_PORT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f46645a[PortSpecifierCase.PORTSPECIFIER_NOT_SET.ordinal()] = 3;
    ...
    /* loaded from: classes6.dex */
    public static final class c extends GeneratedMessageV3.b<c> implements n0 {
        ...
        private Object f46649h;

        /* renamed from: i  reason: collision with root package name */
        private Object f46650i;

        /* renamed from: j  reason: collision with root package name */
        private boolean f46651j;
        ...
        protected GeneratedMessageV3.e K() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.b.f46676d.d(SocketAddress.class, c.class);
        }
        ...
        public SocketAddress I() {
            ...
            socketAddress.protocol_ = this.f46648g;
            socketAddress.address_ = this.f46649h;
            if (this.f46646e == 3) {
                socketAddress.portSpecifier_ = this.f46647f;
            }
            if (this.f46646e == 4) {
                socketAddress.portSpecifier_ = this.f46647f;
            }
            socketAddress.resolverName_ = this.f46650i;
            socketAddress.ipv4Compat_ = this.f46651j;
            socketAddress.portSpecifierCase_ = this.f46646e;
            Q();
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.SocketAddress.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.SocketAddress.access$1100()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.SocketAddress r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.SocketAddress) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.g0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.SocketAddress r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.SocketAddress) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.SocketAddress.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.SocketAddress$c");
        }
        ...
        public c g0(SocketAddress socketAddress) {
            ...
            if (!socketAddress.getAddress().isEmpty()) {
                this.f46649h = socketAddress.address_;
                R();
            }
            if (!socketAddress.getResolverName().isEmpty()) {
                this.f46650i = socketAddress.resolverName_;
                R();
            }
            if (socketAddress.getIpv4Compat()) {
                k0(socketAddress.getIpv4Compat());
            }
            int i9 = b.f46645a[socketAddress.getPortSpecifierCase().ordinal()];
            if (i9 == 1) {
                l0(socketAddress.getPortValue());
            } else if (i9 == 2) {
                this.f46646e = 4;
                this.f46647f = socketAddress.portSpecifier_;
                R();
            }
        ...
        public Descriptors.b getDescriptorForType() {
            return io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.b.f46675c;
        }
        ...
        public c l0(int i9) {
            this.f46646e = 3;
            this.f46647f = Integer.valueOf(i9);
            R();
            return this;
        }
    ...
    public int hashCode() {
        ...
        int hashCode = ((((((((((((((((779 + getDescriptor().hashCode()) * 37) + 1) * 53) + this.protocol_) * 37) + 2) * 53) + getAddress().hashCode()) * 37) + 5) * 53) + getResolverName().hashCode()) * 37) + 6) * 53) + u0.d(getIpv4Compat());
