...
import io.grpc.xds.shaded.io.envoyproxy.envoy.type.CodecClientType;
...
public final class HealthCheck extends GeneratedMessageV3 implements v {
    ...
    public static final class CustomHealthCheck extends GeneratedMessageV3 implements d {
        ...
        public static final class b extends GeneratedMessageV3.b<b> implements d {
            ...
            private Object f46486f;

            /* renamed from: g  reason: collision with root package name */
            private Object f46487g;

            /* renamed from: h  reason: collision with root package name */
            private q2<Struct, Struct.b, u2> f46488h;

            /* renamed from: i  reason: collision with root package name */
            private q2<Any, Any.b, com.google.protobuf.f> f46489i;
            ...
            protected GeneratedMessageV3.e K() {
                return w.f46790n.d(CustomHealthCheck.class, b.class);
            }
            ...
            public CustomHealthCheck I() {
                ...
                customHealthCheck.name_ = this.f46487g;
                if (this.f46485e == 2) {
                    q2<Struct, Struct.b, u2> q2Var = this.f46488h;
                    if (q2Var == null) {
                        customHealthCheck.configType_ = this.f46486f;
                    } else {
                        customHealthCheck.configType_ = q2Var.b();
                    }
                }
                if (this.f46485e == 3) {
                    q2<Any, Any.b, com.google.protobuf.f> q2Var2 = this.f46489i;
                    if (q2Var2 == null) {
                        customHealthCheck.configType_ = this.f46486f;
                    } else {
                        customHealthCheck.configType_ = q2Var2.b();
                    }
                }
                customHealthCheck.configTypeCase_ = this.f46485e;
                Q();
            ...
            public b d0(Struct struct) {
                q2<Struct, Struct.b, u2> q2Var = this.f46488h;
                if (q2Var == null) {
                    if (this.f46485e == 2 && this.f46486f != Struct.getDefaultInstance()) {
                        this.f46486f = Struct.newBuilder((Struct) this.f46486f).i0(struct).I();
                    } else {
                        this.f46486f = struct;
                    }
                    R();
            ...
            */
            public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.CustomHealthCheck.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                /*
                    r2 = this;
                    r0 = 0
                    com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.CustomHealthCheck.access$7200()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$CustomHealthCheck r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.CustomHealthCheck) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    if (r3 == 0) goto L10
                    r2.h0(r3)
                L10:
                    return r2
                ...
                L13:
                    ...
                    io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$CustomHealthCheck r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.CustomHealthCheck) r4     // Catch: java.lang.Throwable -> L11
                ...
                L26:
                    throw r3
                */
                throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.CustomHealthCheck.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$CustomHealthCheck$b");
            }
            ...
            public b v(l1 l1Var) {
                if (l1Var instanceof CustomHealthCheck) {
                    return h0((CustomHealthCheck) l1Var);
                }
                super.P0(l1Var);
                return this;
            }
            ...
            public b h0(CustomHealthCheck customHealthCheck) {
                if (customHealthCheck == CustomHealthCheck.getDefaultInstance()) {
                    return this;
                }
                if (!customHealthCheck.getName().isEmpty()) {
                    this.f46487g = customHealthCheck.name_;
                    R();
                }
                int i9 = b.f46520b[customHealthCheck.getConfigTypeCase().ordinal()];
                if (i9 == 1) {
                    d0(customHealthCheck.getConfig());
                } else if (i9 == 2) {
                    i0(customHealthCheck.getTypedConfig());
                }
            ...
            public b i0(Any any) {
                q2<Any, Any.b, com.google.protobuf.f> q2Var = this.f46489i;
                if (q2Var == null) {
                    if (this.f46485e == 3 && this.f46486f != Any.getDefaultInstance()) {
                        this.f46486f = Any.newBuilder((Any) this.f46486f).d0(any).I();
                    } else {
                        this.f46486f = any;
                    }
                    R();
        ...
        public boolean equals(Object obj) {
            ...
            if (getName().equals(customHealthCheck.getName()) && getConfigTypeCase().equals(customHealthCheck.getConfigTypeCase())) {
                ...
                if (i9 != 2) {
                    if (i9 == 3 && !getTypedConfig().equals(customHealthCheck.getTypedConfig())) {
                        return false;
                    }
                } else if (!getConfig().equals(customHealthCheck.getConfig())) {
                    return false;
                }
        ...
        public static b newBuilder(CustomHealthCheck customHealthCheck) {
            return DEFAULT_INSTANCE.toBuilder().h0(customHealthCheck);
        }
    ...
    public static final class GrpcHealthCheck extends GeneratedMessageV3 implements e {
        ...
        public static final class b extends GeneratedMessageV3.b<b> implements e {
            ...
            /* renamed from: e  reason: collision with root package name */
            private Object f46490e;

            /* renamed from: f  reason: collision with root package name */
            private Object f46491f;
            ...
            @Override // com.google.protobuf.GeneratedMessageV3.b
            protected GeneratedMessageV3.e K() {
                return w.f46788l.d(GrpcHealthCheck.class, b.class);
            }
            ...
            public GrpcHealthCheck I() {
                ...
                grpcHealthCheck.serviceName_ = this.f46490e;
                grpcHealthCheck.authority_ = this.f46491f;
                Q();
            ...
            /*
                ...
                To view partially-correct add '--show-bad-code' argument
            */
            public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.GrpcHealthCheck.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                /*
                    r2 = this;
                    r0 = 0
                    com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.GrpcHealthCheck.access$6000()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$GrpcHealthCheck r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.GrpcHealthCheck) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    if (r3 == 0) goto L10
                    r2.g0(r3)
                L10:
                    return r2
                ...
                L13:
                    r3 = move-exception
                    com.google.protobuf.o1 r4 = r3.getUnfinishedMessage()     // Catch: java.lang.Throwable -> L11
                    io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$GrpcHealthCheck r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.GrpcHealthCheck) r4     // Catch: java.lang.Throwable -> L11
                    java.io.IOException r3 = r3.unwrapIOException()     // Catch: java.lang.Throwable -> L1f
                    throw r3     // Catch: java.lang.Throwable -> L1f
                L1f:
                    r3 = move-exception
                ...
                L26:
                    throw r3
                */
                throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.GrpcHealthCheck.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$GrpcHealthCheck$b");
            }
            ...
            public b g0(GrpcHealthCheck grpcHealthCheck) {
                ...
                if (!grpcHealthCheck.getServiceName().isEmpty()) {
                    this.f46490e = grpcHealthCheck.serviceName_;
                    R();
                }
                if (!grpcHealthCheck.getAuthority().isEmpty()) {
                    this.f46491f = grpcHealthCheck.authority_;
                    R();
                }
    ...
    public static final class HttpHealthCheck extends GeneratedMessageV3 implements f {
        ...
        public static final class b extends GeneratedMessageV3.b<b> implements f {
            ...
            /* renamed from: f  reason: collision with root package name */
            private Object f46493f;

            /* renamed from: g  reason: collision with root package name */
            private Object f46494g;

            /* renamed from: h  reason: collision with root package name */
            private Payload f46495h;

            /* renamed from: i  reason: collision with root package name */
            private q2<Payload, Payload.b, g> f46496i;

            /* renamed from: j  reason: collision with root package name */
            private Payload f46497j;

            /* renamed from: k  reason: collision with root package name */
            private q2<Payload, Payload.b, g> f46498k;

            /* renamed from: l  reason: collision with root package name */
            private Object f46499l;

            /* renamed from: m  reason: collision with root package name */
            private List<HeaderValueOption> f46500m;

            /* renamed from: n  reason: collision with root package name */
            private l2<HeaderValueOption, HeaderValueOption.b, t> f46501n;
            ...
            private List<Int64Range> f46504q;

            /* renamed from: r  reason: collision with root package name */
            private l2<Int64Range, Int64Range.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.e> f46505r;

            /* renamed from: s  reason: collision with root package name */
            private int f46506s;

            /* renamed from: t  reason: collision with root package name */
            private StringMatcher f46507t;

            /* renamed from: u  reason: collision with root package name */
            private q2<StringMatcher, StringMatcher.c, io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.k> f46508u;
            ...
            private void a0() {
                if ((this.f46492e & 4) == 0) {
                    this.f46504q = new ArrayList(this.f46504q);
                    this.f46492e |= 4;
                }
            }
            ...
            private void b0() {
                if ((this.f46492e & 1) == 0) {
                    this.f46500m = new ArrayList(this.f46500m);
                    this.f46492e |= 1;
                }
            }
            ...
            private void d0() {
                if ((this.f46492e & 2) == 0) {
                    this.f46502o = new y0(this.f46502o);
                    this.f46492e |= 2;
                }
            }

            private l2<Int64Range, Int64Range.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.e> g0() {
                if (this.f46505r == null) {
                    this.f46505r = new l2<>(this.f46504q, (this.f46492e & 4) != 0, H(), O());
                    this.f46504q = null;
                }
                return this.f46505r;
            }
            ...
            private l2<HeaderValueOption, HeaderValueOption.b, t> h0() {
                if (this.f46501n == null) {
                    this.f46501n = new l2<>(this.f46500m, (this.f46492e & 1) != 0, H(), O());
                    this.f46500m = null;
                }
                return this.f46501n;
            }
            ...
            @Override // com.google.protobuf.GeneratedMessageV3.b
            protected GeneratedMessageV3.e K() {
                return w.f46782f.d(HttpHealthCheck.class, b.class);
            }
            ...
            public HttpHealthCheck I() {
                ...
                httpHealthCheck.host_ = this.f46493f;
                httpHealthCheck.path_ = this.f46494g;
                q2<Payload, Payload.b, g> q2Var = this.f46496i;
                if (q2Var == null) {
                    httpHealthCheck.send_ = this.f46495h;
                } else {
                    httpHealthCheck.send_ = q2Var.b();
                }
                q2<Payload, Payload.b, g> q2Var2 = this.f46498k;
                if (q2Var2 == null) {
                    httpHealthCheck.receive_ = this.f46497j;
                } else {
                    httpHealthCheck.receive_ = q2Var2.b();
                }
                httpHealthCheck.serviceName_ = this.f46499l;
                l2<HeaderValueOption, HeaderValueOption.b, t> l2Var = this.f46501n;
                if (l2Var == null) {
                    if ((this.f46492e & 1) != 0) {
                        this.f46500m = Collections.unmodifiableList(this.f46500m);
                        this.f46492e &= -2;
                    }
                    httpHealthCheck.requestHeadersToAdd_ = this.f46500m;
                } else {
                    httpHealthCheck.requestHeadersToAdd_ = l2Var.e();
                }
                if ((this.f46492e & 2) != 0) {
                    this.f46502o = this.f46502o.V0();
                    this.f46492e &= -3;
                }
                httpHealthCheck.requestHeadersToRemove_ = this.f46502o;
                httpHealthCheck.useHttp2_ = this.f46503p;
                l2<Int64Range, Int64Range.b, io.grpc.xds.shaded.io.envoyproxy.envoy.type.e> l2Var2 = this.f46505r;
                if (l2Var2 == null) {
                    if ((this.f46492e & 4) != 0) {
                        this.f46504q = Collections.unmodifiableList(this.f46504q);
                        this.f46492e &= -5;
                    }
                    httpHealthCheck.expectedStatuses_ = this.f46504q;
                } else {
                    httpHealthCheck.expectedStatuses_ = l2Var2.e();
                }
                httpHealthCheck.codecClientType_ = this.f46506s;
                q2<StringMatcher, StringMatcher.c, io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.k> q2Var3 = this.f46508u;
                if (q2Var3 == null) {
                    httpHealthCheck.serviceNameMatcher_ = this.f46507t;
                } else {
            ...
            /*
                ...
                To view partially-correct add '--show-bad-code' argument
            */
            public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.HttpHealthCheck.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                /*
                    r2 = this;
                    r0 = 0
                    com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.HttpHealthCheck.access$2800()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$HttpHealthCheck r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.HttpHealthCheck) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    if (r3 == 0) goto L10
                    r2.l0(r3)
                L10:
                    return r2
                ...
                L13:
                    r3 = move-exception
                    com.google.protobuf.o1 r4 = r3.getUnfinishedMessage()     // Catch: java.lang.Throwable -> L11
                    io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$HttpHealthCheck r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.HttpHealthCheck) r4     // Catch: java.lang.Throwable -> L11
                    java.io.IOException r3 = r3.unwrapIOException()     // Catch: java.lang.Throwable -> L1f
                    throw r3     // Catch: java.lang.Throwable -> L1f
                L1f:
                    r3 = move-exception
                ...
                L26:
                    throw r3
                */
                throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.HttpHealthCheck.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$HttpHealthCheck$b");
            }
            ...
            public b l0(HttpHealthCheck httpHealthCheck) {
                ...
                if (!httpHealthCheck.getHost().isEmpty()) {
                    this.f46493f = httpHealthCheck.host_;
                    R();
                }
                if (!httpHealthCheck.getPath().isEmpty()) {
                    this.f46494g = httpHealthCheck.path_;
                    R();
                }
                ...
                if (!httpHealthCheck.getServiceName().isEmpty()) {
                    this.f46499l = httpHealthCheck.serviceName_;
                    R();
                }
                if (this.f46501n == null) {
                    if (!httpHealthCheck.requestHeadersToAdd_.isEmpty()) {
                        if (this.f46500m.isEmpty()) {
                            this.f46500m = httpHealthCheck.requestHeadersToAdd_;
                            this.f46492e &= -2;
                        } else {
                            b0();
                            this.f46500m.addAll(httpHealthCheck.requestHeadersToAdd_);
                        }
                        R();
                    }
                    ...
                    if (this.f46501n.k()) {
                        ...
                        this.f46500m = httpHealthCheck.requestHeadersToAdd_;
                        this.f46492e &= -2;
                        this.f46501n = GeneratedMessageV3.alwaysUseFieldBuilders ? h0() : null;
                    } else {
                        this.f46501n.b(httpHealthCheck.requestHeadersToAdd_);
                    }
                }
                if (!httpHealthCheck.requestHeadersToRemove_.isEmpty()) {
                    if (this.f46502o.isEmpty()) {
                        this.f46502o = httpHealthCheck.requestHeadersToRemove_;
                        this.f46492e &= -3;
                    } else {
                        d0();
                        this.f46502o.addAll(httpHealthCheck.requestHeadersToRemove_);
                    }
                    R();
                }
                if (httpHealthCheck.getUseHttp2()) {
                    u0(httpHealthCheck.getUseHttp2());
                }
                if (this.f46505r == null) {
                    if (!httpHealthCheck.expectedStatuses_.isEmpty()) {
                        if (this.f46504q.isEmpty()) {
                            this.f46504q = httpHealthCheck.expectedStatuses_;
                            this.f46492e &= -5;
                        } else {
                            a0();
                            this.f46504q.addAll(httpHealthCheck.expectedStatuses_);
                        }
                        R();
                    }
                    ...
                    if (this.f46505r.k()) {
                        ...
                        this.f46504q = httpHealthCheck.expectedStatuses_;
                        this.f46492e &= -5;
                        this.f46505r = GeneratedMessageV3.alwaysUseFieldBuilders ? g0() : null;
                    } else {
                        this.f46505r.b(httpHealthCheck.expectedStatuses_);
                    }
                }
            ...
            public b m0(Payload payload) {
                q2<Payload, Payload.b, g> q2Var = this.f46498k;
                if (q2Var == null) {
                    Payload payload2 = this.f46497j;
                    if (payload2 != null) {
                        this.f46497j = Payload.newBuilder(payload2).g0(payload).I();
                    } else {
                        this.f46497j = payload;
                    }
                    R();
                } else {
                    q2Var.e(payload);
            ...
            public b n0(Payload payload) {
                q2<Payload, Payload.b, g> q2Var = this.f46496i;
                if (q2Var == null) {
                    Payload payload2 = this.f46495h;
                    if (payload2 != null) {
                        this.f46495h = Payload.newBuilder(payload2).g0(payload).I();
                    } else {
                        this.f46495h = payload;
                    }
                    R();
                } else {
                    q2Var.e(payload);
            ...
            public b o0(StringMatcher stringMatcher) {
                q2<StringMatcher, StringMatcher.c, io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.k> q2Var = this.f46508u;
                if (q2Var == null) {
                    StringMatcher stringMatcher2 = this.f46507t;
                    if (stringMatcher2 != null) {
                        this.f46507t = StringMatcher.newBuilder(stringMatcher2).g0(stringMatcher).I();
                    } else {
                        this.f46507t = stringMatcher;
                    }
                    R();
                } else {
            ...
            private b() {
                ...
                this.f46494g = "";
                this.f46499l = "";
                this.f46500m = Collections.emptyList();
                this.f46502o = y0.f15344d;
                this.f46504q = Collections.emptyList();
                this.f46506s = 0;
                i0();
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (getHost().equals(httpHealthCheck.getHost()) && getPath().equals(httpHealthCheck.getPath()) && hasSend() == httpHealthCheck.hasSend()) {
                if ((!hasSend() || getSend().equals(httpHealthCheck.getSend())) && hasReceive() == httpHealthCheck.hasReceive()) {
                    if ((!hasReceive() || getReceive().equals(httpHealthCheck.getReceive())) && getServiceName().equals(httpHealthCheck.getServiceName()) && getRequestHeadersToAddList().equals(httpHealthCheck.getRequestHeadersToAddList()) && m1593getRequestHeadersToRemoveList().equals(httpHealthCheck.m1593getRequestHeadersToRemoveList()) && getUseHttp2() == httpHealthCheck.getUseHttp2() && getExpectedStatusesList().equals(httpHealthCheck.getExpectedStatusesList()) && this.codecClientType_ == httpHealthCheck.codecClientType_ && hasServiceNameMatcher() == httpHealthCheck.hasServiceNameMatcher()) {
        ...
        public io.grpc.xds.shaded.io.envoyproxy.envoy.type.e getExpectedStatusesOrBuilder(int i9) {
            return this.expectedStatuses_.get(i9);
        }

        public List<? extends io.grpc.xds.shaded.io.envoyproxy.envoy.type.e> getExpectedStatusesOrBuilderList() {
            return this.expectedStatuses_;
        }
        ...
        public int getSerializedSize() {
            ...
            int size = computeStringSize + i11 + (m1593getRequestHeadersToRemoveList().size() * 1);
        ...
        public io.grpc.xds.shaded.io.envoyproxy.envoy.type.matcher.k getServiceNameMatcherOrBuilder() {
        ...
        public int hashCode() {
            ...
            if (getRequestHeadersToAddCount() > 0) {
                hashCode2 = (((hashCode2 * 37) + 6) * 53) + getRequestHeadersToAddList().hashCode();
            }
            if (getRequestHeadersToRemoveCount() > 0) {
                hashCode2 = (((hashCode2 * 37) + 8) * 53) + m1593getRequestHeadersToRemoveList().hashCode();
            }
            int d10 = (((hashCode2 * 37) + 7) * 53) + u0.d(getUseHttp2());
            if (getExpectedStatusesCount() > 0) {
                d10 = (((d10 * 37) + 9) * 53) + getExpectedStatusesList().hashCode();
            }
            int i10 = (((d10 * 37) + 10) * 53) + this.codecClientType_;
        ...
        public i2 m1593getRequestHeadersToRemoveList() {
        ...
        private HttpHealthCheck() {
            ...
            this.requestHeadersToRemove_ = y0.f15344d;
    ...
    public static final class Payload extends GeneratedMessageV3 implements g {
        ...
        public static final class b extends GeneratedMessageV3.b<b> implements g {
            ...
            @Override // com.google.protobuf.GeneratedMessageV3.b
            protected GeneratedMessageV3.e K() {
                return w.f46780d.d(Payload.class, b.class);
            }
            ...
            public Payload I() {
                ...
                if (this.f46509e == 1) {
                    payload.payload_ = this.f46510f;
                }
                if (this.f46509e == 2) {
                    payload.payload_ = this.f46510f;
                }
                payload.payloadCase_ = this.f46509e;
                Q();
                return payload;
            }
            ...
            /*
                ...
                To view partially-correct add '--show-bad-code' argument
            */
            public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.Payload.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                /*
                    r2 = this;
                    r0 = 0
                    com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.Payload.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$Payload r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.Payload) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    if (r3 == 0) goto L10
                    r2.g0(r3)
                L10:
                    return r2
                ...
                L13:
                    r3 = move-exception
                    com.google.protobuf.o1 r4 = r3.getUnfinishedMessage()     // Catch: java.lang.Throwable -> L11
                    io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$Payload r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.Payload) r4     // Catch: java.lang.Throwable -> L11
                    java.io.IOException r3 = r3.unwrapIOException()     // Catch: java.lang.Throwable -> L1f
                    throw r3     // Catch: java.lang.Throwable -> L1f
                L1f:
                    r3 = move-exception
                ...
                L26:
                    throw r3
                */
                throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.Payload.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$Payload$b");
            }
            ...
            public b g0(Payload payload) {
                ...
                int i9 = b.f46519a[payload.getPayloadCase().ordinal()];
                if (i9 == 1) {
                    this.f46509e = 1;
                    this.f46510f = payload.payload_;
                    R();
                } else if (i9 == 2) {
    ...
    public static final class RedisHealthCheck extends GeneratedMessageV3 implements r1 {
        ...
        public static final class b extends GeneratedMessageV3.b<b> implements r1 {
            ...
            @Override // com.google.protobuf.GeneratedMessageV3.b
            protected GeneratedMessageV3.e K() {
                return w.f46786j.d(RedisHealthCheck.class, b.class);
            }
            ...
            public RedisHealthCheck I() {
                ...
                redisHealthCheck.key_ = this.f46511e;
                Q();
            ...
            /*
                ...
                To view partially-correct add '--show-bad-code' argument
            */
            public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.RedisHealthCheck.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                /*
                    r2 = this;
                    r0 = 0
                    com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.RedisHealthCheck.access$5000()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$RedisHealthCheck r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.RedisHealthCheck) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    if (r3 == 0) goto L10
                    r2.g0(r3)
                L10:
                    return r2
                ...
                L13:
                    r3 = move-exception
                    com.google.protobuf.o1 r4 = r3.getUnfinishedMessage()     // Catch: java.lang.Throwable -> L11
                    io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$RedisHealthCheck r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.RedisHealthCheck) r4     // Catch: java.lang.Throwable -> L11
                    java.io.IOException r3 = r3.unwrapIOException()     // Catch: java.lang.Throwable -> L1f
                    throw r3     // Catch: java.lang.Throwable -> L1f
                L1f:
                    r3 = move-exception
                ...
                L26:
                    throw r3
                */
                throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.RedisHealthCheck.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$RedisHealthCheck$b");
            }
            ...
            public b g0(RedisHealthCheck redisHealthCheck) {
                ...
                if (!redisHealthCheck.getKey().isEmpty()) {
                    this.f46511e = redisHealthCheck.key_;
                    R();
                }
    ...
    public static final class TcpHealthCheck extends GeneratedMessageV3 implements h {
        ...
        public static final class b extends GeneratedMessageV3.b<b> implements h {
            ...
            /* renamed from: f  reason: collision with root package name */
            private Payload f46513f;

            /* renamed from: g  reason: collision with root package name */
            private q2<Payload, Payload.b, g> f46514g;

            /* renamed from: h  reason: collision with root package name */
            private List<Payload> f46515h;

            /* renamed from: i  reason: collision with root package name */
            private l2<Payload, Payload.b, g> f46516i;
            ...
            private void a0() {
                if ((this.f46512e & 1) == 0) {
                    this.f46515h = new ArrayList(this.f46515h);
                    this.f46512e |= 1;
                }
            }

            private l2<Payload, Payload.b, g> d0() {
                if (this.f46516i == null) {
                    this.f46516i = new l2<>(this.f46515h, (this.f46512e & 1) != 0, H(), O());
                    this.f46515h = null;
                }
                return this.f46516i;
            }
            ...
            @Override // com.google.protobuf.GeneratedMessageV3.b
            protected GeneratedMessageV3.e K() {
                return w.f46784h.d(TcpHealthCheck.class, b.class);
            }
            ...
            public TcpHealthCheck I() {
                ...
                q2<Payload, Payload.b, g> q2Var = this.f46514g;
                if (q2Var == null) {
                    tcpHealthCheck.send_ = this.f46513f;
                } else {
                    tcpHealthCheck.send_ = q2Var.b();
                }
                l2<Payload, Payload.b, g> l2Var = this.f46516i;
                if (l2Var == null) {
                    if ((this.f46512e & 1) != 0) {
                        this.f46515h = Collections.unmodifiableList(this.f46515h);
                        this.f46512e &= -2;
                    }
                    tcpHealthCheck.receive_ = this.f46515h;
                } else {
            ...
            /*
                ...
                To view partially-correct add '--show-bad-code' argument
            */
            public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.TcpHealthCheck.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                /*
                    r2 = this;
                    r0 = 0
                    com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.TcpHealthCheck.access$4200()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$TcpHealthCheck r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.TcpHealthCheck) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    if (r3 == 0) goto L10
                    r2.i0(r3)
                L10:
                    return r2
                ...
                L13:
                    r3 = move-exception
                    com.google.protobuf.o1 r4 = r3.getUnfinishedMessage()     // Catch: java.lang.Throwable -> L11
                    io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$TcpHealthCheck r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.TcpHealthCheck) r4     // Catch: java.lang.Throwable -> L11
                    java.io.IOException r3 = r3.unwrapIOException()     // Catch: java.lang.Throwable -> L1f
                    throw r3     // Catch: java.lang.Throwable -> L1f
                L1f:
                    r3 = move-exception
                ...
                L26:
                    throw r3
                */
                throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.TcpHealthCheck.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$TcpHealthCheck$b");
            }
            ...
            public b i0(TcpHealthCheck tcpHealthCheck) {
                ...
                if (this.f46516i == null) {
                    if (!tcpHealthCheck.receive_.isEmpty()) {
                        if (this.f46515h.isEmpty()) {
                            this.f46515h = tcpHealthCheck.receive_;
                            this.f46512e &= -2;
                        } else {
                            a0();
                            this.f46515h.addAll(tcpHealthCheck.receive_);
                        }
                        R();
                    }
                    ...
                    if (this.f46516i.k()) {
                        ...
                        this.f46515h = tcpHealthCheck.receive_;
                        this.f46512e &= -2;
                        this.f46516i = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                    } else {
                        this.f46516i.b(tcpHealthCheck.receive_);
                    }
                }
            ...
            public b j0(Payload payload) {
                q2<Payload, Payload.b, g> q2Var = this.f46514g;
                if (q2Var == null) {
                    Payload payload2 = this.f46513f;
                    if (payload2 != null) {
                        this.f46513f = Payload.newBuilder(payload2).g0(payload).I();
                    } else {
                        this.f46513f = payload;
                    }
                    R();
                } else {
                    q2Var.e(payload);
            ...
            private b() {
                this.f46515h = Collections.emptyList();
                e0();
            }
    ...
    public static final class TlsOptions extends GeneratedMessageV3 implements i {
        ...
        public static final class b extends GeneratedMessageV3.b<b> implements i {
            ...
            private void a0() {
                if ((this.f46517e & 1) == 0) {
                    this.f46518f = new y0(this.f46518f);
                    this.f46517e |= 1;
                }
            }
            ...
            @Override // com.google.protobuf.GeneratedMessageV3.b
            protected GeneratedMessageV3.e K() {
                return w.f46792p.d(TlsOptions.class, b.class);
            }
            ...
            public TlsOptions I() {
                ...
                if ((this.f46517e & 1) != 0) {
                    this.f46518f = this.f46518f.V0();
                    this.f46517e &= -2;
                }
                tlsOptions.alpnProtocols_ = this.f46518f;
                Q();
                return tlsOptions;
            }
            ...
            /*
                ...
                To view partially-correct add '--show-bad-code' argument
            */
            public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.TlsOptions.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
                /*
                    r2 = this;
                    r0 = 0
                    com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.TlsOptions.access$8100()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$TlsOptions r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.TlsOptions) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                    if (r3 == 0) goto L10
                    r2.h0(r3)
                L10:
                    return r2
                ...
                L13:
                    r3 = move-exception
                    com.google.protobuf.o1 r4 = r3.getUnfinishedMessage()     // Catch: java.lang.Throwable -> L11
                    io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$TlsOptions r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.TlsOptions) r4     // Catch: java.lang.Throwable -> L11
                    java.io.IOException r3 = r3.unwrapIOException()     // Catch: java.lang.Throwable -> L1f
                    throw r3     // Catch: java.lang.Throwable -> L1f
                L1f:
                    r3 = move-exception
                ...
                L26:
                    throw r3
                */
                throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.TlsOptions.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$TlsOptions$b");
            }
            ...
            public b h0(TlsOptions tlsOptions) {
                ...
                if (!tlsOptions.alpnProtocols_.isEmpty()) {
                    if (this.f46518f.isEmpty()) {
                        this.f46518f = tlsOptions.alpnProtocols_;
                        this.f46517e &= -2;
                    } else {
                        a0();
                        this.f46518f.addAll(tlsOptions.alpnProtocols_);
                    }
                    R();
                }
        ...
        public boolean equals(Object obj) {
            ...
            return m1594getAlpnProtocolsList().equals(tlsOptions.m1594getAlpnProtocolsList()) && this.unknownFields.equals(tlsOptions.unknownFields);
        }
        ...
        public int getSerializedSize() {
            ...
            int size = 0 + i10 + (m1594getAlpnProtocolsList().size() * 1) + this.unknownFields.getSerializedSize();
        ...
        public int hashCode() {
            ...
            if (getAlpnProtocolsCount() > 0) {
                hashCode = (((hashCode * 37) + 1) * 53) + m1594getAlpnProtocolsList().hashCode();
            }
            int hashCode2 = (hashCode * 29) + this.unknownFields.hashCode();
            this.memoizedHashCode = hashCode2;
            return hashCode2;
        ...
        public i2 m1594getAlpnProtocolsList() {
    ...
    public static /* synthetic */ class b {
        ...
        static final /* synthetic */ int[] f46519a;

        /* renamed from: b  reason: collision with root package name */
        static final /* synthetic */ int[] f46520b;

        /* renamed from: c  reason: collision with root package name */
        static final /* synthetic */ int[] f46521c;
        ...
        static {
            ...
            try {
                f46521c[HealthCheckerCase.TCP_HEALTH_CHECK.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f46521c[HealthCheckerCase.GRPC_HEALTH_CHECK.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f46521c[HealthCheckerCase.CUSTOM_HEALTH_CHECK.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f46521c[HealthCheckerCase.HEALTHCHECKER_NOT_SET.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            int[] iArr2 = new int[CustomHealthCheck.ConfigTypeCase.values().length];
            f46520b = iArr2;
            try {
                iArr2[CustomHealthCheck.ConfigTypeCase.CONFIG.ordinal()] = 1;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f46520b[CustomHealthCheck.ConfigTypeCase.TYPED_CONFIG.ordinal()] = 2;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f46520b[CustomHealthCheck.ConfigTypeCase.CONFIGTYPE_NOT_SET.ordinal()] = 3;
            ...
            try {
                f46519a[Payload.PayloadCase.BINARY.ordinal()] = 2;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f46519a[Payload.PayloadCase.PAYLOAD_NOT_SET.ordinal()] = 3;
    ...
    /* loaded from: classes6.dex */
    public static final class c extends GeneratedMessageV3.b<c> implements v {
        ...
        private Object J;
        private EventServiceConfig K;
        private q2<EventServiceConfig, EventServiceConfig.c, o> L;
        private boolean M;
        private TlsOptions N;
        private q2<TlsOptions, TlsOptions.b, i> O;

        /* renamed from: e  reason: collision with root package name */
        private int f46522e;

        /* renamed from: f  reason: collision with root package name */
        private Object f46523f;

        /* renamed from: g  reason: collision with root package name */
        private Duration f46524g;

        /* renamed from: h  reason: collision with root package name */
        private q2<Duration, Duration.b, com.google.protobuf.v> f46525h;

        /* renamed from: i  reason: collision with root package name */
        private Duration f46526i;

        /* renamed from: j  reason: collision with root package name */
        private q2<Duration, Duration.b, com.google.protobuf.v> f46527j;

        /* renamed from: k  reason: collision with root package name */
        private Duration f46528k;

        /* renamed from: l  reason: collision with root package name */
        private q2<Duration, Duration.b, com.google.protobuf.v> f46529l;

        /* renamed from: m  reason: collision with root package name */
        private Duration f46530m;

        /* renamed from: n  reason: collision with root package name */
        private q2<Duration, Duration.b, com.google.protobuf.v> f46531n;

        /* renamed from: o  reason: collision with root package name */
        private int f46532o;

        /* renamed from: p  reason: collision with root package name */
        private UInt32Value f46533p;

        /* renamed from: q  reason: collision with root package name */
        private q2<UInt32Value, UInt32Value.b, e3> f46534q;

        /* renamed from: r  reason: collision with root package name */
        private UInt32Value f46535r;

        /* renamed from: s  reason: collision with root package name */
        private q2<UInt32Value, UInt32Value.b, e3> f46536s;

        /* renamed from: t  reason: collision with root package name */
        private UInt32Value f46537t;

        /* renamed from: u  reason: collision with root package name */
        private q2<UInt32Value, UInt32Value.b, e3> f46538u;

        /* renamed from: v  reason: collision with root package name */
        private BoolValue f46539v;

        /* renamed from: w  reason: collision with root package name */
        private q2<BoolValue, BoolValue.b, com.google.protobuf.l> f46540w;

        /* renamed from: x  reason: collision with root package name */
        private q2<HttpHealthCheck, HttpHealthCheck.b, f> f46541x;

        /* renamed from: y  reason: collision with root package name */
        private q2<TcpHealthCheck, TcpHealthCheck.b, h> f46542y;

        /* renamed from: z  reason: collision with root package name */
        private q2<GrpcHealthCheck, GrpcHealthCheck.b, e> f46543z;
        ...
        public c B0(UInt32Value uInt32Value) {
            q2<UInt32Value, UInt32Value.b, e3> q2Var = this.f46534q;
            if (q2Var == null) {
                UInt32Value uInt32Value2 = this.f46533p;
                if (uInt32Value2 != null) {
                    this.f46533p = UInt32Value.newBuilder(uInt32Value2).g0(uInt32Value).I();
                } else {
                    this.f46533p = uInt32Value;
                }
                R();
            } else {
                q2Var.e(uInt32Value);
        ...
        @Override // com.google.protobuf.GeneratedMessageV3.b
        protected GeneratedMessageV3.e K() {
            return w.f46778b.d(HealthCheck.class, c.class);
        }
        ...
        public HealthCheck I() {
            ...
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var = this.f46525h;
            if (q2Var == null) {
                healthCheck.timeout_ = this.f46524g;
            } else {
                healthCheck.timeout_ = q2Var.b();
            }
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var2 = this.f46527j;
            if (q2Var2 == null) {
                healthCheck.interval_ = this.f46526i;
            } else {
                healthCheck.interval_ = q2Var2.b();
            }
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var3 = this.f46529l;
            if (q2Var3 == null) {
                healthCheck.initialJitter_ = this.f46528k;
            } else {
                healthCheck.initialJitter_ = q2Var3.b();
            }
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var4 = this.f46531n;
            if (q2Var4 == null) {
                healthCheck.intervalJitter_ = this.f46530m;
            } else {
                healthCheck.intervalJitter_ = q2Var4.b();
            }
            healthCheck.intervalJitterPercent_ = this.f46532o;
            q2<UInt32Value, UInt32Value.b, e3> q2Var5 = this.f46534q;
            if (q2Var5 == null) {
                healthCheck.unhealthyThreshold_ = this.f46533p;
            } else {
                healthCheck.unhealthyThreshold_ = q2Var5.b();
            }
            q2<UInt32Value, UInt32Value.b, e3> q2Var6 = this.f46536s;
            if (q2Var6 == null) {
                healthCheck.healthyThreshold_ = this.f46535r;
            } else {
                healthCheck.healthyThreshold_ = q2Var6.b();
            }
            q2<UInt32Value, UInt32Value.b, e3> q2Var7 = this.f46538u;
            if (q2Var7 == null) {
                healthCheck.altPort_ = this.f46537t;
            } else {
                healthCheck.altPort_ = q2Var7.b();
            }
            q2<BoolValue, BoolValue.b, com.google.protobuf.l> q2Var8 = this.f46540w;
            if (q2Var8 == null) {
                healthCheck.reuseConnection_ = this.f46539v;
            } else {
                healthCheck.reuseConnection_ = q2Var8.b();
            }
            if (this.f46522e == 8) {
                q2<HttpHealthCheck, HttpHealthCheck.b, f> q2Var9 = this.f46541x;
                if (q2Var9 == null) {
                    healthCheck.healthChecker_ = this.f46523f;
                } else {
                    healthCheck.healthChecker_ = q2Var9.b();
                }
            }
            if (this.f46522e == 9) {
                q2<TcpHealthCheck, TcpHealthCheck.b, h> q2Var10 = this.f46542y;
                if (q2Var10 == null) {
                    healthCheck.healthChecker_ = this.f46523f;
                } else {
            ...
            if (this.f46522e == 11) {
                q2<GrpcHealthCheck, GrpcHealthCheck.b, e> q2Var11 = this.f46543z;
                if (q2Var11 == null) {
                    healthCheck.healthChecker_ = this.f46523f;
                } else {
            ...
            if (q2Var14 == null) {
                healthCheck.unhealthyInterval_ = this.D;
            } else {
                healthCheck.unhealthyInterval_ = q2Var14.b();
            }
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var15 = this.G;
            if (q2Var15 == null) {
                healthCheck.unhealthyEdgeInterval_ = this.F;
            } else {
                healthCheck.unhealthyEdgeInterval_ = q2Var15.b();
            }
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var16 = this.I;
            if (q2Var16 == null) {
                healthCheck.healthyEdgeInterval_ = this.H;
            } else {
                healthCheck.healthyEdgeInterval_ = q2Var16.b();
            }
            healthCheck.eventLogPath_ = this.J;
            q2<EventServiceConfig, EventServiceConfig.c, o> q2Var17 = this.L;
            if (q2Var17 == null) {
                healthCheck.eventService_ = this.K;
            } else {
                healthCheck.eventService_ = q2Var17.b();
            }
            healthCheck.alwaysLogHealthCheckFailures_ = this.M;
            q2<TlsOptions, TlsOptions.b, i> q2Var18 = this.O;
            if (q2Var18 == null) {
                healthCheck.tlsOptions_ = this.N;
            } else {
                healthCheck.tlsOptions_ = q2Var18.b();
            }
            healthCheck.healthCheckerCase_ = this.f46522e;
            Q();
            return healthCheck;
        }
        ...
        public c d0(UInt32Value uInt32Value) {
            q2<UInt32Value, UInt32Value.b, e3> q2Var = this.f46538u;
            if (q2Var == null) {
                UInt32Value uInt32Value2 = this.f46537t;
                if (uInt32Value2 != null) {
                    this.f46537t = UInt32Value.newBuilder(uInt32Value2).g0(uInt32Value).I();
                } else {
                    this.f46537t = uInt32Value;
                }
                R();
            } else {
                q2Var.e(uInt32Value);
        ...
        public c e0(CustomHealthCheck customHealthCheck) {
            ...
            if (q2Var == null) {
                if (this.f46522e == 13 && this.f46523f != CustomHealthCheck.getDefaultInstance()) {
                    this.f46523f = CustomHealthCheck.newBuilder((CustomHealthCheck) this.f46523f).h0(customHealthCheck).I();
                } else {
                    this.f46523f = customHealthCheck;
                }
                R();
            } else {
                if (this.f46522e == 13) {
        ...
        public c g0(EventServiceConfig eventServiceConfig) {
            q2<EventServiceConfig, EventServiceConfig.c, o> q2Var = this.L;
            if (q2Var == null) {
                EventServiceConfig eventServiceConfig2 = this.K;
                if (eventServiceConfig2 != null) {
                    this.K = EventServiceConfig.newBuilder(eventServiceConfig2).g0(eventServiceConfig).I();
                } else {
                    this.K = eventServiceConfig;
                }
                R();
            } else {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.access$10800()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck r3 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.j0(r3)
            L10:
                return r2
            ...
            L13:
                r3 = move-exception
                com.google.protobuf.o1 r4 = r3.getUnfinishedMessage()     // Catch: java.lang.Throwable -> L11
                io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck r4 = (io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck) r4     // Catch: java.lang.Throwable -> L11
                java.io.IOException r3 = r3.unwrapIOException()     // Catch: java.lang.Throwable -> L1f
                throw r3     // Catch: java.lang.Throwable -> L1f
            L1f:
                r3 = move-exception
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.HealthCheck$c");
        }
        ...
        public c j0(HealthCheck healthCheck) {
            ...
            if (healthCheck.getIntervalJitterPercent() != 0) {
                J0(healthCheck.getIntervalJitterPercent());
            }
            if (healthCheck.hasUnhealthyThreshold()) {
                B0(healthCheck.getUnhealthyThreshold());
            }
            ...
            if (healthCheck.getAlwaysLogHealthCheckFailures()) {
                H0(healthCheck.getAlwaysLogHealthCheckFailures());
            }
            if (healthCheck.hasTlsOptions()) {
                x0(healthCheck.getTlsOptions());
            }
            int i9 = b.f46521c[healthCheck.getHealthCheckerCase().ordinal()];
            if (i9 == 1) {
                n0(healthCheck.getHttpHealthCheck());
            } else if (i9 == 2) {
                u0(healthCheck.getTcpHealthCheck());
            } else if (i9 == 3) {
        ...
        public c k0(GrpcHealthCheck grpcHealthCheck) {
            q2<GrpcHealthCheck, GrpcHealthCheck.b, e> q2Var = this.f46543z;
            if (q2Var == null) {
                if (this.f46522e == 11 && this.f46523f != GrpcHealthCheck.getDefaultInstance()) {
                    this.f46523f = GrpcHealthCheck.newBuilder((GrpcHealthCheck) this.f46523f).g0(grpcHealthCheck).I();
                } else {
                    this.f46523f = grpcHealthCheck;
                }
                R();
            } else {
                if (this.f46522e == 11) {
                ...
                this.f46543z.g(grpcHealthCheck);
            }
            this.f46522e = 11;
            return this;
        }
        ...
        public c m0(UInt32Value uInt32Value) {
            q2<UInt32Value, UInt32Value.b, e3> q2Var = this.f46536s;
            if (q2Var == null) {
                UInt32Value uInt32Value2 = this.f46535r;
                if (uInt32Value2 != null) {
                    this.f46535r = UInt32Value.newBuilder(uInt32Value2).g0(uInt32Value).I();
                } else {
                    this.f46535r = uInt32Value;
                }
                R();
            } else {
                q2Var.e(uInt32Value);
        ...
        public c n0(HttpHealthCheck httpHealthCheck) {
            q2<HttpHealthCheck, HttpHealthCheck.b, f> q2Var = this.f46541x;
            if (q2Var == null) {
                if (this.f46522e == 8 && this.f46523f != HttpHealthCheck.getDefaultInstance()) {
                    this.f46523f = HttpHealthCheck.newBuilder((HttpHealthCheck) this.f46523f).l0(httpHealthCheck).I();
                } else {
                    this.f46523f = httpHealthCheck;
                }
                R();
            } else {
                if (this.f46522e == 8) {
                ...
                this.f46541x.g(httpHealthCheck);
            }
            this.f46522e = 8;
            return this;
        }
        ...
        public c o0(Duration duration) {
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var = this.f46529l;
            if (q2Var == null) {
                Duration duration2 = this.f46528k;
                if (duration2 != null) {
                    this.f46528k = Duration.newBuilder(duration2).e0(duration).I();
                } else {
                    this.f46528k = duration;
                }
                R();
            } else {
                q2Var.e(duration);
        ...
        public c q0(Duration duration) {
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var = this.f46527j;
            if (q2Var == null) {
                Duration duration2 = this.f46526i;
                if (duration2 != null) {
                    this.f46526i = Duration.newBuilder(duration2).e0(duration).I();
                } else {
                    this.f46526i = duration;
                }
                R();
            } else {
                q2Var.e(duration);
        ...
        public c r0(Duration duration) {
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var = this.f46531n;
            if (q2Var == null) {
                Duration duration2 = this.f46530m;
                if (duration2 != null) {
                    this.f46530m = Duration.newBuilder(duration2).e0(duration).I();
                } else {
                    this.f46530m = duration;
                }
                R();
            } else {
                q2Var.e(duration);
        ...
        public c t0(BoolValue boolValue) {
            q2<BoolValue, BoolValue.b, com.google.protobuf.l> q2Var = this.f46540w;
            if (q2Var == null) {
                BoolValue boolValue2 = this.f46539v;
                if (boolValue2 != null) {
                    this.f46539v = BoolValue.newBuilder(boolValue2).d0(boolValue).I();
                } else {
                    this.f46539v = boolValue;
                }
                R();
            } else {
                q2Var.e(boolValue);
        ...
        public c u0(TcpHealthCheck tcpHealthCheck) {
            q2<TcpHealthCheck, TcpHealthCheck.b, h> q2Var = this.f46542y;
            if (q2Var == null) {
                if (this.f46522e == 9 && this.f46523f != TcpHealthCheck.getDefaultInstance()) {
                    this.f46523f = TcpHealthCheck.newBuilder((TcpHealthCheck) this.f46523f).i0(tcpHealthCheck).I();
                } else {
                    this.f46523f = tcpHealthCheck;
                }
                R();
            } else {
                if (this.f46522e == 9) {
        ...
        public c v0(Duration duration) {
            q2<Duration, Duration.b, com.google.protobuf.v> q2Var = this.f46525h;
            if (q2Var == null) {
                Duration duration2 = this.f46524g;
                if (duration2 != null) {
                    this.f46524g = Duration.newBuilder(duration2).e0(duration).I();
                } else {
                    this.f46524g = duration;
                }
                R();
            } else {
                q2Var.e(duration);
        ...
        public c x0(TlsOptions tlsOptions) {
            q2<TlsOptions, TlsOptions.b, i> q2Var = this.O;
            if (q2Var == null) {
                TlsOptions tlsOptions2 = this.N;
                if (tlsOptions2 != null) {
                    this.N = TlsOptions.newBuilder(tlsOptions2).h0(tlsOptions).I();
                } else {
                    this.N = tlsOptions;
                }
                R();
                                                ...
                                                if ((!hasUnhealthyEdgeInterval() || getUnhealthyEdgeInterval().equals(healthCheck.getUnhealthyEdgeInterval())) && hasHealthyEdgeInterval() == healthCheck.hasHealthyEdgeInterval()) {
                                                    if ((!hasHealthyEdgeInterval() || getHealthyEdgeInterval().equals(healthCheck.getHealthyEdgeInterval())) && getEventLogPath().equals(healthCheck.getEventLogPath()) && hasEventService() == healthCheck.hasEventService()) {
                                                        if ((!hasEventService() || getEventService().equals(healthCheck.getEventService())) && getAlwaysLogHealthCheckFailures() == healthCheck.getAlwaysLogHealthCheckFailures() && hasTlsOptions() == healthCheck.hasTlsOptions()) {
                                                            if ((!hasTlsOptions() || getTlsOptions().equals(healthCheck.getTlsOptions())) && getHealthCheckerCase().equals(healthCheck.getHealthCheckerCase())) {
    ...
    public o getEventServiceOrBuilder() {
    ...
    public int hashCode() {
        ...
        int d10 = (((hashCode3 * 37) + 19) * 53) + u0.d(getAlwaysLogHealthCheckFailures());
        if (hasTlsOptions()) {
                ...
                try {
                    ...
                    switch (L) {
                        ...
                        case 106:
                            ...
                            if (builder12 != null) {
                                builder12.h0((CustomHealthCheck) B4);
