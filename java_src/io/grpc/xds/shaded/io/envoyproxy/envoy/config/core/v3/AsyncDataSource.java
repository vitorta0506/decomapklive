...
public final class AsyncDataSource extends GeneratedMessageV3 implements r1 {
    ...
    public static /* synthetic */ class b {
        ...
        static final /* synthetic */ int[] f47786a;
        ...
        static {
            ...
            try {
                f47786a[SpecifierCase.REMOTE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f47786a[SpecifierCase.SPECIFIER_NOT_SET.ordinal()] = 3;
    ...
    public static final class c extends GeneratedMessageV3.b<c> implements r1 {
        ...
        private Object f47788f;

        /* renamed from: g  reason: collision with root package name */
        private q2<DataSource, DataSource.c, n> f47789g;

        /* renamed from: h  reason: collision with root package name */
        private q2<RemoteDataSource, RemoteDataSource.b, s0> f47790h;
        ...
        protected GeneratedMessageV3.e K() {
            return g.N.d(AsyncDataSource.class, c.class);
        }
        ...
        public AsyncDataSource I() {
            ...
            if (this.f47787e == 1) {
                q2<DataSource, DataSource.c, n> q2Var = this.f47789g;
                if (q2Var == null) {
                    asyncDataSource.specifier_ = this.f47788f;
                } else {
                    asyncDataSource.specifier_ = q2Var.b();
                }
            }
            if (this.f47787e == 2) {
                q2<RemoteDataSource, RemoteDataSource.b, s0> q2Var2 = this.f47790h;
                if (q2Var2 == null) {
                    asyncDataSource.specifier_ = this.f47788f;
                } else {
            ...
            asyncDataSource.specifierCase_ = this.f47787e;
            Q();
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.AsyncDataSource.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.AsyncDataSource.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.AsyncDataSource.c.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.config.core.v3.AsyncDataSource$c");
        }
        ...
        public c g0(AsyncDataSource asyncDataSource) {
            ...
            int i9 = b.f47786a[asyncDataSource.getSpecifierCase().ordinal()];
            if (i9 == 1) {
        ...
        public c h0(DataSource dataSource) {
            q2<DataSource, DataSource.c, n> q2Var = this.f47789g;
            if (q2Var == null) {
                if (this.f47787e == 1 && this.f47788f != DataSource.getDefaultInstance()) {
                    this.f47788f = DataSource.newBuilder((DataSource) this.f47788f).g0(dataSource).I();
                } else {
                    this.f47788f = dataSource;
                }
                R();
            } else {
                if (this.f47787e == 1) {
        ...
        public c i0(RemoteDataSource remoteDataSource) {
            q2<RemoteDataSource, RemoteDataSource.b, s0> q2Var = this.f47790h;
            if (q2Var == null) {
                if (this.f47787e == 2 && this.f47788f != RemoteDataSource.getDefaultInstance()) {
                    this.f47788f = RemoteDataSource.newBuilder((RemoteDataSource) this.f47788f).g0(remoteDataSource).I();
                } else {
                    this.f47788f = remoteDataSource;
                }
                R();
            } else {
                if (this.f47787e == 2) {
                ...
                this.f47790h.g(remoteDataSource);
            }
            this.f47787e = 2;
            return this;
        }
