...
public final class DirectResponseAction extends GeneratedMessageV3 implements c {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements c {
        ...
        private DataSource f47032f;

        /* renamed from: g  reason: collision with root package name */
        private q2<DataSource, DataSource.c, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.n> f47033g;
        ...
        protected GeneratedMessageV3.e K() {
            return l.f47302j0.d(DirectResponseAction.class, b.class);
        }
        ...
        public DirectResponseAction I() {
            ...
            directResponseAction.status_ = this.f47031e;
            q2<DataSource, DataSource.c, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.n> q2Var = this.f47033g;
            if (q2Var == null) {
                directResponseAction.body_ = this.f47032f;
            } else {
        ...
        public b d0(DataSource dataSource) {
            q2<DataSource, DataSource.c, io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.n> q2Var = this.f47033g;
            if (q2Var == null) {
                DataSource dataSource2 = this.f47032f;
                if (dataSource2 != null) {
                    this.f47032f = DataSource.newBuilder(dataSource2).g0(dataSource).I();
                } else {
                    this.f47032f = dataSource;
                }
                R();
            } else {
                q2Var.e(dataSource);
        ...
        */
        public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.DirectResponseAction.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.DirectResponseAction.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.DirectResponseAction.b.u(com.google.protobuf.p, com.google.protobuf.f0):io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.route.DirectResponseAction$b");
        }
    ...
    public io.grpc.xds.shaded.io.envoyproxy.envoy.api.v2.core.n getBodyOrBuilder() {
        return getBody();
    }
