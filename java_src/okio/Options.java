...
public final class Options extends AbstractList<ByteString> implements RandomAccess {
    ...
    public static final class Companion {
        ...
        private final void buildTrieRecursive(long j10, Buffer buffer, int i9, List<? extends ByteString> list, int i10, int i11, List<Integer> list2) {
            int i12;
            int i13;
            int i14;
            int i15;
            ...
            if (i10 < i11) {
                ...
                if (byteString.getByte(i17) != byteString2.getByte(i17)) {
                    ...
                    long intCount = j10 + getIntCount(buffer) + 2 + (i22 * 2);
                    buffer.writeInt(i22);
                    buffer.writeInt(i13);
                    if (i12 < i11) {
                        int i24 = i12;
                        while (true) {
                            ...
                            if (i24 == i12 || b10 != list.get(i24 - 1).getByte(i17)) {
                                buffer.writeInt(b10 & UByte.MAX_VALUE);
                            }
                            if (i25 >= i11) {
                                break;
                            }
                ...
                long intCount2 = j10 + getIntCount(buffer) + 2 + i14 + 1;
                buffer.writeInt(-i14);
                buffer.writeInt(i13);
                int i31 = i17 + i14;
                if (i17 < i31) {
        ...
        static /* synthetic */ void buildTrieRecursive$default(Companion companion, long j10, Buffer buffer, int i9, List list, int i10, int i11, List list2, int i12, Object obj) {
            companion.buildTrieRecursive((i12 & 1) != 0 ? 0L : j10, buffer, (i12 & 4) != 0 ? 0 : i9, list, (i12 & 16) != 0 ? 0 : i10, (i12 & 32) != 0 ? list.size() : i11, list2);
        }
