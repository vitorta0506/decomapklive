...
public final class _SegmentedByteStringKt {
    ...
    public static final void commonCopyInto(@NotNull SegmentedByteString segmentedByteString, int i9, @NotNull byte[] target, int i10, int i11) {
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
        Intrinsics.checkNotNullParameter(target, "target");
        long j10 = i11;
        _UtilKt.checkOffsetAndCount(segmentedByteString.size(), i9, j10);
        ...
        while (i9 < i12) {
            ...
            int min = Math.min(i12, (segmentedByteString.getDirectory$okio()[segment] - i13) + i13) - i9;
            int i15 = i14 + (i9 - i13);
    ...
    public static final int commonHashCode(@NotNull SegmentedByteString segmentedByteString) {
        ...
        int i11 = 1;
        while (i9 < length) {
            int i12 = segmentedByteString.getDirectory$okio()[length + i9];
            int i13 = segmentedByteString.getDirectory$okio()[i9];
            byte[] bArr = segmentedByteString.getSegments$okio()[i9];
            int i14 = (i13 - i10) + i12;
            while (i12 < i14) {
                i11 = (i11 * 31) + bArr[i12];
                i12++;
    ...
    public static final byte commonInternalGet(@NotNull SegmentedByteString segmentedByteString, int i9) {
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
        _UtilKt.checkOffsetAndCount(segmentedByteString.getDirectory$okio()[segmentedByteString.getSegments$okio().length - 1], i9, 1L);
        int segment = segment(segmentedByteString, i9);
        return segmentedByteString.getSegments$okio()[segment][(i9 - (segment == 0 ? 0 : segmentedByteString.getDirectory$okio()[segment - 1])) + segmentedByteString.getDirectory$okio()[segmentedByteString.getSegments$okio().length + segment]];
    }

    public static final boolean commonRangeEquals(@NotNull SegmentedByteString segmentedByteString, int i9, @NotNull ByteString other, int i10, int i11) {
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
        Intrinsics.checkNotNullParameter(other, "other");
        if (i9 < 0 || i9 > segmentedByteString.size() - i11) {
            return false;
        }
        int i12 = i11 + i9;
        int segment = segment(segmentedByteString, i9);
        while (i9 < i12) {
            ...
            int i14 = segmentedByteString.getDirectory$okio()[segmentedByteString.getSegments$okio().length + segment];
            int min = Math.min(i12, (segmentedByteString.getDirectory$okio()[segment] - i13) + i13) - i9;
            if (!other.rangeEquals(i10, segmentedByteString.getSegments$okio()[segment], i14 + (i9 - i13), min)) {
                return false;
            }
            i10 += min;
            i9 += min;
    ...
    @NotNull
    public static final ByteString commonSubstring(@NotNull SegmentedByteString segmentedByteString, int i9, int i10) {
        Object[] copyOfRange;
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
        ...
        if (i9 >= 0) {
            ...
            if (i11 >= 0) {
                if (i9 == 0 && resolveDefaultParameter == segmentedByteString.size()) {
                ...
                if (segment <= segment2) {
                    ...
                    while (true) {
                        int i14 = i12 + 1;
                        iArr[i13] = Math.min(segmentedByteString.getDirectory$okio()[i12] - i9, i11);
                        int i15 = i13 + 1;
    ...
    public static final byte[] commonToByteArray(@NotNull SegmentedByteString segmentedByteString) {
        ...
        while (i9 < length) {
            ...
            int i13 = segmentedByteString.getDirectory$okio()[i9];
            int i14 = i13 - i10;
            ArraysKt___ArraysJvmKt.copyInto(segmentedByteString.getSegments$okio()[i9], bArr, i11, i12, i12 + i14);
            i11 += i14;
            i9++;
            i10 = i13;
        }
    ...
    public static final void commonWrite(@NotNull SegmentedByteString segmentedByteString, @NotNull Buffer buffer, int i9, int i10) {
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
        ...
        while (i9 < i11) {
            ...
            int min = Math.min(i11, (segmentedByteString.getDirectory$okio()[segment] - i12) + i12) - i9;
            int i14 = i13 + (i9 - i12);
    ...
    public static final void forEachSegment(@NotNull SegmentedByteString segmentedByteString, @NotNull Function3<? super byte[], ? super Integer, ? super Integer, Unit> action) {
        ...
        int i10 = 0;
        while (i9 < length) {
            int i11 = segmentedByteString.getDirectory$okio()[length + i9];
            int i12 = segmentedByteString.getDirectory$okio()[i9];
            action.invoke(segmentedByteString.getSegments$okio()[i9], Integer.valueOf(i11), Integer.valueOf(i12 - i10));
            i9++;
            i10 = i12;
        }
    }

    public static final int segment(@NotNull SegmentedByteString segmentedByteString, int i9) {
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
        int binarySearch = binarySearch(segmentedByteString.getDirectory$okio(), i9 + 1, 0, segmentedByteString.getSegments$okio().length);
        return binarySearch >= 0 ? binarySearch : ~binarySearch;
    }

    private static final void forEachSegment(SegmentedByteString segmentedByteString, int i9, int i10, Function3<? super byte[], ? super Integer, ? super Integer, Unit> function3) {
        int segment = segment(segmentedByteString, i9);
        while (i9 < i10) {
            ...
            int min = Math.min(i10, (segmentedByteString.getDirectory$okio()[segment] - i11) + i11) - i9;
            function3.invoke(segmentedByteString.getSegments$okio()[segment], Integer.valueOf(i12 + (i9 - i11)), Integer.valueOf(min));
            i9 += min;
            segment++;
        }
    }

    public static final boolean commonRangeEquals(@NotNull SegmentedByteString segmentedByteString, int i9, @NotNull byte[] other, int i10, int i11) {
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
        Intrinsics.checkNotNullParameter(other, "other");
        if (i9 < 0 || i9 > segmentedByteString.size() - i11 || i10 < 0 || i10 > other.length - i11) {
            return false;
        }
        int i12 = i11 + i9;
        int segment = segment(segmentedByteString, i9);
        while (i9 < i12) {
            ...
            int i14 = segmentedByteString.getDirectory$okio()[segmentedByteString.getSegments$okio().length + segment];
            int min = Math.min(i12, (segmentedByteString.getDirectory$okio()[segment] - i13) + i13) - i9;
            if (!_UtilKt.arrayRangeEquals(segmentedByteString.getSegments$okio()[segment], i14 + (i9 - i13), other, i10, min)) {
                return false;
            }
            i10 += min;
            i9 += min;
