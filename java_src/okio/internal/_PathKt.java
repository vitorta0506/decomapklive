...
public final class _PathKt {
    ...
    static {
        ...
        SLASH = companion.encodeUtf8(FileUtils.RES_PREFIX_STORAGE);
    ...
    */
    public static final okio.Path commonRelativeTo(@org.jetbrains.annotations.NotNull okio.Path r8, @org.jetbrains.annotations.NotNull okio.Path r9) {
        /*
        ...
        if (rootLength < size) {
            ...
            while (true) {
                ...
                if (path.getBytes$okio().getByte(rootLength) == ((byte) 47) || path.getBytes$okio().getByte(rootLength) == ((byte) 92)) {
                    arrayList.add(path.getBytes$okio().substring(i9, rootLength));
                    i9 = i10;
                }
                if (i10 >= size) {
                    break;
    ...
    public static final ByteString toSlash(String str) {
        if (Intrinsics.areEqual(str, FileUtils.RES_PREFIX_STORAGE)) {
            return SLASH;
        }
