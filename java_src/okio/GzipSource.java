...
public final class GzipSource implements Source {
    ...
    private final void checkEqual(String str, int i9, int i10) {
        if (i10 == i9) {
            return;
        }
