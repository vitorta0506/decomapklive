...
public final class CoroutineId extends AbstractCoroutineContextElement implements ThreadContextElement<String> {
    ...
    public static /* synthetic */ CoroutineId copy$default(CoroutineId coroutineId, long j10, int i9, Object obj) {
        if ((i9 & 1) != 0) {
            j10 = coroutineId.f54031id;
        }
        return coroutineId.copy(j10);
    }

    public final long component1() {
        return this.f54031id;
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return (obj instanceof CoroutineId) && this.f54031id == ((CoroutineId) obj).f54031id;
    }
    ...
    public int hashCode() {
        return b.a(this.f54031id);
    }

    @NotNull
    public String toString() {
        return "CoroutineId(" + this.f54031id + ')';
    }
