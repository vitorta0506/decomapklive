...
public final class CompletableDeferredKt {
    ...
    public static /* synthetic */ CompletableDeferred CompletableDeferred$default(Job job, int i9, Object obj) {
        if ((i9 & 1) != 0) {
            job = null;
        }
    ...
    public static final <T> boolean completeWith(@NotNull CompletableDeferred<T> completableDeferred, @NotNull Object obj) {
        ...
        return m1660exceptionOrNullimpl == null ? completableDeferred.complete(obj) : completableDeferred.completeExceptionally(m1660exceptionOrNullimpl);
    }
