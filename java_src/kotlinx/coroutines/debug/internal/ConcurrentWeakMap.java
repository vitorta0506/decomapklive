...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    public final class Core {
        ...
        public final class KeyValueIterator<E> implements Iterator<E>, KMutableIterator {
            ...
            private final void findNext() {
                ...
                while (true) {
                    int i9 = this.index + 1;
                    this.index = i9;
                    if (i9 >= ((Core) Core.this).allocated) {
                        return;
                    }
                    ...
                    if (hashedWeakRef != null && (k10 = (K) hashedWeakRef.get()) != null) {
                        this.key = k10;
                        V v10 = (V) Core.this.values.get(this.index);
                        if (v10 instanceof Marked) {
                            v10 = (V) ((Marked) v10).ref;
                        }
                        if (v10 != null) {
                            this.value = v10;
                            return;
            ...
            public E next() {
                if (this.index < ((Core) Core.this).allocated) {
                    ...
                    E mo1invoke = function2.mo1invoke(k10, v10);
                    findNext();
                    return mo1invoke;
                }
        ...
        public Core(int i9) {
            this.allocated = i9;
            this.shift = Integer.numberOfLeadingZeros(i9) + 1;
            this.threshold = (i9 * 2) / 3;
            this.keys = new AtomicReferenceArray(i9);
            this.values = new AtomicReferenceArray(i9);
        }

        private final int index(int i9) {
            return (i9 * (-1640531527)) >>> this.shift;
        }

        /* JADX WARN: Multi-variable type inference failed */
        public static /* synthetic */ Object putImpl$default(Core core, Object obj, Object obj2, HashedWeakRef hashedWeakRef, int i9, Object obj3) {
            if ((i9 & 4) != 0) {
                hashedWeakRef = null;
            }
        ...
        private final void removeCleanedAt(int i9) {
            Object obj;
            do {
                obj = this.values.get(i9);
                if (obj == null || (obj instanceof Marked)) {
                    return;
                }
            } while (!this.values.compareAndSet(i9, obj, null));
        ...
        @Nullable
        public final V getImpl(@NotNull K k10) {
            int index = index(k10.hashCode());
            while (true) {
        ...
        */
        ...
        public final ConcurrentWeakMap<K, V>.Core rehash() {
            ...
            while (true) {
                ...
                int i9 = this.allocated;
                for (int i10 = 0; i10 < i9; i10++) {
                    HashedWeakRef hashedWeakRef = (HashedWeakRef) this.keys.get(i10);
                    Object obj2 = hashedWeakRef != null ? hashedWeakRef.get() : null;
                    if (hashedWeakRef != null && obj2 == null) {
                        removeCleanedAt(i10);
                    }
                    while (true) {
                        obj = this.values.get(i10);
    ...
    public /* synthetic */ ConcurrentWeakMap(boolean z10, int i9, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    private final synchronized V putSynchronized(K k10, V v10) {
        ...
        while (true) {
            v11 = (V) Core.putImpl$default(core, k10, v10, null, 4, null);
            symbol = ConcurrentWeakMapKt.REHASH;
            if (v11 == symbol) {
                core = core.rehash();
                this.core = core;
    ...
    public Set<Map.Entry<K, V>> getEntries() {
        return new KeyValueSet(new Function2<K, V, Map.Entry<K, V>>() { // from class: kotlinx.coroutines.debug.internal.ConcurrentWeakMap$entries$1
            ...
            @NotNull
            /* renamed from: invoke */
            public final Map.Entry<K, V> mo1invoke(@NotNull K k10, @NotNull V v10) {
    ...
    public Set<K> getKeys() {
        return new KeyValueSet(new Function2<K, V, K>() { // from class: kotlinx.coroutines.debug.internal.ConcurrentWeakMap$keys$1
            ...
            @NotNull
            /* renamed from: invoke */
            public final K mo1invoke(@NotNull K k10, @NotNull V v10) {
                return k10;
            }
        });
    }
    ...
    public V put(@NotNull K k10, @NotNull V v10) {
        Symbol symbol;
        V v11 = (V) Core.putImpl$default((Core) this.core, k10, v10, null, 4, null);
        symbol = ConcurrentWeakMapKt.REHASH;
        if (v11 == symbol) {
            v11 = putSynchronized(k10, v10);
        }
        if (v11 == null) {
    ...
    public V remove(@Nullable Object obj) {
        ...
        V v10 = (V) Core.putImpl$default((Core) this.core, obj, null, null, 4, null);
        symbol = ConcurrentWeakMapKt.REHASH;
        if (v10 == symbol) {
            v10 = putSynchronized(obj, null);
        }
        if (v10 != null) {
            _size$FU.decrementAndGet(this);
        }
