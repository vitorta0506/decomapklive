...
public abstract class Segment<S extends Segment<S>> extends ConcurrentLinkedListNode<S> {
    ...
    private final long f54040id;

    public Segment(long j10, @Nullable S s10, int i9) {
        super(s10);
        this.f54040id = j10;
    ...
    public final boolean tryIncPointers$kotlinx_coroutines_core() {
        ...
        do {
            ...
            if (!(i9 != getMaxSlots() || isTail())) {
                return false;
            }
        } while (!cleanedAndPointers$FU.compareAndSet(this, i9, 65536 + i9));
        return true;
    }
}
