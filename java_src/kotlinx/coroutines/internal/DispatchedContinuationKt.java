...
public final class DispatchedContinuationKt {
    ...
    private static final boolean executeUnconfined(DispatchedContinuation<?> dispatchedContinuation, Object obj, int i9, boolean z10, Function0<Unit> function0) {
        ...
        if (eventLoop$kotlinx_coroutines_core.isUnconfinedLoopActive()) {
            ...
            dispatchedContinuation.resumeMode = i9;
    ...
    static /* synthetic */ boolean executeUnconfined$default(DispatchedContinuation dispatchedContinuation, Object obj, int i9, boolean z10, Function0 function0, int i10, Object obj2) {
        if ((i10 & 4) != 0) {
            z10 = false;
        }
        EventLoop eventLoop$kotlinx_coroutines_core = ThreadLocalEventLoop.INSTANCE.getEventLoop$kotlinx_coroutines_core();
    ...
    public static final <T> void resumeCancellableWith(@NotNull Continuation<? super T> continuation, @NotNull Object obj, @Nullable Function1<? super Throwable, Unit> function1) {
        ...
        if (continuation instanceof DispatchedContinuation) {
            ...
            if (dispatchedContinuation.dispatcher.isDispatchNeeded(dispatchedContinuation.getContext())) {
                ...
                dispatchedContinuation.dispatcher.mo3203dispatch(dispatchedContinuation.getContext(), dispatchedContinuation);
                return;
            }
            EventLoop eventLoop$kotlinx_coroutines_core = ThreadLocalEventLoop.INSTANCE.getEventLoop$kotlinx_coroutines_core();
            if (eventLoop$kotlinx_coroutines_core.isUnconfinedLoopActive()) {
            ...
            try {
                ...
                if (job == null || job.isActive()) {
                    ...
                    dispatchedContinuation.resumeWith(Result.m1657constructorimpl(ResultKt.createFailure(cancellationException)));
                    z10 = true;
                }
                if (!z10) {
