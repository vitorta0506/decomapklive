...
public final class SemaphoreKt {
    ...
    @NotNull
    public static final Semaphore Semaphore(int i9, int i10) {
        return new SemaphoreImpl(i9, i10);
    }

    public static /* synthetic */ Semaphore Semaphore$default(int i9, int i10, int i11, Object obj) {
        if ((i11 & 2) != 0) {
            i10 = 0;
        }
        return Semaphore(i9, i10);
    }
