...
public final class HandlerContext extends HandlerDispatcher {
    ...
    public static final void m3152invokeOnTimeout$lambda3(HandlerContext handlerContext, Runnable runnable) {
    ...
    public DisposableHandle invokeOnTimeout(long j10, @NotNull final Runnable runnable, @NotNull CoroutineContext coroutineContext) {
        ...
        coerceAtMost = RangesKt___RangesKt.coerceAtMost(j10, (long) DurationKt.MAX_MILLIS);
        if (handler.postDelayed(runnable, coerceAtMost)) {
            return new DisposableHandle() { // from class: kotlinx.coroutines.android.a
                @Override // kotlinx.coroutines.DisposableHandle
                public final void dispose() {
                    HandlerContext.m3152invokeOnTimeout$lambda3(HandlerContext.this, runnable);
                }
            };
        }
        cancelOnRejection(coroutineContext, runnable);
    ...
    public void mo3204scheduleResumeAfterDelay(long j10, @NotNull final CancellableContinuation<? super Unit> cancellableContinuation) {
        long coerceAtMost;
