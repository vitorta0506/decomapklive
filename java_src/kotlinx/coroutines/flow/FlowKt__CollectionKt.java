...
public final /* synthetic */ class FlowKt__CollectionKt {
    ...
    */
    ...
    public static /* synthetic */ Object toList$default(Flow flow, List list, Continuation continuation, int i9, Object obj) {
        if ((i9 & 1) != 0) {
            list = new ArrayList();
        }
    ...
    public static /* synthetic */ Object toSet$default(Flow flow, Set set, Continuation continuation, int i9, Object obj) {
        if ((i9 & 1) != 0) {
