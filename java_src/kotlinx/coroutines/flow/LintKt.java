...
public final class LintKt {
    ...
    private static final <T> Flow<T> m3188catch(SharedFlow<? extends T> sharedFlow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt.m3180catch(sharedFlow, function3);
    }
    ...
    static /* synthetic */ Flow retry$default(SharedFlow sharedFlow, long j10, Function2 function2, int i9, Object obj) {
        if ((i9 & 1) != 0) {
            j10 = Long.MAX_VALUE;
        }
        if ((i9 & 2) != 0) {
