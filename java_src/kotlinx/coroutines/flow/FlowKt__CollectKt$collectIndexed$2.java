...
public final class FlowKt__CollectKt$collectIndexed$2<T> implements FlowCollector<T> {
    ...
    public Object emit(T t10, @NotNull Continuation<? super Unit> continuation) {
        ...
        this.index = i9 + 1;
        if (i9 >= 0) {
            Object invoke = function3.invoke(Boxing.boxInt(i9), t10, continuation);
    ...
    @Nullable
    public Object emit$$forInline(T t10, @NotNull final Continuation<? super Unit> continuation) {
        InlineMarker.mark(4);
        ...
        this.index = i9 + 1;
        if (i9 >= 0) {
            function3.invoke(Integer.valueOf(i9), t10, continuation);
