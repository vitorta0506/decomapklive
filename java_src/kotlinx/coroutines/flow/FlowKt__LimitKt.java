...
public final /* synthetic */ class FlowKt__LimitKt {
    ...
    */
    ...
    @NotNull
    public static final <T> Flow<T> drop(@NotNull final Flow<? extends T> flow, final int i9) {
        if (i9 >= 0) {
            return new Flow<T>() { // from class: kotlinx.coroutines.flow.FlowKt__LimitKt$drop$$inlined$unsafeFlow$1
                ...
                public Object collect(@NotNull FlowCollector<? super T> flowCollector, @NotNull Continuation<? super Unit> continuation) {
                    ...
                    Object collect = Flow.this.collect(new FlowKt__LimitKt$drop$2$1(new Ref.IntRef(), i9, flowCollector), continuation);
    ...
    */
    ...
    public static final <T> Flow<T> take(@NotNull Flow<? extends T> flow, int i9) {
        if (i9 > 0) {
            return new FlowKt__LimitKt$take$$inlined$unsafeFlow$1(flow, i9);
        }
        throw new IllegalArgumentException(("Requested element count " + i9 + " should be positive").toString());
    }
