...
public final class FlowKt__MergeKt$flatMapLatest$1<R, T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
    ...
    @Nullable
    public final Object invoke(@NotNull FlowCollector<? super R> flowCollector, T t10, @Nullable Continuation<? super Unit> continuation) {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i9 == 0) {
            ...
            this.label = 1;
            obj = this.$transform.mo1invoke(obj2, this);
    ...
    public final Object invokeSuspend$$forInline(@NotNull Object obj) {
        Object obj2 = this.L$1;
        InlineMarker.mark(0);
        FlowKt.emitAll((FlowCollector) this.L$0, (Flow) this.$transform.mo1invoke(obj2, this), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
