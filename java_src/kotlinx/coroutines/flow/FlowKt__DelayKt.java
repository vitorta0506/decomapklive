...
public final /* synthetic */ class FlowKt__DelayKt {
    ...
    @FlowPreview
    @NotNull
    public static final <T> Flow<T> debounce(@NotNull Flow<? extends T> flow, final long j10) {
        int i9 = (j10 > 0L ? 1 : (j10 == 0L ? 0 : -1));
        if (i9 >= 0) {
            return i9 == 0 ? flow : debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt$debounce$2
    ...
    public static final <T> Flow<T> m3183debounceHG0u8IE(@NotNull Flow<? extends T> flow, long j10) {
        return FlowKt.debounce(flow, DelayKt.m3142toDelayMillisLRDsOJo(j10));
    }
    ...
    public static final <T> Flow<T> debounceDuration(@NotNull Flow<? extends T> flow, @NotNull final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt$debounce$3
            ...
            @NotNull
            public final Long invoke(T t10) {
                return Long.valueOf(DelayKt.m3142toDelayMillisLRDsOJo(function1.invoke(t10).m3037unboximpl()));
            }
        });
    }
    ...
    public static /* synthetic */ ReceiveChannel fixedPeriodTicker$default(CoroutineScope coroutineScope, long j10, long j11, int i9, Object obj) {
        if ((i9 & 2) != 0) {
            j11 = j10;
        }
    ...
    public static final <T> Flow<T> m3184sampleHG0u8IE(@NotNull Flow<? extends T> flow, long j10) {
        return FlowKt.sample(flow, DelayKt.m3142toDelayMillisLRDsOJo(j10));
    }
