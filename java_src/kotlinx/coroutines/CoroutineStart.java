...
public enum CoroutineStart {
    ...
    public final <R, T> void invoke(@NotNull Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r10, @NotNull Continuation<? super T> continuation) {
        int i9 = WhenMappings.$EnumSwitchMapping$0[ordinal()];
        if (i9 == 1) {
            CancellableKt.startCoroutineCancellable$default(function2, r10, continuation, null, 4, null);
        } else if (i9 == 2) {
            ContinuationKt.startCoroutine(function2, r10, continuation);
        } else if (i9 == 3) {
            UndispatchedKt.startCoroutineUndispatched(function2, r10, continuation);
        } else if (i9 != 4) {
            throw new NoWhenBranchMatchedException();
        }
    }
