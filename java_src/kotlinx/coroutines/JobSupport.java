...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    @Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\b\u0002\u0018\u00002\u00020\u0001B'\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007\u0012\b\u0010\b\u001a\u0004\u0018\u00010\t¢\u0006\u0002\u0010\nJ\u0013\u0010\u000b\u001a\u00020\f2\b\u0010\r\u001a\u0004\u0018\u00010\u000eH\u0096\u0002R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\b\u001a\u0004\u0018\u00010\tX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000f"}, d2 = {"Lkotlinx/coroutines/JobSupport$ChildCompletion;", "Lkotlinx/coroutines/JobNode;", "parent", "Lkotlinx/coroutines/JobSupport;", ServerProtocol.DIALOG_PARAM_STATE, "Lkotlinx/coroutines/JobSupport$Finishing;", "child", "Lkotlinx/coroutines/ChildHandleNode;", "proposedUpdate", "", "(Lkotlinx/coroutines/JobSupport;Lkotlinx/coroutines/JobSupport$Finishing;Lkotlinx/coroutines/ChildHandleNode;Ljava/lang/Object;)V", "invoke", "", "cause", "", "kotlinx-coroutines-core"}, k = 1, mv = {1, 6, 0}, xi = 48)
    /* loaded from: classes7.dex */
    ...
    public static /* synthetic */ JobCancellationException defaultCancellationException$kotlinx_coroutines_core$default(JobSupport jobSupport, String str, Throwable th2, int i9, Object obj) {
        if (obj == null) {
            if ((i9 & 1) != 0) {
                str = null;
            }
    ...
    private final JobNode makeNode(Function1<? super Throwable, Unit> function1, boolean z10) {
        JobNode jobNode;
        if (z10) {
    ...
    private final void promoteSingleToNodeList(JobNode jobNode) {
        ...
        androidx.concurrent.futures.a.a(_state$FU, this, jobNode, jobNode.getNextNode());
    }
    ...
    private final int startInternal(Object obj) {
        ...
        if (obj instanceof Empty) {
            ...
            if (androidx.concurrent.futures.a.a(_state$FU, this, obj, ((InactiveNodeList) obj).getList())) {
                onStart();
                return 1;
            }
            return -1;
    ...
    public static /* synthetic */ CancellationException toCancellationException$default(JobSupport jobSupport, Throwable th2, String str, int i9, Object obj) {
        if (obj == null) {
            if ((i9 & 1) != 0) {
                str = null;
            }
    ...
    private final boolean tryMakeCancelling(Incomplete incomplete, Throwable th2) {
        ...
        if (androidx.concurrent.futures.a.a(_state$FU, this, incomplete, new Finishing(orPromoteCancellingList, false, th2))) {
    ...
    public final void removeNode$kotlinx_coroutines_core(@NotNull JobNode jobNode) {
        ...
        } while (!androidx.concurrent.futures.a.a(atomicReferenceFieldUpdater, this, state$kotlinx_coroutines_core, empty));
    }
    ...
    @NotNull
    protected final CancellationException toCancellationException(@NotNull Throwable th2, @Nullable String str) {
    ...
    @Override // kotlinx.coroutines.Job
    @NotNull
    public final DisposableHandle invokeOnCompletion(boolean z10, boolean z11, @NotNull Function1<? super Throwable, Unit> function1) {
        JobNode makeNode = makeNode(function1, z10);
        while (true) {
            Object state$kotlinx_coroutines_core = getState$kotlinx_coroutines_core();
            if (state$kotlinx_coroutines_core instanceof Empty) {
                Empty empty = (Empty) state$kotlinx_coroutines_core;
                if (empty.isActive()) {
                    if (androidx.concurrent.futures.a.a(_state$FU, this, state$kotlinx_coroutines_core, makeNode)) {
                        return makeNode;
                    }
                } else {
                ...
                if (state$kotlinx_coroutines_core instanceof Incomplete) {
                    ...
                    if (list == null) {
                        ...
                        if (z10 && (state$kotlinx_coroutines_core instanceof Finishing)) {
                            synchronized (state$kotlinx_coroutines_core) {
