    ...
    public Object offerSelectInternal(E e10, @NotNull SelectInstance<?> selectInstance) {
        ...
        while (true) {
            if (getHasReceiveOrClosed()) {
                performAtomicTrySelect = super.offerSelectInternal(e10, selectInstance);
            } else {
                performAtomicTrySelect = selectInstance.performAtomicTrySelect(describeSendBuffered(e10));
