...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object mo1invoke(Object obj, Object obj2) {
        return m3178invokeWpGqRn0(((ChannelResult) obj).m3174unboximpl(), (Continuation) obj2);
    }

    @Nullable
    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m3178invokeWpGqRn0(@NotNull Object obj, @Nullable Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m3162boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i9 == 0) {
            ...
            Object m3174unboximpl = ((ChannelResult) this.L$0).m3174unboximpl();
            Throwable m3166exceptionOrNullimpl = ChannelResult.m3166exceptionOrNullimpl(m3174unboximpl);
            if (m3166exceptionOrNullimpl == null) {
                Object m3167getOrNullimpl = ChannelResult.m3167getOrNullimpl(m3174unboximpl);
                this.label = 1;
                obj = this.$block.mo1invoke(m3167getOrNullimpl, this);
