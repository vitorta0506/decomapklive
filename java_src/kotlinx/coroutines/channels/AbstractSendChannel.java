...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (!receive.mo3202remove()) {
                receive.helpRemove();
            } else {
                m3194constructorimpl$default = InlineList.m3199plusFjFbRPM(m3194constructorimpl$default, receive);
            }
        }
        if (m3194constructorimpl$default != null) {
            if (!(m3194constructorimpl$default instanceof ArrayList)) {
                ((Receive) m3194constructorimpl$default).resumeReceiveClosed(closed);
            } else {
                ArrayList arrayList = (ArrayList) m3194constructorimpl$default;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e10, Closed<?> closed) {
        ...
        if (function1 != null && (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e10, null, 2, null)) != null) {
            ...
            continuation.resumeWith(Result.m1657constructorimpl(ResultKt.createFailure(callUndeliveredElementCatchingException$default)));
            return;
        }
        Result.Companion companion2 = Result.Companion;
        continuation.resumeWith(Result.m1657constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    public final <R> void registerSelectSend(SelectInstance<? super R> selectInstance, E e10, Function2<? super SendChannel<? super E>, ? super Continuation<? super R>, ? extends Object> function2) {
        while (!selectInstance.isSelected()) {
            if (isFullImpl()) {
                SendSelect sendSelect = new SendSelect(e10, this, selectInstance, function2);
                ...
                if (enqueueSend == null) {
                    ...
                    throw StackTraceRecoveryKt.recoverStackTrace(helpCloseAndGetSendException(e10, (Closed) enqueueSend));
                }
            }
            Object offerSelectInternal = offerSelectInternal(e10, selectInstance);
            ...
            if (offerSelectInternal != AbstractChannelKt.OFFER_FAILED && offerSelectInternal != AtomicKt.RETRY_ATOMIC) {
                if (offerSelectInternal == AbstractChannelKt.OFFER_SUCCESS) {
                    ...
                    throw StackTraceRecoveryKt.recoverStackTrace(helpCloseAndGetSendException(e10, (Closed) offerSelectInternal));
                } else {
        ...
        while (true) {
            if (isFullImpl()) {
                if (this.onUndeliveredElement == null) {
                    sendElementWithUndeliveredHandler = new SendElement(e10, orCreateCancellableContinuation);
                } else {
                    sendElementWithUndeliveredHandler = new SendElementWithUndeliveredHandler(e10, orCreateCancellableContinuation, this.onUndeliveredElement);
                }
                ...
                if (enqueueSend == null) {
                    ...
                    helpCloseAndResumeWithSendException(orCreateCancellableContinuation, e10, (Closed) enqueueSend);
                    break;
            ...
            if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
                Result.Companion companion = Result.Companion;
                orCreateCancellableContinuation.resumeWith(Result.m1657constructorimpl(Unit.INSTANCE));
                break;
            } else if (offerInternal != AbstractChannelKt.OFFER_FAILED) {
                if (offerInternal instanceof Closed) {
                    helpCloseAndResumeWithSendException(orCreateCancellableContinuation, e10, (Closed) offerInternal);
                } else {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @NotNull
    public final LockFreeLinkedListNode.AddLastDesc<?> describeSendBuffered(E e10) {
        return new SendBufferedDesc(this.queue, e10);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @NotNull
    public final TryOfferDesc<E> describeTryOffer(E e10) {
        return new TryOfferDesc<>(e10, this.queue);
    }
    ...
    public void invokeOnClose(@NotNull Function1<? super Throwable, Unit> function1) {
        ...
        if (closedForSend == null || !a.a(atomicReferenceFieldUpdater, this, function1, AbstractChannelKt.HANDLER_INVOKED)) {
            return;
        }
    ...
    public Object offerSelectInternal(E e10, @NotNull SelectInstance<?> selectInstance) {
        TryOfferDesc<E> describeTryOffer = describeTryOffer(e10);
    ...
    public final Object send(E e10, @NotNull Continuation<? super Unit> continuation) {
        Object coroutine_suspended;
        if (offerInternal(e10) == AbstractChannelKt.OFFER_SUCCESS) {
    ...
    public final Object mo3157trySendJP2dKIU(E e10) {
        Object offerInternal = offerInternal(e10);
        if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
        ...
        if (offerInternal == AbstractChannelKt.OFFER_FAILED) {
            Closed<?> closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.Companion.m3176failurePtdJZtk() : ChannelResult.Companion.m3175closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        } else if (offerInternal instanceof Closed) {
            return ChannelResult.Companion.m3175closedJP2dKIU(helpCloseAndGetSendException((Closed) offerInternal));
        } else {
            throw new IllegalStateException(("trySend returned " + offerInternal).toString());
        }
    }

    private final Throwable helpCloseAndGetSendException(E e10, Closed<?> closed) {
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        helpClose(closed);
        Function1<E, Unit> function1 = this.onUndeliveredElement;
        if (function1 != null && (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e10, null, 2, null)) != null) {
