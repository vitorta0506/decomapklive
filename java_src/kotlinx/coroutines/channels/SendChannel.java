...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        public static /* synthetic */ boolean close$default(SendChannel sendChannel, Throwable th2, int i9, Object obj) {
            if (obj == null) {
                if ((i9 & 1) != 0) {
                    th2 = null;
                }
        ...
        public static <E> boolean offer(@NotNull SendChannel<? super E> sendChannel, E e10) {
            ...
            if (ChannelResult.m3172isSuccessimpl(mo3157trySendJP2dKIU)) {
                return true;
            }
            Throwable m3166exceptionOrNullimpl = ChannelResult.m3166exceptionOrNullimpl(mo3157trySendJP2dKIU);
    ...
    Object mo3157trySendJP2dKIU(E e10);
}
