...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> void sendBlocking(@NotNull SendChannel<? super E> sendChannel, E e10) {
        if (ChannelResult.m3172isSuccessimpl(sendChannel.mo3157trySendJP2dKIU(e10))) {
            return;
        }
        BuildersKt__BuildersKt.runBlocking$default(null, new ChannelsKt__ChannelsKt$sendBlocking$1(sendChannel, e10, null), 1, null);
    }
    ...
    public static final <E> Object trySendBlocking(@NotNull SendChannel<? super E> sendChannel, E e10) {
        ...
        Object mo3157trySendJP2dKIU = sendChannel.mo3157trySendJP2dKIU(e10);
        if (!(mo3157trySendJP2dKIU instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) mo3157trySendJP2dKIU;
            return ChannelResult.Companion.m3177successJP2dKIU(Unit.INSTANCE);
        }
        ...
        return ((ChannelResult) runBlocking$default).m3174unboximpl();
    }
}
