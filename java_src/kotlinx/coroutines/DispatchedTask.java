    ...
    public final void run() {
        ...
        try {
            ...
            if (job != null && !job.isActive()) {
                ...
                continuation.resumeWith(Result.m1657constructorimpl(ResultKt.createFailure(cancellationException)));
            } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                Result.Companion companion2 = Result.Companion;
                continuation.resumeWith(Result.m1657constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
            } else {
                Result.Companion companion3 = Result.Companion;
                continuation.resumeWith(Result.m1657constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core)));
            }
            ...
            try {
                ...
                m1657constructorimpl2 = Result.m1657constructorimpl(unit);
            } catch (Throwable th2) {
                Result.Companion companion5 = Result.Companion;
                m1657constructorimpl2 = Result.m1657constructorimpl(ResultKt.createFailure(th2));
            }
            handleFatalException(null, Result.m1660exceptionOrNullimpl(m1657constructorimpl2));
        } catch (Throwable th3) {
            try {
                Result.Companion companion6 = Result.Companion;
                taskContext.afterTask();
                m1657constructorimpl = Result.m1657constructorimpl(Unit.INSTANCE);
            } catch (Throwable th4) {
                Result.Companion companion7 = Result.Companion;
                m1657constructorimpl = Result.m1657constructorimpl(ResultKt.createFailure(th4));
            }
            handleFatalException(th3, Result.m1660exceptionOrNullimpl(m1657constructorimpl));
        }
    }
