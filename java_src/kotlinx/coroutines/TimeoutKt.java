...
public final class TimeoutKt {
    @NotNull
    public static final TimeoutCancellationException TimeoutCancellationException(long j10, @NotNull Job job) {
    ...
    public static final <T> Object m3150withTimeoutKLykuaI(long j10, @NotNull Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, @NotNull Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m3142toDelayMillisLRDsOJo(j10), function2, continuation);
    }
    ...
    */
    ...
    public static final <T> Object m3151withTimeoutOrNullKLykuaI(long j10, @NotNull Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, @NotNull Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m3142toDelayMillisLRDsOJo(j10), function2, continuation);
    }
}
