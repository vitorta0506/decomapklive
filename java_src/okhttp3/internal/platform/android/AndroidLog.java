...
public final class AndroidLog {
    ...
    public final void androidLog$okhttp(@NotNull String loggerName, int i9, @NotNull String message, @Nullable Throwable th2) {
        int indexOf$default;
        int min;
        Intrinsics.checkNotNullParameter(loggerName, "loggerName");
        Intrinsics.checkNotNullParameter(message, "message");
        String loggerTag = loggerTag(loggerName);
        if (Log.isLoggable(loggerTag, i9)) {
            if (th2 != null) {
            ...
            while (i10 < length) {
                ...
                while (true) {
                    ...
                    Log.println(i9, loggerTag, substring);
