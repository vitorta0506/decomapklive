    ...
    private final List<String> getSubjectAltNames(X509Certificate x509Certificate, int i9) {
        ...
        try {
            ...
            for (List<?> list : subjectAlternativeNames) {
                if (list != null && list.size() >= 2 && Intrinsics.areEqual(list.get(0), Integer.valueOf(i9)) && (obj = list.get(1)) != null) {
                    ...
                    if (!(str2 == null || str2.length() == 0)) {
                        ...
                        if (!startsWith$default2) {
                            ...
                            if (!endsWith$default2) {
                                ...
                                contains$default = StringsKt__StringsKt.contains$default((CharSequence) asciiToLowercase, (CharSequence) ProxyConfig.MATCH_ALL_SCHEMES, false, 2, (Object) null);
                                if (!contains$default) {
