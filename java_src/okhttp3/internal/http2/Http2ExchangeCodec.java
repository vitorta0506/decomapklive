    ...
    public static final class Companion {
        ...
        public final List<Header> http2HeadersList(@NotNull Request request) {
            ...
            while (i9 < size) {
                ...
                if (!Http2ExchangeCodec.HTTP_2_SKIPPED_REQUEST_HEADERS.contains(lowerCase) || (Intrinsics.areEqual(lowerCase, Http2ExchangeCodec.TE) && Intrinsics.areEqual(headers.value(i9), "trailers"))) {
