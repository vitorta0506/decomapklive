...
public final class Huffman {
    ...
    public final void decode(@NotNull BufferedSource source, long j10, @NotNull BufferedSink sink) {
        ...
        while (j11 < j10) {
            j11++;
            i9 = (i9 << 8) | Util.and(source.readByte(), 255);
            i10 += 8;
            while (i10 >= 8) {
                Node[] children = node.getChildren();
                Intrinsics.checkNotNull(children);
                node = children[(i9 >>> (i10 - 8)) & 255];
        ...
        while (i10 > 0) {
            ...
            Intrinsics.checkNotNull(children2);
            Node node2 = children2[(i9 << (8 - i10)) & 255];
    ...
    public final void encode(@NotNull ByteString source, @NotNull BufferedSink sink) throws IOException {
        ...
        while (i9 < size) {
            int i11 = i9 + 1;
            int and = Util.and(source.getByte(i9), 255);
            int i12 = CODES[and];
    ...
    public final int encodedLength(@NotNull ByteString bytes) {
        ...
        while (i9 < size) {
            int i10 = i9 + 1;
            j10 += CODE_BIT_COUNTS[Util.and(bytes.getByte(i9), 255)];
            i9 = i10;
        }
        return (int) ((j10 + 7) >> 3);
    }
