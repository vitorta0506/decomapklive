...
public final class TaskQueue {
    ...
    public static /* synthetic */ void execute$default(TaskQueue taskQueue, String name, long j10, boolean z10, Function0 block, int i9, Object obj) {
        if ((i9 & 2) != 0) {
            j10 = 0;
        }
        if ((i9 & 4) != 0) {
    ...
    public static /* synthetic */ void schedule$default(TaskQueue taskQueue, Task task, long j10, int i9, Object obj) {
        if ((i9 & 2) != 0) {
            j10 = 0;
        }
    ...
    public final boolean scheduleAndDecide$okhttp(@NotNull Task task, long j10, boolean z10) {
        ...
        if (TaskRunner.Companion.getLogger().isLoggable(Level.FINE)) {
            if (z10) {
                stringPlus = Intrinsics.stringPlus("run again after ", TaskLoggerKt.formatDuration(j11 - nanoTime));
            } else {
                stringPlus = Intrinsics.stringPlus("scheduled after ", TaskLoggerKt.formatDuration(j11 - nanoTime));
            }
    ...
    public static /* synthetic */ void schedule$default(TaskQueue taskQueue, String name, long j10, Function0 block, int i9, Object obj) {
        if ((i9 & 2) != 0) {
            j10 = 0;
        }
        Intrinsics.checkNotNullParameter(name, "name");
