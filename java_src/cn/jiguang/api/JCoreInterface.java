...
public class JCoreInterface {
    ...
    public static void processCtrlReport(int i9) {
        JCoreManager.onEvent(null, null, 24, null, null, Integer.valueOf(i9));
    }
    ...
    private static void send(Context context, String str, int i9, byte[] bArr, int i10, boolean z10) {
        if (bArr != null) {
            try {
                if (bArr.length > 24) {
    ...
    public static void sendAction(Context context, String str, Bundle bundle) {
        if (bundle != null) {
            try {
                JCoreManager.onEvent(context, str, 3, bundle.getString(NativeProtocol.WEB_DIALOG_ACTION), bundle, new Object[0]);
            } catch (Throwable th2) {
    ...
    public static void sendData(Context context, String str, int i9, byte[] bArr) {
        send(context, str, i9, bArr, 0, false);
    }

    public static void sendRequestData(Context context, String str, int i9, byte[] bArr) {
        send(context, str, 0, bArr, i9, true);
    }
    ...
    public static void setTestConnIPPort(String str, int i9) {
        d.b(TAG, "Action - setTestConnIPPort ip:" + str + " port:" + i9);
    }
    ...
    public static Bundle si(Context context, int i9, Bundle bundle) {
        if (context != null) {
            mApplicationContext = context.getApplicationContext();
        }
        return b.a(context, i9, bundle);
    }
    ...
    public static void triggerSceneCheck(Context context, int i9) {
        JCoreManager.onEvent(context, null, 29, null, null, Integer.valueOf(i9));
    }
}
