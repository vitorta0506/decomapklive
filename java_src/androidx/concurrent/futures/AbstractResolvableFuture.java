...
public abstract class AbstractResolvableFuture<V> implements d0<V> {
    ...
    public static final class SetFuture<V> implements Runnable {
        final d0<? extends V> future;
        final AbstractResolvableFuture<V> owner;

        SetFuture(AbstractResolvableFuture<V> abstractResolvableFuture, d0<? extends V> d0Var) {
    ...
    static Object getFutureValue(d0<?> d0Var) {
        if (d0Var instanceof AbstractResolvableFuture) {
            Object obj = ((AbstractResolvableFuture) d0Var).value;
            if (obj instanceof Cancellation) {
        ...
        try {
            Object uninterruptibly = getUninterruptibly(d0Var);
            return uninterruptibly == null ? NULL : uninterruptibly;
        } catch (CancellationException e10) {
            if (!isCancelled) {
                return new Failure(new IllegalArgumentException("get() threw CancellationException, despite reporting isCancelled() == false: " + d0Var, e10));
            }
    ...
    public final boolean cancel(boolean z10) {
        ...
        while (true) {
            if (ATOMIC_HELPER.casValue(abstractResolvableFuture, obj, cancellation)) {
                ...
                d0<? extends V> d0Var = ((SetFuture) obj).future;
                if (d0Var instanceof AbstractResolvableFuture) {
                    abstractResolvableFuture = (AbstractResolvableFuture) d0Var;
    ...
    public boolean setFuture(d0<? extends V> d0Var) {
        ...
        if (obj == null) {
            if (d0Var.isDone()) {
                if (ATOMIC_HELPER.casValue(this, null, getFutureValue(d0Var))) {
                    complete(this);
                    return true;
                }
                return false;
            }
            SetFuture setFuture = new SetFuture(this, d0Var);
            if (ATOMIC_HELPER.casValue(this, null, setFuture)) {
                try {
                    d0Var.addListener(setFuture, DirectExecutor.INSTANCE);
                } catch (Throwable th2) {
                    try {
        ...
        if (obj instanceof Cancellation) {
            d0Var.cancel(((Cancellation) obj).wasInterrupted);
        }
        return false;
    }
