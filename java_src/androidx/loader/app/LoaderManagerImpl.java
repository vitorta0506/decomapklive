...
public class LoaderManagerImpl extends LoaderManager {
    ...
    public static class LoaderInfo<D> extends MutableLiveData<D> implements Loader.OnLoadCompleteListener<D> {
        ...
        LoaderInfo(int i9, @Nullable Bundle bundle, @NonNull Loader<D> loader, @Nullable Loader<D> loader2) {
            this.mId = i9;
            this.mArgs = bundle;
            this.mLoader = loader;
    ...
    public static class LoaderViewModel extends ViewModel {
        ...
        public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
            if (this.mLoaders.size() > 0) {
                ...
                String str2 = str + "    ";
                for (int i9 = 0; i9 < this.mLoaders.size(); i9++) {
                    LoaderInfo valueAt = this.mLoaders.valueAt(i9);
                    printWriter.print(str);
                    printWriter.print("  #");
                    printWriter.print(this.mLoaders.keyAt(i9));
                    printWriter.print(": ");
        ...
        <D> LoaderInfo<D> getLoader(int i9) {
            return this.mLoaders.get(i9);
        }

        boolean hasRunningLoaders() {
            int size = this.mLoaders.size();
            for (int i9 = 0; i9 < size; i9++) {
                if (this.mLoaders.valueAt(i9).isCallbackWaitingForData()) {
                    return true;
                }
            }
            return false;
        ...
        void markForRedelivery() {
            int size = this.mLoaders.size();
            for (int i9 = 0; i9 < size; i9++) {
                this.mLoaders.valueAt(i9).markForRedelivery();
            }
        }
        ...
        public void onCleared() {
            ...
            int size = this.mLoaders.size();
            for (int i9 = 0; i9 < size; i9++) {
                this.mLoaders.valueAt(i9).destroy(true);
            }
            this.mLoaders.clear();
        }

        void putLoader(int i9, @NonNull LoaderInfo loaderInfo) {
            this.mLoaders.put(i9, loaderInfo);
        }

        void removeLoader(int i9) {
            this.mLoaders.remove(i9);
        }
    ...
    @NonNull
    @MainThread
    private <D> Loader<D> createAndInstallLoader(int i9, @Nullable Bundle bundle, @NonNull LoaderManager.LoaderCallbacks<D> loaderCallbacks, @Nullable Loader<D> loader) {
        try {
            ...
            if (onCreateLoader != null) {
                ...
                this.mLoaderViewModel.putLoader(i9, loaderInfo);
    ...
    public void destroyLoader(int i9) {
        if (!this.mLoaderViewModel.isCreatingLoader()) {
            if (Looper.getMainLooper() == Looper.myLooper()) {
                if (DEBUG) {
                    Log.v(TAG, "destroyLoader in " + this + " of " + i9);
                }
                LoaderInfo loader = this.mLoaderViewModel.getLoader(i9);
                if (loader != null) {
                    loader.destroy(true);
                    this.mLoaderViewModel.removeLoader(i9);
                    return;
                }
                return;
            }
    ...
    public <D> Loader<D> getLoader(int i9) {
        if (!this.mLoaderViewModel.isCreatingLoader()) {
            LoaderInfo<D> loader = this.mLoaderViewModel.getLoader(i9);
            if (loader != null) {
    ...
    public <D> Loader<D> initLoader(int i9, @Nullable Bundle bundle, @NonNull LoaderManager.LoaderCallbacks<D> loaderCallbacks) {
        if (!this.mLoaderViewModel.isCreatingLoader()) {
            if (Looper.getMainLooper() == Looper.myLooper()) {
                ...
                if (loader == null) {
                    return createAndInstallLoader(i9, bundle, loaderCallbacks, null);
                }
                if (DEBUG) {
    ...
    public <D> Loader<D> restartLoader(int i9, @Nullable Bundle bundle, @NonNull LoaderManager.LoaderCallbacks<D> loaderCallbacks) {
        if (!this.mLoaderViewModel.isCreatingLoader()) {
            if (Looper.getMainLooper() == Looper.myLooper()) {
                ...
                LoaderInfo<D> loader = this.mLoaderViewModel.getLoader(i9);
                return createAndInstallLoader(i9, bundle, loaderCallbacks, loader != null ? loader.destroy(false) : null);
            }
