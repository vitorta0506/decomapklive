...
public interface SupportSQLiteOpenHelper extends Closeable {
    ...
    public static abstract class Callback {
        ...
        public void onDowngrade(@NonNull SupportSQLiteDatabase supportSQLiteDatabase, int i9, int i10) {
        ...
        public abstract void onUpgrade(@NonNull SupportSQLiteDatabase supportSQLiteDatabase, int i9, int i10);
    }
    ...
    public static class Configuration {
        ...
        Configuration(@NonNull Context context, @Nullable String str, @NonNull Callback callback, boolean z10) {
