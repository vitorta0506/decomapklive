...
public interface IMultiInstanceInvalidationService extends IInterface {
    ...
    public static class Default implements IMultiInstanceInvalidationService {
        ...
        public void broadcastInvalidation(int i9, String[] strArr) throws RemoteException {
        }
        ...
        @Override // androidx.room.IMultiInstanceInvalidationService
        public void unregisterCallback(IMultiInstanceInvalidationCallback iMultiInstanceInvalidationCallback, int i9) throws RemoteException {
        }
    }
        ...
        public static class Proxy implements IMultiInstanceInvalidationService {
            ...
            public void broadcastInvalidation(int i9, String[] strArr) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().broadcastInvalidation(i9, strArr);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void unregisterCallback(IMultiInstanceInvalidationCallback iMultiInstanceInvalidationCallback, int i9) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(2, obtain, obtain2, 0) && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().unregisterCallback(iMultiInstanceInvalidationCallback, i9);
                    } else {
                        obtain2.readException();
                    }
                } finally {
    ...
    void unregisterCallback(IMultiInstanceInvalidationCallback iMultiInstanceInvalidationCallback, int i9) throws RemoteException;
}
