...
public final class TableInfo {
    ...
    public static final class Column {
        ...
        @Deprecated
        public Column(String str, String str2, boolean z10, int i9) {
            this(str, str2, z10, i9, null, 0);
        }
                ...
                if (this.primaryKeyPosition == column.primaryKeyPosition && this.name.equals(column.name) && this.notNull == column.notNull) {
                    if (this.mCreatedFrom != 1 || column.mCreatedFrom != 2 || (str3 = this.defaultValue) == null || defaultValueEquals(str3, column.defaultValue)) {
                        if (this.mCreatedFrom != 2 || column.mCreatedFrom != 1 || (str2 = column.defaultValue) == null || defaultValueEquals(str2, this.defaultValue)) {
                            int i9 = this.mCreatedFrom;
                            return (i9 == 0 || i9 != column.mCreatedFrom || ((str = this.defaultValue) == null ? column.defaultValue == null : defaultValueEquals(str, column.defaultValue))) && this.affinity == column.affinity;
                        }
                        return false;
                    }
                    return false;
        ...
        public Column(String str, String str2, boolean z10, int i9, String str3, int i10) {
            this.name = str;
            this.type = str2;
            this.notNull = z10;
    ...
    public static class ForeignKeyWithSequence implements Comparable<ForeignKeyWithSequence> {
        ...
        public int compareTo(@NonNull ForeignKeyWithSequence foreignKeyWithSequence) {
            int i9 = this.mId - foreignKeyWithSequence.mId;
            return i9 == 0 ? this.mSequence - foreignKeyWithSequence.mSequence : i9;
        }
    }
    ...
    private static Set<Index> readIndices(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            ...
            if (columnIndex != -1 && columnIndex2 != -1 && columnIndex3 != -1) {
                HashSet hashSet = new HashSet();
                while (query.moveToNext()) {
                    if (c.f27627a.equals(query.getString(columnIndex2))) {
                        String string = query.getString(columnIndex);
                        boolean z10 = true;
