...
public abstract class RoomDatabase {
    ...
    public static class Builder<T extends RoomDatabase> {
        ...
        public T build() {
            ...
            if (this.mContext != null) {
                if (this.mDatabaseClass != null) {
                    ...
                    if (j10 > 0) {
                        if (this.mName != null) {
                            autoClosingRoomOpenHelperFactory = new AutoClosingRoomOpenHelperFactory(autoClosingRoomOpenHelperFactory, new AutoCloser(j10, this.mAutoCloseTimeUnit, this.mTransactionExecutor));
                        } else {
        ...
        public Builder<T> fallbackToDestructiveMigrationFrom(int... iArr) {
            ...
            for (int i9 : iArr) {
                this.mMigrationsNotRequiredFrom.add(Integer.valueOf(i9));
            }
            return this;
        }
    ...
    public void init(@NonNull DatabaseConfiguration databaseConfiguration) {
        ...
        while (true) {
            ...
            if (it.hasNext()) {
                ...
                if (i9 >= 0) {
                    this.mAutoMigrationSpecs.put(next, databaseConfiguration.autoMigrationSpecs.get(i9));
                } else {
    ...
    public static class MigrationContainer {
        ...
        private void addMigration(Migration migration) {
            ...
            TreeMap<Integer, Migration> treeMap = this.mMigrations.get(Integer.valueOf(i9));
            if (treeMap == null) {
                treeMap = new TreeMap<>();
                this.mMigrations.put(Integer.valueOf(i9), treeMap);
            }
        ...
        */
        ...
        public List<Migration> findMigrationPath(int i9, int i10) {
            ...
            return findUpMigrationPath(new ArrayList(), i10 > i9, i9, i10);
        }
