...
public class RoomOpenHelper extends SupportSQLiteOpenHelper.Callback {
    ...
    public void onDowngrade(SupportSQLiteDatabase supportSQLiteDatabase, int i9, int i10) {
        onUpgrade(supportSQLiteDatabase, i9, i10);
    }
    ...
    @Override // androidx.sqlite.db.SupportSQLiteOpenHelper.Callback
    public void onUpgrade(SupportSQLiteDatabase supportSQLiteDatabase, int i9, int i10) {
        boolean z10;
        List<Migration> findMigrationPath;
        DatabaseConfiguration databaseConfiguration = this.mConfiguration;
        if (databaseConfiguration == null || (findMigrationPath = databaseConfiguration.migrationContainer.findMigrationPath(i9, i10)) == null) {
            z10 = false;
        } else {
        ...
        if (databaseConfiguration2 != null && !databaseConfiguration2.isMigrationRequired(i9, i10)) {
