...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static class VectorDrawableCompatState extends Drawable.ConstantState {
        ...
        public boolean canReuseBitmap(int i9, int i10) {
            return i9 == this.mCachedBitmap.getWidth() && i10 == this.mCachedBitmap.getHeight();
        }
        ...
        public void createCachedBitmapIfNeeded(int i9, int i10) {
            if (this.mCachedBitmap == null || !canReuseBitmap(i9, i10)) {
                this.mCachedBitmap = Bitmap.createBitmap(i9, i10, Bitmap.Config.ARGB_8888);
        ...
        public void updateCachedBitmap(int i9, int i10) {
            ...
            this.mVPathRenderer.draw(new Canvas(this.mCachedBitmap), i9, i10, null);
        }
    ...
    static int applyAlpha(int i9, float f10) {
    ...
    private void printGroupTree(VGroup vGroup, int i9) {
        String str = "";
        ...
        for (int i11 = 0; i11 < vGroup.mChildren.size(); i11++) {
            VObject vObject = vGroup.mChildren.get(i11);
            if (vObject instanceof VGroup) {
                printGroupTree((VGroup) vObject, i9 + 1);
            } else {
    ...
    public void setAlpha(int i9) {
        ...
        } else if (this.mVectorState.mVPathRenderer.getRootAlpha() != i9) {
            this.mVectorState.mVPathRenderer.setRootAlpha(i9);
            invalidateSelf();
        }
    }
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i9 = 0; i9 < pathDataNodeArr.length; i9++) {
                str = str + pathDataNodeArr[i9].mType + CertificateUtil.DELIMITER;
                for (int i10 = 0; i10 < pathDataNodeArr[i9].mParams.length; i10++) {
                    str = str + fArr[i10] + ",";
                }
            }
            return str;
    ...
    public static class VFullPath extends VPath {
        ...
        private Paint.Cap getStrokeLineCap(int i9, Paint.Cap cap) {
            if (i9 != 0) {
                if (i9 != 1) {
                    return i9 != 2 ? cap : Paint.Cap.SQUARE;
                }
        ...
        private Paint.Join getStrokeLineJoin(int i9, Paint.Join join) {
            if (i9 != 0) {
                if (i9 != 1) {
                    return i9 != 2 ? join : Paint.Join.BEVEL;
                }
    ...
    public static class VPathRenderer {
        ...
        private void drawGroupTree(VGroup vGroup, Matrix matrix, Canvas canvas, int i9, int i10, ColorFilter colorFilter) {
            ...
            for (int i11 = 0; i11 < vGroup.mChildren.size(); i11++) {
                VObject vObject = vGroup.mChildren.get(i11);
                if (vObject instanceof VGroup) {
                    drawGroupTree((VGroup) vObject, vGroup.mStackedMatrix, canvas, i9, i10, colorFilter);
                } else if (vObject instanceof VPath) {
                    drawPath(vGroup, (VPath) vObject, canvas, i9, i10, colorFilter);
                }
            }
            canvas.restore();
        }

        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int i9, int i10, ColorFilter colorFilter) {
            float f10 = i9 / this.mViewportWidth;
            float f11 = i10 / this.mViewportHeight;
        ...
        public void draw(Canvas canvas, int i9, int i10, ColorFilter colorFilter) {
            drawGroupTree(this.mRootGroup, IDENTITY_MATRIX, canvas, i9, i10, colorFilter);
        }
    ...
    public static class VGroup extends VObject {
        ...
        public boolean isStateful() {
            for (int i9 = 0; i9 < this.mChildren.size(); i9++) {
                if (this.mChildren.get(i9).isStateful()) {
                    return true;
                }
            }
            return false;
        ...
        public boolean onStateChanged(int[] iArr) {
            boolean z10 = false;
            for (int i9 = 0; i9 < this.mChildren.size(); i9++) {
                z10 |= this.mChildren.get(i9).onStateChanged(iArr);
            }
            return z10;
        }
