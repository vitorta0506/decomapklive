...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
            ...
            if (animatedVectorDrawableCompatState != null) {
                ...
                if (arrayList != null) {
                    ...
                    for (int i9 = 0; i9 < size; i9++) {
                        Animator animator = animatedVectorDrawableCompatState.mAnimators.get(i9);
    ...
    @Nullable
    public static AnimatedVectorDrawableCompat create(@NonNull Context context, @DrawableRes int i9) {
        int next;
    ...
    private void setupColorAnimator(Animator animator) {
        ...
        if ((animator instanceof AnimatorSet) && (childAnimations = ((AnimatorSet) animator).getChildAnimations()) != null) {
            for (int i9 = 0; i9 < childAnimations.size(); i9++) {
                setupColorAnimator(childAnimations.get(i9));
            }
        }
    ...
    protected boolean onLevelChange(int i9) {
        ...
        return this.mAnimatedVectorState.mVectorDrawable.setLevel(i9);
    }
            ...
            if (this.mAnimatorListener == null) {
                this.mAnimatorListener = new AnimatorListenerAdapter() { // from class: androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat.2
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        int size = arrayList.size();
                        for (int i9 = 0; i9 < size; i9++) {
                            ((Animatable2Compat.AnimationCallback) arrayList.get(i9)).onAnimationEnd(AnimatedVectorDrawableCompat.this);
                        }
                    }
                    ...
                    public void onAnimationStart(Animator animator) {
                        ...
                        int size = arrayList.size();
                        for (int i9 = 0; i9 < size; i9++) {
                            ((Animatable2Compat.AnimationCallback) arrayList.get(i9)).onAnimationStart(AnimatedVectorDrawableCompat.this);
                        }
                    }
                };
            }
    ...
    public void setAlpha(int i9) {
        ...
        if (drawable != null) {
            ...
            this.mAnimatedVectorState.mVectorDrawable.setAlpha(i9);
        }
    }
    ...
    public void setTint(int i9) {
        ...
        if (drawable != null) {
            ...
            this.mAnimatedVectorState.mVectorDrawable.setTint(i9);
        }
    }
