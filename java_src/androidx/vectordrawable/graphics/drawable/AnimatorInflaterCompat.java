...
public class AnimatorInflaterCompat {
        ...
        public PathParser.PathDataNode[] evaluate(float f10, PathParser.PathDataNode[] pathDataNodeArr, PathParser.PathDataNode[] pathDataNodeArr2) {
            if (PathParser.canMorph(pathDataNodeArr, pathDataNodeArr2)) {
                ...
                for (int i9 = 0; i9 < pathDataNodeArr.length; i9++) {
                    this.mNodeArray[i9].interpolatePathDataNode(pathDataNodeArr[i9], pathDataNodeArr2[i9], f10);
                }
    ...
    private static void distributeKeyframes(Keyframe[] keyframeArr, float f10, int i9, int i10) {
        float f11 = f10 / ((i10 - i9) + 2);
        while (i9 <= i10) {
            keyframeArr[i9].setFraction(keyframeArr[i9 - 1].getFraction() + f11);
            i9++;
        }
    }
    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        ...
        for (int i9 = 0; i9 < length; i9++) {
            Keyframe keyframe = (Keyframe) objArr[i9];
    ...
    private static PropertyValuesHolder getPVH(TypedArray typedArray, int i9, int i10, int i11, String str) {
        int i12;
        int i13;
        int i14;
        float f10;
        ...
        int i15 = z10 ? peekValue.type : 0;
        TypedValue peekValue2 = typedArray.peekValue(i11);
        boolean z11 = peekValue2 != null;
        int i16 = z11 ? peekValue2.type : 0;
        if (i9 == 4) {
            i9 = ((z10 && isColorType(i15)) || (z11 && isColorType(i16))) ? 3 : 0;
        }
        boolean z12 = i9 == 0;
        ...
        ArgbEvaluator argbEvaluator = i9 == 3 ? ArgbEvaluator.getInstance() : null;
        if (z12) {
            if (z10) {
                if (i15 == 5) {
    ...
    private static int inferValueTypeFromValues(TypedArray typedArray, int i9, int i10) {
        TypedValue peekValue = typedArray.peekValue(i9);
        boolean z10 = peekValue != null;
        int i11 = z10 ? peekValue.type : 0;
        TypedValue peekValue2 = typedArray.peekValue(i10);
        boolean z11 = peekValue2 != null;
        return ((z10 && isColorType(i11)) || (z11 && isColorType(z11 ? peekValue2.type : 0))) ? 3 : 0;
    }
    ...
    private static boolean isColorType(int i9) {
        return i9 >= 28 && i9 <= 31;
    }

    public static Animator loadAnimator(Context context, @AnimatorRes int i9) throws Resources.NotFoundException {
        if (Build.VERSION.SDK_INT >= 24) {
            return AnimatorInflater.loadAnimator(context, i9);
        }
        return loadAnimator(context, context.getResources(), context.getTheme(), i9);
    }

    private static Keyframe loadKeyframe(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i9, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        Keyframe ofInt;
        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, AndroidResources.STYLEABLE_KEYFRAME);
        ...
        if (i9 == 4) {
            i9 = (z10 && isColorType(peekNamedValue.type)) ? 3 : 0;
        }
        if (z10) {
            if (i9 != 0) {
                ofInt = (i9 == 1 || i9 == 3) ? Keyframe.ofInt(namedFloat, TypedArrayUtils.getNamedInt(obtainAttributes, xmlPullParser, "value", 0, 0)) : null;
            } else {
    ...
    private static PropertyValuesHolder loadPvh(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, String str, int i9) throws XmlPullParserException, IOException {
        int size;
        PropertyValuesHolder propertyValuesHolder = null;
        ...
        while (true) {
            ...
            if (next == 3 || next == 1) {
                ...
                if (i9 == 4) {
                    i9 = inferValueTypeOfKeyframe(resources, theme, Xml.asAttributeSet(xmlPullParser), xmlPullParser);
                }
                Keyframe loadKeyframe = loadKeyframe(context, resources, theme, Xml.asAttributeSet(xmlPullParser), i9, xmlPullParser);
    ...
    private static void setupObjectAnimator(ValueAnimator valueAnimator, TypedArray typedArray, int i9, float f10, XmlPullParser xmlPullParser) {
    ...
    */
    ...
    public static Animator loadAnimator(Context context, Resources resources, Resources.Theme theme, @AnimatorRes int i9) throws Resources.NotFoundException {
        return loadAnimator(context, resources, theme, i9, 1.0f);
    }

    public static Animator loadAnimator(Context context, Resources resources, Resources.Theme theme, @AnimatorRes int i9, float f10) throws Resources.NotFoundException {
        XmlResourceParser xmlResourceParser = null;
        try {
            try {
                try {
                    xmlResourceParser = resources.getAnimation(i9);
