...
public final class ConcatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int findRelativeAdapterPositionIn(@NonNull RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter, @NonNull RecyclerView.ViewHolder viewHolder, int i9) {
        return this.mController.getLocalAdapterPosition(adapter, viewHolder, i9);
    }
    ...
    public long getItemId(int i9) {
        return this.mController.getItemId(i9);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemViewType(int i9) {
        return this.mController.getItemViewType(i9);
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i9) {
        this.mController.onBindViewHolder(viewHolder, i9);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    @NonNull
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i9) {
        return this.mController.onCreateViewHolder(viewGroup, i9);
    }
    ...
    public boolean addAdapter(int i9, @NonNull RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter) {
        return this.mController.addAdapter(i9, adapter);
    }
