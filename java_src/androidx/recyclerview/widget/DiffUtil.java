...
public class DiffUtil {
    private static final Comparator<Diagonal> DIAGONAL_COMPARATOR = new Comparator<Diagonal>() { // from class: androidx.recyclerview.widget.DiffUtil.1
        ...
        public int compare(Diagonal diagonal, Diagonal diagonal2) {
            return diagonal.f930x - diagonal2.f930x;
        }
    };
    ...
    public static class Diagonal {
        ...
        int endX() {
            return this.f930x + this.size;
        }

        int endY() {
            return this.f931y + this.size;
        }
    }
    ...
    public static class DiffResult {
        ...
        private void addEdgeDiagonals() {
            ...
            if (diagonal == null || diagonal.f930x != 0 || diagonal.f931y != 0) {
        ...
        private void findMatchingItems() {
            for (Diagonal diagonal : this.mDiagonals) {
                for (int i9 = 0; i9 < diagonal.size; i9++) {
                    int i10 = diagonal.f930x + i9;
                    int i11 = diagonal.f931y + i9;
        ...
        @Nullable
        private static PostponedUpdate getPostponedUpdate(Collection<PostponedUpdate> collection, int i9, boolean z10) {
            ...
            while (true) {
                ...
                if (postponedUpdate.posInOwnerList == i9 && postponedUpdate.removal == z10) {
                    it.remove();
                    break;
                }
            }
        ...
        public void dispatchUpdatesTo(@NonNull ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mDiagonals.size() - 1; size >= 0; size--) {
                ...
                int i18 = diagonal.f930x;
                int i19 = diagonal.f931y;
    ...
    public static class PostponedUpdate {
        ...
        PostponedUpdate(int i9, int i10, boolean z10) {
    ...
    public static class Snake {
        ...
        Diagonal toDiagonal() {
            ...
            int i9 = this.startX;
            return new Diagonal(i9, this.startY, this.endX - i9);
        }
    }
    ...
    @Nullable
    private static Snake backward(Range range, Callback callback, CenteredArray centeredArray, CenteredArray centeredArray2, int i9) {
        int i10;
        int i11;
        int i12;
        ...
        for (int i14 = i13; i14 <= i9; i14 += 2) {
            if (i14 != i13 && (i14 == i9 || centeredArray2.get(i14 + 1) >= centeredArray2.get(i14 - 1))) {
            ...
            if (z10 && (i12 = oldSize - i14) >= i13 && i12 <= i9 && centeredArray.get(i12) >= i11) {
    ...
    @Nullable
    private static Snake forward(Range range, Callback callback, CenteredArray centeredArray, CenteredArray centeredArray2, int i9) {
        int i10;
        int i11;
        int i12;
        ...
        int i13 = -i9;
        for (int i14 = i13; i14 <= i9; i14 += 2) {
            if (i14 != i13 && (i14 == i9 || centeredArray.get(i14 + 1) <= centeredArray.get(i14 - 1))) {
            ...
            if (z10 && (i12 = oldSize - i14) >= i13 + 1 && i12 <= i9 - 1 && centeredArray2.get(i12) <= i11) {
                Snake snake = new Snake();
                snake.startX = i10;
                snake.startY = i16;
                snake.endX = i11;
    ...
    private static Snake midPoint(Range range, Callback callback, CenteredArray centeredArray, CenteredArray centeredArray2) {
        if (range.oldSize() >= 1 && range.newSize() >= 1) {
            ...
            for (int i9 = 0; i9 < oldSize; i9++) {
                Snake forward = forward(range, callback, centeredArray, centeredArray2, i9);
                if (forward != null) {
                    return forward;
                }
                Snake backward = backward(range, callback, centeredArray, centeredArray2, i9);
                if (backward != null) {
                    return backward;
                }
            }
