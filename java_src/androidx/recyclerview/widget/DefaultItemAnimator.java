...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public static class MoveInfo {
        ...
        MoveInfo(RecyclerView.ViewHolder viewHolder, int i9, int i10, int i11, int i12) {
    ...
    public boolean animateChange(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i9, int i10, int i11, int i12) {
        ...
        this.mPendingChanges.add(new ChangeInfo(viewHolder, viewHolder2, i9, i10, i11, i12));
        return true;
    }
    ...
    public boolean animateMove(RecyclerView.ViewHolder viewHolder, int i9, int i10, int i11, int i12) {
        ...
        this.mPendingMoves.add(new MoveInfo(viewHolder, translationX, translationY, i11, i12));
        return true;
    }

    void animateMoveImpl(final RecyclerView.ViewHolder viewHolder, int i9, int i10, int i11, int i12) {
        final View view = viewHolder.itemView;
    ...
    public static class ChangeInfo {
        ...
        ChangeInfo(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i9, int i10, int i11, int i12) {
