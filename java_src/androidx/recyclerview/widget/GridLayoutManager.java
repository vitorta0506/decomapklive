...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public static abstract class SpanSizeLookup {
        ...
        static int findFirstKeyLessThan(SparseIntArray sparseIntArray, int i9) {
        ...
        int getCachedSpanGroupIndex(int i9, int i10) {
        ...
        int getCachedSpanIndex(int i9, int i10) {
    ...
    public GridLayoutManager(Context context, AttributeSet attributeSet, int i9, int i10) {
        ...
        setSpanCount(RecyclerView.LayoutManager.getProperties(context, attributeSet, i9, i10).spanCount);
    }

    private void assignSpans(RecyclerView.Recycler recycler, RecyclerView.State state, int i9, boolean z10) {
        int i10;
        int i11;
        int i12 = 0;
        int i13 = -1;
    ...
    private void ensureAnchorIsInCorrectSpan(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.AnchorInfo anchorInfo, int i9) {
        boolean z10 = i9 == 1;
        ...
        if (z10) {
            while (spanIndex > 0) {
                ...
                spanIndex = getSpanIndex(recycler, state, i11);
            }
            return;
        }
        ...
        while (i12 < itemCount) {
            int i13 = i12 + 1;
            int spanIndex2 = getSpanIndex(recycler, state, i13);
    ...
    private int getSpanGroupIndex(RecyclerView.Recycler recycler, RecyclerView.State state, int i9) {
    ...
    private void guessMeasurement(float f10, int i9) {
        calculateItemBorders(Math.max(Math.round(f10 * this.mSpanCount), i9));
    }

    private void measureChild(View view, int i9, boolean z10) {
        int i10;
        int i11;
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        ...
        if (this.mOrientation == 1) {
            ...
            i10 = RecyclerView.LayoutManager.getChildMeasureSpec(this.mOrientationHelper.getTotalSpace(), getHeightMode(), i12, ((ViewGroup.MarginLayoutParams) layoutParams).height, true);
        } else {
            ...
            int childMeasureSpec2 = RecyclerView.LayoutManager.getChildMeasureSpec(this.mOrientationHelper.getTotalSpace(), getWidthMode(), i13, ((ViewGroup.MarginLayoutParams) layoutParams).width, true);
    ...
    private void measureChildWithDecorationsAndMargin(View view, int i9, int i10, boolean z10) {
        ...
        if (z10) {
            shouldMeasureChild = shouldReMeasureChild(view, i9, i10, layoutParams);
        } else {
            shouldMeasureChild = shouldMeasureChild(view, i9, i10, layoutParams);
        }
    ...
    int getSpaceForSpanRange(int i9, int i10) {
    ...
    */
    ...
    @Override // androidx.recyclerview.widget.LinearLayoutManager
    void onAnchorReady(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.AnchorInfo anchorInfo, int i9) {
        super.onAnchorReady(recycler, state, anchorInfo, i9);
        updateMeasurements();
        if (state.getItemCount() > 0 && !state.isPreLayout()) {
            ensureAnchorIsInCorrectSpan(recycler, state, anchorInfo, i9);
        }
        ensureViewSet();
    }
    ...
    */
    ...
    public void setMeasuredDimension(Rect rect, int i9, int i10) {
        ...
        if (this.mOrientation == 1) {
            ...
            int[] iArr = this.mCachedBorders;
            chooseSize = RecyclerView.LayoutManager.chooseSize(i9, iArr[iArr.length - 1] + paddingLeft, getMinimumWidth());
        } else {
            chooseSize = RecyclerView.LayoutManager.chooseSize(i9, rect.width() + paddingLeft, getMinimumWidth());
            int[] iArr2 = this.mCachedBorders;
            chooseSize2 = RecyclerView.LayoutManager.chooseSize(i10, iArr2[iArr2.length - 1] + paddingTop, getMinimumHeight());
        }
    ...
    static int[] calculateItemBorders(int[] iArr, int i9, int i10) {
        int i11;
    ...
    public GridLayoutManager(Context context, int i9, int i10, boolean z10) {
