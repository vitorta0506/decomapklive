...
public class PagerSnapHelper extends SnapHelper {
    ...
    private boolean isForwardFling(RecyclerView.LayoutManager layoutManager, int i9, int i10) {
        return layoutManager.canScrollHorizontally() ? i9 > 0 : i10 > 0;
    }
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int i9, int i10) {
        ...
        boolean isForwardFling = isForwardFling(layoutManager, i9, i10);
