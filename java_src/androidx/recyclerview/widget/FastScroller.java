...
public class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    private int[] getHorizontalRange() {
        ...
        int i9 = this.mMargin;
        iArr[0] = i9;
        iArr[1] = this.mRecyclerViewWidth - i9;
        return iArr;
    }
    ...
    private int[] getVerticalRange() {
        ...
        int i9 = this.mMargin;
        iArr[0] = i9;
        iArr[1] = this.mRecyclerViewHeight - i9;
        return iArr;
    }
    ...
    private int scrollTo(float f10, float f11, int[] iArr, int i9, int i10, int i11) {
    ...
    void hide(int i9) {
        ...
        this.mShowHideAnimator.setDuration(i9);
    ...
    boolean isPointInsideVerticalThumb(float f10, float f11) {
        if (!isLayoutRTL() ? f10 >= this.mRecyclerViewWidth - this.mVerticalThumbWidth : f10 <= this.mVerticalThumbWidth) {
            int i9 = this.mVerticalThumbCenterY;
    ...
    void updateScrollPosition(int i9, int i10) {
        ...
        if (this.mNeedHorizontalScrollbar) {
            float f11 = i12;
            this.mHorizontalThumbCenterX = (int) ((f11 * (i9 + (f11 / 2.0f))) / computeHorizontalScrollRange);
