...
public class OpReorderer {
    ...
    public interface Callback {
        AdapterHelper.UpdateOp obtainUpdateOp(int i9, int i10, int i11, Object obj);
    ...
    private void swapMoveAdd(List<AdapterHelper.UpdateOp> list, int i9, AdapterHelper.UpdateOp updateOp, int i10, AdapterHelper.UpdateOp updateOp2) {
        ...
        list.set(i9, updateOp2);
        list.set(i10, updateOp);
    }

    private void swapMoveOp(List<AdapterHelper.UpdateOp> list, int i9, int i10) {
        AdapterHelper.UpdateOp updateOp = list.get(i9);
        AdapterHelper.UpdateOp updateOp2 = list.get(i10);
        int i11 = updateOp2.cmd;
        if (i11 == 1) {
            swapMoveAdd(list, i9, updateOp, i10, updateOp2);
        } else if (i11 == 2) {
            swapMoveRemove(list, i9, updateOp, i10, updateOp2);
        } else if (i11 != 4) {
        } else {
            swapMoveUpdate(list, i9, updateOp, i10, updateOp2);
        }
    }
    ...
    void swapMoveRemove(List<AdapterHelper.UpdateOp> list, int i9, AdapterHelper.UpdateOp updateOp, int i10, AdapterHelper.UpdateOp updateOp2) {
        boolean z10;
