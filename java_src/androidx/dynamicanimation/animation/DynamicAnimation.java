...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    public static final ViewProperty X = new ViewProperty(x.f19108w) { // from class: androidx.dynamicanimation.animation.DynamicAnimation.9
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public float getValue(View view) {
            return view.getX();
        }
    ...
    private void endAnimationInternal(boolean z10) {
        ...
        for (int i9 = 0; i9 < this.mEndListeners.size(); i9++) {
            if (this.mEndListeners.get(i9) != null) {
                this.mEndListeners.get(i9).onAnimationEnd(this, z10, this.mValue, this.mVelocity);
            }
        }
    ...
    void setPropertyValue(float f10) {
        ...
        for (int i9 = 0; i9 < this.mUpdateListeners.size(); i9++) {
            if (this.mUpdateListeners.get(i9) != null) {
                this.mUpdateListeners.get(i9).onAnimationUpdate(this, this.mValue, this.mVelocity);
            }
        }
