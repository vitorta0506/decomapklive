...
public abstract class Transition implements Cloneable {
    ...
    private void addUnmatched(ArrayMap<View, TransitionValues> arrayMap, ArrayMap<View, TransitionValues> arrayMap2) {
        for (int i9 = 0; i9 < arrayMap.size(); i9++) {
            TransitionValues valueAt = arrayMap.valueAt(i9);
        ...
        for (int i10 = 0; i10 < arrayMap2.size(); i10++) {
            TransitionValues valueAt2 = arrayMap2.valueAt(i10);
    ...
    private ArrayList<Integer> excludeId(ArrayList<Integer> arrayList, int i9, boolean z10) {
        if (i9 > 0) {
            if (z10) {
                return ArrayListManager.add(arrayList, Integer.valueOf(i9));
            }
            return ArrayListManager.remove(arrayList, Integer.valueOf(i9));
        }
        return arrayList;
    }
    ...
    private void matchItemIds(ArrayMap<View, TransitionValues> arrayMap, ArrayMap<View, TransitionValues> arrayMap2, LongSparseArray<View> longSparseArray, LongSparseArray<View> longSparseArray2) {
        ...
        for (int i9 = 0; i9 < size; i9++) {
            ...
            if (valueAt != null && isValidTarget(valueAt) && (view = longSparseArray2.get(longSparseArray.keyAt(i9))) != null && isValidTarget(view)) {
                TransitionValues transitionValues = arrayMap.get(valueAt);
                TransitionValues transitionValues2 = arrayMap2.get(view);
                if (transitionValues != null && transitionValues2 != null) {
                    this.mStartValuesList.add(transitionValues);
    ...
    private void matchNames(ArrayMap<View, TransitionValues> arrayMap, ArrayMap<View, TransitionValues> arrayMap2, ArrayMap<String, View> arrayMap3, ArrayMap<String, View> arrayMap4) {
        ...
        for (int i9 = 0; i9 < size; i9++) {
            ...
            if (valueAt != null && isValidTarget(valueAt) && (view = arrayMap4.get(arrayMap3.keyAt(i9))) != null && isValidTarget(view)) {
                TransitionValues transitionValues = arrayMap.get(valueAt);
                TransitionValues transitionValues2 = arrayMap2.get(view);
                if (transitionValues != null && transitionValues2 != null) {
                    this.mStartValuesList.add(transitionValues);
    ...
    public void cancel() {
        ...
        for (int i9 = 0; i9 < size2; i9++) {
            ((TransitionListener) arrayList2.get(i9)).onTransitionCancel(this);
        }
    }
    ...
    public void captureValues(ViewGroup viewGroup, boolean z10) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            arrayList3.add(this.mStartValues.mNameValues.remove(this.mNameOverrides.keyAt(i11)));
        }
        for (int i12 = 0; i12 < size; i12++) {
            View view2 = (View) arrayList3.get(i12);
            if (view2 != null) {
                this.mStartValues.mNameValues.put(this.mNameOverrides.valueAt(i12), view2);
            }
        }
    }
    ...
    public void pause(View view) {
        ...
        if (arrayList != null && arrayList.size() > 0) {
            ...
            int size2 = arrayList2.size();
            for (int i9 = 0; i9 < size2; i9++) {
                ((TransitionListener) arrayList2.get(i9)).onTransitionPause(this);
            }
        }
        this.mPaused = true;
    }
    ...
    @NonNull
    public Transition excludeChildren(@IdRes int i9, boolean z10) {
        this.mTargetIdChildExcludes = excludeId(this.mTargetIdChildExcludes, i9, z10);
        return this;
    }

    @NonNull
    public Transition excludeTarget(@IdRes int i9, boolean z10) {
        this.mTargetIdExcludes = excludeId(this.mTargetIdExcludes, i9, z10);
        return this;
    }
