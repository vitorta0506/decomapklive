    ...
    public static ViewOverlayApi14 createFrom(View view) {
        ...
        if (contentView != null) {
            ...
            for (int i9 = 0; i9 < childCount; i9++) {
                View childAt = contentView.getChildAt(i9);
    ...
    public static class OverlayViewGroup extends ViewGroup {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            for (int i9 = 0; i9 < size; i9++) {
                this.mDrawables.get(i9).draw(canvas);
            }
        }
        ...
        protected ViewParent invalidateChildInParentFast(int i9, int i10, Rect rect) {
            if (this.mHostView == null || sInvalidateChildInParentFastMethod == null) {
                return null;
            }
            try {
                getOffset(new int[2]);
                sInvalidateChildInParentFastMethod.invoke(this.mHostView, Integer.valueOf(i9), Integer.valueOf(i10), rect);
                return null;
