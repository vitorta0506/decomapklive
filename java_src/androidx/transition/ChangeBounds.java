        ...
        if (parentMatches(viewGroup2, viewGroup3)) {
            ...
            if (i9 > 0) {
                if (!this.mResizeClip) {
                    ...
                    if (i9 == 2) {
                        if (i19 == i21 && i20 == i22) {
                            mergeAnimators = ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath(i11, i13, i12, i14));
                        } else {
                            ViewBounds viewBounds = new ViewBounds(view);
                            ObjectAnimator ofPointF = ObjectAnimatorUtils.ofPointF(viewBounds, TOP_LEFT_PROPERTY, getPathMotion().getPath(i11, i13, i12, i14));
                            ObjectAnimator ofPointF2 = ObjectAnimatorUtils.ofPointF(viewBounds, BOTTOM_RIGHT_PROPERTY, getPathMotion().getPath(i15, i17, i16, i18));
                        ...
                        mergeAnimators = ObjectAnimatorUtils.ofPointF(view, BOTTOM_RIGHT_ONLY_PROPERTY, getPathMotion().getPath(i15, i17, i16, i18));
                    } else {
                        mergeAnimators = ObjectAnimatorUtils.ofPointF(view, TOP_LEFT_ONLY_PROPERTY, getPathMotion().getPath(i11, i13, i12, i14));
                    }
                } else {
                    view = view2;
                    ViewUtils.setLeftTopRightBottom(view, i11, i13, Math.max(i19, i21) + i11, Math.max(i20, i22) + i13);
                    ObjectAnimator ofPointF3 = (i11 == i12 && i13 == i14) ? null : ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath(i11, i13, i12, i14));
                    if (rect4 == null) {
                        i10 = 0;
