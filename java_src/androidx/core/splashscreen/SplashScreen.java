...
public final class SplashScreen {
    ...
    public static class Impl {
        ...
        public Impl(@NotNull Activity activity) {
            ...
            this.splashScreenWaitPredicate = new KeepOnScreenCondition() { // from class: androidx.core.splashscreen.a
                ...
                public final boolean shouldKeepOnScreen() {
                    boolean m9splashScreenWaitPredicate$lambda0;
                    m9splashScreenWaitPredicate$lambda0 = SplashScreen.Impl.m9splashScreenWaitPredicate$lambda0();
                    return m9splashScreenWaitPredicate$lambda0;
                }
            };
        }
        ...
        public static final void m8dispatchOnExitAnimation$lambda3(SplashScreenViewProvider splashScreenViewProvider, OnExitAnimationListener finalListener) {
        ...
        public static final boolean m9splashScreenWaitPredicate$lambda0() {
            return false;
        }
        ...
        public final void dispatchOnExitAnimation(@NotNull final SplashScreenViewProvider splashScreenViewProvider) {
            ...
            splashScreenViewProvider.getView().postOnAnimation(new Runnable() { // from class: androidx.core.splashscreen.b
                ...
                public final void run() {
                    SplashScreen.Impl.m8dispatchOnExitAnimation$lambda3(SplashScreenViewProvider.this, onExitAnimationListener);
                }
            });
        }
        ...
        public final void setFinalThemeId(int i9) {
    ...
    public static final class Impl31 extends Impl {
        ...
        public static final void m10setOnExitAnimationListener$lambda0(Impl31 this$0, OnExitAnimationListener exitAnimationListener, SplashScreenView splashScreenView) {
        ...
        public void setOnExitAnimationListener(@NotNull final OnExitAnimationListener exitAnimationListener) {
            ...
            getActivity().getSplashScreen().setOnExitAnimationListener(new SplashScreen.OnExitAnimationListener() { // from class: androidx.core.splashscreen.c
                ...
                public final void onSplashScreenExit(SplashScreenView splashScreenView) {
                    SplashScreen.Impl31.m10setOnExitAnimationListener$lambda0(SplashScreen.Impl31.this, exitAnimationListener, splashScreenView);
                }
            });
        }
