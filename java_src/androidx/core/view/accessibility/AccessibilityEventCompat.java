...
public final class AccessibilityEventCompat {
    ...
    @Deprecated
    public static AccessibilityRecordCompat getRecord(AccessibilityEvent accessibilityEvent, int i9) {
        return new AccessibilityRecordCompat(accessibilityEvent.getRecord(i9));
    }
    ...
    public static void setAction(AccessibilityEvent accessibilityEvent, int i9) {
        accessibilityEvent.setAction(i9);
    }

    public static void setContentChangeTypes(AccessibilityEvent accessibilityEvent, int i9) {
        accessibilityEvent.setContentChangeTypes(i9);
    }

    public static void setMovementGranularity(AccessibilityEvent accessibilityEvent, int i9) {
