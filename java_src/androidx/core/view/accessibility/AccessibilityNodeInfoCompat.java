...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        static {
            ...
            ACTION_SHOW_ON_SCREEN = new AccessibilityActionCompat(i9 >= 23 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_SHOW_ON_SCREEN : null, 16908342, null, null, null);
            ACTION_SCROLL_TO_POSITION = new AccessibilityActionCompat(i9 >= 23 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_TO_POSITION : null, 16908343, null, null, AccessibilityViewCommand.ScrollToPositionArguments.class);
            ACTION_SCROLL_UP = new AccessibilityActionCompat(i9 >= 23 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_UP : null, 16908344, null, null, null);
            ACTION_SCROLL_LEFT = new AccessibilityActionCompat(i9 >= 23 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_LEFT : null, 16908345, null, null, null);
            ACTION_SCROLL_DOWN = new AccessibilityActionCompat(i9 >= 23 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_DOWN : null, 16908346, null, null, null);
            ACTION_SCROLL_RIGHT = new AccessibilityActionCompat(i9 >= 23 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_RIGHT : null, 16908347, null, null, null);
            ACTION_PAGE_UP = new AccessibilityActionCompat(i9 >= 29 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_PAGE_UP : null, 16908358, null, null, null);
            ACTION_PAGE_DOWN = new AccessibilityActionCompat(i9 >= 29 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_PAGE_DOWN : null, 16908359, null, null, null);
            ACTION_PAGE_LEFT = new AccessibilityActionCompat(i9 >= 29 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_PAGE_LEFT : null, 16908360, null, null, null);
            ACTION_PAGE_RIGHT = new AccessibilityActionCompat(i9 >= 29 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_PAGE_RIGHT : null, 16908361, null, null, null);
            ACTION_CONTEXT_CLICK = new AccessibilityActionCompat(i9 >= 23 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_CONTEXT_CLICK : null, 16908348, null, null, null);
            ACTION_SET_PROGRESS = new AccessibilityActionCompat(i9 >= 24 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_SET_PROGRESS : null, 16908349, null, null, AccessibilityViewCommand.SetProgressArguments.class);
            ACTION_MOVE_WINDOW = new AccessibilityActionCompat(i9 >= 26 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_MOVE_WINDOW : null, 16908354, null, null, AccessibilityViewCommand.MoveWindowArguments.class);
            ACTION_SHOW_TOOLTIP = new AccessibilityActionCompat(i9 >= 28 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_SHOW_TOOLTIP : null, 16908356, null, null, null);
            ACTION_HIDE_TOOLTIP = new AccessibilityActionCompat(i9 >= 28 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_HIDE_TOOLTIP : null, 16908357, null, null, null);
            ACTION_PRESS_AND_HOLD = new AccessibilityActionCompat(i9 >= 30 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_PRESS_AND_HOLD : null, 16908362, null, null, null);
            ACTION_IME_ENTER = new AccessibilityActionCompat(i9 >= 30 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_IME_ENTER : null, 16908372, null, null, null);
        }
        ...
        AccessibilityActionCompat(Object obj, int i9, CharSequence charSequence, AccessibilityViewCommand accessibilityViewCommand, Class<? extends AccessibilityViewCommand.CommandArguments> cls) {
            ...
            if (obj == null) {
                this.mAction = new AccessibilityNodeInfo.AccessibilityAction(i9, charSequence);
            } else {
                this.mAction = obj;
            }
    ...
    public static class CollectionInfoCompat {
        ...
        public static CollectionInfoCompat obtain(int i9, int i10, boolean z10, int i11) {
            return new CollectionInfoCompat(AccessibilityNodeInfo.CollectionInfo.obtain(i9, i10, z10, i11));
        }
        ...
        public static CollectionInfoCompat obtain(int i9, int i10, boolean z10) {
            return new CollectionInfoCompat(AccessibilityNodeInfo.CollectionInfo.obtain(i9, i10, z10));
        }
    }
    ...
    public static class CollectionItemInfoCompat {
        ...
        public static CollectionItemInfoCompat obtain(int i9, int i10, int i11, int i12, boolean z10, boolean z11) {
            return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(i9, i10, i11, i12, z10, z11));
        }
        ...
        public static CollectionItemInfoCompat obtain(int i9, int i10, int i11, int i12, boolean z10) {
            return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(i9, i10, i11, i12, z10));
        }
    }
    ...
    public static class RangeInfoCompat {
        ...
        public static RangeInfoCompat obtain(int i9, float f10, float f11, float f12) {
            return new RangeInfoCompat(AccessibilityNodeInfo.RangeInfo.obtain(i9, f10, f11, f12));
        }
    ...
    private void addSpanLocationToExtras(ClickableSpan clickableSpan, Spanned spanned, int i9) {
        ...
        extrasIntList(SPANS_ID_KEY).add(Integer.valueOf(i9));
    }
    ...
    private static String getActionSymbolicName(int i9) {
        if (i9 != 1) {
            if (i9 != 2) {
                switch (i9) {
                    case 4:
    ...
    private boolean getBooleanProperty(int i9) {
        Bundle extras = getExtras();
        return extras != null && (extras.getInt(BOOLEAN_PROPERTY_KEY, 0) & i9) == i9;
    }
    ...
    private void removeCollectedSpans(View view) {
        ...
        if (spansFromViewTags != null) {
            ...
            for (int i9 = 0; i9 < spansFromViewTags.size(); i9++) {
                if (spansFromViewTags.valueAt(i9).get() == null) {
    ...
    private void setBooleanProperty(int i9, boolean z10) {
        Bundle extras = getExtras();
        if (extras != null) {
            int i10 = extras.getInt(BOOLEAN_PROPERTY_KEY, 0) & (~i9);
            if (!z10) {
                i9 = 0;
            }
            extras.putInt(BOOLEAN_PROPERTY_KEY, i9 | i10);
        }
    }
    ...
    public void addSpansToExtras(CharSequence charSequence, View view) {
        if (Build.VERSION.SDK_INT < 26) {
            ...
            for (int i9 = 0; i9 < clickableSpans.length; i9++) {
                int idForClickableSpan = idForClickableSpan(clickableSpans[i9], orCreateSpansFromViewTags);
                orCreateSpansFromViewTags.put(idForClickableSpan, new WeakReference<>(clickableSpans[i9]));
                addSpanLocationToExtras(clickableSpans[i9], (Spanned) charSequence, idForClickableSpan);
            }
        }
    }
    ...
    public List<AccessibilityNodeInfoCompat> findAccessibilityNodeInfosByText(String str) {
        ...
        for (int i9 = 0; i9 < size; i9++) {
            arrayList.add(wrap(findAccessibilityNodeInfosByText.get(i9)));
        }
        return arrayList;
    }
    ...
    public AccessibilityNodeInfoCompat findFocus(int i9) {
        return wrapNonNullInstance(this.mInfo.findFocus(i9));
    }

    public AccessibilityNodeInfoCompat focusSearch(int i9) {
        return wrapNonNullInstance(this.mInfo.focusSearch(i9));
    }
    ...
    public AccessibilityNodeInfoCompat getChild(int i9) {
        return wrapNonNullInstance(this.mInfo.getChild(i9));
    }
    ...
    public CharSequence getText() {
        if (hasSpans()) {
            ...
            for (int i9 = 0; i9 < extrasIntList.size(); i9++) {
                spannableString.setSpan(new AccessibilityClickableSpanCompat(extrasIntList4.get(i9).intValue(), this, getExtras().getInt(SPANS_ACTION_ID_KEY)), extrasIntList.get(i9).intValue(), extrasIntList2.get(i9).intValue(), extrasIntList3.get(i9).intValue());
            }
    ...
    public boolean performAction(int i9) {
        return this.mInfo.performAction(i9);
    }
    ...
    public void setDrawingOrder(int i9) {
        if (Build.VERSION.SDK_INT >= 24) {
            this.mInfo.setDrawingOrder(i9);
        }
    }
    ...
    public void setLiveRegion(int i9) {
        this.mInfo.setLiveRegion(i9);
    }
    ...
    public void setMovementGranularities(int i9) {
        this.mInfo.setMovementGranularities(i9);
    }
    ...
    public void setTextSelection(int i9, int i10) {
        this.mInfo.setTextSelection(i9, i10);
    }
    ...
    public String toString() {
        ...
        for (int i9 = 0; i9 < actionList.size(); i9++) {
            AccessibilityActionCompat accessibilityActionCompat = actionList.get(i9);
            String actionSymbolicName = getActionSymbolicName(accessibilityActionCompat.getId());
            if (actionSymbolicName.equals("ACTION_UNKNOWN") && accessibilityActionCompat.getLabel() != null) {
                actionSymbolicName = accessibilityActionCompat.getLabel().toString();
            }
            sb2.append(actionSymbolicName);
            if (i9 != actionList.size() - 1) {
                sb2.append(", ");
            }
        }
        sb2.append("]");
    ...
    public static AccessibilityNodeInfoCompat obtain(View view, int i9) {
        return wrapNonNullInstance(AccessibilityNodeInfo.obtain(view, i9));
    }
    ...
    public void addChild(View view, int i9) {
        this.mInfo.addChild(view, i9);
    }

    public boolean performAction(int i9, Bundle bundle) {
        return this.mInfo.performAction(i9, bundle);
    }

    public boolean removeChild(View view, int i9) {
        return this.mInfo.removeChild(view, i9);
    }

    public void setLabelFor(View view, int i9) {
        this.mInfo.setLabelFor(view, i9);
    }

    public void setLabeledBy(View view, int i9) {
        this.mInfo.setLabeledBy(view, i9);
    }

    public void setParent(View view, int i9) {
        this.mParentVirtualDescendantId = i9;
        this.mInfo.setParent(view, i9);
    }
    ...
    public void setTraversalAfter(View view, int i9) {
        if (Build.VERSION.SDK_INT >= 22) {
            this.mInfo.setTraversalAfter(view, i9);
        }
    }

    public void setTraversalBefore(View view, int i9) {
        if (Build.VERSION.SDK_INT >= 22) {
            this.mInfo.setTraversalBefore(view, i9);
        }
    }
    ...
    public static final class TouchDelegateInfoCompat {
        ...
        @Nullable
        public Region getRegionAt(@IntRange(from = 0) int i9) {
            if (Build.VERSION.SDK_INT >= 29) {
                return this.mInfo.getRegionAt(i9);
            }
            return null;
        }
