...
public class ViewCompat {
    ...
    public static abstract class AccessibilityViewProperty<T> {
        ...
        AccessibilityViewProperty(int i9, Class<T> cls, int i10) {
            this(i9, cls, 0, i10);
        }
        ...
        AccessibilityViewProperty(int i9, Class<T> cls, int i10, int i11) {
            this.mTagKey = i9;
            this.mType = cls;
    ...
    public static class Api16Impl {
        ...
        @DoNotInline
        static boolean performAccessibilityAction(View view, int i9, Bundle bundle) {
        ...
        @DoNotInline
        static void postOnAnimationDelayed(View view, Runnable runnable, long j10) {
        ...
        @DoNotInline
        static void setHasTransientState(View view, boolean z10) {
            view.setHasTransientState(z10);
        }

        @DoNotInline
        static void setImportantForAccessibility(View view, int i9) {
            view.setImportantForAccessibility(i9);
        }

        @DoNotInline
        static void postInvalidateOnAnimation(View view, int i9, int i10, int i11, int i12) {
    ...
    public static class Api17Impl {
        ...
        @DoNotInline
        static void setLabelFor(View view, int i9) {
            view.setLabelFor(i9);
        }
        ...
        @DoNotInline
        static void setLayoutDirection(View view, int i9) {
            view.setLayoutDirection(i9);
        }

        @DoNotInline
        static void setPaddingRelative(View view, int i9, int i10, int i11, int i12) {
    ...
    public static class Api19Impl {
        ...
        @DoNotInline
        static void notifySubtreeAccessibilityStateChanged(ViewParent viewParent, View view, View view2, int i9) {
            viewParent.notifySubtreeAccessibilityStateChanged(view, view2, i9);
        }

        @DoNotInline
        static void setAccessibilityLiveRegion(View view, int i9) {
            view.setAccessibilityLiveRegion(i9);
        }

        @DoNotInline
        static void setContentChangeTypes(AccessibilityEvent accessibilityEvent, int i9) {
    ...
    public static class Api21Impl {
        ...
        @DoNotInline
        static boolean dispatchNestedPreScroll(View view, int i9, int i10, int[] iArr, int[] iArr2) {
            return view.dispatchNestedPreScroll(i9, i10, iArr, iArr2);
        }

        @DoNotInline
        static boolean dispatchNestedScroll(View view, int i9, int i10, int i11, int i12, int[] iArr) {
        ...
        @DoNotInline
        static boolean startNestedScroll(View view, int i9) {
    ...
    private static class Api23Impl {
        ...
        @DoNotInline
        static void setScrollIndicators(@NonNull View view, int i9) {
            view.setScrollIndicators(i9);
        }

        @DoNotInline
        static void setScrollIndicators(@NonNull View view, int i9, int i10) {
    ...
    static class Api24Impl {
        ...
        @DoNotInline
        static boolean startDragAndDrop(@NonNull View view, @Nullable ClipData clipData, @NonNull View.DragShadowBuilder dragShadowBuilder, @Nullable Object obj, int i9) {
    ...
    public static class Api26Impl {
        ...
        @DoNotInline
        static void addKeyboardNavigationClusters(@NonNull View view, Collection<View> collection, int i9) {
        ...
        @DoNotInline
        static View keyboardNavigationClusterSearch(@NonNull View view, View view2, int i9) {
        ...
        @DoNotInline
        static void setImportantForAutofill(View view, int i9) {
        ...
        @DoNotInline
        static void setNextClusterForwardId(View view, int i9) {
    ...
    public static class Api28Impl {
        ...
        static void addOnUnhandledKeyEventListener(@NonNull View view, @NonNull final OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
            ...
            SimpleArrayMap simpleArrayMap = (SimpleArrayMap) view.getTag(i9);
            if (simpleArrayMap == null) {
                simpleArrayMap = new SimpleArrayMap();
                view.setTag(i9, simpleArrayMap);
            }
        ...
        @DoNotInline
        static <T> T requireViewById(View view, int i9) {
    ...
    public static class Api29Impl {
        ...
        @DoNotInline
        static void saveAttributeDataForStyleable(@NonNull View view, @NonNull Context context, @NonNull int[] iArr, @Nullable AttributeSet attributeSet, @NonNull TypedArray typedArray, int i9, int i10) {
    ...
    static class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager at(View view) {
            ...
            UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(i9);
            if (unhandledKeyEventManager == null) {
                UnhandledKeyEventManager unhandledKeyEventManager2 = new UnhandledKeyEventManager();
                view.setTag(i9, unhandledKeyEventManager2);
    ...
    public static void addKeyboardNavigationClusters(@NonNull View view, @NonNull Collection<View> collection, int i9) {
        if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.addKeyboardNavigationClusters(view, collection, i9);
        }
    }
    ...
    public static boolean dispatchNestedPreScroll(@NonNull View view, int i9, int i10, @Nullable int[] iArr, @Nullable int[] iArr2) {
        return Api21Impl.dispatchNestedPreScroll(view, i9, i10, iArr, iArr2);
    }

    public static boolean dispatchNestedScroll(@NonNull View view, int i9, int i10, int i11, int i12, @Nullable int[] iArr) {
        return Api21Impl.dispatchNestedScroll(view, i9, i10, i11, i12, iArr);
    }
    ...
    private static int getAvailableActionIdFromResources(View view, @NonNull CharSequence charSequence) {
        ...
        for (int i9 = 0; i9 < actionList.size(); i9++) {
            if (TextUtils.equals(charSequence, actionList.get(i9).getLabel())) {
                return actionList.get(i9).getId();
            }
        }
        int i10 = 0;
        int i11 = -1;
        while (true) {
            ...
            for (int i13 = 0; i13 < actionList.size(); i13++) {
                z10 &= actionList.get(i13).getId() != i12;
            }
            if (z10) {
                i11 = i12;
            }
    ...
    public static View keyboardNavigationClusterSearch(@NonNull View view, @Nullable View view2, int i9) {
        if (Build.VERSION.SDK_INT >= 26) {
            return Api26Impl.keyboardNavigationClusterSearch(view, view2, i9);
        }
        return null;
    }
    ...
    @RequiresApi(19)
    static void notifyViewAccessibilityStateChangedIfNeeded(View view, int i9) {
        AccessibilityManager accessibilityManager = (AccessibilityManager) view.getContext().getSystemService("accessibility");
        if (accessibilityManager.isEnabled()) {
            boolean z10 = getAccessibilityPaneTitle(view) != null && view.getVisibility() == 0;
            if (getAccessibilityLiveRegion(view) != 0 || z10) {
                AccessibilityEvent obtain = AccessibilityEvent.obtain();
                obtain.setEventType(z10 ? 32 : 2048);
                Api19Impl.setContentChangeTypes(obtain, i9);
                if (z10) {
                ...
                Api19Impl.setContentChangeTypes(obtain2, i9);
                ...
                try {
                    Api19Impl.notifySubtreeAccessibilityStateChanged(view.getParent(), view, view, i9);
    ...
    public static void offsetLeftAndRight(@NonNull View view, int i9) {
        ...
        compatOffsetLeftAndRight(view, i9);
    ...
    public static void offsetTopAndBottom(@NonNull View view, int i9) {
        ...
        compatOffsetTopAndBottom(view, i9);
        if (z10 && emptyTempRect.intersect(view.getLeft(), view.getTop(), view.getRight(), view.getBottom())) {
            ((View) parent).invalidate(emptyTempRect);
        }
    }
    ...
    public static boolean performAccessibilityAction(@NonNull View view, int i9, @Nullable Bundle bundle) {
        return Api16Impl.performAccessibilityAction(view, i9, bundle);
    }
    ...
    private static void removeActionWithId(int i9, View view) {
        ...
        for (int i10 = 0; i10 < actionList.size(); i10++) {
            if (actionList.get(i10).getId() == i9) {
    ...
    @NonNull
    public static <T extends View> T requireViewById(@NonNull View view, @IdRes int i9) {
        if (Build.VERSION.SDK_INT >= 28) {
            return (T) Api28Impl.requireViewById(view, i9);
        }
    ...
    public static void saveAttributeDataForStyleable(@NonNull View view, @NonNull Context context, @NonNull int[] iArr, @Nullable AttributeSet attributeSet, @NonNull TypedArray typedArray, int i9, int i10) {
        if (Build.VERSION.SDK_INT >= 29) {
            Api29Impl.saveAttributeDataForStyleable(view, context, iArr, attributeSet, typedArray, i9, i10);
        }
    }
    ...
    public static void setAccessibilityLiveRegion(@NonNull View view, int i9) {
        Api19Impl.setAccessibilityLiveRegion(view, i9);
    }
    ...
    public static void setImportantForAccessibility(@NonNull View view, int i9) {
        Api16Impl.setImportantForAccessibility(view, i9);
    }

    public static void setImportantForAutofill(@NonNull View view, int i9) {
        if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setImportantForAutofill(view, i9);
        }
    }
    ...
    public static void setLabelFor(@NonNull View view, @IdRes int i9) {
        Api17Impl.setLabelFor(view, i9);
    }
    ...
    public static void setLayoutDirection(@NonNull View view, int i9) {
        Api17Impl.setLayoutDirection(view, i9);
    }
    ...
    public static void setNextClusterForwardId(@NonNull View view, int i9) {
        if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setNextClusterForwardId(view, i9);
        }
    }
    ...
    public static void setOnReceiveContentListener(@NonNull View view, @Nullable String[] strArr, @Nullable OnReceiveContentListener onReceiveContentListener) {
        ...
        if (strArr != null) {
            ...
            while (true) {
                if (i9 >= length) {
                    break;
                } else if (strArr[i9].startsWith(ProxyConfig.MATCH_ALL_SCHEMES)) {
                    z10 = true;
                    break;
                } else {
                    i9++;
    ...
    public static void setPaddingRelative(@NonNull View view, @Px int i9, @Px int i10, @Px int i11, @Px int i12) {
        Api17Impl.setPaddingRelative(view, i9, i10, i11, i12);
    }
    ...
    public static void setScrollIndicators(@NonNull View view, int i9) {
        if (Build.VERSION.SDK_INT >= 23) {
            Api23Impl.setScrollIndicators(view, i9);
        }
    }
    ...
    public static boolean startDragAndDrop(@NonNull View view, @Nullable ClipData clipData, @NonNull View.DragShadowBuilder dragShadowBuilder, @Nullable Object obj, int i9) {
        if (Build.VERSION.SDK_INT >= 24) {
            return Api24Impl.startDragAndDrop(view, clipData, dragShadowBuilder, obj, i9);
        }
        return view.startDrag(clipData, dragShadowBuilder, obj, i9);
    }

    public static boolean startNestedScroll(@NonNull View view, int i9) {
        return Api21Impl.startNestedScroll(view, i9);
    }
    ...
    public static boolean dispatchNestedPreScroll(@NonNull View view, int i9, int i10, @Nullable int[] iArr, @Nullable int[] iArr2, int i11) {
        if (view instanceof NestedScrollingChild2) {
            return ((NestedScrollingChild2) view).dispatchNestedPreScroll(i9, i10, iArr, iArr2, i11);
        }
        if (i11 == 0) {
    ...
    public static void dispatchNestedScroll(@NonNull View view, int i9, int i10, int i11, int i12, @Nullable int[] iArr, int i13, @NonNull int[] iArr2) {
        if (view instanceof NestedScrollingChild3) {
            ((NestedScrollingChild3) view).dispatchNestedScroll(i9, i10, i11, i12, iArr, i13, iArr2);
        } else {
    ...
    public static boolean hasNestedScrollingParent(@NonNull View view, int i9) {
        if (view instanceof NestedScrollingChild2) {
            ((NestedScrollingChild2) view).hasNestedScrollingParent(i9);
            return false;
        } else if (i9 == 0) {
    ...
    public static void postInvalidateOnAnimation(@NonNull View view, int i9, int i10, int i11, int i12) {
        Api16Impl.postInvalidateOnAnimation(view, i9, i10, i11, i12);
    }

    public static boolean startNestedScroll(@NonNull View view, int i9, int i10) {
        if (view instanceof NestedScrollingChild2) {
            return ((NestedScrollingChild2) view).startNestedScroll(i9, i10);
        }
        if (i10 == 0) {
    ...
    public static void stopNestedScroll(@NonNull View view, int i9) {
        if (view instanceof NestedScrollingChild2) {
            ((NestedScrollingChild2) view).stopNestedScroll(i9);
        } else if (i9 == 0) {
    ...
    public static void setScrollIndicators(@NonNull View view, int i9, int i10) {
        if (Build.VERSION.SDK_INT >= 23) {
            Api23Impl.setScrollIndicators(view, i9, i10);
        }
    }
    ...
    public static boolean dispatchNestedScroll(@NonNull View view, int i9, int i10, int i11, int i12, @Nullable int[] iArr, int i13) {
        if (view instanceof NestedScrollingChild2) {
            return ((NestedScrollingChild2) view).dispatchNestedScroll(i9, i10, i11, i12, iArr, i13);
        }
        if (i13 == 0) {
