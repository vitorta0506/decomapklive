...
public final class WindowInsetsAnimationCompat {
    ...
    public static class Impl {
        ...
        Impl(int i9, @Nullable Interpolator interpolator, long j10) {
            this.mTypeMask = i9;
    ...
    public static class Impl21 extends Impl {
        ...
        Impl21(int i9, @Nullable Interpolator interpolator, long j10) {
        ...
        @NonNull
        static BoundsCompat computeAnimationBounds(@NonNull WindowInsetsCompat windowInsetsCompat, @NonNull WindowInsetsCompat windowInsetsCompat2, int i9) {
        ...
        static void dispatchOnEnd(@NonNull View view, @NonNull WindowInsetsAnimationCompat windowInsetsAnimationCompat) {
            ...
            if (view instanceof ViewGroup) {
                ...
                for (int i9 = 0; i9 < viewGroup.getChildCount(); i9++) {
                    dispatchOnEnd(viewGroup.getChildAt(i9), windowInsetsAnimationCompat);
                }
            }
        }
        ...
        static void dispatchOnPrepare(View view, WindowInsetsAnimationCompat windowInsetsAnimationCompat, WindowInsets windowInsets, boolean z10) {
            ...
            if (view instanceof ViewGroup) {
                ViewGroup viewGroup = (ViewGroup) view;
                for (int i9 = 0; i9 < viewGroup.getChildCount(); i9++) {
                    dispatchOnPrepare(viewGroup.getChildAt(i9), windowInsetsAnimationCompat, windowInsets, z10);
                }
            }
        }
        ...
        static void dispatchOnProgress(@NonNull View view, @NonNull WindowInsetsCompat windowInsetsCompat, @NonNull List<WindowInsetsAnimationCompat> list) {
            ...
            if (view instanceof ViewGroup) {
                ViewGroup viewGroup = (ViewGroup) view;
                for (int i9 = 0; i9 < viewGroup.getChildCount(); i9++) {
                    dispatchOnProgress(viewGroup.getChildAt(i9), windowInsetsCompat, list);
                }
            }
        }
        ...
        static void dispatchOnStart(View view, WindowInsetsAnimationCompat windowInsetsAnimationCompat, BoundsCompat boundsCompat) {
            ...
            if (view instanceof ViewGroup) {
                ViewGroup viewGroup = (ViewGroup) view;
                for (int i9 = 0; i9 < viewGroup.getChildCount(); i9++) {
                    dispatchOnStart(viewGroup.getChildAt(i9), windowInsetsAnimationCompat, boundsCompat);
                }
            }
        }
        ...
        static WindowInsetsCompat interpolateInsets(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, float f10, int i9) {
            ...
            for (int i10 = 1; i10 <= 256; i10 <<= 1) {
                if ((i9 & i10) == 0) {
                    ...
                    float f11 = 1.0f - f10;
                    builder.setInsets(i10, WindowInsetsCompat.insetInsets(insets, (int) (((insets.left - insets2.left) * f11) + 0.5d), (int) (((insets.top - insets2.top) * f11) + 0.5d), (int) (((insets.right - insets2.right) * f11) + 0.5d), (int) (((insets.bottom - insets2.bottom) * f11) + 0.5d)));
                }
            }
    ...
    public WindowInsetsAnimationCompat(int i9, @Nullable Interpolator interpolator, long j10) {
        if (Build.VERSION.SDK_INT >= 30) {
            this.mImpl = new Impl30(i9, interpolator, j10);
        } else {
            this.mImpl = new Impl21(i9, interpolator, j10);
        }
    }
    ...
    public static class Impl30 extends Impl {
        ...
        Impl30(int i9, Interpolator interpolator, long j10) {
