...
public final class InputConnectionCompat {
    ...
    public interface OnCommitContentListener {
        boolean onCommitContent(@NonNull InputContentInfoCompat inputContentInfoCompat, int i9, @Nullable Bundle bundle);
    }

    public static boolean commitContent(@NonNull InputConnection inputConnection, @NonNull EditorInfo editorInfo, @NonNull InputContentInfoCompat inputContentInfoCompat, int i9, @Nullable Bundle bundle) {
        boolean z10;
        ...
        while (true) {
            if (i10 >= length) {
                z10 = false;
                break;
            } else if (description.hasMimeType(contentMimeTypes[i10])) {
                z10 = true;
                break;
            } else {
                i10++;
        ...
        if (z10) {
            if (Build.VERSION.SDK_INT >= 25) {
                return inputConnection.commitContent((InputContentInfo) inputContentInfoCompat.unwrap(), i9, bundle);
            }
            ...
            bundle2.putInt(z11 ? COMMIT_CONTENT_FLAGS_INTEROP_KEY : COMMIT_CONTENT_FLAGS_KEY, i9);
    ...
    private static OnCommitContentListener createOnCommitContentListenerUsingPerformReceiveContent(@NonNull final View view) {
        ...
        return new OnCommitContentListener() { // from class: androidx.core.view.inputmethod.InputConnectionCompat.3
            ...
            public boolean onCommitContent(InputContentInfoCompat inputContentInfoCompat, int i9, Bundle bundle) {
                if (Build.VERSION.SDK_INT >= 25 && (i9 & 1) != 0) {
                    try {
                        ...
                        Log.w(InputConnectionCompat.LOG_TAG, "Can't insert content from IME; requestPermission() failed", e10);
                        return false;
                    }
                }
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            return new InputConnectionWrapper(inputConnection, false) { // from class: androidx.core.view.inputmethod.InputConnectionCompat.1
                ...
                public boolean commitContent(InputContentInfo inputContentInfo, int i9, Bundle bundle) {
                    if (onCommitContentListener.onCommitContent(InputContentInfoCompat.wrap(inputContentInfo), i9, bundle)) {
                        return true;
                    }
    ...
    static boolean handlePerformPrivateCommand(@Nullable String str, @Nullable Bundle bundle, @NonNull OnCommitContentListener onCommitContentListener) {
        ...
        try {
            ...
            try {
                ...
                int i9 = bundle.getInt(z10 ? COMMIT_CONTENT_FLAGS_INTEROP_KEY : COMMIT_CONTENT_FLAGS_KEY);
                Bundle bundle2 = (Bundle) bundle.getParcelable(z10 ? COMMIT_CONTENT_OPTS_INTEROP_KEY : COMMIT_CONTENT_OPTS_KEY);
                if (uri != null && clipDescription != null) {
                    r02 = onCommitContentListener.onCommitContent(new InputContentInfoCompat(uri, clipDescription, uri2), i9, bundle2);
                }
                if (resultReceiver != 0) {
