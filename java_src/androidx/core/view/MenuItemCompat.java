...
public final class MenuItemCompat {
    ...
    public static void setAlphabeticShortcut(MenuItem menuItem, char c10, int i9) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setAlphabeticShortcut(c10, i9);
    ...
    public static void setNumericShortcut(MenuItem menuItem, char c10, int i9) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setNumericShortcut(c10, i9);
        } else if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static void setShortcut(MenuItem menuItem, char c10, char c11, int i9, int i10) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setShortcut(c10, c11, i9, i10);
        } else if (Build.VERSION.SDK_INT >= 26) {
            menuItem.setShortcut(c10, c11, i9, i10);
        }
    }
    ...
    @Deprecated
    public static MenuItem setActionView(MenuItem menuItem, int i9) {
        return menuItem.setActionView(i9);
    }
}
