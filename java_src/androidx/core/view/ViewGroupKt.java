...
public final class ViewGroupKt {
    ...
    public static final void forEachIndexed(@NotNull ViewGroup viewGroup, @NotNull Function2<? super Integer, ? super View, Unit> action) {
        ...
        while (true) {
            ...
            View childAt = viewGroup.getChildAt(i9);
            Intrinsics.checkNotNullExpressionValue(childAt, "getChildAt(index)");
            action.mo1invoke(valueOf, childAt);
            if (i10 >= childCount) {
                return;
            }
            i9 = i10;
    ...
    @NotNull
    public static final View get(@NotNull ViewGroup viewGroup, int i9) {
        Intrinsics.checkNotNullParameter(viewGroup, "<this>");
        View childAt = viewGroup.getChildAt(i9);
        if (childAt != null) {
            return childAt;
    ...
    public static final void setMargins(@NotNull ViewGroup.MarginLayoutParams marginLayoutParams, @Px int i9) {
        Intrinsics.checkNotNullParameter(marginLayoutParams, "<this>");
        marginLayoutParams.setMargins(i9, i9, i9, i9);
    }

    public static final void updateMargins(@NotNull ViewGroup.MarginLayoutParams marginLayoutParams, @Px int i9, @Px int i10, @Px int i11, @Px int i12) {
        Intrinsics.checkNotNullParameter(marginLayoutParams, "<this>");
    ...
    @RequiresApi(17)
    public static final void updateMarginsRelative(@NotNull ViewGroup.MarginLayoutParams marginLayoutParams, @Px int i9, @Px int i10, @Px int i11, @Px int i12) {
        Intrinsics.checkNotNullParameter(marginLayoutParams, "<this>");
