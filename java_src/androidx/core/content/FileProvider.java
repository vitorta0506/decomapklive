...
public class FileProvider extends ContentProvider {
    ...
    private static final File DEVICE_ROOT = new File(FileUtils.RES_PREFIX_STORAGE);
    @GuardedBy("sCache")
        ...
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                if (entry != null) {
                    ...
                    if (path2.endsWith(FileUtils.RES_PREFIX_STORAGE)) {
                        substring = canonicalPath.substring(path2.length());
                    } else {
                        substring = canonicalPath.substring(path2.length() + 1);
                    }
                    return new Uri.Builder().scheme("content").authority(this.mAuthority).encodedPath(Uri.encode(entry.getKey()) + IOUtils.DIR_SEPARATOR_UNIX + Uri.encode(substring, FileUtils.RES_PREFIX_STORAGE)).build();
                }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] strArr, @Nullable String str, @Nullable String[] strArr2, @Nullable String str2) {
        ...
        for (String str3 : strArr) {
            if ("_display_name".equals(str3)) {
                ...
                i9 = i10 + 1;
                objArr[i10] = queryParameter == null ? fileForUri.getName() : queryParameter;
