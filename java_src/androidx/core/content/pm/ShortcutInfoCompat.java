...
public class ShortcutInfoCompat {
                    ...
                    if (this.mCapabilityBindingParams != null) {
                        ...
                        for (String str : this.mCapabilityBindingParams.keySet()) {
                            ...
                            for (String str2 : map.keySet()) {
                                ...
                                persistableBundle.putStringArray(str + FileUtils.RES_PREFIX_STORAGE + str2, list == null ? new String[0] : (String[]) list.toArray(new String[0]));
                            }
                        }
                    }
    ...
    private PersistableBundle buildLegacyExtrasBundle() {
        ...
        if (personArr != null && personArr.length > 0) {
            ...
            int i9 = 0;
            while (i9 < this.mPersons.length) {
                PersistableBundle persistableBundle = this.mExtras;
                StringBuilder sb2 = new StringBuilder();
                sb2.append(EXTRA_PERSON_);
                int i10 = i9 + 1;
                sb2.append(i10);
                persistableBundle.putPersistableBundle(sb2.toString(), this.mPersons[i9].toPersistableBundle());
                i9 = i10;
            }
        }
    ...
    static Person[] getPersonsFromExtra(@NonNull PersistableBundle persistableBundle) {
        ...
        while (i10 < i9) {
            ...
            int i11 = i10 + 1;
            sb2.append(i11);
            personArr[i10] = Person.fromPersistableBundle(persistableBundle.getPersistableBundle(sb2.toString()));
            i10 = i11;
        }
        return personArr;
    }
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (personArr != null && personArr.length > 0) {
                ...
                for (int i9 = 0; i9 < length; i9++) {
                    personArr2[i9] = this.mPersons[i9].toAndroidPerson();
                }
