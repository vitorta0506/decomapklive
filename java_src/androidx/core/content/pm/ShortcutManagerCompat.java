...
public class ShortcutManagerCompat {
    ...
    private static String getShortcutInfoCompatWithLowestRank(@NonNull List<ShortcutInfoCompat> list) {
        ...
        String str = null;
        for (ShortcutInfoCompat shortcutInfoCompat : list) {
            if (shortcutInfoCompat.getRank() > i9) {
                str = shortcutInfoCompat.getId();
                i9 = shortcutInfoCompat.getRank();
            }
        }
        return str;
    }
    ...
    @NonNull
    public static List<ShortcutInfoCompat> getShortcuts(@NonNull Context context, int i9) {
        int i10 = Build.VERSION.SDK_INT;
        if (i10 >= 30) {
            return ShortcutInfoCompat.fromShortcuts(context, ((ShortcutManager) context.getSystemService(ShortcutManager.class)).getShortcuts(i9));
        }
        if (i10 >= 25) {
