...
public class ContextCompat {
    ...
    public static class Api21Impl {
        ...
        @DoNotInline
        static Drawable getDrawable(Context context, int i9) {
    ...
    public static class Api23Impl {
        ...
        @DoNotInline
        static int getColor(Context context, int i9) {
    ...
    public static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            hashMap.put(ActivityManager.class, PushConstants.INTENT_ACTIVITY_NAME);
    ...
    @ColorInt
    public static int getColor(@NonNull Context context, @ColorRes int i9) {
        if (Build.VERSION.SDK_INT >= 23) {
            return Api23Impl.getColor(context, i9);
        }
    ...
    public static Drawable getDrawable(@NonNull Context context, @DrawableRes int i9) {
        return Api21Impl.getDrawable(context, i9);
    }
