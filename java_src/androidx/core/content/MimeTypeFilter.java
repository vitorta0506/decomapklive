...
public final class MimeTypeFilter {
    ...
    public static boolean matches(@Nullable String str, @NonNull String str2) {
        ...
        return mimeTypeAgainstFilter(str.split(FileUtils.RES_PREFIX_STORAGE), str2.split(FileUtils.RES_PREFIX_STORAGE));
    }
    ...
    public static String[] matchesMany(@Nullable String[] strArr, @NonNull String str) {
        ...
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(str2.split(FileUtils.RES_PREFIX_STORAGE), split)) {
                arrayList.add(str2);
            }
        }
    ...
    public static String matches(@Nullable String str, @NonNull String[] strArr) {
        ...
        String[] split = str.split(FileUtils.RES_PREFIX_STORAGE);
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(split, str2.split(FileUtils.RES_PREFIX_STORAGE))) {
                return str2;
            }
        }
        return null;
