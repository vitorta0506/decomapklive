...
public class CamColor {
    ...
    @NonNull
    static CamColor fromColorInViewingConditions(@ColorInt int i9, @NonNull ViewingConditions viewingConditions) {
        float pow;
        ...
        double d11 = f22;
        return new CamColor(f21, pow6, pow5, flRoot, flRoot2, sqrt, f23, log * ((float) Math.cos(d11)), log * ((float) Math.sin(d11)));
    }
