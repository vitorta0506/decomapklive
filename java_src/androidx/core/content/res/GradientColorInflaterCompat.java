...
public final class GradientColorInflaterCompat {
    ...
    private static ColorStops checkColors(@Nullable ColorStops colorStops, @ColorInt int i9, @ColorInt int i10, boolean z10, @ColorInt int i11) {
        if (colorStops != null) {
            return colorStops;
        }
        if (z10) {
            return new ColorStops(i9, i11, i10);
        }
        return new ColorStops(i9, i10);
    }
    ...
    */
    ...
    private static Shader.TileMode parseTileMode(int i9) {
        if (i9 != 1) {
            if (i9 != 2) {
    ...
    public static final class ColorStops {
        ...
        ColorStops(@NonNull List<Integer> list, @NonNull List<Float> list2) {
            ...
            for (int i9 = 0; i9 < size; i9++) {
                this.mColors[i9] = list.get(i9).intValue();
                this.mOffsets[i9] = list2.get(i9).floatValue();
            }
        }

        ColorStops(@ColorInt int i9, @ColorInt int i10) {
            this.mColors = new int[]{i9, i10};
            this.mOffsets = new float[]{0.0f, 1.0f};
        }

        ColorStops(@ColorInt int i9, @ColorInt int i10, @ColorInt int i11) {
            this.mColors = new int[]{i9, i10, i11};
