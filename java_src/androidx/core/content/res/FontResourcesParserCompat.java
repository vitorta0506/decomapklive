...
public class FontResourcesParserCompat {
    ...
    public static final class FontFileResourceEntry {
        ...
        public FontFileResourceEntry(@NonNull String str, int i9, boolean z10, @Nullable String str2, int i10, int i11) {
            this.mFileName = str;
            this.mWeight = i9;
            this.mItalic = z10;
    ...
    private static int getType(TypedArray typedArray, int i9) {
    ...
    public static List<List<byte[]>> readCerts(Resources resources, @ArrayRes int i9) {
        if (i9 == 0) {
        ...
        try {
            ...
            if (getType(obtainTypedArray, 0) == 1) {
                ...
                arrayList.add(toByteArrayList(resources.getStringArray(i9)));
            }
            return arrayList;
        } finally {
    ...
    private static FontFileResourceEntry readFont(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        ...
        int i9 = R.styleable.FontFamilyFont_fontWeight;
        if (!obtainAttributes.hasValue(i9)) {
            i9 = R.styleable.FontFamilyFont_android_fontWeight;
        }
        ...
        boolean z10 = 1 == obtainAttributes.getInt(i11, 0);
        ...
        return new FontFileResourceEntry(string2, i10, z10, string, i14, resourceId);
    }
    ...
    public static final class ProviderResourceEntry implements FamilyResourceEntry {
        ...
        public ProviderResourceEntry(@NonNull FontRequest fontRequest, int i9, int i10, @Nullable String str) {
        ...
        public ProviderResourceEntry(@NonNull FontRequest fontRequest, int i9, int i10) {
            this(fontRequest, i9, i10, null);
        }
    }
}
