...
public final class ComplexColorCompat {
    ...
    private ComplexColorCompat(Shader shader, ColorStateList colorStateList, @ColorInt int i9) {
        this.mShader = shader;
    ...
    @NonNull
    private static ComplexColorCompat createFromXml(@NonNull Resources resources, @ColorRes int i9, @Nullable Resources.Theme theme) throws IOException, XmlPullParserException {
        int next;
    ...
    @Nullable
    public static ComplexColorCompat inflate(@NonNull Resources resources, @ColorRes int i9, @Nullable Resources.Theme theme) {
        try {
            return createFromXml(resources, i9, theme);
        } catch (Exception e10) {
    ...
    public static ComplexColorCompat from(@ColorInt int i9) {
