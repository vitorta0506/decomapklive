...
final class CamUtils {
    ...
    static float linearized(int i9) {
        float f10 = i9 / 255.0f;
    ...
    public static float[] xyzFromInt(int i9) {
        float linearized = linearized(Color.red(i9));
        float linearized2 = linearized(Color.green(i9));
        float linearized3 = linearized(Color.blue(i9));
