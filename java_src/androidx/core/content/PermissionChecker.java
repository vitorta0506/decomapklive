...
public final class PermissionChecker {
    ...
    public static int checkPermission(@NonNull Context context, @NonNull String str, int i9, int i10, @Nullable String str2) {
        ...
        if (Process.myUid() == i10 && ObjectsCompat.equals(context.getPackageName(), str2)) {
            noteProxyOpNoThrow = AppOpsManagerCompat.checkOrNoteProxyOp(context, i10, permissionToOp, str2);
        } else {
