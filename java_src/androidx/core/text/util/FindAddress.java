...
class FindAddress {
    ...
    public static class ZipRange {
        ...
        ZipRange(int i9, int i10, int i11, int i12) {
            this.mLow = i9;
            this.mHigh = i10;
    ...
    */
    ...
    private static boolean checkHouseNumber(String str) {
        ...
        if (matcher.find()) {
            ...
            if (i11 == 1) {
                ...
                return lowerCase.equals(Language.THAILAND);
            } else {
                if (parseInt % 100 != 13) {
                    str2 = "rd";
                }
    ...
    @VisibleForTesting
    public static MatchResult matchHouseNumber(String str, int i9) {
        if (i9 <= 0 || HOUSE_PRE_DELIM.indexOf(str.charAt(i9 - 1)) != -1) {
            Matcher region = sHouseNumberRe.matcher(str).region(i9, str.length());
            if (region.lookingAt()) {
    ...
    @VisibleForTesting
    public static MatchResult matchState(String str, int i9) {
        if (i9 <= 0 || WORD_DELIM.indexOf(str.charAt(i9 - 1)) != -1) {
            Matcher region = sStateRe.matcher(str).region(i9, str.length());
            if (region.lookingAt()) {
