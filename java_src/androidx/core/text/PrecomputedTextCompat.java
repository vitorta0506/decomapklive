...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static PrecomputedTextCompat create(@NonNull CharSequence charSequence, @NonNull Params params) {
        ...
        try {
            ...
            int i9 = 0;
            while (i9 < length) {
                int indexOf = TextUtils.indexOf(charSequence, (char) LINE_FEED, i9, length);
    ...
    @IntRange(from = 0)
    public int getParagraphEnd(@IntRange(from = 0) int i9) {
        Preconditions.checkArgumentInRange(i9, 0, getParagraphCount(), "paraIndex");
        if (Build.VERSION.SDK_INT >= 29) {
            return this.mWrapped.getParagraphEnd(i9);
        }
        return this.mParagraphEnds[i9];
    }

    @IntRange(from = 0)
    public int getParagraphStart(@IntRange(from = 0) int i9) {
        Preconditions.checkArgumentInRange(i9, 0, getParagraphCount(), "paraIndex");
        if (Build.VERSION.SDK_INT >= 29) {
            return this.mWrapped.getParagraphStart(i9);
        }
        if (i9 == 0) {
            return 0;
        }
        return this.mParagraphEnds[i9 - 1];
    }
    ...
    public <T> T[] getSpans(int i9, int i10, Class<T> cls) {
        if (Build.VERSION.SDK_INT >= 29) {
            return (T[]) this.mWrapped.getSpans(i9, i10, cls);
        }
        return (T[]) this.mText.getSpans(i9, i10, cls);
    }
    ...
    public int nextSpanTransition(int i9, int i10, Class cls) {
        return this.mText.nextSpanTransition(i9, i10, cls);
    }
    ...
    public void setSpan(Object obj, int i9, int i10, int i11) {
        if (!(obj instanceof MetricAffectingSpan)) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mWrapped.setSpan(obj, i9, i10, i11);
                return;
            } else {
                this.mText.setSpan(obj, i9, i10, i11);
                return;
            }
        }
    ...
    public CharSequence subSequence(int i9, int i10) {
        return this.mText.subSequence(i9, i10);
    }
    ...
    public static final class Params {
        ...
        public static class Builder {
            ...
            @RequiresApi(23)
            public Builder setBreakStrategy(int i9) {
                this.mBreakStrategy = i9;
                return this;
            }

            @RequiresApi(23)
            public Builder setHyphenationFrequency(int i9) {
        ...
        Params(@NonNull TextPaint textPaint, @NonNull TextDirectionHeuristic textDirectionHeuristic, int i9, int i10) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mWrapped = new PrecomputedText.Params.Builder(textPaint).setBreakStrategy(i9).setHyphenationFrequency(i10).setTextDirection(textDirectionHeuristic).build();
            } else {
                this.mWrapped = null;
            }
            this.mPaint = textPaint;
