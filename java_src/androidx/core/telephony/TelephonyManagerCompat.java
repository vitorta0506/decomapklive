...
public class TelephonyManagerCompat {
    ...
    private static class Api23Impl {
        ...
        @DoNotInline
        static String getDeviceId(TelephonyManager telephonyManager, int i9) {
    ...
    public static String getImei(@NonNull TelephonyManager telephonyManager) {
        ...
        if (i9 >= 22 && (subscriptionId = getSubscriptionId(telephonyManager)) != Integer.MAX_VALUE && subscriptionId != -1) {
