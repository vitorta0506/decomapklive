...
public final class PopupWindowCompat {
    ...
    static class Api19Impl {
        ...
        @DoNotInline
        static void showAsDropDown(PopupWindow popupWindow, View view, int i9, int i10, int i11) {
    ...
    static class Api23Impl {
        ...
        @DoNotInline
        static void setWindowLayoutType(PopupWindow popupWindow, int i9) {
    ...
    public static void setWindowLayoutType(@NonNull PopupWindow popupWindow, int i9) {
        if (Build.VERSION.SDK_INT >= 23) {
            Api23Impl.setWindowLayoutType(popupWindow, i9);
            return;
        }
    ...
    public static void showAsDropDown(@NonNull PopupWindow popupWindow, @NonNull View view, int i9, int i10, int i11) {
        Api19Impl.showAsDropDown(popupWindow, view, i9, i10, i11);
    }
}
