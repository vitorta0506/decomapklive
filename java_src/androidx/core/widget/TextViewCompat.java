...
public final class TextViewCompat {
    ...
    public static class OreoCallback implements ActionMode.Callback {
        ...
        private void recomputeProcessTextMenuItems(Menu menu) {
            ...
            try {
                ...
                for (int i9 = 0; i9 < supportedActivities.size(); i9++) {
                    ResolveInfo resolveInfo = supportedActivities.get(i9);
                    menu.add(0, 0, i9 + 100, resolveInfo.loadLabel(packageManager)).setIntent(createProcessTextIntentForResolveInfo(resolveInfo, this.mTextView)).setShowAsAction(1);
                }
    ...
    public static void setAutoSizeTextTypeUniformWithConfiguration(@NonNull TextView textView, int i9, int i10, int i11, int i12) throws IllegalArgumentException {
        if (Build.VERSION.SDK_INT >= 27) {
            textView.setAutoSizeTextTypeUniformWithConfiguration(i9, i10, i11, i12);
        } else if (textView instanceof AutoSizeableTextView) {
            ((AutoSizeableTextView) textView).setAutoSizeTextTypeUniformWithConfiguration(i9, i10, i11, i12);
        }
    }

    public static void setAutoSizeTextTypeUniformWithPresetSizes(@NonNull TextView textView, @NonNull int[] iArr, int i9) throws IllegalArgumentException {
        if (Build.VERSION.SDK_INT >= 27) {
            textView.setAutoSizeTextTypeUniformWithPresetSizes(iArr, i9);
        } else if (textView instanceof AutoSizeableTextView) {
            ((AutoSizeableTextView) textView).setAutoSizeTextTypeUniformWithPresetSizes(iArr, i9);
        }
    }

    public static void setAutoSizeTextTypeWithDefaults(@NonNull TextView textView, int i9) {
        if (Build.VERSION.SDK_INT >= 27) {
            textView.setAutoSizeTextTypeWithDefaults(i9);
        } else if (textView instanceof AutoSizeableTextView) {
            ((AutoSizeableTextView) textView).setAutoSizeTextTypeWithDefaults(i9);
        }
    }
    ...
    public static void setFirstBaselineToTopHeight(@NonNull TextView textView, @IntRange(from = 0) @Px int i9) {
        int i10;
        Preconditions.checkArgumentNonnegative(i9);
    ...
    public static void setLastBaselineToBottomHeight(@NonNull TextView textView, @IntRange(from = 0) @Px int i9) {
        int i10;
        Preconditions.checkArgumentNonnegative(i9);
        Paint.FontMetricsInt fontMetricsInt = textView.getPaint().getFontMetricsInt();
        if (textView.getIncludeFontPadding()) {
    ...
    public static void setLineHeight(@NonNull TextView textView, @IntRange(from = 0) @Px int i9) {
        Preconditions.checkArgumentNonnegative(i9);
        int fontMetricsInt = textView.getPaint().getFontMetricsInt(null);
        if (i9 != fontMetricsInt) {
            textView.setLineSpacing(i9 - fontMetricsInt, 1.0f);
        }
    }
    ...
    public static void setTextAppearance(@NonNull TextView textView, @StyleRes int i9) {
    ...
    public static ActionMode.Callback wrapCustomSelectionActionModeCallback(@NonNull TextView textView, @Nullable ActionMode.Callback callback) {
        int i9 = Build.VERSION.SDK_INT;
        return (i9 < 26 || i9 > 27 || (callback instanceof OreoCallback) || callback == null) ? callback : new OreoCallback(callback, textView);
    }

    public static void setCompoundDrawablesRelativeWithIntrinsicBounds(@NonNull TextView textView, @DrawableRes int i9, @DrawableRes int i10, @DrawableRes int i11, @DrawableRes int i12) {
