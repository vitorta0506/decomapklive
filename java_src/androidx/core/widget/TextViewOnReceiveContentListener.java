...
public final class TextViewOnReceiveContentListener implements OnReceiveContentListener {
    ...
    public static final class Api16Impl {
        ...
        static CharSequence coerce(@NonNull Context context, @NonNull ClipData.Item item, int i9) {
            if ((i9 & 1) != 0) {
    ...
    private static final class ApiImpl {
        ...
        static CharSequence coerce(@NonNull Context context, @NonNull ClipData.Item item, int i9) {
            CharSequence coerceToText = item.coerceToText(context);
            return ((i9 & 1) == 0 || !(coerceToText instanceof Spanned)) ? coerceToText : coerceToText.toString();
        }
    }

    private static CharSequence coerceToText(@NonNull Context context, @NonNull ClipData.Item item, int i9) {
        return Api16Impl.coerce(context, item, i9);
    }
    ...
    public ContentInfoCompat onReceiveContent(@NonNull View view, @NonNull ContentInfoCompat contentInfoCompat) {
        ...
        for (int i9 = 0; i9 < clip.getItemCount(); i9++) {
            CharSequence coerceToText = coerceToText(context, clip.getItemAt(i9), flags);
