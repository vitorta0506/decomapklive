...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    public static class ClampedScroller {
        ...
        public void setRampDownDuration(int i9) {
            this.mRampDownDuration = i9;
        }

        public void setRampUpDuration(int i9) {
            this.mRampUpDuration = i9;
        }
    ...
    private float computeTargetVelocity(int i9, float f10, float f11, float f12) {
        float edgeValue = getEdgeValue(this.mRelativeEdges[i9], f11, this.mMaximumEdges[i9], f10);
        int i10 = (edgeValue > 0.0f ? 1 : (edgeValue == 0.0f ? 0 : -1));
        if (i10 == 0) {
            return 0.0f;
        }
        float f13 = this.mRelativeVelocity[i9];
        float f14 = this.mMinimumVelocity[i9];
        float f15 = this.mMaximumVelocity[i9];
        float f16 = f13 * f12;
        if (i10 > 0) {
    ...
    static int constrain(int i9, int i10, int i11) {
    ...
    private void startAnimating() {
        ...
        if (!this.mAlreadyDelayed && (i9 = this.mActivationDelay) > 0) {
            ViewCompat.postOnAnimationDelayed(this.mTarget, this.mRunnable, i9);
        } else {
            this.mRunnable.run();
        }
    ...
    */
    ...
    public AutoScrollHelper setRampDownDuration(int i9) {
        this.mScroller.setRampDownDuration(i9);
        return this;
    }

    @NonNull
    public AutoScrollHelper setRampUpDuration(int i9) {
        this.mScroller.setRampUpDuration(i9);
        return this;
    }
