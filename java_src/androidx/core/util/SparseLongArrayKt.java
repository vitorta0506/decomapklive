...
public final class SparseLongArrayKt {
    ...
    public static final void forEach(@NotNull SparseLongArray sparseLongArray, @NotNull Function2<? super Integer, ? super Long, Unit> action) {
        ...
        while (true) {
            int i10 = i9 + 1;
            action.mo1invoke(Integer.valueOf(sparseLongArray.keyAt(i9)), Long.valueOf(sparseLongArray.valueAt(i9)));
            if (i10 >= size) {
                return;
            }
            i9 = i10;
    ...
    @RequiresApi(18)
    public static final long getOrDefault(@NotNull SparseLongArray sparseLongArray, int i9, long j10) {
        Intrinsics.checkNotNullParameter(sparseLongArray, "<this>");
        return sparseLongArray.get(i9, j10);
    }

    @RequiresApi(18)
    public static final long getOrElse(@NotNull SparseLongArray sparseLongArray, int i9, @NotNull Function0<Long> defaultValue) {
        Intrinsics.checkNotNullParameter(sparseLongArray, "<this>");
    ...
    public static final IntIterator keyIterator(@NotNull final SparseLongArray sparseLongArray) {
        ...
        return new IntIterator() { // from class: androidx.core.util.SparseLongArrayKt$keyIterator$1
            ...
            public int nextInt() {
                ...
                int i9 = this.index;
                this.index = i9 + 1;
                return sparseLongArray2.keyAt(i9);
            }
    ...
    @RequiresApi(18)
    public static final boolean remove(@NotNull SparseLongArray sparseLongArray, int i9, long j10) {
        Intrinsics.checkNotNullParameter(sparseLongArray, "<this>");
        int indexOfKey = sparseLongArray.indexOfKey(i9);
    ...
    @RequiresApi(18)
    public static final void set(@NotNull SparseLongArray sparseLongArray, int i9, long j10) {
        Intrinsics.checkNotNullParameter(sparseLongArray, "<this>");
    ...
    public static final LongIterator valueIterator(@NotNull final SparseLongArray sparseLongArray) {
        ...
        return new LongIterator() { // from class: androidx.core.util.SparseLongArrayKt$valueIterator$1
            ...
            public long nextLong() {
                ...
                int i9 = this.index;
                this.index = i9 + 1;
                return sparseLongArray2.valueAt(i9);
            }
