...
public final class LruCacheKt$lruCache$4<K, V> extends LruCache<K, V> {
    ...
    public LruCacheKt$lruCache$4(Function2<? super K, ? super V, Integer> function2, Function1<? super K, ? extends V> function1, Function4<? super Boolean, ? super K, ? super V, ? super V, Unit> function4, int i9) {
        super(i9);
    ...
    protected int sizeOf(@NotNull K key, @NotNull V value) {
        ...
        return this.$sizeOf.mo1invoke(key, value).intValue();
    }
}
