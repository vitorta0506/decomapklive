...
public final class SparseArrayKt {
    ...
    public static final <T> void forEach(@NotNull SparseArray<T> sparseArray, @NotNull Function2<? super Integer, ? super T, Unit> action) {
        ...
        while (true) {
            int i10 = i9 + 1;
            action.mo1invoke(Integer.valueOf(sparseArray.keyAt(i9)), sparseArray.valueAt(i9));
            if (i10 >= size) {
                return;
            }
            i9 = i10;
    ...
    public static final <T> T getOrDefault(@NotNull SparseArray<T> sparseArray, int i9, T t10) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
        T t11 = sparseArray.get(i9);
        return t11 == null ? t10 : t11;
    }

    public static final <T> T getOrElse(@NotNull SparseArray<T> sparseArray, int i9, @NotNull Function0<? extends T> defaultValue) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
    ...
    public static final <T> boolean remove(@NotNull SparseArray<T> sparseArray, int i9, T t10) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
    ...
    public static final <T> void set(@NotNull SparseArray<T> sparseArray, int i9, T t10) {
        Intrinsics.checkNotNullParameter(sparseArray, "<this>");
