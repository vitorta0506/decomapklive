...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            public Builder(int i9, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent) {
                this(i9 != 0 ? IconCompat.createWithResource(null, "", i9) : null, charSequence, pendingIntent, new Bundle(), null, true, 0, true, false);
            }
            ...
            private Builder(@Nullable IconCompat iconCompat, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @NonNull Bundle bundle, @Nullable RemoteInput[] remoteInputArr, boolean z10, int i9, boolean z11, boolean z12) {
        ...
        public static final class WearableExtender implements Extender {
            ...
            private void setFlag(int i9, boolean z10) {
                if (z10) {
        ...
        public IconCompat getIconCompat() {
            int i9;
            if (this.mIcon == null && (i9 = this.icon) != 0) {
                this.mIcon = IconCompat.createWithResource(null, "", i9);
            }
            return this.mIcon;
        }
        ...
        public Action(int i9, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @Nullable Bundle bundle, @Nullable RemoteInput[] remoteInputArr, @Nullable RemoteInput[] remoteInputArr2, boolean z10, int i10, boolean z11, boolean z12) {
            this(i9 != 0 ? IconCompat.createWithResource(null, "", i9) : null, charSequence, pendingIntent, bundle, remoteInputArr, remoteInputArr2, z10, i10, z11, z12);
        }

        Action(@Nullable IconCompat iconCompat, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @Nullable Bundle bundle, @Nullable RemoteInput[] remoteInputArr, @Nullable RemoteInput[] remoteInputArr2, boolean z10, int i9, boolean z11, boolean z12) {
            this.mShowsUserInterface = true;
            this.mIcon = iconCompat;
    ...
    public static final class BubbleMetadata {
        ...
        public static final class Builder {
            ...
            @NonNull
            private Builder setFlag(int i9, boolean z10) {
                if (z10) {
                    this.mFlags = i9 | this.mFlags;
                } else {
                    this.mFlags = (~i9) & this.mFlags;
        ...
        private BubbleMetadata(@Nullable PendingIntent pendingIntent, @Nullable PendingIntent pendingIntent2, @Nullable IconCompat iconCompat, int i9, @DimenRes int i10, int i11, @Nullable String str) {
            this.mPendingIntent = pendingIntent;
            this.mIcon = iconCompat;
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context, @NonNull Notification notification) {
            ...
            int i9 = Build.VERSION.SDK_INT;
            if (i9 >= 24 && bundle.containsKey(NotificationCompat.EXTRA_CHRONOMETER_COUNT_DOWN)) {
                setChronometerCountDown(bundle.getBoolean(NotificationCompat.EXTRA_CHRONOMETER_COUNT_DOWN));
            }
            if (i9 < 26 || !bundle.containsKey(NotificationCompat.EXTRA_COLORIZED)) {
                return;
            }
        ...
        public Builder addInvisibleAction(int i9, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent) {
            this.mInvisibleActions.add(new Action(i9, charSequence, pendingIntent));
            return this;
        }
        ...
        @NonNull
        public Builder setProgress(int i9, int i10, boolean z10) {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (z10) {
                i9 = R.layout.notification_action_tombstone;
            } else {
                i9 = R.layout.notification_action;
            }
    ...
    public static abstract class Style {
        ...
        private Bitmap createIconWithBackground(int i9, int i10, int i11, int i12) {
            ...
            Drawable mutate = this.mBuilder.mContext.getResources().getDrawable(i9).mutate();
        ...
        */
        ...
        public Bitmap createColoredBitmap(int i9, int i10) {
            return createColoredBitmap(i9, i10, 0);
        }
        ...
        Bitmap createColoredBitmap(@NonNull IconCompat iconCompat, int i9) {
            return createColoredBitmap(iconCompat, i9, 0);
        }

        private Bitmap createColoredBitmap(int i9, int i10, int i11) {
            return createColoredBitmap(IconCompat.createWithResource(this.mBuilder.mContext, i9), i10, i11);
        }

        private Bitmap createColoredBitmap(@NonNull IconCompat iconCompat, int i9, int i10) {
            ...
            if (bundle != null) {
                ...
                if (parcelableArrayList != null) {
                    ...
                    for (int i9 = 0; i9 < size; i9++) {
                        actionArr[i9] = NotificationCompat.getActionCompatFromAction((Notification.Action) parcelableArrayList.get(i9));
                    }
    ...
    static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        if (i12 >= 28) {
            i9 = action.getSemanticAction();
        } else {
            i9 = action.getExtras().getInt("android.support.action.semanticAction", 0);
        }
        int i13 = i9;
        boolean isContextual = i12 >= 29 ? action.isContextual() : false;
        if (i12 >= 23) {
            if (action.getIcon() == null && (i10 = action.icon) != 0) {
                return new Action(i10, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z11, i13, z12, isContextual);
            }
            return new Action(action.getIcon() != null ? IconCompat.createFromIconOrNullIfZeroResId(action.getIcon()) : null, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z11, i13, z12, isContextual);
        }
        return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z11, i13, z12, isContextual);
    }
    ...
    public static List<Action> getInvisibleActions(@NonNull Notification notification) {
        ...
        if (bundle2 != null && (bundle = bundle2.getBundle("invisible_actions")) != null) {
            for (int i9 = 0; i9 < bundle.size(); i9++) {
                arrayList.add(NotificationCompatJellybean.getActionFromBundle(bundle.getBundle(Integer.toString(i9))));
            }
        }
        return arrayList;
    }
    ...
    public static final class CarExtender implements Extender {
        ...
        private static Bundle getBundleForUnreadConversation(@NonNull UnreadConversation unreadConversation) {
            ...
            for (int i9 = 0; i9 < length; i9++) {
                ...
                bundle2.putString("text", unreadConversation.getMessages()[i9]);
    ...
    public static class MessagingStyle extends Style {
        ...
        @NonNull
        private TextAppearanceSpan makeFontColorSpan(int i9) {
        ...
        private CharSequence makeMessageLine(@NonNull Message message) {
            ...
            if (TextUtils.isEmpty(name)) {
                ...
                if (this.mBuilder.getColor() != 0) {
                    i9 = this.mBuilder.getColor();
                }
            }
            CharSequence unicodeWrap = bidiFormatter.unicodeWrap(name);
            spannableStringBuilder.append(unicodeWrap);
            spannableStringBuilder.setSpan(makeFontColorSpan(i9), spannableStringBuilder.length() - unicodeWrap.length(), spannableStringBuilder.length(), 33);
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                ...
                CharSequence makeMessageLine = z10 ? makeMessageLine(message3) : message3.getText();
        ...
        public static final class Message {
            ...
            static Bundle[] getBundleArrayForMessages(@NonNull List<Message> list) {
                ...
                int size = list.size();
                for (int i9 = 0; i9 < size; i9++) {
                    bundleArr[i9] = list.get(i9).toBundle();
                }
                return bundleArr;
            }
            ...
            static List<Message> getMessagesFromBundleArray(@NonNull Parcelable[] parcelableArr) {
                ...
                for (int i9 = 0; i9 < parcelableArr.length; i9++) {
                    if ((parcelableArr[i9] instanceof Bundle) && (messageFromBundle = getMessageFromBundle((Bundle) parcelableArr[i9])) != null) {
