...
public abstract class JobIntentService extends Service {
    ...
    public final class CompatWorkItem implements GenericWorkItem {
        ...
        CompatWorkItem(Intent intent, int i9) {
            this.mIntent = intent;
            this.mStartId = i9;
        }
    ...
    public static final class JobWorkEnqueuer extends WorkEnqueuer {
        ...
        JobWorkEnqueuer(Context context, ComponentName componentName, int i9) {
            super(componentName);
            ensureJobId(i9);
    ...
    static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName componentName, boolean z10, int i9) {
