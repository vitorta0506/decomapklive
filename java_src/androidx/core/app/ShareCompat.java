...
public final class ShareCompat {
    ...
    public static class IntentBuilder {
        ...
        @NonNull
        public IntentBuilder setChooserTitle(@StringRes int i9) {
            return setChooserTitle(this.mContext.getText(i9));
        }
    ...
    public static class IntentReader {
        ...
        private static void withinStyle(StringBuilder sb2, CharSequence charSequence, int i9, int i10) {
            while (i9 < i10) {
        ...
        public Uri getStream(int i9) {
            ...
            throw new IndexOutOfBoundsException("Stream items available: " + getStreamCount() + " index requested: " + i9);
        }
    }
    ...
    @Deprecated
    public static void configureMenuItem(@NonNull Menu menu, @IdRes int i9, @NonNull IntentBuilder intentBuilder) {
        MenuItem findItem = menu.findItem(i9);
        if (findItem != null) {
            configureMenuItem(findItem, intentBuilder);
            return;
        }
        throw new IllegalArgumentException("Could not find menu item with id " + i9 + " in the supplied menu");
    }
}
