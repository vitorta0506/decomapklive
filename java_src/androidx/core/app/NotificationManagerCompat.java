...
public final class NotificationManagerCompat {
    ...
    public static class NotifyTask implements Task {
        ...
        NotifyTask(String str, int i9, String str2, Notification notification) {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            iNotificationSideChannel.notify(this.packageName, this.f839id, this.tag, this.notif);
        }

        @NonNull
        public String toString() {
            return "NotifyTask[packageName:" + this.packageName + ", id:" + this.f839id + ", tag:" + this.tag + "]";
        }
    }
    ...
    public static class SideChannelManager implements Handler.Callback, ServiceConnection {
        ...
        private void scheduleListenerRetry(ListenerRecord listenerRecord) {
            ...
            int i9 = listenerRecord.retryCount + 1;
    ...
    public boolean areNotificationsEnabled() {
        ...
        try {
            ...
            return ((Integer) cls.getMethod(CHECK_OP_NO_THROW, cls2, cls2, String.class).invoke(appOpsManager, Integer.valueOf(((Integer) cls.getDeclaredField(OP_POST_NOTIFICATION).get(Integer.class)).intValue()), Integer.valueOf(i9), packageName)).intValue() == 0;
    ...
    public NotificationChannelGroupCompat getNotificationChannelGroupCompat(@NonNull String str) {
        ...
        if (i9 >= 28) {
            ...
            return null;
        } else if (i9 < 26 || (notificationChannelGroup = getNotificationChannelGroup(str)) == null) {
            return null;
        } else {
    ...
    public void notify(@Nullable String str, int i9, @NonNull Notification notification) {
        if (useSideChannelForNotification(notification)) {
            pushSideChannelQueue(new NotifyTask(this.mContext.getPackageName(), i9, str, notification));
            this.mNotificationManager.cancel(str, i9);
            return;
        }
    ...
    private static class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            if (this.all) {
                ...
                iNotificationSideChannel.cancel(this.packageName, this.f838id, this.tag);
            }
        }

        @NonNull
        public String toString() {
            return "CancelTask[packageName:" + this.packageName + ", id:" + this.f838id + ", tag:" + this.tag + ", all:" + this.all + "]";
        }

        CancelTask(String str, int i9, String str2) {
            this.packageName = str;
            this.f838id = i9;
            this.tag = str2;
            this.all = false;
