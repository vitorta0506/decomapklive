...
public class FingerprintManagerCompat {
    ...
    private static FingerprintManager.AuthenticationCallback wrapCallback(final AuthenticationCallback authenticationCallback) {
        return new FingerprintManager.AuthenticationCallback() { // from class: androidx.core.hardware.fingerprint.FingerprintManagerCompat.1
            ...
            public void onAuthenticationError(int i9, CharSequence charSequence) {
                AuthenticationCallback.this.onAuthenticationError(i9, charSequence);
            }
            ...
            @Override // android.hardware.fingerprint.FingerprintManager.AuthenticationCallback
            public void onAuthenticationHelp(int i9, CharSequence charSequence) {
                AuthenticationCallback.this.onAuthenticationHelp(i9, charSequence);
            }
    ...
    public void authenticate(@Nullable CryptoObject cryptoObject, int i9, @Nullable CancellationSignal cancellationSignal, @NonNull AuthenticationCallback authenticationCallback, @Nullable Handler handler) {
        FingerprintManager fingerprintManagerOrNull;
        if (Build.VERSION.SDK_INT < 23 || (fingerprintManagerOrNull = getFingerprintManagerOrNull(this.mContext)) == null) {
            return;
        }
        fingerprintManagerOrNull.authenticate(wrapCryptoObject(cryptoObject), cancellationSignal != null ? (android.os.CancellationSignal) cancellationSignal.getCancellationSignalObject() : null, i9, wrapCallback(authenticationCallback), handler);
    }
