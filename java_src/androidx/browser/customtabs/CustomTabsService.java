...
public abstract class CustomTabsService extends Service {
    ...
    private ICustomTabsService.Stub mBinder = new ICustomTabsService.Stub() { // from class: androidx.browser.customtabs.CustomTabsService.1
        ...
        @Override // android.support.customtabs.ICustomTabsService
        public boolean validateRelationship(ICustomTabsCallback iCustomTabsCallback, int i9, Uri uri, Bundle bundle) {
            return CustomTabsService.this.validateRelationship(new CustomTabsSessionToken(iCustomTabsCallback), i9, uri, bundle);
        }
    ...
    protected abstract boolean validateRelationship(CustomTabsSessionToken customTabsSessionToken, int i9, Uri uri, Bundle bundle);
