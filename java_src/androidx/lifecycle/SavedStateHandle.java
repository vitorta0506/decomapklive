...
public final class SavedStateHandle {
    ...
    public SavedStateHandle(@NotNull Map<String, ? extends Object> initialState) {
        ...
        this.savedStateProvider = new SavedStateRegistry.SavedStateProvider() { // from class: androidx.lifecycle.f
            ...
            public final Bundle saveState() {
                Bundle m16savedStateProvider$lambda0;
                m16savedStateProvider$lambda0 = SavedStateHandle.m16savedStateProvider$lambda0(SavedStateHandle.this);
                return m16savedStateProvider$lambda0;
            }
        };
    ...
    public static final Bundle m16savedStateProvider$lambda0(SavedStateHandle this$0) {
        Map map;
