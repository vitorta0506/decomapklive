...
public final class LifecycleController {
    ...
    public LifecycleController(@NotNull Lifecycle lifecycle, @NotNull Lifecycle.State minState, @NotNull DispatchQueue dispatchQueue, @NotNull final Job parentJob) {
        ...
        LifecycleEventObserver lifecycleEventObserver = new LifecycleEventObserver() { // from class: androidx.lifecycle.d
            ...
            public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                LifecycleController.m15observer$lambda0(LifecycleController.this, parentJob, lifecycleOwner, event);
            }
        };
    ...
    public static final void m15observer$lambda0(LifecycleController this$0, Job parentJob, LifecycleOwner source, Lifecycle.Event event) {
