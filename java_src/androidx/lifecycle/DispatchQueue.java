...
public final class DispatchQueue {
    ...
    public static final void m14dispatchAndEnqueue$lambda2$lambda1(DispatchQueue this$0, Runnable runnable) {
    ...
    public final void dispatchAndEnqueue(@NotNull CoroutineContext context, @NotNull final Runnable runnable) {
        ...
        if (!immediate.isDispatchNeeded(context) && !canRun()) {
            ...
            immediate.mo3203dispatch(context, new Runnable() { // from class: androidx.lifecycle.b
                @Override // java.lang.Runnable
                public final void run() {
                    DispatchQueue.m14dispatchAndEnqueue$lambda2$lambda1(DispatchQueue.this, runnable);
                }
            });
        }
    }
