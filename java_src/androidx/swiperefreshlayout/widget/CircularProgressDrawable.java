...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    public static class Ring {
        ...
        void setColorIndex(int i9) {
            this.mColorIndex = i9;
            this.mCurrentColor = this.mColors[i9];
        }
    ...
    private void applyFinishTranslation(float f10, Ring ring) {
        ...
        ring.setStartTrim(ring.getStartingStartTrim() + (((ring.getStartingEndTrim() - MIN_PROGRESS_ARC) - ring.getStartingStartTrim()) * f10));
    ...
    private int evaluateColorChange(float f10, int i9, int i10) {
        int i11 = (i9 >> 24) & 255;
        int i12 = (i9 >> 16) & 255;
        int i13 = (i9 >> 8) & 255;
        int i14 = i9 & 255;
    ...
    void applyTransformation(float f10, Ring ring, boolean z10) {
        ...
        if (this.mFinishing) {
            ...
            if (f10 < 0.5f) {
                ...
                interpolation = startingStartTrim - (((1.0f - MATERIAL_INTERPOLATOR.getInterpolation((f10 - 0.5f) / 0.5f)) * 0.79f) + MIN_PROGRESS_ARC);
                f11 = startingStartTrim;
            }
            float f12 = (f10 + this.mRotationCount) * GROUP_FULL_ROTATION;
            ring.setStartTrim(interpolation);
            ring.setEndTrim(f11);
            ring.setRotation(startingRotation + (RING_ROTATION * f10));
            setRotation(f12);
        }
    }
    ...
    public void setBackgroundColor(int i9) {
        this.mRing.setBackgroundColor(i9);
        invalidateSelf();
    }
