...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public class PopBackStackState implements OpGenerator {
        ...
        PopBackStackState(@Nullable String str, int i9, int i10) {
            this.mName = str;
            this.mId = i9;
            this.mFlags = i10;
        }
    ...
    private Set<SpecialEffectsController> collectChangedControllers(@NonNull ArrayList<BackStackRecord> arrayList, int i9, int i10) {
        ViewGroup viewGroup;
        HashSet hashSet = new HashSet();
        while (i9 < i10) {
    ...
    private void dispatchStateChange(int i9) {
        try {
            ...
            this.mFragmentStore.dispatchStateChange(i9);
    ...
    private static void executeOps(@NonNull ArrayList<BackStackRecord> arrayList, @NonNull ArrayList<Boolean> arrayList2, int i9, int i10) {
        while (i9 < i10) {
    ...
    private void executeOpsTogether(@NonNull ArrayList<BackStackRecord> arrayList, @NonNull ArrayList<Boolean> arrayList2, int i9, int i10) {
        boolean z10 = arrayList.get(i9).mReorderingAllowed;
        ...
        for (SpecialEffectsController specialEffectsController : collectChangedControllers(arrayList, i9, i10)) {
    ...
    private int findBackStackIndex(@Nullable String str, int i9, boolean z10) {
        ...
        while (size >= 0) {
            ...
            if ((str != null && str.equals(backStackRecord.getName())) || (i9 >= 0 && i9 == backStackRecord.mIndex)) {
                break;
            }
            size--;
        }
        ...
        while (size > 0) {
            ...
            if ((str == null || !str.equals(backStackRecord2.getName())) && (i9 < 0 || i9 != backStackRecord2.mIndex)) {
                return size;
            }
            size--;
        }
    ...
    private boolean generateOpsForPendingActions(@NonNull ArrayList<BackStackRecord> arrayList, @NonNull ArrayList<Boolean> arrayList2) {
        synchronized (this.mPendingActions) {
            ...
            for (int i9 = 0; i9 < size; i9++) {
                z10 |= this.mPendingActions.get(i9).generateOps(arrayList, arrayList2);
            }
    ...
    private void reportBackStackChanged() {
        if (this.mBackStackChangeListeners != null) {
            for (int i9 = 0; i9 < this.mBackStackChangeListeners.size(); i9++) {
                this.mBackStackChangeListeners.get(i9).onBackStackChanged();
            }
        }
    }
    ...
    private void setVisibleRemovingFragment(@NonNull Fragment fragment) {
        ...
        if (fragmentContainer.getTag(i9) == null) {
            fragmentContainer.setTag(i9, fragment);
        }
        ((Fragment) fragmentContainer.getTag(i9)).setPopDirection(fragment.getPopDirection());
    }
            ...
            if (fragmentHostCallback3 instanceof ActivityResultRegistryOwner) {
                ...
                this.mStartActivityForResult = activityResultRegistry.register(str2 + "StartActivityForResult", new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() { // from class: androidx.fragment.app.FragmentManager.7
                    ...
                    public void onActivityResult(ActivityResult activityResult) {
                        ...
                        findFragmentByWho.onActivityResult(i9, activityResult.getResultCode(), activityResult.getData());
                    }
                });
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        if (arrayList != null && (size2 = arrayList.size()) > 0) {
            ...
            for (int i9 = 0; i9 < size2; i9++) {
                ...
                printWriter.print(": ");
                printWriter.println(this.mCreatedMenus.get(i9).toString());
            }
        }
    ...
    public Fragment findFragmentById(@IdRes int i9) {
        return this.mFragmentStore.findFragmentById(i9);
    }
    ...
    public void launchRequestPermissions(@NonNull Fragment fragment, @NonNull String[] strArr, int i9) {
        if (this.mRequestPermissions != null) {
            this.mLaunchedFragments.addLast(new LaunchedFragmentInfo(fragment.mWho, i9));
            this.mRequestPermissions.launch(strArr);
            return;
        }
        this.mHost.onRequestPermissionsFromFragment(fragment, strArr, i9);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void launchStartActivityForResult(@NonNull Fragment fragment, Intent intent, int i9, @Nullable Bundle bundle) {
        ...
        this.mHost.onStartActivityFromFragment(fragment, intent, i9, bundle);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void launchStartIntentSenderForResult(@NonNull Fragment fragment, IntentSender intentSender, int i9, @Nullable Intent intent, int i10, int i11, int i12, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        Intent intent2;
        ...
        this.mHost.onStartIntentSenderFromFragment(fragment, intentSender, i9, intent, i10, i11, i12, bundle);
    }

    void moveToState(int i9, boolean z10) {
        FragmentHostCallback<?> fragmentHostCallback;
        if (this.mHost == null && i9 != -1) {
            throw new IllegalStateException("No activity");
        }
        if (z10 || i9 != this.mCurState) {
            this.mCurState = i9;
    ...
    boolean popBackStackState(@NonNull ArrayList<BackStackRecord> arrayList, @NonNull ArrayList<Boolean> arrayList2, @Nullable String str, int i9, int i10) {
        int findBackStackIndex = findBackStackIndex(str, i9, (i10 & 1) != 0);
    ...
    boolean restoreBackStackState(@NonNull ArrayList<BackStackRecord> arrayList, @NonNull ArrayList<Boolean> arrayList2, @NonNull String str) {
        ...
        while (true) {
            for (BackStackRecord backStackRecord : remove.instantiate(this, hashMap)) {
                z10 = backStackRecord.generateOps(arrayList, arrayList2) || z10;
            }
            return z10;
        }
    }
    ...
    public void restoreSaveStateInternal(@Nullable Parcelable parcelable) {
        ...
        if (fragmentManagerState.mBackStack != null) {
            ...
            while (true) {
                ...
                if (isLoggingEnabled(2)) {
                    Log.v(TAG, "restoreAllState: back stack #" + i9 + " (index " + instantiate.mIndex + "): " + instantiate);
                    PrintWriter printWriter = new PrintWriter(new LogWriter(TAG));
    ...
    public Parcelable saveAllStateInternal() {
        ...
        if (arrayList != null && (size = arrayList.size()) > 0) {
            ...
            for (int i9 = 0; i9 < size; i9++) {
                backStackRecordStateArr[i9] = new BackStackRecordState(this.mBackStack.get(i9));
                if (isLoggingEnabled(2)) {
                    Log.v(TAG, "saveAllState: adding back stack #" + i9 + ": " + this.mBackStack.get(i9));
                }
            }
        }
    ...
    boolean saveBackStackState(@NonNull ArrayList<BackStackRecord> arrayList, @NonNull ArrayList<Boolean> arrayList2, @NonNull String str) {
        ...
        for (int i11 = findBackStackIndex; i11 < this.mBackStack.size(); i11++) {
            ...
            while (it.hasNext()) {
                ...
                if (fragment != null) {
                    if (!next.mFromExpandedOp || (i9 = next.mCmd) == 1 || i9 == 2 || i9 == 8) {
    ...
    public void popBackStack(@Nullable String str, int i9) {
        enqueueAction(new PopBackStackState(str, -1, i9), false);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void popBackStack(int i9, int i10, boolean z10) {
        if (i9 >= 0) {
            enqueueAction(new PopBackStackState(null, i9, i10), z10);
            return;
        }
        throw new IllegalArgumentException("Bad id: " + i9);
    }
