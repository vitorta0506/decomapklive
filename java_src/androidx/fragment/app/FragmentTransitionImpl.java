...
public abstract class FragmentTransitionImpl {
    ...
    private static boolean containedBeforeIndex(List<View> list, View view, int i9) {
        ...
        for (int i9 = 0; i9 < size; i9++) {
            ...
            if (transitionName != null) {
                ...
                while (true) {
                    if (i10 >= size) {
                        break;
                    } else if (str.equals(arrayList3.get(i10))) {
                        ViewCompat.setTransitionName(arrayList2.get(i10), transitionName);
                        break;
                    } else {
                        i10++;
                    }
        ...
        OneShotPreDrawListener.add(view, new Runnable() { // from class: androidx.fragment.app.FragmentTransitionImpl.1
            ...
            public void run() {
                for (int i11 = 0; i11 < size; i11++) {
                    ViewCompat.setTransitionName((View) arrayList2.get(i11), (String) arrayList3.get(i11));
                    ViewCompat.setTransitionName((View) arrayList.get(i11), (String) arrayList4.get(i11));
                }
            }
        });
    }
