...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
        ...
        return new FragmentContainer() { // from class: androidx.fragment.app.DialogFragment.5
            ...
            public View onFindViewById(int i9) {
                if (createFragmentContainer.onHasView()) {
                    return createFragmentContainer.onFindViewById(i9);
                }
                return DialogFragment.this.onFindViewById(i9);
            }
    ...
    public void setStyle(int i9, @StyleRes int i10) {
        if (FragmentManager.isLoggingEnabled(2)) {
    ...
    public DialogFragment(@LayoutRes int i9) {
        super(i9);
        this.mDismissRunnable = new Runnable() { // from class: androidx.fragment.app.DialogFragment.1
            @Override // java.lang.Runnable
            public void run() {
