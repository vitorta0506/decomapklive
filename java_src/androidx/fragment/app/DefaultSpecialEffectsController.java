...
class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    private Map<SpecialEffectsController.Operation, Boolean> startTransitions(@NonNull List<TransitionInfo> list, @NonNull List<SpecialEffectsController.Operation> list2, final boolean z10, @Nullable final SpecialEffectsController.Operation operation, @Nullable final SpecialEffectsController.Operation operation2) {
        ...
        while (true) {
            ...
            if (!next3.hasSharedElementTransition() || operation6 == null || operation7 == null) {
                ...
                if (arrayMap2.isEmpty()) {
                    ...
                    if (sharedElementTargetNames2.isEmpty() || (view5 = arrayMap4.get(sharedElementTargetNames2.get(i9))) == null) {
                        rect = rect3;
                        view4 = view9;
                    } else {
                        rect = rect3;
        ...
        for (TransitionInfo transitionInfo3 : list) {
            if (transitionInfo3.isVisibilityUnchanged()) {
                ...
                boolean z13 = obj4 != null && (operation10 == operation8 || operation10 == operation9);
        ...
        for (final TransitionInfo transitionInfo4 : list) {
            if (!transitionInfo4.isVisibilityUnchanged()) {
                ...
                boolean z14 = obj4 != null && (operation11 == operation8 || operation11 == operation9);
    ...
    void executeOperations(@NonNull List<SpecialEffectsController.Operation> list, boolean z10) {
        ...
        for (SpecialEffectsController.Operation operation3 : list) {
            ...
            int i9 = AnonymousClass10.$SwitchMap$androidx$fragment$app$SpecialEffectsController$Operation$State[operation3.getFinalState().ordinal()];
            if (i9 != 1 && i9 != 2 && i9 != 3) {
                if (i9 == 4 && from != SpecialEffectsController.Operation.State.VISIBLE) {
