...
public abstract class SpecialEffectsController {
    ...
    public static class Operation {
        ...
        final void mergeWith(@NonNull State state, @NonNull LifecycleImpact lifecycleImpact) {
            int i9 = AnonymousClass3.$SwitchMap$androidx$fragment$app$SpecialEffectsController$Operation$LifecycleImpact[lifecycleImpact.ordinal()];
            if (i9 == 1) {
                ...
                if (i9 == 3 && this.mFinalState != State.REMOVED) {
                    if (FragmentManager.isLoggingEnabled(2)) {
        ...
        public enum State {
            ...
            public void applyState(@NonNull View view) {
                int i9 = AnonymousClass3.$SwitchMap$androidx$fragment$app$SpecialEffectsController$Operation$State[ordinal()];
                if (i9 == 1) {
    ...
    public static SpecialEffectsController getOrCreateController(@NonNull ViewGroup viewGroup, @NonNull SpecialEffectsControllerFactory specialEffectsControllerFactory) {
        ...
        viewGroup.setTag(i9, createController);
