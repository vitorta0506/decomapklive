    ...
    int computeExpectedState() {
        ...
        if (fragment2.mFromLayout) {
            if (fragment2.mInLayout) {
                ...
                i9 = this.mFragmentManagerState < 4 ? Math.min(i9, fragment2.mState) : Math.min(i9, 1);
            }
        }
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v("FragmentManager", "computeExpectedState() of " + i9 + " for " + this.mFragment);
        }
        return i9;
    }
    ...
    public void moveToExpectedState() {
        ...
        try {
            ...
            while (true) {
                ...
                if (computeExpectedState == i9) {
                    if (!z10 && i9 == -1 && fragment.mRemoving && !fragment.isInBackStack() && !this.mFragment.mBeingSaved) {
                        if (FragmentManager.isLoggingEnabled(3)) {
    ...
    public void saveState() {
        ...
        if (fragment.mState > -1 && fragmentState.mSavedFragmentState == null) {
            ...
            if (this.mFragment.mTargetWho != null) {
                ...
                int i9 = this.mFragment.mTargetRequestCode;
                if (i9 != 0) {
                    fragmentState.mSavedFragmentState.putInt(TARGET_REQUEST_CODE_STATE_TAG, i9);
                }
            }
        } else {
