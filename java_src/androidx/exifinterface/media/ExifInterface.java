...
public class ExifInterface {
    ...
    public static class ByteOrderedDataInputStream extends InputStream implements DataInput {
        ...
        public void readFully(byte[] bArr, int i9, int i10) throws IOException {
            this.mPosition += i10;
            this.mDataInputStream.readFully(bArr, i9, i10);
        }
        ...
        public void skipFully(int i9) throws IOException {
            ...
            while (i10 < i9) {
                int i11 = i9 - i10;
                int skip = (int) this.mDataInputStream.skip(i11);
                if (skip <= 0) {
                    if (this.mSkipBuffer == null) {
                        this.mSkipBuffer = new byte[8192];
                    }
                    skip = this.mDataInputStream.read(this.mSkipBuffer, 0, Math.min(8192, i11));
                    if (skip == -1) {
        ...
        public int read(byte[] bArr, int i9, int i10) throws IOException {
            int read = this.mDataInputStream.read(bArr, i9, i10);
            this.mPosition += read;
            return read;
        }
    ...
    public static class ByteOrderedDataOutputStream extends FilterOutputStream {
        ...
        public void writeByte(int i9) throws IOException {
            this.mOutputStream.write(i9);
        }

        public void writeInt(int i9) throws IOException {
            ByteOrder byteOrder = this.mByteOrder;
            if (byteOrder == ByteOrder.LITTLE_ENDIAN) {
                this.mOutputStream.write((i9 >>> 0) & 255);
                this.mOutputStream.write((i9 >>> 8) & 255);
                this.mOutputStream.write((i9 >>> 16) & 255);
                this.mOutputStream.write((i9 >>> 24) & 255);
        ...
        public void writeUnsignedShort(int i9) throws IOException {
            writeShort((short) i9);
        }

        @Override // java.io.FilterOutputStream, java.io.OutputStream
        public void write(byte[] bArr, int i9, int i10) throws IOException {
            this.mOutputStream.write(bArr, i9, i10);
        }
    }
    ...
    public static class ExifAttribute {
        ...
        ExifAttribute(int i9, int i10, byte[] bArr) {
            this(i9, i10, -1L, bArr);
        }
        ...
        public String getStringValue(ByteOrder byteOrder) {
            ...
            if (value instanceof long[]) {
                ...
                Rational[] rationalArr = (Rational[]) value;
                while (i9 < rationalArr.length) {
                    sb2.append(rationalArr[i9].numerator);
                    sb2.append(IOUtils.DIR_SEPARATOR_UNIX);
                    sb2.append(rationalArr[i9].denominator);
                    i9++;
                    if (i9 != rationalArr.length) {
                        sb2.append(",");
                    }
                }
                return sb2.toString();
        ...
        */
        ...
        ExifAttribute(int i9, int i10, long j10, byte[] bArr) {
            this.format = i9;
        ...
        public static ExifAttribute createSLong(int i9, ByteOrder byteOrder) {
        ...
        public static ExifAttribute createUShort(int i9, ByteOrder byteOrder) {
    ...
    public static class Rational {
        ...
        public String toString() {
            return this.numerator + FileUtils.RES_PREFIX_STORAGE + this.denominator;
        }
    ...
    static {
        ...
        while (true) {
            ...
            if (i9 < exifTagArr12.length) {
                sExifTagMapsForReading[i9] = new HashMap<>();
                sExifTagMapsForWriting[i9] = new HashMap<>();
                for (ExifTag exifTag : exifTagArr12[i9]) {
                    sExifTagMapsForReading[i9].put(Integer.valueOf(exifTag.number), exifTag);
                    sExifTagMapsForWriting[i9].put(exifTag.name, exifTag);
                }
                i9++;
            } else {
    ...
    private static double convertRationalLatLonToDouble(String str, String str2) {
        try {
            ...
            String[] split2 = split[0].split(FileUtils.RES_PREFIX_STORAGE, -1);
            String[] split3 = split[1].split(FileUtils.RES_PREFIX_STORAGE, -1);
            String[] split4 = split[2].split(FileUtils.RES_PREFIX_STORAGE, -1);
    ...
    private ExifAttribute getExifAttribute(@NonNull String str) {
        ...
        for (int i9 = 0; i9 < EXIF_TAGS.length; i9++) {
            ExifAttribute exifAttribute = this.mAttributes[i9].get(str);
            ...
            try {
                try {
                    ExifInterfaceUtils.Api23Impl.setDataSource(mediaMetadataRetriever, new MediaDataSource() { // from class: androidx.exifinterface.media.ExifInterface.1
                        ...
                        @Override // android.media.MediaDataSource
                        public int readAt(long j10, byte[] bArr, int i9, int i10) throws IOException {
                            if (i10 == 0) {
                                return 0;
                            }
                            if (j10 < 0) {
                            ...
                            try {
                                ...
                                if (i10 > seekableByteOrderedDataInputStream.available()) {
                                    i10 = seekableByteOrderedDataInputStream.available();
                                }
                                int read = seekableByteOrderedDataInputStream.read(bArr, i9, i10);
                                if (read >= 0) {
                                    this.mPosition += read;
                                    return read;
                                }
                    ...
                    if (str2 != null) {
                        ...
                        this.mAttributes[0].put(TAG_ORIENTATION, ExifAttribute.createUShort(i9, this.mExifByteOrder));
                    }
                    ...
                    if (DEBUG) {
                        Log.d(TAG, "Heif meta: " + str3 + x.f19108w + str + ", rotation " + str2);
                    }
                    return;
    ...
    */
    ...
    private void getRafAttributes(ByteOrderedDataInputStream byteOrderedDataInputStream) throws IOException {
        ...
        getJpegAttributes(new ByteOrderedDataInputStream(bArr4), i9, 5);
    ...
    private static Pair<Integer, Integer> guessDataFormat(String str) {
        if (str.contains(",")) {
            ...
            return guessDataFormat;
        } else if (str.contains(FileUtils.RES_PREFIX_STORAGE)) {
            String[] split2 = str.split(FileUtils.RES_PREFIX_STORAGE, -1);
            if (split2.length == 2) {
                try {
    ...
    private static boolean isSupportedFormatForSavingAttributes(int i9) {
        return i9 == 4 || i9 == 13 || i9 == 14 || i9 == 3 || i9 == 0;
    }
    ...
    private void loadAttributes(@NonNull InputStream inputStream) {
        ...
        for (int i9 = 0; i9 < EXIF_TAGS.length; i9++) {
            try {
                try {
                    this.mAttributes[i9] = new HashMap<>();
                } finally {
            ...
            try {
                ...
                if (str3 != null) {
                    ...
                    if (("+".equals(substring) || "-".equals(substring)) && CertificateUtil.DELIMITER.equals(str3.substring(3, 4)) && parseInt <= 14) {
                        int i10 = ((parseInt * 60) + parseInt2) * 60 * 1000;
                        if (!"-".equals(substring)) {
                            i9 = -1;
                        }
                        time += i10 * i9;
    ...
    private void printAttributes() {
        for (int i9 = 0; i9 < this.mAttributes.length; i9++) {
            Log.d(TAG, "The size of tag group[" + i9 + "]: " + this.mAttributes[i9].size());
    ...
    private void readExifSegment(byte[] bArr, int i9) throws IOException {
        SeekableByteOrderedDataInputStream seekableByteOrderedDataInputStream = new SeekableByteOrderedDataInputStream(bArr);
        parseTiffHeaders(seekableByteOrderedDataInputStream);
        readImageFileDirectory(seekableByteOrderedDataInputStream, i9);
    }
    ...
    */
    ...
    private void removeAttribute(String str) {
        for (int i9 = 0; i9 < EXIF_TAGS.length; i9++) {
            this.mAttributes[i9].remove(str);
        }
    }

    private void replaceInvalidTags(int i9, String str, String str2) {
        if (this.mAttributes[i9].isEmpty() || this.mAttributes[i9].get(str) == null) {
            return;
        }
        HashMap<String, ExifAttribute>[] hashMapArr = this.mAttributes;
        hashMapArr[i9].put(str2, hashMapArr[i9].get(str));
        this.mAttributes[i9].remove(str);
    }

    private void retrieveJpegImageSize(SeekableByteOrderedDataInputStream seekableByteOrderedDataInputStream, int i9) throws IOException {
        ExifAttribute exifAttribute = this.mAttributes[i9].get(TAG_IMAGE_LENGTH);
        ExifAttribute exifAttribute2 = this.mAttributes[i9].get(TAG_IMAGE_WIDTH);
        if (exifAttribute == null || exifAttribute2 == null) {
            ExifAttribute exifAttribute3 = this.mAttributes[i9].get(TAG_JPEG_INTERCHANGE_FORMAT);
            ExifAttribute exifAttribute4 = this.mAttributes[i9].get(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH);
            ...
            getJpegAttributes(new ByteOrderedDataInputStream(bArr), intValue, i9);
        }
    }
            ...
            if (byteOrderedDataInputStream.readByte() == -40) {
                ...
                while (byteOrderedDataInputStream.readByte() == -1) {
                    ...
                    if (readByte == -39 || readByte == -38) {
                        ...
                        while (i9 > 0) {
                            int read = byteOrderedDataInputStream.read(bArr, 0, Math.min(i9, 4096));
                            if (read >= 0) {
    ...
    private void savePngAttributes(InputStream inputStream, OutputStream outputStream) throws IOException {
        ...
        int i9 = this.mOffsetToExifData;
        if (i9 == 0) {
            int readInt = byteOrderedDataInputStream.readInt();
            byteOrderedDataOutputStream.writeInt(readInt);
            ExifInterfaceUtils.copy(byteOrderedDataInputStream, byteOrderedDataOutputStream, readInt + 4 + 4);
        } else {
            ExifInterfaceUtils.copy(byteOrderedDataInputStream, byteOrderedDataOutputStream, ((i9 - bArr.length) - 4) - 4);
    ...
    */
    ...
    private static boolean shouldSupportSeek(int i9) {
        return (i9 == 4 || i9 == 9 || i9 == 13 || i9 == 14) ? false : true;
    }

    private void swapBasedOnImageSize(int i9, int i10) throws IOException {
        if (!this.mAttributes[i9].isEmpty() && !this.mAttributes[i10].isEmpty()) {
            ExifAttribute exifAttribute = this.mAttributes[i9].get(TAG_IMAGE_LENGTH);
            ExifAttribute exifAttribute2 = this.mAttributes[i9].get(TAG_IMAGE_WIDTH);
            ...
            if (exifAttribute == null || exifAttribute2 == null) {
                ...
                HashMap<String, ExifAttribute>[] hashMapArr = this.mAttributes;
                HashMap<String, ExifAttribute> hashMap = hashMapArr[i9];
    ...
    private void updateImageSizeValues(SeekableByteOrderedDataInputStream seekableByteOrderedDataInputStream, int i9) throws IOException {
        ExifAttribute createUShort;
        ExifAttribute createUShort2;
        ExifAttribute exifAttribute = this.mAttributes[i9].get(TAG_DEFAULT_CROP_SIZE);
        ExifAttribute exifAttribute2 = this.mAttributes[i9].get(TAG_RW2_SENSOR_TOP_BORDER);
        ExifAttribute exifAttribute3 = this.mAttributes[i9].get(TAG_RW2_SENSOR_LEFT_BORDER);
        ExifAttribute exifAttribute4 = this.mAttributes[i9].get(TAG_RW2_SENSOR_BOTTOM_BORDER);
        ExifAttribute exifAttribute5 = this.mAttributes[i9].get(TAG_RW2_SENSOR_RIGHT_BORDER);
        if (exifAttribute == null) {
            if (exifAttribute2 != null && exifAttribute3 != null && exifAttribute4 != null && exifAttribute5 != null) {
                ...
                this.mAttributes[i9].put(TAG_IMAGE_LENGTH, createUShort3);
                this.mAttributes[i9].put(TAG_IMAGE_WIDTH, createUShort4);
                return;
            }
            retrieveJpegImageSize(seekableByteOrderedDataInputStream, i9);
            return;
        }
        ...
        this.mAttributes[i9].put(TAG_IMAGE_WIDTH, createUShort);
        this.mAttributes[i9].put(TAG_IMAGE_LENGTH, createUShort2);
    }
    ...
    private int writeExifSegment(ByteOrderedDataOutputStream byteOrderedDataOutputStream) throws IOException {
        ...
        if (this.mHasThumbnail) {
            if (this.mHasThumbnailStrips) {
                this.mAttributes[4].put(TAG_STRIP_OFFSETS, ExifAttribute.createUShort(i12, this.mExifByteOrder));
            } else {
                this.mAttributes[4].put(TAG_JPEG_INTERCHANGE_FORMAT, ExifAttribute.createULong(i12, this.mExifByteOrder));
            }
    ...
    public int getAttributeInt(@NonNull String str, int i9) {
        Objects.requireNonNull(str, "tag shouldn't be null");
        ExifAttribute exifAttribute = getExifAttribute(str);
        if (exifAttribute == null) {
            return i9;
    ...
    public byte[] getThumbnail() {
        int i9 = this.mThumbnailCompression;
        if (i9 == 6 || i9 == 7) {
    ...
    public void rotate(int i9) {
        if (i9 % 90 == 0) {
            ...
            if (list.contains(Integer.valueOf(attributeInt))) {
                int indexOf = (list.indexOf(Integer.valueOf(attributeInt)) + (i9 / 90)) % 4;
                r4 = list.get(indexOf + (indexOf < 0 ? 4 : 0)).intValue();
            } else {
                List<Integer> list2 = FLIPPED_ROTATION_ORDER;
                if (list2.contains(Integer.valueOf(attributeInt))) {
                    int indexOf2 = (list2.indexOf(Integer.valueOf(attributeInt)) + (i9 / 90)) % 4;
    ...
    */
                    ...
                    switch (i9) {
                        ...
                        case 5:
                            ...
                            while (i18 < split3.length) {
                                String[] split4 = split3[i18].split(FileUtils.RES_PREFIX_STORAGE, i13);
                        ...
                        default:
                            if (DEBUG) {
                                Log.d(TAG, "Data format isn't one of expected formats: " + i9);
                            } else {
                                continue;
                            }
                            i12++;
                        ...
                        case 10:
                            ...
                            while (i20 < split6.length) {
                                String[] split7 = split6[i20].split(FileUtils.RES_PREFIX_STORAGE, -1);
    ...
    public static class ExifTag {
        ...
        ExifTag(String str, int i9, int i10) {
            this.name = str;
            this.number = i9;
        ...
        boolean isFormatCompatible(int i9) {
            int i10;
        ...
        ExifTag(String str, int i9, int i10, int i11) {
            this.name = str;
            this.number = i9;
            this.primaryFormat = i10;
    ...
    public ExifInterface(@NonNull InputStream inputStream, int i9) throws IOException {
        ExifTag[][] exifTagArr = EXIF_TAGS;
        this.mAttributes = new HashMap[exifTagArr.length];
        this.mAttributesOffsets = new HashSet(exifTagArr.length);
        this.mExifByteOrder = ByteOrder.BIG_ENDIAN;
