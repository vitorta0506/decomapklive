...
public final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    private void dispatchScrolled(int i9, float f10, int i10) {
    ...
    private void updateScrollEventValues() {
        ...
        int i9 = -top;
        scrollEventValues.mOffsetPx = i9;
        if (i9 < 0) {
        ...
        scrollEventValues.mOffset = height == 0 ? 0.0f : i9 / height;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void notifyProgrammaticScroll(int i9, boolean z10) {
        this.mAdapterState = z10 ? 2 : 3;
        this.mFakeDragging = false;
        boolean z11 = this.mTarget != i9;
        this.mTarget = i9;
        dispatchStateChanged(2);
        if (z11) {
            dispatchSelected(i9);
    ...
    public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int i9) {
        boolean z10 = true;
        if ((this.mAdapterState != 1 || this.mScrollState != 1) && i9 == 1) {
            startDrag(false);
        } else if (isInAnyDraggingState() && i9 == 2) {
            if (this.mScrollHappened) {
                dispatchStateChanged(2);
                this.mDispatchSelected = true;
            }
        } else {
            if (isInAnyDraggingState() && i9 == 0) {
                updateScrollEventValues();
                if (!this.mScrollHappened) {
