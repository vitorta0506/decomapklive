...
public final class FakeDrag {
    ...
    private void addFakeMotionEvent(long j10, int i9, float f10, float f11) {
        MotionEvent obtain = MotionEvent.obtain(this.mFakeDragBeginTime, j10, i9, f10, f11, 0);
    ...
    public boolean fakeDragBy(float f10) {
        if (this.mScrollEventAdapter.isFakeDragging()) {
            ...
            this.mRecyclerView.scrollBy(i9, i10);
