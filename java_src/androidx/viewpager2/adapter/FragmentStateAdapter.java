...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
    ...
    public class FragmentMaxLifecycleEnforcer {
        ...
        void updateFragmentMaxLifecycle(boolean z10) {
            ...
            if ((itemId != this.mPrimaryItemId || z10) && (fragment = FragmentStateAdapter.this.mFragments.get(itemId)) != null && fragment.isAdded()) {
                ...
                for (int i9 = 0; i9 < FragmentStateAdapter.this.mFragments.size(); i9++) {
                    long keyAt = FragmentStateAdapter.this.mFragments.keyAt(i9);
                    Fragment valueAt = FragmentStateAdapter.this.mFragments.valueAt(i9);
                    if (valueAt.isAdded()) {
    ...
    private Long itemForViewHolder(int i9) {
        Long l10 = null;
        for (int i10 = 0; i10 < this.mItemIdToViewHolder.size(); i10++) {
            if (this.mItemIdToViewHolder.valueAt(i10).intValue() == i9) {
                if (l10 == null) {
                    l10 = Long.valueOf(this.mItemIdToViewHolder.keyAt(i10));
                } else {
    ...
    void gcFragments() {
        ...
        for (int i9 = 0; i9 < this.mFragments.size(); i9++) {
            long keyAt = this.mFragments.keyAt(i9);
        ...
        if (!this.mIsInGracePeriod) {
            ...
            for (int i10 = 0; i10 < this.mFragments.size(); i10++) {
                long keyAt2 = this.mFragments.keyAt(i10);
    ...
    public final Parcelable saveState() {
        ...
        for (int i10 = 0; i10 < this.mSavedStates.size(); i10++) {
            long keyAt2 = this.mSavedStates.keyAt(i10);
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public final void onBindViewHolder(@NonNull final FragmentViewHolder fragmentViewHolder, int i9) {
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    @NonNull
    public final FragmentViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i9) {
