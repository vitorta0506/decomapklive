...
public final class MetadataRepo {
    ...
    public static class Node {
        ...
        void put(@NonNull EmojiMetadata emojiMetadata, int i9, int i10) {
            Node node = get(emojiMetadata.getCodepointAt(i9));
            if (node == null) {
                node = new Node();
                this.mChildren.put(emojiMetadata.getCodepointAt(i9), node);
            }
            if (i10 > i9) {
    ...
    private void constructIndex(MetadataList metadataList) {
        ...
        for (int i9 = 0; i9 < listLength; i9++) {
            ...
            Character.toChars(emojiMetadata.getId(), this.mEmojiCharArray, i9 * 2);
            put(emojiMetadata);
        }
    }
