...
public class EmojiCompat {
    ...
    public static class CompatInternal {
        ...
        boolean hasEmojiGlyph(@NonNull CharSequence charSequence, int i9) {
            return false;
        }
        ...
        CharSequence process(@NonNull CharSequence charSequence, @IntRange(from = 0) int i9, @IntRange(from = 0) int i10, @IntRange(from = 0) int i11, boolean z10) {
            return charSequence;
        }
    ...
    private static final class CompatInternal19 extends CompatInternal {
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        public int getEmojiMatch(CharSequence charSequence, int i9) {
            return this.mProcessor.getEmojiMatch(charSequence, i9);
        }
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        CharSequence process(@NonNull CharSequence charSequence, int i9, int i10, int i11, boolean z10) {
            return this.mProcessor.process(charSequence, i9, i10, i11, z10);
        }
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        boolean hasEmojiGlyph(@NonNull CharSequence charSequence, int i9) {
            return this.mProcessor.getEmojiMatch(charSequence, i9) == 1;
        }
    }
    ...
    public static abstract class Config {
        ...
        public Config setEmojiSpanIndicatorColor(@ColorInt int i9) {
            this.mEmojiSpanIndicatorColor = i9;
            return this;
        }
        ...
        public Config setUseEmojiAsDefaultStyle(boolean z10, @Nullable List<Integer> list) {
            ...
            if (z10 && list != null) {
                ...
                for (Integer num : list) {
                    this.mEmojiAsDefaultStyleExceptions[i9] = num.intValue();
                    i9++;
                }
    ...
    public static class ListenerDispatcher implements Runnable {
        ...
        public void run() {
            ...
            if (this.mLoadState != 1) {
                while (i9 < size) {
                    this.mInitCallbacks.get(i9).onFailed(this.mThrowable);
                    i9++;
                }
                return;
            }
            while (i9 < size) {
                this.mInitCallbacks.get(i9).onInitialized();
                i9++;
            }
        }
        ...
        ListenerDispatcher(@NonNull Collection<InitCallback> collection, int i9, @Nullable Throwable th2) {
    ...
    public static boolean handleDeleteSurroundingText(@NonNull InputConnection inputConnection, @NonNull Editable editable, @IntRange(from = 0) int i9, @IntRange(from = 0) int i10, boolean z10) {
        return EmojiProcessor.handleDeleteSurroundingText(inputConnection, editable, i9, i10, z10);
    }

    public static boolean handleOnKeyDown(@NonNull Editable editable, int i9, @NonNull KeyEvent keyEvent) {
        return EmojiProcessor.handleOnKeyDown(editable, i9, keyEvent);
    }
    ...
    public int getEmojiMatch(@NonNull CharSequence charSequence, @IntRange(from = 0) int i9) {
        ...
        return this.mHelper.getEmojiMatch(charSequence, i9);
    }
    ...
    public boolean hasEmojiGlyph(@NonNull CharSequence charSequence, @IntRange(from = 0) int i9) {
        Preconditions.checkState(isInitialized(), "Not initialized yet");
        Preconditions.checkNotNull(charSequence, "sequence cannot be null");
        return this.mHelper.hasEmojiGlyph(charSequence, i9);
    }
    ...
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = 0) int i9, @IntRange(from = 0) int i10, @IntRange(from = 0) int i11, int i12) {
        ...
        if (i12 != 1) {
            z10 = i12 != 2 ? this.mReplaceAll : false;
        } else {
            z10 = true;
        }
        return this.mHelper.process(charSequence, i9, i10, i11, z10);
    }
