...
public class MetadataListReader {
    ...
    public static class InputStreamOpenTypeReader implements OpenTypeReader {
        ...
        private void read(@IntRange(from = 0, to = 4) int i9) throws IOException {
            if (this.mInputStream.read(this.mByteArray, 0, i9) == i9) {
                this.mPosition += i9;
                return;
            }
        ...
        public void skip(int i9) throws IOException {
            while (i9 > 0) {
                int skip = (int) this.mInputStream.skip(i9);
                if (skip >= 1) {
                    i9 -= skip;
                    this.mPosition += skip;
                } else {
