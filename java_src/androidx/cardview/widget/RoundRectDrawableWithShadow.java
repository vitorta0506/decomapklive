...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    private void buildShadowCorners() {
        ...
        paint.setShader(new RadialGradient(0.0f, 0.0f, f14, new int[]{i9, i9, this.mShadowEndColor}, new float[]{0.0f, f13, 1.0f}, Shader.TileMode.CLAMP));
        Paint paint2 = this.mEdgeShadowPaint;
        float f15 = this.mCornerRadius;
        float f16 = this.mShadowSize;
        int i10 = this.mShadowStartColor;
        paint2.setShader(new LinearGradient(0.0f, (-f15) + f16, 0.0f, (-f15) - f16, new int[]{i10, i10, this.mShadowEndColor}, new float[]{0.0f, 0.5f, 1.0f}, Shader.TileMode.CLAMP));
    ...
    public static float calculateVerticalPadding(float f10, float f11, boolean z10) {
        return z10 ? (float) ((f10 * SHADOW_MULTIPLIER) + ((1.0d - COS_45) * f11)) : f10 * SHADOW_MULTIPLIER;
    }
    ...
    public void setAlpha(int i9) {
        ...
        this.mCornerShadowPaint.setAlpha(i9);
        this.mEdgeShadowPaint.setAlpha(i9);
    }
