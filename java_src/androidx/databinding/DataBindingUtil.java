...
public class DataBindingUtil {
    ...
    private static <T extends ViewDataBinding> T bindToAddedViews(DataBindingComponent dataBindingComponent, ViewGroup viewGroup, int i9, int i10) {
        int childCount = viewGroup.getChildCount();
        int i11 = childCount - i9;
        if (i11 == 1) {
            return (T) bind(dataBindingComponent, viewGroup.getChildAt(childCount - 1), i10);
        }
        View[] viewArr = new View[i11];
        for (int i12 = 0; i12 < i11; i12++) {
            viewArr[i12] = viewGroup.getChildAt(i12 + i9);
        }
        return (T) bind(dataBindingComponent, viewArr, i10);
    }

    @Nullable
    public static String convertBrIdToString(int i9) {
        return sMapper.convertBrIdToString(i9);
    }
    ...
    */
    ...
    public static <T extends ViewDataBinding> T inflate(@NonNull LayoutInflater layoutInflater, int i9, @Nullable ViewGroup viewGroup, boolean z10) {
        return (T) inflate(layoutInflater, i9, viewGroup, z10, sDefaultComponent);
    }

    public static <T extends ViewDataBinding> T setContentView(@NonNull Activity activity, int i9) {
        return (T) setContentView(activity, i9, sDefaultComponent);
    }
    ...
    public static <T extends ViewDataBinding> T inflate(@NonNull LayoutInflater layoutInflater, int i9, @Nullable ViewGroup viewGroup, boolean z10, @Nullable DataBindingComponent dataBindingComponent) {
        boolean z11 = viewGroup != null && z10;
        int childCount = z11 ? viewGroup.getChildCount() : 0;
        View inflate = layoutInflater.inflate(i9, viewGroup, z10);
        if (z11) {
            return (T) bindToAddedViews(dataBindingComponent, viewGroup, childCount, i9);
        }
        return (T) bind(dataBindingComponent, inflate, i9);
    }
    ...
    public static <T extends ViewDataBinding> T setContentView(@NonNull Activity activity, int i9, @Nullable DataBindingComponent dataBindingComponent) {
        ...
        return (T) bindToAddedViews(dataBindingComponent, (ViewGroup) activity.getWindow().getDecorView().findViewById(16908290), 0, i9);
    }
