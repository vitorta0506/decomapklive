...
public class TimePickerBindingAdapter {
    ...
    public static void setHour(TimePicker timePicker, int i9) {
        if (Build.VERSION.SDK_INT >= 23) {
            if (timePicker.getHour() != i9) {
                timePicker.setHour(i9);
            }
        } else if (timePicker.getCurrentHour().intValue() != i9) {
            ...
            timePicker.setOnTimeChangedListener(new TimePicker.OnTimeChangedListener() { // from class: androidx.databinding.adapters.TimePickerBindingAdapter.1
                ...
                public void onTimeChanged(TimePicker timePicker2, int i9, int i10) {
                    ...
                    if (onTimeChangedListener2 != null) {
                        onTimeChangedListener2.onTimeChanged(timePicker2, i9, i10);
                    }
    ...
    public static void setMinute(TimePicker timePicker, int i9) {
        if (Build.VERSION.SDK_INT >= 23) {
            if (timePicker.getMinute() != i9) {
                timePicker.setMinute(i9);
            }
        } else if (timePicker.getCurrentMinute().intValue() != i9) {
            timePicker.setCurrentHour(Integer.valueOf(i9));
        }
    }
}
