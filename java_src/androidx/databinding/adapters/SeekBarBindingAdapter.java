...
public class SeekBarBindingAdapter {
    ...
    public interface OnProgressChanged {
        void onProgressChanged(SeekBar seekBar, int i9, boolean z10);
    }
            ...
            seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: androidx.databinding.adapters.SeekBarBindingAdapter.1
                ...
                public void onProgressChanged(SeekBar seekBar2, int i9, boolean z10) {
                    ...
                    if (onProgressChanged2 != null) {
                        onProgressChanged2.onProgressChanged(seekBar2, i9, z10);
                    }
    ...
    public static void setProgress(SeekBar seekBar, int i9) {
