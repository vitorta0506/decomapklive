...
public class Barrier extends ConstraintHelper {
    ...
    private void updateType(ConstraintWidget constraintWidget, int i9, boolean z10) {
        this.mResolvedType = i9;
        if (z10) {
    ...
    public void setDpMargin(int i9) {
        ...
        barrier.setMargin((int) ((i9 * getResources().getDisplayMetrics().density) + 0.5f));
    }

    public void setMargin(int i9) {
        this.mBarrier.setMargin(i9);
    }

    public void setType(int i9) {
        this.mIndicatedType = i9;
    }
