...
public class SolverVariable implements Comparable<SolverVariable> {
    ...
    private static String getUniqueName(Type type, String str) {
        ...
        int i9 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$SolverVariable$Type[type.ordinal()];
        if (i9 == 1) {
    ...
    public void setSynonym(LinearSystem linearSystem, SolverVariable solverVariable, float f10) {
        this.isSynonym = true;
        this.synonym = solverVariable.f805id;
    ...
    String strengthsToString() {
        ...
        boolean z10 = false;
        boolean z11 = true;
        for (int i9 = 0; i9 < this.strengthVector.length; i9++) {
            String str2 = str + this.strengthVector[i9];
    ...
    public int compareTo(SolverVariable solverVariable) {
        return this.f805id - solverVariable.f805id;
    }
