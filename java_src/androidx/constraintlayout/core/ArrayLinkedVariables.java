...
public class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    public void add(SolverVariable solverVariable, float f10, boolean z10) {
        ...
        if (f10 <= (-f11) || f10 >= f11) {
            ...
            if (i9 == -1) {
                ...
                this.mArrayIndices[0] = solverVariable.f805id;
            ...
            int i11 = -1;
            for (int i12 = 0; i9 != -1 && i12 < this.currentSize; i12++) {
            ...
            this.mArrayIndices[i15] = solverVariable.f805id;
    ...
    public final void clear() {
        ...
        for (int i10 = 0; i9 != -1 && i10 < this.currentSize; i10++) {
            SolverVariable solverVariable = this.mCache.mIndexedVariables[this.mArrayIndices[i9]];
    ...
    public boolean contains(SolverVariable solverVariable) {
        ...
        for (int i10 = 0; i9 != -1 && i10 < this.currentSize; i10++) {
            if (this.mArrayIndices[i9] == solverVariable.f805id) {
                return true;
            }
            i9 = this.mArrayNextIndices[i9];
        }
    ...
    public final int getId(int i9) {
        return this.mArrayIndices[i9];
    }

    public final int getNextIndice(int i9) {
        return this.mArrayNextIndices[i9];
    }
    ...
    SolverVariable getPivotCandidate() {
        ...
        if (solverVariable == null) {
            ...
            for (int i10 = 0; i9 != -1 && i10 < this.currentSize; i10++) {
                if (this.mArrayValues[i9] < 0.0f) {
                    SolverVariable solverVariable3 = this.mCache.mIndexedVariables[this.mArrayIndices[i9]];
    ...
    public final float remove(SolverVariable solverVariable, boolean z10) {
        ...
        int i10 = 0;
        int i11 = -1;
        while (i9 != -1 && i10 < this.currentSize) {
            if (this.mArrayIndices[i9] == solverVariable.f805id) {
                if (i9 == this.mHead) {
                    this.mHead = this.mArrayNextIndices[i9];
                } else {
    ...
    public String toString() {
        ...
        String str = "";
        for (int i10 = 0; i9 != -1 && i10 < this.currentSize; i10++) {
            str = ((str + " -> ") + this.mArrayValues[i9] + " : ") + this.mCache.mIndexedVariables[this.mArrayIndices[i9]];
            i9 = this.mArrayNextIndices[i9];
        }
        return str;
    }
