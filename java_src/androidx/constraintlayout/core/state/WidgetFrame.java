...
public class WidgetFrame {
    ...
    private static void add(StringBuilder sb2, String str, int i9) {
        sb2.append(str);
        sb2.append(": ");
        sb2.append(i9);
        sb2.append(",\n");
    ...
    public static void interpolate(int i9, int i10, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f10) {
        int i11;
        float f11;
        int i12;
        float f12;
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (findPreviousPosition != null) {
                i13 = (int) (findPreviousPosition.f816x * i9);
                i15 = i10;
                i20 = (int) (findPreviousPosition.f817y * i15);
            ...
            if (findNextPosition != null) {
                i21 = (int) (findNextPosition.f816x * i14);
                i22 = (int) (findNextPosition.f817y * i15);
    ...
    public float centerX() {
        int i9 = this.left;
        return i9 + ((this.right - i9) / 2.0f);
    }

    public float centerY() {
        int i9 = this.top;
        return i9 + ((this.bottom - i9) / 2.0f);
    }
    ...
    void logv(String str) {
        ...
        if (this.widget != null) {
            str2 = str3 + FileUtils.RES_PREFIX_STORAGE + (this.widget.hashCode() % 1000);
        } else {
            str2 = str3 + "/NULL";
        }
    ...
    void parseCustom(CLElement cLElement) throws CLParsingException {
        ...
        for (int i9 = 0; i9 < size; i9++) {
            CLKey cLKey = (CLKey) cLObject.get(i9);
            cLKey.content();
    ...
    void printCustomAttributes() {
        ...
        if (this.widget != null) {
            str = str2 + FileUtils.RES_PREFIX_STORAGE + (this.widget.hashCode() % 1000) + " ";
        } else {
            str = str2 + "/NULL ";
        }
    ...
    public StringBuilder serialize(StringBuilder sb2, boolean z10) {
        sb2.append("{\n");
        add(sb2, ViewHierarchyConstants.DIMENSION_LEFT_KEY, this.left);
