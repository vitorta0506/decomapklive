...
public class State {
    ...
    private String createHelperKey() {
        ...
        int i9 = this.numHelpers;
        this.numHelpers = i9 + 1;
        sb2.append(i9);
        sb2.append("__");
        return sb2.toString();
    }
    ...
    public HelperReference helper(Object obj, Helper helper) {
        ...
        if (helperReference == null) {
            int i9 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$state$State$Helper[helper.ordinal()];
            if (i9 == 1) {
    ...
    public boolean sameFixedHeight(int i9) {
        return this.mParent.getHeight().equalsFixedValue(i9);
    }

    public boolean sameFixedWidth(int i9) {
        return this.mParent.getWidth().equalsFixedValue(i9);
    }
