...
public class ConstraintReference implements Reference {
    ...
    private void applyConnection(ConstraintWidget constraintWidget, Object obj, State.Constraint constraint) {
        ...
        int i9 = iArr[constraint.ordinal()];
    ...
    public void addCustomColor(String str, int i9) {
        this.mCustomColors.put(str, Integer.valueOf(i9));
    }
    ...
    public void apply() {
        ...
        int i9 = this.mHorizontalChainStyle;
        if (i9 != 0) {
            this.mConstraintWidget.setHorizontalChainStyle(i9);
        }
        int i10 = this.mVerticalChainStyle;
        if (i10 != 0) {
            this.mConstraintWidget.setVerticalChainStyle(i10);
        }
    ...
    public ConstraintReference bias(float f10) {
        ...
        int i9 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()];
        if (i9 != 17) {
            if (i9 != 18) {
                switch (i9) {
                }
    ...
    public ConstraintReference visibility(int i9) {
        this.mVisibility = i9;
        return this;
    }
    ...
    public ConstraintReference margin(int i9) {
        ...
        if (constraint != null) {
            switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()]) {
                ...
                case 14:
                case 15:
                    this.mMarginBaseline = i9;
                    break;
                case 16:
                    this.mCircularDistance = i9;
                    break;
            }
        } else {
            this.mMarginLeft = i9;
    ...
    public ConstraintReference marginGone(int i9) {
        State.Constraint constraint = this.mLast;
        if (constraint != null) {
            switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()]) {
                case 1:
                case 2:
                    this.mMarginLeftGone = i9;
                    break;
                case 3:
                case 4:
                    this.mMarginRightGone = i9;
                    break;
                case 5:
                case 6:
                    this.mMarginStartGone = i9;
                    break;
                case 7:
                case 8:
                    this.mMarginEndGone = i9;
                    break;
                case 9:
                case 10:
                    this.mMarginTopGone = i9;
                    break;
                case 11:
                case 12:
                    this.mMarginBottomGone = i9;
                    break;
                case 13:
                case 14:
                case 15:
                    this.mMarginBaselineGone = i9;
                    break;
            }
        } else {
            this.mMarginLeftGone = i9;
