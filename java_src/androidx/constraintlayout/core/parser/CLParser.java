...
public class CLParser {
    ...
    private CLElement createElement(CLElement cLElement, int i9, TYPE type, boolean z10, char[] cArr) {
        CLElement allocate;
        if (DEBUG) {
    ...
    private CLElement getNextJsonElement(int i9, char c10, CLElement cLElement, char[] cArr) throws CLParsingException {
        if (c10 == '\t' || c10 == '\n' || c10 == '\r' || c10 == ' ') {
            return cLElement;
        }
        if (c10 == '\"' || c10 == '\'') {
            if (cLElement instanceof CLObject) {
                return createElement(cLElement, i9, TYPE.KEY, true, cArr);
            }
            return createElement(cLElement, i9, TYPE.STRING, true, cArr);
        } else if (c10 != '[') {
            if (c10 != ']') {
                if (c10 == '{') {
                    return createElement(cLElement, i9, TYPE.OBJECT, true, cArr);
                }
                if (c10 != '}') {
                    switch (c10) {
                        case '+':
                        ...
                        case '8':
                        case '9':
                            return createElement(cLElement, i9, TYPE.NUMBER, true, cArr);
                        case ',':
                        case ':':
                            return cLElement;
                        case '/':
                        ...
                        default:
                            if ((cLElement instanceof CLContainer) && !(cLElement instanceof CLObject)) {
                                CLElement createElement = createElement(cLElement, i9, TYPE.TOKEN, true, cArr);
                                CLToken cLToken = (CLToken) createElement;
                                if (cLToken.validate(c10, i9)) {
            ...
            cLElement.setEnd(i9 - 1);
            CLElement container = cLElement.getContainer();
            container.setEnd(i9);
            return container;
        } else {
            return createElement(cLElement, i9, TYPE.ARRAY, true, cArr);
        }
    }
