...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z10) {
        boolean diff = diff(this.f808x, motionPaths.f808x);
        boolean diff2 = diff(this.f809y, motionPaths.f809y);
    ...
    public void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f808x, this.f809y, this.width, this.height, this.mPathRotate};
        int i9 = 0;
    ...
    public void getCenter(double d10, int[] iArr, double[] dArr, float[] fArr, int i9) {
        float f10 = this.f808x;
        float f11 = this.f809y;
    ...
    void initCartesian(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f17 = motionPaths.f808x;
        float f18 = motionPaths.f809y;
        float f19 = (motionPaths2.f808x + (f13 / 2.0f)) - ((f14 / 2.0f) + f17);
        float f20 = (motionPaths2.f809y + (f15 / 2.0f)) - (f18 + (f16 / 2.0f));
        float f21 = (f13 - f14) * f11;
        float f22 = f21 / 2.0f;
        this.f808x = (int) ((f17 + (f19 * f10)) - f22);
        float f23 = (f15 - f16) * f12;
        float f24 = f23 / 2.0f;
        this.f809y = (int) ((f18 + (f20 * f10)) - f24);
        ...
        this.mMode = 0;
        this.f808x = (int) (((motionPaths.f808x + (f25 * f19)) + (f27 * f20)) - f22);
        this.f809y = (int) (((motionPaths.f809y + (f19 * f26)) + (f20 * f10)) - f24);
    ...
    void initPath(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f19 = motionPaths.f809y;
        float f20 = motionPaths.height;
        float f21 = (motionPaths2.f808x + (motionPaths2.width / 2.0f)) - ((f18 / 2.0f) + f17);
        float f22 = (motionPaths2.f809y + (motionPaths2.height / 2.0f)) - ((f20 / 2.0f) + f19);
        float f23 = f21 * f12;
        float f24 = (f15 * f13) / 2.0f;
        this.f808x = (int) ((f17 + f23) - f24);
        float f25 = f12 * f22;
        float f26 = (f16 * f14) / 2.0f;
        this.f809y = (int) ((f19 + f25) - f26);
        ...
        this.mMode = 1;
        float f28 = (int) ((motionPaths.f808x + f23) - f24);
        float f29 = (int) ((motionPaths.f809y + f25) - f26);
        this.f808x = f28 + ((-f22) * f27);
        this.f809y = f29 + (f21 * f27);
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(motionKeyPosition.mTransitionEasing);
        this.mPathMotionArc = motionKeyPosition.mPathMotionArc;
    }

    void initPolar(int i9, int i10, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        float min;
        float f10;
        ...
        if (i11 == 1) {
            ...
            float f19 = motionPaths2.f808x;
            float f20 = motionPaths.f808x;
            this.f808x = (f18 * (f19 - f20)) + f20;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f11 = motionKeyPosition.mPercentY;
            }
            float f21 = motionPaths2.f809y;
            float f22 = motionPaths.f809y;
            this.f809y = (f11 * (f21 - f22)) + f22;
        } else if (i11 != 2) {
            float f23 = Float.isNaN(motionKeyPosition.mPercentX) ? f11 : motionKeyPosition.mPercentX;
            float f24 = motionPaths2.f808x;
            float f25 = motionPaths.f808x;
            this.f808x = (f23 * (f24 - f25)) + f25;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f11 = motionKeyPosition.mPercentY;
            }
            float f26 = motionPaths2.f809y;
            float f27 = motionPaths.f809y;
            this.f809y = (f11 * (f26 - f27)) + f27;
        } else {
            if (Float.isNaN(motionKeyPosition.mPercentX)) {
                float f28 = motionPaths2.f808x;
                float f29 = motionPaths.f808x;
                min = ((f28 - f29) * f11) + f29;
            } else {
            ...
            this.f808x = min;
            if (Float.isNaN(motionKeyPosition.mPercentY)) {
                float f30 = motionPaths2.f809y;
                float f31 = motionPaths.f809y;
                f10 = (f11 * (f30 - f31)) + f31;
            } else {
                f10 = motionKeyPosition.mPercentY;
            }
    ...
    void initScreen(int i9, int i10, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        float f10 = motionKeyPosition.mFramePosition / 100.0f;
        this.time = f10;
        this.mDrawPath = motionKeyPosition.mDrawPath;
        float f11 = Float.isNaN(motionKeyPosition.mPercentWidth) ? f10 : motionKeyPosition.mPercentWidth;
        ...
        float f17 = motionPaths.f808x;
        float f18 = motionPaths.f809y;
        float f19 = motionPaths2.f808x + (f13 / 2.0f);
        float f20 = motionPaths2.f809y + (f15 / 2.0f);
        float f21 = (f13 - f14) * f11;
        this.f808x = (int) ((f17 + ((f19 - ((f14 / 2.0f) + f17)) * f10)) - (f21 / 2.0f));
        float f22 = (f15 - f16) * f12;
        this.f809y = (int) ((f18 + ((f20 - (f18 + (f16 / 2.0f))) * f10)) - (f22 / 2.0f));
        this.width = (int) (f14 + f21);
        this.height = (int) (f16 + f22);
        this.mMode = 2;
        if (!Float.isNaN(motionKeyPosition.mPercentX)) {
            this.f808x = (int) (motionKeyPosition.mPercentX * ((int) (i9 - this.width)));
        }
        if (!Float.isNaN(motionKeyPosition.mPercentY)) {
            this.f809y = (int) (motionKeyPosition.mPercentY * ((int) (i10 - this.height)));
        }
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(motionKeyPosition.mTransitionEasing);
        this.mPathMotionArc = motionKeyPosition.mPathMotionArc;
    ...
    public void setView(float f10, MotionWidget motionWidget, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3) {
        float f11;
        float f12;
        float f13 = this.f808x;
        float f14 = this.f809y;
    ...
    public void setupRelative(Motion motion, MotionPaths motionPaths) {
        double d10 = ((this.f808x + (this.width / 2.0f)) - motionPaths.f808x) - (motionPaths.width / 2.0f);
        double d11 = ((this.f809y + (this.height / 2.0f)) - motionPaths.f809y) - (motionPaths.height / 2.0f);
        this.mRelativeToController = motion;
        this.f808x = (float) Math.hypot(d11, d10);
        if (Float.isNaN(this.mRelativeAngle)) {
            this.f809y = (float) (Math.atan2(d11, d10) + 1.5707963267948966d);
        } else {
            this.f809y = (float) Math.toRadians(this.mRelativeAngle);
        }
    }
    ...
    public void getCenter(double d10, int[] iArr, double[] dArr, float[] fArr, double[] dArr2, float[] fArr2) {
        float f10;
        float f11 = this.f808x;
        float f12 = this.f809y;
