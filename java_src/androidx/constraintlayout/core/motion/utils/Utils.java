...
public class Utils {
    ...
    public static void logStack(String str, int i9) {
        ...
        for (int i10 = 1; i10 <= min; i10++) {
            ...
            str2 = str2 + " ";
            PrintStream printStream = System.out;
            printStream.println(str + str2 + (".(" + stackTrace[i10].getFileName() + CertificateUtil.DELIMITER + stackTrace[i10].getLineNumber() + ") " + stackTrace[i10].getMethodName()) + str2);
        }
    }
