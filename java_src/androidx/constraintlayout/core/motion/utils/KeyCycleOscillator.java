...
public abstract class KeyCycleOscillator {
    ...
    public static class CycleOscillator {
        ...
        public void setPoint(int i9, int i10, float f10, float f11, float f12, float f13) {
            this.mPosition[i9] = i10 / 100.0d;
            this.mPeriod[i9] = f10;
            this.mOffset[i9] = f11;
            this.mPhase[i9] = f12;
            this.mValues[i9] = f13;
        ...
        public void setup(float f10) {
            ...
            for (int i9 = 0; i9 < dArr.length; i9++) {
                dArr[i9][0] = this.mOffset[i9];
                dArr[i9][1] = this.mPhase[i9];
                dArr[i9][2] = this.mValues[i9];
                this.mOscillator.addPoint(this.mPosition[i9], this.mPeriod[i9]);
            }
    ...
    private static class IntDoubleSort {
        ...
        static void sort(int[] iArr, float[] fArr, int i9, int i10) {
    ...
    private static class IntFloatFloatSort {
        ...
        private static int partition(int[] iArr, float[] fArr, float[] fArr2, int i9, int i10) {
            int i11 = iArr[i10];
            int i12 = i9;
            while (i9 < i10) {
                if (iArr[i9] <= i11) {
                    swap(iArr, fArr, fArr2, i12, i9);
                    i12++;
                }
                i9++;
            }
        ...
        static void sort(int[] iArr, float[] fArr, float[] fArr2, int i9, int i10) {
            int[] iArr2 = new int[iArr.length + 10];
            iArr2[0] = i10;
            iArr2[1] = i9;
            int i11 = 2;
        ...
        private static void swap(int[] iArr, float[] fArr, float[] fArr2, int i9, int i10) {
            int i11 = iArr[i9];
            iArr[i9] = iArr[i10];
            iArr[i10] = i11;
            float f10 = fArr[i9];
    ...
    public static class WavePoint {
        ...
        public WavePoint(int i9, float f10, float f11, float f12, float f13) {
            this.mPosition = i9;
            this.mValue = f13;
            this.mOffset = f11;
            this.mPeriod = f10;
    ...
    public void setPoint(int i9, int i10, String str, int i11, float f10, float f11, float f12, float f13, Object obj) {
        this.mWavePoints.add(new WavePoint(i9, f10, f11, f12, f13));
        if (i11 != -1) {
            this.mVariesBy = i11;
        }
        this.mWaveShape = i10;
    ...
    public void setup(float f10) {
        ...
        while (it.hasNext()) {
            ...
            dArr5[2] = f14;
            this.mCycleOscillator.setPoint(i9, next.mPosition, f11, f13, f14, f12);
            i9++;
            c10 = 0;
        }
    ...
    public void setPoint(int i9, int i10, String str, int i11, float f10, float f11, float f12, float f13) {
        this.mWavePoints.add(new WavePoint(i9, f10, f11, f12, f13));
        if (i11 != -1) {
            this.mVariesBy = i11;
        }
