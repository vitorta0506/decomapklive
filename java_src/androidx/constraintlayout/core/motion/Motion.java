...
public class Motion implements TypedValues {
    ...
    private static DifferentialInterpolator getInterpolator(int i9, String str, int i10) {
        if (i9 != -1) {
            return null;
        }
    ...
    void buildRectangles(float[] fArr, int i9) {
        float f10 = 1.0f / (i9 - 1);
        for (int i10 = 0; i10 < i9; i10++) {
    ...
    int getAttributeValues(String str, float[] fArr, int i9) {
    ...
    void getDpDt(float f10, float f11, float f12, float[] fArr) {
        ...
        float f14 = motionPaths.f808x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f15 = f14 - motionPaths2.f808x;
        float f16 = motionPaths.f809y - motionPaths2.f809y;
    ...
    public float getFinalX() {
        return this.mEndMotionPath.f808x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f809y;
    }
    ...
    float getKeyFrameParameter(int i9, float f10, float f11) {
        MotionPaths motionPaths = this.mEndMotionPath;
        float f12 = motionPaths.f808x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f13 = motionPaths2.f808x;
        float f14 = f12 - f13;
        float f15 = motionPaths.f809y;
        float f16 = motionPaths2.f809y;
        float f17 = f15 - f16;
    ...
    MotionKeyPosition getPositionKeyframe(int i9, int i10, float f10, float f11) {
        FloatRect floatRect = new FloatRect();
        MotionPaths motionPaths = this.mStartMotionPath;
        float f12 = motionPaths.f808x;
        floatRect.left = f12;
        float f13 = motionPaths.f809y;
        floatRect.top = f13;
        floatRect.right = f12 + motionPaths.width;
        floatRect.bottom = f13 + motionPaths.height;
        FloatRect floatRect2 = new FloatRect();
        MotionPaths motionPaths2 = this.mEndMotionPath;
        float f14 = motionPaths2.f808x;
        floatRect2.left = f14;
        float f15 = motionPaths2.f809y;
        floatRect2.top = f15;
        ...
        while (it.hasNext()) {
            ...
            if (next instanceof MotionKeyPosition) {
                MotionKeyPosition motionKeyPosition = (MotionKeyPosition) next;
                if (motionKeyPosition.intersects(i9, i10, floatRect, floatRect2, f10, f11)) {
    ...
    void getPostLayoutDvDp(float f10, int i9, int i10, float f11, float f12, float[] fArr) {
        float adjustedPosition = getAdjustedPosition(f10, this.mVelocity);
        HashMap<String, SplineSet> hashMap = this.mAttributesMap;
        SplineSet splineSet = hashMap == null ? null : hashMap.get("translationX");
        HashMap<String, SplineSet> hashMap2 = this.mAttributesMap;
    ...
    public float getStartX() {
        return this.mStartMotionPath.f808x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f809y;
    }
    ...
    public boolean interpolate(MotionWidget motionWidget, float f10, long j10, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            MotionPaths motionPaths = this.mStartMotionPath;
            float f15 = motionPaths.f808x;
            MotionPaths motionPaths2 = this.mEndMotionPath;
            float f16 = f15 + ((motionPaths2.f808x - f15) * f14);
            float f17 = motionPaths.f809y;
            float f18 = f17 + ((motionPaths2.f809y - f17) * f14);
    ...
    public void setStartState(ViewState viewState, MotionWidget motionWidget, int i9, int i10, int i11) {
        ...
        this.mStartPoint.setState(rect, motionWidget, i9, viewState.rotation);
    }
    ...
    public void setup(int i9, int i10, float f10, long j10) {
        ...
        if (arrayList2 != null) {
            ...
            while (it2.hasNext()) {
                ...
                if (next instanceof MotionKeyPosition) {
                    MotionKeyPosition motionKeyPosition = (MotionKeyPosition) next;
                    insertKey(new MotionPaths(i9, i10, motionKeyPosition, this.mStartMotionPath, this.mEndMotionPath));
        ...
        if (motionPathsArr[0].mPathMotionArc != -1) {
            ...
            for (int i29 = 0; i29 < size; i29++) {
                ...
                dArr6[i29][0] = motionPathsArr[i29].f808x;
                dArr6[i29][1] = motionPathsArr[i29].f809y;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f808x + " y: " + this.mStartMotionPath.f809y + " end: x: " + this.mEndMotionPath.f808x + " y: " + this.mEndMotionPath.f809y;
    }
