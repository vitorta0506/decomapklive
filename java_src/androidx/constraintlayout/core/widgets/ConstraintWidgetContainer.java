...
public class ConstraintWidgetContainer extends WidgetContainer {
    ...
    private void addHorizontalChain(ConstraintWidget constraintWidget) {
        int i9 = this.mHorizontalChainsSize + 1;
    ...
    public boolean directMeasureWithOrientation(boolean z10, int i9) {
        return this.mDependencyGraph.directMeasureWithOrientation(z10, i9);
    }
    ...
    */
    ...
    public long measure(int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17) {
        ...
        return this.mBasicMeasureSolver.solverMeasure(this, i9, i16, i17, i10, i11, i12, i13, i14, i15);
    }
    ...
    public void updateFromRuns(boolean z10, boolean z11) {
        ...
        int size = this.mChildren.size();
        for (int i9 = 0; i9 < size; i9++) {
            this.mChildren.get(i9).updateFromRuns(z10, z11);
        }
    }
    ...
    public static boolean measure(int i9, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, BasicMeasure.Measure measure, int i10) {
        int i11;
        int i12;
        if (measurer == null) {
            return false;
    ...
    public ConstraintWidgetContainer(String str, int i9, int i10) {
        super(i9, i10);
        this.mBasicMeasureSolver = new BasicMeasure(this);
        this.mDependencyGraph = new DependencyGraph(this);
        this.mMeasurer = null;
