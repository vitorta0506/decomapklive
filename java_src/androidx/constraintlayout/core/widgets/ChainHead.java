...
public class ChainHead {
    ...
    public ChainHead(ConstraintWidget constraintWidget, int i9, boolean z10) {
    ...
    private void defineChainProperties() {
        ...
        while (!z11) {
            ...
            constraintWidget.mListNextMatchConstraintsWidget[i10] = null;
            if (constraintWidget.getVisibility() != 8) {
                ...
                int margin = this.mTotalSize + constraintWidget.mListAnchors[i9].getMargin();
                this.mTotalSize = margin;
                int i11 = i9 + 1;
                this.mTotalSize = margin + constraintWidget.mListAnchors[i11].getMargin();
                int margin2 = this.mTotalMargins + constraintWidget.mListAnchors[i9].getMargin();
                this.mTotalMargins = margin2;
                this.mTotalMargins = margin2 + constraintWidget.mListAnchors[i11].getMargin();
                ...
                if (dimensionBehaviourArr[i12] == dimensionBehaviour2) {
                    ...
                    if (iArr[i12] == 0 || iArr[i12] == 3 || iArr[i12] == 2) {
                        ...
                        if (isMatchConstraintEqualityCandidate(constraintWidget, i12)) {
                            if (f10 < 0.0f) {
        ...
        if (constraintWidget6 != null) {
            this.mTotalSize -= constraintWidget6.mListAnchors[i9].getMargin();
        }
        ConstraintWidget constraintWidget7 = this.mLastVisibleWidget;
        if (constraintWidget7 != null) {
            this.mTotalSize -= constraintWidget7.mListAnchors[i9 + 1].getMargin();
        }
    ...
    private static boolean isMatchConstraintEqualityCandidate(ConstraintWidget constraintWidget, int i9) {
