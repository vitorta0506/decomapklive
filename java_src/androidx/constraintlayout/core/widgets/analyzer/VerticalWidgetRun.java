...
public class VerticalWidgetRun extends WidgetRun {
    ...
    void apply() {
        ...
        if (!z10 && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            if (i9 != 2) {
                if (i9 == 3 && !constraintWidget3.isInVerticalChain()) {
    ...
    public void update(Dependency dependency) {
        ...
        if (dimensionDependency2.readyToSolve && !dimensionDependency2.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            if (i11 != 2) {
                if (i11 == 3 && constraintWidget3.horizontalRun.dimension.resolved) {
                    ...
                    if (dimensionRatioSide == -1) {
                        ...
                        f11 = constraintWidget.horizontalRun.dimension.value * this.widget.getDimensionRatio();
                        i9 = (int) (f11 + 0.5f);
                        this.dimension.resolve(i9);
            ...
            if (dependencyNode2.readyToSolve) {
                ...
                if (!this.dimension.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                    ...
                    if (constraintWidget6.mMatchConstraintDefaultWidth == 0 && !constraintWidget6.isInVerticalChain()) {
                        ...
                        int i13 = i12 + dependencyNode3.margin;
                        int i14 = this.end.targets.get(0).value + this.end.margin;
                        dependencyNode3.resolve(i13);
                ...
                if (!this.dimension.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && this.matchConstraintsType == 1 && this.start.targets.size() > 0 && this.end.targets.size() > 0) {
                    int i15 = (this.end.targets.get(0).value + this.end.margin) - (this.start.targets.get(0).value + this.start.margin);
                    DimensionDependency dimensionDependency3 = this.dimension;
                ...
                if (this.dimension.resolved && this.start.targets.size() > 0 && this.end.targets.size() > 0) {
                    ...
                    int i17 = dependencyNode4.value + this.start.margin;
                    int i18 = dependencyNode5.value + this.end.margin;
                    float verticalBiasPercent = this.widget.getVerticalBiasPercent();
                    if (dependencyNode4 == dependencyNode5) {
                        i17 = dependencyNode4.value;
                        i18 = dependencyNode5.value;
                        verticalBiasPercent = 0.5f;
                    }
                    this.start.resolve((int) (i17 + 0.5f + (((i18 - i17) - this.dimension.value) * verticalBiasPercent)));
