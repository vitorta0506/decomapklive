...
public class Direct {
    ...
    private static boolean canMeasure(int i9, ConstraintWidget constraintWidget) {
    ...
    private static void horizontalSolvingPass(int i9, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, boolean z10) {
            ...
            while (it.hasNext()) {
                ...
                if (horizontalDimensionBehaviour == dimensionBehaviour && !canMeasure) {
                    if (constraintWidget2.getHorizontalDimensionBehaviour() == dimensionBehaviour && constraintWidget2.mMatchConstraintMaxWidth >= 0 && constraintWidget2.mMatchConstraintMinWidth >= 0 && ((constraintWidget2.getVisibility() == 8 || (constraintWidget2.mMatchConstraintDefaultWidth == 0 && constraintWidget2.getDimensionRatio() == 0.0f)) && !constraintWidget2.isInHorizontalChain() && !constraintWidget2.isInVirtualLayout() && z11 && !constraintWidget2.isInHorizontalChain())) {
                        solveHorizontalMatchConstraint(i11, constraintWidget, measurer, constraintWidget2, z10);
                    }
                    ...
                    if (next == constraintAnchor5 && constraintWidget2.mRight.mTarget == null) {
                        ...
                        horizontalSolvingPass(i11, constraintWidget2, measurer, z10);
                    } else {
                        ...
                        if (next == constraintAnchor6 && constraintAnchor5.mTarget == null) {
                            ...
                            solveHorizontalCenterConstraints(i11, measurer, constraintWidget2, z10);
                        }
                    }
                }
            }
                ...
                if (horizontalDimensionBehaviour2 == dimensionBehaviour2 && !canMeasure2) {
                    if (constraintWidget3.getHorizontalDimensionBehaviour() == dimensionBehaviour2 && constraintWidget3.mMatchConstraintMaxWidth >= 0 && constraintWidget3.mMatchConstraintMinWidth >= 0 && (constraintWidget3.getVisibility() == 8 || (constraintWidget3.mMatchConstraintDefaultWidth == 0 && constraintWidget3.getDimensionRatio() == 0.0f))) {
                        if (!constraintWidget3.isInHorizontalChain() && !constraintWidget3.isInVirtualLayout() && z12 && !constraintWidget3.isInHorizontalChain()) {
                            solveHorizontalMatchConstraint(i12, constraintWidget, measurer, constraintWidget3, z10);
                        }
                    }
                    ...
                    if (next2 == constraintAnchor7 && constraintWidget3.mRight.mTarget == null) {
                        ...
                        horizontalSolvingPass(i12, constraintWidget3, measurer, z10);
                    } else {
                        ...
                        if (next2 == constraintAnchor8 && constraintAnchor7.mTarget == null) {
                            ...
                            solveHorizontalCenterConstraints(i12, measurer, constraintWidget3, z10);
                        }
                    }
                }
            }
    ...
    private static void solveBarrier(int i9, Barrier barrier, BasicMeasure.Measurer measurer, int i10, boolean z10) {
        if (barrier.allSolved()) {
            if (i10 == 0) {
                horizontalSolvingPass(i9 + 1, barrier, measurer, z10);
            } else {
                verticalSolvingPass(i9 + 1, barrier, measurer);
            }
        }
    }
    ...
    */
    ...
    private static void solveHorizontalCenterConstraints(int i9, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget, boolean z10) {
        ...
        horizontalSolvingPass(i9 + 1, constraintWidget, measurer, z10);
    }

    private static void solveHorizontalMatchConstraint(int i9, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget2, boolean z10) {
        int width;
        ...
        if (finalValue2 >= finalValue) {
            ...
            horizontalSolvingPass(i9 + 1, constraintWidget2, measurer, z10);
        }
    }

    private static void solveVerticalCenterConstraints(int i9, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget) {
        ...
        verticalSolvingPass(i9 + 1, constraintWidget, measurer);
    }

    private static void solveVerticalMatchConstraint(int i9, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget2) {
        int height;
        ...
        if (finalValue2 >= finalValue) {
            ...
            verticalSolvingPass(i9 + 1, constraintWidget2, measurer);
        }
    }
    ...
    public static void solvingPass(ConstraintWidgetContainer constraintWidgetContainer, BasicMeasure.Measurer measurer) {
        ...
        for (int i9 = 0; i9 < size; i9++) {
            children.get(i9).resetFinalResolution();
        }
    ...
    private static void verticalSolvingPass(int i9, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer) {
        ConstraintAnchor constraintAnchor;
        ConstraintAnchor constraintAnchor2;
        ConstraintAnchor constraintAnchor3;
        ConstraintAnchor constraintAnchor4;
