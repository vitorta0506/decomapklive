...
public class ChainRun extends WidgetRun {
    ...
    private ConstraintWidget getFirstVisibleWidget() {
        for (int i9 = 0; i9 < this.widgets.size(); i9++) {
            WidgetRun widgetRun = this.widgets.get(i9);
    ...
    public void applyToWidget() {
        for (int i9 = 0; i9 < this.widgets.size(); i9++) {
            this.widgets.get(i9).applyToWidget();
        }
    }
    ...
    public long getWrapDimension() {
        ...
        for (int i9 = 0; i9 < size; i9++) {
            WidgetRun widgetRun = this.widgets.get(i9);
            j10 = j10 + widgetRun.start.margin + widgetRun.getWrapDimension() + widgetRun.end.margin;
        }
        return j10;
    }
    ...
    boolean supportsWrapComputation() {
        int size = this.widgets.size();
        for (int i9 = 0; i9 < size; i9++) {
            if (!this.widgets.get(i9).supportsWrapComputation()) {
                return false;
            }
        }
        return true;
