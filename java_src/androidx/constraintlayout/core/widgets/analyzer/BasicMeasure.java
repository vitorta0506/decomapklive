...
public class BasicMeasure {
    ...
    private boolean measure(Measurer measurer, ConstraintWidget constraintWidget, int i9) {
    ...
    */
    ...
    private void solveLinearSystem(ConstraintWidgetContainer constraintWidgetContainer, String str, int i9, int i10, int i11) {
        ...
        this.constraintWidgetContainer.setPass(i9);
        this.constraintWidgetContainer.layout();
    }

    public long solverMeasure(ConstraintWidgetContainer constraintWidgetContainer, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17) {
        boolean z10;
        int i18;
        int i19;
        boolean z11;
        ...
        boolean enabled = Optimizer.enabled(i9, 128);
        boolean z13 = enabled || Optimizer.enabled(i9, 64);
        if (z13) {
        ...
        boolean z15 = z13 & ((i12 == 1073741824 && i14 == 1073741824) || enabled);
        if (z15) {
            ...
            while (i29 < i30) {
                ...
                while (i31 < size2) {
                    ...
                    if (((constraintWidget3 instanceof Helper) && !(constraintWidget3 instanceof VirtualLayout)) || (constraintWidget3 instanceof Guideline) || constraintWidget3.getVisibility() == 8 || ((z15 && constraintWidget3.horizontalRun.dimension.resolved && constraintWidget3.verticalRun.dimension.resolved) || (constraintWidget3 instanceof VirtualLayout))) {
                        ...
                        boolean measure2 = measure(measurer2, constraintWidget3, i32) | z18;
