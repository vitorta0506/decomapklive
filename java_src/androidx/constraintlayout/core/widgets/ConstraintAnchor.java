...
public class ConstraintAnchor {
    ...
    private boolean isConnectionToMe(ConstraintWidget constraintWidget, HashSet<ConstraintWidget> hashSet) {
        ...
        for (int i9 = 0; i9 < size; i9++) {
            ConstraintAnchor constraintAnchor = anchors.get(i9);
    ...
    public boolean connect(ConstraintAnchor constraintAnchor, int i9, int i10, boolean z10) {
    ...
    public void findDependents(int i9, ArrayList<WidgetGroup> arrayList, WidgetGroup widgetGroup) {
        HashSet<ConstraintAnchor> hashSet = this.mDependents;
        if (hashSet != null) {
            Iterator<ConstraintAnchor> it = hashSet.iterator();
            while (it.hasNext()) {
                Grouping.findDependents(it.next().mOwner, i9, arrayList, widgetGroup);
            }
        }
    }
        ...
        switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$widgets$ConstraintAnchor$Type[type2.ordinal()]) {
            ...
            case 3:
                ...
                if (constraintAnchor.getOwner() instanceof Guideline) {
                    return (z11 || type == Type.CENTER_X) ? true : true;
                }
                return z11;
            case 4:
            case 5:
                ...
                if (constraintAnchor.getOwner() instanceof Guideline) {
                    return (z12 || type == Type.CENTER_Y) ? true : true;
                }
                return z12;
            case 6:
    ...
    public boolean connect(ConstraintAnchor constraintAnchor, int i9) {
        return connect(constraintAnchor, i9, Integer.MIN_VALUE, false);
    }
}
