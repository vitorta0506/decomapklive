...
public class Barrier extends HelperWidget {
    ...
    public void addToSolver(LinearSystem linearSystem, boolean z10) {
        ...
        int i16 = !z11 && (((i9 = this.mBarrierType) == 0 && z12) || ((i9 == 2 && z13) || ((i9 == 1 && z12) || (i9 == 3 && z13)))) ? 5 : 4;
        for (int i17 = 0; i17 < this.mWidgetsCount; i17++) {
            ...
            if (this.mAllowsGoneWidget || constraintWidget2.allowedInBarrier()) {
                ...
                if (i18 != 0 && i18 != 2) {
                    linearSystem.addGreaterBarrier(constraintAnchor.mSolverVariable, createObjectVariable, this.mMargin + i19, z11);
                } else {
                    linearSystem.addLowerBarrier(constraintAnchor.mSolverVariable, createObjectVariable, this.mMargin - i19, z11);
                }
