...
public class Guideline extends ConstraintWidget {
    ...
    public void addToSolver(LinearSystem linearSystem, boolean z10) {
        ...
        if (this.mOrientation == 0) {
            ...
            z12 = (constraintWidget2 == null || constraintWidget2.mListDimensionBehaviors[1] != ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) ? false : false;
        }
