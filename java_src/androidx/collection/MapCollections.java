...
public abstract class MapCollections<K, V> {
    ...
    final class ArrayIterator<T> implements Iterator<T> {
        ...
        public void remove() {
            if (this.mCanRemove) {
                ...
                MapCollections.this.colRemoveAt(i9);
                return;
            }
    ...
    final class EntrySet implements Set<Map.Entry<K, V>> {
        ...
        public int hashCode() {
            ...
            for (int colGetSize = MapCollections.this.colGetSize() - 1; colGetSize >= 0; colGetSize--) {
                ...
                i9 += (colGetEntry == null ? 0 : colGetEntry.hashCode()) ^ (colGetEntry2 == null ? 0 : colGetEntry2.hashCode());
            }
            return i9;
        }
    ...
    final class ValuesCollection implements Collection<V> {
        ...
        public boolean removeAll(Collection<?> collection) {
            ...
            boolean z10 = false;
            while (i9 < colGetSize) {
                if (collection.contains(MapCollections.this.colGetEntry(i9, 1))) {
                    MapCollections.this.colRemoveAt(i9);
                    i9--;
                    colGetSize--;
                    z10 = true;
    ...
    protected abstract Object colGetEntry(int i9, int i10);
    ...
    protected abstract void colPut(K k10, V v10);

    protected abstract void colRemoveAt(int i9);

    protected abstract V colSetValue(int i9, V v10);
    ...
    public Object[] toArrayHelper(int i9) {
        int colGetSize = colGetSize();
        Object[] objArr = new Object[colGetSize];
        for (int i10 = 0; i10 < colGetSize; i10++) {
            objArr[i10] = colGetEntry(i10, i9);
        }
        return objArr;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public <T> T[] toArrayHelper(T[] tArr, int i9) {
        int colGetSize = colGetSize();
        if (tArr.length < colGetSize) {
            tArr = (T[]) ((Object[]) Array.newInstance(tArr.getClass().getComponentType(), colGetSize));
        }
        for (int i10 = 0; i10 < colGetSize; i10++) {
            tArr[i10] = colGetEntry(i10, i9);
        }
        if (tArr.length > colGetSize) {
