...
public final class SparseArrayKt {
    ...
    public static final <T> void forEach(@NotNull SparseArrayCompat<T> sparseArrayCompat, @NotNull Function2<? super Integer, ? super T, Unit> function2) {
        ...
        for (int i9 = 0; i9 < size; i9++) {
            function2.mo1invoke(Integer.valueOf(sparseArrayCompat.keyAt(i9)), sparseArrayCompat.valueAt(i9));
        }
    }

    public static final <T> T getOrDefault(@NotNull SparseArrayCompat<T> sparseArrayCompat, int i9, T t10) {
        return sparseArrayCompat.get(i9, t10);
    }

    public static final <T> T getOrElse(@NotNull SparseArrayCompat<T> sparseArrayCompat, int i9, @NotNull Function0<? extends T> function0) {
        T t10 = sparseArrayCompat.get(i9);
        return t10 != null ? t10 : function0.invoke();
    }
    ...
    public static final <T> boolean remove(@NotNull SparseArrayCompat<T> sparseArrayCompat, int i9, T t10) {
        return sparseArrayCompat.remove(i9, t10);
    }

    public static final <T> void set(@NotNull SparseArrayCompat<T> sparseArrayCompat, int i9, T t10) {
