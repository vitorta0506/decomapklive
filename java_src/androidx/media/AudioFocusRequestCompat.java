...
public class AudioFocusRequestCompat {
    ...
    private static class Api26Impl {
        ...
        @DoNotInline
        static AudioFocusRequest createInstance(int i9, AudioAttributes audioAttributes, boolean z10, AudioManager.OnAudioFocusChangeListener onAudioFocusChangeListener, Handler handler) {
    ...
    AudioFocusRequestCompat(int i9, AudioManager.OnAudioFocusChangeListener onAudioFocusChangeListener, Handler handler, AudioAttributesCompat audioAttributesCompat, boolean z10) {
        this.mFocusGain = i9;
        this.mFocusChangeHandler = handler;
        this.mAudioAttributesCompat = audioAttributesCompat;
        this.mPauseOnDuck = z10;
        ...
        if (i10 >= 26) {
            this.mFrameworkAudioFocusRequest = Api26Impl.createInstance(i9, getAudioAttributes(), z10, this.mOnAudioFocusChangeListener, handler);
        } else {
