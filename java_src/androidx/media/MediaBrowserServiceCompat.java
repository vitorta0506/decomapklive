...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public class ConnectionRecord implements IBinder.DeathRecipient {
        ...
        ConnectionRecord(String str, int i9, int i10, Bundle bundle, ServiceCallbacks serviceCallbacks) {
            this.pkg = str;
            this.pid = i9;
            this.uid = i10;
            this.browserInfo = new MediaSessionManager.RemoteUserInfo(str, i9, i10);
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl {
        ...
        class MediaBrowserServiceApi21 extends MediaBrowserService {
            ...
            public MediaBrowserService.BrowserRoot onGetRoot(String str, int i9, Bundle bundle) {
                ...
                BrowserRoot onGetRoot = MediaBrowserServiceImplApi21.this.onGetRoot(str, i9, bundle == null ? null : new Bundle(bundle));
                if (onGetRoot == null) {
                    return null;
                }
        ...
        public BrowserRoot onGetRoot(String str, int i9, Bundle bundle) {
            Bundle bundle2;
            int i10;
            if (bundle == null || bundle.getInt(MediaBrowserProtocol.EXTRA_CLIENT_VERSION, 0) == 0) {
                ...
                int i11 = bundle.getInt(MediaBrowserProtocol.EXTRA_CALLING_PID, -1);
                bundle.remove(MediaBrowserProtocol.EXTRA_CALLING_PID);
                i10 = i11;
            }
            ConnectionRecord connectionRecord = new ConnectionRecord(str, i10, i9, bundle, null);
        ...
        void notifyChildrenChangedForCompat(final MediaSessionManager.RemoteUserInfo remoteUserInfo, final String str, final Bundle bundle) {
            MediaBrowserServiceCompat.this.mHandler.post(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi21.4
                @Override // java.lang.Runnable
                public void run() {
                    for (int i9 = 0; i9 < MediaBrowserServiceCompat.this.mConnections.size(); i9++) {
                        ConnectionRecord valueAt = MediaBrowserServiceCompat.this.mConnections.valueAt(i9);
    ...
    private class ServiceBinderImpl {
        ...
        public void connect(final String str, final int i9, final int i10, final Bundle bundle, final ServiceCallbacks serviceCallbacks) {
            if (MediaBrowserServiceCompat.this.isValidPackage(str, i10)) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.1
                    ...
                    public void run() {
                        ...
                        ConnectionRecord connectionRecord = new ConnectionRecord(str, i9, i10, bundle, serviceCallbacks);
                        MediaBrowserServiceCompat mediaBrowserServiceCompat = MediaBrowserServiceCompat.this;
                        mediaBrowserServiceCompat.mCurConnection = connectionRecord;
        ...
        public void registerCallbacks(final ServiceCallbacks serviceCallbacks, final String str, final int i9, final int i10, final Bundle bundle) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.6
                ...
                public void run() {
                    ...
                    if (connectionRecord == null) {
                        connectionRecord = new ConnectionRecord(str, i9, i10, bundle, serviceCallbacks);
                    }
    ...
    private static class ServiceCallbacksCompat implements ServiceCallbacks {
        ...
        private void sendRequest(int i9, Bundle bundle) throws RemoteException {
    ...
    boolean isValidPackage(String str, int i9) {
        if (str == null) {
            return false;
        }
    ...
    @Nullable
    public abstract BrowserRoot onGetRoot(@NonNull String str, int i9, @Nullable Bundle bundle);
