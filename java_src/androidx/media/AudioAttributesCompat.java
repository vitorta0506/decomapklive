...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    public static int toVolumeStreamType(boolean z10, int i9, int i10) {
        if ((i9 & 1) == 1) {
            return z10 ? 1 : 7;
        } else if ((i9 & 4) == 4) {
            return z10 ? 0 : 6;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static String usageToString(int i9) {
        switch (i9) {
            case 0:
    ...
    public static class Builder {
        ...
        public Builder setContentType(int i9) {
            this.mBuilderImpl.setContentType(i9);
            return this;
        }

        public Builder setFlags(int i9) {
            this.mBuilderImpl.setFlags(i9);
            return this;
        }

        public Builder setLegacyStreamType(int i9) {
            this.mBuilderImpl.setLegacyStreamType(i9);
            return this;
        }

        public Builder setUsage(int i9) {
            this.mBuilderImpl.setUsage(i9);
            return this;
        }
