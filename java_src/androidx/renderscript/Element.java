...
public class Element extends BaseObj {
    ...
    Element(long j10, RenderScript renderScript, Element[] elementArr, String[] strArr, int[] iArr) {
        ...
        while (true) {
            ...
            if (i9 < elementArr2.length) {
                int[] iArr2 = this.mOffsetInBytes;
                int i10 = this.mSize;
                iArr2[i9] = i10;
                this.mSize = i10 + (elementArr2[i9].mSize * this.mArraySizes[i9]);
                i9++;
            } else {
    ...
    public static Element createPixel(RenderScript renderScript, DataType dataType, DataKind dataKind) {
        ...
        int i9 = AnonymousClass1.$SwitchMap$androidx$renderscript$Element$DataKind[dataKind.ordinal()];
        int i10 = i9 != 1 ? i9 != 2 ? i9 != 3 ? 1 : 4 : 3 : 2;
        return new Element(renderScript.nElementCreate(dataType.mID, dataKind.mID, true, i10), renderScript, dataType, dataKind, true, i10);
    }
    ...
    public static Element createVector(RenderScript renderScript, DataType dataType, int i9) {
        if (i9 >= 2 && i9 <= 4) {
            switch (AnonymousClass1.$SwitchMap$androidx$renderscript$Element$DataType[dataType.ordinal()]) {
                ...
                case 11:
                    DataKind dataKind = DataKind.USER;
                    return new Element(renderScript.nElementCreate(dataType.mID, dataKind.mID, false, i9), renderScript, dataType, dataKind, false, i9);
                default:
    ...
    private void updateVisibleSubElements() {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            if (this.mElementNames[i10].charAt(0) != '#') {
                i9++;
            }
        }
        this.mVisibleElementMap = new int[i9];
        int i11 = 0;
        for (int i12 = 0; i12 < length; i12++) {
            if (this.mElementNames[i12].charAt(0) != '#') {
                this.mVisibleElementMap[i11] = i12;
                i11++;
            }
        }
    }
    ...
    public Element getSubElement(int i9) {
        int[] iArr = this.mVisibleElementMap;
        if (iArr != null) {
            if (i9 >= 0 && i9 < iArr.length) {
                return this.mElements[iArr[i9]];
            }
    ...
    public int getSubElementArraySize(int i9) {
        int[] iArr = this.mVisibleElementMap;
        if (iArr != null) {
            if (i9 >= 0 && i9 < iArr.length) {
                return this.mArraySizes[iArr[i9]];
            }
            throw new RSIllegalArgumentException("Illegal sub-element index");
        }
        throw new RSIllegalArgumentException("Element contains no sub-elements");
    ...
    public String getSubElementName(int i9) {
        int[] iArr = this.mVisibleElementMap;
        if (iArr != null) {
            if (i9 >= 0 && i9 < iArr.length) {
                return this.mElementNames[iArr[i9]];
            }
            throw new RSIllegalArgumentException("Illegal sub-element index");
        }
        throw new RSIllegalArgumentException("Element contains no sub-elements");
    ...
    public int getSubElementOffsetBytes(int i9) {
        int[] iArr = this.mVisibleElementMap;
        if (iArr != null) {
            if (i9 >= 0 && i9 < iArr.length) {
                return this.mOffsetInBytes[iArr[i9]];
            }
            throw new RSIllegalArgumentException("Illegal sub-element index");
        }
        throw new RSIllegalArgumentException("Element contains no sub-elements");
    ...
    public boolean isComplex() {
        ...
        while (true) {
            ...
            if (elementArr[i9].mElements != null) {
                return true;
            }
            i9++;
        }
    ...
    Element(long j10, RenderScript renderScript, DataType dataType, DataKind dataKind, boolean z10, int i9) {
        super(j10, renderScript);
        if (dataType == DataType.UNSIGNED_5_6_5 || dataType == DataType.UNSIGNED_4_4_4_4 || dataType == DataType.UNSIGNED_5_5_5_1) {
            ...
            this.mSize = dataType.mSize * i9;
        }
        this.mType = dataType;
        this.mKind = dataKind;
        this.mNormalized = z10;
        this.mVectorSize = i9;
    }
    ...
    public static class Builder {
        ...
        public Builder add(Element element, String str, int i9) {
            if (i9 >= 1) {
                ...
                if (i10 == elementArr.length) {
                    Element[] elementArr2 = new Element[i10 + 8];
                    String[] strArr = new String[i10 + 8];
                    int[] iArr = new int[i10 + 8];
                    System.arraycopy(elementArr, 0, elementArr2, 0, i10);
                ...
                int i11 = this.mCount;
                elementArr3[i11] = element;
                this.mElementNames[i11] = str;
                this.mArraySizes[i11] = i9;
                this.mCount = i11 + 1;
                return this;
            }
        ...
        public Element create() {
            this.mRS.validate();
            int i9 = this.mCount;
            Element[] elementArr = new Element[i9];
            String[] strArr = new String[i9];
            int[] iArr = new int[i9];
            System.arraycopy(this.mElements, 0, elementArr, 0, i9);
            System.arraycopy(this.mElementNames, 0, strArr, 0, this.mCount);
            System.arraycopy(this.mArraySizes, 0, iArr, 0, this.mCount);
            long[] jArr = new long[i9];
            for (int i10 = 0; i10 < i9; i10++) {
                jArr[i10] = elementArr[i10].getID(this.mRS);
            }
    ...
    Element(long j10, RenderScript renderScript) {
        super(j10, renderScript);
    }
}
