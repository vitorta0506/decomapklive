...
public class StateListDrawable extends DrawableContainer {
    ...
    public static class StateListState extends DrawableContainer.DrawableContainerState {
        ...
        public void growArray(int i9, int i10) {
            super.growArray(i9, i10);
            int[][] iArr = new int[i10];
            System.arraycopy(this.mStateSets, 0, iArr, 0, i9);
    ...
    private void inflateChildElements(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next2 == 2 && depth2 <= depth && xmlPullParser.getName().equals(BaseConfig.ITEM)) {
    ...
    Drawable getStateDrawable(int i9) {
        return this.mStateListState.getChild(i9);
    }
    ...
    int[] getStateSet(int i9) {
        return this.mStateListState.mStateSets[i9];
    }
