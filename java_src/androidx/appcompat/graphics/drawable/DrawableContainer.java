...
public class DrawableContainer extends Drawable implements Drawable.Callback {
    ...
    public static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        private void createAllFutures() {
            ...
            if (sparseArray != null) {
                ...
                for (int i9 = 0; i9 < size; i9++) {
                    this.mDrawables[this.mDrawableFutures.keyAt(i9)] = prepareDrawable(this.mDrawableFutures.valueAt(i9).newDrawable(this.mSourceRes));
                }
        ...
        public final int addChild(Drawable drawable) {
            int i9 = this.mNumChildren;
            if (i9 >= this.mDrawables.length) {
                growArray(i9, i9 + 10);
            }
            drawable.mutate();
            drawable.setVisible(false, true);
            drawable.setCallback(this.mOwner);
            this.mDrawables[i9] = drawable;
            this.mNumChildren++;
            ...
            if (theme != null) {
                ...
                for (int i10 = 0; i10 < i9; i10++) {
                    if (drawableArr[i10] != null && DrawableCompat.canApplyTheme(drawableArr[i10])) {
                        ...
                        this.mChildrenChangingConfigurations |= drawableArr[i10].getChangingConfigurations();
                    }
                }
        ...
        public boolean canApplyTheme() {
            ...
            for (int i10 = 0; i10 < i9; i10++) {
                ...
                if (drawable != null) {
                    ...
                    Drawable.ConstantState constantState = this.mDrawableFutures.get(i10);
        ...
        public final Drawable getChild(int i9) {
            int indexOfKey;
            Drawable drawable = this.mDrawables[i9];
            if (drawable != null) {
                return drawable;
            }
            SparseArray<Drawable.ConstantState> sparseArray = this.mDrawableFutures;
            ...
            this.mDrawables[i9] = prepareDrawable;
        ...
        public final boolean isStateful() {
            ...
            while (true) {
                if (i10 >= i9) {
                    break;
                } else if (drawableArr[i10].isStateful()) {
                    z10 = true;
                    break;
                } else {
                    i10++;
        ...
        public final void setEnterFadeDuration(int i9) {
            this.mEnterFadeDuration = i9;
        }

        public final void setExitFadeDuration(int i9) {
            this.mExitFadeDuration = i9;
        }

        final boolean setLayoutDirection(int i9, int i10) {
            int i11 = this.mNumChildren;
            Drawable[] drawableArr = this.mDrawables;
            boolean z10 = false;
            for (int i12 = 0; i12 < i11; i12++) {
                if (drawableArr[i12] != null) {
                    boolean layoutDirection = Build.VERSION.SDK_INT >= 23 ? DrawableCompat.setLayoutDirection(drawableArr[i12], i9) : false;
                    if (i12 == i10) {
                        z10 = layoutDirection;
                    }
                }
    ...
    static int resolveDensity(@Nullable Resources resources, int i9) {
        if (resources != null) {
    ...
    */
    ...
    public boolean onLayoutDirectionChanged(int i9) {
        return this.mDrawableContainerState.setLayoutDirection(i9, getCurrentIndex());
    }
    ...
    */
    ...
    public void setAlpha(int i9) {
        if (this.mHasAlpha && this.mAlpha == i9) {
            return;
        }
        this.mHasAlpha = true;
        this.mAlpha = i9;
    ...
    public void setEnterFadeDuration(int i9) {
        this.mDrawableContainerState.mEnterFadeDuration = i9;
    }

    public void setExitFadeDuration(int i9) {
        this.mDrawableContainerState.mExitFadeDuration = i9;
    }
    ...
    public void setHotspotBounds(int i9, int i10, int i11, int i12) {
        ...
        Drawable drawable = this.mCurrDrawable;
        if (drawable != null) {
            DrawableCompat.setHotspotBounds(drawable, i9, i10, i11, i12);
        }
    }
