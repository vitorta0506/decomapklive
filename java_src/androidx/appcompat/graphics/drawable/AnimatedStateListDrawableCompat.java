...
public class AnimatedStateListDrawableCompat extends StateListDrawable implements TintAwareDrawable {
    ...
    public static class AnimatedStateListState extends StateListDrawable.StateListState {
        ...
        private static long generateTransitionKey(int i9, int i10) {
            return i10 | (i9 << 32);
        }

        int addStateSet(@NonNull int[] iArr, @NonNull Drawable drawable, int i9) {
            int addStateSet = super.addStateSet(iArr, drawable);
            this.mStateIds.put(addStateSet, Integer.valueOf(i9));
            return addStateSet;
        }

        int addTransition(int i9, int i10, @NonNull Drawable drawable, boolean z10) {
            int addChild = super.addChild(drawable);
            long generateTransitionKey = generateTransitionKey(i9, i10);
            long j10 = z10 ? REVERSIBLE_FLAG_BIT : 0L;
            long j11 = addChild;
            this.mTransitions.append(generateTransitionKey, Long.valueOf(j11 | j10));
            if (z10) {
                this.mTransitions.append(generateTransitionKey(i10, i9), Long.valueOf(REVERSED_BIT | j11 | j10));
            }
            return addChild;
        }

        int getKeyframeIdAt(int i9) {
            if (i9 < 0) {
                return 0;
            }
            return this.mStateIds.get(i9, 0).intValue();
        }
        ...
        int indexOfTransition(int i9, int i10) {
            return (int) this.mTransitions.get(generateTransitionKey(i9, i10), -1L).longValue();
        }

        boolean isTransitionReversed(int i9, int i10) {
            return (this.mTransitions.get(generateTransitionKey(i9, i10), -1L).longValue() & REVERSED_BIT) != 0;
        }
        ...
        boolean transitionHasReversibleFlag(int i9, int i10) {
            return (this.mTransitions.get(generateTransitionKey(i9, i10), -1L).longValue() & REVERSIBLE_FLAG_BIT) != 0;
        }
    ...
    private static class FrameInterpolator implements TimeInterpolator {
        ...
        public float getInterpolation(float f10) {
            int i9 = (int) ((f10 * this.mTotalDuration) + 0.5f);
            ...
            return (i11 / i10) + (i11 < i10 ? i9 / this.mTotalDuration : 0.0f);
        }
    ...
    @Nullable
    public static AnimatedStateListDrawableCompat create(@NonNull Context context, @DrawableRes int i9, @Nullable Resources.Theme theme) {
        int next;
        try {
    ...
    private boolean selectTransition(int i9) {
        int currentIndex;
        int indexOfTransition;
        Transition animatableTransition;
        Transition transition = this.mTransition;
        if (transition != null) {
            if (i9 == this.mTransitionToIndex) {
                return true;
            }
            if (i9 == this.mTransitionFromIndex && transition.canReverse()) {
                transition.reverse();
                this.mTransitionToIndex = this.mTransitionFromIndex;
                this.mTransitionFromIndex = i9;
                return true;
            }
        ...
        int keyframeIdAt2 = animatedStateListState.getKeyframeIdAt(i9);
    ...
    public <T extends Drawable & Animatable> void addTransition(int i9, int i10, @NonNull T t10, boolean z10) {
        if (t10 != null) {
            this.mState.addTransition(i9, i10, t10, z10);
            return;
        }
    ...
    @Override // androidx.appcompat.graphics.drawable.DrawableContainer, android.graphics.drawable.Drawable
    public /* bridge */ /* synthetic */ boolean onLayoutDirectionChanged(int i9) {
        return super.onLayoutDirectionChanged(i9);
    }
    ...
    public /* bridge */ /* synthetic */ void setEnterFadeDuration(int i9) {
        super.setEnterFadeDuration(i9);
    }

    @Override // androidx.appcompat.graphics.drawable.DrawableContainer
    public /* bridge */ /* synthetic */ void setExitFadeDuration(int i9) {
        super.setExitFadeDuration(i9);
    }
    ...
    public void addState(@NonNull int[] iArr, @NonNull Drawable drawable, int i9) {
        if (drawable != null) {
            this.mState.addStateSet(iArr, drawable, i9);
            onStateChange(getState());
            return;
        }
