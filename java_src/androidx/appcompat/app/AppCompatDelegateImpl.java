...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private int calculateNightMode() {
        int i9 = this.mLocalNightMode;
        return i9 != -100 ? i9 : AppCompatDelegate.getDefaultNightMode();
    }
    ...
    @NonNull
    private Configuration createOverrideConfigurationForDayNight(@NonNull Context context, int i9, @Nullable Configuration configuration) {
        int i10;
        if (i9 != 1) {
            i10 = i9 != 2 ? context.getApplicationContext().getResources().getConfiguration().uiMode & 48 : 32;
        } else {
            i10 = 16;
        }
    ...
    private ViewGroup createSubDecor() {
        ...
        Context context;
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(R.styleable.AppCompatTheme);
        int i9 = R.styleable.AppCompatTheme_windowActionBar;
        if (obtainStyledAttributes.hasValue(i9)) {
    ...
    private void invalidatePanelMenu(int i9) {
        this.mInvalidatePanelMenuFeatures = (1 << i9) | this.mInvalidatePanelMenuFeatures;
    ...
    private boolean isActivityManifestHandlingUiMode() {
        if (!this.mActivityHandlesUiModeChecked && (this.mHost instanceof Activity)) {
            ...
            try {
                ...
                ActivityInfo activityInfo = packageManager.getActivityInfo(new ComponentName(this.mContext, this.mHost.getClass()), i9 >= 29 ? 269221888 : i9 >= 24 ? 786432 : 0);
    ...
    private boolean onKeyDownPanel(int i9, KeyEvent keyEvent) {
        if (keyEvent.getRepeatCount() == 0) {
            PanelFeatureState panelState = getPanelState(i9, true);
    ...
    private boolean onKeyUpPanel(int i9, KeyEvent keyEvent) {
        boolean z10;
        ...
        boolean z11 = true;
        PanelFeatureState panelState = getPanelState(i9, true);
        if (i9 == 0 && (decorContentParent = this.mDecorContentParent) != null && decorContentParent.canShowOverflowMenu() && !ViewConfiguration.get(this.mContext).hasPermanentMenuKey()) {
        ...
        if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
            ...
            if (viewGroup != null && !panelFeatureState.refreshDecorView) {
                ...
                if (view != null && (layoutParams = view.getLayoutParams()) != null && layoutParams.width == -1) {
                    ...
                    WindowManager.LayoutParams layoutParams2 = new WindowManager.LayoutParams(i9, -2, panelFeatureState.f802x, panelFeatureState.f803y, 1002, 8519680, -3);
            ...
            i9 = -2;
            panelFeatureState.isHandled = false;
            WindowManager.LayoutParams layoutParams22 = new WindowManager.LayoutParams(i9, -2, panelFeatureState.f802x, panelFeatureState.f803y, 1002, 8519680, -3);
    ...
    private boolean performPanelShortcut(PanelFeatureState panelFeatureState, int i9, KeyEvent keyEvent, int i10) {
        ...
        if ((panelFeatureState.isPrepared || preparePanel(panelFeatureState, keyEvent)) && (menuBuilder = panelFeatureState.menu) != null) {
            z10 = menuBuilder.performShortcut(i9, keyEvent, i10);
        }
        if (z10 && (i10 & 1) == 0 && this.mDecorContentParent == null) {
            closePanel(panelFeatureState, true);
        }
        return z10;
    }
    ...
    private int sanitizeWindowFeatureId(int i9) {
        if (i9 == 8) {
    ...
    */
    ...
    private void updateResourcesConfigurationForNightMode(int i9, boolean z10, @Nullable Configuration configuration) {
    ...
    void callOnPanelClosed(int i9, PanelFeatureState panelFeatureState, Menu menu) {
        if (menu == null) {
        ...
        if ((panelFeatureState == null || panelFeatureState.isOpen) && !this.mDestroyed) {
            this.mAppCompatWindowCallback.getWrapped().onPanelClosed(i9, menu);
        }
    }
    ...
    void closePanel(int i9) {
        closePanel(getPanelState(i9, true), true);
    }
    ...
    void doInvalidatePanelMenu(int i9) {
        PanelFeatureState panelState;
        PanelFeatureState panelState2 = getPanelState(i9, true);
        ...
        panelState2.refreshDecorView = true;
        if ((i9 != 108 && i9 != 0) || this.mDecorContentParent == null || (panelState = getPanelState(0, false)) == null) {
            return;
        }
        panelState.isPrepared = false;
    ...
    public <T extends View> T findViewById(@IdRes int i9) {
        ensureSubDecor();
        return (T) this.mWindow.findViewById(i9);
    }
    ...
    protected PanelFeatureState getPanelState(int i9, boolean z10) {
        PanelFeatureState[] panelFeatureStateArr = this.mPanels;
    ...
    public boolean hasWindowFeature(int i9) {
        boolean z10;
        int sanitizeWindowFeatureId = sanitizeWindowFeatureId(i9);
        ...
        return z10 || this.mWindow.hasFeature(i9);
    }
    ...
    int mapNightMode(@NonNull Context context, int i9) {
        if (i9 != -100) {
            if (i9 != -1) {
                if (i9 == 0) {
    ...
    */
    ...
    boolean onKeyShortcut(int i9, KeyEvent keyEvent) {
        ActionBar supportActionBar = getSupportActionBar();
    ...
    public void setLocalNightMode(int i9) {
        if (this.mLocalNightMode != i9) {
            this.mLocalNightMode = i9;
    ...
    */
    ...
    public class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        public View onCreatePanelView(int i9) {
            ...
            return (actionBarMenuCallback == null || (onCreatePanelView = actionBarMenuCallback.onCreatePanelView(i9)) == null) ? super.onCreatePanelView(i9) : onCreatePanelView;
        }

        @Override // androidx.appcompat.view.WindowCallbackWrapper, android.view.Window.Callback
        public boolean onMenuOpened(int i9, Menu menu) {
            super.onMenuOpened(i9, menu);
            AppCompatDelegateImpl.this.onMenuOpened(i9);
            return true;
        }
        ...
        public void onPanelClosed(int i9, Menu menu) {
            ...
            AppCompatDelegateImpl.this.onPanelClosed(i9);
        }
        ...
        public boolean onPreparePanel(int i9, View view, Menu menu) {
            ...
            ActionBarMenuCallback actionBarMenuCallback = this.mActionBarCallback;
            z10 = (actionBarMenuCallback == null || !actionBarMenuCallback.onPreparePanel(i9)) ? false : false;
            if (!z10) {
                z10 = super.onPreparePanel(i9, view, menu);
            }
            if (menuBuilder != null) {
        ...
        @Override // androidx.appcompat.view.WindowCallbackWrapper, android.view.Window.Callback
        @RequiresApi(23)
        public android.view.ActionMode onWindowStartingActionMode(ActionMode.Callback callback, int i9) {
            if (AppCompatDelegateImpl.this.isHandleNativeActionModesEnabled() && i9 == 0) {
                return startAsSupportActionMode(callback);
            }
    ...
    public void setContentView(int i9) {
        ...
        ViewGroup viewGroup = (ViewGroup) this.mSubDecor.findViewById(16908290);
        viewGroup.removeAllViews();
        LayoutInflater.from(this.mContext).inflate(i9, viewGroup);
        this.mAppCompatWindowCallback.getWrapped().onContentChanged();
    }
