...
public class AlertController {
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                ...
                if (this.mIsSingleChoice) {
                    i9 = alertController.mSingleChoiceItemLayout;
                } else {
                    i9 = alertController.mListItemLayout;
                }
                int i10 = i9;
                if (this.mCursor != null) {
                    listAdapter = new SimpleCursorAdapter(this.mContext, i10, this.mCursor, new String[]{this.mLabelColumn}, new int[]{16908308});
                } else {
                    listAdapter = this.mAdapter;
                    if (listAdapter == null) {
                        listAdapter = new CheckedItemAdapter(this.mContext, i10, 16908308, this.mItems);
                    }
                }
            }
        ...
        public void apply(AlertController alertController) {
            ...
            if (view != null) {
                ...
                int i9 = this.mIconId;
                if (i9 != 0) {
                    alertController.setIcon(i9);
                }
                int i10 = this.mIconAttrId;
                if (i10 != 0) {
                    alertController.setIcon(alertController.getIconAttributeResId(i10));
                }
            }
    ...
    private int selectContentView() {
        int i9 = this.mButtonPanelSideLayout;
        if (i9 == 0) {
            return this.mAlertDialogLayout;
        }
        return this.mButtonPanelLayoutHint == 1 ? i9 : this.mAlertDialogLayout;
    }

    private void setScrollIndicators(ViewGroup viewGroup, View view, int i9, int i10) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ViewCompat.setScrollIndicators(view, i9, i10);
    ...
    private void setupView() {
        ...
        if (!z10) {
            ...
            if (view2 != null) {
                setScrollIndicators(resolvePanel2, view2, z11 | (z12 ? 2 : 0), 3);
            }
        }
    ...
    public int getIconAttributeResId(int i9) {
        TypedValue typedValue = new TypedValue();
        this.mContext.getTheme().resolveAttribute(i9, typedValue, true);
    ...
    public void setButton(int i9, CharSequence charSequence, DialogInterface.OnClickListener onClickListener, Message message, Drawable drawable) {
        if (message == null && onClickListener != null) {
            message = this.mHandler.obtainMessage(i9, onClickListener);
        }
        if (i9 == -3) {
    ...
    public void setButtonPanelLayoutHint(int i9) {
        this.mButtonPanelLayoutHint = i9;
    }
    ...
    public void setView(View view, int i9, int i10, int i11, int i12) {
        ...
        this.mViewSpacingLeft = i9;
        this.mViewSpacingTop = i10;
        this.mViewSpacingRight = i11;
        this.mViewSpacingBottom = i12;
    }
}
