...
public abstract class AppCompatDelegate {
    ...
    @Nullable
    public abstract <T extends View> T findViewById(@IdRes int i9);
    ...
    public abstract boolean hasWindowFeature(int i9);
    ...
    public abstract void setContentView(@LayoutRes int i9);
