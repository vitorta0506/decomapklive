...
class ActionBarDrawerToggleHoneycomb {
    ...
    public static SetIndicatorInfo setActionBarDescription(SetIndicatorInfo setIndicatorInfo, Activity activity, int i9) {
        if (setIndicatorInfo == null) {
            setIndicatorInfo = new SetIndicatorInfo(activity);
        }
        if (setIndicatorInfo.setHomeAsUpIndicator != null) {
            try {
                setIndicatorInfo.setHomeActionContentDescription.invoke(activity.getActionBar(), Integer.valueOf(i9));
            } catch (Exception e10) {
    ...
    public static SetIndicatorInfo setActionBarUpIndicator(Activity activity, Drawable drawable, int i9) {
        ...
        if (setIndicatorInfo.setHomeAsUpIndicator != null) {
            try {
                ...
                setIndicatorInfo.setHomeActionContentDescription.invoke(actionBar, Integer.valueOf(i9));
            } catch (Exception e10) {
