...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    static class ToolbarCompatDelegate implements Delegate {
        ...
        public void setActionBarDescription(@StringRes int i9) {
            if (i9 == 0) {
                ...
                this.mToolbar.setNavigationContentDescription(i9);
            }
        }
    ...
    void setActionBarDescription(int i9) {
        this.mActivityImpl.setActionBarDescription(i9);
    }
    ...
    void setActionBarUpIndicator(Drawable drawable, int i9) {
        ...
        this.mActivityImpl.setActionBarUpIndicator(drawable, i9);
    }
    ...
    ActionBarDrawerToggle(Activity activity, Toolbar toolbar, DrawerLayout drawerLayout, DrawerArrowDrawable drawerArrowDrawable, @StringRes int i9, @StringRes int i10) {
