...
public final class Compatibility {
    ...
    public static class Api15Impl {
        ...
        @DoNotInline
        public static void getValueForDensity(@NonNull Resources resources, int i9, int i10, @NonNull TypedValue typedValue, boolean z10) {
            resources.getValueForDensity(i9, i10, typedValue, z10);
        }
    }
