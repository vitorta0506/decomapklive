...
class AppCompatSeekBarHelper extends AppCompatProgressBarHelper {
    ...
    public void drawTickMarks(Canvas canvas) {
        if (this.mTickMark != null) {
            ...
            if (max > 1) {
                ...
                this.mTickMark.setBounds(-i9, -i10, i9, i10);
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i9) {
        ...
        ViewCompat.saveAttributeDataForStyleable(seekBar, seekBar.getContext(), iArr, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), i9, 0);
        ...
        if (obtainStyledAttributes.hasValue(i10)) {
            this.mTickMarkTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(i10, -1), this.mTickMarkTintMode);
            this.mHasTickMarkTintMode = true;
        }
        int i11 = R.styleable.AppCompatSeekBar_tickMarkTint;
        if (obtainStyledAttributes.hasValue(i11)) {
            this.mTickMarkTintList = obtainStyledAttributes.getColorStateList(i11);
