...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    private boolean hitThumb(float f10, float f11) {
        ...
        int i11 = i9 - i10;
        int i12 = (this.mSwitchLeft + thumbOffset) - i10;
        Rect rect = this.mTempRect;
        return f10 > ((float) i12) && f10 < ((float) ((((this.mThumbWidth + i12) + rect.left) + rect.right) + i10)) && f11 > ((float) i11) && f11 < ((float) (this.mSwitchBottom + i10));
    }
    ...
    private void setSwitchTypefaceByIndex(int i9, int i10) {
        Typeface typeface;
        if (i9 == 1) {
            typeface = Typeface.SANS_SERIF;
        } else if (i9 != 2) {
            typeface = i9 != 3 ? null : Typeface.MONOSPACE;
        } else {
            typeface = Typeface.SERIF;
        }
        setSwitchTypeface(typeface, i10);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (drawable2 != null) {
            ...
            if (rect != null) {
                ...
                if (i21 > i22) {
                    i10 = i14 - (i21 - i22);
                    this.mTrackDrawable.setBounds(i11, i9, i13, i10);
                }
            } else {
                i9 = i12;
            }
        ...
        if (drawable3 != null) {
            ...
            int i24 = thumbOffset + this.mThumbWidth + rect2.right;
    ...
    protected void onLayout(boolean z10, int i9, int i10, int i11, int i12) {
        ...
        if (gravity == 16) {
            i15 = this.mSwitchHeight;
            paddingTop = (((getPaddingTop() + getHeight()) - getPaddingBottom()) / 2) - (i15 / 2);
        } else if (gravity != 80) {
            paddingTop = getPaddingTop();
            i15 = this.mSwitchHeight;
        } else {
            i16 = getHeight() - getPaddingBottom();
            paddingTop = i16 - this.mSwitchHeight;
    ...
    public void onMeasure(int i9, int i10) {
        ...
        this.mThumbWidth = Math.max(this.mShowText ? Math.max(this.mOnLayout.getWidth(), this.mOffLayout.getWidth()) + (this.mThumbTextPadding * 2) : 0, i11);
        Drawable drawable2 = this.mTrackDrawable;
        if (drawable2 != null) {
        ...
        int max = Math.max(this.mSwitchMinWidth, (this.mThumbWidth * 2) + i14 + i15);
    ...
    */
    ...
    public void setSwitchMinWidth(int i9) {
        this.mSwitchMinWidth = i9;
        requestLayout();
    }

    public void setSwitchPadding(int i9) {
        this.mSwitchPadding = i9;
        requestLayout();
    }
    ...
    public void setSwitchTypeface(Typeface typeface, int i9) {
        ...
        if (i9 > 0) {
            ...
            int i10 = (~(create != null ? create.getStyle() : 0)) & i9;
    ...
    public void setThumbResource(int i9) {
        setThumbDrawable(AppCompatResources.getDrawable(getContext(), i9));
    }

    public void setThumbTextPadding(int i9) {
        this.mThumbTextPadding = i9;
        requestLayout();
    }
    ...
    public void setTrackResource(int i9) {
        setTrackDrawable(AppCompatResources.getDrawable(getContext(), i9));
    }
    ...
    public SwitchCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i9) {
