...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mReserveOverflow && (z10 || i17 + i16 > i14)) {
            i14--;
        }
        int i19 = i14 - i16;
        ...
        while (i21 < i9) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                if (actionMenuPresenter.mStrictWidthLimit) {
                    i11 -= ActionMenuView.measureChildForCells(itemView, i10, i11, makeMeasureSpec, i13);
                } else {
                ...
                boolean z12 = (i19 > 0 || z11) && i15 > 0 && (!actionMenuPresenter.mStrictWidthLimit || i11 > 0);
                boolean z13 = z12;
                i12 = i9;
                if (z12) {
                    View itemView2 = actionMenuPresenter.getItemView(menuItemImpl2, null, viewGroup);
                    if (actionMenuPresenter.mStrictWidthLimit) {
                        int measureChildForCells = ActionMenuView.measureChildForCells(itemView2, i10, i11, makeMeasureSpec, 0);
                    ...
                    z12 = z14 & (!actionMenuPresenter.mStrictWidthLimit ? i15 + i22 <= 0 : i15 < 0);
                }
                if (z12 && groupId2 != 0) {
    ...
    public void setWidthLimit(int i9, boolean z10) {
        this.mWidthLimit = i9;
    ...
    @Override // androidx.appcompat.view.menu.BaseMenuPresenter
    public boolean shouldIncludeItem(int i9, MenuItemImpl menuItemImpl) {
