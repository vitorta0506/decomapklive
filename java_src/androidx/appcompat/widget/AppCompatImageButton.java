...
public class AppCompatImageButton extends ImageButton implements TintableBackgroundView, TintableImageSourceView {
    ...
    public void setImageResource(@DrawableRes int i9) {
        this.mImageHelper.setImageResource(i9);
    }
    ...
    public AppCompatImageButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i9) {
        ...
        appCompatImageHelper.loadFromAttributes(attributeSet, i9);
    }
}
