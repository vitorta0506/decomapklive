...
public class AppCompatTextViewAutoSizeHelper {
    ...
    @RequiresApi(23)
    private StaticLayout createStaticLayoutForMeasuring(CharSequence charSequence, Layout.Alignment alignment, int i9, int i10) {
        StaticLayout.Builder obtain = StaticLayout.Builder.obtain(charSequence, 0, charSequence.length(), this.mTempTextPaint, i9);
    ...
    private StaticLayout createStaticLayoutForMeasuringPre16(CharSequence charSequence, Layout.Alignment alignment, int i9) {
        return new StaticLayout(charSequence, this.mTempTextPaint, i9, alignment, ((Float) accessAndReturnWithDefault(this.mTextView, "mSpacingMult", Float.valueOf(1.0f))).floatValue(), ((Float) accessAndReturnWithDefault(this.mTextView, "mSpacingAdd", Float.valueOf(0.0f))).floatValue(), ((Boolean) accessAndReturnWithDefault(this.mTextView, "mIncludePad", Boolean.TRUE)).booleanValue());
    }

    @RequiresApi(16)
    private StaticLayout createStaticLayoutForMeasuringPre23(CharSequence charSequence, Layout.Alignment alignment, int i9) {
        return new StaticLayout(charSequence, this.mTempTextPaint, i9, alignment, this.mTextView.getLineSpacingMultiplier(), this.mTextView.getLineSpacingExtra(), this.mTextView.getIncludeFontPadding());
    }
    ...
    private int findLargestTextSizeWhichFits(RectF rectF) {
        ...
        if (length != 0) {
            ...
            while (i10 <= i9) {
                int i12 = (i10 + i9) / 2;
                if (suggestedSizeFitsInSpace(this.mAutoSizeTextSizesInPx[i12], rectF)) {
                    int i13 = i12 + 1;
                    i11 = i10;
                    i10 = i13;
                } else {
            ...
            return this.mAutoSizeTextSizesInPx[i11];
        }
        ...
        if (supportsAutoSizeText() && this.mAutoSizeTextType == 1) {
            if (!this.mHasPresetAutoSizeValues || this.mAutoSizeTextSizesInPx.length == 0) {
                ...
                for (int i9 = 0; i9 < floor; i9++) {
                    iArr[i9] = Math.round(this.mAutoSizeMinTextSizeInPx + (i9 * this.mAutoSizeStepGranularityInPx));
                }
    ...
    private boolean suggestedSizeFitsInSpace(int i9, RectF rectF) {
    ...
    @VisibleForTesting
    StaticLayout createLayout(CharSequence charSequence, Layout.Alignment alignment, int i9, int i10) {
        if (Build.VERSION.SDK_INT >= 23) {
            return createStaticLayoutForMeasuring(charSequence, alignment, i9, i10);
        }
        return createStaticLayoutForMeasuringPre23(charSequence, alignment, i9);
    }
    ...
    void initTempTextPaint(int i9) {
        ...
        this.mTempTextPaint.setTextSize(i9);
    }
    ...
    public void loadFromAttributes(@Nullable AttributeSet attributeSet, int i9) {
        ...
        ViewCompat.saveAttributeDataForStyleable(textView, textView.getContext(), iArr, attributeSet, obtainStyledAttributes, i9, 0);
        ...
        float dimension = obtainStyledAttributes.hasValue(i11) ? obtainStyledAttributes.getDimension(i11, UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE) : UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE;
        int i12 = R.styleable.AppCompatTextView_autoSizeMinTextSize;
        float dimension2 = obtainStyledAttributes.hasValue(i12) ? obtainStyledAttributes.getDimension(i12, UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE) : UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE;
        int i13 = R.styleable.AppCompatTextView_autoSizeMaxTextSize;
        float dimension3 = obtainStyledAttributes.hasValue(i13) ? obtainStyledAttributes.getDimension(i13, UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE) : UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE;
    ...
    public void setAutoSizeTextTypeUniformWithConfiguration(int i9, int i10, int i11, int i12) throws IllegalArgumentException {
        if (supportsAutoSizeText()) {
            DisplayMetrics displayMetrics = this.mContext.getResources().getDisplayMetrics();
            validateAndSetAutoSizeTextTypeUniformConfiguration(TypedValue.applyDimension(i12, i9, displayMetrics), TypedValue.applyDimension(i12, i10, displayMetrics), TypedValue.applyDimension(i12, i11, displayMetrics));
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public void setTextSizeInternal(int i9, float f10) {
        Resources resources;
        Context context = this.mContext;
        if (context == null) {
        ...
        setRawTextSize(TypedValue.applyDimension(i9, f10, resources.getDisplayMetrics()));
    }
}
