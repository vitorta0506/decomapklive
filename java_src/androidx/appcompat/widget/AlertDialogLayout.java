...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private boolean tryOnMeasure(int i9, int i10) {
        int i11;
        int i12;
        int i13;
        int i14;
        ...
        if (view2 != null) {
            ...
            view2.measure(i9, View.MeasureSpec.makeMeasureSpec(i12, BasicMeasure.EXACTLY));
        ...
        setMeasuredDimension(View.resolveSizeAndState(i18 + getPaddingLeft() + getPaddingRight(), i9, i11), View.resolveSizeAndState(paddingTop, i10, 0));
        if (mode2 != 1073741824) {
