...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private Intent createIntent(String str, Uri uri, String str2, String str3, int i9, String str4) {
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int i9, String str) {
        int i10;
        String columnString;
        try {
            ...
            if (columnString3 != null && (columnString = SuggestionsAdapter.getColumnString(cursor, "suggest_intent_data_id")) != null) {
                columnString3 = columnString3 + FileUtils.RES_PREFIX_STORAGE + Uri.encode(columnString);
            }
            return createIntent(str2, columnString3 == null ? null : Uri.parse(columnString3), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_extra_data"), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_query"), i9, str);
    ...
    private boolean launchSuggestion(int i9, int i10, String str) {
        Cursor cursor = this.mSuggestionsAdapter.getCursor();
        if (cursor == null || !cursor.moveToPosition(i9)) {
            return false;
        }
        launchIntent(createIntentFromSuggestion(cursor, i10, str));
        return true;
    }
    ...
    private void rewriteQueryFromSuggestion(int i9) {
    ...
    private void updateVoiceButton(boolean z10) {
        ...
        this.mVoiceButton.setVisibility(i9);
    }
    ...
    void launchQuerySearch(int i9, String str, String str2) {
        getContext().startActivity(createIntent("android.intent.action.SEARCH", null, null, str2, i9, str));
    }
    ...
    boolean onItemClicked(int i9, int i10, String str) {
        OnSuggestionListener onSuggestionListener = this.mOnSuggestionListener;
        if (onSuggestionListener == null || !onSuggestionListener.onSuggestionClick(i9)) {
            launchSuggestion(i9, 0, null);
            this.mSearchSrcTextView.setImeVisibility(false);
            dismissSuggestions();
            return true;
        }
    ...
    boolean onItemSelected(int i9) {
        OnSuggestionListener onSuggestionListener = this.mOnSuggestionListener;
        if (onSuggestionListener == null || !onSuggestionListener.onSuggestionSelect(i9)) {
            rewriteQueryFromSuggestion(i9);
            return true;
        }
        return false;
    }
    ...
    public void onMeasure(int i9, int i10) {
        ...
        } else if (mode == 1073741824 && (i11 = this.mMaxWidth) > 0) {
    ...
    boolean onSuggestionsKey(View view, int i9, KeyEvent keyEvent) {
        if (this.mSearchable != null && this.mSuggestionsAdapter != null && keyEvent.getAction() == 0 && keyEvent.hasNoModifiers()) {
            if (i9 == 66 || i9 == 84 || i9 == 61) {
                return onItemClicked(this.mSearchSrcTextView.getListSelection(), 0, null);
            }
            if (i9 == 21 || i9 == 22) {
                this.mSearchSrcTextView.setSelection(i9 == 21 ? 0 : this.mSearchSrcTextView.length());
    ...
    public boolean requestFocus(int i9, Rect rect) {
        if (!this.mClearingFocus && isFocusable()) {
            if (!isIconified()) {
                boolean requestFocus = this.mSearchSrcTextView.requestFocus(i9, rect);
                if (requestFocus) {
                    updateViewsVisibility(false);
                }
                return requestFocus;
    ...
    public void setImeOptions(int i9) {
        this.mSearchSrcTextView.setImeOptions(i9);
    }

    public void setInputType(int i9) {
        this.mSearchSrcTextView.setInputType(i9);
    }
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i9) {
        ...
        int i10 = R.styleable.SearchView_searchIcon;
        ...
        imageView5.setImageDrawable(obtainStyledAttributes.getDrawable(i10));
