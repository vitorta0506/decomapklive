...
public class Toolbar extends ViewGroup implements MenuHost {
            ...
            if (this.mCurrentExpandedItem != null) {
                ...
                if (menuBuilder != null) {
                    ...
                    while (true) {
                        if (i9 >= size) {
                            break;
                        } else if (this.mMenu.getItem(i9) == this.mCurrentExpandedItem) {
                            z11 = true;
                            break;
                        } else {
                            i9++;
    ...
    private void measureChildConstrained(View view, int i9, int i10, int i11, int i12, int i13) {
        ...
        if (mode != 1073741824 && i13 >= 0) {
            ...
            childMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(i13, BasicMeasure.EXACTLY);
        }
    ...
    */
    ...
    protected void onMeasure(int i9, int i10) {
        ...
        iArr[isLayoutRtl ? 1 : 0] = Math.max(0, currentContentInsetStart - i11);
        ...
        if (shouldLayout(this.mTitleTextView)) {
            measureChildCollapseMargins(this.mTitleTextView, i9, max2 + i21, i10, i20, iArr);
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            i16 = Math.max(i16, measureChildCollapseMargins(this.mSubtitleTextView, i9, max2 + i21, i10, i17 + i20, iArr));
        ...
        setMeasuredDimension(View.resolveSizeAndState(Math.max(max2 + i16 + getPaddingLeft() + getPaddingRight(), getSuggestedMinimumWidth()), i9, (-16777216) & i15), shouldCollapse() ? 0 : View.resolveSizeAndState(Math.max(max3 + getPaddingTop() + getPaddingBottom(), getSuggestedMinimumHeight()), i10, i15 << 16));
    }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (i9 != 0 && this.mExpandedMenuPresenter != null && peekMenu != null && (findItem = peekMenu.findItem(i9)) != null) {
    ...
    public void setCollapseIcon(@DrawableRes int i9) {
        setCollapseIcon(AppCompatResources.getDrawable(getContext(), i9));
    }
    ...
    public void setLogo(@DrawableRes int i9) {
        setLogo(AppCompatResources.getDrawable(getContext(), i9));
    }
    ...
    public void setNavigationIcon(@DrawableRes int i9) {
        setNavigationIcon(AppCompatResources.getDrawable(getContext(), i9));
    }
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i9) {
        ...
        dimensionPixelOffset = obtainStyledAttributes.hasValue(i10) ? obtainStyledAttributes.getDimensionPixelOffset(i10, dimensionPixelOffset) : dimensionPixelOffset;
        ...
        if (obtainStyledAttributes.hasValue(i11)) {
            setTitleTextColor(obtainStyledAttributes.getColorStateList(i11));
        }
        int i12 = R.styleable.Toolbar_subtitleTextColor;
        if (obtainStyledAttributes.hasValue(i12)) {
            setSubtitleTextColor(obtainStyledAttributes.getColorStateList(i12));
        }
