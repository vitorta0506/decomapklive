...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public Object getItem(int i9) {
            ...
            return this.mDataModel.getActivity(i9);
        }
        ...
        public int getItemViewType(int i9) {
            return (this.mShowFooterView && i9 == getCount() - 1) ? 1 : 0;
        }
        ...
        public View getView(int i9, View view, ViewGroup viewGroup) {
            ...
            if (this.mShowDefaultActivity && i9 == 0 && this.mHighlightDefaultActivity) {
        ...
        public void setMaxActivityCount(int i9) {
            if (this.mMaxActivityCount != i9) {
                this.mMaxActivityCount = i9;
                notifyDataSetChanged();
            }
        }
    ...
    public class Callbacks implements AdapterView.OnItemClickListener, View.OnClickListener, View.OnLongClickListener, PopupWindow.OnDismissListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i9, long j10) {
            ...
            if (activityChooserView.mIsSelectingDefaultActivity) {
                if (i9 > 0) {
                    activityChooserView.mAdapter.getDataModel().setDefaultActivity(i9);
                    return;
                }
                return;
            }
            ...
            Intent chooseActivity = ActivityChooserView.this.mAdapter.getDataModel().chooseActivity(i9);
            if (chooseActivity != null) {
                chooseActivity.addFlags(524288);
                ActivityChooserView.this.getContext().startActivity(chooseActivity);
            }
    ...
    protected void onLayout(boolean z10, int i9, int i10, int i11, int i12) {
        this.mActivityChooserContent.layout(0, 0, i11 - i9, i12 - i10);
        if (isShowingPopup()) {
            return;
        }
        dismissPopup();
    ...
    public void setDefaultActionButtonContentDescription(int i9) {
        this.mDefaultActionButtonContentDescription = i9;
    }

    public void setExpandActivityOverflowButtonContentDescription(int i9) {
        this.mExpandActivityOverflowButtonImage.setContentDescription(getContext().getString(i9));
    }
    ...
    void showPopupUnchecked(int i9) {
        if (this.mAdapter.getDataModel() != null) {
            getViewTreeObserver().addOnGlobalLayoutListener(this.mOnGlobalLayoutListener);
            ?? r02 = this.mDefaultActivityButton.getVisibility() == 0 ? 1 : 0;
            int activityCount = this.mAdapter.getActivityCount();
            if (i9 != Integer.MAX_VALUE && activityCount > i9 + r02) {
                this.mAdapter.setShowFooterView(true);
                this.mAdapter.setMaxActivityCount(i9 - 1);
            } else {
                this.mAdapter.setShowFooterView(false);
                this.mAdapter.setMaxActivityCount(i9);
            }
    ...
    public ActivityChooserView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i9) {
        ...
        int i10 = R.id.image;
        this.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(i10);
