...
public class ShareActionProvider extends ActionProvider {
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        for (int i9 = 0; i9 < min; i9++) {
            ResolveInfo activity = activityChooserModel.getActivity(i9);
            subMenu.add(0, i9, i9, activity.loadLabel(packageManager)).setIcon(activity.loadIcon(packageManager)).setOnMenuItemClickListener(this.mOnMenuItemClickListener);
        }
        if (min < activityCount) {
            ...
            for (int i10 = 0; i10 < activityCount; i10++) {
                ResolveInfo activity2 = activityChooserModel.getActivity(i10);
                addSubMenu.add(0, i10, i10, activity2.loadLabel(packageManager)).setIcon(activity2.loadIcon(packageManager)).setOnMenuItemClickListener(this.mOnMenuItemClickListener);
            }
        }
    }
