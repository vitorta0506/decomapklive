...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<LinearLayoutCompat> {
        ...
        public void mapProperties(@NonNull PropertyMapper propertyMapper) {
            ...
            this.mOrientationId = propertyMapper.mapIntEnum(AdUnitActivity.EXTRA_ORIENTATION, 16842948, new IntFunction<String>() { // from class: androidx.appcompat.widget.LinearLayoutCompat.InspectionCompanion.1
    ...
    void drawHorizontalDivider(Canvas canvas, int i9) {
    ...
    void drawVerticalDivider(Canvas canvas, int i9) {
    ...
    int getChildrenSkipCount(View view, int i9) {
        return 0;
    }
    ...
    */
    ...
    void measureChildBeforeLayout(View view, int i9, int i10, int i11, int i12, int i13) {
    ...
    */
    ...
    public void setGravity(@GravityInt int i9) {
        if (this.mGravity != i9) {
            if ((8388615 & i9) == 0) {
    ...
    public LinearLayoutCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i9) {
