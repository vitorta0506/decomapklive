    ...
    public class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(i9)) {
                this.itemCheckable = obtainStyledAttributes.getBoolean(i9, false) ? 1 : 0;
            } else {
            ...
            if (obtainStyledAttributes.hasValue(i10)) {
                this.itemIconTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(i10, -1), this.itemIconTintMode);
            } else {
                this.itemIconTintMode = null;
            }
            int i11 = R.styleable.MenuItem_iconTint;
            if (obtainStyledAttributes.hasValue(i11)) {
                this.itemIconTintList = obtainStyledAttributes.getColorStateList(i11);
            } else {
