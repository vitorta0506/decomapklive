...
public class ContextThemeWrapper extends ContextWrapper {
    ...
    protected void onApplyThemeResource(Resources.Theme theme, int i9, boolean z10) {
        theme.applyStyle(i9, true);
    }

    @Override // android.content.ContextWrapper, android.content.Context
    public void setTheme(int i9) {
        if (this.mThemeResource != i9) {
            this.mThemeResource = i9;
            initializeTheme();
        }
    }

    public ContextThemeWrapper(Context context, @StyleRes int i9) {
        super(context);
        this.mThemeResource = i9;
    }
