...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public MenuItemImpl(MenuBuilder menuBuilder, int i9, int i10, int i11, int i12, CharSequence charSequence, int i13) {
    ...
    private static void appendModifier(StringBuilder sb2, int i9, int i10, String str) {
        if ((i9 & i10) == i10) {
            sb2.append(str);
        }
    }
    ...
    public String getShortcutLabel() {
        ...
        int i9 = this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
        appendModifier(sb2, i9, 65536, resources.getString(R.string.abc_menu_meta_shortcut_label));
        appendModifier(sb2, i9, 4096, resources.getString(R.string.abc_menu_ctrl_shortcut_label));
        appendModifier(sb2, i9, 2, resources.getString(R.string.abc_menu_alt_shortcut_label));
        appendModifier(sb2, i9, 1, resources.getString(R.string.abc_menu_shift_shortcut_label));
        appendModifier(sb2, i9, 4, resources.getString(R.string.abc_menu_sym_shortcut_label));
        appendModifier(sb2, i9, 8, resources.getString(R.string.abc_menu_function_shortcut_label));
        if (shortcut == '\b') {
    ...
    public MenuItem setAlphabeticShortcut(char c10, int i9) {
        if (this.mShortcutAlphabeticChar == c10 && this.mShortcutAlphabeticModifiers == i9) {
            return this;
        }
        this.mShortcutAlphabeticChar = Character.toLowerCase(c10);
    ...
    public MenuItem setNumericShortcut(char c10, int i9) {
        if (this.mShortcutNumericChar == c10 && this.mShortcutNumericModifiers == i9) {
            return this;
        }
        this.mShortcutNumericChar = c10;
    ...
    public MenuItem setTitle(int i9) {
        return setTitle(this.mMenu.getContext().getString(i9));
    }
