...
public class MenuItemWrapperICS extends BaseMenuWrapper implements MenuItem {
    ...
    public void setShowAsAction(int i9) {
        this.mWrappedObject.setShowAsAction(i9);
    }

    @Override // android.view.MenuItem
    public MenuItem setShowAsActionFlags(int i9) {
        this.mWrappedObject.setShowAsActionFlags(i9);
        return this;
    }
    ...
    public MenuItem setAlphabeticShortcut(char c10, int i9) {
        this.mWrappedObject.setAlphabeticShortcut(c10, i9);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setIcon(int i9) {
        this.mWrappedObject.setIcon(i9);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setNumericShortcut(char c10, int i9) {
        this.mWrappedObject.setNumericShortcut(c10, i9);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setShortcut(char c10, char c11, int i9, int i10) {
        this.mWrappedObject.setShortcut(c10, c11, i9, i10);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setTitle(int i9) {
        this.mWrappedObject.setTitle(i9);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setActionView(int i9) {
        this.mWrappedObject.setActionView(i9);
        View actionView = this.mWrappedObject.getActionView();
