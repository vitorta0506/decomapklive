...
public class MenuBuilder implements SupportMenu {
    ...
    private MenuItemImpl createNewMenuItem(int i9, int i10, int i11, int i12, CharSequence charSequence, int i13) {
        return new MenuItemImpl(this, i9, i10, i11, i12, charSequence, i13);
    }
    ...
    private static int findInsertIndex(ArrayList<MenuItemImpl> arrayList, int i9) {
    ...
    private void removeItemAtInt(int i9, boolean z10) {
    ...
    private void setShortcutsVisibleInner(boolean z10) {
        boolean z11 = true;
        this.mShortcutsVisible = (z10 && this.mResources.getConfiguration().keyboard != 1 && ViewConfigurationCompat.shouldShowMenuShortcutsWhenKeyboardPresent(ViewConfiguration.get(this.mContext), this.mContext)) ? false : false;
    }
    ...
    public MenuItem addInternal(int i9, int i10, int i11, CharSequence charSequence) {
        ...
        MenuItemImpl createNewMenuItem = createNewMenuItem(i9, i10, i11, ordering, charSequence, this.mDefaultShowAsAction);
    ...
    public MenuItem findItem(int i9) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (menuItemImpl.getItemId() == i9) {
                return menuItemImpl;
            }
            if (menuItemImpl.hasSubMenu() && (findItem = menuItemImpl.getSubMenu().findItem(i9)) != null) {
                return findItem;
            }
        }
        return null;
    ...
    MenuItemImpl findItemWithShortcutForKey(int i9, KeyEvent keyEvent) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if ((numericShortcut == cArr[0] && (metaState & 2) == 0) || ((numericShortcut == cArr[2] && (metaState & 2) != 0) || (isQwertyMode && numericShortcut == '\b' && i9 == 67))) {
                return menuItemImpl;
            }
        }
        return null;
    ...
    void findItemsWithShortcutForKey(List<MenuItemImpl> list, int i9, KeyEvent keyEvent) {
        boolean isQwertyMode = isQwertyMode();
        ...
        if (keyEvent.getKeyData(keyData) || i9 == 67) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                if (menuItemImpl.hasSubMenu()) {
                    ((MenuBuilder) menuItemImpl.getSubMenu()).findItemsWithShortcutForKey(list, i9, keyEvent);
                }
                ...
                if (((modifiers & SupportMenu.SUPPORTED_MODIFIERS_MASK) == ((isQwertyMode ? menuItemImpl.getAlphabeticModifiers() : menuItemImpl.getNumericModifiers()) & SupportMenu.SUPPORTED_MODIFIERS_MASK)) && alphabeticShortcut != 0) {
                    char[] cArr = keyData.meta;
                    if ((alphabeticShortcut == cArr[0] || alphabeticShortcut == cArr[2] || (isQwertyMode && alphabeticShortcut == '\b' && i9 == 67)) && menuItemImpl.isEnabled()) {
    ...
    public boolean performShortcut(int i9, KeyEvent keyEvent, int i10) {
        MenuItemImpl findItemWithShortcutForKey = findItemWithShortcutForKey(i9, keyEvent);
    ...
    public void removeGroup(int i9) {
        ...
        if (findGroupIndex >= 0) {
            ...
            while (true) {
                int i11 = i10 + 1;
                if (i10 >= size || this.mItems.get(findGroupIndex).getGroupId() != i9) {
                    break;
                }
    ...
    public MenuBuilder setDefaultShowAsAction(int i9) {
    ...
    public void setGroupVisible(int i9, boolean z10) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            MenuItemImpl menuItemImpl = this.mItems.get(i10);
            if (menuItemImpl.getGroupId() == i9 && menuItemImpl.setVisibleInt(z10)) {
                z11 = true;
            }
        }
        if (z11) {
    ...
    public boolean performItemAction(MenuItem menuItem, MenuPresenter menuPresenter, int i9) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public MenuBuilder setHeaderIconInt(int i9) {
        setHeaderInternal(0, null, i9, null, null);
        return this;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public MenuBuilder setHeaderTitleInt(int i9) {
    ...
    public SubMenu addSubMenu(int i9, int i10, int i11, CharSequence charSequence) {
        MenuItemImpl menuItemImpl = (MenuItemImpl) addInternal(i9, i10, i11, charSequence);
