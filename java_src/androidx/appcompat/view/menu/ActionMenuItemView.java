...
public class ActionMenuItemView extends AppCompatTextView implements MenuView.ItemView, View.OnClickListener, ActionMenuView.ActionMenuChildView {
    ...
    public void onMeasure(int i9, int i10) {
        ...
        if (mode == Integer.MIN_VALUE) {
            i11 = Math.min(size, this.mMinWidth);
        } else {
            i11 = this.mMinWidth;
        }
        if (mode != 1073741824 && this.mMinWidth > 0 && measuredWidth < i11) {
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int i9) {
        ...
        this.mAllowTextWithIcon = shouldAllowTextWithIcon();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.ActionMenuItemView, i9, 0);
