...
public class d2 extends i.b {
    ...
    public d2(fk.e eVar, fk.f fVar, fk.f fVar2) {
        super(eVar, fVar, fVar2);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public d2(fk.e eVar, fk.f fVar, fk.f fVar2, fk.f[] fVarArr) {
    ...
    public fk.i E() {
        ...
        return new d2(i9, o11, o12.a(a10).a(o10).j(o12).a(fVar3).a(o11).a(j10), new fk.f[]{j10});
    }
    ...
    public fk.i F(fk.i iVar) {
        ...
        if (o14.i()) {
            ...
            return new d2(i9, l10, i9.m());
        } else {
            fk.f j11 = l10.o().j(j10);
            fk.f j12 = l10.j(o14).j(o13);
            return new d2(i9, j11, l10.a(o14).o().l(a10, b10, j12), new fk.f[]{j12});
        }
    }
    ...
    public fk.i a(fk.i iVar) {
        ...
        return new d2(i9, fVar4, fVar6, new fk.f[]{fVar5});
    }
    ...
    public fk.i x() {
        ...
        fk.f fVar2 = this.f39807c;
        fk.f fVar3 = this.f39808d[0];
        return new d2(this.f39805a, fVar, fVar2.a(fVar3), new fk.f[]{fVar3});
    }
}
