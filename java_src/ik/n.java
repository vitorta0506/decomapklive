...
public class n extends i.c {
    ...
    public n(fk.e eVar, fk.f fVar, fk.f fVar2) {
        super(eVar, fVar, fVar2);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public n(fk.e eVar, fk.f fVar, fk.f fVar2, fk.f[] fVarArr) {
    ...
    public fk.i E() {
        ...
        int[] d11 = nk.e.d();
        int[] d12 = nk.e.d();
        l.m(mVar.f41546g, d12);
        int[] d13 = nk.e.d();
        l.m(d12, d13);
        boolean h10 = mVar3.h();
        int[] iArr = mVar3.f41546g;
        if (!h10) {
            l.m(iArr, d11);
            iArr = d11;
        }
        l.o(mVar2.f41546g, iArr, d10);
        l.a(mVar2.f41546g, iArr, d11);
        l.f(d11, d10, d11);
        l.l(nk.e.b(d11, d11, d11), d11);
        l.f(d12, mVar2.f41546g, d12);
        l.l(nk.n.L(5, d12, 2, 0), d12);
        l.l(nk.n.M(5, d13, 3, 0, d10), d10);
        m mVar4 = new m(d13);
        l.m(d11, mVar4.f41546g);
        int[] iArr2 = mVar4.f41546g;
        l.o(iArr2, d12, iArr2);
        int[] iArr3 = mVar4.f41546g;
        l.o(iArr3, d12, iArr3);
        m mVar5 = new m(d12);
        l.o(d12, mVar4.f41546g, mVar5.f41546g);
        int[] iArr4 = mVar5.f41546g;
        l.f(iArr4, d11, iArr4);
        int[] iArr5 = mVar5.f41546g;
        l.o(iArr5, d10, iArr5);
        m mVar6 = new m(d11);
        l.p(mVar.f41546g, mVar6.f41546g);
        if (!h10) {
            int[] iArr6 = mVar6.f41546g;
            l.f(iArr6, mVar3.f41546g, iArr6);
        }
        return new n(i9, mVar4, mVar5, new fk.f[]{mVar6});
    }
    ...
    public fk.i a(fk.i iVar) {
        ...
        return new n(i9, mVar7, mVar8, new fk.f[]{mVar9});
    }
    ...
    @Override // fk.i
    public fk.i x() {
        return t() ? this : new n(this.f39805a, this.f39806b, this.f39807c.m(), this.f39808d);
    }
}
