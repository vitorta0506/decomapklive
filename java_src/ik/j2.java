...
public class j2 extends i.b {
    ...
    public j2(fk.e eVar, fk.f fVar, fk.f fVar2) {
        super(eVar, fVar, fVar2);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public j2(fk.e eVar, fk.f fVar, fk.f fVar2, fk.f[] fVarArr) {
    ...
    public fk.i E() {
        ...
        fk.f a10 = fVar2.o().a(j10).a(o10);
        if (a10.i()) {
            return new j2(i9, a10, i9.m().n());
        }
        fk.f o11 = a10.o();
        ...
        return new j2(i9, o11, fVar.p(a10, j10).a(o11).a(j11), new fk.f[]{j11});
    }
    ...
    public fk.i F(fk.i iVar) {
        ...
        if (o14.i()) {
            ...
            return new j2(i9, l10, i9.m().n());
        } else {
            fk.f j11 = l10.o().j(j10);
            fk.f j12 = l10.j(o14).j(o13);
            return new j2(i9, j11, l10.a(o14).o().l(a10, o10.b(), j12), new fk.f[]{j12});
        }
    }
    ...
    public fk.i a(fk.i iVar) {
        ...
        return new j2(i9, fVar4, fVar6, new fk.f[]{fVar5});
    }
    ...
    public fk.i x() {
        ...
        fk.f fVar2 = this.f39807c;
        fk.f fVar3 = this.f39808d[0];
        return new j2(this.f39805a, fVar, fVar2.a(fVar3), new fk.f[]{fVar3});
    }
}
