...
public class d1 extends i.b {
    ...
    public d1(fk.e eVar, fk.f fVar, fk.f fVar2) {
        super(eVar, fVar, fVar2);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public d1(fk.e eVar, fk.f fVar, fk.f fVar2, fk.f[] fVarArr) {
    ...
    public fk.i E() {
        ...
        fk.f a10 = fVar2.o().a(j10).a(l10);
        if (a10.i()) {
            return new d1(i9, a10, i9.m().n());
        }
        fk.f o11 = a10.o();
        fk.f j11 = h10 ? a10 : a10.j(o10);
        if (!h10) {
            fVar = fVar.j(fVar3);
        }
        return new d1(i9, o11, fVar.p(a10, j10).a(o11).a(j11), new fk.f[]{j11});
    }
    ...
    public fk.i F(fk.i iVar) {
        ...
        fk.f o12 = fVar2.o();
        fk.f o13 = fVar3.o();
        fk.f a10 = i9.l().j(o13).a(o12).a(fVar2.j(fVar3));
        fk.f b10 = o10.b();
        fk.f l10 = i9.l().a(b10).j(o13).a(o12).l(a10, o11, o13);
        fk.f j10 = n9.j(o13);
        fk.f o14 = j10.a(a10).o();
        if (o14.i()) {
            return l10.i() ? iVar.E() : i9.r();
        } else if (l10.i()) {
            return new d1(i9, l10, i9.m().n());
        } else {
            fk.f j11 = l10.o().j(j10);
            fk.f j12 = l10.j(o14).j(o13);
            return new d1(i9, j11, l10.a(o14).o().l(a10, b10, j12), new fk.f[]{j12});
        }
    }
    ...
    public fk.i a(fk.i iVar) {
        ...
        if (n9.i()) {
            ...
            fVar4 = d10.o().a(d10).a(p10).a(i9.l());
            if (fVar4.i()) {
                return new d1(i9, fVar4, i9.m().n());
            }
        ...
        return new d1(i9, fVar4, fVar6, new fk.f[]{fVar5});
    }
    ...
    public fk.i x() {
        ...
        fk.f fVar2 = this.f39807c;
        fk.f fVar3 = this.f39808d[0];
        return new d1(this.f39805a, fVar, fVar2.a(fVar3), new fk.f[]{fVar3});
    }
}
