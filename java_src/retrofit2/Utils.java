...
final class Utils {
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        public String toString() {
            ...
            for (int i9 = 1; i9 < this.typeArguments.length; i9++) {
                sb2.append(", ");
                sb2.append(Utils.typeToString(this.typeArguments[i9]));
            }
            sb2.append(">");
            return sb2.toString();
        }
    ...
    static Type getGenericSupertype(Type type, Class<?> cls, Class<?> cls2) {
        ...
        if (cls2.isInterface()) {
            ...
            for (int i9 = 0; i9 < length; i9++) {
                if (interfaces[i9] == cls2) {
                    return cls.getGenericInterfaces()[i9];
                }
                if (cls2.isAssignableFrom(interfaces[i9])) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Type getParameterLowerBound(int i9, ParameterizedType parameterizedType) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static RuntimeException parameterError(Method method, Throwable th2, int i9, String str, Object... objArr) {
        return methodError(method, th2, str + " (parameter #" + (i9 + 1) + ")", objArr);
    }
