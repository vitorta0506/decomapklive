...
public class Util {
    ...
    public static int getHmsVersion(Context context) {
        ...
        try {
            ...
            HMSLog.e(TAG, "In getHmsVersion, Failed to read meta data for the HMS VERSION.", e10);
            return 0;
        }
    }
    ...
    public static String getProcessName(Context context, int i9) {
        return UIUtil.getProcessName(context, i9);
    }
            ...
            if (!availableInit) {
                ...
                if (packageManager == null) {
                    ...
                    try {
                        ...
                        HMSLog.e(TAG, "In isAvailableLibExist, Failed to read meta data for the availableLoaded.", e10);
                    }
                    isAvailableAvailable = z10;
                    availableInit = true;
                }
                z10 = true;
                isAvailableAvailable = z10;
    ...
    public static void unBindServiceCatchException(Context context, ServiceConnection serviceConnection) {
        try {
            ...
            HMSLog.e(TAG, "On unBindServiceException:" + e10.getMessage());
        }
    }
}
