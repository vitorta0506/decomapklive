...
public class j {
    ...
    public static final String[] f27727a = {"url", PushConstants.EXTRA_APPLICATION_PENDING_INTENT, "cosa", "rp"};
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x00ba, code lost:
        if (com.huawei.hms.push.q.a(r6.f27728b, r6.f27729c.d(), r2).booleanValue() != false) goto L14;
     */
    ...
    */
    public final void b() {
        /*
            ...
            com.huawei.hms.push.k r2 = r6.f27729c     // Catch: java.lang.Exception -> Le1
            ...
            android.content.Context r1 = r6.f27728b     // Catch: java.lang.Exception -> Le1
            com.huawei.hms.push.k r2 = r6.f27729c     // Catch: java.lang.Exception -> Le1
            java.lang.String r2 = r2.d()     // Catch: java.lang.Exception -> Le1
            ...
            r3 = 0
            if (r2 == 0) goto L97
            com.huawei.hms.push.k r2 = r6.f27729c     // Catch: java.lang.Exception -> L7d
            ...
            android.content.Context r4 = r6.f27728b     // Catch: java.lang.Exception -> L7d
            com.huawei.hms.push.k r5 = r6.f27729c     // Catch: java.lang.Exception -> L7d
        ...
        L97:
            ...
            com.huawei.hms.push.k r4 = r6.f27729c     // Catch: java.lang.Exception -> Le1
            java.lang.String r4 = r4.a()     // Catch: java.lang.Exception -> Le1
            r2.<init>(r4)     // Catch: java.lang.Exception -> Le1
            android.content.Context r4 = r6.f27728b     // Catch: java.lang.Exception -> Le1
            com.huawei.hms.push.k r5 = r6.f27729c     // Catch: java.lang.Exception -> Le1
        ...
        Ldb:
            android.content.Context r2 = r6.f27728b     // Catch: java.lang.Exception -> Le1
    ...
    public void c() {
        ...
        if (this.f27728b != null && (kVar = this.f27729c) != null) {
            if (PushConstants.EXTRA_APPLICATION_PENDING_INTENT.equals(kVar.i())) {
                a();
                return;
            } else if ("cosa".equals(this.f27729c.i())) {
                b();
                return;
            } else if ("rp".equals(this.f27729c.i())) {
                HMSLog.w("PushSelfShowLog", this.f27729c.i() + " not support rich message.");
                return;
            } else if ("url".equals(this.f27729c.i())) {
                HMSLog.w("PushSelfShowLog", this.f27729c.i() + " not support URL.");
                return;
            } else {
                HMSLog.d("PushSelfShowLog", this.f27729c.i() + " is not exist in hShowType");
                return;
            }
        }
    ...
    public final void a() {
        try {
            ...
            sb2.append(this.f27729c.d());
            HMSLog.i("PushSelfShowLog", sb2.toString());
            if (q.c(this.f27728b, this.f27729c.d())) {
                b();
            }
        } catch (Exception e10) {
