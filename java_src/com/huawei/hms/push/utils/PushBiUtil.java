...
public final class PushBiUtil {
    ...
    public static void reportExit(Context context, String str, String str2, int i9) {
        HiAnalyticsClient.reportExit(context, str, str2, Status.SUCCESS.getStatusCode(), i9, 60500300);
    }
}
