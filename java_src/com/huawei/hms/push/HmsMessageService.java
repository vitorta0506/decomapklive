...
public class HmsMessageService extends Service {
    ...
    public final Messenger f27675a = new Messenger(new t(new a()));
    ...
    public final void b(String str, String str2, int i9) {
        ...
        a(PushNaming.UPSEND_MSG_ASYNC_RSP, str, i9);
        onSendError(str2, new SendException(i9));
    }

    public final synchronized void a(Intent intent, Bundle bundle, String str, int i9) {
        Context applicationContext = getApplicationContext();
        ...
        if (bundle.isEmpty() && z10) {
            ...
            onTokenError(new BaseException(i9));
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            if (subjectIds != null && subjectIds.length != 0) {
                for (int i10 = 0; i10 < subjectIds.length; i10++) {
                    ...
                    HMSLog.i("HmsMessageService", "onTokenError to sub app, subjectId:" + subjectIds[i10]);
                    onTokenError(new BaseException(i9), bundle2);
                }
                BaseUtils.clearSubjectIds(applicationContext);
            }
            HMSLog.i("HmsMessageService", "onTokenError to host app with bundle.");
            onTokenError(new BaseException(i9), bundle);
            return;
        }
    ...
    public final synchronized void a(Intent intent, Bundle bundle, String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            String[] subjectIds = BaseUtils.getSubjectIds(applicationContext);
            if (subjectIds != null && subjectIds.length != 0) {
                for (int i9 = 0; i9 < subjectIds.length; i9++) {
                    Bundle bundle2 = new Bundle();
                    bundle2.putString(SUBJECT_ID, subjectIds[i9]);
                    HMSLog.i("HmsMessageService", "onNewToken to sub app, subjectId:" + subjectIds[i9]);
                    onNewToken(stringExtra, bundle2);
                    a(stringExtra, subjectIds[i9]);
                }
                BaseUtils.clearSubjectIds(applicationContext);
            }
    ...
    public final void a(String str, String str2, int i9) {
        ...
        PushBiUtil.reportExit(getApplicationContext(), str, str2, i9);
    }
}
