...
public abstract class a {
    ...
    protected com.huawei.hms.framework.network.grs.local.model.a f27332a;

    /* renamed from: b  reason: collision with root package name */
    protected List<com.huawei.hms.framework.network.grs.local.model.b> f27333b;

    /* renamed from: c  reason: collision with root package name */
    protected Map<String, String> f27334c = new ConcurrentHashMap(16);

    /* renamed from: d  reason: collision with root package name */
    protected boolean f27335d = false;

    /* renamed from: e  reason: collision with root package name */
    protected boolean f27336e = false;

    /* renamed from: f  reason: collision with root package name */
    protected boolean f27337f = false;

    /* renamed from: g  reason: collision with root package name */
    protected Set<String> f27338g = new HashSet(16);
    ...
    private int g(String str) {
        ...
        return (!this.f27336e || !((list = this.f27333b) == null || list.isEmpty()) || (c10 = c(str)) == 0) ? d(str) : c10;
    }
    ...
    public int a(String str, Context context) {
        ...
        sb2.append(GrsApp.getInstance().getBrand(FileUtils.RES_PREFIX_STORAGE));
        sb2.append(str);
    ...
    */
    ...
    public Map<String, String> a(Context context, com.huawei.hms.framework.network.grs.e.a aVar, GrsBaseInfo grsBaseInfo, String str, boolean z10) {
        com.huawei.hms.framework.network.grs.local.model.a aVar2 = this.f27332a;
        if (aVar2 == null) {
        ...
        com.huawei.hms.framework.network.grs.local.model.d a12 = a10.a(((a11 == null || a11.size() == 0) ? this.f27334c : a(a11, grsBaseInfo, b10)).get(b10));
        if (a12 == null) {
            return null;
        }
        return a12.a();
    ...
    public void a() {
        com.huawei.hms.framework.network.grs.local.model.a aVar = this.f27332a;
        if (aVar != null) {
            aVar.a();
            this.f27337f = true;
        }
    ...
    public void a(Context context, List<String> list) {
        ...
        for (String str : list) {
            if (Pattern.matches("^grs_sdk_global_route_config_[a-zA-Z]+\\.json$", str)) {
                if (g(com.huawei.hms.framework.network.grs.h.c.a(GrsApp.getInstance().getBrand(FileUtils.RES_PREFIX_STORAGE) + str, context)) == 0) {
    ...
    public void a(GrsBaseInfo grsBaseInfo) {
        this.f27334c.put("no_route_country", "no-country");
        List<com.huawei.hms.framework.network.grs.local.model.b> list = this.f27333b;
        if (list == null || list.isEmpty()) {
            return;
        }
        for (com.huawei.hms.framework.network.grs.local.model.b bVar : this.f27333b) {
            if (bVar.a().contains(grsBaseInfo.getIssueCountry())) {
                this.f27334c.put(grsBaseInfo.getIssueCountry(), bVar.b());
            }
            if (bVar.a().contains(grsBaseInfo.getRegCountry())) {
                this.f27334c.put(grsBaseInfo.getRegCountry(), bVar.b());
            }
            if (bVar.a().contains(grsBaseInfo.getSerCountry())) {
                this.f27334c.put(grsBaseInfo.getSerCountry(), bVar.b());
            }
        }
        this.f27333b = null;
    }
    ...
    */
    public void b(org.json.JSONArray r15) {
        ...
        Lc:
            ...
            r3.b(r4)
            java.util.Set<java.lang.String> r5 = r14.f27338g
            boolean r5 = r5.contains(r4)
            if (r5 != 0) goto Lf2
            java.util.Set<java.lang.String> r5 = r14.f27338g
            r5.add(r4)
            boolean r5 = r14.f27336e
            if (r5 == 0) goto Lf2
        ...
        Ldf:
            r3.a(r5)
            com.huawei.hms.framework.network.grs.local.model.a r2 = r14.f27332a
            if (r2 != 0) goto Led
    ...
    public int c(String str) {
        ...
        try {
            ...
            this.f27333b.addAll(a(jSONArray));
            return 0;
