...
public class ForegroundBusDelegate implements IBridgeActivityDelegate {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void errorReturn(int i9, String str) {
        HMSLog.e(TAG, str);
        ...
        if (responseCallback != null) {
            BusResponseResult innerError = responseCallback.innerError(this.mThisWeakRef.get(), i9, str);
            if (innerError == null) {
    ...
    public void startApkHubActivity() {
        ...
        try {
            ...
            HMSLog.e(TAG, "Launch sign in Intent failed. hms is probably being updated：", e10);
            errorReturn(0, "launch bus intent failed");
        }
    }

    private void succeedReturn(int i9, Intent intent) {
    ...
    public boolean onBridgeActivityResult(int i9, int i10, Intent intent) {
        if (i9 == REQUEST_CODE_BUS) {
            ...
            BusResponseCallback responseCallback = getResponseCallback(this.innerHeader.getResponseCallbackKey());
            if (responseCallback == null) {
                succeedReturn(i10, intent);
                return true;
            }
            BusResponseResult succeedReturn = responseCallback.succeedReturn(this.mThisWeakRef.get(), i10, intent);
