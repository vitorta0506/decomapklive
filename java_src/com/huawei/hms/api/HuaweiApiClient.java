...
public abstract class HuaweiApiClient implements AidlApiClient {
    ...
    public static final class Builder {
        ...
        private final List<Scope> f27203b = new ArrayList();

        /* renamed from: c  reason: collision with root package name */
        private final List<PermissionInfo> f27204c = new ArrayList();

        /* renamed from: d  reason: collision with root package name */
        private final Map<Api<?>, Api.ApiOptions> f27205d = new HashMap();

        /* renamed from: e  reason: collision with root package name */
        private OnConnectionFailedListener f27206e;

        /* renamed from: f  reason: collision with root package name */
        private ConnectionCallbacks f27207f;

        /* renamed from: g  reason: collision with root package name */
        private int f27208g;

        /* renamed from: h  reason: collision with root package name */
        private Activity f27209h;
        ...
        public Builder addApi(Api<? extends Api.ApiOptions.NotRequiredOptions> api) {
            this.f27205d.put(api, null);
            if (HuaweiApiAvailability.HMS_API_NAME_GAME.equals(api.getApiName())) {
                HiAnalyticsUtil hiAnalyticsUtil = HiAnalyticsUtil.getInstance();
                Context applicationContext = this.f27202a.getApplicationContext();
        ...
        public Builder addApiWithScope(Api<? extends Api.ApiOptions.NotRequiredOptions> api, Scope... scopeArr) {
            ...
            this.f27205d.put(api, null);
            this.f27203b.addAll(new ArrayList(Arrays.asList(scopeArr)));
            return this;
        }

        public Builder addConnectionCallbacks(ConnectionCallbacks connectionCallbacks) {
            Checker.checkNonNull(connectionCallbacks, "listener must not be null.");
            this.f27207f = connectionCallbacks;
            return this;
        }

        public Builder addOnConnectionFailedListener(OnConnectionFailedListener onConnectionFailedListener) {
            Checker.checkNonNull(onConnectionFailedListener, "listener must not be null.");
            this.f27206e = onConnectionFailedListener;
            return this;
        }

        public Builder addScope(Scope scope) {
            Checker.checkNonNull(scope, "scope must not be null.");
            this.f27203b.add(scope);
            return this;
        }

        public Builder allowLifeCycleManagement(Activity activity, int i9, OnConnectionFailedListener onConnectionFailedListener) {
            if (i9 >= 0) {
                this.f27208g = i9;
                this.f27209h = (Activity) Preconditions.checkNotNull(activity, "activity must not be Null.");
                return this;
            }
        ...
        public HuaweiApiClient build() {
            ...
            HuaweiApiClientImpl huaweiApiClientImpl = new HuaweiApiClientImpl(this.f27202a);
            huaweiApiClientImpl.setScopes(this.f27203b);
            huaweiApiClientImpl.setPermissionInfos(this.f27204c);
            huaweiApiClientImpl.setApiMap(this.f27205d);
            huaweiApiClientImpl.setConnectionCallbacks(this.f27207f);
            huaweiApiClientImpl.setConnectionFailedListener(this.f27206e);
            huaweiApiClientImpl.setAutoLifecycleClientId(this.f27208g);
            if (this.f27208g >= 0) {
        ...
        public Builder setPopupsGravity(int i9) {
            return this;
        }
        ...
        private void a(HuaweiApiClient huaweiApiClient) {
            AutoLifecycleFragment.getInstance(this.f27209h).startAutoMange(this.f27208g, huaweiApiClient);
        }
        ...
        public <O extends Api.ApiOptions.HasOptions> Builder addApiWithScope(Api<O> api, O o10, Scope... scopeArr) {
            ...
            Checker.checkNonNull(scopeArr, "Scopes must not be null");
            this.f27205d.put(api, o10);
            if (api.getOptions() != null) {
                this.f27203b.addAll(api.getOptions().getScopeList(o10));
                this.f27204c.addAll(api.getOptions().getPermissionInfoList(o10));
            }
            this.f27203b.addAll(new ArrayList(Arrays.asList(scopeArr)));
            return this;
        }
