...
public abstract class HuaweiApiAvailability {
    ...
    public static void setServicesVersionCode(int i9) {
        SERVICES_VERSION_CODE = i9;
    }
    ...
    public abstract PendingIntent getErrPendingIntent(Context context, int i9, int i10);

    public abstract PendingIntent getErrPendingIntent(Context context, ConnectionResult connectionResult);

    public abstract Dialog getErrorDialog(Activity activity, int i9, int i10);

    public abstract Dialog getErrorDialog(Activity activity, int i9, int i10, DialogInterface.OnCancelListener onCancelListener);

    public abstract String getErrorString(int i9);

    public abstract f<Void> getHuaweiServicesReady(Activity activity);

    public abstract Intent getResolveErrorIntent(Activity activity, int i9);

    public abstract PendingIntent getResolveErrorPendingIntent(Activity activity, int i9);
    ...
    public abstract int isHuaweiMobileServicesAvailable(Context context, int i9);

    public abstract boolean isUserResolvableError(int i9);

    public abstract boolean isUserResolvableError(int i9, PendingIntent pendingIntent);

    public abstract void popupErrNotification(Context context, ConnectionResult connectionResult);

    public abstract void resolveError(Activity activity, int i9, int i10);

    public abstract void resolveError(Activity activity, int i9, int i10, PendingIntent pendingIntent);

    public abstract boolean showErrorDialogFragment(Activity activity, int i9, int i10);

    public abstract boolean showErrorDialogFragment(Activity activity, int i9, int i10, DialogInterface.OnCancelListener onCancelListener);

    public abstract boolean showErrorDialogFragment(Activity activity, int i9, Fragment fragment, int i10, DialogInterface.OnCancelListener onCancelListener);

    public abstract void showErrorNotification(Context context, int i9);
}
