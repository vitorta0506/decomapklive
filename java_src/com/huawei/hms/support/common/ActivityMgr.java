...
public final class ActivityMgr implements Application.ActivityLifecycleCallbacks {
    ...
    public WeakReference<Activity> f27817a;
    ...
    public Activity getCurrentActivity() {
        if (this.f27817a == null) {
            HMSLog.i("ActivityMgr", "mCurrentActivity is " + this.f27817a);
            return null;
        }
        HMSLog.i("ActivityMgr", "mCurrentActivity.get() is " + this.f27817a.get());
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        ...
        this.f27817a = new WeakReference<>(activity);
    }
