...
public abstract class a0 {
    ...
    public static HttpURLConnection a(String str, int i9, Map<String, String> map, String str2) {
        if (TextUtils.isEmpty(str)) {
        ...
        httpURLConnection.setRequestProperty("Content-Length", String.valueOf(i9));
    ...
    */
    public static void a(java.net.HttpURLConnection r3) {
        /*
            ...
            cc.b r1 = cc.b.b(r2)     // Catch: java.lang.IllegalAccessException -> L12 java.io.IOException -> L15 java.security.GeneralSecurityException -> L18 java.security.KeyStoreException -> L1b java.security.NoSuchAlgorithmException -> L1e
            goto L23
        L12:
