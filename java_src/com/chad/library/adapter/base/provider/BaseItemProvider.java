...
public abstract class BaseItemProvider<T> {
    ...
    public abstract void convert(@NotNull BaseViewHolder baseViewHolder, T t10);

    public void convert(@NotNull BaseViewHolder helper, T t10, @NotNull List<? extends Object> payloads) {
    ...
    public void onChildClick(@NotNull BaseViewHolder helper, @NotNull View view, T t10, int i9) {
        Intrinsics.checkNotNullParameter(helper, "helper");
        Intrinsics.checkNotNullParameter(view, "view");
    }

    public boolean onChildLongClick(@NotNull BaseViewHolder helper, @NotNull View view, T t10, int i9) {
        Intrinsics.checkNotNullParameter(helper, "helper");
        Intrinsics.checkNotNullParameter(view, "view");
        return false;
    }

    public void onClick(@NotNull BaseViewHolder helper, @NotNull View view, T t10, int i9) {
        Intrinsics.checkNotNullParameter(helper, "helper");
        Intrinsics.checkNotNullParameter(view, "view");
    }
    ...
    public boolean onLongClick(@NotNull BaseViewHolder helper, @NotNull View view, T t10, int i9) {
        Intrinsics.checkNotNullParameter(helper, "helper");
        Intrinsics.checkNotNullParameter(view, "view");
        return false;
    }
    ...
    public void onViewHolderCreated(@NotNull BaseViewHolder viewHolder, int i9) {
