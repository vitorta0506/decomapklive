...
public final class Postcard extends RouteMeta {
    ...
    public Postcard addFlags(int i9) {
    ...
    public Postcard setTimeout(int i9) {
        this.timeout = i9;
        return this;
    }
    ...
    public Postcard withFlags(int i9) {
        this.flags = i9;
        return this;
    }
    ...
    public Postcard withInt(@Nullable String str, int i9) {
        this.mBundle.putInt(str, i9);
        return this;
    }
    ...
    public Postcard withObject(@Nullable String str, @Nullable Object obj) {
        SerializationService serializationService = (SerializationService) a.c().g(SerializationService.class);
    ...
    public Postcard withTransition(int i9, int i10) {
        this.enterAnim = i9;
        this.exitAnim = i10;
        return this;
    }
    ...
    public Object navigation(Context context, NavigationCallback navigationCallback) {
        return a.c().f(context, this, -1, navigationCallback);
    }

    public void navigation(Activity activity, int i9) {
        navigation(activity, i9, null);
    }

    public void navigation(Activity activity, int i9, NavigationCallback navigationCallback) {
        a.c().f(activity, this, i9, navigationCallback);
    }
}
