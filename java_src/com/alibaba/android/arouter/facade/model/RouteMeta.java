...
public class RouteMeta {
    ...
    public static RouteMeta build(RouteType routeType, Class<?> cls, String str, String str2, int i9, int i10) {
        return new RouteMeta(routeType, null, cls, null, str, str2, null, i9, i10);
    }
    ...
    public RouteMeta setExtra(int i9) {
        this.extra = i9;
        return this;
    }
    ...
    public RouteMeta setPriority(int i9) {
        this.priority = i9;
        return this;
    }
    ...
    public static RouteMeta build(RouteType routeType, Class<?> cls, String str, String str2, Map<String, Integer> map, int i9, int i10) {
        return new RouteMeta(routeType, null, cls, null, str, str2, map, i9, i10);
    }
    ...
    public RouteMeta(RouteType routeType, Element element, Class<?> cls, String str, String str2, String str3, Map<String, Integer> map, int i9, int i10) {
        this.type = routeType;
        this.name = str;
        this.destination = cls;
        this.rawType = element;
