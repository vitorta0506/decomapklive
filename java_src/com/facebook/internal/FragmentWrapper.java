...
public final class FragmentWrapper {
    ...
    public final void startActivityForResult(@Nullable Intent intent, int i9) {
        androidx.fragment.app.Fragment fragment = this.supportFragment;
        if (fragment != null) {
            if (fragment == null) {
                return;
