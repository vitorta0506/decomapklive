...
public final class CallbackManagerImpl implements CallbackManager {
    ...
    public interface Callback {
        boolean onActivityResult(int i9, @Nullable Intent intent);
    }
    ...
    public static final class Companion {
        ...
        @JvmStatic
        private final synchronized Callback getStaticCallback(int i9) {
            return (Callback) CallbackManagerImpl.staticCallbacks.get(Integer.valueOf(i9));
        }

        /* JADX INFO: Access modifiers changed from: private */
        @JvmStatic
        public final boolean runStaticCallback(int i9, int i10, Intent intent) {
            Callback staticCallback = getStaticCallback(i9);
            if (staticCallback == null) {
                return false;
            }
            return staticCallback.onActivityResult(i10, intent);
        }

        @JvmStatic
        public final synchronized void registerStaticCallback(int i9, @NotNull Callback callback) {
            Intrinsics.checkNotNullParameter(callback, "callback");
            if (CallbackManagerImpl.staticCallbacks.containsKey(Integer.valueOf(i9))) {
                return;
            }
            CallbackManagerImpl.staticCallbacks.put(Integer.valueOf(i9), callback);
        }
    }
    ...
    @JvmStatic
    public static final synchronized void registerStaticCallback(int i9, @NotNull Callback callback) {
        synchronized (CallbackManagerImpl.class) {
            Companion.registerStaticCallback(i9, callback);
        }
    }

    @Override // com.facebook.CallbackManager
    public boolean onActivityResult(int i9, int i10, @Nullable Intent intent) {
        Callback callback = this.callbacks.get(Integer.valueOf(i9));
        if (callback == null) {
            return Companion.runStaticCallback(i9, i10, intent);
        }
        return callback.onActivityResult(i10, intent);
    }

    public final void registerCallback(int i9, @NotNull Callback callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        this.callbacks.put(Integer.valueOf(i9), callback);
    }

    public final void unregisterCallback(int i9) {
        this.callbacks.remove(Integer.valueOf(i9));
    }
}
