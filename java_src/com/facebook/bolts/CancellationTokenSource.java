...
public final class CancellationTokenSource implements Closeable {
    ...
    public static final void m114cancelAfter$lambda6$lambda5(CancellationTokenSource this$0) {
            ...
            if (i9 != 0) {
                this.scheduledCancellation = this.executor.schedule(new Runnable() { // from class: com.facebook.bolts.a
                    ...
                    public final void run() {
                        CancellationTokenSource.m114cancelAfter$lambda6$lambda5(CancellationTokenSource.this);
                    }
                }, j10, timeUnit);
            }
            Unit unit = Unit.INSTANCE;
