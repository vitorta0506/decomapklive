...
public final class LoginStatusClient extends PlatformServiceClient {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final LoginStatusClient newInstance$facebook_common_release(@NotNull Context context, @NotNull String applicationId, @NotNull String loggerRef, @NotNull String graphApiVersion, long j10, @Nullable String str) {
