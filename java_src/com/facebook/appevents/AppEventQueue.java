...
public final class AppEventQueue {
    ...
    static {
        ...
        flushRunnable = new Runnable() { // from class: com.facebook.appevents.h
            @Override // java.lang.Runnable
            public final void run() {
                AppEventQueue.m67flushRunnable$lambda0();
            }
        };
    }
    ...
    public static final void add(@NotNull final AccessTokenAppIdPair accessTokenAppId, @NotNull final AppEvent appEvent) {
        ...
        try {
            ...
            singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.d
                @Override // java.lang.Runnable
                public final void run() {
                    AppEventQueue.m64add$lambda3(AccessTokenAppIdPair.this, appEvent);
                }
            });
        } catch (Throwable th2) {
    ...
    public static final void m64add$lambda3(AccessTokenAppIdPair accessTokenAppId, AppEvent appEvent) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    @JvmStatic
    @Nullable
    public static final GraphRequest buildRequestForSession(@NotNull final AccessTokenAppIdPair accessTokenAppId, @NotNull final SessionEventsState appEvents, boolean z10, @NotNull final FlushStatistics flushState) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return null;
        }
        try {
            ...
            int populateRequest = appEvents.populateRequest(newPostRequest, FacebookSdk.getApplicationContext(), supportsImplicitLogging, z10);
            if (populateRequest == 0) {
                return null;
            }
            flushState.setNumEvents(flushState.getNumEvents() + populateRequest);
            newPostRequest.setCallback(new GraphRequest.Callback() { // from class: com.facebook.appevents.c
                @Override // com.facebook.GraphRequest.Callback
                public final void onCompleted(GraphResponse graphResponse) {
                    AppEventQueue.m65buildRequestForSession$lambda4(AccessTokenAppIdPair.this, newPostRequest, appEvents, flushState, graphResponse);
                }
            });
    ...
    public static final void m65buildRequestForSession$lambda4(AccessTokenAppIdPair accessTokenAppId, GraphRequest postRequest, SessionEventsState appEvents, FlushStatistics flushState, GraphResponse response) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    public static final void flush(@NotNull final FlushReason reason) {
        ...
        try {
            ...
            singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.f
                @Override // java.lang.Runnable
                public final void run() {
                    AppEventQueue.m66flush$lambda2(FlushReason.this);
                }
            });
        } catch (Throwable th2) {
            CrashShieldHandler.handleThrowable(th2, AppEventQueue.class);
    ...
    public static final void m66flush$lambda2(FlushReason reason) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    public static final void m67flushRunnable$lambda0() {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    public static final void handleResponse(@NotNull final AccessTokenAppIdPair accessTokenAppId, @NotNull GraphRequest request, @NotNull GraphResponse response, @NotNull final SessionEventsState appEvents, @NotNull FlushStatistics flushState) {
        ...
        try {
            ...
            if (flushResult == flushResult2) {
                ...
                FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.appevents.e
                    @Override // java.lang.Runnable
                    public final void run() {
                        AppEventQueue.m68handleResponse$lambda5(AccessTokenAppIdPair.this, appEvents);
                    }
                });
            }
    ...
    public static final void m68handleResponse$lambda5(AccessTokenAppIdPair accessTokenAppId, SessionEventsState appEvents) {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
    ...
    public static final void persistToDisk() {
        ...
        try {
            singleThreadExecutor.execute(new Runnable() { // from class: com.facebook.appevents.g
                @Override // java.lang.Runnable
                public final void run() {
                    AppEventQueue.m69persistToDisk$lambda1();
                }
            });
        } catch (Throwable th2) {
            CrashShieldHandler.handleThrowable(th2, AppEventQueue.class);
    ...
    public static final void m69persistToDisk$lambda1() {
        if (CrashShieldHandler.isObjectCrashing(AppEventQueue.class)) {
            return;
        }
        try {
