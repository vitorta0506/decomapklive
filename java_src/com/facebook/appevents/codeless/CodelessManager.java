...
public final class CodelessManager {
        ...
        try {
            ...
            FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.appevents.codeless.c
                ...
                public final void run() {
                    CodelessManager.m87checkCodelessSession$lambda1(str);
                }
            });
        } catch (Throwable th2) {
    ...
    public static final void m87checkCodelessSession$lambda1(String str) {
    ...
    public static final void onActivityResumed(@NotNull Activity activity) {
        ...
        try {
            ...
            if (isCodelessEnabled.get()) {
                ...
                if (Intrinsics.areEqual(appSettingsWithoutQuery == null ? null : Boolean.valueOf(appSettingsWithoutQuery.getCodelessEventsEnabled()), Boolean.TRUE) || INSTANCE.isDebugOnEmulator()) {
                    ...
                    viewIndexingTrigger2.setOnShakeListener(new ViewIndexingTrigger.OnShakeListener() { // from class: com.facebook.appevents.codeless.b
                        ...
                        public final void onShake() {
                            CodelessManager.m88onActivityResumed$lambda0(FetchedAppSettings.this, applicationId);
                        }
                    });
    ...
    public static final void m88onActivityResumed$lambda0(FetchedAppSettings fetchedAppSettings, String appId) {
        if (CrashShieldHandler.isObjectCrashing(CodelessManager.class)) {
            return;
        }
        try {
