...
public final class ViewIndexer {
    ...
    public static final class Companion {
        ...
        public static final void m92buildAppIndexingRequest$lambda0(GraphResponse it) {
        ...
        public final GraphRequest buildAppIndexingRequest(@Nullable String str, @Nullable AccessToken accessToken, @Nullable String str2, @NotNull String requestType) {
            ...
            newPostRequest.setCallback(new GraphRequest.Callback() { // from class: com.facebook.appevents.codeless.g
                ...
                public final void onCompleted(GraphResponse graphResponse) {
                    ViewIndexer.Companion.m92buildAppIndexingRequest$lambda0(graphResponse);
                }
            });
    ...
    public static final void m90schedule$lambda0(ViewIndexer this$0, TimerTask indexingTask) {
        if (CrashShieldHandler.isObjectCrashing(ViewIndexer.class)) {
            return;
        }
        try {
        ...
        try {
            ...
            FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.appevents.codeless.f
                ...
                public final void run() {
                    ViewIndexer.m91sendToServer$lambda1(str, this);
                }
            });
        } catch (Throwable th2) {
    ...
    public static final void m91sendToServer$lambda1(String tree, ViewIndexer this$0) {
        if (CrashShieldHandler.isObjectCrashing(ViewIndexer.class)) {
            return;
        }
        try {
        ...
        try {
            ...
            try {
                ...
                FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.appevents.codeless.e
                    @Override // java.lang.Runnable
                    public final void run() {
                        ViewIndexer.m90schedule$lambda0(ViewIndexer.this, timerTask);
                    }
                });
