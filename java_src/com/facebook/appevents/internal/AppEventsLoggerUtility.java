...
public final class AppEventsLoggerUtility {
    ...
    @JvmStatic
    @NotNull
    public static final JSONObject getJSONObjectForGraphAPICall(@NotNull GraphAPIActivityType activityType, @Nullable AttributionIdentifiers attributionIdentifiers, @Nullable String str, boolean z10, @NotNull Context context) throws JSONException {
