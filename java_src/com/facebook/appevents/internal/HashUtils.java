...
public final class HashUtils {
    ...
    @JvmStatic
    @Nullable
    public static final String computeChecksumWithPackageManager(@NotNull Context context, @Nullable Long l10) {
        List mutableList;
        List mutableList2;
