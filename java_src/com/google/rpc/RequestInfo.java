...
public final class RequestInfo extends GeneratedMessageV3 implements r1 {
    private static final RequestInfo DEFAULT_INSTANCE = new RequestInfo();
    private static final e2<RequestInfo> PARSER = new a();
    ...
    public static class a extends com.google.protobuf.c<RequestInfo> {
        ...
        /* renamed from: G */
        public RequestInfo m(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
            return new RequestInfo(pVar, f0Var, null);
        }
    }
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        protected GeneratedMessageV3.e K() {
            return com.google.rpc.b.f15615v.d(RequestInfo.class, b.class);
        }
        ...
        public RequestInfo I() {
            ...
            requestInfo.requestId_ = this.f15580e;
            requestInfo.servingData_ = this.f15581f;
            Q();
            return requestInfo;
        }
        ...
        */
        public com.google.rpc.RequestInfo.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = com.google.rpc.RequestInfo.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.rpc.RequestInfo.b.u(com.google.protobuf.p, com.google.protobuf.f0):com.google.rpc.RequestInfo$b");
        }

        @Override // com.google.protobuf.a.AbstractC0142a
        /* renamed from: e0 */
        public b v(l1 l1Var) {
            if (l1Var instanceof RequestInfo) {
                return g0((RequestInfo) l1Var);
            }
            super.P0(l1Var);
            return this;
        }

        public b g0(RequestInfo requestInfo) {
            if (requestInfo == RequestInfo.getDefaultInstance()) {
                return this;
            }
            if (!requestInfo.getRequestId().isEmpty()) {
                this.f15580e = requestInfo.requestId_;
                R();
            }
            if (!requestInfo.getServingData().isEmpty()) {
                this.f15581f = requestInfo.servingData_;
                R();
            }
            z(((GeneratedMessageV3) requestInfo).unknownFields);
            R();
            return this;
        }
        ...
        public Descriptors.b getDescriptorForType() {
            return com.google.rpc.b.f15614u;
        }
    ...
    /* synthetic */ RequestInfo(p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
    ...
    public static e2<RequestInfo> parser() {
        return PARSER;
    }
    ...
    public e2<RequestInfo> getParserForType() {
        return PARSER;
    }
    ...
    public static b newBuilder(RequestInfo requestInfo) {
        return DEFAULT_INSTANCE.toBuilder().g0(requestInfo);
    }

    public static RequestInfo parseDelimitedFrom(InputStream inputStream, f0 f0Var) throws IOException {
        return (RequestInfo) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream, f0Var);
    }

    public static RequestInfo parseFrom(ByteBuffer byteBuffer, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static RequestInfo parseFrom(ByteString byteString, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static RequestInfo parseFrom(byte[] bArr, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static RequestInfo parseFrom(InputStream inputStream, f0 f0Var) throws IOException {
        return (RequestInfo) GeneratedMessageV3.parseWithIOException(PARSER, inputStream, f0Var);
    }

    private RequestInfo(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
    ...
    public static RequestInfo parseFrom(p pVar) throws IOException {
        return (RequestInfo) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
    }

    public static RequestInfo parseFrom(p pVar, f0 f0Var) throws IOException {
        return (RequestInfo) GeneratedMessageV3.parseWithIOException(PARSER, pVar, f0Var);
    }
}
