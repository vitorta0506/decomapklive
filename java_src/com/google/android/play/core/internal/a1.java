...
public final class a1 {
    ...
    private static final g f10565a = new g("PhoneskyVerificationUtils");
        ...
        try {
            if (context.getPackageManager().getApplicationInfo("com.android.vending", 0).enabled) {
                ...
                if (signatureArr == null || (r0 = signatureArr.length) == 0) {
                    f10565a.e("Phonesky package is not signed -- possibly self-built package. Could not verify.", new Object[0]);
                } else {
                    for (Signature signature : signatureArr) {
                        String a10 = z0.a(signature.toByteArray());
