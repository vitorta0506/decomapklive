...
public final class b extends t8 {
    ...
    private final r9 n(Integer num) {
        if (this.f9280f.containsKey(num)) {
            return (r9) this.f9280f.get(num);
        }
        r9 r9Var = new r9(this, this.f9278d, null);
        this.f9280f.put(num, r9Var);
        return r9Var;
    }

    private final boolean o(int i9, int i10) {
        r9 r9Var = (r9) this.f9280f.get(Integer.valueOf(i9));
        if (r9Var == null) {
            return false;
        }
        return r9.b(r9Var).get(i10);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:393:0x0a59, code lost:
        r0 = r64.f9432a.b().w();
        r6 = com.google.android.gms.measurement.internal.j3.z(r64.f9278d);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:395:0x0a6f, code lost:
        r7 = java.lang.Integer.valueOf(r7.w());
     */
