...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    static {
        int i9 = R.attr.snackbarButtonStyle;
        SNACKBAR_BUTTON_STYLE_ATTR = new int[]{i9};
        SNACKBAR_CONTENT_STYLE_ATTRS = new int[]{i9, R.attr.snackbarTextViewStyle};
    }
    ...
    @NonNull
    public static Snackbar make(@NonNull View view, @NonNull CharSequence charSequence, int i9) {
        return makeInternal(null, view, charSequence, i9);
    }

    @NonNull
    private static Snackbar makeInternal(@Nullable Context context, @NonNull View view, @NonNull CharSequence charSequence, int i9) {
    ...
    @NonNull
    public Snackbar setAction(@StringRes int i9, View.OnClickListener onClickListener) {
    ...
    @NonNull
    public Snackbar setBackgroundTint(@ColorInt int i9) {
        return setBackgroundTintList(ColorStateList.valueOf(i9));
    }
    ...
    @NonNull
    public Snackbar setMaxInlineActionWidth(@Dimension int i9) {
        ((SnackbarContentLayout) this.view.getChildAt(0)).setMaxInlineActionWidth(i9);
        return this;
    }
    ...
    @NonNull
    public static Snackbar make(@NonNull Context context, @NonNull View view, @NonNull CharSequence charSequence, int i9) {
        return makeInternal(context, view, charSequence, i9);
    }
    ...
    @NonNull
    public static Snackbar make(@NonNull View view, @StringRes int i9, int i10) {
        return make(view, view.getResources().getText(i9), i10);
    }

    @NonNull
    public Snackbar setActionTextColor(@ColorInt int i9) {
        ((SnackbarContentLayout) this.view.getChildAt(0)).getActionView().setTextColor(i9);
        return this;
    }

    @NonNull
    public Snackbar setText(@StringRes int i9) {
        return setText(getContext().getText(i9));
    }

    @NonNull
    public Snackbar setTextColor(@ColorInt int i9) {
        ((SnackbarContentLayout) this.view.getChildAt(0)).getMessageView().setTextColor(i9);
        return this;
    }
}
