...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        public SnackbarBaseLayout(@NonNull Context context, AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(i9)) {
                ViewCompat.setElevation(this, obtainStyledAttributes.getDimensionPixelSize(i9, 0));
            }
    ...
    private void animateViewOut(int i9) {
        if (this.view.getAnimationMode() == 1) {
            startFadeOutAnimation(i9);
        } else {
            startSlideOutAnimation(i9);
        }
    }
    ...
    private void startFadeOutAnimation(final int i9) {
    ...
    private void startSlideOutAnimation(final int i9) {
        ValueAnimator valueAnimator = new ValueAnimator();
