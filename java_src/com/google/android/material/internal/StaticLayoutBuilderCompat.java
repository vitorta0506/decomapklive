...
final class StaticLayoutBuilderCompat {
    ...
    @NonNull
    public static StaticLayoutBuilderCompat obtain(@NonNull CharSequence charSequence, @NonNull TextPaint textPaint, @IntRange(from = 0) int i9) {
    ...
    @NonNull
    public StaticLayoutBuilderCompat setEnd(@IntRange(from = 0) int i9) {
        this.end = i9;
        return this;
    }

    @NonNull
    public StaticLayoutBuilderCompat setHyphenationFrequency(int i9) {
    ...
    @NonNull
    public StaticLayoutBuilderCompat setMaxLines(@IntRange(from = 0) int i9) {
        this.maxLines = i9;
        return this;
    }

    @NonNull
    public StaticLayoutBuilderCompat setStart(@IntRange(from = 0) int i9) {
        this.start = i9;
        return this;
    }
}
