...
public class ShadowRenderer {
    ...
    public void drawCornerShadow(@NonNull Canvas canvas, @Nullable Matrix matrix, @NonNull RectF rectF, int i9, float f10, float f11) {
    ...
    public void setShadowColor(int i9) {
        this.shadowStartColor = ColorUtils.setAlphaComponent(i9, 68);
        this.shadowMiddleColor = ColorUtils.setAlphaComponent(i9, 20);
        this.shadowEndColor = ColorUtils.setAlphaComponent(i9, 0);
