...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    private void updateIconPosition(int i9, int i10) {
        ...
        if (!isIconStart() && !isIconEnd()) {
            if (isIconTop()) {
                ...
                int textHeight = (((((i10 - getTextHeight()) - getPaddingTop()) - i11) - this.iconPadding) - getPaddingBottom()) / 2;
        ...
        if (i12 != 1 && i12 != 3) {
            ...
            int textWidth = (((((i9 - getTextWidth()) - ViewCompat.getPaddingEnd(this)) - i13) - this.iconPadding) - ViewCompat.getPaddingStart(this)) / 2;
    ...
    public void onLayout(boolean z10, int i9, int i10, int i11, int i12) {
        ...
        materialButtonHelper.updateMaskBounds(i12 - i10, i11 - i9);
    }
    ...
    public void setInsetBottom(@Dimension int i9) {
        this.materialButtonHelper.setInsetBottom(i9);
    }

    public void setInsetTop(@Dimension int i9) {
        this.materialButtonHelper.setInsetTop(i9);
    }
