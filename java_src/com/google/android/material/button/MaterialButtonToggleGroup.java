...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public interface OnButtonCheckedListener {
        void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup, @IdRes int i9, boolean z10);
    }
    ...
    private void adjustChildMarginsAndUpdateLayout() {
        ...
        for (int i9 = firstVisibleChildIndex + 1; i9 < getChildCount(); i9++) {
            ...
            int min = Math.min(childButton.getStrokeWidth(), getChildButton(i9 - 1).getStrokeWidth());
    ...
    private void checkForced(int i9, boolean z10) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void dispatchOnButtonChecked(@IdRes int i9, boolean z10) {
        Iterator<OnButtonCheckedListener> it = this.onButtonCheckedListeners.iterator();
        while (it.hasNext()) {
            it.next().onButtonChecked(this, i9, z10);
        }
    }

    private MaterialButton getChildButton(int i9) {
    ...
    @Nullable
    private CornerData getNewCornerData(int i9, int i10, int i11) {
        CornerData cornerData = this.originalCornerData.get(i9);
        if (i10 == i11) {
            return cornerData;
        }
    ...
    private boolean isChildVisible(int i9) {
        return getChildAt(i9).getVisibility() != 8;
    }

    private void resetChildMargins(int i9) {
        if (getChildCount() == 0 || i9 == -1) {
            return;
        }
        LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) getChildButton(i9).getLayoutParams();
        if (getOrientation() == 1) {
    ...
    private void setCheckedId(int i9) {
        this.checkedId = i9;
        dispatchOnButtonChecked(i9, true);
    }

    private void setCheckedStateForView(@IdRes int i9, boolean z10) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean updateCheckedStates(int i9, boolean z10) {
    ...
    private void updateChildOrder() {
        ...
        int childCount = getChildCount();
        for (int i9 = 0; i9 < childCount; i9++) {
            treeMap.put(getChildButton(i9), Integer.valueOf(i9));
        }
    ...
    public void uncheck(@IdRes int i9) {
        checkForced(i9, false);
    }
    ...
    void updateChildShapes() {
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childButton.getVisibility() != 8) {
                ...
                updateBuilderWithCornerData(builder, getNewCornerData(i9, firstVisibleChildIndex, lastVisibleChildIndex));
