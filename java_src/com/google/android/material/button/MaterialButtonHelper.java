...
public class MaterialButtonHelper {
    ...
    private void setVerticalInsets(@Dimension int i9, @Dimension int i10) {
        ...
        ViewCompat.setPaddingRelative(this.materialButton, paddingStart, (paddingTop + i9) - i11, paddingEnd, (paddingBottom + i10) - i12);
    }
    ...
    public void setCornerRadius(int i9) {
        if (this.cornerRadiusSet && this.cornerRadius == i9) {
            return;
        }
        this.cornerRadius = i9;
        this.cornerRadiusSet = true;
        setShapeAppearanceModel(this.shapeAppearanceModel.withCornerSize(i9));
    }

    public void setInsetBottom(@Dimension int i9) {
        setVerticalInsets(this.insetTop, i9);
    }

    public void setInsetTop(@Dimension int i9) {
        setVerticalInsets(i9, this.insetBottom);
    }
    ...
    public void updateMaskBounds(int i9, int i10) {
        ...
        if (drawable != null) {
            drawable.setBounds(this.insetLeft, this.insetTop, i10 - this.insetRight, i9 - this.insetBottom);
        }
    }
