    ...
    protected void onMeasure(int i9, int i10) {
        ...
        for (int i19 = 0; i19 < childCount; i19++) {
            ...
            if (childAt2.getVisibility() != 8) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec(this.tempChildWidths[i19], BasicMeasure.EXACTLY), makeMeasureSpec);
                childAt2.getLayoutParams().width = childAt2.getMeasuredWidth();
                i18 += childAt2.getMeasuredWidth();
            }
        }
        setMeasuredDimension(View.resolveSizeAndState(i18, View.MeasureSpec.makeMeasureSpec(i18, BasicMeasure.EXACTLY), 0), View.resolveSizeAndState(size3, i10, 0));
    }
