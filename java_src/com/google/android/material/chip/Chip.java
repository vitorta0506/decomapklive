...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    private void initMinTouchTarget(Context context, @Nullable AttributeSet attributeSet, int i9) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.Chip, i9, DEF_STYLE_RES, new int[0]);
    ...
    private void insetChipBackgroundDrawable(int i9, int i10, int i11, int i12) {
        this.insetBackgroundDrawable = new InsetDrawable((Drawable) this.chipDrawable, i9, i10, i11, i12);
    }
    ...
    public boolean ensureAccessibleTouchTarget(@Dimension int i9) {
        this.minTouchTargetSize = i9;
        ...
        int max = Math.max(0, i9 - this.chipDrawable.getIntrinsicHeight());
        int max2 = Math.max(0, i9 - this.chipDrawable.getIntrinsicWidth());
        if (max2 <= 0 && max <= 0) {
            if (this.insetBackgroundDrawable != null) {
                removeBackgroundInset();
            } else {
    ...
    protected void onFocusChanged(boolean z10, int i9, Rect rect) {
        ...
        if (this.touchHelperEnabled) {
            this.touchHelper.onFocusChanged(z10, i9, rect);
        }
    }
    ...
    public void onRtlPropertiesChanged(int i9) {
        ...
        if (this.lastLayoutDirection != i9) {
            this.lastLayoutDirection = i9;
            updatePaddingInternal();
        }
    }
    ...
    */
    ...
    public void setCheckedIconTintResource(@ColorRes int i9) {
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setCheckedIconTintResource(i9);
        }
    }
