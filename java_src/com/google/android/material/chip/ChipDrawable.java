...
public class ChipDrawable extends MaterialShapeDrawable implements Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private ChipDrawable(@NonNull Context context, AttributeSet attributeSet, @AttrRes int i9, @StyleRes int i10) {
    ...
    @NonNull
    public static ChipDrawable createFromAttributes(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i9, @StyleRes int i10) {
    ...
    @NonNull
    public static ChipDrawable createFromResource(@NonNull Context context, @XmlRes int i9) {
        AttributeSet parseDrawableXml = DrawableUtils.parseDrawableXml(context, i9, "chip");
    ...
    private static boolean hasState(@Nullable int[] iArr, @AttrRes int i9) {
        if (iArr == null) {
            return false;
        }
        for (int i10 : iArr) {
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i9, @StyleRes int i10) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(this.context, attributeSet, R.styleable.Chip, i9, i10, new int[0]);
        ...
        if (obtainStyledAttributes.hasValue(i13)) {
            setChipIconTint(MaterialResources.getColorStateList(this.context, obtainStyledAttributes, i13));
        }
        ...
        if (obtainStyledAttributes.hasValue(i14)) {
            setCheckedIconTint(MaterialResources.getColorStateList(this.context, obtainStyledAttributes, i14));
        }
    ...
    public boolean onLayoutDirectionChanged(int i9) {
        ...
        if (showsChipIcon()) {
            onLayoutDirectionChanged |= DrawableCompat.setLayoutDirection(this.chipIcon, i9);
        }
        if (showsCheckedIcon()) {
            onLayoutDirectionChanged |= DrawableCompat.setLayoutDirection(this.checkedIcon, i9);
        }
        if (showsCloseIcon()) {
            onLayoutDirectionChanged |= DrawableCompat.setLayoutDirection(this.closeIcon, i9);
        }
    ...
    protected boolean onLevelChange(int i9) {
        ...
        if (showsChipIcon()) {
            onLevelChange |= this.chipIcon.setLevel(i9);
        }
        if (showsCheckedIcon()) {
            onLevelChange |= this.checkedIcon.setLevel(i9);
        }
        if (showsCloseIcon()) {
            onLevelChange |= this.closeIcon.setLevel(i9);
        }
        if (onLevelChange) {
            invalidateSelf();
        }
    ...
    public void setCheckedIconResource(@DrawableRes int i9) {
        setCheckedIcon(AppCompatResources.getDrawable(this.context, i9));
    }
    ...
    public void setCheckedIconTintResource(@ColorRes int i9) {
        setCheckedIconTint(AppCompatResources.getColorStateList(this.context, i9));
    }
    ...
    public void setChipBackgroundColorResource(@ColorRes int i9) {
        setChipBackgroundColor(AppCompatResources.getColorStateList(this.context, i9));
    }
    ...
    public void setChipIconResource(@DrawableRes int i9) {
        setChipIcon(AppCompatResources.getDrawable(this.context, i9));
    }
    ...
    public void setChipIconTintResource(@ColorRes int i9) {
        setChipIconTint(AppCompatResources.getColorStateList(this.context, i9));
    }
    ...
    public void setChipStrokeColorResource(@ColorRes int i9) {
        setChipStrokeColor(AppCompatResources.getColorStateList(this.context, i9));
    }
    ...
    public void setCloseIconResource(@DrawableRes int i9) {
        setCloseIcon(AppCompatResources.getDrawable(this.context, i9));
    }
    ...
    public void setCloseIconTintResource(@ColorRes int i9) {
        setCloseIconTint(AppCompatResources.getColorStateList(this.context, i9));
    }
    ...
    public void setRippleColorResource(@ColorRes int i9) {
        setRippleColor(AppCompatResources.getColorStateList(this.context, i9));
    }
