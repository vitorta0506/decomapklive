...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    private void drawCompatShadow(@NonNull Canvas canvas) {
        ...
        for (int i9 = 0; i9 < 4; i9++) {
            this.cornerShadowOperation[i9].draw(this.shadowRenderer, this.drawableState.shadowCompatRadius, canvas);
            this.edgeShadowOperation[i9].draw(this.shadowRenderer, this.drawableState.shadowCompatRadius, canvas);
        }
    ...
    private boolean hasCompatShadow() {
        ...
        int i9 = materialShapeDrawableState.shadowCompatMode;
        return i9 != 1 && materialShapeDrawableState.shadowCompatRadius > 0 && (i9 == 2 || requiresCompatShadow());
    }
    ...
    public boolean isShadowEnabled() {
        int i9 = this.drawableState.shadowCompatMode;
        return i9 == 0 || i9 == 2;
    }
    ...
    public void setAlpha(@IntRange(from = 0, to = 255) int i9) {
        MaterialShapeDrawableState materialShapeDrawableState = this.drawableState;
        if (materialShapeDrawableState.alpha != i9) {
            materialShapeDrawableState.alpha = i9;
            invalidateSelfIgnoreShape();
        }
    }
    ...
    public void setPadding(int i9, int i10, int i11, int i12) {
        ...
        this.drawableState.padding.set(i9, i10, i11, i12);
        invalidateSelf();
    }
    ...
    public void setShadowColor(int i9) {
        this.shadowRenderer.setShadowColor(i9);
    ...
    public void setShadowCompatRotation(int i9) {
        MaterialShapeDrawableState materialShapeDrawableState = this.drawableState;
        if (materialShapeDrawableState.shadowCompatRotation != i9) {
            materialShapeDrawableState.shadowCompatRotation = i9;
            invalidateSelfIgnoreShape();
        }
    }
    ...
    public void setShadowCompatibilityMode(int i9) {
        MaterialShapeDrawableState materialShapeDrawableState = this.drawableState;
        if (materialShapeDrawableState.shadowCompatMode != i9) {
            materialShapeDrawableState.shadowCompatMode = i9;
            invalidateSelfIgnoreShape();
        }
    }
    ...
    public void setShadowRadius(int i9) {
        this.drawableState.shadowCompatRadius = i9;
    }

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public void setShadowVerticalOffset(int i9) {
        MaterialShapeDrawableState materialShapeDrawableState = this.drawableState;
        if (materialShapeDrawableState.shadowCompatOffset != i9) {
            materialShapeDrawableState.shadowCompatOffset = i9;
            invalidateSelfIgnoreShape();
        }
    }
    ...
    private MaterialShapeDrawable(@NonNull MaterialShapeDrawableState materialShapeDrawableState) {
        ...
        this.pathShadowListener = new ShapeAppearancePathProvider.PathListener() { // from class: com.google.android.material.shape.MaterialShapeDrawable.1
            ...
            public void onCornerPathCreated(@NonNull ShapePath shapePath, Matrix matrix, int i9) {
                MaterialShapeDrawable.this.containsIncompatibleShadowOp.set(i9, shapePath.containsIncompatibleShadowOp());
                MaterialShapeDrawable.this.cornerShadowOperation[i9] = shapePath.createShadowCompatOperation(matrix);
            }

            @Override // com.google.android.material.shape.ShapeAppearancePathProvider.PathListener
            public void onEdgePathCreated(@NonNull ShapePath shapePath, Matrix matrix, int i9) {
                MaterialShapeDrawable.this.containsIncompatibleShadowOp.set(i9 + 4, shapePath.containsIncompatibleShadowOp());
                MaterialShapeDrawable.this.edgeShadowOperation[i9] = shapePath.createShadowCompatOperation(matrix);
            }
        };
    }
