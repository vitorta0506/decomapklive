...
public class ShapeAppearanceModel {
    ...
    public static final class Builder {
        ...
        public Builder setAllCorners(int i9, @Dimension float f10) {
            return setAllCorners(MaterialShapeUtils.createCornerTreatment(i9)).setAllCornerSizes(f10);
        }
        ...
        public Builder setBottomLeftCorner(int i9, @Dimension float f10) {
            return setBottomLeftCorner(MaterialShapeUtils.createCornerTreatment(i9)).setBottomLeftCornerSize(f10);
        }
        ...
        public Builder setBottomRightCorner(int i9, @Dimension float f10) {
            return setBottomRightCorner(MaterialShapeUtils.createCornerTreatment(i9)).setBottomRightCornerSize(f10);
        }
        ...
        public Builder setTopLeftCorner(int i9, @Dimension float f10) {
            return setTopLeftCorner(MaterialShapeUtils.createCornerTreatment(i9)).setTopLeftCornerSize(f10);
        }
        ...
        public Builder setTopRightCorner(int i9, @Dimension float f10) {
            return setTopRightCorner(MaterialShapeUtils.createCornerTreatment(i9)).setTopRightCornerSize(f10);
        }
        ...
        public Builder setBottomLeftCorner(int i9, @NonNull CornerSize cornerSize) {
            return setBottomLeftCorner(MaterialShapeUtils.createCornerTreatment(i9)).setBottomLeftCornerSize(cornerSize);
        }

        @NonNull
        public Builder setBottomRightCorner(int i9, @NonNull CornerSize cornerSize) {
            return setBottomRightCorner(MaterialShapeUtils.createCornerTreatment(i9)).setBottomRightCornerSize(cornerSize);
        }

        @NonNull
        public Builder setTopLeftCorner(int i9, @NonNull CornerSize cornerSize) {
            return setTopLeftCorner(MaterialShapeUtils.createCornerTreatment(i9)).setTopLeftCornerSize(cornerSize);
        }

        @NonNull
        public Builder setTopRightCorner(int i9, @NonNull CornerSize cornerSize) {
            return setTopRightCorner(MaterialShapeUtils.createCornerTreatment(i9)).setTopRightCornerSize(cornerSize);
        }
    ...
    @NonNull
    private static CornerSize getCornerSize(TypedArray typedArray, int i9, @NonNull CornerSize cornerSize) {
        ...
        return i10 == 6 ? new RelativeCornerSize(peekValue.getFraction(1.0f, 1.0f)) : cornerSize;
    }
    ...
    public static Builder builder(Context context, @StyleRes int i9, @StyleRes int i10) {
        return builder(context, i9, i10, 0);
    }

    @NonNull
    private static Builder builder(Context context, @StyleRes int i9, @StyleRes int i10, int i11) {
        return builder(context, i9, i10, new AbsoluteCornerSize(i11));
    }

    @NonNull
    private static Builder builder(Context context, @StyleRes int i9, @StyleRes int i10, @NonNull CornerSize cornerSize) {
        if (i10 != 0) {
