...
public class MonthAdapter extends BaseAdapter {
    ...
    private void updateSelectedStateForDate(MaterialCalendarGridView materialCalendarGridView, long j10) {
        if (Month.create(j10).equals(this.month)) {
            updateSelectedState((TextView) materialCalendarGridView.getChildAt(materialCalendarGridView.getAdapter2().dayToPosition(this.month.getDayOfMonth(j10)) - materialCalendarGridView.getFirstVisiblePosition()), j10);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public int dayToPosition(int i9) {
        return firstPositionInMonth() + (i9 - 1);
    }
    ...
    public long getItemId(int i9) {
        return i9 / this.month.daysInWeek;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public boolean isFirstInRow(int i9) {
        return i9 % this.month.daysInWeek == 0;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public boolean isLastInRow(int i9) {
        return (i9 + 1) % this.month.daysInWeek == 0;
    }
    ...
    int positionToDay(int i9) {
        return (i9 - this.month.daysFromStartOfWeekToFirstOfMonth()) + 1;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public boolean withinMonth(int i9) {
        return i9 >= firstPositionInMonth() && i9 <= lastPositionInMonth();
    }

    @Override // android.widget.Adapter
    @Nullable
    public Long getItem(int i9) {
        if (i9 < this.month.daysFromStartOfWeekToFirstOfMonth() || i9 > lastPositionInMonth()) {
            return null;
        }
        return Long.valueOf(this.month.getDay(positionToDay(i9)));
    }
