...
final class CalendarItemStyle {
    ...
    private CalendarItemStyle(ColorStateList colorStateList, ColorStateList colorStateList2, ColorStateList colorStateList3, int i9, ShapeAppearanceModel shapeAppearanceModel, @NonNull Rect rect) {
    ...
    @NonNull
    public static CalendarItemStyle create(@NonNull Context context, @StyleRes int i9) {
