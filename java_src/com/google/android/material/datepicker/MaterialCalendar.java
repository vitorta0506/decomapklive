...
public final class MaterialCalendar<S> extends PickerFragment<S> {
                        ...
                        if (l10 != null && pair.second != null) {
                            ...
                            while (i9 <= spanCount2) {
                                ...
                                if (findViewByPosition3 != null) {
                                    ...
                                    int left = i9 == spanCount ? findViewByPosition.getLeft() + (findViewByPosition.getWidth() / 2) : 0;
                                    if (i9 == spanCount2) {
    ...
    private static int getDialogPickerHeight(@NonNull Context context) {
        ...
        int i9 = MonthAdapter.MAXIMUM_WEEKS;
    ...
    @NonNull
    public static <T> MaterialCalendar<T> newInstance(@NonNull DateSelector<T> dateSelector, @StyleRes int i9, @NonNull CalendarConstraints calendarConstraints) {
    ...
    private void postSmoothRecyclerViewScroll(final int i9) {
        this.recyclerView.post(new Runnable() { // from class: com.google.android.material.datepicker.MaterialCalendar.10
            @Override // java.lang.Runnable
            public void run() {
                MaterialCalendar.this.recyclerView.smoothScrollToPosition(i9);
            }
        });
    }
