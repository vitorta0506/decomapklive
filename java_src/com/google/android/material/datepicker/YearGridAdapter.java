...
public class YearGridAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    @NonNull
    private View.OnClickListener createYearClickListener(final int i9) {
        return new View.OnClickListener() { // from class: com.google.android.material.datepicker.YearGridAdapter.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                YearGridAdapter.this.materialCalendar.setCurrentMonth(YearGridAdapter.this.materialCalendar.getCalendarConstraints().clamp(Month.create(i9, YearGridAdapter.this.materialCalendar.getCurrentMonth().month)));
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public int getPositionForYear(int i9) {
        return i9 - this.materialCalendar.getCalendarConstraints().getStart().year;
    }

    int getYearForPosition(int i9) {
        return this.materialCalendar.getCalendarConstraints().getStart().year + i9;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i9) {
        int yearForPosition = getYearForPosition(i9);
