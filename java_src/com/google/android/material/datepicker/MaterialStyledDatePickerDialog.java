...
public class MaterialStyledDatePickerDialog extends DatePickerDialog {
    ...
    public MaterialStyledDatePickerDialog(@NonNull Context context, int i9) {
        this(context, i9, null, -1, -1, -1);
    }

    public MaterialStyledDatePickerDialog(@NonNull Context context, @Nullable DatePickerDialog.OnDateSetListener onDateSetListener, int i9, int i10, int i11) {
        this(context, 0, onDateSetListener, i9, i10, i11);
    }

    public MaterialStyledDatePickerDialog(@NonNull Context context, int i9, @Nullable DatePickerDialog.OnDateSetListener onDateSetListener, int i10, int i11, int i12) {
