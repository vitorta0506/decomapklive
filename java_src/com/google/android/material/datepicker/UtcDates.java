...
class UtcDates {
    ...
    private static int findCharactersInDateFormatPattern(@NonNull String str, @NonNull String str2, int i9, int i10) {
    ...
    private static java.text.DateFormat getFormat(int i9, Locale locale) {
