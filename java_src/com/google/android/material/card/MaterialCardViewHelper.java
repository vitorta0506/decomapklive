...
public class MaterialCardViewHelper {
    ...
    public MaterialCardViewHelper(@NonNull MaterialCardView materialCardView, AttributeSet attributeSet, int i9, @StyleRes int i10) {
    ...
    private Drawable insetDrawable(Drawable drawable) {
        ...
        if (this.materialCardView.getUseCompatPadding()) {
            ...
            i9 = (int) Math.ceil(calculateHorizontalBackgroundPadding());
            i10 = ceil;
        } else {
            i9 = 0;
            i10 = 0;
    ...
    public void forceRippleRedraw() {
        ...
        if (drawable != null) {
            ...
            this.rippleDrawable.setBounds(bounds.left, bounds.top, bounds.right, i9 - 1);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void setUserContentPadding(int i9, int i10, int i11, int i12) {
        this.userContentPadding.set(i9, i10, i11, i12);
        updateContentPadding();
    }
