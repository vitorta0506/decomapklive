...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    public void setCardBackgroundColor(@ColorInt int i9) {
        this.cardViewHelper.setCardBackgroundColor(ColorStateList.valueOf(i9));
    }
    ...
    public void setCheckedIconMargin(@Dimension int i9) {
        this.cardViewHelper.setCheckedIconMargin(i9);
    }

    public void setCheckedIconMarginResource(@DimenRes int i9) {
        if (i9 != -1) {
            this.cardViewHelper.setCheckedIconMargin(getResources().getDimensionPixelSize(i9));
        }
    }

    public void setCheckedIconResource(@DrawableRes int i9) {
        this.cardViewHelper.setCheckedIcon(AppCompatResources.getDrawable(getContext(), i9));
    }

    public void setCheckedIconSize(@Dimension int i9) {
        this.cardViewHelper.setCheckedIconSize(i9);
    }

    public void setCheckedIconSizeResource(@DimenRes int i9) {
        if (i9 != 0) {
            this.cardViewHelper.setCheckedIconSize(getResources().getDimensionPixelSize(i9));
        }
    }
    ...
    public void setContentPadding(int i9, int i10, int i11, int i12) {
        this.cardViewHelper.setUserContentPadding(i9, i10, i11, i12);
    }
    ...
    public void setRippleColorResource(@ColorRes int i9) {
        this.cardViewHelper.setRippleColor(AppCompatResources.getColorStateList(getContext(), i9));
    }
