...
public abstract class IndeterminateAnimatorDelegate<T extends Animator> {
    ...
    public IndeterminateAnimatorDelegate(int i9) {
        this.segmentPositions = new float[i9 * 2];
        this.segmentColors = new int[i9];
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public float getFractionInRange(int i9, int i10, int i11) {
        return (i9 - i10) / i11;
    }
