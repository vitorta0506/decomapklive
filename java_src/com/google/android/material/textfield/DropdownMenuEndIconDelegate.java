...
public class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public DropdownMenuEndIconDelegate(@NonNull TextInputLayout textInputLayout, @DrawableRes int i9) {
    ...
    private void addRippleEffectOnFilledLayout(@NonNull AutoCompleteTextView autoCompleteTextView, int i9, int[][] iArr, @NonNull MaterialShapeDrawable materialShapeDrawable) {
    ...
    private void addRippleEffectOnOutlinedLayout(@NonNull AutoCompleteTextView autoCompleteTextView, int i9, int[][] iArr, @NonNull MaterialShapeDrawable materialShapeDrawable) {
    ...
    private MaterialShapeDrawable getPopUpMaterialShapeDrawable(float f10, float f11, float f12, int i9) {
    ...
    public void initialize() {
        ...
        if (i9 == 0) {
            i9 = IS_LOLLIPOP ? R.drawable.mtrl_dropdown_arrow : R.drawable.mtrl_ic_arrow_drop_down;
        }
        this.textInputLayout.setEndIconDrawable(i9);
