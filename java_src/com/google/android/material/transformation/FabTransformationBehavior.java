...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private void createExpansionAnimation(@NonNull View view, View view2, boolean z10, boolean z11, @NonNull FabTransformationSpec fabTransformationSpec, float f10, float f11, @NonNull List<Animator> list, @NonNull List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof CircularRevealWidget) {
            ...
            if (z10) {
                ...
                int i9 = (int) calculateRevealCenterX;
                int i10 = (int) calculateRevealCenterY;
                createPreFillRadialExpansion(view2, timing.getDelay(), i9, i10, f12, list);
                createPostFillRadialExpansion(view2, timing.getDelay(), timing.getDuration(), fabTransformationSpec.timings.getTotalDuration(), i9, i10, width, list);
    ...
    private void createPostFillRadialExpansion(View view, long j10, long j11, long j12, int i9, int i10, float f10, @NonNull List<Animator> list) {
        long j13 = j10 + j11;
        if (j13 < j12) {
            Animator createCircularReveal = ViewAnimationUtils.createCircularReveal(view, i9, i10, f10, f10);
    ...
    private void createPreFillRadialExpansion(View view, long j10, int i9, int i10, float f10, @NonNull List<Animator> list) {
        if (j10 > 0) {
            Animator createCircularReveal = ViewAnimationUtils.createCircularReveal(view, i9, i10, f10, f10);
