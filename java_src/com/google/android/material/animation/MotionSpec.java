...
public class MotionSpec {
    ...
    @Nullable
    public static MotionSpec createFromAttribute(@NonNull Context context, @NonNull TypedArray typedArray, @StyleableRes int i9) {
        int resourceId;
    ...
    @Nullable
    public static MotionSpec createFromResource(@NonNull Context context, @AnimatorRes int i9) {
        try {
            ...
            Log.w(TAG, "Can't load animation resource ID #0x" + Integer.toHexString(i9), e10);
            return null;
        }
    }
    ...
    private static MotionSpec createSpecFromAnimators(@NonNull List<Animator> list) {
        ...
        for (int i9 = 0; i9 < size; i9++) {
            addInfoFromAnimator(motionSpec, list.get(i9));
        }
        return motionSpec;
    }
    ...
    public long getTotalDuration() {
        ...
        long j10 = 0;
        for (int i9 = 0; i9 < size; i9++) {
            MotionTiming valueAt = this.timings.valueAt(i9);
