...
public abstract class NavigationBarView extends FrameLayout {
    ...
    public NavigationBarView(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i9, @StyleRes int i10) {
        ...
        TintTypedArray obtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, iArr, i9, i10, i11, i12);
        ...
        if (obtainTintedStyledAttributes.hasValue(i17)) {
            setElevation(obtainTintedStyledAttributes.getDimensionPixelSize(i17, 0));
        }
    ...
    public BadgeDrawable getBadge(int i9) {
        return this.menuView.getBadge(i9);
    }
    ...
    public BadgeDrawable getOrCreateBadge(int i9) {
        return this.menuView.getOrCreateBadge(i9);
    }
    ...
    public void setItemOnTouchListener(int i9, @Nullable View.OnTouchListener onTouchListener) {
        this.menuView.setItemOnTouchListener(i9, onTouchListener);
    }
