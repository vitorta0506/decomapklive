...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public static class ActiveIndicatorTransform {
        ...
        protected float calculateAlpha(@FloatRange(from = 0.0d, to = 1.0d) float f10, @FloatRange(from = 0.0d, to = 1.0d) float f11) {
            ...
            return AnimationUtils.lerp(0.0f, 1.0f, i9 == 0 ? 0.8f : 0.0f, i9 == 0 ? 1.0f : 0.2f, f10);
        }
    ...
    private static void setViewScaleValues(@NonNull View view, float f10, float f11, int i9) {
        view.setScaleX(f10);
        view.setScaleY(f11);
        view.setVisibility(i9);
    }

    private static void setViewTopMarginAndGravity(@NonNull View view, int i9, int i10) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void updateActiveIndicatorLayoutParams(int i9) {
    ...
    private static void updateViewPaddingBottom(@NonNull View view, int i9) {
    ...
    protected void onSizeChanged(final int i9, int i10, int i11, int i12) {
        ...
        post(new Runnable() { // from class: com.google.android.material.navigation.NavigationBarItemView.2
            ...
            public void run() {
                NavigationBarItemView.this.updateActiveIndicatorLayoutParams(i9);
            }
        });
    }
    ...
    public void setTextAppearanceActive(@StyleRes int i9) {
        TextViewCompat.setTextAppearance(this.largeLabel, i9);
        calculateTextScaleFactors(this.smallLabel.getTextSize(), this.largeLabel.getTextSize());
    }

    public void setTextAppearanceInactive(@StyleRes int i9) {
        TextViewCompat.setTextAppearance(this.smallLabel, i9);
        calculateTextScaleFactors(this.smallLabel.getTextSize(), this.largeLabel.getTextSize());
    }
