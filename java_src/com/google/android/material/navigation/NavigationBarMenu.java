...
public final class NavigationBarMenu extends MenuBuilder {
    ...
    public NavigationBarMenu(@NonNull Context context, @NonNull Class<?> cls, int i9) {
        super(context);
        this.viewClass = cls;
    ...
    @NonNull
    public MenuItem addInternal(int i9, int i10, int i11, @NonNull CharSequence charSequence) {
    ...
    @NonNull
    public SubMenu addSubMenu(int i9, int i10, int i11, @NonNull CharSequence charSequence) {
