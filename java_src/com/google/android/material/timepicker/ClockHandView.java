...
public class ClockHandView extends View {
    ...
    public void setHandRotationInternal(@FloatRange(from = 0.0d, to = 360.0d) float f10, boolean z10) {
        ...
        int i9 = this.selectorRadius;
        rectF.set(width - i9, height - i9, width + i9, height + i9);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1 || actionMasked == 2) {
                int i9 = (int) (x10 - this.downX);
                int i10 = (int) (y10 - this.downY);
                this.isInTapRegion = (i9 * i9) + (i10 * i10) > this.scaledTouchSlop;
    ...
    public void setCircleRadius(@Dimension int i9) {
