...
class TimePickerTextInputKeyController implements TextView.OnEditorActionListener, View.OnKeyListener {
    ...
    private void moveSelection(int i9) {
        this.minuteLayoutComboView.setChecked(i9 == 12);
        this.hourLayoutComboView.setChecked(i9 == 10);
        this.time.selection = i9;
    }

    private boolean onHourKeyPress(int i9, KeyEvent keyEvent, EditText editText) {
    ...
    private boolean onMinuteKeyPress(int i9, KeyEvent keyEvent, EditText editText) {
    ...
    public boolean onKey(View view, int i9, KeyEvent keyEvent) {
        ...
        if (this.time.selection == 12) {
            onHourKeyPress = onMinuteKeyPress(i9, keyEvent, editText);
        } else {
            onHourKeyPress = onHourKeyPress(i9, keyEvent, editText);
        }
