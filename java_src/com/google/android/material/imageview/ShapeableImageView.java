...
public class ShapeableImageView extends AppCompatImageView implements Shapeable {
    ...
    private void updateShapeMask(int i9, int i10) {
        this.destination.set(getPaddingLeft(), getPaddingTop(), i9 - getPaddingRight(), i10 - getPaddingBottom());
        this.pathProvider.calculatePath(this.shapeAppearanceModel, 1.0f, this.destination, this.path);
        this.maskPath.rewind();
        this.maskPath.addPath(this.path);
        this.maskRect.set(0.0f, 0.0f, i9, i10);
    ...
    public final int getContentPaddingEnd() {
        int i9 = this.endContentPadding;
        return i9 != Integer.MIN_VALUE ? i9 : isRtl() ? this.leftContentPadding : this.rightContentPadding;
    }
    ...
    public final int getContentPaddingStart() {
        int i9 = this.startContentPadding;
        return i9 != Integer.MIN_VALUE ? i9 : isRtl() ? this.rightContentPadding : this.leftContentPadding;
    }
    ...
    public void setContentPadding(@Dimension int i9, @Dimension int i10, @Dimension int i11, @Dimension int i12) {
        ...
        super.setPadding((super.getPaddingLeft() - this.leftContentPadding) + i9, (super.getPaddingTop() - this.topContentPadding) + i10, (super.getPaddingRight() - this.rightContentPadding) + i11, (super.getPaddingBottom() - this.bottomContentPadding) + i12);
    ...
    public void setContentPaddingRelative(@Dimension int i9, @Dimension int i10, @Dimension int i11, @Dimension int i12) {
        super.setPaddingRelative((super.getPaddingStart() - getContentPaddingStart()) + i9, (super.getPaddingTop() - this.topContentPadding) + i10, (super.getPaddingEnd() - getContentPaddingEnd()) + i11, (super.getPaddingBottom() - this.bottomContentPadding) + i12);
        this.leftContentPadding = isRtl() ? i11 : i9;
        this.topContentPadding = i10;
        if (!isRtl()) {
            i9 = i11;
        }
