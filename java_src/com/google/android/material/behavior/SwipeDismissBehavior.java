...
public class SwipeDismissBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private final ViewDragHelper.Callback dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.behavior.SwipeDismissBehavior.1
        ...
        public void onViewReleased(@NonNull View view, float f10, float f11) {
            ...
            if (SwipeDismissBehavior.this.viewDragHelper.settleCapturedViewAt(i9, view.getTop())) {
        ...
        public boolean tryCaptureView(View view, int i9) {
            ...
            return (i10 == -1 || i10 == i9) && SwipeDismissBehavior.this.canSwipeDismissView(view);
        }
    };
    ...
    static int clamp(int i9, int i10, int i11) {
