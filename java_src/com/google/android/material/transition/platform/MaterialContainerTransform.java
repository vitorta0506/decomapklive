...
public final class MaterialContainerTransform extends Transition {
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private void drawDebugCumulativePath(Canvas canvas, RectF rectF, Path path, @ColorInt int i9) {
        ...
        private void drawDebugRect(Canvas canvas, RectF rectF, @ColorInt int i9) {
            this.debugPaint.setColor(i9);
    ...
    private static void captureValues(@NonNull TransitionValues transitionValues, @Nullable View view, @IdRes int i9, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        if (i9 != -1) {
            transitionValues.view = TransitionUtils.findDescendantOrAncestorById(transitionValues.view, i9);
        } else if (view != null) {
    ...
    private boolean isEntering(@NonNull RectF rectF, @NonNull RectF rectF2) {
        int i9 = this.transitionDirection;
        if (i9 == 0) {
    ...
    private void maybeApplyThemeValues(Context context, boolean z10) {
        ...
        TransitionUtils.maybeApplyThemeDuration(this, context, z10 ? R.attr.motionDurationLong1 : R.attr.motionDurationMedium2);
    ...
    public void setAllContainerColors(@ColorInt int i9) {
        this.containerColor = i9;
        this.startContainerColor = i9;
        this.endContainerColor = i9;
    }

    public void setContainerColor(@ColorInt int i9) {
        this.containerColor = i9;
    }
    ...
    public void setDrawingViewId(@IdRes int i9) {
        this.drawingViewId = i9;
    }
    ...
    public void setEndContainerColor(@ColorInt int i9) {
        this.endContainerColor = i9;
    }
    ...
    public void setEndViewId(@IdRes int i9) {
        this.endViewId = i9;
    }

    public void setFadeMode(int i9) {
        this.fadeMode = i9;
    }
    ...
    public void setStartContainerColor(@ColorInt int i9) {
        this.startContainerColor = i9;
    }
    ...
    public void setStartViewId(@IdRes int i9) {
        this.startViewId = i9;
    }

    public void setTransitionDirection(int i9) {
        this.transitionDirection = i9;
    }
