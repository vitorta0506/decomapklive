...
public class TabLayout extends HorizontalScrollView {
    ...
    public class SlidingTabIndicator extends LinearLayout {
        ...
        private void updateOrRecreateIndicatorAnimation(boolean z10, final int i9, int i10) {
            ...
            if (z10) {
                ...
                valueAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.tabs.TabLayout.SlidingTabIndicator.2
                    ...
                    public void onAnimationEnd(Animator animator) {
                        SlidingTabIndicator.this.selectedPosition = i9;
                    }
        ...
        void animateIndicatorToPosition(int i9, int i10) {
            ValueAnimator valueAnimator = this.indicatorAnimator;
            if (valueAnimator != null && valueAnimator.isRunning()) {
                this.indicatorAnimator.cancel();
            }
            updateOrRecreateIndicatorAnimation(true, i9, i10);
        }
        ...
        public void onRtlPropertiesChanged(int i9) {
            ...
            if (Build.VERSION.SDK_INT >= 23 || this.layoutDirection == i9) {
                return;
            }
            requestLayout();
        ...
        void setIndicatorPositionFromTabPosition(int i9, float f10) {
            ValueAnimator valueAnimator = this.indicatorAnimator;
            if (valueAnimator != null && valueAnimator.isRunning()) {
                this.indicatorAnimator.cancel();
            }
            ...
            tweenIndicatorPosition(getChildAt(i9), getChildAt(this.selectedPosition + 1), this.selectionOffset);
        }

        void setSelectedIndicatorHeight(int i9) {
            Rect bounds = TabLayout.this.tabSelectedIndicator.getBounds();
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int i9, float f10, int i10) {
            ...
            if (tabLayout != null) {
                ...
                boolean z10 = false;
                tabLayout.setScrollPosition(i9, f10, i11 != 2 || this.previousScrollState == 1, (i11 == 2 && this.previousScrollState == 0) ? true : true);
            }
        }
    ...
    public final class TabView extends LinearLayout {
        ...
        private float approximateLineWidth(@NonNull Layout layout, int i9, float f10) {
    ...
    private int calculateScrollXForTab(int i9, float f10) {
        View childAt;
        int i10 = this.mode;
    ...
    private void configureTab(@NonNull Tab tab, int i9) {
        tab.setPosition(i9);
    ...
    public Tab newTab() {
        ...
        if (createTabFromPool.f10134id != -1) {
            createTabFromPool.view.setId(createTabFromPool.f10134id);
        }
    ...
    */
    ...
    public void setScrollPosition(int i9, float f10, boolean z10) {
        setScrollPosition(i9, f10, z10, true);
    }
    ...
    public void setScrollPosition(int i9, float f10, boolean z10, boolean z11) {
        int round = Math.round(i9 + f10);
        if (round < 0 || round >= this.slidingTabIndicator.getChildCount()) {
            return;
        }
        if (z11) {
            this.slidingTabIndicator.setIndicatorPositionFromTabPosition(i9, f10);
        }
        ValueAnimator valueAnimator = this.scrollAnimator;
        if (valueAnimator != null && valueAnimator.isRunning()) {
            this.scrollAnimator.cancel();
        }
        scrollTo(i9 < 0 ? 0 : calculateScrollXForTab(i9, f10), 0);
        if (z10) {
    ...
    */
    ...
    public void addTab(@NonNull Tab tab, int i9, boolean z10) {
        if (tab.parent == this) {
            configureTab(tab, i9);
            addTabView(tab);
            if (z10) {
