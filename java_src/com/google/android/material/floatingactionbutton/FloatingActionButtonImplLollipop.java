...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    @NonNull
    BorderDrawable createBorderDrawable(int i9, ColorStateList colorStateList) {
        ...
        borderDrawable.setBorderWidth(i9);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.google.android.material.floatingactionbutton.FloatingActionButtonImpl
    public void initializeBackgroundDrawable(ColorStateList colorStateList, @Nullable PorterDuff.Mode mode, ColorStateList colorStateList2, int i9) {
        Drawable drawable;
