...
public abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    private static int resolveGravity(int i9) {
        return i9 == 0 ? BadgeDrawable.TOP_START : i9;
    }
    ...
    public final int getOverlapPixelsForOffset(View view) {
        ...
        return MathUtils.clamp((int) (overlapRatioForOffset * i9), 0, i9);
    }
    ...
    public void layoutChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, int i9) {
        ...
        if (findFirstDependency != null) {
            ...
            GravityCompat.apply(resolveGravity(layoutParams.gravity), view.getMeasuredWidth(), view.getMeasuredHeight(), rect, rect2, i9);
    ...
    public boolean onMeasureChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, int i9, int i10, int i11, int i12) {
        ...
        if ((i13 == -1 || i13 == -2) && (findFirstDependency = findFirstDependency(coordinatorLayout.getDependencies(view))) != null) {
            ...
            coordinatorLayout.onMeasureChild(view, i9, i10, View.MeasureSpec.makeMeasureSpec(scrollRange, i13 == -1 ? BasicMeasure.EXACTLY : Integer.MIN_VALUE), i12);
            return true;
        }
        return false;
    }
