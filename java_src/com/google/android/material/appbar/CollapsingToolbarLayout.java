...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    private class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int i9) {
            ...
            for (int i10 = 0; i10 < childCount; i10++) {
                ...
                if (i11 == 1) {
                    viewOffsetHelper.setTopAndBottomOffset(MathUtils.clamp(-i9, 0, CollapsingToolbarLayout.this.getMaxOffsetForPinChild(childAt)));
                } else if (i11 == 2) {
            ...
            CollapsingToolbarLayout.this.collapsingTextHelper.setExpansionFraction(Math.abs(i9) / f10);
        }
    }
    ...
    private void animateScrim(int i9) {
        ...
        if (valueAnimator == null) {
            ...
            valueAnimator2.setInterpolator(i9 > this.scrimAlpha ? AnimationUtils.FAST_OUT_LINEAR_IN_INTERPOLATOR : AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
    ...
    private void updateCollapsedBounds(boolean z10) {
        ...
        collapsingTextHelper.setCollapsedBounds(i13, i14, i15 - i12, (rect.bottom + maxOffsetForPinChild) - i9);
    }
    ...
    private void updateContentScrimBounds(@NonNull Drawable drawable, int i9, int i10) {
    ...
    private void updateTextBounds(int i9, int i10, int i11, int i12, boolean z10) {
        ...
        if (z11 || z10) {
            ...
            this.collapsingTextHelper.setExpandedBounds(z12 ? this.expandedMarginEnd : this.expandedMarginStart, this.tmpRect.top + this.expandedMarginTop, (i11 - i9) - (z12 ? this.expandedMarginStart : this.expandedMarginEnd), (i12 - i10) - this.expandedMarginBottom);
    ...
    protected void onMeasure(int i9, int i10) {
        ...
        if (this.extraMultilineHeightEnabled && this.collapsingTextHelper.getMaxLines() > 1) {
            ...
            if (expandedLineCount > 1) {
                ...
                super.onMeasure(i9, View.MeasureSpec.makeMeasureSpec(getMeasuredHeight() + this.extraMultilineHeight, BasicMeasure.EXACTLY));
            }
        }
        ViewGroup viewGroup = this.toolbar;
        if (viewGroup != null) {
    ...
    public void setHyphenationFrequency(int i9) {
        this.collapsingTextHelper.setHyphenationFrequency(i9);
    }
    ...
    public void setMaxLines(int i9) {
        this.collapsingTextHelper.setMaxLines(i9);
    }
    ...
    private void updateContentScrimBounds(@NonNull Drawable drawable, @Nullable View view, int i9, int i10) {
