...
public abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    final boolean fling(CoordinatorLayout coordinatorLayout, @NonNull V v10, int i9, int i10, float f10) {
        ...
        this.scroller.fling(0, getTopAndBottomOffset(), 0, Math.round(f10), 0, 0, i9, i10);
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final int scroll(CoordinatorLayout coordinatorLayout, V v10, int i9, int i10, int i11) {
        return setHeaderTopBottomOffset(coordinatorLayout, v10, getTopBottomOffsetForScrollingSibling() - i9, i10, i11);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v10, int i9) {
        return setHeaderTopBottomOffset(coordinatorLayout, v10, i9, Integer.MIN_VALUE, Integer.MAX_VALUE);
    }

    int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v10, int i9, int i10, int i11) {
        int clamp;
        int topAndBottomOffset = getTopAndBottomOffset();
        if (i10 == 0 || topAndBottomOffset < i10 || topAndBottomOffset > i11 || topAndBottomOffset == (clamp = MathUtils.clamp(i9, i10, i11))) {
            return 0;
        }
