...
public final class WordInfo extends GeneratedMessageV3 implements r {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r {
        ...
        private Duration f11953e;

        /* renamed from: f  reason: collision with root package name */
        private q2<Duration, Duration.b, v> f11954f;

        /* renamed from: g  reason: collision with root package name */
        private Duration f11955g;

        /* renamed from: h  reason: collision with root package name */
        private q2<Duration, Duration.b, v> f11956h;

        /* renamed from: i  reason: collision with root package name */
        private Object f11957i;
        ...
        public WordInfo I() {
            ...
            q2<Duration, Duration.b, v> q2Var = this.f11954f;
            if (q2Var == null) {
                wordInfo.startTime_ = this.f11953e;
            } else {
                wordInfo.startTime_ = q2Var.b();
            }
            q2<Duration, Duration.b, v> q2Var2 = this.f11956h;
            if (q2Var2 == null) {
                wordInfo.endTime_ = this.f11955g;
            } else {
                wordInfo.endTime_ = q2Var2.b();
            }
            wordInfo.word_ = this.f11957i;
            wordInfo.confidence_ = this.f11958j;
            wordInfo.speakerTag_ = this.f11959k;
            Q();
            return wordInfo;
        }
        ...
        public b d0(Duration duration) {
            q2<Duration, Duration.b, v> q2Var = this.f11956h;
            if (q2Var == null) {
                Duration duration2 = this.f11955g;
                if (duration2 != null) {
                    this.f11955g = Duration.newBuilder(duration2).e0(duration).I();
                } else {
                    this.f11955g = duration;
                }
                R();
            } else {
                q2Var.e(duration);
        ...
        */
        public com.google.cloud.speech.v1.WordInfo.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = com.google.cloud.speech.v1.WordInfo.access$1000()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.cloud.speech.v1.WordInfo.b.u(com.google.protobuf.p, com.google.protobuf.f0):com.google.cloud.speech.v1.WordInfo$b");
        }
        ...
        public b i0(Duration duration) {
            q2<Duration, Duration.b, v> q2Var = this.f11954f;
            if (q2Var == null) {
                Duration duration2 = this.f11953e;
                if (duration2 != null) {
                    this.f11953e = Duration.newBuilder(duration2).e0(duration).I();
                } else {
                    this.f11953e = duration;
                }
                R();
            } else {
                q2Var.e(duration);
