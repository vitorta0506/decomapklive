...
public final class RecognitionConfig extends GeneratedMessageV3 implements d {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements d {
        private RecognitionMetadata A;
        private q2<RecognitionMetadata, RecognitionMetadata.b, e> B;
        private Object C;
        private boolean D;
        ...
        private SpeechAdaptation f11870n;

        /* renamed from: o  reason: collision with root package name */
        private q2<SpeechAdaptation, SpeechAdaptation.b, g> f11871o;

        /* renamed from: p  reason: collision with root package name */
        private List<SpeechContext> f11872p;

        /* renamed from: q  reason: collision with root package name */
        private l2<SpeechContext, SpeechContext.b, i> f11873q;
        ...
        private BoolValue f11877u;

        /* renamed from: v  reason: collision with root package name */
        private q2<BoolValue, BoolValue.b, com.google.protobuf.l> f11878v;

        /* renamed from: w  reason: collision with root package name */
        private BoolValue f11879w;

        /* renamed from: x  reason: collision with root package name */
        private q2<BoolValue, BoolValue.b, com.google.protobuf.l> f11880x;

        /* renamed from: y  reason: collision with root package name */
        private SpeakerDiarizationConfig f11881y;

        /* renamed from: z  reason: collision with root package name */
        private q2<SpeakerDiarizationConfig, SpeakerDiarizationConfig.b, f> f11882z;
        ...
        private void a0() {
            if ((this.f11861e & 1) == 0) {
                this.f11867k = new y0(this.f11867k);
                this.f11861e |= 1;
            }
        }
        ...
        private void b0() {
            if ((this.f11861e & 2) == 0) {
                this.f11872p = new ArrayList(this.f11872p);
                this.f11861e |= 2;
            }
        }
        ...
        private l2<SpeechContext, SpeechContext.b, i> e0() {
            if (this.f11873q == null) {
                this.f11873q = new l2<>(this.f11872p, (this.f11861e & 2) != 0, H(), O());
                this.f11872p = null;
            }
            return this.f11873q;
        }
        ...
        protected GeneratedMessageV3.e K() {
            return j.f11974l.d(RecognitionConfig.class, b.class);
        }
        ...
        public RecognitionConfig I() {
            ...
            recognitionConfig.encoding_ = this.f11862f;
            recognitionConfig.sampleRateHertz_ = this.f11863g;
            recognitionConfig.audioChannelCount_ = this.f11864h;
            recognitionConfig.enableSeparateRecognitionPerChannel_ = this.f11865i;
            recognitionConfig.languageCode_ = this.f11866j;
            if ((this.f11861e & 1) != 0) {
                this.f11867k = this.f11867k.V0();
                this.f11861e &= -2;
            }
            recognitionConfig.alternativeLanguageCodes_ = this.f11867k;
            recognitionConfig.maxAlternatives_ = this.f11868l;
            recognitionConfig.profanityFilter_ = this.f11869m;
            q2<SpeechAdaptation, SpeechAdaptation.b, g> q2Var = this.f11871o;
            if (q2Var == null) {
                recognitionConfig.adaptation_ = this.f11870n;
            } else {
                recognitionConfig.adaptation_ = q2Var.b();
            }
            l2<SpeechContext, SpeechContext.b, i> l2Var = this.f11873q;
            if (l2Var == null) {
                if ((this.f11861e & 2) != 0) {
                    this.f11872p = Collections.unmodifiableList(this.f11872p);
                    this.f11861e &= -3;
                }
                recognitionConfig.speechContexts_ = this.f11872p;
            } else {
                recognitionConfig.speechContexts_ = l2Var.e();
            }
            recognitionConfig.enableWordTimeOffsets_ = this.f11874r;
            recognitionConfig.enableWordConfidence_ = this.f11875s;
            recognitionConfig.enableAutomaticPunctuation_ = this.f11876t;
            q2<BoolValue, BoolValue.b, com.google.protobuf.l> q2Var2 = this.f11878v;
            if (q2Var2 == null) {
                recognitionConfig.enableSpokenPunctuation_ = this.f11877u;
            } else {
                recognitionConfig.enableSpokenPunctuation_ = q2Var2.b();
            }
            q2<BoolValue, BoolValue.b, com.google.protobuf.l> q2Var3 = this.f11880x;
            if (q2Var3 == null) {
                recognitionConfig.enableSpokenEmojis_ = this.f11879w;
            } else {
                recognitionConfig.enableSpokenEmojis_ = q2Var3.b();
            }
            q2<SpeakerDiarizationConfig, SpeakerDiarizationConfig.b, f> q2Var4 = this.f11882z;
            if (q2Var4 == null) {
                recognitionConfig.diarizationConfig_ = this.f11881y;
            } else {
                recognitionConfig.diarizationConfig_ = q2Var4.b();
            }
            q2<RecognitionMetadata, RecognitionMetadata.b, e> q2Var5 = this.B;
            if (q2Var5 == null) {
                recognitionConfig.metadata_ = this.A;
            } else {
                recognitionConfig.metadata_ = q2Var5.b();
            }
            recognitionConfig.model_ = this.C;
            recognitionConfig.useEnhanced_ = this.D;
            Q();
        ...
        public b h0(SpeechAdaptation speechAdaptation) {
            q2<SpeechAdaptation, SpeechAdaptation.b, g> q2Var = this.f11871o;
            if (q2Var == null) {
                SpeechAdaptation speechAdaptation2 = this.f11870n;
                if (speechAdaptation2 != null) {
                    this.f11870n = SpeechAdaptation.newBuilder(speechAdaptation2).j0(speechAdaptation).I();
                } else {
                    this.f11870n = speechAdaptation;
                }
                R();
            } else {
        ...
        public b i0(SpeakerDiarizationConfig speakerDiarizationConfig) {
            q2<SpeakerDiarizationConfig, SpeakerDiarizationConfig.b, f> q2Var = this.f11882z;
            if (q2Var == null) {
                SpeakerDiarizationConfig speakerDiarizationConfig2 = this.f11881y;
                if (speakerDiarizationConfig2 != null) {
                    this.f11881y = SpeakerDiarizationConfig.newBuilder(speakerDiarizationConfig2).d0(speakerDiarizationConfig).I();
                } else {
                    this.f11881y = speakerDiarizationConfig;
                }
                R();
            } else {
        ...
        public b j0(BoolValue boolValue) {
            q2<BoolValue, BoolValue.b, com.google.protobuf.l> q2Var = this.f11880x;
            if (q2Var == null) {
                BoolValue boolValue2 = this.f11879w;
                if (boolValue2 != null) {
                    this.f11879w = BoolValue.newBuilder(boolValue2).d0(boolValue).I();
                } else {
                    this.f11879w = boolValue;
                }
                R();
            } else {
                q2Var.e(boolValue);
        ...
        public b k0(BoolValue boolValue) {
            q2<BoolValue, BoolValue.b, com.google.protobuf.l> q2Var = this.f11878v;
            if (q2Var == null) {
                BoolValue boolValue2 = this.f11877u;
                if (boolValue2 != null) {
                    this.f11877u = BoolValue.newBuilder(boolValue2).d0(boolValue).I();
                } else {
                    this.f11877u = boolValue;
                }
                R();
            } else {
                q2Var.e(boolValue);
        ...
        public b l0(RecognitionConfig recognitionConfig) {
            ...
            if (recognitionConfig.encoding_ != 0) {
                y0(recognitionConfig.getEncodingValue());
            }
            if (recognitionConfig.getSampleRateHertz() != 0) {
                I0(recognitionConfig.getSampleRateHertz());
            }
            if (recognitionConfig.getAudioChannelCount() != 0) {
                r0(recognitionConfig.getAudioChannelCount());
            }
            if (recognitionConfig.getEnableSeparateRecognitionPerChannel()) {
                t0(recognitionConfig.getEnableSeparateRecognitionPerChannel());
            }
            if (!recognitionConfig.getLanguageCode().isEmpty()) {
                this.f11866j = recognitionConfig.languageCode_;
                R();
            }
            if (!recognitionConfig.alternativeLanguageCodes_.isEmpty()) {
                if (this.f11867k.isEmpty()) {
                    this.f11867k = recognitionConfig.alternativeLanguageCodes_;
                    this.f11861e &= -2;
                } else {
                    a0();
                    this.f11867k.addAll(recognitionConfig.alternativeLanguageCodes_);
                }
                R();
            }
            if (recognitionConfig.getMaxAlternatives() != 0) {
                D0(recognitionConfig.getMaxAlternatives());
            }
            if (recognitionConfig.getProfanityFilter()) {
                H0(recognitionConfig.getProfanityFilter());
            }
            ...
            if (this.f11873q == null) {
                if (!recognitionConfig.speechContexts_.isEmpty()) {
                    if (this.f11872p.isEmpty()) {
                        this.f11872p = recognitionConfig.speechContexts_;
                        this.f11861e &= -3;
                    } else {
                        b0();
                        this.f11872p.addAll(recognitionConfig.speechContexts_);
                    }
                    R();
                }
                ...
                if (this.f11873q.k()) {
                    ...
                    this.f11872p = recognitionConfig.speechContexts_;
                    this.f11861e &= -3;
                    this.f11873q = GeneratedMessageV3.alwaysUseFieldBuilders ? e0() : null;
                } else {
                    this.f11873q.b(recognitionConfig.speechContexts_);
                }
            }
            if (recognitionConfig.getEnableWordTimeOffsets()) {
                v0(recognitionConfig.getEnableWordTimeOffsets());
            }
            if (recognitionConfig.getEnableWordConfidence()) {
                u0(recognitionConfig.getEnableWordConfidence());
            }
            if (recognitionConfig.getEnableAutomaticPunctuation()) {
                s0(recognitionConfig.getEnableAutomaticPunctuation());
            }
            ...
            if (!recognitionConfig.getModel().isEmpty()) {
                this.C = recognitionConfig.model_;
                R();
            }
            if (recognitionConfig.getUseEnhanced()) {
                K0(recognitionConfig.getUseEnhanced());
            }
        ...
        */
        public com.google.cloud.speech.v1.RecognitionConfig.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = com.google.cloud.speech.v1.RecognitionConfig.access$2500()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.cloud.speech.v1.RecognitionConfig.b.u(com.google.protobuf.p, com.google.protobuf.f0):com.google.cloud.speech.v1.RecognitionConfig$b");
        }
        ...
        public b o0(RecognitionMetadata recognitionMetadata) {
            q2<RecognitionMetadata, RecognitionMetadata.b, e> q2Var = this.B;
            if (q2Var == null) {
                RecognitionMetadata recognitionMetadata2 = this.A;
                if (recognitionMetadata2 != null) {
                    this.A = RecognitionMetadata.newBuilder(recognitionMetadata2).d0(recognitionMetadata).I();
                } else {
                    this.A = recognitionMetadata;
                }
                R();
            } else {
        ...
        public b x0(AudioEncoding audioEncoding) {
            Objects.requireNonNull(audioEncoding);
            this.f11862f = audioEncoding.getNumber();
            R();
            return this;
        }
        ...
        private b() {
            this.f11862f = 0;
            this.f11866j = "";
            this.f11867k = y0.f15344d;
            this.f11872p = Collections.emptyList();
            this.C = "";
            g0();
        }
    ...
    public int getSerializedSize() {
        ...
        int i14 = 0;
        for (int i15 = 0; i15 < this.alternativeLanguageCodes_.size(); i15++) {
            i14 += GeneratedMessageV3.computeStringSizeNoTag(this.alternativeLanguageCodes_.c1(i15));
        }
        int size = l10 + i14 + (m202getAlternativeLanguageCodesList().size() * 2);
    ...
    public int hashCode() {
        ...
        if (getAlternativeLanguageCodesCount() > 0) {
            hashCode = (((hashCode * 37) + 18) * 53) + m202getAlternativeLanguageCodesList().hashCode();
        }
        ...
        if (hasDiarizationConfig()) {
            d10 = (((d10 * 37) + 19) * 53) + getDiarizationConfig().hashCode();
        }
        if (hasMetadata()) {
            d10 = (((d10 * 37) + 9) * 53) + getMetadata().hashCode();
        }
        int hashCode2 = (((((((((d10 * 37) + 13) * 53) + getModel().hashCode()) * 37) + 14) * 53) + u0.d(getUseEnhanced())) * 29) + this.unknownFields.hashCode();
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        for (int i13 = 0; i13 < this.alternativeLanguageCodes_.size(); i13++) {
            GeneratedMessageV3.writeString(codedOutputStream, 18, this.alternativeLanguageCodes_.c1(i13));
        }
        if (this.diarizationConfig_ != null) {
    ...
    public i2 m202getAlternativeLanguageCodesList() {
