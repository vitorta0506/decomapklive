...
public final class RecognizeResponse extends GeneratedMessageV3 implements r1 {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        private List<SpeechRecognitionResult> f11896f;

        /* renamed from: g  reason: collision with root package name */
        private l2<SpeechRecognitionResult, SpeechRecognitionResult.b, l> f11897g;

        /* renamed from: h  reason: collision with root package name */
        private Duration f11898h;

        /* renamed from: i  reason: collision with root package name */
        private q2<Duration, Duration.b, v> f11899i;
        ...
        private void a0() {
            if ((this.f11895e & 1) == 0) {
                this.f11896f = new ArrayList(this.f11896f);
                this.f11895e |= 1;
            }
        }
        ...
        private l2<SpeechRecognitionResult, SpeechRecognitionResult.b, l> d0() {
            if (this.f11897g == null) {
                this.f11897g = new l2<>(this.f11896f, (this.f11895e & 1) != 0, H(), O());
                this.f11896f = null;
            }
            return this.f11897g;
        }
        ...
        protected GeneratedMessageV3.e K() {
            return j.f11984v.d(RecognizeResponse.class, b.class);
        }
        ...
        public RecognizeResponse I() {
            ...
            int i9 = this.f11895e;
            l2<SpeechRecognitionResult, SpeechRecognitionResult.b, l> l2Var = this.f11897g;
            if (l2Var == null) {
                if ((i9 & 1) != 0) {
                    this.f11896f = Collections.unmodifiableList(this.f11896f);
                    this.f11895e &= -2;
                }
                recognizeResponse.results_ = this.f11896f;
            } else {
                recognizeResponse.results_ = l2Var.e();
            }
            q2<Duration, Duration.b, v> q2Var = this.f11899i;
            if (q2Var == null) {
                recognizeResponse.totalBilledTime_ = this.f11898h;
            } else {
        ...
        public b g0(RecognizeResponse recognizeResponse) {
            ...
            if (this.f11897g == null) {
                if (!recognizeResponse.results_.isEmpty()) {
                    if (this.f11896f.isEmpty()) {
                        this.f11896f = recognizeResponse.results_;
                        this.f11895e &= -2;
                    } else {
                        a0();
                        this.f11896f.addAll(recognizeResponse.results_);
                    }
                    R();
                }
                ...
                if (this.f11897g.k()) {
                    ...
                    this.f11896f = recognizeResponse.results_;
                    this.f11895e &= -2;
                    this.f11897g = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                } else {
                    this.f11897g.b(recognizeResponse.results_);
                }
            }
        ...
        */
        public com.google.cloud.speech.v1.RecognizeResponse.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = com.google.cloud.speech.v1.RecognizeResponse.access$800()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                com.google.cloud.speech.v1.RecognizeResponse r3 = (com.google.cloud.speech.v1.RecognizeResponse) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.g0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                com.google.cloud.speech.v1.RecognizeResponse r4 = (com.google.cloud.speech.v1.RecognizeResponse) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.cloud.speech.v1.RecognizeResponse.b.u(com.google.protobuf.p, com.google.protobuf.f0):com.google.cloud.speech.v1.RecognizeResponse$b");
        }
        ...
        public b j0(Duration duration) {
            q2<Duration, Duration.b, v> q2Var = this.f11899i;
            if (q2Var == null) {
                Duration duration2 = this.f11898h;
                if (duration2 != null) {
                    this.f11898h = Duration.newBuilder(duration2).e0(duration).I();
                } else {
                    this.f11898h = duration;
                }
                R();
            } else {
                q2Var.e(duration);
