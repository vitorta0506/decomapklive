...
public final class SpeechRecognitionResult extends GeneratedMessageV3 implements l {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements l {
        ...
        private List<SpeechRecognitionAlternative> f11919f;

        /* renamed from: g  reason: collision with root package name */
        private l2<SpeechRecognitionAlternative, SpeechRecognitionAlternative.b, k> f11920g;

        /* renamed from: h  reason: collision with root package name */
        private int f11921h;

        /* renamed from: i  reason: collision with root package name */
        private Duration f11922i;

        /* renamed from: j  reason: collision with root package name */
        private q2<Duration, Duration.b, v> f11923j;

        /* renamed from: k  reason: collision with root package name */
        private Object f11924k;
        ...
        private void a0() {
            if ((this.f11918e & 1) == 0) {
                this.f11919f = new ArrayList(this.f11919f);
                this.f11918e |= 1;
            }
        }
        ...
        private l2<SpeechRecognitionAlternative, SpeechRecognitionAlternative.b, k> b0() {
            if (this.f11920g == null) {
                this.f11920g = new l2<>(this.f11919f, (this.f11918e & 1) != 0, H(), O());
                this.f11919f = null;
            }
            return this.f11920g;
        }
        ...
        public SpeechRecognitionResult I() {
            ...
            int i9 = this.f11918e;
            l2<SpeechRecognitionAlternative, SpeechRecognitionAlternative.b, k> l2Var = this.f11920g;
            if (l2Var == null) {
                if ((i9 & 1) != 0) {
                    this.f11919f = Collections.unmodifiableList(this.f11919f);
                    this.f11918e &= -2;
                }
                speechRecognitionResult.alternatives_ = this.f11919f;
            } else {
                speechRecognitionResult.alternatives_ = l2Var.e();
            }
            speechRecognitionResult.channelTag_ = this.f11921h;
            q2<Duration, Duration.b, v> q2Var = this.f11923j;
            if (q2Var == null) {
                speechRecognitionResult.resultEndTime_ = this.f11922i;
            } else {
                speechRecognitionResult.resultEndTime_ = q2Var.b();
            }
            speechRecognitionResult.languageCode_ = this.f11924k;
            Q();
        ...
        public b g0(SpeechRecognitionResult speechRecognitionResult) {
            ...
            if (this.f11920g == null) {
                if (!speechRecognitionResult.alternatives_.isEmpty()) {
                    if (this.f11919f.isEmpty()) {
                        this.f11919f = speechRecognitionResult.alternatives_;
                        this.f11918e &= -2;
                    } else {
                        a0();
                        this.f11919f.addAll(speechRecognitionResult.alternatives_);
                    }
                    R();
                }
                ...
                if (this.f11920g.k()) {
                    ...
                    this.f11919f = speechRecognitionResult.alternatives_;
                    this.f11918e &= -2;
                    this.f11920g = GeneratedMessageV3.alwaysUseFieldBuilders ? b0() : null;
                } else {
                    this.f11920g.b(speechRecognitionResult.alternatives_);
                }
            }
            ...
            if (!speechRecognitionResult.getLanguageCode().isEmpty()) {
                this.f11924k = speechRecognitionResult.languageCode_;
                R();
            }
        ...
        */
        public com.google.cloud.speech.v1.SpeechRecognitionResult.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = com.google.cloud.speech.v1.SpeechRecognitionResult.access$1000()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                com.google.cloud.speech.v1.SpeechRecognitionResult r3 = (com.google.cloud.speech.v1.SpeechRecognitionResult) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.g0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                com.google.cloud.speech.v1.SpeechRecognitionResult r4 = (com.google.cloud.speech.v1.SpeechRecognitionResult) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.cloud.speech.v1.SpeechRecognitionResult.b.u(com.google.protobuf.p, com.google.protobuf.f0):com.google.cloud.speech.v1.SpeechRecognitionResult$b");
        }
        ...
        public b j0(Duration duration) {
            q2<Duration, Duration.b, v> q2Var = this.f11923j;
            if (q2Var == null) {
                Duration duration2 = this.f11922i;
                if (duration2 != null) {
                    this.f11922i = Duration.newBuilder(duration2).e0(duration).I();
                } else {
                    this.f11922i = duration;
                }
                R();
            } else {
                q2Var.e(duration);
        ...
        private b() {
            this.f11919f = Collections.emptyList();
            this.f11924k = "";
            e0();
        }
