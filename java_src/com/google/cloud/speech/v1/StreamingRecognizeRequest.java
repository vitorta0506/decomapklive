...
public final class StreamingRecognizeRequest extends GeneratedMessageV3 implements r1 {
    ...
    public static /* synthetic */ class b {
        ...
        static {
            ...
            try {
                f11938a[StreamingRequestCase.AUDIO_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f11938a[StreamingRequestCase.STREAMINGREQUEST_NOT_SET.ordinal()] = 3;
    ...
    public static final class c extends GeneratedMessageV3.b<c> implements r1 {
        ...
        private q2<StreamingRecognitionConfig, StreamingRecognitionConfig.b, o> f11941g;
        ...
        protected GeneratedMessageV3.e K() {
            return j.f11970h.d(StreamingRecognizeRequest.class, c.class);
        }
        ...
        public StreamingRecognizeRequest I() {
            ...
            if (this.f11939e == 1) {
                q2<StreamingRecognitionConfig, StreamingRecognitionConfig.b, o> q2Var = this.f11941g;
                if (q2Var == null) {
                    streamingRecognizeRequest.streamingRequest_ = this.f11940f;
                } else {
            ...
            streamingRecognizeRequest.streamingRequestCase_ = this.f11939e;
            Q();
        ...
        public c d0(StreamingRecognizeRequest streamingRecognizeRequest) {
            ...
            int i9 = b.f11938a[streamingRecognizeRequest.getStreamingRequestCase().ordinal()];
            if (i9 == 1) {
        ...
        */
        public com.google.cloud.speech.v1.StreamingRecognizeRequest.c u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = com.google.cloud.speech.v1.StreamingRecognizeRequest.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.cloud.speech.v1.StreamingRecognizeRequest.c.u(com.google.protobuf.p, com.google.protobuf.f0):com.google.cloud.speech.v1.StreamingRecognizeRequest$c");
        }
        ...
        public c h0(StreamingRecognitionConfig streamingRecognitionConfig) {
            q2<StreamingRecognitionConfig, StreamingRecognitionConfig.b, o> q2Var = this.f11941g;
            if (q2Var == null) {
                if (this.f11939e == 1 && this.f11940f != StreamingRecognitionConfig.getDefaultInstance()) {
                    this.f11940f = StreamingRecognitionConfig.newBuilder((StreamingRecognitionConfig) this.f11940f).e0(streamingRecognitionConfig).I();
                } else {
                    this.f11940f = streamingRecognitionConfig;
                }
                R();
            } else {
                if (this.f11939e == 1) {
                ...
                this.f11941g.g(streamingRecognitionConfig);
            }
            this.f11939e = 1;
            return this;
        }
        ...
        public c l0(StreamingRecognitionConfig streamingRecognitionConfig) {
            q2<StreamingRecognitionConfig, StreamingRecognitionConfig.b, o> q2Var = this.f11941g;
            if (q2Var == null) {
                ...
                q2Var.g(streamingRecognitionConfig);
            }
            this.f11939e = 1;
            return this;
        }
    ...
    public o getStreamingConfigOrBuilder() {
        if (this.streamingRequestCase_ == 1) {
            return (StreamingRecognitionConfig) this.streamingRequest_;
        }
        return StreamingRecognitionConfig.getDefaultInstance();
