...
public final class StreamingRecognitionResult extends GeneratedMessageV3 implements p {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements p {
        ...
        private List<SpeechRecognitionAlternative> f11930f;

        /* renamed from: g  reason: collision with root package name */
        private l2<SpeechRecognitionAlternative, SpeechRecognitionAlternative.b, k> f11931g;
        ...
        private Duration f11934j;

        /* renamed from: k  reason: collision with root package name */
        private q2<Duration, Duration.b, v> f11935k;

        /* renamed from: l  reason: collision with root package name */
        private int f11936l;

        /* renamed from: m  reason: collision with root package name */
        private Object f11937m;
        ...
        private void a0() {
            if ((this.f11929e & 1) == 0) {
                this.f11930f = new ArrayList(this.f11930f);
                this.f11929e |= 1;
            }
        }
        ...
        private l2<SpeechRecognitionAlternative, SpeechRecognitionAlternative.b, k> b0() {
            if (this.f11931g == null) {
                this.f11931g = new l2<>(this.f11930f, (this.f11929e & 1) != 0, H(), O());
                this.f11930f = null;
            }
            return this.f11931g;
        }
        ...
        public StreamingRecognitionResult I() {
            ...
            int i9 = this.f11929e;
            l2<SpeechRecognitionAlternative, SpeechRecognitionAlternative.b, k> l2Var = this.f11931g;
            if (l2Var == null) {
                if ((i9 & 1) != 0) {
                    this.f11930f = Collections.unmodifiableList(this.f11930f);
                    this.f11929e &= -2;
                }
                streamingRecognitionResult.alternatives_ = this.f11930f;
            } else {
                streamingRecognitionResult.alternatives_ = l2Var.e();
            }
            streamingRecognitionResult.isFinal_ = this.f11932h;
            streamingRecognitionResult.stability_ = this.f11933i;
            q2<Duration, Duration.b, v> q2Var = this.f11935k;
            if (q2Var == null) {
                streamingRecognitionResult.resultEndTime_ = this.f11934j;
            } else {
                streamingRecognitionResult.resultEndTime_ = q2Var.b();
            }
            streamingRecognitionResult.channelTag_ = this.f11936l;
            streamingRecognitionResult.languageCode_ = this.f11937m;
            Q();
        ...
        public b g0(StreamingRecognitionResult streamingRecognitionResult) {
            ...
            if (this.f11931g == null) {
                if (!streamingRecognitionResult.alternatives_.isEmpty()) {
                    if (this.f11930f.isEmpty()) {
                        this.f11930f = streamingRecognitionResult.alternatives_;
                        this.f11929e &= -2;
                    } else {
                        a0();
                        this.f11930f.addAll(streamingRecognitionResult.alternatives_);
                    }
                    R();
                }
                ...
                if (this.f11931g.k()) {
                    ...
                    this.f11930f = streamingRecognitionResult.alternatives_;
                    this.f11929e &= -2;
                    this.f11931g = GeneratedMessageV3.alwaysUseFieldBuilders ? b0() : null;
                } else {
                    this.f11931g.b(streamingRecognitionResult.alternatives_);
                }
            }
            ...
            if (!streamingRecognitionResult.getLanguageCode().isEmpty()) {
                this.f11937m = streamingRecognitionResult.languageCode_;
                R();
            }
        ...
        */
        public com.google.cloud.speech.v1.StreamingRecognitionResult.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = com.google.cloud.speech.v1.StreamingRecognitionResult.access$1200()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.cloud.speech.v1.StreamingRecognitionResult.b.u(com.google.protobuf.p, com.google.protobuf.f0):com.google.cloud.speech.v1.StreamingRecognitionResult$b");
        }
        ...
        public b j0(Duration duration) {
            q2<Duration, Duration.b, v> q2Var = this.f11935k;
            if (q2Var == null) {
                Duration duration2 = this.f11934j;
                if (duration2 != null) {
                    this.f11934j = Duration.newBuilder(duration2).e0(duration).I();
                } else {
                    this.f11934j = duration;
                }
                R();
            } else {
                q2Var.e(duration);
