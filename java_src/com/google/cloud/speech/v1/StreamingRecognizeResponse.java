...
public final class StreamingRecognizeResponse extends GeneratedMessageV3 implements r1 {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        private Status f11943f;

        /* renamed from: g  reason: collision with root package name */
        private q2<Status, Status.b, com.google.rpc.c> f11944g;

        /* renamed from: h  reason: collision with root package name */
        private List<StreamingRecognitionResult> f11945h;

        /* renamed from: i  reason: collision with root package name */
        private l2<StreamingRecognitionResult, StreamingRecognitionResult.b, p> f11946i;

        /* renamed from: j  reason: collision with root package name */
        private int f11947j;

        /* renamed from: k  reason: collision with root package name */
        private Duration f11948k;

        /* renamed from: l  reason: collision with root package name */
        private q2<Duration, Duration.b, v> f11949l;
        ...
        private void a0() {
            if ((this.f11942e & 1) == 0) {
                this.f11945h = new ArrayList(this.f11945h);
                this.f11942e |= 1;
            }
        }

        private l2<StreamingRecognitionResult, StreamingRecognitionResult.b, p> d0() {
            if (this.f11946i == null) {
                this.f11946i = new l2<>(this.f11945h, (this.f11942e & 1) != 0, H(), O());
                this.f11945h = null;
            }
            return this.f11946i;
        }
        ...
        public StreamingRecognizeResponse I() {
            ...
            q2<Status, Status.b, com.google.rpc.c> q2Var = this.f11944g;
            if (q2Var == null) {
                streamingRecognizeResponse.error_ = this.f11943f;
            } else {
                streamingRecognizeResponse.error_ = q2Var.b();
            }
            l2<StreamingRecognitionResult, StreamingRecognitionResult.b, p> l2Var = this.f11946i;
            if (l2Var == null) {
                if ((this.f11942e & 1) != 0) {
                    this.f11945h = Collections.unmodifiableList(this.f11945h);
                    this.f11942e &= -2;
                }
                streamingRecognizeResponse.results_ = this.f11945h;
            } else {
                streamingRecognizeResponse.results_ = l2Var.e();
            }
            streamingRecognizeResponse.speechEventType_ = this.f11947j;
            q2<Duration, Duration.b, v> q2Var2 = this.f11949l;
            if (q2Var2 == null) {
                streamingRecognizeResponse.totalBilledTime_ = this.f11948k;
            } else {
        ...
        public b g0(Status status) {
            q2<Status, Status.b, com.google.rpc.c> q2Var = this.f11944g;
            if (q2Var == null) {
                Status status2 = this.f11943f;
                if (status2 != null) {
                    this.f11943f = Status.newBuilder(status2).i0(status).I();
                } else {
                    this.f11943f = status;
                }
                R();
        ...
        public b h0(StreamingRecognizeResponse streamingRecognizeResponse) {
            ...
            if (this.f11946i == null) {
                if (!streamingRecognizeResponse.results_.isEmpty()) {
                    if (this.f11945h.isEmpty()) {
                        this.f11945h = streamingRecognizeResponse.results_;
                        this.f11942e &= -2;
                    } else {
                        a0();
                        this.f11945h.addAll(streamingRecognizeResponse.results_);
                    }
                    R();
                }
                ...
                if (this.f11946i.k()) {
                    ...
                    this.f11945h = streamingRecognizeResponse.results_;
                    this.f11942e &= -2;
                    this.f11946i = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                } else {
                    this.f11946i.b(streamingRecognizeResponse.results_);
                }
            }
        ...
        */
        public com.google.cloud.speech.v1.StreamingRecognizeResponse.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = com.google.cloud.speech.v1.StreamingRecognizeResponse.access$1000()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.cloud.speech.v1.StreamingRecognizeResponse.b.u(com.google.protobuf.p, com.google.protobuf.f0):com.google.cloud.speech.v1.StreamingRecognizeResponse$b");
        }
        ...
        public b k0(Duration duration) {
            q2<Duration, Duration.b, v> q2Var = this.f11949l;
            if (q2Var == null) {
                Duration duration2 = this.f11948k;
                if (duration2 != null) {
                    this.f11948k = Duration.newBuilder(duration2).e0(duration).I();
                } else {
                    this.f11948k = duration;
                }
                R();
            } else {
                q2Var.e(duration);
        ...
        private b() {
            this.f11945h = Collections.emptyList();
            this.f11947j = 0;
            e0();
        }
    ...
    public p getResultsOrBuilder(int i9) {
        return this.results_.get(i9);
    }

    public List<? extends p> getResultsOrBuilderList() {
        return this.results_;
    }
