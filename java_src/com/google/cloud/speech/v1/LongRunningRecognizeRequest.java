...
public final class LongRunningRecognizeRequest extends GeneratedMessageV3 implements r1 {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        private RecognitionConfig f11836e;

        /* renamed from: f  reason: collision with root package name */
        private q2<RecognitionConfig, RecognitionConfig.b, d> f11837f;

        /* renamed from: g  reason: collision with root package name */
        private RecognitionAudio f11838g;

        /* renamed from: h  reason: collision with root package name */
        private q2<RecognitionAudio, RecognitionAudio.c, c> f11839h;

        /* renamed from: i  reason: collision with root package name */
        private TranscriptOutputConfig f11840i;

        /* renamed from: j  reason: collision with root package name */
        private q2<TranscriptOutputConfig, TranscriptOutputConfig.c, q> f11841j;
        ...
        protected GeneratedMessageV3.e K() {
            return j.f11966d.d(LongRunningRecognizeRequest.class, b.class);
        }
        ...
        public LongRunningRecognizeRequest I() {
            ...
            q2<RecognitionConfig, RecognitionConfig.b, d> q2Var = this.f11837f;
            if (q2Var == null) {
                longRunningRecognizeRequest.config_ = this.f11836e;
            } else {
                longRunningRecognizeRequest.config_ = q2Var.b();
            }
            q2<RecognitionAudio, RecognitionAudio.c, c> q2Var2 = this.f11839h;
            if (q2Var2 == null) {
                longRunningRecognizeRequest.audio_ = this.f11838g;
            } else {
                longRunningRecognizeRequest.audio_ = q2Var2.b();
            }
            q2<TranscriptOutputConfig, TranscriptOutputConfig.c, q> q2Var3 = this.f11841j;
            if (q2Var3 == null) {
                longRunningRecognizeRequest.outputConfig_ = this.f11840i;
            } else {
        ...
        public b d0(RecognitionAudio recognitionAudio) {
            q2<RecognitionAudio, RecognitionAudio.c, c> q2Var = this.f11839h;
            if (q2Var == null) {
                RecognitionAudio recognitionAudio2 = this.f11838g;
                if (recognitionAudio2 != null) {
                    this.f11838g = RecognitionAudio.newBuilder(recognitionAudio2).d0(recognitionAudio).I();
                } else {
                    this.f11838g = recognitionAudio;
                }
                R();
            } else {
        ...
        public b e0(RecognitionConfig recognitionConfig) {
            q2<RecognitionConfig, RecognitionConfig.b, d> q2Var = this.f11837f;
            if (q2Var == null) {
                RecognitionConfig recognitionConfig2 = this.f11836e;
                if (recognitionConfig2 != null) {
                    this.f11836e = RecognitionConfig.newBuilder(recognitionConfig2).l0(recognitionConfig).I();
                } else {
                    this.f11836e = recognitionConfig;
                }
                R();
            } else {
        ...
        */
        public com.google.cloud.speech.v1.LongRunningRecognizeRequest.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = com.google.cloud.speech.v1.LongRunningRecognizeRequest.access$800()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                com.google.cloud.speech.v1.LongRunningRecognizeRequest r3 = (com.google.cloud.speech.v1.LongRunningRecognizeRequest) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.g0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                com.google.cloud.speech.v1.LongRunningRecognizeRequest r4 = (com.google.cloud.speech.v1.LongRunningRecognizeRequest) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.cloud.speech.v1.LongRunningRecognizeRequest.b.u(com.google.protobuf.p, com.google.protobuf.f0):com.google.cloud.speech.v1.LongRunningRecognizeRequest$b");
        }
        ...
        public b j0(TranscriptOutputConfig transcriptOutputConfig) {
            q2<TranscriptOutputConfig, TranscriptOutputConfig.c, q> q2Var = this.f11841j;
            if (q2Var == null) {
                TranscriptOutputConfig transcriptOutputConfig2 = this.f11840i;
                if (transcriptOutputConfig2 != null) {
                    this.f11840i = TranscriptOutputConfig.newBuilder(transcriptOutputConfig2).d0(transcriptOutputConfig).I();
                } else {
                    this.f11840i = transcriptOutputConfig;
                }
                R();
            } else {
