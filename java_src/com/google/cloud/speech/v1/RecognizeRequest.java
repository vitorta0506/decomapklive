...
public final class RecognizeRequest extends GeneratedMessageV3 implements r1 {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        private RecognitionConfig f11891e;

        /* renamed from: f  reason: collision with root package name */
        private q2<RecognitionConfig, RecognitionConfig.b, d> f11892f;

        /* renamed from: g  reason: collision with root package name */
        private RecognitionAudio f11893g;

        /* renamed from: h  reason: collision with root package name */
        private q2<RecognitionAudio, RecognitionAudio.c, c> f11894h;
        ...
        protected GeneratedMessageV3.e K() {
            return j.f11964b.d(RecognizeRequest.class, b.class);
        }
        ...
        public RecognizeRequest I() {
            ...
            q2<RecognitionConfig, RecognitionConfig.b, d> q2Var = this.f11892f;
            if (q2Var == null) {
                recognizeRequest.config_ = this.f11891e;
            } else {
                recognizeRequest.config_ = q2Var.b();
            }
            q2<RecognitionAudio, RecognitionAudio.c, c> q2Var2 = this.f11894h;
            if (q2Var2 == null) {
                recognizeRequest.audio_ = this.f11893g;
            } else {
        ...
        public b d0(RecognitionAudio recognitionAudio) {
            q2<RecognitionAudio, RecognitionAudio.c, c> q2Var = this.f11894h;
            if (q2Var == null) {
                RecognitionAudio recognitionAudio2 = this.f11893g;
                if (recognitionAudio2 != null) {
                    this.f11893g = RecognitionAudio.newBuilder(recognitionAudio2).d0(recognitionAudio).I();
                } else {
                    this.f11893g = recognitionAudio;
                }
                R();
            } else {
        ...
        public b e0(RecognitionConfig recognitionConfig) {
            q2<RecognitionConfig, RecognitionConfig.b, d> q2Var = this.f11892f;
            if (q2Var == null) {
                RecognitionConfig recognitionConfig2 = this.f11891e;
                if (recognitionConfig2 != null) {
                    this.f11891e = RecognitionConfig.newBuilder(recognitionConfig2).l0(recognitionConfig).I();
                } else {
                    this.f11891e = recognitionConfig;
                }
                R();
            } else {
        ...
        */
        public com.google.cloud.speech.v1.RecognizeRequest.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = com.google.cloud.speech.v1.RecognizeRequest.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.cloud.speech.v1.RecognizeRequest.b.u(com.google.protobuf.p, com.google.protobuf.f0):com.google.cloud.speech.v1.RecognizeRequest$b");
        }
