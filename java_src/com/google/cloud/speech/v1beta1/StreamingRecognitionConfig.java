...
public final class StreamingRecognitionConfig extends GeneratedMessageV3 implements g {
    ...
    public static class a extends com.google.protobuf.c<StreamingRecognitionConfig> {
        ...
        /* renamed from: G */
        public StreamingRecognitionConfig m(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements g {
        ...
        private RecognitionConfig f12029e;

        /* renamed from: f  reason: collision with root package name */
        private q2<RecognitionConfig, RecognitionConfig.b, com.google.cloud.speech.v1beta1.b> f12030f;
        ...
        protected GeneratedMessageV3.e K() {
            return d.f12063h.d(StreamingRecognitionConfig.class, b.class);
        }
        ...
        public StreamingRecognitionConfig I() {
            ...
            q2<RecognitionConfig, RecognitionConfig.b, com.google.cloud.speech.v1beta1.b> q2Var = this.f12030f;
            if (q2Var == null) {
                streamingRecognitionConfig.config_ = this.f12029e;
            } else {
                streamingRecognitionConfig.config_ = q2Var.b();
            }
            streamingRecognitionConfig.singleUtterance_ = this.f12031g;
            streamingRecognitionConfig.interimResults_ = this.f12032h;
            Q();
        ...
        public b d0(RecognitionConfig recognitionConfig) {
            q2<RecognitionConfig, RecognitionConfig.b, com.google.cloud.speech.v1beta1.b> q2Var = this.f12030f;
            if (q2Var == null) {
                RecognitionConfig recognitionConfig2 = this.f12029e;
                if (recognitionConfig2 != null) {
                    this.f12029e = RecognitionConfig.newBuilder(recognitionConfig2).d0(recognitionConfig).I();
                } else {
                    this.f12029e = recognitionConfig;
                }
                R();
            } else {
        ...
        */
        public com.google.cloud.speech.v1beta1.StreamingRecognitionConfig.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = com.google.cloud.speech.v1beta1.StreamingRecognitionConfig.access$800()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.cloud.speech.v1beta1.StreamingRecognitionConfig.b.u(com.google.protobuf.p, com.google.protobuf.f0):com.google.cloud.speech.v1beta1.StreamingRecognitionConfig$b");
        }
    ...
    /* synthetic */ StreamingRecognitionConfig(p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
    ...
    public boolean equals(Object obj) {
        ...
        boolean z10 = hasConfig() == streamingRecognitionConfig.hasConfig();
        if (hasConfig()) {
            z10 = z10 && getConfig().equals(streamingRecognitionConfig.getConfig());
        }
        return ((z10 && getSingleUtterance() == streamingRecognitionConfig.getSingleUtterance()) && getInterimResults() == streamingRecognitionConfig.getInterimResults()) && this.unknownFields.equals(streamingRecognitionConfig.unknownFields);
    }
    ...
    private StreamingRecognitionConfig(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
    ...
    public static StreamingRecognitionConfig parseFrom(p pVar) throws IOException {
        return (StreamingRecognitionConfig) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
    }

    public static StreamingRecognitionConfig parseFrom(p pVar, f0 f0Var) throws IOException {
