...
public final class RecognitionMetadata extends GeneratedMessageV3 implements e {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements e {
        ...
        private Object f12174j;

        /* renamed from: k  reason: collision with root package name */
        private Object f12175k;

        /* renamed from: l  reason: collision with root package name */
        private long f12176l;

        /* renamed from: m  reason: collision with root package name */
        private Object f12177m;
        ...
        protected GeneratedMessageV3.e K() {
            return j.f12301p.d(RecognitionMetadata.class, b.class);
        }
        ...
        public RecognitionMetadata I() {
            ...
            recognitionMetadata.interactionType_ = this.f12169e;
            recognitionMetadata.industryNaicsCodeOfAudio_ = this.f12170f;
            recognitionMetadata.microphoneDistance_ = this.f12171g;
            recognitionMetadata.originalMediaType_ = this.f12172h;
            recognitionMetadata.recordingDeviceType_ = this.f12173i;
            recognitionMetadata.recordingDeviceName_ = this.f12174j;
            recognitionMetadata.originalMimeType_ = this.f12175k;
            recognitionMetadata.obfuscatedId_ = this.f12176l;
            recognitionMetadata.audioTopic_ = this.f12177m;
            Q();
        ...
        public b d0(RecognitionMetadata recognitionMetadata) {
            ...
            if (recognitionMetadata.originalMediaType_ != 0) {
                n0(recognitionMetadata.getOriginalMediaTypeValue());
            }
            if (recognitionMetadata.recordingDeviceType_ != 0) {
                o0(recognitionMetadata.getRecordingDeviceTypeValue());
            }
            if (!recognitionMetadata.getRecordingDeviceName().isEmpty()) {
                this.f12174j = recognitionMetadata.recordingDeviceName_;
                R();
            }
            if (!recognitionMetadata.getOriginalMimeType().isEmpty()) {
                this.f12175k = recognitionMetadata.originalMimeType_;
                R();
            }
            if (recognitionMetadata.getObfuscatedId() != 0) {
                m0(recognitionMetadata.getObfuscatedId());
            }
            if (!recognitionMetadata.getAudioTopic().isEmpty()) {
                this.f12177m = recognitionMetadata.audioTopic_;
                R();
            }
        ...
        */
        public com.google.cloud.speech.v1p1beta1.RecognitionMetadata.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = com.google.cloud.speech.v1p1beta1.RecognitionMetadata.access$1400()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                com.google.cloud.speech.v1p1beta1.RecognitionMetadata r3 = (com.google.cloud.speech.v1p1beta1.RecognitionMetadata) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.d0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                com.google.cloud.speech.v1p1beta1.RecognitionMetadata r4 = (com.google.cloud.speech.v1p1beta1.RecognitionMetadata) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.cloud.speech.v1p1beta1.RecognitionMetadata.b.u(com.google.protobuf.p, com.google.protobuf.f0):com.google.cloud.speech.v1p1beta1.RecognitionMetadata$b");
        }
    ...
    public int getSerializedSize() {
        ...
        long j10 = this.obfuscatedId_;
        if (j10 != 0) {
            l10 += CodedOutputStream.z(9, j10);
        }
    ...
    public int hashCode() {
        ...
        int hashCode = ((((((((((((((((((((((((((((((((((((((779 + getDescriptor().hashCode()) * 37) + 1) * 53) + this.interactionType_) * 37) + 3) * 53) + getIndustryNaicsCodeOfAudio()) * 37) + 4) * 53) + this.microphoneDistance_) * 37) + 5) * 53) + this.originalMediaType_) * 37) + 6) * 53) + this.recordingDeviceType_) * 37) + 7) * 53) + getRecordingDeviceName().hashCode()) * 37) + 8) * 53) + getOriginalMimeType().hashCode()) * 37) + 9) * 53) + u0.i(getObfuscatedId())) * 37) + 10) * 53) + getAudioTopic().hashCode()) * 29) + this.unknownFields.hashCode();
