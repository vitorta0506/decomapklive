...
public final class SpeechRecognitionAlternative extends GeneratedMessageV3 implements k {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements k {
        ...
        private List<WordInfo> f12203h;

        /* renamed from: i  reason: collision with root package name */
        private l2<WordInfo, WordInfo.b, r> f12204i;
        ...
        private void a0() {
            if ((this.f12200e & 1) == 0) {
                this.f12203h = new ArrayList(this.f12203h);
                this.f12200e |= 1;
            }
        }
        ...
        private l2<WordInfo, WordInfo.b, r> d0() {
            if (this.f12204i == null) {
                this.f12204i = new l2<>(this.f12203h, (this.f12200e & 1) != 0, H(), O());
                this.f12203h = null;
            }
            return this.f12204i;
        }
        ...
        public SpeechRecognitionAlternative I() {
            ...
            speechRecognitionAlternative.transcript_ = this.f12201f;
            speechRecognitionAlternative.confidence_ = this.f12202g;
            l2<WordInfo, WordInfo.b, r> l2Var = this.f12204i;
            if (l2Var == null) {
                if ((this.f12200e & 1) != 0) {
                    this.f12203h = Collections.unmodifiableList(this.f12203h);
                    this.f12200e &= -2;
                }
                speechRecognitionAlternative.words_ = this.f12203h;
            } else {
        ...
        public b g0(SpeechRecognitionAlternative speechRecognitionAlternative) {
            ...
            if (!speechRecognitionAlternative.getTranscript().isEmpty()) {
                this.f12201f = speechRecognitionAlternative.transcript_;
                R();
            }
            ...
            if (this.f12204i == null) {
                if (!speechRecognitionAlternative.words_.isEmpty()) {
                    if (this.f12203h.isEmpty()) {
                        this.f12203h = speechRecognitionAlternative.words_;
                        this.f12200e &= -2;
                    } else {
                        a0();
                        this.f12203h.addAll(speechRecognitionAlternative.words_);
                    }
                    R();
                }
                ...
                if (this.f12204i.k()) {
                    ...
                    this.f12203h = speechRecognitionAlternative.words_;
                    this.f12200e &= -2;
                    this.f12204i = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                } else {
                    this.f12204i.b(speechRecognitionAlternative.words_);
                }
            }
        ...
        */
        public com.google.cloud.speech.v1p1beta1.SpeechRecognitionAlternative.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = com.google.cloud.speech.v1p1beta1.SpeechRecognitionAlternative.access$900()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                com.google.cloud.speech.v1p1beta1.SpeechRecognitionAlternative r3 = (com.google.cloud.speech.v1p1beta1.SpeechRecognitionAlternative) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.g0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                com.google.cloud.speech.v1p1beta1.SpeechRecognitionAlternative r4 = (com.google.cloud.speech.v1p1beta1.SpeechRecognitionAlternative) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.cloud.speech.v1p1beta1.SpeechRecognitionAlternative.b.u(com.google.protobuf.p, com.google.protobuf.f0):com.google.cloud.speech.v1p1beta1.SpeechRecognitionAlternative$b");
        }
        ...
        private b() {
            this.f12201f = "";
            this.f12203h = Collections.emptyList();
            e0();
        }
