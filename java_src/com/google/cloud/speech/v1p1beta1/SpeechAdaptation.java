...
public final class SpeechAdaptation extends GeneratedMessageV3 implements g {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements g {
        ...
        private List<PhraseSet> f12192f;

        /* renamed from: g  reason: collision with root package name */
        private l2<PhraseSet, PhraseSet.b, com.google.cloud.speech.v1p1beta1.b> f12193g;

        /* renamed from: h  reason: collision with root package name */
        private z0 f12194h;

        /* renamed from: i  reason: collision with root package name */
        private List<CustomClass> f12195i;

        /* renamed from: j  reason: collision with root package name */
        private l2<CustomClass, CustomClass.b, com.google.cloud.speech.v1p1beta1.a> f12196j;
        ...
        private void a0() {
            if ((this.f12191e & 4) == 0) {
                this.f12195i = new ArrayList(this.f12195i);
                this.f12191e |= 4;
            }
        }
        ...
        private void b0() {
            if ((this.f12191e & 2) == 0) {
                this.f12194h = new y0(this.f12194h);
                this.f12191e |= 2;
            }
        }
        ...
        private void d0() {
            if ((this.f12191e & 1) == 0) {
                this.f12192f = new ArrayList(this.f12192f);
                this.f12191e |= 1;
            }
        }

        private l2<CustomClass, CustomClass.b, com.google.cloud.speech.v1p1beta1.a> e0() {
            if (this.f12196j == null) {
                this.f12196j = new l2<>(this.f12195i, (this.f12191e & 4) != 0, H(), O());
                this.f12195i = null;
            }
            return this.f12196j;
        }

        private l2<PhraseSet, PhraseSet.b, com.google.cloud.speech.v1p1beta1.b> h0() {
            if (this.f12193g == null) {
                this.f12193g = new l2<>(this.f12192f, (this.f12191e & 1) != 0, H(), O());
                this.f12192f = null;
            }
            return this.f12193g;
        }
        ...
        protected GeneratedMessageV3.e K() {
            return m.f12321j.d(SpeechAdaptation.class, b.class);
        }
        ...
        public SpeechAdaptation I() {
            ...
            int i9 = this.f12191e;
            l2<PhraseSet, PhraseSet.b, com.google.cloud.speech.v1p1beta1.b> l2Var = this.f12193g;
            if (l2Var == null) {
                if ((i9 & 1) != 0) {
                    this.f12192f = Collections.unmodifiableList(this.f12192f);
                    this.f12191e &= -2;
                }
                speechAdaptation.phraseSets_ = this.f12192f;
            } else {
                speechAdaptation.phraseSets_ = l2Var.e();
            }
            if ((this.f12191e & 2) != 0) {
                this.f12194h = this.f12194h.V0();
                this.f12191e &= -3;
            }
            speechAdaptation.phraseSetReferences_ = this.f12194h;
            l2<CustomClass, CustomClass.b, com.google.cloud.speech.v1p1beta1.a> l2Var2 = this.f12196j;
            if (l2Var2 == null) {
                if ((this.f12191e & 4) != 0) {
                    this.f12195i = Collections.unmodifiableList(this.f12195i);
                    this.f12191e &= -5;
                }
                speechAdaptation.customClasses_ = this.f12195i;
            } else {
            ...
            if (this.f12193g == null) {
                if (!speechAdaptation.phraseSets_.isEmpty()) {
                    if (this.f12192f.isEmpty()) {
                        this.f12192f = speechAdaptation.phraseSets_;
                        this.f12191e &= -2;
                    } else {
                        d0();
                        this.f12192f.addAll(speechAdaptation.phraseSets_);
                    }
                    R();
                }
                ...
                if (this.f12193g.k()) {
                    ...
                    this.f12192f = speechAdaptation.phraseSets_;
                    this.f12191e &= -2;
                    this.f12193g = GeneratedMessageV3.alwaysUseFieldBuilders ? h0() : null;
                } else {
                    this.f12193g.b(speechAdaptation.phraseSets_);
                }
            }
            if (!speechAdaptation.phraseSetReferences_.isEmpty()) {
                if (this.f12194h.isEmpty()) {
                    this.f12194h = speechAdaptation.phraseSetReferences_;
                    this.f12191e &= -3;
                } else {
                    b0();
                    this.f12194h.addAll(speechAdaptation.phraseSetReferences_);
                }
                R();
            }
            if (this.f12196j == null) {
                if (!speechAdaptation.customClasses_.isEmpty()) {
                    if (this.f12195i.isEmpty()) {
                        this.f12195i = speechAdaptation.customClasses_;
                        this.f12191e &= -5;
                    } else {
                        a0();
                        this.f12195i.addAll(speechAdaptation.customClasses_);
                    }
                    R();
                }
                ...
                if (this.f12196j.k()) {
                    ...
                    this.f12195i = speechAdaptation.customClasses_;
                    this.f12191e &= -5;
                    this.f12196j = GeneratedMessageV3.alwaysUseFieldBuilders ? e0() : null;
                } else {
                    this.f12196j.b(speechAdaptation.customClasses_);
                }
            }
        ...
        */
        public com.google.cloud.speech.v1p1beta1.SpeechAdaptation.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = com.google.cloud.speech.v1p1beta1.SpeechAdaptation.access$1000()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                com.google.cloud.speech.v1p1beta1.SpeechAdaptation r3 = (com.google.cloud.speech.v1p1beta1.SpeechAdaptation) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.j0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                com.google.cloud.speech.v1p1beta1.SpeechAdaptation r4 = (com.google.cloud.speech.v1p1beta1.SpeechAdaptation) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.cloud.speech.v1p1beta1.SpeechAdaptation.b.u(com.google.protobuf.p, com.google.protobuf.f0):com.google.cloud.speech.v1p1beta1.SpeechAdaptation$b");
        }
        ...
        private b() {
            ...
            this.f12194h = y0.f15344d;
            this.f12195i = Collections.emptyList();
            i0();
        }
    ...
    public boolean equals(Object obj) {
        ...
        return getPhraseSetsList().equals(speechAdaptation.getPhraseSetsList()) && m207getPhraseSetReferencesList().equals(speechAdaptation.m207getPhraseSetReferencesList()) && getCustomClassesList().equals(speechAdaptation.getCustomClassesList()) && this.unknownFields.equals(speechAdaptation.unknownFields);
    }
    ...
    public int getSerializedSize() {
        ...
        int size = i10 + i12 + (m207getPhraseSetReferencesList().size() * 1);
    ...
    public int hashCode() {
        ...
        if (getPhraseSetReferencesCount() > 0) {
            hashCode = (((hashCode * 37) + 2) * 53) + m207getPhraseSetReferencesList().hashCode();
        }
    ...
    public i2 m207getPhraseSetReferencesList() {
