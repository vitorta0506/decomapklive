...
public final class LongRunningRecognizeMetadata extends GeneratedMessageV3 implements r1 {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        private Timestamp f12115f;

        /* renamed from: g  reason: collision with root package name */
        private q2<Timestamp, Timestamp.b, z2> f12116g;

        /* renamed from: h  reason: collision with root package name */
        private Timestamp f12117h;

        /* renamed from: i  reason: collision with root package name */
        private q2<Timestamp, Timestamp.b, z2> f12118i;

        /* renamed from: j  reason: collision with root package name */
        private Object f12119j;

        /* renamed from: k  reason: collision with root package name */
        private TranscriptOutputConfig f12120k;

        /* renamed from: l  reason: collision with root package name */
        private q2<TranscriptOutputConfig, TranscriptOutputConfig.c, q> f12121l;
        ...
        protected GeneratedMessageV3.e K() {
            return j.f12311z.d(LongRunningRecognizeMetadata.class, b.class);
        }
        ...
        public LongRunningRecognizeMetadata I() {
            ...
            longRunningRecognizeMetadata.progressPercent_ = this.f12114e;
            q2<Timestamp, Timestamp.b, z2> q2Var = this.f12116g;
            if (q2Var == null) {
                longRunningRecognizeMetadata.startTime_ = this.f12115f;
            } else {
                longRunningRecognizeMetadata.startTime_ = q2Var.b();
            }
            q2<Timestamp, Timestamp.b, z2> q2Var2 = this.f12118i;
            if (q2Var2 == null) {
                longRunningRecognizeMetadata.lastUpdateTime_ = this.f12117h;
            } else {
                longRunningRecognizeMetadata.lastUpdateTime_ = q2Var2.b();
            }
            longRunningRecognizeMetadata.uri_ = this.f12119j;
            q2<TranscriptOutputConfig, TranscriptOutputConfig.c, q> q2Var3 = this.f12121l;
            if (q2Var3 == null) {
                longRunningRecognizeMetadata.outputConfig_ = this.f12120k;
            } else {
                longRunningRecognizeMetadata.outputConfig_ = q2Var3.b();
            }
            Q();
        ...
        public b d0(LongRunningRecognizeMetadata longRunningRecognizeMetadata) {
            ...
            if (longRunningRecognizeMetadata.getProgressPercent() != 0) {
                m0(longRunningRecognizeMetadata.getProgressPercent());
            }
            if (longRunningRecognizeMetadata.hasStartTime()) {
                j0(longRunningRecognizeMetadata.getStartTime());
            }
            ...
            if (!longRunningRecognizeMetadata.getUri().isEmpty()) {
                this.f12119j = longRunningRecognizeMetadata.uri_;
                R();
            }
            if (longRunningRecognizeMetadata.hasOutputConfig()) {
                i0(longRunningRecognizeMetadata.getOutputConfig());
            }
        ...
        */
        public com.google.cloud.speech.v1p1beta1.LongRunningRecognizeMetadata.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = com.google.cloud.speech.v1p1beta1.LongRunningRecognizeMetadata.access$1000()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                com.google.cloud.speech.v1p1beta1.LongRunningRecognizeMetadata r3 = (com.google.cloud.speech.v1p1beta1.LongRunningRecognizeMetadata) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.d0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                com.google.cloud.speech.v1p1beta1.LongRunningRecognizeMetadata r4 = (com.google.cloud.speech.v1p1beta1.LongRunningRecognizeMetadata) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.cloud.speech.v1p1beta1.LongRunningRecognizeMetadata.b.u(com.google.protobuf.p, com.google.protobuf.f0):com.google.cloud.speech.v1p1beta1.LongRunningRecognizeMetadata$b");
        }
        ...
        public b h0(Timestamp timestamp) {
            q2<Timestamp, Timestamp.b, z2> q2Var = this.f12118i;
            if (q2Var == null) {
                Timestamp timestamp2 = this.f12117h;
                if (timestamp2 != null) {
                    this.f12117h = Timestamp.newBuilder(timestamp2).g0(timestamp).I();
                } else {
                    this.f12117h = timestamp;
                }
                R();
            } else {
                q2Var.e(timestamp);
        ...
        public b i0(TranscriptOutputConfig transcriptOutputConfig) {
            q2<TranscriptOutputConfig, TranscriptOutputConfig.c, q> q2Var = this.f12121l;
            if (q2Var == null) {
                TranscriptOutputConfig transcriptOutputConfig2 = this.f12120k;
                if (transcriptOutputConfig2 != null) {
                    this.f12120k = TranscriptOutputConfig.newBuilder(transcriptOutputConfig2).d0(transcriptOutputConfig).I();
                } else {
                    this.f12120k = transcriptOutputConfig;
                }
                R();
            } else {
        ...
        public b j0(Timestamp timestamp) {
            q2<Timestamp, Timestamp.b, z2> q2Var = this.f12116g;
            if (q2Var == null) {
                Timestamp timestamp2 = this.f12115f;
                if (timestamp2 != null) {
                    this.f12115f = Timestamp.newBuilder(timestamp2).g0(timestamp).I();
                } else {
                    this.f12115f = timestamp;
                }
                R();
            } else {
                q2Var.e(timestamp);
        ...
        if (getProgressPercent() == longRunningRecognizeMetadata.getProgressPercent() && hasStartTime() == longRunningRecognizeMetadata.hasStartTime()) {
            if ((!hasStartTime() || getStartTime().equals(longRunningRecognizeMetadata.getStartTime())) && hasLastUpdateTime() == longRunningRecognizeMetadata.hasLastUpdateTime()) {
                if ((!hasLastUpdateTime() || getLastUpdateTime().equals(longRunningRecognizeMetadata.getLastUpdateTime())) && getUri().equals(longRunningRecognizeMetadata.getUri()) && hasOutputConfig() == longRunningRecognizeMetadata.hasOutputConfig()) {
                    return (!hasOutputConfig() || getOutputConfig().equals(longRunningRecognizeMetadata.getOutputConfig())) && this.unknownFields.equals(longRunningRecognizeMetadata.unknownFields);
                }
                return false;
            }
            return false;
    ...
    public int getSerializedSize() {
        ...
        if (this.outputConfig_ != null) {
            x10 += CodedOutputStream.G(5, getOutputConfig());
        }
    ...
    public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
        ...
        if (this.outputConfig_ != null) {
            codedOutputStream.L0(5, getOutputConfig());
        }
                            ...
                            if (L != 8) {
                                if (L == 18) {
                                    ...
                                    if (builder2 != null) {
                                        ...
                                        this.lastUpdateTime_ = builder2.I();
                                    }
                                } else if (L == 34) {
                                    this.uri_ = pVar.K();
                                } else if (L != 42) {
