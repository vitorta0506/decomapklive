...
public final class LongRunningRecognizeResponse extends GeneratedMessageV3 implements r1 {
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        private List<SpeechRecognitionResult> f12129f;

        /* renamed from: g  reason: collision with root package name */
        private l2<SpeechRecognitionResult, SpeechRecognitionResult.b, l> f12130g;

        /* renamed from: h  reason: collision with root package name */
        private Duration f12131h;

        /* renamed from: i  reason: collision with root package name */
        private q2<Duration, Duration.b, v> f12132i;

        /* renamed from: j  reason: collision with root package name */
        private TranscriptOutputConfig f12133j;

        /* renamed from: k  reason: collision with root package name */
        private q2<TranscriptOutputConfig, TranscriptOutputConfig.c, q> f12134k;

        /* renamed from: l  reason: collision with root package name */
        private Status f12135l;

        /* renamed from: m  reason: collision with root package name */
        private q2<Status, Status.b, com.google.rpc.c> f12136m;
        ...
        private void a0() {
            if ((this.f12128e & 1) == 0) {
                this.f12129f = new ArrayList(this.f12129f);
                this.f12128e |= 1;
            }
        }
        ...
        private l2<SpeechRecognitionResult, SpeechRecognitionResult.b, l> d0() {
            if (this.f12130g == null) {
                this.f12130g = new l2<>(this.f12129f, (this.f12128e & 1) != 0, H(), O());
                this.f12129f = null;
            }
            return this.f12130g;
        }
        ...
        protected GeneratedMessageV3.e K() {
            return j.f12309x.d(LongRunningRecognizeResponse.class, b.class);
        }
        ...
        public LongRunningRecognizeResponse I() {
            ...
            int i9 = this.f12128e;
            l2<SpeechRecognitionResult, SpeechRecognitionResult.b, l> l2Var = this.f12130g;
            if (l2Var == null) {
                if ((i9 & 1) != 0) {
                    this.f12129f = Collections.unmodifiableList(this.f12129f);
                    this.f12128e &= -2;
                }
                longRunningRecognizeResponse.results_ = this.f12129f;
            } else {
                longRunningRecognizeResponse.results_ = l2Var.e();
            }
            q2<Duration, Duration.b, v> q2Var = this.f12132i;
            if (q2Var == null) {
                longRunningRecognizeResponse.totalBilledTime_ = this.f12131h;
            } else {
                longRunningRecognizeResponse.totalBilledTime_ = q2Var.b();
            }
            q2<TranscriptOutputConfig, TranscriptOutputConfig.c, q> q2Var2 = this.f12134k;
            if (q2Var2 == null) {
                longRunningRecognizeResponse.outputConfig_ = this.f12133j;
            } else {
                longRunningRecognizeResponse.outputConfig_ = q2Var2.b();
            }
            q2<Status, Status.b, com.google.rpc.c> q2Var3 = this.f12136m;
            if (q2Var3 == null) {
                longRunningRecognizeResponse.outputError_ = this.f12135l;
            } else {
            ...
            if (this.f12130g == null) {
                if (!longRunningRecognizeResponse.results_.isEmpty()) {
                    if (this.f12129f.isEmpty()) {
                        this.f12129f = longRunningRecognizeResponse.results_;
                        this.f12128e &= -2;
                    } else {
                        a0();
                        this.f12129f.addAll(longRunningRecognizeResponse.results_);
                    }
                    R();
                }
                ...
                if (this.f12130g.k()) {
                    ...
                    this.f12129f = longRunningRecognizeResponse.results_;
                    this.f12128e &= -2;
                    this.f12130g = GeneratedMessageV3.alwaysUseFieldBuilders ? d0() : null;
                } else {
                    this.f12130g.b(longRunningRecognizeResponse.results_);
                }
            }
        ...
        */
        public com.google.cloud.speech.v1p1beta1.LongRunningRecognizeResponse.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = com.google.cloud.speech.v1p1beta1.LongRunningRecognizeResponse.access$1000()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                java.lang.Object r3 = r1.m(r3, r4)     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                com.google.cloud.speech.v1p1beta1.LongRunningRecognizeResponse r3 = (com.google.cloud.speech.v1p1beta1.LongRunningRecognizeResponse) r3     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
                if (r3 == 0) goto L10
                r2.g0(r3)
            L10:
                return r2
            ...
            L13:
                ...
                com.google.cloud.speech.v1p1beta1.LongRunningRecognizeResponse r4 = (com.google.cloud.speech.v1p1beta1.LongRunningRecognizeResponse) r4     // Catch: java.lang.Throwable -> L11
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.cloud.speech.v1p1beta1.LongRunningRecognizeResponse.b.u(com.google.protobuf.p, com.google.protobuf.f0):com.google.cloud.speech.v1p1beta1.LongRunningRecognizeResponse$b");
        }
        ...
        public b j0(TranscriptOutputConfig transcriptOutputConfig) {
            q2<TranscriptOutputConfig, TranscriptOutputConfig.c, q> q2Var = this.f12134k;
            if (q2Var == null) {
                TranscriptOutputConfig transcriptOutputConfig2 = this.f12133j;
                if (transcriptOutputConfig2 != null) {
                    this.f12133j = TranscriptOutputConfig.newBuilder(transcriptOutputConfig2).d0(transcriptOutputConfig).I();
                } else {
                    this.f12133j = transcriptOutputConfig;
                }
                R();
            } else {
        ...
        public b k0(Status status) {
            q2<Status, Status.b, com.google.rpc.c> q2Var = this.f12136m;
            if (q2Var == null) {
                Status status2 = this.f12135l;
                if (status2 != null) {
                    this.f12135l = Status.newBuilder(status2).i0(status).I();
                } else {
                    this.f12135l = status;
                }
                R();
        ...
        public b l0(Duration duration) {
            q2<Duration, Duration.b, v> q2Var = this.f12132i;
            if (q2Var == null) {
                Duration duration2 = this.f12131h;
                if (duration2 != null) {
                    this.f12131h = Duration.newBuilder(duration2).e0(duration).I();
                } else {
                    this.f12131h = duration;
                }
                R();
            } else {
                q2Var.e(duration);
        ...
        private b() {
            this.f12129f = Collections.emptyList();
            e0();
        }
