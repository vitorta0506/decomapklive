...
public final class OperationInfo extends GeneratedMessageV3 implements r1 {
    ...
    private static final e2<OperationInfo> PARSER = new a();

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static class a extends com.google.protobuf.c<OperationInfo> {
        a() {
        }

        @Override // com.google.protobuf.e2
        /* renamed from: G */
        public OperationInfo m(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
            return new OperationInfo(pVar, f0Var, null);
        }
    }
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements r1 {
        ...
        protected GeneratedMessageV3.e K() {
            return c.f14271q.d(OperationInfo.class, b.class);
        }
        ...
        public OperationInfo I() {
            ...
            operationInfo.responseType_ = this.f14249e;
            operationInfo.metadataType_ = this.f14250f;
            Q();
        ...
        public b d0(OperationInfo operationInfo) {
            if (operationInfo == OperationInfo.getDefaultInstance()) {
                return this;
            }
            if (!operationInfo.getResponseType().isEmpty()) {
                this.f14249e = operationInfo.responseType_;
                R();
            }
            if (!operationInfo.getMetadataType().isEmpty()) {
                this.f14250f = operationInfo.metadataType_;
                R();
            }
            z(((GeneratedMessageV3) operationInfo).unknownFields);
            R();
            return this;
        }
        ...
        */
        public com.google.longrunning.OperationInfo.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = com.google.longrunning.OperationInfo.access$700()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.longrunning.OperationInfo.b.u(com.google.protobuf.p, com.google.protobuf.f0):com.google.longrunning.OperationInfo$b");
        }

        @Override // com.google.protobuf.a.AbstractC0142a
        /* renamed from: g0 */
        public b v(l1 l1Var) {
            if (l1Var instanceof OperationInfo) {
                return d0((OperationInfo) l1Var);
            }
            super.P0(l1Var);
            return this;
        }
    ...
    /* synthetic */ OperationInfo(p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
    ...
    public static e2<OperationInfo> parser() {
        return PARSER;
    }
    ...
    public e2<OperationInfo> getParserForType() {
        return PARSER;
    }
    ...
    /* synthetic */ OperationInfo(GeneratedMessageV3.b bVar, a aVar) {
        this(bVar);
    }

    public static b newBuilder(OperationInfo operationInfo) {
        return DEFAULT_INSTANCE.toBuilder().d0(operationInfo);
    }

    public static OperationInfo parseDelimitedFrom(InputStream inputStream, f0 f0Var) throws IOException {
        return (OperationInfo) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream, f0Var);
    }

    public static OperationInfo parseFrom(ByteBuffer byteBuffer, f0 f0Var) throws InvalidProtocolBufferException {
        return PARSER.f(byteBuffer, f0Var);
    }

    private OperationInfo(GeneratedMessageV3.b<?> bVar) {
        super(bVar);
        this.memoizedIsInitialized = (byte) -1;
    }
    ...
    public static OperationInfo parseFrom(ByteString byteString, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static OperationInfo parseFrom(byte[] bArr, f0 f0Var) throws InvalidProtocolBufferException {
    ...
    public static OperationInfo parseFrom(InputStream inputStream, f0 f0Var) throws IOException {
        return (OperationInfo) GeneratedMessageV3.parseWithIOException(PARSER, inputStream, f0Var);
    }

    private OperationInfo(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
            ...
            try {
                try {
                    try {
                        ...
                        if (L != 0) {
                            if (L == 10) {
                                this.responseType_ = pVar.K();
                            } else if (L != 18) {
                                if (!parseUnknownField(pVar, h10, f0Var, L)) {
                                }
                            } else {
                                this.metadataType_ = pVar.K();
                            }
                        }
                        z10 = true;
    ...
    public static OperationInfo parseFrom(p pVar) throws IOException {
        return (OperationInfo) GeneratedMessageV3.parseWithIOException(PARSER, pVar);
    }

    public static OperationInfo parseFrom(p pVar, f0 f0Var) throws IOException {
        return (OperationInfo) GeneratedMessageV3.parseWithIOException(PARSER, pVar, f0Var);
    }
}
