...
public final class FieldType {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f14657b[JavaType.MESSAGE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f14657b[JavaType.STRING.ordinal()] = 3;
            ...
            try {
                f14656a[b.VECTOR.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f14656a[b.SCALAR.ordinal()] = 3;
    ...
    static {
        ...
        for (FieldType fieldType52 : values) {
            VALUES[fieldType52.f14655id] = fieldType52;
        }
    }

    private FieldType(String str, int i9, int i10, b bVar, JavaType javaType) {
        int i11;
        this.f14655id = i10;
        this.collection = bVar;
        this.javaType = javaType;
        int i12 = a.f14656a[bVar.ordinal()];
        boolean z10 = true;
        if (i12 == 1) {
        ...
        this.primitiveScalar = (bVar != b.SCALAR || (i11 = a.f14657b[javaType.ordinal()]) == 1 || i11 == 2 || i11 == 3) ? false : false;
    }
