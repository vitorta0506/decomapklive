...
public final class SourceContext extends GeneratedMessageV3 implements s2 {
    public static final int FILE_NAME_FIELD_NUMBER = 1;
    private static final long serialVersionUID = 0;
    private volatile Object fileName_;
    private byte memoizedIsInitialized;
    private static final SourceContext DEFAULT_INSTANCE = new SourceContext();
    private static final e2<SourceContext> PARSER = new a();
    ...
    public static class a extends c<SourceContext> {
        ...
        /* renamed from: G */
        public SourceContext m(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
            return new SourceContext(pVar, f0Var, null);
        }
    }
    ...
    public static final class b extends GeneratedMessageV3.b<b> implements s2 {
        ...
        protected GeneratedMessageV3.e K() {
            return t2.f15281b.d(SourceContext.class, b.class);
        }
        ...
        public SourceContext I() {
            ...
            sourceContext.fileName_ = this.f14795e;
            Q();
        ...
        */
        public com.google.protobuf.SourceContext.b u(com.google.protobuf.p r3, com.google.protobuf.f0 r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
                com.google.protobuf.e2 r1 = com.google.protobuf.SourceContext.access$400()     // Catch: java.lang.Throwable -> L11 com.google.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.SourceContext.b.u(com.google.protobuf.p, com.google.protobuf.f0):com.google.protobuf.SourceContext$b");
        }

        @Override // com.google.protobuf.a.AbstractC0142a
        /* renamed from: e0 */
        public b v(l1 l1Var) {
            if (l1Var instanceof SourceContext) {
                return g0((SourceContext) l1Var);
            }
            super.P0(l1Var);
            return this;
        }

        public b g0(SourceContext sourceContext) {
            if (sourceContext == SourceContext.getDefaultInstance()) {
                return this;
            }
            if (!sourceContext.getFileName().isEmpty()) {
                this.f14795e = sourceContext.fileName_;
                R();
            }
            z(sourceContext.unknownFields);
            R();
            return this;
        }
    ...
    /* synthetic */ SourceContext(p pVar, f0 f0Var, a aVar) throws InvalidProtocolBufferException {
        this(pVar, f0Var);
    }
    ...
    public static e2<SourceContext> parser() {
        return PARSER;
    }
    ...
    public e2<SourceContext> getParserForType() {
        return PARSER;
    }
    ...
    public static b newBuilder(SourceContext sourceContext) {
        return DEFAULT_INSTANCE.toBuilder().g0(sourceContext);
    }
    ...
    public static SourceContext parseDelimitedFrom(InputStream inputStream, f0 f0Var) throws IOException {
        return (SourceContext) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, inputStream, f0Var);
    }
    ...
    private SourceContext(p pVar, f0 f0Var) throws InvalidProtocolBufferException {
        this();
    ...
    public static SourceContext parseFrom(InputStream inputStream, f0 f0Var) throws IOException {
        return (SourceContext) GeneratedMessageV3.parseWithIOException(PARSER, inputStream, f0Var);
    }
    ...
    public static SourceContext parseFrom(p pVar, f0 f0Var) throws IOException {
        return (SourceContext) GeneratedMessageV3.parseWithIOException(PARSER, pVar, f0Var);
    }
}
