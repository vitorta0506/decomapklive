...
public final class PairedStats implements Serializable {
    ...
    public static PairedStats fromByteArray(byte[] bArr) {
        ...
        com.google.common.base.o.i(bArr.length == 88, "Expected PairedStats.BYTES = %s, got %s", 88, bArr.length);
    ...
    public int hashCode() {
        return com.google.common.base.l.b(this.xStats, this.yStats, Double.valueOf(this.sumOfProductsOfDeltas));
    }

    public d leastSquaresFit() {
        com.google.common.base.o.z(count() > 1);
        ...
        com.google.common.base.o.z(this.yStats.sumOfSquaresOfDeltas() > 0.0d);
    ...
    public double pearsonsCorrelationCoefficient() {
        ...
        com.google.common.base.o.z(sumOfSquaresOfDeltas > 0.0d);
        com.google.common.base.o.z(sumOfSquaresOfDeltas2 > 0.0d);
        return ensureInUnitRange(this.sumOfProductsOfDeltas / Math.sqrt(ensurePositive(sumOfSquaresOfDeltas * sumOfSquaresOfDeltas2)));
    }

    public double populationCovariance() {
        com.google.common.base.o.z(count() != 0);
    ...
    public String toString() {
        if (count() > 0) {
            return com.google.common.base.j.c(this).d("xStats", this.xStats).d("yStats", this.yStats).a("populationCovariance", populationCovariance()).toString();
        }
        return com.google.common.base.j.c(this).d("xStats", this.xStats).d("yStats", this.yStats).toString();
    }
