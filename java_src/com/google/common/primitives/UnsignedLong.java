...
public final class UnsignedLong extends Number implements Comparable<UnsignedLong> {
    ...
    public UnsignedLong dividedBy(UnsignedLong unsignedLong) {
        return fromLongBits(m.b(this.value, ((UnsignedLong) o.s(unsignedLong)).value));
    }
    ...
    public UnsignedLong minus(UnsignedLong unsignedLong) {
        return fromLongBits(this.value - ((UnsignedLong) o.s(unsignedLong)).value);
    }

    public UnsignedLong mod(UnsignedLong unsignedLong) {
        return fromLongBits(m.e(this.value, ((UnsignedLong) o.s(unsignedLong)).value));
    }
    ...
    public int compareTo(UnsignedLong unsignedLong) {
        o.s(unsignedLong);
        return m.a(this.value, unsignedLong.value);
    }

    public String toString(int i9) {
        return m.g(this.value, i9);
    }
    ...
    public static UnsignedLong valueOf(String str, int i9) {
        return fromLongBits(m.d(str, i9));
    }
}
