    ...
    private static List<Result> processStructuredAppend(List<Result> list) {
        ...
        if (z10) {
            ...
            for (Result result2 : arrayList2) {
                sb2.append(result2.getText());
                i9 += result2.getRawBytes().length;
            ...
            for (Result result3 : arrayList2) {
                System.arraycopy(result3.getRawBytes(), 0, bArr2, i11, result3.getRawBytes().length);
                i11 += result3.getRawBytes().length;
            ...
            Result result4 = new Result(sb2.toString(), bArr2, NO_POINTS, BarcodeFormat.QR_CODE);
            if (i10 > 0) {
