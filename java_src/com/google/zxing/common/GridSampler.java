...
public abstract class GridSampler {
    ...
    */
    ...
    public abstract BitMatrix sampleGrid(BitMatrix bitMatrix, int i9, int i10, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17, float f18, float f19, float f20, float f21, float f22, float f23, float f24, float f25) throws NotFoundException;

    public abstract BitMatrix sampleGrid(BitMatrix bitMatrix, int i9, int i10, PerspectiveTransform perspectiveTransform) throws NotFoundException;
}
