...
final class FieldParser {
    ...
    static {
        ...
        VARIABLE_LENGTH = obj;
        TWO_DIGIT_DATA_LENGTH = new Object[][]{new Object[]{"00", 18}, new Object[]{HiAnalyticsConstant.KeyAndValue.NUMBER_01, 14}, new Object[]{"02", 14}, new Object[]{ThirdPushHelper.TYPE_XIAOMI_CHINA, obj, 20}, new Object[]{ThirdPushHelper.TYPE_XIAOMI_INTERNATIONAL, 6}, new Object[]{"12", 6}, new Object[]{ReportController.REPORT_TYPE_DYNAMIC_COMMENT, 6}, new Object[]{"15", 6}, new Object[]{ReportController.REPORT_TYPE_VOICE_ROOM, 6}, new Object[]{ThirdPushHelper.TYPE_HUAWEI, 2}, new Object[]{"21", obj, 20}, new Object[]{"22", obj, 29}, new Object[]{ThirdPushHelper.TYPE_OPPO, obj, 8}, new Object[]{"37", obj, 8}, new Object[]{"90", obj, 30}, new Object[]{"91", obj, 30}, new Object[]{"92", obj, 30}, new Object[]{"93", obj, 30}, new Object[]{"94", obj, 30}, new Object[]{"95", obj, 30}, new Object[]{"96", obj, 30}, new Object[]{"97", obj, 30}, new Object[]{"98", obj, 30}, new Object[]{"99", obj, 30}};
    ...
    private static String processFixedAI(int i9, int i10, String str) throws NotFoundException {
        if (str.length() >= i9) {
            ...
            if (str.length() >= i11) {
                ...
                String parseFieldsInGeneralPurpose = parseFieldsInGeneralPurpose(str.substring(i11));
    ...
    private static String processVariableAI(int i9, int i10, String str) throws NotFoundException {
        String substring = str.substring(0, i9);
        int i11 = i10 + i9;
        if (str.length() < i11) {
            i11 = str.length();
