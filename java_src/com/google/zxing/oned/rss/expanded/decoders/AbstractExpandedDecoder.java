                ...
                if (extractNumericValueFromBitArray2 != 12) {
                    if (extractNumericValueFromBitArray2 != 13) {
                        switch (GeneralAppIdDecoder.extractNumericValueFromBitArray(bitArray, 1, 7)) {
                            case 56:
                                return new AI013x0x1xDecoder(bitArray, "310", ThirdPushHelper.TYPE_XIAOMI_INTERNATIONAL);
                            case 57:
                                return new AI013x0x1xDecoder(bitArray, "320", ThirdPushHelper.TYPE_XIAOMI_INTERNATIONAL);
                            case 58:
                                return new AI013x0x1xDecoder(bitArray, "310", ReportController.REPORT_TYPE_DYNAMIC_COMMENT);
                            case 59:
                                return new AI013x0x1xDecoder(bitArray, "320", ReportController.REPORT_TYPE_DYNAMIC_COMMENT);
                            case 60:
                                return new AI013x0x1xDecoder(bitArray, "310", "15");
                            case 61:
                                return new AI013x0x1xDecoder(bitArray, "320", "15");
                            case 62:
                                return new AI013x0x1xDecoder(bitArray, "310", ReportController.REPORT_TYPE_VOICE_ROOM);
                            case 63:
                                return new AI013x0x1xDecoder(bitArray, "320", ReportController.REPORT_TYPE_VOICE_ROOM);
                            default:
