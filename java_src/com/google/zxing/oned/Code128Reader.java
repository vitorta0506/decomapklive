...
public final class Code128Reader extends OneDReader {
    ...
    private static int decodeCode(BitArray bitArray, int[] iArr, int i9) throws NotFoundException {
            ...
            if (bitArray.get(nextSet) != z10) {
                ...
                if (i10 == 5) {
                    ...
                    for (int i12 = 103; i12 <= 105; i12++) {
                        float patternMatchVariance = OneDReader.patternMatchVariance(iArr, CODE_PATTERNS[i12], MAX_INDIVIDUAL_VARIANCE);
                        if (patternMatchVariance < f10) {
                            i11 = i12;
                            f10 = patternMatchVariance;
                        }
                    }
                    if (i11 >= 0 && bitArray.isRange(Math.max(0, i9 - ((nextSet - i9) / 2)), i9, false)) {
                        return new int[]{i9, nextSet, i11};
                    }
                    i9 += iArr[0] + iArr[1];
                    int i13 = i10 - 1;
