...
public final class Version {
    ...
    public static Version decodeVersionInformation(int i9) {
        ...
        while (true) {
            ...
            int numBitsDiffering = FormatInformation.numBitsDiffering(i9, i13);
