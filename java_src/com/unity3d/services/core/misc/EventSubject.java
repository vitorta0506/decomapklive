...
public class EventSubject<T> {
    ...
    public EventSubject(String str, Queue<T> queue, Integer num, IIntervalTimerFactory iIntervalTimerFactory) {
        ...
        this._intervalTimer = iIntervalTimerFactory.createTimer(str, num, Integer.valueOf(queue.size()), new IIntervalTimerListener() { // from class: com.unity3d.services.core.misc.EventSubject.1
