...
public class f extends com.meizu.cloud.pushsdk.handler.a.a<UnRegisterStatus> {
    ...
    public UnRegisterStatus c(Intent intent) {
        ...
        UnRegisterStatus b10 = !TextUtils.isEmpty(stringExtra) ? com.meizu.cloud.pushsdk.platform.message.a.b(stringExtra) : (UnRegisterStatus) intent.getSerializableExtra(PushConstants.EXTRA_APP_PUSH_UNREGISTER_STATUS);
        if (b10.isUnRegisterSuccess()) {
