...
public class d extends com.meizu.cloud.pushsdk.handler.a.a<SubAliasStatus> {
    ...
    public SubAliasStatus c(Intent intent) {
        ...
        SubAliasStatus d10 = !TextUtils.isEmpty(stringExtra) ? com.meizu.cloud.pushsdk.platform.message.a.d(stringExtra) : (SubAliasStatus) intent.getSerializableExtra(PushConstants.EXTRA_APP_PUSH_SUBALIAS_STATUS);
        if (BasicPushStatus.SUCCESS_CODE.equals(d10.getCode())) {
            c(d10.getAlias());
        }
        return d10;
    }
