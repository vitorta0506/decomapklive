...
public class e extends a<MessageV3> {
    ...
    public void b(MessageV3 messageV3) {
        ...
        String b10 = b(messageV3.getThroughMessage());
        if (TextUtils.isEmpty(b10)) {
            ...
            com.meizu.cloud.pushsdk.util.d.c(d(), b10, messageV3.getDeviceId(), messageV3.getTaskId(), messageV3.getSeqId(), messageV3.getPushTimestamp());
        }
    }
