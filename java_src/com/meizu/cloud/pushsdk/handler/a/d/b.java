...
public class b extends com.meizu.cloud.pushsdk.handler.a.a<MessageV3> {
    ...
    private void e(MessageV3 messageV3) {
        ...
        Intent b10 = b(d(), messageV3);
        if (b10 != null) {
            b10.addFlags(268435456);
            try {
                d().startActivity(b10);
            } catch (Exception e10) {
                DebugLogger.e("AbstractMessageHandler", "Click message StartActivity error " + e10.getMessage());
            }
        }
    }
    ...
    private MessageV3 m(Intent intent) {
        ...
        try {
            ...
            return MessageV3.parse(g10, d10, taskId, mPushMessage);
        } finally {
