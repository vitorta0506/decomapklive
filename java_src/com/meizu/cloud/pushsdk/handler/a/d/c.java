...
public class c extends com.meizu.cloud.pushsdk.handler.a.a<MessageV3> {
    ...
    private void e(MessageV3 messageV3) {
        ...
        com.meizu.cloud.pushsdk.util.b.a(this.f28724a, messageV3.getAdvertisementOption().getAdPackage(), System.currentTimeMillis());
        com.meizu.cloud.pushsdk.util.d.e(this.f28724a, messageV3.getAdvertisementOption().getAdInstallPackage(), messageV3.getDeviceId(), messageV3.getTaskId(), messageV3.getSeqId(), messageV3.getPushTimestamp());
    }
