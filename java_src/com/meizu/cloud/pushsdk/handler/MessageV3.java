...
public class MessageV3 implements Parcelable {
    public static final Parcelable.Creator<MessageV3> CREATOR = new Parcelable.Creator<MessageV3>() { // from class: com.meizu.cloud.pushsdk.handler.MessageV3.1
        ...
        @Override // android.os.Parcelable.Creator
        /* renamed from: a */
        public MessageV3[] newArray(int i9) {
            return new MessageV3[i9];
        }
    };
    ...
    public static MessageV3 parse(String str, String str2, String str3, MPushMessage mPushMessage) {
        ...
        messageV3.setIsDiscard(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equals(mPushMessage.getIsDiscard()));
        ...
        try {
            ...
            if (!jSONObject.isNull(PushConstants.EXTRA)) {
                ...
                if (!jSONObject2.isNull(TimeDisplaySetting.TIME_DISPLAY_SETTING)) {
                    messageV3.setTimeDisplaySetting(TimeDisplaySetting.parse(jSONObject2.getJSONObject(TimeDisplaySetting.TIME_DISPLAY_SETTING)));
                }
    ...
    public void writeToParcel(Parcel parcel, int i9) {
        ...
        parcel.writeParcelable(this.mAdvanceSetting, i9);
        parcel.writeParcelable(this.mAppIconSetting, i9);
        parcel.writeParcelable(this.mNotificationStyle, i9);
        parcel.writeParcelable(this.mTimeDisplaySetting, i9);
    }
}
