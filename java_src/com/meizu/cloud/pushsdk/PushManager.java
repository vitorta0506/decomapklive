...
public class PushManager {
    ...
    public static final String TAG = "4.0.7-SNAPSHOT";
    ...
    public static void checkNotificationMessage(Context context) {
        ...
        try {
            ...
            DebugLogger.e(TAG, "start check notification message service error " + e10.getMessage());
        }
    }
    ...
    public static void enableCacheRequest(Context context, boolean z10) {
        com.meizu.cloud.pushsdk.platform.a.b.a(context).a(z10);
    }

    public static String getPushId(Context context) {
        int b10 = com.meizu.cloud.pushsdk.util.b.b(context, context.getPackageName());
    ...
    public static void register(Context context) {
        ...
        try {
            ...
            DebugLogger.e(TAG, "start register service error " + e10.getMessage());
            return;
        }
    ...
    public static void switchPush(Context context, String str, String str2, String str3, int i9, boolean z10) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            com.meizu.cloud.pushsdk.platform.a.b.a(context).a(str, str2, context.getPackageName(), str3, i9, z10);
        } else {
    ...
    public static void switchPush(Context context, String str, String str2, String str3, boolean z10) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            com.meizu.cloud.pushsdk.platform.a.b.a(context).a(str, str2, context.getPackageName(), str3, z10);
        } else {
            DebugLogger.e(TAG, "please invoke switchPush on meizu device Build-in FlymeOS");
        }
    }
    ...
    public static void unRegister(Context context) {
        ...
        try {
            ...
            DebugLogger.e(TAG, "start unRegister service error " + e10.getMessage());
            return;
        }
        intent.setClassName(str, PushConstants.MZ_PUSH_SERVICE_NAME);
        intent.putExtra("sender", context.getPackageName());
