...
public abstract class V2TIMManager {
    ...
    public abstract boolean initSDK(Context context, int i9, V2TIMSDKConfig v2TIMSDKConfig);

    @Deprecated
    public abstract boolean initSDK(Context context, int i9, V2TIMSDKConfig v2TIMSDKConfig, V2TIMSDKListener v2TIMSDKListener);
    ...
    public abstract String sendGroupCustomMessage(byte[] bArr, String str, int i9, V2TIMValueCallback<V2TIMMessage> v2TIMValueCallback);

    public abstract String sendGroupTextMessage(String str, String str2, int i9, V2TIMValueCallback<V2TIMMessage> v2TIMValueCallback);
