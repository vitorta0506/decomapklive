...
public abstract class V2TIMFriendshipManager {
    ...
    public abstract void acceptFriendApplication(V2TIMFriendApplication v2TIMFriendApplication, int i9, V2TIMValueCallback<V2TIMFriendOperationResult> v2TIMValueCallback);
    ...
    public abstract void checkFriend(List<String> list, int i9, V2TIMValueCallback<List<V2TIMFriendCheckResult>> v2TIMValueCallback);
    ...
    public abstract void deleteFromFriendList(List<String> list, int i9, V2TIMValueCallback<List<V2TIMFriendOperationResult>> v2TIMValueCallback);
