...
public interface ITPPlayer {
    ...
    void deselectTrack(int i9, long j10);
    ...
    void seekTo(int i9, int i10);

    void selectProgram(int i9, long j10);

    void selectTrack(int i9, long j10);
    ...
    void switchDefinition(@NonNull ITPMediaAsset iTPMediaAsset, long j10, TPVideoInfo tPVideoInfo);

    void switchDefinition(@NonNull ITPMediaAsset iTPMediaAsset, long j10, TPVideoInfo tPVideoInfo, int i9);

    void switchDefinition(@NonNull String str, long j10, TPVideoInfo tPVideoInfo);

    void switchDefinition(@NonNull String str, long j10, TPVideoInfo tPVideoInfo, int i9);

    void switchDefinition(@NonNull String str, long j10, TPVideoInfo tPVideoInfo, Map<String, String> map);

    void switchDefinition(@NonNull String str, long j10, TPVideoInfo tPVideoInfo, Map<String, String> map, int i9);
