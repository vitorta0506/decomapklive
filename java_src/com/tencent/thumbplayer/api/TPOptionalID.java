...
public class TPOptionalID {
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_BOOL_VIDEO_KEEP_MEDIA_CODEC_PTS", type = 3, value = TPNativePlayerInitConfig.BOOL_VIDEO_KEEP_MEDIA_CODEC_PTS)
