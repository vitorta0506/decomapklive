...
public class TPNativePlayerInitConfig {
    ...
    public void addQueueInt(int i9, int i10) {
        Vector<Integer> vector = this.mQueueIntMap.get(Integer.valueOf(i9));
        if (vector == null) {
            vector = new Vector<>();
            this.mQueueIntMap.put(Integer.valueOf(i9), vector);
        }
        vector.add(Integer.valueOf(i10));
    }

    public void addQueueString(int i9, String str) {
        Vector<String> vector = this.mQueueStringMap.get(Integer.valueOf(i9));
        if (vector == null) {
            vector = new Vector<>();
            this.mQueueStringMap.put(Integer.valueOf(i9), vector);
        }
        vector.add(str);
    }
    ...
    public void setBool(int i9, boolean z10) {
        this.mBoolMap.put(Integer.valueOf(i9), Boolean.valueOf(z10));
    }

    public void setFloat(int i9, float f10) {
        this.mFloatMap.put(Integer.valueOf(i9), Float.valueOf(f10));
    }
    ...
    public void setLong(int i9, long j10) {
        this.mLongMap.put(Integer.valueOf(i9), Long.valueOf(j10));
    }

    public void setObject(int i9, Object obj) {
        this.mObjectMap.put(Integer.valueOf(i9), obj);
    }
