...
public final class TPMediaCodecProfileLevel {
    ...
    public static int getAV1MaxLumaSample(int i9) {
    ...
    public static int getAVCMaxLumaSample(int i9) {
    ...
    public static int getHEVCMaxLumaSample(int i9) {
    ...
    public static int getVP8MaxLumaSample(int i9) {
    ...
    public static int getVP9MaxLumaSample(int i9) {
