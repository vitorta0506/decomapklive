...
public final class ConnectionSpec {
    ...
    private ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z10) {
        ...
        String[] enabledCipherSuites = strArr != null ? (String[]) i.n(String.class, strArr, sSLSocket.getEnabledCipherSuites()) : sSLSocket.getEnabledCipherSuites();
        String[] strArr2 = this.tlsVersions;
        String[] enabledProtocols = strArr2 != null ? (String[]) i.n(String.class, strArr2, sSLSocket.getEnabledProtocols()) : sSLSocket.getEnabledProtocols();
        if (z10 && i.f(sSLSocket.getSupportedCipherSuites(), "TLS_FALLBACK_SCSV")) {
            enabledCipherSuites = i.e(enabledCipherSuites, "TLS_FALLBACK_SCSV");
        }
