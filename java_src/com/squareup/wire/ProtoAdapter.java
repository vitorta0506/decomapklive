...
public abstract class ProtoAdapter<E> {
    ...
    private static final class MapProtoAdapter<K, V> extends ProtoAdapter<Map<K, V>> {
        ...
        @Override // com.squareup.wire.ProtoAdapter
        public /* bridge */ /* synthetic */ void encodeWithTag(ProtoWriter protoWriter, int i9, Object obj) throws IOException {
            encodeWithTag(protoWriter, i9, (Map) ((Map) obj));
        }
        ...
        @Override // com.squareup.wire.ProtoAdapter
        public /* bridge */ /* synthetic */ int encodedSizeWithTag(int i9, Object obj) {
            return encodedSizeWithTag(i9, (Map) ((Map) obj));
        }
        ...
        public void encodeWithTag(ProtoWriter protoWriter, int i9, Map<K, V> map) throws IOException {
            for (Map.Entry<K, V> entry : map.entrySet()) {
                this.entryAdapter.encodeWithTag(protoWriter, i9, entry);
            }
        }
        ...
        public int encodedSizeWithTag(int i9, Map<K, V> map) {
            int i10 = 0;
            for (Map.Entry<K, V> entry : map.entrySet()) {
                i10 += this.entryAdapter.encodedSizeWithTag(i9, entry);
            }
            return i10;
        }
    ...
    private ProtoAdapter<List<E>> createPacked() {
        ...
        if (fieldEncoding != fieldEncoding2) {
            return new ProtoAdapter<List<E>>(fieldEncoding2, List.class) { // from class: com.squareup.wire.ProtoAdapter.14
                ...
                @Override // com.squareup.wire.ProtoAdapter
                public /* bridge */ /* synthetic */ void encodeWithTag(ProtoWriter protoWriter, int i9, Object obj) throws IOException {
                    encodeWithTag(protoWriter, i9, (List) ((List) obj));
                }
                ...
                @Override // com.squareup.wire.ProtoAdapter
                public /* bridge */ /* synthetic */ int encodedSizeWithTag(int i9, Object obj) {
                    return encodedSizeWithTag(i9, (List) ((List) obj));
                }
                ...
                public void encode(ProtoWriter protoWriter, List<E> list) throws IOException {
                    ...
                    for (int i9 = 0; i9 < size; i9++) {
                        ProtoAdapter.this.encode(protoWriter, (ProtoWriter) list.get(i9));
                    }
                }

                public void encodeWithTag(ProtoWriter protoWriter, int i9, List<E> list) throws IOException {
                    if (list.isEmpty()) {
                        return;
                    }
                    super.encodeWithTag(protoWriter, i9, (int) list);
                }
                ...
                public int encodedSize(List<E> list) {
                    ...
                    for (int i10 = 0; i10 < size; i10++) {
                        i9 += ProtoAdapter.this.encodedSize(list.get(i10));
                    }
                    return i9;
                }

                public int encodedSizeWithTag(int i9, List<E> list) {
                    if (list.isEmpty()) {
                        return 0;
                    }
                    return super.encodedSizeWithTag(i9, (int) list);
                }
    ...
    private ProtoAdapter<List<E>> createRepeated() {
        return new ProtoAdapter<List<E>>(this.fieldEncoding, List.class) { // from class: com.squareup.wire.ProtoAdapter.15
            ...
            public void encodeWithTag(ProtoWriter protoWriter, int i9, List<E> list) throws IOException {
                int size = list.size();
                for (int i10 = 0; i10 < size; i10++) {
                    ProtoAdapter.this.encodeWithTag(protoWriter, i9, list.get(i10));
                }
            }
            ...
            public int encodedSizeWithTag(int i9, List<E> list) {
                ...
                for (int i11 = 0; i11 < size; i11++) {
                    i10 += ProtoAdapter.this.encodedSizeWithTag(i9, list.get(i11));
                }
                return i10;
            }
    ...
    public void encodeWithTag(ProtoWriter protoWriter, int i9, E e10) throws IOException {
        if (e10 == null) {
            return;
        }
        protoWriter.writeTag(i9, this.fieldEncoding);
    ...
    public int encodedSizeWithTag(int i9, E e10) {
        if (e10 == null) {
            return 0;
        }
        ...
        return encodedSize + ProtoWriter.tagSize(i9);
    }
