...
public class BuyPendantAvatarDialog extends BaseBuyDressDialog {
    ...
    public void initView(View view) {
        ...
        ((ViewGroup.MarginLayoutParams) ((ViewGroup) this.f17634a.getParent()).getLayoutParams()).topMargin = DensityUtil.dp2px(112.0f);
        ((ViewGroup.MarginLayoutParams) this.f17638e.getLayoutParams()).topMargin = DensityUtil.dp2px(16.0f);
        ((ViewGroup.MarginLayoutParams) this.f17638e.getLayoutParams()).width = DensityUtil.dp2px(80.0f);
        ((ViewGroup.MarginLayoutParams) this.f17638e.getLayoutParams()).height = DensityUtil.dp2px(80.0f);
