...
public class BuyEntranceCarDialog extends BaseBuyDressDialog {
    ...
    public void initView(View view) {
        super.initView(view);
        ((ViewGroup.MarginLayoutParams) this.f17640g.getLayoutParams()).topMargin = DensityUtil.dp2px(50.0f);
        ((ViewGroup.MarginLayoutParams) ((ViewGroup) this.f17634a.getParent()).getLayoutParams()).topMargin = DensityUtil.dp2px(66.0f);
        ((ViewGroup.MarginLayoutParams) this.f17638e.getLayoutParams()).topMargin = DensityUtil.dp2px(0.0f);
        ((ViewGroup.MarginLayoutParams) this.f17638e.getLayoutParams()).width = DensityUtil.dp2px(100.0f);
        ((ViewGroup.MarginLayoutParams) this.f17638e.getLayoutParams()).height = DensityUtil.dp2px(100.0f);
