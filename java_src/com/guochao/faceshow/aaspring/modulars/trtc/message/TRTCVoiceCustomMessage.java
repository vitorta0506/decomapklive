...
public class TRTCVoiceCustomMessage extends com.guochao.faceshow.aaspring.modulars.chat.models.a {
    public TRTCVoiceCustomMessage(V2TIMMessage v2TIMMessage) {
        super(v2TIMMessage);
    }
    ...
    public String getSummary(Context context) {
        ...
        if (TextUtils.isEmpty(getTransformedOtherLanguage())) {
            if (TextUtils.isEmpty(str)) {
                return "[" + context.getString(R.string.trtc_voice_call) + "]";
            }
            return str;
        }
        String str2 = getTransformedOtherLanguage() + "_voice";
    ...
    public TRTCVoiceCustomMessage(int i9, int i10, String str) {
