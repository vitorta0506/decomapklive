...
public class VoiceRoomShareMessage extends a implements h {
    ...
    public VoiceRoomShareMessage(V2TIMMessage v2TIMMessage) {
        super(v2TIMMessage);
        parseMessage();
    }

    public static VoiceRoomShareMessage from(LiveRoomModel liveRoomModel) {
        ...
        try {
            ...
            jSONObject.put("msg_type", 70007);
            jSONObject.put("msg_text", "Version is too low to view");
        } catch (JSONException e10) {
            e10.printStackTrace();
        }
        return new VoiceRoomShareMessage(V2TIMManager.getMessageManager().createCustomMessage(jSONObject.toString().getBytes(StandardCharsets.UTF_8)));
    }
