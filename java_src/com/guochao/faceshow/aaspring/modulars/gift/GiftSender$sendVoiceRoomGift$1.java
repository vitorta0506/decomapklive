...
@DebugMetadata(c = "com.guochao.faceshow.aaspring.modulars.gift.GiftSender$sendVoiceRoomGift$1", f = "GiftSender.kt", i = {}, l = {360}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class GiftSender$sendVoiceRoomGift$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public GiftSender$sendVoiceRoomGift$1(SendGiftRequestModel sendGiftRequestModel, LifecycleOwner lifecycleOwner, com.guochao.faceshow.aaspring.base.http.callback.c<SendGiftResponseModel> cVar, Continuation<? super GiftSender$sendVoiceRoomGift$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new GiftSender$sendVoiceRoomGift$1(this.$sendGiftRequestModel, this.$lifecycleOwner, this.$callBack, continuation);
    }
    ...
    public final Object mo1invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((GiftSender$sendVoiceRoomGift$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i10 == 0) {
            ...
            this.label = 1;
            obj = giftSender.sendVoiceRoomGiftToServer(sendGiftRequestModel, this);
