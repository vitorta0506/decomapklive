...
public class DynamicDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public static class Builder {
        ...
        public DynamicDividerItemDecoration build() {
            return new DynamicDividerItemDecoration(this);
        }
    ...
    private boolean isFirsColumn(int i9, int i10, int i11) {
        if (i11 == 1) {
            return true;
        }
        return i11 == 4 ? i9 == 0 || i9 == 2 : i11 == 5 ? i9 == 0 || i9 == 2 : i9 % i10 == 0;
    }

    private boolean isFirstRow(int i9, int i10, int i11) {
        if (i11 == 1 || i11 == 2 || i11 == 3) {
            return true;
        }
        return i11 >= 4 ? i9 < 2 : i9 / i10 == 0;
    }

    private boolean isLastColumn(int i9, int i10, int i11) {
        if (i11 == 1) {
            return true;
        }
        return i11 == 2 ? i9 == 1 : i11 == 3 ? i9 == 2 : i11 == 4 ? i9 == 1 || i9 == 3 : i11 == 5 ? i9 == 1 || i9 == 4 : (i9 + 1) % i10 == 0;
    }
    ...
    public void getItemOffsets(@NonNull Rect rect, @NonNull View view, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.State state) {
        ...
        if (layoutManager instanceof GridLayoutManager) {
            ...
            if (isFirsColumn(childAdapterPosition, spanCount, itemCount)) {
                if (isFirstRow(childAdapterPosition, spanCount, itemCount)) {
            ...
            } else if (isLastColumn(childAdapterPosition, spanCount, itemCount)) {
                if (isLastRow(childAdapterPosition, spanCount, itemCount) && isFirstRow(childAdapterPosition, spanCount, itemCount)) {
                ...
                } else if (isFirstRow(childAdapterPosition, spanCount, itemCount)) {
            ...
            } else if (isFirstRow(childAdapterPosition, spanCount, itemCount) && isLastRow(childAdapterPosition, spanCount, itemCount)) {
    ...
    private DynamicDividerItemDecoration(Builder builder) {
