...
public final class ItemAtMeNotifycationBinding implements ViewBinding {
    @NonNull
    ...
    private ItemAtMeNotifycationBinding(@NonNull RelativeLayout relativeLayout, @NonNull HeadPortraitView headPortraitView, @NonNull ImageView imageView, @NonNull TextView textView, @NonNull ImageView imageView2, @NonNull FrameLayout frameLayout, @NonNull TextView textView2, @NonNull View view, @NonNull TextView textView3, @NonNull LinearLayout linearLayout) {
    ...
    @NonNull
    public static ItemAtMeNotifycationBinding bind(@NonNull View view) {
                                ...
                                if (findChildViewById != null) {
                                    ...
                                    if (textView3 != null) {
                                        ...
                                        if (linearLayout != null) {
                                            return new ItemAtMeNotifycationBinding((RelativeLayout) view, headPortraitView, imageView, textView, imageView2, frameLayout, textView2, findChildViewById, textView3, linearLayout);
                                        }
                                    }
                                }
                            }
    ...
    @NonNull
    public static ItemAtMeNotifycationBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static ItemAtMeNotifycationBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R.layout.item_at_me_notifycation, viewGroup, false);
        if (z10) {
