...
public final class VideoListItemPrivateBinding implements ViewBinding {
    @NonNull
    ...
    @NonNull
    public final TextView searchFriend;
    @NonNull
    ...
    private VideoListItemPrivateBinding(@NonNull RelativeLayout relativeLayout, @NonNull FrameLayout frameLayout, @NonNull LinearLayout linearLayout, @NonNull ImageView imageView, @NonNull TextView textView, @NonNull FrameLayout frameLayout2, @NonNull LinearLayout linearLayout2, @NonNull ImageView imageView2, @NonNull CardView cardView, @NonNull RelativeLayout relativeLayout2, @NonNull ImageView imageView3, @NonNull FrameLayout frameLayout3, @NonNull ImageView imageView4, @NonNull NormalCircleImageView normalCircleImageView, @NonNull Love love, @NonNull ImageButton imageButton, @NonNull TextView textView2, @NonNull SVGAImageView sVGAImageView, @NonNull TextView textView3, @NonNull TextView textView4, @NonNull LinearLayout linearLayout3, @NonNull HollowTextView hollowTextView, @NonNull LinearLayout linearLayout4, @NonNull TXCloudVideoView tXCloudVideoView, @NonNull ImageView imageView5, @NonNull ProgressBar progressBar, @NonNull LinearLayout linearLayout5) {
    ...
    @NonNull
    public static VideoListItemPrivateBinding bind(@NonNull View view) {
                                                            ...
                                                            if (imageButton != null) {
                                                                ...
                                                                if (textView2 != null) {
                                                                    ...
                                                                    if (sVGAImageView != null) {
                                                                        i9 = R.id.search_friend;
                                                                        TextView textView3 = (TextView) ViewBindings.findChildViewById(view, R.id.search_friend);
                                                                        if (textView3 != null) {
                                                                            i9 = R.id.share_num;
                                                                            TextView textView4 = (TextView) ViewBindings.findChildViewById(view, R.id.share_num);
                                                                            if (textView4 != null) {
                                                                                i9 = R.id.tips;
                                                                                                ...
                                                                                                if (imageView5 != null) {
                                                                                                    ...
                                                                                                    if (progressBar != null) {
                                                                                                        ...
                                                                                                        if (linearLayout5 != null) {
                                                                                                            return new VideoListItemPrivateBinding(relativeLayout, frameLayout, linearLayout, imageView, textView, frameLayout2, linearLayout2, imageView2, cardView, relativeLayout, imageView3, frameLayout3, imageView4, normalCircleImageView, love, imageButton, textView2, sVGAImageView, textView3, textView4, linearLayout3, hollowTextView, linearLayout4, tXCloudVideoView, imageView5, progressBar, linearLayout5);
                                                                                                        }
                                                                                                    }
                                                                                                }
                                                                                            }
    ...
    @NonNull
    public static VideoListItemPrivateBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static VideoListItemPrivateBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R.layout.video_list_item_private, viewGroup, false);
        if (z10) {
