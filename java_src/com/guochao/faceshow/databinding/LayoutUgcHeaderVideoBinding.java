...
public final class LayoutUgcHeaderVideoBinding implements ViewBinding {
    @NonNull
    ...
    private LayoutUgcHeaderVideoBinding(@NonNull LinearLayout linearLayout, @NonNull ImageView imageView, @NonNull CardView cardView, @NonNull CardView cardView2, @NonNull CardView cardView3, @NonNull CardView cardView4, @NonNull SvgaImageViewV2 svgaImageViewV2) {
    ...
    @NonNull
    public static LayoutUgcHeaderVideoBinding bind(@NonNull View view) {
        int i9 = R.id.bg_1v1;
                    ...
                    if (cardView3 != null) {
                        ...
                        if (cardView4 != null) {
                            ...
                            if (svgaImageViewV2 != null) {
                                return new LayoutUgcHeaderVideoBinding((LinearLayout) view, imageView, cardView, cardView2, cardView3, cardView4, svgaImageViewV2);
                            }
                        }
                    }
                }
    ...
    @NonNull
    public static LayoutUgcHeaderVideoBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static LayoutUgcHeaderVideoBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R.layout.layout_ugc_header_video, viewGroup, false);
        if (z10) {
