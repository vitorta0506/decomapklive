...
public final class LayoutBuyVipBanner1Binding implements ViewBinding {
    @NonNull
    ...
    private LayoutBuyVipBanner1Binding(@NonNull RelativeLayout relativeLayout, @NonNull LinearLayout linearLayout, @NonNull HeadPortraitView headPortraitView, @NonNull TextView textView, @NonNull TextView textView2, @NonNull TextView textView3, @NonNull VipIndicatorView vipIndicatorView) {
    ...
    @NonNull
    public static LayoutBuyVipBanner1Binding bind(@NonNull View view) {
                    ...
                    if (textView2 != null) {
                        ...
                        if (textView3 != null) {
                            ...
                            if (vipIndicatorView != null) {
                                return new LayoutBuyVipBanner1Binding((RelativeLayout) view, linearLayout, headPortraitView, textView, textView2, textView3, vipIndicatorView);
                            }
                        }
                    }
                }
    ...
    @NonNull
    public static LayoutBuyVipBanner1Binding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static LayoutBuyVipBanner1Binding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R.layout.layout_buy_vip_banner1, viewGroup, false);
        if (z10) {
