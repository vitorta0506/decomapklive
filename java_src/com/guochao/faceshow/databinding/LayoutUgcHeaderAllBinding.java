...
public final class LayoutUgcHeaderAllBinding implements ViewBinding {
    @NonNull
    ...
    private LayoutUgcHeaderAllBinding(@NonNull LinearLayout linearLayout, @NonNull ImageView imageView, @NonNull CardView cardView, @NonNull CardView cardView2, @NonNull CardView cardView3, @NonNull CardView cardView4, @NonNull SvgaImageViewV2 svgaImageViewV2) {
    ...
    @NonNull
    public static LayoutUgcHeaderAllBinding bind(@NonNull View view) {
        int i9 = R.id.bg_1v1;
                    ...
                    if (cardView3 != null) {
                        ...
                        if (cardView4 != null) {
                            ...
                            if (svgaImageViewV2 != null) {
                                return new LayoutUgcHeaderAllBinding((LinearLayout) view, imageView, cardView, cardView2, cardView3, cardView4, svgaImageViewV2);
                            }
                        }
                    }
                }
    ...
    @NonNull
    public static LayoutUgcHeaderAllBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static LayoutUgcHeaderAllBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R.layout.layout_ugc_header_all, viewGroup, false);
        if (z10) {
