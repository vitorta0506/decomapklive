...
public final class LayoutEmptyViewBinding implements ViewBinding {
    ...
    private LayoutEmptyViewBinding(@NonNull LinearLayout linearLayout, @NonNull TextView textView, @NonNull LinearLayout linearLayout2) {
    ...
    public static LayoutEmptyViewBinding bind(@NonNull View view) {
        ...
        if (textView != null) {
            ...
            return new LayoutEmptyViewBinding(linearLayout, textView, linearLayout);
        }
