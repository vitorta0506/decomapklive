...
public final class FragmentBeautyBinding implements ViewBinding {
    ...
    private FragmentBeautyBinding(@NonNull FrameLayout frameLayout, @NonNull RecyclerView recyclerView, @NonNull SeekBar seekBar, @NonNull LinearLayout linearLayout, @NonNull TextView textView) {
    ...
    @NonNull
    public static FragmentBeautyBinding bind(@NonNull View view) {
        int i9 = R.id.content;
        ...
        if (recyclerView != null) {
            ...
            if (seekBar != null) {
                ...
                if (linearLayout != null) {
                    ...
                    if (textView != null) {
                        return new FragmentBeautyBinding((FrameLayout) view, recyclerView, seekBar, linearLayout, textView);
                    }
                }
            }
        }
    ...
    @NonNull
    public static FragmentBeautyBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static FragmentBeautyBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
