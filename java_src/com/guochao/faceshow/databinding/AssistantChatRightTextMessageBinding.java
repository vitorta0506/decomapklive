...
public final class AssistantChatRightTextMessageBinding implements ViewBinding {
    @NonNull
    ...
    private AssistantChatRightTextMessageBinding(@NonNull RelativeLayout relativeLayout, @NonNull NormalCircleImageView normalCircleImageView, @NonNull LinearLayout linearLayout, @NonNull ImageView imageView, @NonNull LinearLayout linearLayout2, @NonNull ImageView imageView2, @NonNull ImageView imageView3, @NonNull ProgressBar progressBar, @NonNull RelativeLayout relativeLayout2, @NonNull FrameLayout frameLayout) {
    ...
    @NonNull
    public static AssistantChatRightTextMessageBinding bind(@NonNull View view) {
                            ...
                            if (imageView3 != null) {
                                ...
                                if (progressBar != null) {
                                    ...
                                    if (relativeLayout != null) {
                                        ...
                                        if (frameLayout != null) {
                                            return new AssistantChatRightTextMessageBinding((RelativeLayout) view, normalCircleImageView, linearLayout, imageView, linearLayout2, imageView2, imageView3, progressBar, relativeLayout, frameLayout);
                                        }
                                    }
                                }
                            }
    ...
    @NonNull
    public static AssistantChatRightTextMessageBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static AssistantChatRightTextMessageBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R.layout.assistant_chat_right_text_message, viewGroup, false);
        if (z10) {
