...
public final class LayoutRankListHeaderFirstAreaBinding implements ViewBinding {
    @NonNull
    ...
    @NonNull
    public final FrameLayout firstArea;
    @NonNull
    ...
    private LayoutRankListHeaderFirstAreaBinding(@NonNull FrameLayout frameLayout, @NonNull HeadPortraitView headPortraitView, @NonNull LinearLayout linearLayout, @NonNull LinearLayout linearLayout2, @NonNull LinearLayout linearLayout3, @NonNull FrameLayout frameLayout2, @NonNull ImageView imageView, @NonNull ImageView imageView2, @NonNull LevelView levelView, @NonNull TextView textView, @NonNull TextView textView2, @NonNull TextView textView3) {
    ...
    @NonNull
    public static LayoutRankListHeaderFirstAreaBinding bind(@NonNull View view) {
                                ...
                                if (levelView != null) {
                                    ...
                                    if (textView != null) {
                                        ...
                                        if (textView2 != null) {
                                            ...
                                            if (textView3 != null) {
                                                return new LayoutRankListHeaderFirstAreaBinding(frameLayout, headPortraitView, linearLayout, linearLayout2, linearLayout3, frameLayout, imageView, imageView2, levelView, textView, textView2, textView3);
                                            }
                                        }
                                    }
                                }
    ...
    @NonNull
    public static LayoutRankListHeaderFirstAreaBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static LayoutRankListHeaderFirstAreaBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R.layout.layout_rank_list_header_first_area, viewGroup, false);
        if (z10) {
