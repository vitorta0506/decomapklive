...
public final class LayoutRankListHeaderSecondAreaBinding implements ViewBinding {
    @NonNull
    ...
    @NonNull
    public final FrameLayout seconArea;
    @NonNull
    ...
    @NonNull
    public static LayoutRankListHeaderSecondAreaBinding bind(@NonNull View view) {
                                ...
                                if (levelView != null) {
                                    ...
                                    if (textView != null) {
                                        ...
                                        if (textView2 != null) {
                                            ...
                                            if (textView3 != null) {
                                                return new LayoutRankListHeaderSecondAreaBinding(frameLayout, headPortraitView, linearLayout, linearLayout2, linearLayout3, imageView, imageView2, levelView, frameLayout, textView, textView2, textView3);
                                            }
                                        }
                                    }
                                }
    ...
    @NonNull
    public static LayoutRankListHeaderSecondAreaBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static LayoutRankListHeaderSecondAreaBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R.layout.layout_rank_list_header_second_area, viewGroup, false);
        if (z10) {
