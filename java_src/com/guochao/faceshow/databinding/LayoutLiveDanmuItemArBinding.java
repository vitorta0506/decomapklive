...
public final class LayoutLiveDanmuItemArBinding implements ViewBinding {
    @NonNull
    ...
    private LayoutLiveDanmuItemArBinding(@NonNull FrameLayout frameLayout, @NonNull DrawableView drawableView, @NonNull VipBackgroundView vipBackgroundView, @NonNull TextView textView, @NonNull DrawableView drawableView2, @NonNull TextView textView2, @NonNull VipIndicatorView vipIndicatorView) {
    ...
    @NonNull
    public static LayoutLiveDanmuItemArBinding bind(@NonNull View view) {
        int i9 = R.id.avatar;
                    ...
                    if (drawableView2 != null) {
                        ...
                        if (textView2 != null) {
                            ...
                            if (vipIndicatorView != null) {
                                return new LayoutLiveDanmuItemArBinding((FrameLayout) view, drawableView, vipBackgroundView, textView, drawableView2, textView2, vipIndicatorView);
                            }
                        }
                    }
                }
    ...
    @NonNull
    public static LayoutLiveDanmuItemArBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static LayoutLiveDanmuItemArBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R.layout.layout_live_danmu_item_ar, viewGroup, false);
        if (z10) {
