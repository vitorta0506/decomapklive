...
public final class VideoListSelfBinding implements ViewBinding {
    @NonNull
    ...
    @NonNull
    public static VideoListSelfBinding bind(@NonNull View view) {
    ...
    @NonNull
    public static VideoListSelfBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static VideoListSelfBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R.layout.video_list_self, viewGroup, false);
        if (z10) {
