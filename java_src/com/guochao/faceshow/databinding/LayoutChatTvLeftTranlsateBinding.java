...
public final class LayoutChatTvLeftTranlsateBinding implements ViewBinding {
    @NonNull
    ...
    private LayoutChatTvLeftTranlsateBinding(@NonNull LinearLayout linearLayout, @NonNull FrameLayout frameLayout, @NonNull ImageView imageView, @NonNull View view, @NonNull ControlClickSpanTextView controlClickSpanTextView, @NonNull TextView textView, @NonNull ControlClickSpanTextView controlClickSpanTextView2) {
    ...
    @NonNull
    public static LayoutChatTvLeftTranlsateBinding bind(@NonNull View view) {
                    ...
                    if (controlClickSpanTextView != null) {
                        ...
                        if (textView != null) {
                            ...
                            if (controlClickSpanTextView2 != null) {
                                return new LayoutChatTvLeftTranlsateBinding((LinearLayout) view, frameLayout, imageView, findChildViewById, controlClickSpanTextView, textView, controlClickSpanTextView2);
                            }
                        }
                    }
                }
    ...
    @NonNull
    public static LayoutChatTvLeftTranlsateBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static LayoutChatTvLeftTranlsateBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R.layout.layout_chat_tv_left_tranlsate, viewGroup, false);
        if (z10) {
