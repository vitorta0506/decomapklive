...
public final class LiveAreaSettingFragment extends GCCoreFragment {
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006¨\u0006\u0007"}, d2 = {"Lcom/guochao/faceshow/mine/view/fragment/LiveAreaSettingFragment$Companion;", "", "()V", "getInstance", "Lcom/guochao/faceshow/mine/view/fragment/LiveAreaSettingFragment;", "countryStateBean", "Lcom/guochao/faceshow/aaspring/beans/CountryStateBean;", "app_GooglePlayRelease"}, k = 1, mv = {1, 7, 1}, xi = 48)
    /* loaded from: classes4.dex */
    public static final class Companion {
        ...
        @NotNull
        public final LiveAreaSettingFragment getInstance(@NotNull CountryStateBean countryStateBean) {
            Intrinsics.checkNotNullParameter(countryStateBean, "countryStateBean");
            LiveAreaSettingFragment liveAreaSettingFragment = new LiveAreaSettingFragment();
            Bundle bundle = new Bundle();
            bundle.putParcelable("data", countryStateBean);
            liveAreaSettingFragment.setArguments(bundle);
            return liveAreaSettingFragment;
        }
    }
    ...
    public void initView(@NotNull View root, @Nullable Bundle bundle) {
        ...
        getViewBinding().getRoot().setLayoutManager(new LinearLayoutManager(getContext(), 1, false));
        getViewBinding().getRoot().setAdapter(new LiveAreaSettingFragment$initView$2(this));
    }
