...
public final class ActivityComplaintBinding implements ViewBinding {
    ...
    private ActivityComplaintBinding(@NonNull ConstraintLayout constraintLayout, @NonNull Button button, @NonNull ConstraintLayout constraintLayout2, @NonNull ConstraintLayout constraintLayout3, @NonNull EditText editText, @NonNull TextView textView, @NonNull LinearLayoutCompat linearLayoutCompat, @NonNull TextView textView2, @NonNull TextView textView3, @NonNull LinearLayoutCompat linearLayoutCompat2, @NonNull RecyclerView recyclerView, @NonNull TextView textView4, @NonNull TextView textView5, @NonNull TextView textView6, @NonNull GcBaseTitleBarBinding gcBaseTitleBarBinding) {
                                            ...
                                            if (recyclerView != null) {
                                                ...
                                                if (textView4 != null) {
                                                    ...
                                                    if (textView5 != null) {
                                                        ...
                                                        if (textView6 != null && (findChildViewById = ViewBindings.findChildViewById(view, (i9 = R$id.title_bar))) != null) {
                                                            return new ActivityComplaintBinding((ConstraintLayout) view, button, constraintLayout, constraintLayout2, editText, textView, linearLayoutCompat, textView2, textView3, linearLayoutCompat2, recyclerView, textView4, textView5, textView6, GcBaseTitleBarBinding.bind(findChildViewById));
                                                        }
                                                    }
                                                }
                                            }
