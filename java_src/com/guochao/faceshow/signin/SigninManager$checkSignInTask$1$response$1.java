...
@DebugMetadata(c = "com.guochao.faceshow.signin.SigninManager$checkSignInTask$1$response$1", f = "SigninManager.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes4.dex */
final class SigninManager$checkSignInTask$1$response$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Response<SigninBean>>, Object> {
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    public SigninManager$checkSignInTask$1$response$1(Continuation<? super SigninManager$checkSignInTask$1$response$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new SigninManager$checkSignInTask$1$response$1(continuation);
    }
    ...
    public final Object mo1invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Response<SigninBean>> continuation) {
        return ((SigninManager$checkSignInTask$1$response$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
