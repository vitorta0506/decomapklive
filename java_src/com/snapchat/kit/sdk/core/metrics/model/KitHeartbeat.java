...
public final class KitHeartbeat extends Message<KitHeartbeat, Builder> {
    ...
    private static final class ProtoAdapter_KitHeartbeat extends ProtoAdapter<KitHeartbeat> {
        ...
        /* JADX WARN: Type inference failed for: r3v1, types: [com.snapchat.kit.sdk.core.metrics.model.KitHeartbeat$Builder, com.squareup.wire.Message$Builder] */
        @Override // com.squareup.wire.ProtoAdapter
    ...
    public final String toString() {
        ...
        StringBuilder replace = sb2.replace(0, 2, "KitHeartbeat{");
        replace.append('}');
    ...
    public final Message.Builder<KitHeartbeat, Builder> newBuilder2() {
        Builder builder = new Builder();
