...
public final class WallGetRepostsResponse {
    ...
    public static /* synthetic */ WallGetRepostsResponse copy$default(WallGetRepostsResponse wallGetRepostsResponse, List list, List list2, List list3, int i9, Object obj) {
        if ((i9 & 1) != 0) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof WallGetRepostsResponse) {
            ...
            return Intrinsics.areEqual(this.items, wallGetRepostsResponse.items) && Intrinsics.areEqual(this.profiles, wallGetRepostsResponse.profiles) && Intrinsics.areEqual(this.groups, wallGetRepostsResponse.groups);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "WallGetRepostsResponse(items=" + list + ", profiles=" + list2 + ", groups=" + list3 + ")";
    }
}
