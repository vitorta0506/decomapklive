...
public final class BaseStickerNew {
    ...
    public static /* synthetic */ BaseStickerNew copy$default(BaseStickerNew baseStickerNew, Integer num, Integer num2, List list, List list2, String str, List list3, Boolean bool, int i9, Object obj) {
        if ((i9 & 1) != 0) {
        ...
        if ((i9 & 4) != 0) {
            list4 = baseStickerNew.images;
        }
        List list5 = list4;
        List<BaseImage> list6 = list2;
        if ((i9 & 8) != 0) {
            list6 = baseStickerNew.imagesWithBackground;
        }
        List list7 = list6;
        if ((i9 & 16) != 0) {
        ...
        if ((i9 & 32) != 0) {
            list8 = baseStickerNew.animations;
        }
        List list9 = list8;
        if ((i9 & 64) != 0) {
            bool = baseStickerNew.isAllowed;
        }
        return baseStickerNew.copy(num, num3, list5, list7, str2, list9, bool);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof BaseStickerNew) {
            ...
            return Intrinsics.areEqual(this.stickerId, baseStickerNew.stickerId) && Intrinsics.areEqual(this.productId, baseStickerNew.productId) && Intrinsics.areEqual(this.images, baseStickerNew.images) && Intrinsics.areEqual(this.imagesWithBackground, baseStickerNew.imagesWithBackground) && Intrinsics.areEqual(this.animationUrl, baseStickerNew.animationUrl) && Intrinsics.areEqual(this.animations, baseStickerNew.animations) && Intrinsics.areEqual(this.isAllowed, baseStickerNew.isAllowed);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        List<BaseStickerAnimation> list3 = this.animations;
        Boolean bool = this.isAllowed;
        return "BaseStickerNew(stickerId=" + num + ", productId=" + num2 + ", images=" + list + ", imagesWithBackground=" + list2 + ", animationUrl=" + str + ", animations=" + list3 + ", isAllowed=" + bool + ")";
    }

    public /* synthetic */ BaseStickerNew(Integer num, Integer num2, List list, List list2, String str, List list3, Boolean bool, int i9, DefaultConstructorMarker defaultConstructorMarker) {
