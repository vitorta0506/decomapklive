...
public final class NewsfeedGetResponse {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ NewsfeedGetResponse copy$default(NewsfeedGetResponse newsfeedGetResponse, List list, List list2, List list3, String str, int i9, Object obj) {
        if ((i9 & 1) != 0) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof NewsfeedGetResponse) {
            ...
            return Intrinsics.areEqual(this.items, newsfeedGetResponse.items) && Intrinsics.areEqual(this.profiles, newsfeedGetResponse.profiles) && Intrinsics.areEqual(this.groups, newsfeedGetResponse.groups) && Intrinsics.areEqual(this.nextFrom, newsfeedGetResponse.nextFrom);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        List<GroupsGroupFull> list3 = this.groups;
        String str = this.nextFrom;
        return "NewsfeedGetResponse(items=" + list + ", profiles=" + list2 + ", groups=" + list3 + ", nextFrom=" + str + ")";
    }

    public /* synthetic */ NewsfeedGetResponse(List list, List list2, List list3, String str, int i9, DefaultConstructorMarker defaultConstructorMarker) {
