...
public final class MessagesGetImportantMessagesResponse {
    ...
    public static /* synthetic */ MessagesGetImportantMessagesResponse copy$default(MessagesGetImportantMessagesResponse messagesGetImportantMessagesResponse, MessagesMessagesArray messagesMessagesArray, List list, List list2, List list3, int i9, Object obj) {
        if ((i9 & 1) != 0) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof MessagesGetImportantMessagesResponse) {
            ...
            return Intrinsics.areEqual(this.messages, messagesGetImportantMessagesResponse.messages) && Intrinsics.areEqual(this.profiles, messagesGetImportantMessagesResponse.profiles) && Intrinsics.areEqual(this.groups, messagesGetImportantMessagesResponse.groups) && Intrinsics.areEqual(this.conversations, messagesGetImportantMessagesResponse.conversations);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        List<GroupsGroupFull> list2 = this.groups;
        List<MessagesConversation> list3 = this.conversations;
        return "MessagesGetImportantMessagesResponse(messages=" + messagesMessagesArray + ", profiles=" + list + ", groups=" + list2 + ", conversations=" + list3 + ")";
    }

    public /* synthetic */ MessagesGetImportantMessagesResponse(MessagesMessagesArray messagesMessagesArray, List list, List list2, List list3, int i9, DefaultConstructorMarker defaultConstructorMarker) {
