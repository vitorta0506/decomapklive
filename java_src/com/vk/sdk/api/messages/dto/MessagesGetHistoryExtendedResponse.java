...
public final class MessagesGetHistoryExtendedResponse {
    ...
    public MessagesGetHistoryExtendedResponse(int i9, @NotNull List<MessagesMessage> items, @Nullable List<UsersUserFull> list, @Nullable List<GroupsGroupFull> list2, @Nullable List<MessagesConversation> list3) {
    ...
    public static /* synthetic */ MessagesGetHistoryExtendedResponse copy$default(MessagesGetHistoryExtendedResponse messagesGetHistoryExtendedResponse, int i9, List list, List list2, List list3, List list4, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            i9 = messagesGetHistoryExtendedResponse.count;
        }
        List<MessagesMessage> list5 = list;
        if ((i10 & 2) != 0) {
            list5 = messagesGetHistoryExtendedResponse.items;
        }
        List list6 = list5;
        List<UsersUserFull> list7 = list2;
        if ((i10 & 4) != 0) {
            list7 = messagesGetHistoryExtendedResponse.profiles;
        }
        List list8 = list7;
        List<GroupsGroupFull> list9 = list3;
        if ((i10 & 8) != 0) {
            list9 = messagesGetHistoryExtendedResponse.groups;
        }
        List list10 = list9;
        List<MessagesConversation> list11 = list4;
        if ((i10 & 16) != 0) {
            list11 = messagesGetHistoryExtendedResponse.conversations;
        }
        return messagesGetHistoryExtendedResponse.copy(i9, list6, list8, list10, list11);
    }
    ...
    @NotNull
    public final MessagesGetHistoryExtendedResponse copy(int i9, @NotNull List<MessagesMessage> items, @Nullable List<UsersUserFull> list, @Nullable List<GroupsGroupFull> list2, @Nullable List<MessagesConversation> list3) {
        Intrinsics.checkNotNullParameter(items, "items");
        return new MessagesGetHistoryExtendedResponse(i9, items, list, list2, list3);
    }
    ...
    public String toString() {
        ...
        return "MessagesGetHistoryExtendedResponse(count=" + i9 + ", items=" + list + ", profiles=" + list2 + ", groups=" + list3 + ", conversations=" + list4 + ")";
    }

    public /* synthetic */ MessagesGetHistoryExtendedResponse(int i9, List list, List list2, List list3, List list4, int i10, DefaultConstructorMarker defaultConstructorMarker) {
