...
public final class TypeReference implements KType {
    ...
    public TypeReference(@NotNull KClassifier classifier, @NotNull List<KTypeProjection> arguments, @Nullable KType kType, int i9) {
    ...
    public final String asString(KTypeProjection kTypeProjection) {
        ...
        int i9 = WhenMappings.$EnumSwitchMapping$0[kTypeProjection.getVariance().ordinal()];
        if (i9 != 1) {
            if (i9 == 2) {
                return "in " + valueOf;
            } else if (i9 == 3) {
