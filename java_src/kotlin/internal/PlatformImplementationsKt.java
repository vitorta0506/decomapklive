...
public final class PlatformImplementationsKt {
    ...
    public static final boolean apiVersionIsAtLeast(int i9, int i10, int i11) {
        return KotlinVersion.CURRENT.isAtLeast(i9, i10, i11);
    }
    ...
    private static final int getJavaVersion() {
        ...
        indexOf$default2 = StringsKt__StringsKt.indexOf$default((CharSequence) property, (char) JwtParser.SEPARATOR_CHAR, i9, false, 4, (Object) null);
        if (indexOf$default2 < 0) {
            indexOf$default2 = property.length();
        }
        String substring = property.substring(0, indexOf$default);
        Intrinsics.checkNotNullExpressionValue(substring, "this as java.lang.String…ing(startIndex, endIndex)");
        String substring2 = property.substring(i9, indexOf$default2);
