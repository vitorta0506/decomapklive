...
public final class StreamsKt {
    ...
    public static final <T> Stream<T> asStream(@NotNull final Sequence<? extends T> sequence) {
        ...
        Stream<T> stream = StreamSupport.stream(new Supplier() { // from class: kotlin.streams.jdk8.a
            ...
            public final Object get() {
                Spliterator m2962asStream$lambda4;
                m2962asStream$lambda4 = StreamsKt.m2962asStream$lambda4(Sequence.this);
                return m2962asStream$lambda4;
            }
        }, 16, false);
    ...
    public static final Spliterator m2962asStream$lambda4(Sequence this_asStream) {
