...
public final class UByteArrayKt {
    ...
    @InlineOnly
    private static final byte[] UByteArray(int i9, Function1<? super Integer, UByte> init) {
        Intrinsics.checkNotNullParameter(init, "init");
        byte[] bArr = new byte[i9];
        for (int i10 = 0; i10 < i9; i10++) {
            bArr[i10] = init.invoke(Integer.valueOf(i10)).m1724unboximpl();
        }
        return UByteArray.m1727constructorimpl(bArr);
    }
    ...
    private static final byte[] m1743ubyteArrayOfGBYM_sE(byte... elements) {
