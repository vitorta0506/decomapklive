...
class StringsKt__StringBuilderJVMKt extends StringsKt__RegexExtensionsKt {
    ...
    @InlineOnly
    private static final StringBuilder appendRange(StringBuilder sb2, char[] value, int i9, int i10) {
        Intrinsics.checkNotNullParameter(sb2, "<this>");
    ...
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    @InlineOnly
    private static final StringBuilder deleteAt(StringBuilder sb2, int i9) {
        Intrinsics.checkNotNullParameter(sb2, "<this>");
    ...
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    @InlineOnly
    private static final StringBuilder deleteRange(StringBuilder sb2, int i9, int i10) {
        Intrinsics.checkNotNullParameter(sb2, "<this>");
    ...
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    @InlineOnly
    private static final StringBuilder insertRange(StringBuilder sb2, int i9, char[] value, int i10, int i11) {
        Intrinsics.checkNotNullParameter(sb2, "<this>");
        Intrinsics.checkNotNullParameter(value, "value");
    ...
    @InlineOnly
    private static final void set(StringBuilder sb2, int i9, char c10) {
        Intrinsics.checkNotNullParameter(sb2, "<this>");
        sb2.setCharAt(i9, c10);
    }

    @SinceKotlin(version = "1.4")
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    @InlineOnly
    private static final StringBuilder setRange(StringBuilder sb2, int i9, int i10, String value) {
        Intrinsics.checkNotNullParameter(sb2, "<this>");
        Intrinsics.checkNotNullParameter(value, "value");
    ...
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    @InlineOnly
    private static final void toCharArray(StringBuilder sb2, char[] destination, int i9, int i10, int i11) {
        Intrinsics.checkNotNullParameter(sb2, "<this>");
        Intrinsics.checkNotNullParameter(destination, "destination");
        sb2.getChars(i10, i11, destination, i9);
    }

    static /* synthetic */ void toCharArray$default(StringBuilder sb2, char[] destination, int i9, int i10, int i11, int i12, Object obj) {
        if ((i12 & 2) != 0) {
            i9 = 0;
        }
        if ((i12 & 4) != 0) {
    ...
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    @InlineOnly
    private static final StringBuilder appendRange(StringBuilder sb2, CharSequence value, int i9, int i10) {
        Intrinsics.checkNotNullParameter(sb2, "<this>");
        Intrinsics.checkNotNullParameter(value, "value");
    ...
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    @InlineOnly
    private static final StringBuilder insertRange(StringBuilder sb2, int i9, CharSequence value, int i10, int i11) {
        Intrinsics.checkNotNullParameter(sb2, "<this>");
        Intrinsics.checkNotNullParameter(value, "value");
    ...
    @SinceKotlin(version = "1.4")
    @InlineOnly
    private static final StringBuilder appendLine(StringBuilder sb2, int i9) {
        Intrinsics.checkNotNullParameter(sb2, "<this>");
        sb2.append(i9);
        Intrinsics.checkNotNullExpressionValue(sb2, "append(value)");
        sb2.append('\n');
    ...
    @Deprecated(level = DeprecationLevel.WARNING, message = "Use appendLine instead. Note that the new method always appends the line feed character '\\n' regardless of the system line separator.", replaceWith = @ReplaceWith(expression = "appendLine(value)", imports = {}))
    @InlineOnly
    private static final StringBuilder appendln(StringBuilder sb2, int i9) {
        Intrinsics.checkNotNullParameter(sb2, "<this>");
        sb2.append(i9);
        Intrinsics.checkNotNullExpressionValue(sb2, "append(value)");
        return appendln(sb2);
