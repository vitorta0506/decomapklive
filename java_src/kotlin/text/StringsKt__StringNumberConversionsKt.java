...
public class StringsKt__StringNumberConversionsKt extends StringsKt__StringNumberConversionsJVMKt {
    ...
    @SinceKotlin(version = "1.1")
    @Nullable
    public static final Byte toByteOrNull(@NotNull String str, int i9) {
        int intValue;
        Intrinsics.checkNotNullParameter(str, "<this>");
        Integer intOrNull = toIntOrNull(str, i9);
    ...
    @SinceKotlin(version = "1.1")
    @Nullable
    public static final Integer toIntOrNull(@NotNull String str, int i9) {
        boolean z10;
        int i10;
        Intrinsics.checkNotNullParameter(str, "<this>");
        ...
        int i14 = -59652323;
        while (i13 < length) {
            int digitOf = CharsKt__CharJVMKt.digitOf(str.charAt(i13), i9);
            if (digitOf < 0) {
                return null;
            }
            if ((i11 < i14 && (i14 != -59652323 || i11 < (i14 = i12 / i9))) || (i10 = i11 * i9) < i12 + digitOf) {
                return null;
            }
            i11 = i10 - digitOf;
            i13++;
    ...
    */
    ...
    @SinceKotlin(version = "1.1")
    @Nullable
    public static final Short toShortOrNull(@NotNull String str, int i9) {
        int intValue;
        Intrinsics.checkNotNullParameter(str, "<this>");
        Integer intOrNull = toIntOrNull(str, i9);
