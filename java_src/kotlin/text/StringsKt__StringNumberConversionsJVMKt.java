...
public class StringsKt__StringNumberConversionsJVMKt extends StringsKt__StringBuilderKt {
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final String toString(byte b10, int i9) {
        int checkRadix;
        int checkRadix2;
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final BigInteger toBigInteger(String str, int i9) {
        int checkRadix;
        Intrinsics.checkNotNullParameter(str, "<this>");
        checkRadix = CharsKt__CharJVMKt.checkRadix(i9);
    ...
    @SinceKotlin(version = "1.2")
    @Nullable
    public static final BigInteger toBigIntegerOrNull(@NotNull String str, int i9) {
        int checkRadix;
        Intrinsics.checkNotNullParameter(str, "<this>");
        ...
        if (length != 0) {
            ...
            } else if (CharsKt__CharJVMKt.digitOf(str.charAt(0), i9) < 0) {
                return null;
            }
            checkRadix = CharsKt__CharJVMKt.checkRadix(i9);
            return new BigInteger(str, checkRadix);
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final byte toByte(String str, int i9) {
        int checkRadix;
        Intrinsics.checkNotNullParameter(str, "<this>");
        checkRadix = CharsKt__CharJVMKt.checkRadix(i9);
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final int toInt(String str, int i9) {
        int checkRadix;
        Intrinsics.checkNotNullParameter(str, "<this>");
        checkRadix = CharsKt__CharJVMKt.checkRadix(i9);
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final long toLong(String str, int i9) {
        int checkRadix;
        Intrinsics.checkNotNullParameter(str, "<this>");
        checkRadix = CharsKt__CharJVMKt.checkRadix(i9);
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final short toShort(String str, int i9) {
        int checkRadix;
        Intrinsics.checkNotNullParameter(str, "<this>");
        checkRadix = CharsKt__CharJVMKt.checkRadix(i9);
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final String toString(short s10, int i9) {
        int checkRadix;
        int checkRadix2;
        checkRadix = CharsKt__CharJVMKt.checkRadix(i9);
        checkRadix2 = CharsKt__CharJVMKt.checkRadix(checkRadix);
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final String toString(int i9, int i10) {
        int checkRadix;
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final String toString(long j10, int i9) {
        int checkRadix;
        checkRadix = CharsKt__CharJVMKt.checkRadix(i9);
