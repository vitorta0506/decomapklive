...
public enum CharDirectionality {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final CharDirectionality valueOf(int i9) {
            CharDirectionality charDirectionality = getDirectionalityMap().get(Integer.valueOf(i9));
