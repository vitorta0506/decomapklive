...
public class StringsKt__IndentKt extends StringsKt__AppendableKt {
    ...
    private static final int indentWidth$StringsKt__IndentKt(String str) {
        ...
        while (true) {
            if (i9 >= length) {
                i9 = -1;
                break;
            } else if (!CharsKt__CharJVMKt.isWhitespace(str.charAt(i9))) {
                break;
            } else {
                i9++;
            }
    ...
    public static final String prependIndent(@NotNull String str, @NotNull final String indent) {
        ...
        joinToString$default = SequencesKt___SequencesKt.joinToString$default(map, IOUtils.LINE_SEPARATOR_UNIX, null, null, 0, null, null, 62, null);
