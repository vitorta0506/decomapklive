...
public class CharsKt__CharJVMKt {
    ...
    public static int checkRadix(int i9) {
        if (new IntRange(2, 36).contains(i9)) {
            return i9;
        }
        throw new IllegalArgumentException("radix " + i9 + " was not in valid range " + new IntRange(2, 36));
    }

    public static final int digitOf(char c10, int i9) {
