...
public enum CharCategory {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final CharCategory valueOf(int i9) {
            if (new IntRange(0, 16).contains(i9)) {
                return CharCategory.values()[i9];
            }
            if (new IntRange(18, 30).contains(i9)) {
                return CharCategory.values()[i9 - 1];
            }
            throw new IllegalArgumentException("Category #" + i9 + " is not defined.");
        }
    }

    CharCategory(int i9, String str) {
        this.value = i9;
        this.code = str;
    }
