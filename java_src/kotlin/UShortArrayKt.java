...
public final class UShortArrayKt {
    ...
    @InlineOnly
    private static final short[] UShortArray(int i9, Function1<? super Integer, UShort> init) {
        Intrinsics.checkNotNullParameter(init, "init");
        short[] sArr = new short[i9];
        for (int i10 = 0; i10 < i9; i10++) {
            sArr[i10] = init.invoke(Integer.valueOf(i10)).m1984unboximpl();
        }
        return UShortArray.m1987constructorimpl(sArr);
    }
    ...
    private static final short[] m2003ushortArrayOfrL5Bavg(short... elements) {
