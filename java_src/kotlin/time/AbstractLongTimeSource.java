...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    private static final class LongTimeMark implements TimeMark {
        ...
        public TimeMark mo2977plusLRDsOJo(long j10) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m3019plusLRDsOJo(this.offset, j10), null);
        }
    }
    ...
    public TimeMark markNow() {
        return new LongTimeMark(read(), this, Duration.Companion.m3085getZEROUwyO8pc(), null);
    }
