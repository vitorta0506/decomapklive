...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m3135copyRFiDyg4$default(TimedValue timedValue, Object obj, long j10, int i9, Object obj2) {
        if ((i9 & 1) != 0) {
        ...
        return timedValue.m3137copyRFiDyg4(obj, j10);
    }
    ...
    public final long m3136component2UwyO8pc() {
        return this.duration;
    }

    @NotNull
    /* renamed from: copy-RFiDyg4  reason: not valid java name */
    public final TimedValue<T> m3137copyRFiDyg4(T t10, long j10) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof TimedValue) {
            ...
            return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m2988equalsimpl0(this.duration, timedValue.duration);
        }
        return false;
    }

    /* renamed from: getDuration-UwyO8pc  reason: not valid java name */
    public final long m3138getDurationUwyO8pc() {
        return this.duration;
    }
    ...
    public int hashCode() {
        T t10 = this.value;
        return ((t10 == null ? 0 : t10.hashCode()) * 31) + Duration.m3011hashCodeimpl(this.duration);
    }

    @NotNull
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m3032toStringimpl(this.duration)) + ')';
    }
}
