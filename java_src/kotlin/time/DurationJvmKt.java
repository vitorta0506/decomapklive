...
public final class DurationJvmKt {
    ...
    private static final DecimalFormat createFormatForDecimals(int i9) {
    ...
    @NotNull
    public static final String formatToExactDecimals(double d10, int i9) {
        ...
        if (i9 < threadLocalArr.length) {
            ThreadLocal<DecimalFormat> threadLocal = threadLocalArr[i9];
            DecimalFormat decimalFormat = threadLocal.get();
            if (decimalFormat == null) {
                decimalFormat = createFormatForDecimals(i9);
            ...
            createFormatForDecimals = createFormatForDecimals(i9);
        }
    ...
    @NotNull
    public static final String formatUpToDecimals(double d10, int i9) {
        DecimalFormat createFormatForDecimals = createFormatForDecimals(0);
        createFormatForDecimals.setMaximumFractionDigits(i9);
        String format = createFormatForDecimals.format(d10);
