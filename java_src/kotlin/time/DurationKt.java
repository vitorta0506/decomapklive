...
public final class DurationKt {
    ...
    public static final long durationOf(long j10, int i9) {
        return Duration.m2983constructorimpl((j10 << 1) + i9);
    }

    public static final long durationOfMillis(long j10) {
        return Duration.m2983constructorimpl((j10 << 1) + 1);
    }

    public static final long durationOfMillisNormalized(long j10) {
        long coerceIn;
        if (new LongRange(-4611686018426L, MAX_NANOS_IN_MILLIS).contains(j10)) {
            return durationOfNanos(millisToNanos(j10));
        }
        coerceIn = RangesKt___RangesKt.coerceIn(j10, -4611686018427387903L, (long) MAX_MILLIS);
        return durationOfMillis(coerceIn);
    }

    public static final long durationOfNanos(long j10) {
        return Duration.m2983constructorimpl(j10 << 1);
    }

    public static final long durationOfNanosNormalized(long j10) {
        if (new LongRange(-4611686018426999999L, MAX_NANOS).contains(j10)) {
    ...
    public static final long getDays(int i9) {
        return toDuration(i9, DurationUnit.DAYS);
    }
    ...
    public static final long getHours(int i9) {
        return toDuration(i9, DurationUnit.HOURS);
    }
    ...
    public static final long getMicroseconds(int i9) {
        return toDuration(i9, DurationUnit.MICROSECONDS);
    }
    ...
    public static final long getMilliseconds(int i9) {
        return toDuration(i9, DurationUnit.MILLISECONDS);
    }
    ...
    public static final long getMinutes(int i9) {
        return toDuration(i9, DurationUnit.MINUTES);
    }
    ...
    public static final long getNanoseconds(int i9) {
        return toDuration(i9, DurationUnit.NANOSECONDS);
    }
    ...
    public static final long getSeconds(int i9) {
        return toDuration(i9, DurationUnit.SECONDS);
    }
    ...
    */
    ...
    private static final int skipWhile(String str, int i9, Function1<? super Character, Boolean> function1) {
    ...
    private static final String substringWhile(String str, int i9, Function1<? super Character, Boolean> function1) {
        int i10 = i9;
    ...
    private static final long m3108timeskIfJnKk(double d10, long j10) {
        return Duration.m3020timesUwyO8pc(j10, d10);
    }
    ...
    private static final long m3109timesmvk6XK0(int i9, long j10) {
        return Duration.m3021timesUwyO8pc(j10, i9);
    }

    @SinceKotlin(version = "1.6")
    @WasExperimental(markerClass = {ExperimentalTime.class})
    public static final long toDuration(int i9, @NotNull DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if (unit.compareTo(DurationUnit.SECONDS) <= 0) {
            return durationOfNanos(DurationUnitKt__DurationUnitJvmKt.convertDurationUnitOverflow(i9, unit, DurationUnit.NANOSECONDS));
        }
        return toDuration(i9, unit);
    }
    ...
    public static final long toDuration(long j10, @NotNull DurationUnit unit) {
        ...
        coerceIn = RangesKt___RangesKt.coerceIn(DurationUnitKt__DurationUnitJvmKt.convertDurationUnit(j10, unit, DurationUnit.MILLISECONDS), -4611686018427387903L, (long) MAX_MILLIS);
        return durationOfMillis(coerceIn);
    }
    ...
    public static final long toDuration(double d10, @NotNull DurationUnit unit) {
        ...
        if (!Double.isNaN(convertDurationUnit)) {
            ...
            roundToLong2 = MathKt__MathJVMKt.roundToLong(DurationUnitKt__DurationUnitJvmKt.convertDurationUnit(d10, unit, DurationUnit.MILLISECONDS));
