...
public final class TypesJVMKt {
        ...
        if (classifier instanceof KClass) {
            ...
            if (javaObjectType.isArray()) {
                ...
                if (kTypeProjection != null) {
                    ...
                    int i9 = component1 == null ? -1 : WhenMappings.$EnumSwitchMapping$0[component1.ordinal()];
                    if (i9 == -1 || i9 == 1) {
                        return javaObjectType;
                    }
                    if (i9 != 2 && i9 != 3) {
    ...
    static /* synthetic */ Type computeJavaType$default(KType kType, boolean z10, int i9, Object obj) {
        if ((i9 & 1) != 0) {
            z10 = false;
        }
    ...
    private static final Type getJavaType(KTypeProjection kTypeProjection) {
        ...
        int i9 = WhenMappings.$EnumSwitchMapping$0[variance.ordinal()];
        if (i9 != 1) {
            if (i9 != 2) {
                if (i9 == 3) {
