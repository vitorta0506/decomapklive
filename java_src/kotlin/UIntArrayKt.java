...
public final class UIntArrayKt {
    ...
    @InlineOnly
    private static final int[] UIntArray(int i9, Function1<? super Integer, UInt> init) {
        Intrinsics.checkNotNullParameter(init, "init");
        int[] iArr = new int[i9];
        for (int i10 = 0; i10 < i9; i10++) {
            iArr[i10] = init.invoke(Integer.valueOf(i10)).m1802unboximpl();
        }
        return UIntArray.m1805constructorimpl(iArr);
    }
    ...
    private static final int[] m1821uintArrayOfajY9A(int... elements) {
