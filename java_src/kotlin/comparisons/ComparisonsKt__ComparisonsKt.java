...
public class ComparisonsKt__ComparisonsKt {
        ...
        if (selectors.length > 0) {
            return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$compareBy$1
                ...
                public final int compare(T t10, T t11) {
                    ...
                    compareValuesByImpl$ComparisonsKt__ComparisonsKt = ComparisonsKt__ComparisonsKt.compareValuesByImpl$ComparisonsKt__ComparisonsKt(t10, t11, selectors);
    ...
    public static final <T> int compareValuesByImpl$ComparisonsKt__ComparisonsKt(T t10, T t11, Function1<? super T, ? extends Comparable<?>>[] function1Arr) {
        int compareValues;
        for (Function1<? super T, ? extends Comparable<?>> function1 : function1Arr) {
            compareValues = compareValues(function1.invoke(t10), function1.invoke(t11));
            if (compareValues != 0) {
    ...
    private static final <T> Comparator<T> thenBy(final Comparator<T> comparator, final Function1<? super T, ? extends Comparable<?>> selector) {
        ...
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$thenBy$1
            ...
            public final int compare(T t10, T t11) {
                ...
                compareValues = ComparisonsKt__ComparisonsKt.compareValues(function1.invoke(t10), function1.invoke(t11));
                return compareValues;
            }
        };
    }
    ...
    private static final <T> Comparator<T> thenByDescending(final Comparator<T> comparator, final Function1<? super T, ? extends Comparable<?>> selector) {
        ...
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$thenByDescending$1
            ...
            public final int compare(T t10, T t11) {
                ...
                Function1<T, Comparable<?>> function1 = selector;
                compareValues = ComparisonsKt__ComparisonsKt.compareValues(function1.invoke(t11), function1.invoke(t10));
                return compareValues;
            }
        };
    }
    ...
    private static final <T> Comparator<T> thenComparator(final Comparator<T> comparator, final Function2<? super T, ? super T, Integer> comparison) {
        ...
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$thenComparator$1
            ...
            public final int compare(T t10, T t11) {
                int compare = comparator.compare(t10, t11);
                return compare != 0 ? compare : comparison.mo1invoke(t10, t11).intValue();
            }
        };
    }
    ...
    public static final <T> Comparator<T> thenDescending(@NotNull final Comparator<T> comparator, @NotNull final Comparator<? super T> comparator2) {
        ...
        return new Comparator() { // from class: kotlin.comparisons.ComparisonsKt__ComparisonsKt$thenDescending$1
            ...
            public final int compare(T t10, T t11) {
                int compare = comparator.compare(t10, t11);
                return compare != 0 ? compare : comparator2.compare(t11, t10);
            }
        };
    }
    ...
    private static final <T> int compareValuesBy(T t10, T t11, Function1<? super T, ? extends Comparable<?>> selector) {
        int compareValues;
        Intrinsics.checkNotNullParameter(selector, "selector");
        compareValues = compareValues(selector.invoke(t10), selector.invoke(t11));
        return compareValues;
    }
    ...
    private static final <T, K> int compareValuesBy(T t10, T t11, Comparator<? super K> comparator, Function1<? super T, ? extends K> selector) {
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        Intrinsics.checkNotNullParameter(selector, "selector");
        return comparator.compare((K) selector.invoke(t10), (K) selector.invoke(t11));
    }
}
