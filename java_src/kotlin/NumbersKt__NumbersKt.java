...
class NumbersKt__NumbersKt extends NumbersKt__NumbersJVMKt {
    ...
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    public static final byte rotateLeft(byte b10, int i9) {
        int i10 = i9 & 7;
    ...
    @SinceKotlin(version = "1.6")
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    public static final short rotateLeft(short s10, int i9) {
        int i10 = i9 & 15;
        return (short) (((s10 & 65535) >>> (16 - i10)) | (s10 << i10));
    }

    @SinceKotlin(version = "1.6")
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    public static final byte rotateRight(byte b10, int i9) {
        int i10 = i9 & 7;
    ...
    @SinceKotlin(version = "1.6")
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    public static final short rotateRight(short s10, int i9) {
        int i10 = i9 & 15;
        return (short) (((s10 & 65535) >>> i10) | (s10 << (16 - i10)));
    }
