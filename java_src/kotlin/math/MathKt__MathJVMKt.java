...
public class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    public static final double asinh(double d10) {
        ...
        } else if (d10 > Constants.upper_taylor_n_bound) {
            if (d10 > Constants.upper_taylor_2_bound) {
                return Math.log(d10) + Constants.LN2;
            }
            double d12 = d10 * 2;
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double pow(double d10, int i9) {
        return Math.pow(d10, i9);
    }
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double withSign(double d10, int i9) {
        return Math.copySign(d10, i9);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final int abs(int i9) {
        return Math.abs(i9);
    }

    private static final int getAbsoluteValue(int i9) {
        return Math.abs(i9);
    }
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final int min(int i9, int i10) {
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final float pow(float f10, int i9) {
        return (float) Math.pow(f10, i9);
    }
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final float withSign(float f10, int i9) {
        return Math.copySign(f10, i9);
    }
