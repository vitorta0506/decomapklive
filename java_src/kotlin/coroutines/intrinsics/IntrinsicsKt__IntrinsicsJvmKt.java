...
public class IntrinsicsKt__IntrinsicsJvmKt {
    ...
    private static final <R, T> Object startCoroutineUninterceptedOrReturn(Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r10, Continuation<? super T> completion) {
        ...
        Intrinsics.checkNotNullParameter(completion, "completion");
        return ((Function2) TypeIntrinsics.beforeCheckcastToFunctionOfArity(function2, 2)).mo1invoke(r10, completion);
    }
    ...
    public static <R, T> Continuation<Unit> createCoroutineUnintercepted(@NotNull final Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, final R r10, @NotNull Continuation<? super T> completion) {
            ...
            return new RestrictedContinuationImpl(probeCoroutineCreated, function2, r10) { // from class: kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnintercepted$$inlined$createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt$3
                ...
                protected Object invokeSuspend(@NotNull Object obj) {
                    ...
                    if (i9 == 0) {
                        ...
                        return ((Function2) TypeIntrinsics.beforeCheckcastToFunctionOfArity(this.$this_createCoroutineUnintercepted$inlined, 2)).mo1invoke(this.$receiver$inlined, this);
                    } else if (i9 == 1) {
                        this.label = 2;
                        ResultKt.throwOnFailure(obj);
                        return obj;
        ...
        return new ContinuationImpl(probeCoroutineCreated, context, function2, r10) { // from class: kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt$createCoroutineUnintercepted$$inlined$createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt$4
            final /* synthetic */ Object $receiver$inlined;
            final /* synthetic */ Function2 $this_createCoroutineUnintercepted$inlined;
            private int label;
