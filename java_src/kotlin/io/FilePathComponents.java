...
public final class FilePathComponents {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ FilePathComponents copy$default(FilePathComponents filePathComponents, File file, List list, int i9, Object obj) {
        if ((i9 & 1) != 0) {
    ...
    public final File subPath(int i9, int i10) {
        ...
        if (i9 >= 0 && i9 <= i10 && i10 <= getSize()) {
            List<File> subList = this.segments.subList(i9, i10);
