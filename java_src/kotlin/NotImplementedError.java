...
public final class NotImplementedError extends Error {
    ...
    public /* synthetic */ NotImplementedError(String str, int i9, DefaultConstructorMarker defaultConstructorMarker) {
        this((i9 & 1) != 0 ? "An operation is not implemented." : str);
    }
}
