...
public class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final <T extends Comparable<? super T>> T coerceIn(@NotNull T t10, @Nullable T t11, @Nullable T t12) {
        ...
        } else if (t11 != null && t10.compareTo(t11) < 0) {
            return t11;
        } else {
    ...
    @NotNull
    public static final IntProgression downTo(int i9, byte b10) {
        return IntProgression.Companion.fromClosedRange(i9, b10, -1);
    }
    ...
    @NotNull
    public static IntProgression step(@NotNull IntProgression intProgression, int i9) {
        Intrinsics.checkNotNullParameter(intProgression, "<this>");
        ...
        return companion.fromClosedRange(first, last, i9);
    }
    ...
    @NotNull
    public static final IntRange until(int i9, byte b10) {
        return new IntRange(i9, b10 - 1);
    }
    ...
    @JvmName(name = "byteRangeContains")
    public static final boolean byteRangeContains(@NotNull ClosedRange<Byte> closedRange, int i9) {
        Intrinsics.checkNotNullParameter(closedRange, "<this>");
    ...
    @DeprecatedSinceKotlin(errorSince = "1.4", hiddenSince = "1.5", warningSince = "1.3")
    @JvmName(name = "doubleRangeContains")
    public static final /* synthetic */ boolean doubleRangeContains(ClosedRange closedRange, int i9) {
        Intrinsics.checkNotNullParameter(closedRange, "<this>");
        return closedRange.contains(Double.valueOf(i9));
    }
    ...
    @DeprecatedSinceKotlin(errorSince = "1.4", hiddenSince = "1.5", warningSince = "1.3")
    @JvmName(name = "floatRangeContains")
    public static final /* synthetic */ boolean floatRangeContains(ClosedRange closedRange, int i9) {
        Intrinsics.checkNotNullParameter(closedRange, "<this>");
        return closedRange.contains(Float.valueOf(i9));
    }
    ...
    public static final Byte toByteExactOrNull(short s10) {
        if (intRangeContains((ClosedRange<Integer>) new IntRange(-128, 127), s10)) {
    ...
    @JvmName(name = "longRangeContains")
    public static final boolean longRangeContains(@NotNull ClosedRange<Long> closedRange, int i9) {
        Intrinsics.checkNotNullParameter(closedRange, "<this>");
        return closedRange.contains(Long.valueOf(i9));
    }
    ...
    @JvmName(name = "shortRangeContains")
    public static final boolean shortRangeContains(@NotNull ClosedRange<Short> closedRange, int i9) {
        Intrinsics.checkNotNullParameter(closedRange, "<this>");
    ...
    @NotNull
    public static final CharProgression step(@NotNull CharProgression charProgression, int i9) {
        Intrinsics.checkNotNullParameter(charProgression, "<this>");
        RangesKt__RangesKt.checkStepIsPositive(i9 > 0, Integer.valueOf(i9));
    ...
    public static IntProgression downTo(int i9, int i10) {
        return IntProgression.Companion.fromClosedRange(i9, i10, -1);
    }
    ...
    public static final byte coerceIn(byte b10, byte b11, byte b12) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((int) b12) + " is less than minimum " + ((int) b11) + JwtParser.SEPARATOR_CHAR);
    }

    @NotNull
    public static final LongProgression downTo(long j10, int i9) {
        return LongProgression.Companion.fromClosedRange(j10, i9, -1L);
    }
    ...
    public static final short coerceIn(short s10, short s11, short s12) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((int) s12) + " is less than minimum " + ((int) s11) + JwtParser.SEPARATOR_CHAR);
    }

    @NotNull
    public static final IntProgression downTo(byte b10, int i9) {
        return IntProgression.Companion.fromClosedRange(b10, i9, -1);
    }
    ...
    @NotNull
    public static final IntProgression downTo(short s10, int i9) {
        return IntProgression.Companion.fromClosedRange(s10, i9, -1);
    }

    @NotNull
    public static final LongRange until(long j10, int i9) {
        return new LongRange(j10, i9 - 1);
    }
    ...
    @NotNull
    public static final LongProgression downTo(int i9, long j10) {
        return LongProgression.Companion.fromClosedRange(i9, j10, -1L);
    }

    @NotNull
    public static final IntRange until(byte b10, int i9) {
        if (i9 <= Integer.MIN_VALUE) {
            return IntRange.Companion.getEMPTY();
        }
        return new IntRange(b10, i9 - 1);
    }
    ...
    @NotNull
    public static final IntRange until(short s10, int i9) {
        if (i9 <= Integer.MIN_VALUE) {
            return IntRange.Companion.getEMPTY();
        }
        return new IntRange(s10, i9 - 1);
    }
    ...
    @NotNull
    public static final IntProgression downTo(int i9, short s10) {
        return IntProgression.Companion.fromClosedRange(i9, s10, -1);
    }

    @NotNull
    public static final LongRange until(int i9, long j10) {
        if (j10 <= Long.MIN_VALUE) {
            return LongRange.Companion.getEMPTY();
        }
        return new LongRange(i9, j10 - 1);
    }
    ...
    @NotNull
    public static final IntRange until(int i9, short s10) {
        return new IntRange(i9, s10 - 1);
    }

    public static final int coerceIn(int i9, @NotNull ClosedRange<Integer> range) {
        Intrinsics.checkNotNullParameter(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((Number) coerceIn(Integer.valueOf(i9), (ClosedFloatingPointRange<Integer>) range)).intValue();
        }
        if (!range.isEmpty()) {
