...
public class CharProgression implements Iterable<Character>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final CharProgression fromClosedRange(char c10, char c11, int i9) {
            return new CharProgression(c10, c11, i9);
        }
    }
    ...
    public CharProgression(char c10, char c11, int i9) {
        ...
        if (i9 != Integer.MIN_VALUE) {
            this.first = c10;
            this.last = (char) ProgressionUtilKt.getProgressionLastElement((int) c10, (int) c11, i9);
            this.step = i9;
            return;
        }
