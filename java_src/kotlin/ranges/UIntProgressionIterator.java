...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    private UIntProgressionIterator(int i9, int i10, int i11) {
        ...
        this.hasNext = z10;
        this.step = UInt.m1751constructorimpl(i11);
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m1745boximpl(m2901nextpVg5ArA());
    }

    /* renamed from: next-pVg5ArA  reason: not valid java name */
    public int m2901nextpVg5ArA() {
        int i9 = this.next;
        if (i9 == this.finalElement) {
            ...
            this.next = UInt.m1751constructorimpl(this.step + i9);
        }
        return i9;
    }
