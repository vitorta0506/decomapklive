...
public final class IndexedValue<T> {
    ...
    public IndexedValue(int i9, T t10) {
        this.index = i9;
        this.value = t10;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ IndexedValue copy$default(IndexedValue indexedValue, int i9, Object obj, int i10, Object obj2) {
        if ((i10 & 1) != 0) {
            i9 = indexedValue.index;
        }
        if ((i10 & 2) != 0) {
            obj = indexedValue.value;
        }
        return indexedValue.copy(i9, obj);
    }
    ...
    @NotNull
    public final IndexedValue<T> copy(int i9, T t10) {
        return new IndexedValue<>(i9, t10);
    }
