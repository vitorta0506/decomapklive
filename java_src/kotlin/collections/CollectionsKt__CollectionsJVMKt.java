...
public class CollectionsKt__CollectionsJVMKt {
    ...
    @PublishedApi
    @InlineOnly
    private static final int checkCountOverflow(int i9) {
        if (i9 < 0) {
    ...
    @PublishedApi
    @InlineOnly
    private static final int checkIndexOverflow(int i9) {
        if (i9 < 0) {
            if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 3, 0)) {
    ...
    @PublishedApi
    @InlineOnly
    private static final <E> List<E> buildListInternal(int i9, Function1<? super List<E>, Unit> builderAction) {
        List createListBuilder;
        List<E> build;
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        createListBuilder = createListBuilder(i9);
        builderAction.invoke(createListBuilder);
        build = build(createListBuilder);
        return build;
    }
