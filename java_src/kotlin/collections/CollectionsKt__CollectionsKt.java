...
public class CollectionsKt__CollectionsKt extends CollectionsKt__CollectionsJVMKt {
    ...
    @InlineOnly
    private static final <T> List<T> List(int i9, Function1<? super Integer, ? extends T> init) {
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final <T> List<T> MutableList(int i9, Function1<? super Integer, ? extends T> init) {
        Intrinsics.checkNotNullParameter(init, "init");
        ArrayList arrayList = new ArrayList(i9);
        for (int i10 = 0; i10 < i9; i10++) {
            arrayList.add(init.invoke(Integer.valueOf(i10)));
    ...
    public static final <T extends Comparable<? super T>> int binarySearch(@NotNull List<? extends T> list, @Nullable T t10, int i9, int i10) {
        int compareValues;
        Intrinsics.checkNotNullParameter(list, "<this>");
        rangeCheck$CollectionsKt__CollectionsKt(list.size(), i9, i10);
        int i11 = i10 - 1;
        while (i9 <= i11) {
            int i12 = (i9 + i11) >>> 1;
            compareValues = ComparisonsKt__ComparisonsKt.compareValues(list.get(i12), t10);
            if (compareValues < 0) {
                i9 = i12 + 1;
    ...
    public static /* synthetic */ int binarySearch$default(List list, Comparable comparable, int i9, int i10, int i11, Object obj) {
        ...
        return binarySearch(list, comparable, i9, i10);
    }

    public static final <T, K extends Comparable<? super K>> int binarySearchBy(@NotNull List<? extends T> list, @Nullable K k10, int i9, int i10, @NotNull Function1<? super T, ? extends K> selector) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
        return binarySearch(list, i9, i10, new CollectionsKt__CollectionsKt$binarySearchBy$1(selector, k10));
    }

    public static /* synthetic */ int binarySearchBy$default(List list, Comparable comparable, int i9, int i10, Function1 function1, int i11, Object obj) {
        if ((i11 & 2) != 0) {
            i9 = 0;
        }
        if ((i11 & 4) != 0) {
        ...
        return binarySearch(list, i9, i10, new CollectionsKt__CollectionsKt$binarySearchBy$1(function1, comparable));
    }
    ...
    private static final void rangeCheck$CollectionsKt__CollectionsKt(int i9, int i10, int i11) {
        if (i10 > i11) {
    ...
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    @InlineOnly
    private static final <E> List<E> buildList(int i9, @BuilderInference Function1<? super List<E>, Unit> builderAction) {
        List createListBuilder;
        List<E> build;
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        createListBuilder = CollectionsKt__CollectionsJVMKt.createListBuilder(i9);
        builderAction.invoke(createListBuilder);
        build = CollectionsKt__CollectionsJVMKt.build(createListBuilder);
        return build;
    }
    ...
    public static /* synthetic */ int binarySearch$default(List list, int i9, int i10, Function1 function1, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            i9 = 0;
        }
        if ((i11 & 2) != 0) {
        ...
        return binarySearch(list, i9, i10, function1);
    }

    public static final <T> int binarySearch(@NotNull List<? extends T> list, T t10, @NotNull Comparator<? super T> comparator, int i9, int i10) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        ...
        while (i9 <= i11) {
            int i12 = (i9 + i11) >>> 1;
            int compare = comparator.compare((T) list.get(i12), t10);
            if (compare < 0) {
                i9 = i12 + 1;
            } else if (compare <= 0) {
                return i12;
    ...
    public static final <T> int binarySearch(@NotNull List<? extends T> list, int i9, int i10, @NotNull Function1<? super T, Integer> comparison) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        ...
        while (i9 <= i11) {
            int i12 = (i9 + i11) >>> 1;
            int intValue = comparison.invoke((T) list.get(i12)).intValue();
            if (intValue < 0) {
                i9 = i12 + 1;
            } else if (intValue <= 0) {
                return i12;
