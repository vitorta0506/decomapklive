...
public class SetsKt__SetsKt extends SetsKt__SetsJVMKt {
    ...
    public static <T> Set<T> optimizeReadOnlySet(@NotNull Set<? extends T> set) {
        ...
        if (size == 0) {
            ...
            of2 = SetsKt__SetsJVMKt.setOf(set.iterator().next());
            return of2;
        }
    }
    ...
    public static final <T> Set<T> setOfNotNull(@Nullable T t10) {
        ...
        Set<T> of2;
        if (t10 != null) {
            of2 = SetsKt__SetsJVMKt.setOf(t10);
            return of2;
        }
        emptySet = emptySet();
        return emptySet;
    ...
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    @InlineOnly
    private static final <E> Set<E> buildSet(int i9, @BuilderInference Function1<? super Set<E>, Unit> builderAction) {
        Set createSetBuilder;
        Set<E> build;
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        createSetBuilder = SetsKt__SetsJVMKt.createSetBuilder(i9);
        builderAction.invoke(createSetBuilder);
        build = SetsKt__SetsJVMKt.build(createSetBuilder);
        return build;
    }
