...
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    private final void copyCollectionElements(int i9, Collection<? extends E> collection) {
    ...
    private final void copyElements(int i9) {
    ...
    private final int decremented(int i9) {
        int lastIndex;
        if (i9 == 0) {
    ...
    private final void ensureCapacity(int i9) {
        ...
        if (i9 >= 0) {
            ...
            if (objArr == emptyElementData) {
                coerceAtLeast = RangesKt___RangesKt.coerceAtLeast(i9, 10);
                this.elementData = new Object[coerceAtLeast];
                return;
            }
            copyElements(Companion.newCapacity$kotlin_stdlib(objArr.length, i9));
            return;
        }
    ...
    private final int incremented(int i9) {
        int lastIndex;
        lastIndex = ArraysKt___ArraysKt.getLastIndex(this.elementData);
        if (i9 == lastIndex) {
            return 0;
    ...
    @InlineOnly
    private final E internalGet(int i9) {
        return (E) this.elementData[i9];
    }

    @InlineOnly
    private final int internalIndex(int i9) {
        return positiveMod(this.head + i9);
    }

    private final int negativeMod(int i9) {
        return i9 < 0 ? i9 + this.elementData.length : i9;
    }

    private final int positiveMod(int i9) {
        Object[] objArr = this.elementData;
    ...
    public final void addLast(E e10) {
        ensureCapacity(size() + 1);
        this.elementData[positiveMod(this.head + size())] = e10;
        this.size = size() + 1;
    }
    ...
    public void clear() {
        ...
        int i9 = this.head;
        if (i9 < positiveMod) {
            ArraysKt___ArraysJvmKt.fill(this.elementData, (Object) null, i9, positiveMod);
        } else if (!isEmpty()) {
            Object[] objArr = this.elementData;
    ...
    public E get(int i9) {
        ...
        return (E) this.elementData[positiveMod(this.head + i9)];
    }
    ...
    public final void internalStructure$kotlin_stdlib(@NotNull Function2<? super Integer, ? super Object[], Unit> structure) {
        ...
        structure.mo1invoke(Integer.valueOf((isEmpty() || (i9 = this.head) < positiveMod(this.head + size())) ? this.head : i9 - this.elementData.length), toArray());
    }
    ...
    public final E last() {
        ...
        return (E) objArr[positiveMod(i9 + lastIndex)];
    }
    ...
    public E removeAt(int i9) {
        ...
        int positiveMod = positiveMod(this.head + i9);
    ...
    public final E removeLast() {
        ...
        if (!isEmpty()) {
            int i9 = this.head;
            lastIndex = CollectionsKt__CollectionsKt.getLastIndex(this);
            int positiveMod = positiveMod(i9 + lastIndex);
            Object[] objArr = this.elementData;
    ...
    public E set(int i9, E e10) {
        ...
        int positiveMod = positiveMod(this.head + i9);
        Object[] objArr = this.elementData;
        E e11 = (E) objArr[positiveMod];
        objArr[positiveMod] = e10;
        return e11;
    }
    ...
    public <T> T[] toArray(@NotNull T[] array) {
        ...
        int i9 = this.head;
        if (i9 < positiveMod) {
            ArraysKt___ArraysJvmKt.copyInto$default(this.elementData, array, 0, i9, positiveMod, 2, (Object) null);
        } else if (!isEmpty()) {
            Object[] objArr = this.elementData;
    ...
    public void add(int i9, E e10) {
        AbstractList.Companion.checkPositionIndex$kotlin_stdlib(i9, size());
        if (i9 == size()) {
            addLast(e10);
        } else if (i9 == 0) {
            addFirst(e10);
    ...
    public boolean addAll(int i9, @NotNull Collection<? extends E> elements) {
        ...
        ensureCapacity(size() + elements.size());
        int positiveMod = positiveMod(this.head + size());
        int positiveMod2 = positiveMod(this.head + i9);
