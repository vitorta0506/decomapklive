...
public final class ArraysKt___ArraysJvmKt$asList$8 extends AbstractList<Character> implements RandomAccess {
    ...
    public boolean contains(char c10) {
        boolean contains;
        contains = ArraysKt___ArraysKt.contains(this.$this_asList, c10);
        return contains;
    }
    ...
    public Character get(int i9) {
        return Character.valueOf(this.$this_asList[i9]);
    }

    public int indexOf(char c10) {
        return ArraysKt___ArraysKt.indexOf(this.$this_asList, c10);
    }

    public int lastIndexOf(char c10) {
        return ArraysKt___ArraysKt.lastIndexOf(this.$this_asList, c10);
    }
}
