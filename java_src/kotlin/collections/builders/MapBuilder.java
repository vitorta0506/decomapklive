...
public final class MapBuilder<K, V> implements Map<K, V>, Serializable, KMutableMap {
    ...
    public static final class Companion {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public final int computeHashSize(int i9) {
            int coerceAtLeast;
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public final int computeShift(int i9) {
    ...
    public static final class EntryRef<K, V> implements Map.Entry<K, V>, KMutableMap.Entry {
        ...
        public V setValue(V v10) {
            ...
            int i9 = this.index;
            V v11 = (V) allocateValuesArray[i9];
            allocateValuesArray[i9] = v10;
            return v11;
        }
    ...
    private final void ensureCapacity(int i9) {
        if (i9 >= 0) {
            if (i9 > getCapacity()) {
                ...
                this.keysArray = (K[]) ListBuilderKt.copyOfUninitializedElements(this.keysArray, i9);
                V[] vArr = this.valuesArray;
                this.valuesArray = vArr != null ? (V[]) ListBuilderKt.copyOfUninitializedElements(vArr, i9) : null;
                int[] copyOf = Arrays.copyOf(this.presenceArray, i9);
                Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
                this.presenceArray = copyOf;
                int computeHashSize = Companion.computeHashSize(i9);
                if (computeHashSize > getHashSize()) {
                    rehash(computeHashSize);
                    return;
                }
                return;
            } else if ((this.length + i9) - size() > getCapacity()) {
                rehash(getHashSize());
                return;
            } else {
                return;
    ...
    private final int findValue(V v10) {
        ...
        while (true) {
            ...
            if (this.presenceArray[i9] >= 0) {
                ...
                if (Intrinsics.areEqual(vArr[i9], v10)) {
                    return i9;
                }
            }
        }
    ...
    private final boolean putEntry(Map.Entry<? extends K, ? extends V> entry) {
        ...
        if (Intrinsics.areEqual(entry.getValue(), allocateValuesArray[i9])) {
            return false;
        }
        allocateValuesArray[i9] = entry.getValue();
        return true;
    }

    private final boolean putRehash(int i9) {
        int hash = hash(this.keysArray[i9]);
        int i10 = this.maxProbeDistance;
        while (true) {
            int[] iArr = this.hashArray;
            if (iArr[hash] == 0) {
                iArr[hash] = i9 + 1;
                this.presenceArray[i9] = hash;
                return true;
            }
            i10--;
            if (i10 < 0) {
    ...
    private final void rehash(int i9) {
        if (this.length > size()) {
            compact();
        }
        int i10 = 0;
        if (i9 != getHashSize()) {
            ...
            this.hashShift = Companion.computeShift(i9);
        } else {
    ...
    private final void removeHashAt(int i9) {
        int coerceAtMost;
        ...
        do {
            ...
            if (i13 < 0) {
                ...
                int i14 = i13 - 1;
                if (((hash(this.keysArray[i14]) - i9) & (getHashSize() - 1)) >= i11) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void removeKeyAt(int i9) {
        ListBuilderKt.resetAt(this.keysArray, i9);
        removeHashAt(this.presenceArray[i9]);
    ...
    public MapBuilder(int i9) {
        this(ListBuilderKt.arrayOfUninitializedElements(i9), null, new int[i9], new int[Companion.computeHashSize(i9)], 2, 0);
    }
}
