...
public final class SerializedCollection implements Externalizable {
    ...
    public SerializedCollection(@NotNull Collection<?> collection, int i9) {
        ...
        if ((readByte & (-2)) == 0) {
            ...
            if (readInt >= 0) {
                ...
                if (i9 == 0) {
                    ...
                    throw new InvalidObjectException("Unsupported collection type tag: " + i9 + JwtParser.SEPARATOR_CHAR);
                }
