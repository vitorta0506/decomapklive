...
public final class ListBuilder<E> extends AbstractMutableList<E> implements RandomAccess, Serializable {
    ...
    private static final class Itr<E> implements ListIterator<E>, KMutableListIterator {
        ...
        public Itr(@NotNull ListBuilder<E> list, int i9) {
    ...
    private ListBuilder(E[] eArr, int i9, int i10, boolean z10, ListBuilder<E> listBuilder, ListBuilder<E> listBuilder2) {
        this.array = eArr;
        this.offset = i9;
        this.length = i10;
        this.isReadOnly = z10;
    ...
    private final void addAtInternal(int i9, E e10) {
        ListBuilder<E> listBuilder = this.backing;
        if (listBuilder != null) {
            listBuilder.addAtInternal(i9, e10);
            this.array = this.backing.array;
            this.length++;
            return;
        }
    ...
    private final void ensureCapacity(int i9) {
        ...
        if (i9 >= 0) {
            E[] eArr = this.array;
            if (i9 > eArr.length) {
                this.array = (E[]) ListBuilderKt.copyOfUninitializedElements(this.array, ArrayDeque.Companion.newCapacity$kotlin_stdlib(eArr.length, i9));
                return;
            }
            return;
        }
    ...
    private final void insertAtInternal(int i9, int i10) {
        ...
        E[] eArr = this.array;
        ArraysKt___ArraysJvmKt.copyInto(eArr, eArr, i9 + i10, i9, this.offset + this.length);
        this.length += i10;
    }
    ...
    private final E removeAtInternal(int i9) {
        ...
        E[] eArr = this.array;
        E e10 = eArr[i9];
        ArraysKt___ArraysJvmKt.copyInto(eArr, eArr, i9, i9 + 1, this.offset + this.length);
    ...
    private final void removeRangeInternal(int i9, int i10) {
        ...
        if (listBuilder != null) {
            ...
            E[] eArr = this.array;
            ArraysKt___ArraysJvmKt.copyInto(eArr, eArr, i9, i9 + i10, this.length);
            E[] eArr2 = this.array;
            int i11 = this.length;
    ...
    private final int retainOrRemoveAllInternal(int i9, int i10, Collection<? extends E> collection, boolean z10) {
        ListBuilder<E> listBuilder = this.backing;
        if (listBuilder != null) {
            int retainOrRemoveAllInternal = listBuilder.retainOrRemoveAllInternal(i9, i10, collection, z10);
        ...
        int i14 = i10 - i12;
        E[] eArr2 = this.array;
        ArraysKt___ArraysJvmKt.copyInto(eArr2, eArr2, i9 + i12, i10 + i9, this.length);
        E[] eArr3 = this.array;
        int i15 = this.length;
    ...
    public E get(int i9) {
        AbstractList.Companion.checkElementIndex$kotlin_stdlib(i9, this.length);
    ...
    public List<E> subList(int i9, int i10) {
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i9, i10, this.length);
        E[] eArr = this.array;
    ...
    public ListIterator<E> listIterator(int i9) {
        AbstractList.Companion.checkPositionIndex$kotlin_stdlib(i9, this.length);
    ...
    public void add(int i9, E e10) {
        checkIsMutable();
        AbstractList.Companion.checkPositionIndex$kotlin_stdlib(i9, this.length);
        addAtInternal(this.offset + i9, e10);
    }
    ...
    public Object[] toArray() {
        ...
        E[] eArr = this.array;
        int i9 = this.offset;
        copyOfRange = ArraysKt___ArraysJvmKt.copyOfRange(eArr, i9, this.length + i9);
    ...
    public ListBuilder(int i9) {
        this(ListBuilderKt.arrayOfUninitializedElements(i9), 0, 0, false, null, null);
    }
}
