...
public abstract class AbstractList<E> extends AbstractCollection<E> implements List<E> {
    ...
    public class IteratorImpl implements Iterator<E>, KMappedMarker {
        ...
        protected final void setIndex(int i9) {
            this.index = i9;
        }
    }
    ...
    private class ListIteratorImpl extends AbstractList<E>.IteratorImpl implements ListIterator<E> {
        public ListIteratorImpl(int i9) {
            super();
            AbstractList.Companion.checkPositionIndex$kotlin_stdlib(i9, AbstractList.this.size());
            setIndex(i9);
        }
    ...
    private static final class SubList<E> extends AbstractList<E> implements RandomAccess {
        ...
        public SubList(@NotNull AbstractList<? extends E> list, int i9, int i10) {
            Intrinsics.checkNotNullParameter(list, "list");
            this.list = list;
            this.fromIndex = i9;
            AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i9, i10, list.size());
            this._size = i10 - i9;
        }

        @Override // kotlin.collections.AbstractList, java.util.List
        public E get(int i9) {
            AbstractList.Companion.checkElementIndex$kotlin_stdlib(i9, this._size);
    ...
    public ListIterator<E> listIterator(int i9) {
        return new ListIteratorImpl(i9);
    }
}
