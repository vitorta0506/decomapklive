...
public class MapsKt__MapsJVMKt extends MapsKt__MapWithDefaultKt {
    ...
    @PublishedApi
    @InlineOnly
    private static final <K, V> Map<K, V> buildMapInternal(int i9, Function1<? super Map<K, V>, Unit> builderAction) {
        Map createMapBuilder;
        Map<K, V> build;
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        createMapBuilder = createMapBuilder(i9);
        builderAction.invoke(createMapBuilder);
        build = build(createMapBuilder);
        return build;
    }
    ...
    @PublishedApi
    @NotNull
    public static <K, V> Map<K, V> createMapBuilder(int i9) {
