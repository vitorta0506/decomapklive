...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, La5/f;->b:Landroid/content/Context;
...
.method public static l(Ljava/io/File;)V
    ...
    .line 4
    invoke-static {v4}, La5/f;->l(Ljava/io/File;)V
...
.method private final r()Ljava/io/File;
    ...
    invoke-direct {p0}, La5/f;->w()Ljava/io/File;
    ...
    invoke-static {v0}, La5/f;->u(Ljava/io/File;)Ljava/io/File;
...
.method private final s(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-direct {p0}, La5/f;->r()Ljava/io/File;

    move-result-object v0

    invoke-static {v0, p1}, La5/f;->q(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object p1

    invoke-static {p1}, La5/f;->u(Ljava/io/File;)Ljava/io/File;
...
.method private final v()Ljava/io/File;
    ...
    .line 1
    iget-object v0, p0, La5/f;->c:Ljava/io/File;

    if-nez v0, :cond_1

    iget-object v0, p0, La5/f;->b:Landroid/content/Context;
    ...
    iput-object v0, p0, La5/f;->c:Ljava/io/File;
    ...
    iget-object v1, p0, La5/f;->c:Ljava/io/File;
...
.method private final w()Ljava/io/File;
    ...
    invoke-direct {p0}, La5/f;->v()Ljava/io/File;

    move-result-object v1

    iget-wide v2, p0, La5/f;->a:J
...
.method public final c(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-direct {p0, p1}, La5/f;->s(Ljava/lang/String;)Ljava/io/File;

    move-result-object p1

    invoke-static {p1, p2}, La5/f;->q(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
...
.method public final e(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-virtual {p0}, La5/f;->b()Ljava/io/File;

    move-result-object v0

    invoke-static {p1}, La5/f;->x(Ljava/lang/String;)Ljava/lang/String;
...
.method public final f(Ljava/io/File;)Ljava/io/File;
    ...
    invoke-direct {p0}, La5/f;->t()Ljava/io/File;
...
.method final j()Ljava/util/Set;
    ...
    .line 7
    invoke-static {v5}, La5/f;->p(Ljava/io/File;)Z
    ...
    .line 10
    invoke-direct {v7, v5, v6}, La5/c;-><init>(Ljava/io/File;Ljava/lang/String;)V
...
.method public final k()V
    ...
    .line 7
    invoke-static {v5}, La5/f;->l(Ljava/io/File;)V
...
.method final n(Ljava/lang/String;)V
    ...
    invoke-static {p1}, La5/f;->l(Ljava/io/File;)V
