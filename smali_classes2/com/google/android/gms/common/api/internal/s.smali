...
# direct methods
.method constructor <init>(Lcom/google/android/gms/common/api/internal/c;ILv3/b;JJLjava/lang/String;Ljava/lang/String;)V
    .locals 0
    ...
    iput-object p3, p0, Lcom/google/android/gms/common/api/internal/s;->c:Lv3/b;
...
.method static b(Lcom/google/android/gms/common/api/internal/c;ILv3/b;)Lcom/google/android/gms/common/api/internal/s;
    .locals 12
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    .line 5
    invoke-virtual {p0, p2}, Lcom/google/android/gms/common/api/internal/c;->x(Lv3/b;)Lcom/google/android/gms/common/api/internal/o;

    move-result-object v2

    if-eqz v2, :cond_5

    invoke-virtual {v2}, Lcom/google/android/gms/common/api/internal/o;->u()Lcom/google/android/gms/common/api/a$f;
    ...
    .line 8
    invoke-virtual {v3}, Lcom/google/android/gms/common/internal/d;->G()Z
    ...
    .line 9
    invoke-static {v2, v3, p1}, Lcom/google/android/gms/common/api/internal/s;->c(Lcom/google/android/gms/common/api/internal/o;Lcom/google/android/gms/common/internal/d;I)Lcom/google/android/gms/common/internal/ConnectionTelemetryConfiguration;
    ...
    .line 10
    :cond_3
    invoke-virtual {v2}, Lcom/google/android/gms/common/api/internal/o;->F()V

    .line 11
    invoke-virtual {v0}, Lcom/google/android/gms/common/internal/ConnectionTelemetryConfiguration;->P()Z
    ...
    invoke-direct/range {v1 .. v10}, Lcom/google/android/gms/common/api/internal/s;-><init>(Lcom/google/android/gms/common/api/internal/c;ILv3/b;JJLjava/lang/String;Ljava/lang/String;)V

    return-object v11
.end method

.method private static c(Lcom/google/android/gms/common/api/internal/o;Lcom/google/android/gms/common/internal/d;I)Lcom/google/android/gms/common/internal/ConnectionTelemetryConfiguration;
    .locals 2
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    .line 1
    invoke-virtual {p1}, Lcom/google/android/gms/common/internal/d;->E()Lcom/google/android/gms/common/internal/ConnectionTelemetryConfiguration;
    ...
    .line 4
    invoke-virtual {p1}, Lcom/google/android/gms/common/internal/ConnectionTelemetryConfiguration;->L()[I
    ...
    .line 5
    :cond_0
    invoke-static {v1, p2}, Le4/b;->b([II)Z
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0}, Lcom/google/android/gms/common/api/internal/o;->r()I
...
.method public final a(Lt4/g;)V
    ...
    iget-object v3, v0, Lcom/google/android/gms/common/api/internal/s;->c:Lv3/b;

    .line 4
    invoke-virtual {v2, v3}, Lcom/google/android/gms/common/api/internal/c;->x(Lv3/b;)Lcom/google/android/gms/common/api/internal/o;
    ...
    .line 7
    :goto_1
    invoke-virtual {v3}, Lcom/google/android/gms/common/internal/d;->w()I
    ...
    .line 13
    invoke-static {v2, v3, v4}, Lcom/google/android/gms/common/api/internal/s;->c(Lcom/google/android/gms/common/api/internal/o;Lcom/google/android/gms/common/internal/d;I)Lcom/google/android/gms/common/internal/ConnectionTelemetryConfiguration;
    ...
    .line 14
    :cond_5
    invoke-virtual {v2}, Lcom/google/android/gms/common/internal/ConnectionTelemetryConfiguration;->P()Z
    ...
    .line 16
    invoke-virtual/range {p1 .. p1}, Lt4/g;->o()Z
    ...
    .line 17
    :cond_9
    invoke-virtual/range {p1 .. p1}, Lt4/g;->m()Z
    ...
    .line 18
    :cond_a
    invoke-virtual/range {p1 .. p1}, Lt4/g;->j()Ljava/lang/Exception;
    ...
    .line 22
    invoke-virtual {v5}, Lcom/google/android/gms/common/api/Status;->I()Lcom/google/android/gms/common/ConnectionResult;
    ...
    .line 23
    :cond_b
    invoke-virtual {v5}, Lcom/google/android/gms/common/ConnectionResult;->I()I
    ...
    .line 29
    invoke-virtual/range {v11 .. v16}, Lcom/google/android/gms/common/api/internal/c;->G(Lcom/google/android/gms/common/internal/MethodInvocation;IJI)V
