...
.method public k(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, v0, p3}, Lcom/google/android/gms/common/internal/d0;->b(Landroid/app/Activity;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/d0;

    move-result-object p3

    .line 2
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/google/android/gms/common/a;->p(Landroid/content/Context;ILcom/google/android/gms/common/internal/d0;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method final p(Landroid/content/Context;ILcom/google/android/gms/common/internal/d0;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 11
    :cond_4
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/a0;->g(Landroid/content/Context;I)Ljava/lang/String;
...
.method public final q(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    .line 6
    invoke-static {p1, v0}, Lcom/google/android/gms/common/internal/a0;->d(Landroid/content/Context;I)Ljava/lang/String;
...
.method public final r(Landroid/content/Context;Lv3/r;)Lcom/google/android/gms/common/api/internal/zabx;
    .locals 2
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    .line 3
    invoke-direct {v1, p2}, Lcom/google/android/gms/common/api/internal/zabx;-><init>(Lv3/r;)V

    .line 4
    invoke-static {p1, v1, v0}, Lcom/google/android/gms/internal/base/zao;->a(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
...
.method final s(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    .line 4
    invoke-static {p2, p4}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->P1(Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;)Lcom/google/android/gms/common/SupportErrorDialogFragment;
...
.method final t(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    .line 5
    :cond_2
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/a0;->f(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v0

    .line 6
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/a0;->e(Landroid/content/Context;I)Ljava/lang/String;
    ...
    .line 14
    invoke-static {p1}, Le4/h;->c(Landroid/content/Context;)Z
    ...
    .line 18
    invoke-static {p1}, Le4/h;->d(Landroid/content/Context;)Z
    ...
    invoke-static {p4}, Lcom/google/android/gms/common/internal/p;->n(Z)V
    ...
    .line 33
    invoke-static {p1}, Lcom/google/android/gms/common/internal/a0;->b(Landroid/content/Context;)Ljava/lang/String;
...
.method public final v(Landroid/app/Activity;Lv3/e;IILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 1
    .param p1    # Landroid/app/Activity;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {p2, p4, v0}, Lcom/google/android/gms/common/internal/d0;->c(Lv3/e;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/d0;

    move-result-object p2

    .line 2
    invoke-virtual {p0, p1, p3, p2, p5}, Lcom/google/android/gms/common/a;->p(Landroid/content/Context;ILcom/google/android/gms/common/internal/d0;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public final w(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;I)Z
    ...
    .line 1
    invoke-static {p1}, Lg4/a;->a(Landroid/content/Context;)Z
    ...
    .line 6
    invoke-virtual {p0, p1, p2, v2, p3}, Lcom/google/android/gms/common/a;->t(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
