...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ld4/a;->b:Ljava/lang/Object;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Ld4/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static b()Ld4/a;
    ...
    .line 1
    sget-object v0, Ld4/a;->c:Ld4/a;

    if-nez v0, :cond_1

    sget-object v0, Ld4/a;->b:Ljava/lang/Object;
...
.method private final f(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
    ...
    invoke-virtual {v2, p6, v1}, Lg4/b;->c(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_1
    :goto_0
    invoke-static {p4}, Ld4/a;->g(Landroid/content/ServiceConnection;)Z

    move-result p6

    if-eqz p6, :cond_4

    iget-object p6, p0, Ld4/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2
    :try_start_1
    invoke-static {p1, p3, p4, p5, p7}, Ld4/a;->h(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    :cond_3
    iget-object p1, p0, Ld4/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 14
    iget-object p2, p0, Ld4/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public a(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    .line 2
    invoke-direct/range {v1 .. v8}, Ld4/a;->f(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
...
.method public c(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    .line 1
    invoke-static {p2}, Ld4/a;->g(Landroid/content/ServiceConnection;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Ld4/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p1, v0}, Ld4/a;->e(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 5
    :cond_0
    invoke-static {p1, p2}, Ld4/a;->e(Landroid/content/Context;Landroid/content/ServiceConnection;)V
...
.method public final d(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    invoke-direct/range {v0 .. v7}, Ld4/a;->f(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
