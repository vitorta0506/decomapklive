...
.method constructor <init>(I)V
    ...
    .line 2
    iput p1, p0, Lorg/threeten/bp/format/c$j;->a:I
...
.method public a(Lorg/threeten/bp/format/d;Ljava/lang/CharSequence;I)I
    ...
    .line 1
    invoke-virtual/range {p1 .. p1}, Lorg/threeten/bp/format/d;->e()Lorg/threeten/bp/format/d;
    ...
    .line 2
    iget v1, v7, Lorg/threeten/bp/format/c$j;->a:I
    ...
    .line 3
    :cond_1
    new-instance v4, Lorg/threeten/bp/format/c;

    invoke-direct {v4}, Lorg/threeten/bp/format/c;-><init>()V

    sget-object v5, Lorg/threeten/bp/format/b;->h:Lorg/threeten/bp/format/b;

    .line 4
    invoke-virtual {v4, v5}, Lorg/threeten/bp/format/c;->a(Lorg/threeten/bp/format/b;)Lorg/threeten/bp/format/c;

    move-result-object v4

    const/16 v5, 0x54

    invoke-virtual {v4, v5}, Lorg/threeten/bp/format/c;->f(C)Lorg/threeten/bp/format/c;
    ...
    .line 5
    invoke-virtual {v4, v5, v8}, Lorg/threeten/bp/format/c;->m(Lorg/threeten/bp/temporal/g;I)Lorg/threeten/bp/format/c;

    move-result-object v4

    const/16 v9, 0x3a

    invoke-virtual {v4, v9}, Lorg/threeten/bp/format/c;->f(C)Lorg/threeten/bp/format/c;

    move-result-object v4

    sget-object v10, Lorg/threeten/bp/temporal/ChronoField;->MINUTE_OF_HOUR:Lorg/threeten/bp/temporal/ChronoField;

    invoke-virtual {v4, v10, v8}, Lorg/threeten/bp/format/c;->m(Lorg/threeten/bp/temporal/g;I)Lorg/threeten/bp/format/c;
    ...
    .line 6
    invoke-virtual {v4, v9, v8}, Lorg/threeten/bp/format/c;->m(Lorg/threeten/bp/temporal/g;I)Lorg/threeten/bp/format/c;
    ...
    invoke-virtual {v4, v8, v3, v1, v11}, Lorg/threeten/bp/format/c;->c(Lorg/threeten/bp/temporal/g;IIZ)Lorg/threeten/bp/format/c;

    move-result-object v1

    const/16 v3, 0x5a

    invoke-virtual {v1, v3}, Lorg/threeten/bp/format/c;->f(C)Lorg/threeten/bp/format/c;

    move-result-object v1

    .line 7
    invoke-virtual {v1}, Lorg/threeten/bp/format/c;->v()Lorg/threeten/bp/format/b;

    move-result-object v1

    invoke-virtual {v1, v2}, Lorg/threeten/bp/format/b;->k(Z)Lorg/threeten/bp/format/c$g;
    ...
    .line 8
    invoke-virtual {v1, v0, v3, v6}, Lorg/threeten/bp/format/c$g;->a(Lorg/threeten/bp/format/d;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v0, v1}, Lorg/threeten/bp/format/d;->j(Lorg/threeten/bp/temporal/g;)Ljava/lang/Long;
    ...
    .line 12
    invoke-virtual {v0, v5}, Lorg/threeten/bp/format/d;->j(Lorg/threeten/bp/temporal/g;)Ljava/lang/Long;
    ...
    .line 13
    invoke-virtual {v0, v10}, Lorg/threeten/bp/format/d;->j(Lorg/threeten/bp/temporal/g;)Ljava/lang/Long;
    ...
    .line 14
    invoke-virtual {v0, v9}, Lorg/threeten/bp/format/d;->j(Lorg/threeten/bp/temporal/g;)Ljava/lang/Long;

    move-result-object v9

    .line 15
    invoke-virtual {v0, v8}, Lorg/threeten/bp/format/d;->j(Lorg/threeten/bp/temporal/g;)Ljava/lang/Long;
    ...
    .line 19
    invoke-virtual/range {p1 .. p1}, Lorg/threeten/bp/format/d;->r()V
    ...
    invoke-static {v3, v4, v13, v14}, Ljl/d;->n(JJ)J
...
.method public b(Lorg/threeten/bp/format/e;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {v3, v2}, Lorg/threeten/bp/format/e;->f(Lorg/threeten/bp/temporal/g;)Ljava/lang/Long;
    ...
    .line 3
    invoke-virtual/range {p1 .. p1}, Lorg/threeten/bp/format/e;->e()Lorg/threeten/bp/temporal/c;

    move-result-object v7

    sget-object v8, Lorg/threeten/bp/temporal/ChronoField;->NANO_OF_SECOND:Lorg/threeten/bp/temporal/ChronoField;

    invoke-interface {v7, v8}, Lorg/threeten/bp/temporal/c;->isSupported(Lorg/threeten/bp/temporal/g;)Z
    ...
    invoke-interface {v3, v8}, Lorg/threeten/bp/temporal/c;->getLong(Lorg/threeten/bp/temporal/g;)J
    ...
    .line 7
    invoke-static {v9, v10, v4, v5}, Ljl/d;->e(JJ)J
    ...
    .line 8
    invoke-static {v9, v10, v4, v5}, Ljl/d;->h(JJ)J
    ...
    :cond_7
    :goto_0
    iget v4, v0, Lorg/threeten/bp/format/c$j;->a:I
    ...
    .line 33
    :goto_1
    iget v6, v0, Lorg/threeten/bp/format/c$j;->a:I
