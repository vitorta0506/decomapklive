.class public final Lorg/bouncycastle/crypto/d;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/crypto/d;->a:Ljava/security/Permission;
    ...
    sput-object v0, Lorg/bouncycastle/crypto/d;->b:Ljava/security/Permission;
    ...
    sput-object v0, Lorg/bouncycastle/crypto/d;->c:Ljava/security/Permission;

    new-instance v0, Ljava/lang/ThreadLocal;

    invoke-direct {v0}, Ljava/lang/ThreadLocal;-><init>()V

    sput-object v0, Lorg/bouncycastle/crypto/d;->d:Ljava/lang/ThreadLocal;
    ...
    sput-object v0, Lorg/bouncycastle/crypto/d;->e:Ljava/util/Map;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lorg/bouncycastle/crypto/d;->f:Ljava/lang/Object;
    ...
    invoke-static {v6}, Lorg/bouncycastle/util/encoders/d;->b(Ljava/lang/String;)[B

    move-result-object v6

    const/16 v7, 0x7b

    invoke-direct {v5, v6, v7}, Lvj/k;-><init>([BI)V

    invoke-direct {v0, v1, v2, v4, v5}, Lvj/h;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lvj/k;)V
    ...
    new-instance v6, Lvj/k;

    const-string v7, "77d0f8c4dad15eb8c4f2f8d6726cefd96d5bb399"

    invoke-static {v7}, Lorg/bouncycastle/util/encoders/d;->b(Ljava/lang/String;)[B

    move-result-object v7

    const/16 v8, 0x107

    invoke-direct {v6, v7, v8}, Lvj/k;-><init>([BI)V

    invoke-direct {v1, v2, v4, v5, v6}, Lvj/h;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lvj/k;)V
    ...
    invoke-static {v8}, Lorg/bouncycastle/util/encoders/d;->b(Ljava/lang/String;)[B

    move-result-object v8

    const/16 v9, 0x5c

    invoke-direct {v7, v8, v9}, Lvj/k;-><init>([BI)V

    invoke-direct {v2, v4, v5, v6, v7}, Lvj/h;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lvj/k;)V
    ...
    invoke-direct {v3, v8, v9}, Lvj/k;-><init>([BI)V

    invoke-direct {v4, v5, v6, v7, v3}, Lvj/h;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lvj/k;)V

    sget-object v3, Lorg/bouncycastle/crypto/d$a;->e:Lorg/bouncycastle/crypto/d$a;

    const/4 v5, 0x4

    new-array v6, v5, [Lvj/h;
    ...
    invoke-static {v3, v6}, Lorg/bouncycastle/crypto/d;->c(Lorg/bouncycastle/crypto/d$a;[Ljava/lang/Object;)V

    sget-object v3, Lorg/bouncycastle/crypto/d$a;->d:Lorg/bouncycastle/crypto/d$a;

    new-array v5, v5, [Lvj/c;

    invoke-static {v0}, Lorg/bouncycastle/crypto/d;->e(Lvj/h;)Lvj/c;

    move-result-object v0

    aput-object v0, v5, v7

    invoke-static {v1}, Lorg/bouncycastle/crypto/d;->e(Lvj/h;)Lvj/c;

    move-result-object v0

    aput-object v0, v5, v8

    invoke-static {v2}, Lorg/bouncycastle/crypto/d;->e(Lvj/h;)Lvj/c;

    move-result-object v0

    aput-object v0, v5, v9

    invoke-static {v4}, Lorg/bouncycastle/crypto/d;->e(Lvj/h;)Lvj/c;

    move-result-object v0

    aput-object v0, v5, v10

    invoke-static {v3, v5}, Lorg/bouncycastle/crypto/d;->c(Lorg/bouncycastle/crypto/d$a;[Ljava/lang/Object;)V
...
.method public static b()Ljava/security/SecureRandom;
    ...
    sget-object v0, Lorg/bouncycastle/crypto/d;->f:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lorg/bouncycastle/crypto/d;->g:Ljava/security/SecureRandom;
    ...
    :try_start_1
    sget-object v2, Lorg/bouncycastle/crypto/d;->g:Ljava/security/SecureRandom;

    if-nez v2, :cond_1

    sput-object v1, Lorg/bouncycastle/crypto/d;->g:Ljava/security/SecureRandom;
...
.method private static varargs c(Lorg/bouncycastle/crypto/d$a;[Ljava/lang/Object;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0}, Lorg/bouncycastle/crypto/d$a;->b(Lorg/bouncycastle/crypto/d$a;)Ljava/lang/Class;
    ...
    invoke-static {p0, p1}, Lorg/bouncycastle/crypto/d;->d(Lorg/bouncycastle/crypto/d$a;[Ljava/lang/Object;)V

    sget-object v0, Lorg/bouncycastle/crypto/d;->e:Ljava/util/Map;

    invoke-static {p0}, Lorg/bouncycastle/crypto/d$a;->a(Lorg/bouncycastle/crypto/d$a;)Ljava/lang/String;
...
.method private static d(Lorg/bouncycastle/crypto/d$a;[Ljava/lang/Object;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    sget-object v0, Lorg/bouncycastle/crypto/d;->d:Ljava/lang/ThreadLocal;
...
.method private static e(Lvj/h;)Lvj/c;
    .locals 9

    invoke-virtual {p0}, Lvj/h;->b()Ljava/math/BigInteger;
    ...
    invoke-static {v0}, Lorg/bouncycastle/crypto/d;->a(I)I
    ...
    invoke-virtual {p0}, Lvj/h;->a()Ljava/math/BigInteger;

    move-result-object v3

    invoke-virtual {p0}, Lvj/h;->c()Ljava/math/BigInteger;

    move-result-object v4

    new-instance v8, Lvj/f;

    invoke-virtual {p0}, Lvj/h;->d()Lvj/k;

    move-result-object v1

    invoke-virtual {v1}, Lvj/k;->b()[B
    ...
    invoke-virtual {p0}, Lvj/k;->a()I

    move-result p0

    invoke-direct {v8, v1, p0}, Lvj/f;-><init>([BI)V
    ...
    invoke-direct/range {v1 .. v8}, Lvj/c;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;IILjava/math/BigInteger;Lvj/f;)V
