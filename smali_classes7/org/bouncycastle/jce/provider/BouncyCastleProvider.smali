...
.field public static final CONFIGURATION:Lzj/b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->CONFIGURATION:Lzj/b;
...
.method private static getAsymmetricKeyInfoConverter(Lorg/bouncycastle/asn1/n;)Lak/b;
    .locals 1
...
.method public static getPrivateKey(Lgj/d;)Ljava/security/PrivateKey;
    .locals 1
    ...
    invoke-static {v0}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->getAsymmetricKeyInfoConverter(Lorg/bouncycastle/asn1/n;)Lak/b;
    ...
    :cond_0
    invoke-interface {v0, p0}, Lak/b;->a(Lgj/d;)Ljava/security/PrivateKey;
...
.method public static getPublicKey(Loj/v;)Ljava/security/PublicKey;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    invoke-interface {v0, p0}, Lak/b;->b(Loj/v;)Ljava/security/PublicKey;
...
.method private loadAlgorithms(Ljava/lang/String;[Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p0}, Lak/a;->a(Lzj/a;)V
    :try_end_0
...
.method private loadPQCKeys()V
    ...
    new-instance v1, Lorg/bouncycastle/pqc/jcajce/provider/sphincs/a;

    invoke-direct {v1}, Lorg/bouncycastle/pqc/jcajce/provider/sphincs/a;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Lorg/bouncycastle/asn1/n;Lak/b;)V

    sget-object v0, Lpk/e;->v:Lorg/bouncycastle/asn1/n;

    new-instance v1, Lorg/bouncycastle/pqc/jcajce/provider/newhope/a;

    invoke-direct {v1}, Lorg/bouncycastle/pqc/jcajce/provider/newhope/a;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Lorg/bouncycastle/asn1/n;Lak/b;)V

    sget-object v0, Lpk/e;->w:Lorg/bouncycastle/asn1/n;

    new-instance v1, Lorg/bouncycastle/pqc/jcajce/provider/xmss/b;

    invoke-direct {v1}, Lorg/bouncycastle/pqc/jcajce/provider/xmss/b;-><init>()V
    ...
    sget-object v0, Lpk/e;->F:Lorg/bouncycastle/asn1/n;

    new-instance v1, Lorg/bouncycastle/pqc/jcajce/provider/xmss/c;

    invoke-direct {v1}, Lorg/bouncycastle/pqc/jcajce/provider/xmss/c;-><init>()V
    ...
    new-instance v1, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/b;

    invoke-direct {v1}, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/b;-><init>()V
    ...
    sget-object v0, Lpk/e;->a:Lorg/bouncycastle/asn1/n;
    ...
    sget-object v0, Lpk/e;->X:Lorg/bouncycastle/asn1/n;

    new-instance v1, Lorg/bouncycastle/pqc/jcajce/provider/qtesla/a;

    invoke-direct {v1}, Lorg/bouncycastle/pqc/jcajce/provider/qtesla/a;-><init>()V

    invoke-virtual {p0, v0, v1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->addKeyInfoConverter(Lorg/bouncycastle/asn1/n;Lak/b;)V

    sget-object v0, Lpk/e;->Y:Lorg/bouncycastle/asn1/n;
    ...
    sget-object v0, Lgj/c;->Q1:Lorg/bouncycastle/asn1/n;

    new-instance v1, Lorg/bouncycastle/pqc/jcajce/provider/lms/a;

    invoke-direct {v1}, Lorg/bouncycastle/pqc/jcajce/provider/lms/a;-><init>()V
...
.method public addKeyInfoConverter(Lorg/bouncycastle/asn1/n;Lak/b;)V
    .locals 1
...
.method public getKeyInfoConverter(Lorg/bouncycastle/asn1/n;)Lak/b;
    .locals 1
...
.method public setParameter(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, p1, p2}, Lorg/bouncycastle/jce/provider/a;->d(Ljava/lang/String;Ljava/lang/Object;)V
