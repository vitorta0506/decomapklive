...
.field transient xdhPrivateKey:Lvj/a;
...
.method constructor <init>(Lgj/d;)V
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->populateFromPrivateKeyInfo(Lgj/d;)V
...
.method constructor <init>(Lvj/a;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->xdhPrivateKey:Lvj/a;
...
.method private populateFromPrivateKeyInfo(Lgj/d;)V
    ...
    :cond_0
    sget-object v1, Laj/a;->c:Lorg/bouncycastle/asn1/n;
    ...
    invoke-direct {p1, v0, v1}, Lvj/i0;-><init>([BI)V

    goto :goto_0

    :cond_1
    new-instance p1, Lvj/g0;
    ...
    invoke-direct {p1, v0, v1}, Lvj/g0;-><init>([BI)V
...
.method engineGetKeyParameters()Lvj/a;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->xdhPrivateKey:Lvj/a;
...
.method public getEncoded()[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->xdhPrivateKey:Lvj/a;
...
.method public getPublicKey()Lorg/bouncycastle/jcajce/interfaces/XDHPublicKey;
    ...
    instance-of v1, v0, Lvj/i0;

    if-eqz v1, :cond_0

    new-instance v1, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPublicKey;

    check-cast v0, Lvj/i0;

    invoke-virtual {v0}, Lvj/i0;->b()Lvj/j0;

    move-result-object v0

    invoke-direct {v1, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCXDHPublicKey;-><init>(Lvj/a;)V
    ...
    check-cast v0, Lvj/g0;

    invoke-virtual {v0}, Lvj/g0;->b()Lvj/h0;
