...
.method constructor <init>(Lgj/d;)V
    ...
    invoke-direct {p0, v0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;-><init>(Loj/a;Lgj/e;)V
...
.method constructor <init>(Ljava/security/interfaces/RSAPrivateCrtKey;)V
    ...
    invoke-direct/range {v0 .. v8}, Lvj/f0;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    invoke-direct {p0, v9}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;-><init>(Lvj/e0;)V
...
.method constructor <init>(Loj/a;Lgj/e;)V
    .locals 10

    new-instance v9, Lvj/f0;

    invoke-virtual {p2}, Lgj/e;->F()Ljava/math/BigInteger;

    move-result-object v1

    invoke-virtual {p2}, Lgj/e;->J()Ljava/math/BigInteger;

    move-result-object v2

    invoke-virtual {p2}, Lgj/e;->I()Ljava/math/BigInteger;

    move-result-object v3

    invoke-virtual {p2}, Lgj/e;->G()Ljava/math/BigInteger;

    move-result-object v4

    invoke-virtual {p2}, Lgj/e;->H()Ljava/math/BigInteger;

    move-result-object v5

    invoke-virtual {p2}, Lgj/e;->y()Ljava/math/BigInteger;

    move-result-object v6

    invoke-virtual {p2}, Lgj/e;->z()Ljava/math/BigInteger;

    move-result-object v7

    invoke-virtual {p2}, Lgj/e;->x()Ljava/math/BigInteger;
    ...
    invoke-direct {p0, p1, v9}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;-><init>(Loj/a;Lvj/e0;)V
...
.method constructor <init>(Loj/a;Lvj/f0;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;-><init>(Loj/a;Lvj/e0;)V

    invoke-virtual {p2}, Lvj/f0;->h()Ljava/math/BigInteger;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;->publicExponent:Ljava/math/BigInteger;

    invoke-virtual {p2}, Lvj/f0;->g()Ljava/math/BigInteger;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;->primeP:Ljava/math/BigInteger;

    invoke-virtual {p2}, Lvj/f0;->i()Ljava/math/BigInteger;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;->primeQ:Ljava/math/BigInteger;

    invoke-virtual {p2}, Lvj/f0;->e()Ljava/math/BigInteger;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;->primeExponentP:Ljava/math/BigInteger;

    invoke-virtual {p2}, Lvj/f0;->f()Ljava/math/BigInteger;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;->primeExponentQ:Ljava/math/BigInteger;

    invoke-virtual {p2}, Lvj/f0;->j()Ljava/math/BigInteger;
...
.method constructor <init>(Lvj/f0;)V
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;-><init>(Lvj/e0;)V
...
.method private readObject(Ljava/io/ObjectInputStream;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;->attrCarrier:Lyj/f;
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;->rsaPrivateKey:Lvj/e0;
...
.method public getEncoded()[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;->algorithmIdentifier:Loj/a;
    ...
    invoke-direct/range {v1 .. v9}, Lgj/e;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    invoke-static {v0, v10}, Lyj/e;->b(Loj/a;Lorg/bouncycastle/asn1/e;)[B
