...
.field oid:Lorg/bouncycastle/asn1/n;

.field private final param:Lorg/bouncycastle/crypto/c;
...
# direct methods
.method public constructor <init>(Ljava/lang/String;Lorg/bouncycastle/asn1/n;IIIILjavax/crypto/spec/PBEKeySpec;Lorg/bouncycastle/crypto/c;)V
    .locals 2
    ...
    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;->oid:Lorg/bouncycastle/asn1/n;
    ...
    iput-object p8, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;->param:Lorg/bouncycastle/crypto/c;

    return-void
.end method

.method public constructor <init>(Ljava/lang/String;Lorg/bouncycastle/crypto/c;)V
    .locals 2
    ...
    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;->param:Lorg/bouncycastle/crypto/c;
...
.method public destroy()V
    ...
    invoke-static {v0, v1}, Lorg/bouncycastle/util/a;->p([CC)V
...
.method public getEncoded()[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;->param:Lorg/bouncycastle/crypto/c;

    if-eqz v0, :cond_1

    instance-of v1, v0, Lvj/d0;

    if-eqz v1, :cond_0

    check-cast v0, Lvj/d0;

    invoke-virtual {v0}, Lvj/d0;->a()Lorg/bouncycastle/crypto/c;

    move-result-object v0

    :cond_0
    check-cast v0, Lvj/c0;

    invoke-virtual {v0}, Lvj/c0;->a()[B
    ...
    invoke-static {v0}, Lorg/bouncycastle/crypto/h;->a([C)[B
    ...
    invoke-static {v0}, Lorg/bouncycastle/crypto/h;->c([C)[B
    ...
    invoke-static {v0}, Lorg/bouncycastle/crypto/h;->b([C)[B
...
.method public getOID()Lorg/bouncycastle/asn1/n;
    .locals 1

    invoke-static {p0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;->checkDestroyed(Ljavax/security/auth/Destroyable;)V

    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;->oid:Lorg/bouncycastle/asn1/n;

    return-object v0
.end method

.method public getParam()Lorg/bouncycastle/crypto/c;
    .locals 1
...
.method public getPassword()[C
    ...
    invoke-static {v0}, Lorg/bouncycastle/util/a;->f([C)[C
