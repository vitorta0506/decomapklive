...
.method public static fromPkcs7DerInputStream(Ljava/io/InputStream;)Ljava/util/List;
    ...
    .line 3
    invoke-virtual {v0}, Lorg/conscrypt/OpenSSLBIOInputStream;->c()V
    ...
    .line 9
    :try_start_1
    new-instance v1, Lorg/conscrypt/y;

    invoke-direct {v1, p0}, Lorg/conscrypt/y;-><init>(Ljava/lang/Exception;)V
...
.method private verifyOpenSSL(Lorg/conscrypt/w;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateException;,
...
.method public getPublicKey()Ljava/security/PublicKey;
    ...
    .line 2
    invoke-virtual {v0}, Lorg/conscrypt/w;->b()Ljava/security/PublicKey;
    ...
    .line 7
    :catch_1
    new-instance v2, Lorg/conscrypt/f0;

    invoke-direct {v2, v0, v1}, Lorg/conscrypt/f0;-><init>(Ljava/lang/String;[B)V
...
.method public getSigAlgName()Ljava/lang/String;
    ...
    .line 2
    invoke-static {v0}, Lorg/conscrypt/r;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 3
    :cond_0
    invoke-static {v0}, Lorg/conscrypt/a0;->q(Ljava/lang/String;)Ljava/lang/String;
...
.method public verify(Ljava/security/PublicKey;)V
    ...
    .line 1
    instance-of v0, p1, Lorg/conscrypt/x;

    if-eqz v0, :cond_0

    .line 2
    check-cast p1, Lorg/conscrypt/x;

    invoke-interface {p1}, Lorg/conscrypt/x;->getOpenSSLKey()Lorg/conscrypt/w;

    move-result-object p1

    .line 3
    invoke-direct {p0, p1}, Lorg/conscrypt/OpenSSLX509Certificate;->verifyOpenSSL(Lorg/conscrypt/w;)V
