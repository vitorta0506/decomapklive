...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lrj/b;->a:[J

    const/16 v0, 0xc0

    new-array v0, v0, [B

    iput-object v0, p0, Lrj/b;->b:[B

    invoke-direct {p0, p1}, Lrj/b;->n(I)V
...
.method private g([BI)V
    ...
    iget-object v2, p0, Lrj/b;->a:[J

    aget-wide v3, v2, v1

    invoke-static {p1, p2}, Lorg/bouncycastle/util/g;->g([BI)J
    ...
    :cond_0
    invoke-virtual {p0}, Lrj/b;->m()[B

    move-result-object p1

    invoke-static {p1}, Lorg/bouncycastle/util/encoders/d;->f([B)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {p1}, Ljava/lang/String;->toLowerCase()Ljava/lang/String;

    invoke-direct {p0}, Lrj/b;->i()V
...
.method private h()V
    ...
    iget-object v0, p0, Lrj/b;->a:[J

    iget v1, p0, Lrj/b;->c:I

    ushr-int/lit8 v1, v1, 0x6

    iget-object v2, p0, Lrj/b;->b:[B

    const/4 v3, 0x0

    invoke-static {v0, v3, v1, v2, v3}, Lorg/bouncycastle/util/g;->l([JII[BI)V
...
.method private n(I)V
    ...
    invoke-direct {p0, p1}, Lrj/b;->o(I)V
...
.method private o(I)V
    ...
    invoke-static {v2, v1}, Lorg/bouncycastle/util/a;->o([BB)V

    iput v1, p0, Lrj/b;->d:I

    iput-boolean v1, p0, Lrj/b;->f:Z
...
.method private p()V
    ...
    iget-object v0, p0, Lrj/b;->b:[B

    iget v1, p0, Lrj/b;->d:I
    ...
    iget v2, p0, Lrj/b;->c:I

    const/4 v3, 0x0

    if-ne v1, v2, :cond_0

    invoke-direct {p0, v0, v3}, Lrj/b;->g([BI)V
    ...
    iget-object v6, p0, Lrj/b;->a:[J

    aget-wide v7, v6, v2

    iget-object v9, p0, Lrj/b;->b:[B

    invoke-static {v9, v4}, Lorg/bouncycastle/util/g;->g([BI)J
    ...
    iput v3, p0, Lrj/b;->d:I

    iput-boolean v5, p0, Lrj/b;->f:Z
...
.method public b(B)V
    ...
    invoke-virtual {p0, p1}, Lrj/b;->j(B)V
...
.method public c([BII)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lrj/b;->k([BII)V
...
.method protected j(B)V
    ...
    iget-boolean v1, p0, Lrj/b;->f:Z

    if-nez v1, :cond_1

    iget-object v1, p0, Lrj/b;->b:[B
    ...
    iget p1, p0, Lrj/b;->c:I

    if-ne v0, p1, :cond_0

    const/4 p1, 0x0

    invoke-direct {p0, v1, p1}, Lrj/b;->g([BI)V

    iput p1, p0, Lrj/b;->d:I
...
.method protected k([BII)V
    ...
    invoke-direct {p0, p1, v0}, Lrj/b;->g([BI)V
...
.method protected m()[B
    ...
    invoke-static {v4, v5, v0, v2}, Lorg/bouncycastle/util/g;->k(J[BI)V
...
.method protected q([BIJ)V
    ...
    iget v2, p0, Lrj/b;->d:I

    if-nez v2, :cond_1

    invoke-direct {p0}, Lrj/b;->h()V
    ...
    iget v6, p0, Lrj/b;->c:I

    iget v7, p0, Lrj/b;->d:I
...
.method public reset()V
    ...
    invoke-direct {p0, v0}, Lrj/b;->n(I)V
