...
# direct methods
.method constructor <init>(Lcom/bumptech/glide/c;Lc0/a;IILe0/h;Landroid/graphics/Bitmap;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-virtual {p1}, Lcom/bumptech/glide/c;->f()Lg0/d;
    ...
    .line 4
    invoke-direct/range {v0 .. v7}, Lcom/bumptech/glide/load/resource/gif/f;-><init>(Lg0/d;Lcom/bumptech/glide/h;Lc0/a;Landroid/os/Handler;Lcom/bumptech/glide/g;Le0/h;Landroid/graphics/Bitmap;)V

    return-void
.end method

.method constructor <init>(Lg0/d;Lcom/bumptech/glide/h;Lc0/a;Landroid/os/Handler;Lcom/bumptech/glide/g;Le0/h;Landroid/graphics/Bitmap;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 9
    :cond_0
    iput-object p1, p0, Lcom/bumptech/glide/load/resource/gif/f;->e:Lg0/d;
    ...
    .line 12
    iput-object p3, p0, Lcom/bumptech/glide/load/resource/gif/f;->a:Lc0/a;

    .line 13
    invoke-virtual {p0, p6, p7}, Lcom/bumptech/glide/load/resource/gif/f;->o(Le0/h;Landroid/graphics/Bitmap;)V

    return-void
.end method

.method private static g()Le0/b;
    .locals 3
    ...
    invoke-direct {v0, v1}, Lu0/d;-><init>(Ljava/lang/Object;)V
...
.method private l()V
    ...
    invoke-static {v0, v3}, Lv0/j;->a(ZLjava/lang/String;)V

    .line 4
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/gif/f;->a:Lc0/a;

    invoke-interface {v0}, Lc0/a;->f()V
    ...
    iget-object v4, p0, Lcom/bumptech/glide/load/resource/gif/f;->a:Lc0/a;

    invoke-interface {v4}, Lc0/a;->g()I
    ...
    invoke-static {}, Lcom/bumptech/glide/load/resource/gif/f;->g()Le0/b;

    move-result-object v1

    invoke-static {v1}, Lcom/bumptech/glide/request/h;->D0(Le0/b;)Lcom/bumptech/glide/request/h;
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/resource/gif/f;->a:Lc0/a;

    invoke-virtual {v0, v1}, Lcom/bumptech/glide/g;->Y0(Ljava/lang/Object;)Lcom/bumptech/glide/g;
...
.method private n()V
    ...
    .line 2
    iget-object v1, p0, Lcom/bumptech/glide/load/resource/gif/f;->e:Lg0/d;

    invoke-interface {v1, v0}, Lg0/d;->c(Landroid/graphics/Bitmap;)V
...
.method a()V
    ...
    invoke-virtual {v2, v0}, Lcom/bumptech/glide/h;->g(Ls0/k;)V
    ...
    invoke-interface {v0}, Lc0/a;->clear()V
...
.method b()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v0}, Lc0/a;->getData()Ljava/nio/ByteBuffer;
...
.method d()I
    ...
    iget v0, v0, Lcom/bumptech/glide/load/resource/gif/f$a;->b:I
...
.method o(Le0/h;Landroid/graphics/Bitmap;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/resource/gif/f;->n:Le0/h;
    ...
    invoke-virtual {v1, p1}, Lcom/bumptech/glide/request/a;->q0(Le0/h;)Lcom/bumptech/glide/request/a;

    move-result-object p1

    invoke-virtual {v0, p1}, Lcom/bumptech/glide/g;->y0(Lcom/bumptech/glide/request/a;)Lcom/bumptech/glide/g;
    ...
    .line 4
    invoke-static {p2}, Lv0/k;->h(Landroid/graphics/Bitmap;)I
...
.method setOnEveryFrameReadyListener(Lcom/bumptech/glide/load/resource/gif/f$d;)V
    ...
    iput-object p1, p0, Lcom/bumptech/glide/load/resource/gif/f;->p:Lcom/bumptech/glide/load/resource/gif/f$d;
