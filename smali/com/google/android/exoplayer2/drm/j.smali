...
.field private b:Lcom/google/android/exoplayer2/s1$f;
...
.method private b(Lcom/google/android/exoplayer2/s1$f;)Lcom/google/android/exoplayer2/drm/u;
    .locals 4
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/exoplayer2/drm/j;->d:Lj3/i$a;
    ...
    invoke-virtual {v0, v1}, Lj3/r$b;->c(Ljava/lang/String;)Lj3/r$b;
    ...
    .line 4
    iget-object v2, p1, Lcom/google/android/exoplayer2/s1$f;->c:Landroid/net/Uri;
    ...
    invoke-direct {v1, v2, v3, v0}, Lcom/google/android/exoplayer2/drm/j0;-><init>(Ljava/lang/String;ZLj3/i$a;)V
    ...
    iget-object v2, p1, Lcom/google/android/exoplayer2/s1$f;->a:Ljava/util/UUID;

    sget-object v3, Lcom/google/android/exoplayer2/drm/i0;->d:Lcom/google/android/exoplayer2/drm/c0$f;

    .line 8
    invoke-virtual {v0, v2, v3}, Lcom/google/android/exoplayer2/drm/DefaultDrmSessionManager$b;->e(Ljava/util/UUID;Lcom/google/android/exoplayer2/drm/c0$f;)Lcom/google/android/exoplayer2/drm/DefaultDrmSessionManager$b;

    move-result-object v0

    iget-boolean v2, p1, Lcom/google/android/exoplayer2/s1$f;->f:Z
    ...
    iget-boolean v2, p1, Lcom/google/android/exoplayer2/s1$f;->g:Z
    ...
    iget-object v2, p1, Lcom/google/android/exoplayer2/s1$f;->j:Lcom/google/common/collect/ImmutableList;

    .line 11
    invoke-static {v2}, Lcom/google/common/primitives/f;->j(Ljava/util/Collection;)[I
    ...
    .line 14
    invoke-virtual {p1}, Lcom/google/android/exoplayer2/s1$f;->c()[B
...
# virtual methods
.method public a(Lcom/google/android/exoplayer2/s1;)Lcom/google/android/exoplayer2/drm/u;
    .locals 2
    ...
    .line 5
    :try_start_0
    iget-object v1, p0, Lcom/google/android/exoplayer2/drm/j;->b:Lcom/google/android/exoplayer2/s1$f;
    ...
    .line 6
    iput-object p1, p0, Lcom/google/android/exoplayer2/drm/j;->b:Lcom/google/android/exoplayer2/s1$f;

    .line 7
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/drm/j;->b(Lcom/google/android/exoplayer2/s1$f;)Lcom/google/android/exoplayer2/drm/u;
