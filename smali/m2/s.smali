...
.field private final c:Lcom/google/android/exoplayer2/util/a0;

.field private d:Lc2/e0;

.field private e:Ljava/lang/String;

.field private f:Lcom/google/android/exoplayer2/k1;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lm2/s;->b:Lcom/google/android/exoplayer2/util/b0;
    ...
    iput-object v0, p0, Lm2/s;->c:Lcom/google/android/exoplayer2/util/a0;
...
.method private static a(Lcom/google/android/exoplayer2/util/a0;)J
    .locals 2
...
.method private g(Lcom/google/android/exoplayer2/util/a0;)V
    .locals 2
    ...
    .line 3
    invoke-direct {p0, p1}, Lm2/s;->l(Lcom/google/android/exoplayer2/util/a0;)V
    ...
    .line 7
    invoke-direct {p0, p1}, Lm2/s;->j(Lcom/google/android/exoplayer2/util/a0;)I

    move-result v0

    .line 8
    invoke-direct {p0, p1, v0}, Lm2/s;->k(Lcom/google/android/exoplayer2/util/a0;I)V
...
.method private h(Lcom/google/android/exoplayer2/util/a0;)I
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/android/exoplayer2/ParserException;
    ...
    .line 1
    invoke-virtual {p1}, Lcom/google/android/exoplayer2/util/a0;->b()I
    ...
    .line 2
    invoke-static {p1, v1}, Lcom/google/android/exoplayer2/audio/a;->d(Lcom/google/android/exoplayer2/util/a0;Z)Lcom/google/android/exoplayer2/audio/a$b;
...
.method private i(Lcom/google/android/exoplayer2/util/a0;)V
    .locals 4
    ...
    .line 4
    :cond_2
    invoke-virtual {p1, v3}, Lcom/google/android/exoplayer2/util/a0;->r(I)V
...
.method private j(Lcom/google/android/exoplayer2/util/a0;)I
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/android/exoplayer2/ParserException;
    ...
    .line 2
    invoke-virtual {p1, v1}, Lcom/google/android/exoplayer2/util/a0;->h(I)I
...
.method private k(Lcom/google/android/exoplayer2/util/a0;I)V
    .locals 8

    .line 1
    invoke-virtual {p1}, Lcom/google/android/exoplayer2/util/a0;->e()I
    ...
    .line 2
    iget-object p1, p0, Lm2/s;->b:Lcom/google/android/exoplayer2/util/b0;
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Lm2/s;->b:Lcom/google/android/exoplayer2/util/b0;
    ...
    invoke-virtual {p1, v0, v2, v1}, Lcom/google/android/exoplayer2/util/a0;->i([BII)V
    ...
    invoke-interface {p1, v0, p2}, Lc2/e0;->a(Lcom/google/android/exoplayer2/util/b0;I)V
...
.method private l(Lcom/google/android/exoplayer2/util/a0;)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/android/exoplayer2/ParserException;
    ...
    .line 3
    invoke-static {p1}, Lm2/s;->a(Lcom/google/android/exoplayer2/util/a0;)J
    ...
    .line 5
    invoke-virtual {p1, v3}, Lcom/google/android/exoplayer2/util/a0;->h(I)I
    ...
    .line 9
    invoke-direct {p0, p1}, Lm2/s;->h(Lcom/google/android/exoplayer2/util/a0;)I

    move-result v5

    .line 10
    invoke-virtual {p1, v4}, Lcom/google/android/exoplayer2/util/a0;->p(I)V
    ...
    .line 12
    invoke-virtual {p1, v4, v2, v5}, Lcom/google/android/exoplayer2/util/a0;->i([BII)V
    ...
    .line 14
    invoke-virtual {v2, v5}, Lcom/google/android/exoplayer2/k1$b;->S(Ljava/lang/String;)Lcom/google/android/exoplayer2/k1$b;
    ...
    .line 15
    invoke-virtual {v2, v5}, Lcom/google/android/exoplayer2/k1$b;->e0(Ljava/lang/String;)Lcom/google/android/exoplayer2/k1$b;
    ...
    .line 16
    invoke-virtual {v2, v5}, Lcom/google/android/exoplayer2/k1$b;->I(Ljava/lang/String;)Lcom/google/android/exoplayer2/k1$b;
    ...
    .line 17
    invoke-virtual {v2, v5}, Lcom/google/android/exoplayer2/k1$b;->H(I)Lcom/google/android/exoplayer2/k1$b;
    ...
    .line 18
    invoke-virtual {v2, v5}, Lcom/google/android/exoplayer2/k1$b;->f0(I)Lcom/google/android/exoplayer2/k1$b;
    ...
    invoke-virtual {v2, v4}, Lcom/google/android/exoplayer2/k1$b;->T(Ljava/util/List;)Lcom/google/android/exoplayer2/k1$b;
    ...
    .line 22
    iget-object v4, p0, Lm2/s;->f:Lcom/google/android/exoplayer2/k1;

    invoke-virtual {v2, v4}, Lcom/google/android/exoplayer2/k1;->equals(Ljava/lang/Object;)Z
    ...
    .line 23
    iput-object v2, p0, Lm2/s;->f:Lcom/google/android/exoplayer2/k1;

    const-wide/32 v4, 0x3d090000

    .line 24
    iget v6, v2, Lcom/google/android/exoplayer2/k1;->z:I
    ...
    invoke-interface {v4, v2}, Lc2/e0;->d(Lcom/google/android/exoplayer2/k1;)V
    ...
    :cond_3
    :goto_1
    invoke-direct {p0, p1}, Lm2/s;->i(Lcom/google/android/exoplayer2/util/a0;)V
...
.method private m(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/exoplayer2/util/b0;->L(I)V

    .line 2
    iget-object p1, p0, Lm2/s;->c:Lcom/google/android/exoplayer2/util/a0;
    ...
    invoke-virtual {p1, v0}, Lcom/google/android/exoplayer2/util/a0;->n([B)V
...
.method public b(Lcom/google/android/exoplayer2/util/b0;)V
    ...
    .line 5
    iget-object v1, p0, Lm2/s;->c:Lcom/google/android/exoplayer2/util/a0;

    iget-object v1, v1, Lcom/google/android/exoplayer2/util/a0;->a:[B

    iget v2, p0, Lm2/s;->h:I

    invoke-virtual {p1, v1, v2, v0}, Lcom/google/android/exoplayer2/util/b0;->j([BII)V
    ...
    .line 8
    iget-object v0, p0, Lm2/s;->c:Lcom/google/android/exoplayer2/util/a0;

    invoke-virtual {v0, v4}, Lcom/google/android/exoplayer2/util/a0;->p(I)V

    .line 9
    iget-object v0, p0, Lm2/s;->c:Lcom/google/android/exoplayer2/util/a0;

    invoke-direct {p0, v0}, Lm2/s;->g(Lcom/google/android/exoplayer2/util/a0;)V
    ...
    .line 13
    iget-object v2, p0, Lm2/s;->b:Lcom/google/android/exoplayer2/util/b0;
