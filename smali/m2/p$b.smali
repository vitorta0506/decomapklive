...
.method public constructor <init>(Lc2/e0;ZZ)V
    ...
    invoke-direct {p2, p1, p3, p3}, Lcom/google/android/exoplayer2/util/c0;-><init>([BII)V

    iput-object p2, p0, Lm2/p$b;->f:Lcom/google/android/exoplayer2/util/c0;
...
.method public a([BII)V
    ...
    .line 6
    iget-object v2, v0, Lm2/p$b;->f:Lcom/google/android/exoplayer2/util/c0;

    iget-object v3, v0, Lm2/p$b;->g:[B

    const/4 v4, 0x0

    invoke-virtual {v2, v3, v4, v1}, Lcom/google/android/exoplayer2/util/c0;->i([BII)V

    .line 7
    iget-object v1, v0, Lm2/p$b;->f:Lcom/google/android/exoplayer2/util/c0;

    const/16 v2, 0x8

    invoke-virtual {v1, v2}, Lcom/google/android/exoplayer2/util/c0;->b(I)Z
    ...
    invoke-virtual {v1}, Lcom/google/android/exoplayer2/util/c0;->k()V

    .line 9
    iget-object v1, v0, Lm2/p$b;->f:Lcom/google/android/exoplayer2/util/c0;

    invoke-virtual {v1, v7}, Lcom/google/android/exoplayer2/util/c0;->e(I)I
    ...
    invoke-virtual {v1}, Lcom/google/android/exoplayer2/util/c0;->c()Z
    ...
    invoke-virtual {v1}, Lcom/google/android/exoplayer2/util/c0;->h()I
    ...
    check-cast v1, Lcom/google/android/exoplayer2/util/w$b;

    .line 23
    iget-object v3, v0, Lm2/p$b;->d:Landroid/util/SparseArray;

    iget v5, v1, Lcom/google/android/exoplayer2/util/w$b;->b:I
    ...
    check-cast v9, Lcom/google/android/exoplayer2/util/w$c;

    .line 24
    iget-boolean v3, v9, Lcom/google/android/exoplayer2/util/w$c;->i:Z

    if-eqz v3, :cond_9

    .line 25
    iget-object v3, v0, Lm2/p$b;->f:Lcom/google/android/exoplayer2/util/c0;

    invoke-virtual {v3, v7}, Lcom/google/android/exoplayer2/util/c0;->b(I)Z
    ...
    iget v5, v9, Lcom/google/android/exoplayer2/util/w$c;->k:I

    invoke-virtual {v3, v5}, Lcom/google/android/exoplayer2/util/c0;->b(I)Z
    ...
    invoke-virtual {v3, v5}, Lcom/google/android/exoplayer2/util/c0;->e(I)I

    move-result v12

    .line 29
    iget-boolean v3, v9, Lcom/google/android/exoplayer2/util/w$c;->j:Z
    ...
    invoke-virtual {v3}, Lcom/google/android/exoplayer2/util/c0;->d()Z
    ...
    .line 32
    iget-object v6, v0, Lm2/p$b;->f:Lcom/google/android/exoplayer2/util/c0;

    invoke-virtual {v6, v5}, Lcom/google/android/exoplayer2/util/c0;->b(I)Z
    ...
    invoke-virtual {v6}, Lcom/google/android/exoplayer2/util/c0;->d()Z
    ...
    invoke-virtual {v2}, Lcom/google/android/exoplayer2/util/c0;->c()Z
    ...
    .line 37
    :goto_3
    iget v2, v9, Lcom/google/android/exoplayer2/util/w$c;->l:I
    ...
    iget v3, v9, Lcom/google/android/exoplayer2/util/w$c;->m:I

    invoke-virtual {v2, v3}, Lcom/google/android/exoplayer2/util/c0;->b(I)Z
    ...
    invoke-virtual {v2, v3}, Lcom/google/android/exoplayer2/util/c0;->e(I)I

    move-result v2

    .line 40
    iget-boolean v1, v1, Lcom/google/android/exoplayer2/util/w$b;->c:Z
    ...
    invoke-virtual {v1}, Lcom/google/android/exoplayer2/util/c0;->g()I
    ...
    .line 43
    iget-boolean v2, v9, Lcom/google/android/exoplayer2/util/w$c;->n:Z
    ...
    invoke-virtual/range {v8 .. v22}, Lm2/p$b$a;->e(Lcom/google/android/exoplayer2/util/w$c;IIIIZZZZIIIII)V
...
.method public e(Lcom/google/android/exoplayer2/util/w$b;)V
    .locals 2

    iget-object v0, p0, Lm2/p$b;->e:Landroid/util/SparseArray;

    iget v1, p1, Lcom/google/android/exoplayer2/util/w$b;->a:I
...
.method public f(Lcom/google/android/exoplayer2/util/w$c;)V
    .locals 2

    iget-object v0, p0, Lm2/p$b;->d:Landroid/util/SparseArray;

    iget v1, p1, Lcom/google/android/exoplayer2/util/w$c;->d:I
