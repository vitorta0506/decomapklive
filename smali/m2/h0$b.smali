...
.method public constructor <init>(Lm2/h0;I)V
    ...
    invoke-direct {p1, v0}, Lcom/google/android/exoplayer2/util/a0;-><init>([B)V

    iput-object p1, p0, Lm2/h0$b;->a:Lcom/google/android/exoplayer2/util/a0;
...
.method private c(Lcom/google/android/exoplayer2/util/b0;I)Lm2/i0$b;
    .locals 13
    ...
    .line 8
    invoke-virtual {p1, v8}, Lcom/google/android/exoplayer2/util/b0;->A(I)Ljava/lang/String;
    ...
    .line 13
    invoke-virtual {p1, v9, v10, v5}, Lcom/google/android/exoplayer2/util/b0;->j([BII)V
    ...
    invoke-virtual {p1, v6}, Lcom/google/android/exoplayer2/util/b0;->Q(I)V
...
.method public b(Lcom/google/android/exoplayer2/util/b0;)V
    ...
    invoke-static {v2}, Lm2/h0;->e(Lm2/h0;)I
    ...
    .line 3
    :cond_1
    new-instance v2, Lcom/google/android/exoplayer2/util/i0;
    ...
    check-cast v6, Lcom/google/android/exoplayer2/util/i0;

    invoke-virtual {v6}, Lcom/google/android/exoplayer2/util/i0;->c()J

    move-result-wide v6

    invoke-direct {v2, v6, v7}, Lcom/google/android/exoplayer2/util/i0;-><init>(J)V
    ...
    check-cast v2, Lcom/google/android/exoplayer2/util/i0;
    ...
    .line 8
    :cond_3
    invoke-virtual {v1, v5}, Lcom/google/android/exoplayer2/util/b0;->Q(I)V
    ...
    .line 10
    invoke-virtual {v1, v7}, Lcom/google/android/exoplayer2/util/b0;->Q(I)V

    .line 11
    iget-object v8, v0, Lm2/h0$b;->a:Lcom/google/android/exoplayer2/util/a0;

    invoke-virtual {v1, v8, v3}, Lcom/google/android/exoplayer2/util/b0;->i(Lcom/google/android/exoplayer2/util/a0;I)V

    .line 12
    iget-object v8, v0, Lm2/h0$b;->a:Lcom/google/android/exoplayer2/util/a0;

    invoke-virtual {v8, v7}, Lcom/google/android/exoplayer2/util/a0;->r(I)V

    .line 13
    iget-object v8, v0, Lm2/h0$b;->e:Lm2/h0;

    iget-object v9, v0, Lm2/h0$b;->a:Lcom/google/android/exoplayer2/util/a0;
    ...
    invoke-virtual {v8, v9}, Lcom/google/android/exoplayer2/util/a0;->r(I)V
    ...
    invoke-virtual {v8, v11}, Lcom/google/android/exoplayer2/util/a0;->h(I)I

    move-result v8

    .line 17
    invoke-virtual {v1, v8}, Lcom/google/android/exoplayer2/util/b0;->Q(I)V
    ...
    .line 23
    invoke-static {v14}, Lm2/h0;->r(Lm2/h0;)Lc2/n;
    ...
    .line 24
    invoke-interface {v8, v2, v14, v15}, Lm2/i0;->a(Lcom/google/android/exoplayer2/util/i0;Lc2/n;Lm2/i0$d;)V
    ...
    .line 28
    iget-object v14, v0, Lm2/h0$b;->a:Lcom/google/android/exoplayer2/util/a0;

    const/4 v15, 0x5

    invoke-virtual {v1, v14, v15}, Lcom/google/android/exoplayer2/util/b0;->i(Lcom/google/android/exoplayer2/util/a0;I)V
    ...
    invoke-virtual {v14, v4}, Lcom/google/android/exoplayer2/util/a0;->h(I)I
    ...
    invoke-virtual {v14, v7}, Lcom/google/android/exoplayer2/util/a0;->r(I)V

    .line 31
    iget-object v14, v0, Lm2/h0$b;->a:Lcom/google/android/exoplayer2/util/a0;

    invoke-virtual {v14, v10}, Lcom/google/android/exoplayer2/util/a0;->h(I)I

    move-result v14

    .line 32
    iget-object v7, v0, Lm2/h0$b;->a:Lcom/google/android/exoplayer2/util/a0;

    invoke-virtual {v7, v9}, Lcom/google/android/exoplayer2/util/a0;->r(I)V

    .line 33
    iget-object v7, v0, Lm2/h0$b;->a:Lcom/google/android/exoplayer2/util/a0;

    invoke-virtual {v7, v11}, Lcom/google/android/exoplayer2/util/a0;->h(I)I

    move-result v7

    .line 34
    invoke-direct {v0, v1, v7}, Lm2/h0$b;->c(Lcom/google/android/exoplayer2/util/b0;I)Lm2/i0$b;
    ...
    .line 53
    invoke-static {v10}, Lm2/h0;->r(Lm2/h0;)Lc2/n;
    ...
    .line 54
    invoke-interface {v9, v2, v10, v11}, Lm2/i0;->a(Lcom/google/android/exoplayer2/util/i0;Lc2/n;Lm2/i0$d;)V

    .line 55
    :cond_d
    iget-object v7, v0, Lm2/h0$b;->e:Lm2/h0;

    invoke-static {v7}, Lm2/h0;->d(Lm2/h0;)Landroid/util/SparseArray;
    ...
    invoke-static {v1}, Lm2/h0;->r(Lm2/h0;)Lc2/n;
    ...
    invoke-static {v1}, Lm2/h0;->d(Lm2/h0;)Landroid/util/SparseArray;
    ...
    invoke-static {v1}, Lm2/h0;->e(Lm2/h0;)I
