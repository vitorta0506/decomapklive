...
.method bridge synthetic i(Ln/a;F)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lf/d;->r(Ln/a;F)Ljava/lang/Float;
...
.method public p()F
    ...
    invoke-virtual {p0, v0, v1}, Lf/d;->q(Ln/a;F)F
...
.method q(Ln/a;F)F
    ...
    .line 7
    :cond_0
    invoke-virtual {p1}, Ln/a;->f()F

    move-result v0

    invoke-virtual {p1}, Ln/a;->c()F

    move-result p1

    invoke-static {v0, p1, p2}, Lm/g;->k(FFF)F
...
.method r(Ln/a;F)Ljava/lang/Float;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p2}, Lf/d;->q(Ln/a;F)F
