...
# static fields
.field private static volatile b:Lcn/jiguang/ao/d;
...
.method public static a()Lcn/jiguang/ao/d;
    ...
    sget-object v0, Lcn/jiguang/ao/d;->b:Lcn/jiguang/ao/d;
    ...
    :try_start_0
    sget-object v1, Lcn/jiguang/ao/d;->b:Lcn/jiguang/ao/d;

    if-nez v1, :cond_0

    new-instance v1, Lcn/jiguang/ao/d;

    invoke-direct {v1}, Lcn/jiguang/ao/d;-><init>()V

    sput-object v1, Lcn/jiguang/ao/d;->b:Lcn/jiguang/ao/d;
...
.method protected a(Landroid/content/Context;)Ljava/lang/String;
    ...
    sput-boolean p1, Lcn/jiguang/aq/e;->a:Z
...
.method protected b(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcn/jiguang/ao/d;->c:Lcn/jiguang/ap/a;
...
.method protected d(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcn/jiguang/ao/d;->c:Lcn/jiguang/ap/a;

    iget-boolean v0, v0, Lcn/jiguang/ap/a;->t:Z

    const-string v1, "JWakeReport"

    if-eqz v0, :cond_2

    invoke-static {p1}, Lcn/jiguang/aq/c;->b(Landroid/content/Context;)Lorg/json/JSONArray;
    ...
    invoke-static {p1}, Lcn/jiguang/aq/c;->c(Landroid/content/Context;)V
    ...
    iget-boolean v0, v0, Lcn/jiguang/ap/a;->u:Z

    if-eqz v0, :cond_5

    invoke-static {p1}, Lcn/jiguang/aq/e;->a(Landroid/content/Context;)Lorg/json/JSONArray;
    ...
    invoke-static {p1}, Lcn/jiguang/aq/e;->d(Landroid/content/Context;)V
