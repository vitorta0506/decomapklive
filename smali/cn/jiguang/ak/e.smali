...
# static fields
.field private static volatile b:Lcn/jiguang/ak/e;
...
.method public static a()Lcn/jiguang/ak/e;
    .locals 2

    sget-object v0, Lcn/jiguang/ak/e;->b:Lcn/jiguang/ak/e;

    if-nez v0, :cond_1

    const-class v0, Lcn/jiguang/ak/e;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcn/jiguang/ak/e;->b:Lcn/jiguang/ak/e;

    if-nez v1, :cond_0

    new-instance v1, Lcn/jiguang/ak/e;

    invoke-direct {v1}, Lcn/jiguang/ak/e;-><init>()V

    sput-object v1, Lcn/jiguang/ak/e;->b:Lcn/jiguang/ak/e;
...
.method protected a(Landroid/content/Context;)Ljava/lang/String;
    ...
    iput-object p1, p0, Lcn/jiguang/ak/e;->a:Landroid/content/Context;
    ...
    :cond_0
    :try_start_0
    invoke-static {p1}, Lcn/jiguang/o/b;->k(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p1, v0}, Lcn/jiguang/ak/d;->a(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcn/jiguang/ak/e;->b(Landroid/content/Context;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public b(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0}, Lcn/jiguang/ak/e;->c()Z
    ...
    :cond_0
    :try_start_0
    new-instance v0, Lcn/jiguang/ak/e$a;

    invoke-direct {v0, p0, p1}, Lcn/jiguang/ak/e$a;-><init>(Lcn/jiguang/ak/e;Landroid/content/Context;)V
    ...
    invoke-static {p2, p1}, Lcn/jiguang/al/a;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method protected b(Landroid/content/Context;Ljava/lang/String;)V
    ...
    sget-boolean v0, Lcn/jiguang/ak/c;->b:Z
    ...
    sget-boolean v0, Lcn/jiguang/ak/c;->c:Z
    ...
    sget-boolean p2, Lcn/jiguang/ak/c;->b:Z
    ...
    invoke-static {p1}, Lcn/jiguang/ak/f;->a(Landroid/content/Context;)Lcn/jiguang/ak/f;

    move-result-object p2

    invoke-virtual {p2}, Lcn/jiguang/ak/f;->b()V
    ...
    invoke-virtual {v0}, Lcn/jiguang/ak/f;->c()V
    ...
    invoke-virtual {v0}, Lcn/jiguang/ak/f;->a()V
    ...
    invoke-virtual {v0}, Lcn/jiguang/ak/f;->d()V
...
.method protected b()Z
    ...
    iget-object v0, p0, Lcn/jiguang/ak/e;->a:Landroid/content/Context;
...
.method protected d(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcn/jiguang/ak/f;->e()Lorg/json/JSONObject;
    ...
    invoke-virtual {v0}, Lcn/jiguang/ak/f;->f()V
