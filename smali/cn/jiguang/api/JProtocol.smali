...
.field protected head:Lcn/jiguang/bf/c;
...
.method public constructor <init>(ZIIJ)V
    ...
    new-instance v6, Lcn/jiguang/bf/c;
    ...
    invoke-direct/range {v0 .. v5}, Lcn/jiguang/bf/c;-><init>(ZIIJ)V

    iput-object v6, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bf/c;
...
.method public constructor <init>(ZIIJIJ)V
    ...
    new-instance v11, Lcn/jiguang/bf/c;
    ...
    invoke-direct/range {v1 .. v10}, Lcn/jiguang/bf/c;-><init>(ZIIIJIJ)V

    iput-object v11, v0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bf/c;
...
.method public constructor <init>(ZLjava/lang/Object;Ljava/nio/ByteBuffer;)V
    ...
    check-cast p2, Lcn/jiguang/bf/c;

    iput-object p2, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bf/c;
    ...
    invoke-static {p1, p2}, Lcn/jiguang/bf/d;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public constructor <init>(ZLjava/nio/ByteBuffer;[B)V
    ...
    invoke-direct {v1, p1, p3}, Lcn/jiguang/bf/c;-><init>(Z[B)V

    iput-object v1, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bf/c;
    :try_end_0
    ...
    invoke-static {v0, p1}, Lcn/jiguang/bf/d;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static parseHead(Ljava/lang/Object;)[B
    ...
    :goto_0
    invoke-static {v1, p0}, Lcn/jiguang/bf/d;->c(Ljava/lang/String;Ljava/lang/String;)V

    return-object v0

    :cond_0
    instance-of v2, p0, Lcn/jiguang/bf/c;

    if-eqz v2, :cond_1

    check-cast p0, Lcn/jiguang/bf/c;

    invoke-virtual {p0}, Lcn/jiguang/bf/c;->f()[B
...
.method private final toBytes()[B
    ...
    invoke-static {v2, v0}, Lcn/jiguang/bf/d;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v3, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bf/c;
    ...
    invoke-virtual {v3, v4}, Lcn/jiguang/bf/c;->a(I)V

    :try_start_0
    iget-object v3, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bf/c;

    invoke-virtual {v3}, Lcn/jiguang/bf/c;->f()[B
    ...
    invoke-static {v0}, Lcn/jiguang/bf/f;->a([B)Ljava/lang/String;
    ...
    invoke-static {v2, v1}, Lcn/jiguang/bf/d;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public getCommand()I
    ...
    iget-object v0, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bf/c;

    invoke-virtual {v0}, Lcn/jiguang/bf/c;->a()I
...
.method public getHead()Lcn/jiguang/bf/c;
    .locals 1
...
.method public getJuid()J
    ...
    invoke-virtual {v0}, Lcn/jiguang/bf/c;->c()J
...
.method public getRid()Ljava/lang/Long;
    ...
    invoke-virtual {v0}, Lcn/jiguang/bf/c;->b()Ljava/lang/Long;
...
.method public getSid()I
    ...
    invoke-virtual {v0}, Lcn/jiguang/bf/c;->d()I
...
.method public getVersion()I
    ...
    invoke-virtual {v0}, Lcn/jiguang/bf/c;->e()I
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcn/jiguang/api/JProtocol;->head:Lcn/jiguang/bf/c;

    invoke-virtual {v1}, Lcn/jiguang/bf/c;->toString()Ljava/lang/String;
